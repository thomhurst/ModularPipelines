...
- Follow [pull request maintenance](../../../../AGENTS.md#pull-request-maintenance) for autogenerated CLI options PRs, closed-PR CI cancellation, and review-thread resolution.
