...
{
    [Test]
    public async Task Empty_List_Default_Does_Not_Add_Type_Metadata()
    {
        await Assert.That(OptionEnumFactory.PreserveValueHint(null, "Set labels.", "[]")).IsEqualTo("Set labels.");
    }
