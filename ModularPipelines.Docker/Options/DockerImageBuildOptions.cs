...
public record DockerImageBuildOptions([property: PositionalArgument(Position = Position.AfterArguments)] string Path, [property: PositionalArgument(Position = Position.AfterArguments)] string Url) : DockerOptions
{
