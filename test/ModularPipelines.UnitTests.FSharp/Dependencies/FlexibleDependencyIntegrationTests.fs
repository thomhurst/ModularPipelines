...
module FlexibleDependencyIntegrationTestsData =
    ...
    let getExecutionOrder() = ResizeArray(executionOrderQueue.ToArray())
...
type FlexibleDependencyIntegrationTests() =
    ...
    member _.DependsOnModulesWithTag_WaitsForTaggedModules() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let afterDbIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterDatabaseModule)
        let dbAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.DatabaseModuleA)
        let dbBIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.DatabaseModuleB)
    ...
    member _.DependsOnModulesWithTag_MultipleTagsOnModule_MatchesCorrectly() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let multiTagIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.ModuleWithMultipleTags)
        let afterSlowIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterSlowModule)
    ...
    member _.DependsOnModulesInCategory_WaitsForCategorizedModules() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let afterInfraIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterInfrastructureModule)
        let infraAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.InfrastructureModuleA)
        let infraBIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.InfrastructureModuleB)
    ...
    //    let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
    //    let afterCriticalIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterCriticalModule)
    //    let criticalAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.CriticalModuleA)
    //    let criticalBIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.CriticalModuleB)
    ...
    //    let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
    //    let derivedIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.DerivedCriticalModule)
    //    let afterCriticalIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterCriticalModule)
    ...
    member _.ModuleWithOverrideTags_IsRecognizedByTagDependency() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let overrideIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.ModuleWithOverrideTags)
        let afterDbIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterDatabaseModule)
    ...
    member _.ModuleWithOverrideCategory_IsRecognizedByCategoryDependency() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let overrideIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.ModuleWithOverrideCategory)
        let afterInfraIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterInfrastructureModule)
    ...
    member _.ModuleWithRegistrationTags_IsRecognizedByTagDependency() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let plainIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.PlainModule)
        let afterDbIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterDatabaseModule)
    ...
    //    let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
    //    let combinedIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.ModuleWithMultipleFlexibleDependencies)
    //    let dbAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.DatabaseModuleA)
    //    let infraAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.InfrastructureModuleA)
    //    let criticalAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.CriticalModuleA)
    ...
    member _.ChainedFlexibleDependencies_ExecuteInCorrectOrder() = async {
        ...
        let order = FlexibleDependencyIntegrationTestsData.getExecutionOrder() |> Seq.toArray
        let dbAIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.DatabaseModuleA)
        let afterDbIndex = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterDatabaseModuleWithPhase1Tag)
        let afterPhase1Index = Array.IndexOf(order, nameof FlexibleDependencyIntegrationTestsData.AfterPhase1Module)
