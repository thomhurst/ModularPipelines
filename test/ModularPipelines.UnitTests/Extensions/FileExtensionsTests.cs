...
public class FileExtensionsTests
{
    ...
    public async Task EnumerablePaths()
    {
        ...
        {
            new File(Path.Combine(TestContext.OutputDirectory, "File1.txt")),
            new File(Path.Combine(TestContext.OutputDirectory, "File2.txt")),
        }.AsEnumerable();
        ...
        {
            Path.Combine(TestContext.OutputDirectory, "File1.txt"),
            Path.Combine(TestContext.OutputDirectory, "File2.txt"),
        });
    }
