...
public class FileExtensionsTests
{
    ...
    public async Task EnumerablePaths()
    {
        ...
        {
            new File(Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "File1.txt")),
            new File(Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "File2.txt")),
        }.AsEnumerable();
        ...
        {
            Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "File1.txt"),
            Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "File2.txt"),
        });
    }
