...
public class FolderExtensionsTests
{
    ...
    public async Task EnumerablePaths()
    {
        ...
        {
            new Folder(Path.Combine(TestContext.OutputDirectory, "Folder1")),
            new Folder(Path.Combine(TestContext.OutputDirectory, "Folder2")),
        }.AsEnumerable();
        ...
        {
            Path.Combine(TestContext.OutputDirectory, "Folder1"),
            Path.Combine(TestContext.OutputDirectory, "Folder2"),
        });
    }
