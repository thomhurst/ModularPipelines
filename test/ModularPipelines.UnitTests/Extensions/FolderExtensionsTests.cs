...
public class FolderExtensionsTests
{
    ...
    public async Task EnumerablePaths()
    {
        ...
        {
            new Folder(Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "Folder1")),
            new Folder(Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "Folder2")),
        }.AsEnumerable();
        ...
        {
            Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "Folder1"),
            Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "Folder2"),
        });
    }
