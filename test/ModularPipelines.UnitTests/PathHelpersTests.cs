...
public class PathHelpersTests
{
    ...
    {
        var outputDirectory = new DirectoryInfo(TestContext.OutputDirectory);
    ...
    {
        var path = Path.Combine(TestContext.OutputDirectory, "Blah", "Foo", "Bar", "Foo.txt");
    ...
    {
        var path = Path.Combine(TestContext.OutputDirectory, "Blah", "Foo", "Bar", "Foo");
