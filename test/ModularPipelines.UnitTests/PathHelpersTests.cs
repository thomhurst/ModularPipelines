...
public class PathHelpersTests
{
    ...
    {
        var outputDirectory = new DirectoryInfo(TUnit.Engine.TUnit.OutputDirectory);
    ...
    {
        var path = Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "Blah", "Foo", "Bar", "Foo.txt");
    ...
    {
        var path = Path.Combine(TUnit.Engine.TUnit.OutputDirectory, "Blah", "Foo", "Bar", "Foo");
