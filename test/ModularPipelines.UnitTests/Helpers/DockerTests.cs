...
public class DockerTests : TestBase
{
    ...
    public async Task DockerBuild_CorrectInputCommand()
    {
        ...
        Assert.That(result.Value!.CommandInput, Is.EqualTo("docker image build --build-arg Arg1=Value1 --build-arg Arg2=Value2 --build-arg Arg3=Value3 --tag mytaggedimage --target build-env"));
    }
}