...
public class FileTests : TestBase
{
    ...
    {
        var workingDirectory = new Folder(TestContext.OutputDirectory).FindAncestorContainingProject()!;
    ...
    {
        var folder = new Folder(TestContext.OutputDirectory).FindAncestorContainingProject()!
