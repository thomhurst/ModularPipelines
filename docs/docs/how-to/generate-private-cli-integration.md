...
versioned independently by `schemaVersion`. This release supports schema version `2`. It
rejects version `1` and unknown versions rather than interpreting them differently.
