...
Absolute paths and paths that escape that root are rejected. Set
...
by the JSON definition and generator version. Commit them, but do not edit files marked
`<auto-generated>` manually. Change the JSON and rerun instead.
