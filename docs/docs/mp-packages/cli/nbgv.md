...
Resolve the service with `context.Tools.Nbgv`. The `context.Nbgv()` extension method remains available as a compatibility fallback for projects older than C# 14.
