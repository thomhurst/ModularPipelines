...
public class AssignAccessToBlobStorageModule : IModule<RoleAssignmentResource>
{
    /// <inheritdoc/>
    public async Task<RoleAssignmentResource?> ExecuteAsync(IModuleContext context, CancellationToken cancellationToken)
    {
