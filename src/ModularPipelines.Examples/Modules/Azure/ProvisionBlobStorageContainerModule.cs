...
public class ProvisionBlobStorageContainerModule : IModule<BlobContainerResource>
{
    /// <inheritdoc/>
    public async Task<BlobContainerResource?> ExecuteAsync(IModuleContext context, CancellationToken cancellationToken)
    {
