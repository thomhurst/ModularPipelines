...
public class MinikubeConfig : IMinikubeConfig
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new MinikubeConfigOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ViewAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new MinikubeConfigViewOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
