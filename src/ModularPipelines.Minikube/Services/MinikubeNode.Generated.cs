...
public class MinikubeNode : IMinikubeNode
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new MinikubeNodeOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> AddAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new MinikubeNodeAddOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
