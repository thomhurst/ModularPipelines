...
public record KubernetesCreateClusterrolebindingOptions : KubernetesOptions
{
    public KubernetesCreateClusterrolebindingOptions(
        string clusterrole
)
    {
        CommandParts = ["create", "clusterrolebinding"];
