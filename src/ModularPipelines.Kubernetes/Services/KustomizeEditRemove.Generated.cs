...
public class KustomizeEditRemove
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new KustomizeEditRemoveOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> PatchAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new KustomizeEditRemovePatchOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
