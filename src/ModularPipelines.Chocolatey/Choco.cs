...
internal class Choco : IChoco
{
    ...
    public async Task<CommandResult> CacheRemove(CacheRemoveOptions? options = default,
    ...
    public async Task<CommandResult> ConfigUnset(ConfigUnsetOptions? options = default,
        CancellationToken token = default)
    {
    ...
    public async Task<CommandResult> FeatureDisable(FeatureDisableOptions? options = default,
        CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new FeatureDisableOptions(), token);
    }

    public async Task<CommandResult> FeatureEnable(FeatureEnableOptions? options = default,
        CancellationToken token = default)
    {
    ...
    public async Task<CommandResult> SourceRemove(SourceRemoveOptions? options = default,
        CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new SourceRemoveOptions(), token);
    }

    public async Task<CommandResult> SourceDisable(SourceDisableOptions? options = default,
        CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new SourceDisableOptions(), token);
    }

    public async Task<CommandResult> SourceEnable(SourceEnableOptions? options = default,
        CancellationToken token = default)
    {
    ...
    public async Task<CommandResult> SourcesRemove(SourcesRemoveOptions? options = default,
        CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new SourcesRemoveOptions(), token);
    }

    public async Task<CommandResult> SourcesDisable(SourcesDisableOptions? options = default,
        CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new SourcesDisableOptions(), token);
    }

    public async Task<CommandResult> SourcesEnable(SourcesEnableOptions? options = default,
        CancellationToken token = default)
    {
    ...
    public async Task<CommandResult> TemplateInfo(TemplateInfoOptions? options = default,
        CancellationToken token = default)
    {
