...
public record PulumiNeoOptions : PulumiOptions
{
    ...
    /// <summary>
    /// latest"] Debug a failed preview. With no value, targets the stack's latest preview; pass =&lt;preview-id&gt; to target a specific one
    /// </summary>
    [CliOption("--debug-preview", Format = OptionFormat.EqualsSeparated)]
    public string? DebugPreview { get; set; }

    /// <summary>
    /// latest"] Debug a failed update. With no value, targets the stack's latest update; pass =&lt;version&gt; (e.g. --debug-update=42) to target a specific one
    /// </summary>
    [CliOption("--debug-update", Format = OptionFormat.EqualsSeparated)]
    public string? DebugUpdate { get; set; }
