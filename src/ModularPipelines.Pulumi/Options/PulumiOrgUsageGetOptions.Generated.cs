...
[CliSubCommand("org", "usage", "get")]
public record PulumiOrgUsageGetOptions : PulumiOptions
{
    /// <summary>
    /// Time granularity for aggregation. One of: hourly, daily, monthly (default "daily")
    /// </summary>
    [CliOption("--granularity", Format = OptionFormat.EqualsSeparated)]
    ...
    /// </summary>
    [CliOption("--lookback-start", Format = OptionFormat.EqualsSeparated)]
    public int? LookbackStart { get; set; }
