...
[CliSubCommand("org", "search")]
public record PulumiOrgSearchOptions : PulumiOptions
{
    /// <summary>
    /// Delimiter to use when rendering CSV output. (default  )
    /// </summary>
    ...
    /// <summary>
    /// Output format. Supported values are: default, json, yaml and csv (default "default")
    /// </summary>
