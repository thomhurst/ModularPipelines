...
public record PulumiInsightsAccountNewOptions : PulumiOptions
{
    ...
    public PulumiInsightsAccountNewProvider? Provider { get; set; }

    /// <summary>
    /// Provider-specific configuration as an inline JSON object (e.g. '{"regions":["us-east-1"]}')
    /// </summary>
    [CliOption("--provider-config", Format = OptionFormat.EqualsSeparated)]
    public string? ProviderConfig { get; set; }

    /// <summary>
    /// Automated scan schedule. One of: none, 12h, daily
    /// </summary>
    [CliOption("--scan-schedule", Format = OptionFormat.EqualsSeparated)]
    public PulumiInsightsAccountNewScanSchedule? ScanSchedule { get; set; }
