...
[CliSubCommand("stack", "schedule", "new")]
public record PulumiStackScheduleNewOptions : PulumiOptions
{
    /// <summary>
    /// (drift only) Automatically run a remediation update when drift is detected
    /// </summary>
    [CliFlag("--auto-remediate")]
    ...
    public PulumiStackScheduleNewKind? Kind { get; set; }

    /// <summary>
    /// ISO 8601 timestamp for a one-time execution (e.g. '2026-12-31T23:59:00Z')
    /// </summary>
    [CliOption("--once", Format = OptionFormat.EqualsSeparated)]
    ...
    public PulumiStackScheduleNewOperation? Operation { get; set; }
