...
) : PulumiOptions
{
    ...
    /// </summary>
    [CliOption("--access-duration-seconds", Format = OptionFormat.EqualsSeparated)]
    public string? AccessDurationSeconds { get; set; }

    /// <summary>
    /// expiration time for the grant in seconds (default 25h0m0s)
    /// </summary>
