...
[CliSubCommand("env", "tag", "remove")]
public record PulumiEnvTagRemoveOptions : PulumiOptions
{
    /// <summary>
    /// Remove an environment tag
    /// </summary>
    /// <param name="EnvironmentName">The &lt;environment-name&gt; operand.</param>
    /// <param name="TagName">The &lt;tag-name&gt; operand.</param>
    public PulumiEnvTagRemoveOptions(
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(TagName);
        this.TagName = TagName;
    }

    public void Deconstruct(out string EnvironmentName, out string TagName)
    {
