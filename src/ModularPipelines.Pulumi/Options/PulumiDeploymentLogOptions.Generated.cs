...
public record PulumiDeploymentLogOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string DeploymentVersion
) : PulumiOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The step index within the job; requires --job (-1 to leave unset) (default -1)
    /// </summary>
    [CliOption("--step", Format = OptionFormat.EqualsSeparated)]
