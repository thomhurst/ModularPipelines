...
[CliSubCommand("stack", "webhook", "new")]
public record PulumiStackWebhookNewOptions : PulumiOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The webhook format: raw, slack, ms_teams, or pulumi_deployments (default "raw")
    /// </summary>
