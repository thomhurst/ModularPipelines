...
public record PulumiEnvOpenOptions : PulumiOptions
{
    ...
    /// <summary>
    /// the output format to use. May be 'dotenv', 'json', 'yaml', 'detailed', 'shell' or 'string' (default "json")
    /// </summary>
    ...
    /// </summary>
    [CliOption("--lifetime", ShortForm = "-l", Format = OptionFormat.EqualsSeparated)]
