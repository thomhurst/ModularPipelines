...
public class PulumiDeployment : IPulumiDeployment
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiDeploymentOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiDeploymentListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
