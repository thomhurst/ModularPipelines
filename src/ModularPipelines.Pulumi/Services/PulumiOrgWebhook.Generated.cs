...
public class PulumiOrgWebhook
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiOrgWebhookOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiOrgWebhookListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> NewAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiOrgWebhookNewOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
