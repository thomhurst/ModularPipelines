...
public class PulumiInsightsAccountScan
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiInsightsAccountScanOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
