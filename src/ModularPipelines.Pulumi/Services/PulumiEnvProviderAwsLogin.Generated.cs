...
public class PulumiEnvProviderAwsLogin
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiEnvProviderAwsLoginOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
