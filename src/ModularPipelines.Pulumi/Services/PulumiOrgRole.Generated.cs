...
public class PulumiOrgRole
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiOrgRoleOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PulumiOrgRoleListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
