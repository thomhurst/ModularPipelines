...
public record BrewEditOptions : BrewOptions
{
    ...
    /// </summary>
    [CliOption("--print-path", Format = OptionFormat.EqualsSeparated)]
    public string? PrintPathValue { get; set; }
    ...
    [Obsolete("Use PrintPathValue instead.")]
    public bool? PrintPath
    {
        get => bool.TryParse(PrintPathValue, out var value) ? value : null;
        set => PrintPathValue = value?.ToString(global::System.Globalization.CultureInfo.InvariantCulture);
    }
