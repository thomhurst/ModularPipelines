...
) : BrewOptions
{
    ...
    /// <summary>
    /// Use generated bottle JSON files in the given
    /// </summary>
    [CliOption("--bottle-json-dir", Format = OptionFormat.EqualsSeparated)]
    public string? BottleJsonDir { get; set; }

    /// <summary>
    /// Remove database entries for formulae listed
    /// </summary>
    [CliFlag("--removed-formulae-file")]
    public bool? RemovedFormulaeFile { get; set; }

    /// <summary>
    /// Update entries for formula changes in the
    /// </summary>
