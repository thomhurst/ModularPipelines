...
public record BrewContributionsOptions : BrewOptions
{
    ...
    [Obsolete("Use Repositories instead.")]
    public string? RepositoriesValue
    {
        get => Repositories;
        set => Repositories = value;
    }

    [Obsolete("Use Organisation instead.")]
