...
public record BrewServicesRestartOptions(
    [property: CliArgument(0, Phase = CommandLinePhase.EarlyOperand, Required = true)] string Formula
) : BrewOptions
{
    /// <summary>
    ...
    public string? FileOperand { get; set; }
