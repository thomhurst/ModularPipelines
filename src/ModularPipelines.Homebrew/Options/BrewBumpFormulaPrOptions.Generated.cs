...
public record BrewBumpFormulaPrOptions : BrewOptions
{
    ...
    [Obsolete("Use PythonPackageName instead.")]
    public string? PythonPackageNameValue
    {
        get => PythonPackageName;
        set => PythonPackageName = value;
    }

    [Obsolete("Use PythonExtraPackages instead.")]
    public string? PythonExtraPackagesValue
    {
        get => PythonExtraPackages;
        set => PythonExtraPackages = value;
    }

    [Obsolete("Use PythonExcludePackages instead.")]
    public string? PythonExcludePackagesValue
    {
        get => PythonExcludePackages;
        set => PythonExcludePackages = value;
    }
