...
public record PodmanContainerRunOptions : PodmanOptions
{
    /// <summary>
    /// Run a command in a new container
    /// </summary>
    /// <param name="Image">The IMAGE operand.</param>
    public PodmanContainerRunOptions(
        string Image
    )
    {
    ...
    /// <summary>
    /// Pass a file descriptor into the container (default [])
    /// </summary>
    ...
    public PodmanContainerRunSystemd? Systemd { get; set; }
