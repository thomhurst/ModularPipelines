...
[CliSubCommand("farm", "build")]
public record PodmanFarmBuildOptions : PodmanOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Remove built images from farm nodes on success
    /// </summary>
    [CliFlag("--cleanup")]
    ...
    /// </summary>
    [CliOption("--farm", Format = OptionFormat.EqualsSeparated)]
