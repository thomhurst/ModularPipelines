...
public class GcloudContainerHubScopesRbacrolebindings
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerHubScopesRbacrolebindingsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerHubScopesRbacrolebindingsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
