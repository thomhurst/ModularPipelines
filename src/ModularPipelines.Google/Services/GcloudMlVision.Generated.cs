...
public class GcloudMlVision
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudMlVisionOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudMlVisionOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
