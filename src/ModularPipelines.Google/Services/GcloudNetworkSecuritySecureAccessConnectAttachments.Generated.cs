...
public class GcloudNetworkSecuritySecureAccessConnectAttachments
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudNetworkSecuritySecureAccessConnectAttachmentsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudNetworkSecuritySecureAccessConnectAttachmentsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudNetworkSecuritySecureAccessConnectAttachmentsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
