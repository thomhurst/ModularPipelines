...
public class GcloudEndpointsOperations
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudEndpointsOperationsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudEndpointsOperationsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
