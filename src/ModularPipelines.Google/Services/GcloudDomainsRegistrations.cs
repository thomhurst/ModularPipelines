...
public class GcloudDomainsRegistrations
{
    ...
    public virtual async Task<CommandResult> AuthorizationCode(
        GcloudDomainsRegistrationsAuthorizationCodeOptions options,
    ...
    public virtual async Task<CommandResult> Configure(
        GcloudDomainsRegistrationsConfigureOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> GoogleDomainsDns(
        GcloudDomainsRegistrationsGoogleDomainsDnsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Operations(
        GcloudDomainsRegistrationsOperationsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
