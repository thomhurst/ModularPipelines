...
public class GcloudComputeTargetSslProxies
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeTargetSslProxiesOptions(), executionOptions, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> TestIamPermissionsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeTargetSslProxiesTestIamPermissionsOptions(), executionOptions, cancellationToken);
    }
