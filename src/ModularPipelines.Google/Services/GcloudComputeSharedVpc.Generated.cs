...
public class GcloudComputeSharedVpc
{
    ...
    /// </summary>
    public GcloudComputeSharedVpc(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudComputeSharedVpcOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeSharedVpcOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
