...
public class GcloudComputeTpusTpuVm
{
    ...
    public virtual async Task<CommandResult> AcceleratorTypes(
        GcloudComputeTpusTpuVmAcceleratorTypesOptions options,
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> ServiceIdentity(
        GcloudComputeTpusTpuVmServiceIdentityOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Versions(
        GcloudComputeTpusTpuVmVersionsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
