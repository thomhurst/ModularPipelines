...
public class GcloudSqlSslClientCerts
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudSqlSslClientCertsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlSslClientCertsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlSslClientCertsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
