...
public class GcloudComputeNetworkFirewallPoliciesMirroringRules
{
    ...
    /// </summary>
    public GcloudComputeNetworkFirewallPoliciesMirroringRules(ICommandContext command)
    {
        _command = command;
    }
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeNetworkFirewallPoliciesMirroringRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
