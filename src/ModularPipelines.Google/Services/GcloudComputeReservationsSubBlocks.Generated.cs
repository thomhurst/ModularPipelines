...
public class GcloudComputeReservationsSubBlocks
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeReservationsSubBlocksOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
