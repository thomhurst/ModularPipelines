...
public class GcloudComputeNetworkEdgeSecurityServices
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeNetworkEdgeSecurityServicesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeNetworkEdgeSecurityServicesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
