...
public class GcloudComputeHealthChecksUpdate
{
    ...
    /// </summary>
    public GcloudComputeHealthChecksUpdate(ICommandContext command)
    {
        _command = command;
    }
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeHealthChecksUpdateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
