...
public class GcloudSccMuteconfigs
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSccMuteconfigsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSccMuteconfigsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
