...
public class GcloudComputeFirewallPoliciesRules
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeFirewallPoliciesRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
