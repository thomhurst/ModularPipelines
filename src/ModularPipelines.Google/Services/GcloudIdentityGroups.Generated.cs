...
public class GcloudIdentityGroups
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudIdentityGroupsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> SearchAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudIdentityGroupsSearchOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
