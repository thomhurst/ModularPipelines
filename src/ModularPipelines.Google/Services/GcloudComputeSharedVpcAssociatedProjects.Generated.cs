...
public class GcloudComputeSharedVpcAssociatedProjects
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeSharedVpcAssociatedProjectsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
