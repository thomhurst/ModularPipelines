...
public class GcloudAiPlatform
{
    ...
    public virtual async Task<CommandResult> Jobs(
        GcloudAiPlatformJobsOptions options,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> Local(
        GcloudAiPlatformLocalOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Models(
        GcloudAiPlatformModelsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Operations(
        GcloudAiPlatformOperationsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Versions(
        GcloudAiPlatformVersionsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
