...
public class GcloudAlloydbClusters
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAlloydbClustersOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAlloydbClustersListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
