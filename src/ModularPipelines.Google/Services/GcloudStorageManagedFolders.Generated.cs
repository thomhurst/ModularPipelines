...
public class GcloudStorageManagedFolders
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudStorageManagedFoldersOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
