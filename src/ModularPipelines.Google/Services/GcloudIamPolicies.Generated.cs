...
public class GcloudIamPolicies
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudIamPoliciesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudIamPoliciesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
