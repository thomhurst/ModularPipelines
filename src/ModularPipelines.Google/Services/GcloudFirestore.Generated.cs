...
public class GcloudFirestore : IGcloudFirestore
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudFirestoreOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> BulkDeleteAsync(
        GcloudFirestoreBulkDeleteOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudFirestoreBulkDeleteOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
