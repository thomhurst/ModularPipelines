...
public class GcloudVmwareNetworks
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudVmwareNetworksOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudVmwareNetworksListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
