...
public class GcloudComputeInstantSnapshots
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInstantSnapshotsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInstantSnapshotsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
