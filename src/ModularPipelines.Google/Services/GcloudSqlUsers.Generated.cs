...
public class GcloudSqlUsers
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlUsersOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlUsersListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
