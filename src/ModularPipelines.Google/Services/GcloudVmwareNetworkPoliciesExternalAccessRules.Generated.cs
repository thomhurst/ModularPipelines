...
public class GcloudVmwareNetworkPoliciesExternalAccessRules
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudVmwareNetworkPoliciesExternalAccessRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
