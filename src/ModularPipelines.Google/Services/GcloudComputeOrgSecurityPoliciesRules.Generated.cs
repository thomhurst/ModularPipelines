...
public class GcloudComputeOrgSecurityPoliciesRules
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeOrgSecurityPoliciesRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
