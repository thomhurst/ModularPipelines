...
public class GcloudTransferAgentPools
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudTransferAgentPoolsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudTransferAgentPoolsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
