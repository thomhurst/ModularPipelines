...
public class GcloudAlloydbOperations
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAlloydbOperationsOptions(), executionOptions, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAlloydbOperationsListOptions(), executionOptions, cancellationToken);
    }
