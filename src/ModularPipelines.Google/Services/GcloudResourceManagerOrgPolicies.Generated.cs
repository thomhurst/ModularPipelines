...
public class GcloudResourceManagerOrgPolicies
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudResourceManagerOrgPoliciesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudResourceManagerOrgPoliciesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
