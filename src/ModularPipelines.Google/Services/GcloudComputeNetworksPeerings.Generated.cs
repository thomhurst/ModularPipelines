...
public class GcloudComputeNetworksPeerings
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeNetworksPeeringsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeNetworksPeeringsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
