...
public class GcloudStorageBatchOperations
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudStorageBatchOperationsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
