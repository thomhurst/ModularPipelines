...
public class GcloudSpannerInstanceConfigs
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSpannerInstanceConfigsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSpannerInstanceConfigsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
