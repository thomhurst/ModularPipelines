...
public class GcloudContainerNodePools
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerNodePoolsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerNodePoolsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
