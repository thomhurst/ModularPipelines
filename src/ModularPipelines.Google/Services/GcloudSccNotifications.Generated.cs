...
public class GcloudSccNotifications
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSccNotificationsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSccNotificationsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
