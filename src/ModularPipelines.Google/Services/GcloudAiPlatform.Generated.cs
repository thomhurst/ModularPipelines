...
public class GcloudAiPlatform : IGcloudAiPlatform
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAiPlatformOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> PredictAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAiPlatformPredictOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
