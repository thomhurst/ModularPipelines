...
public class GcloudPrivateca : IGcloudPrivateca
{
    ...
    /// </summary>
    public GcloudPrivateca(ICommandContext command)
    {
        _command = command;
    }
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPrivatecaOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
