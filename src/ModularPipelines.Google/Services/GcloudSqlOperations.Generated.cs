...
public class GcloudSqlOperations
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlOperationsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlOperationsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
