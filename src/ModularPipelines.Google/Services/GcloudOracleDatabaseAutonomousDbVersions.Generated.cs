...
public class GcloudOracleDatabaseAutonomousDbVersions
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudOracleDatabaseAutonomousDbVersionsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
