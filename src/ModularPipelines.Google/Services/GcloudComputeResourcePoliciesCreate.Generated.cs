...
public class GcloudComputeResourcePoliciesCreate
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeResourcePoliciesCreateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
