...
public class GcloudEdgeCloudNetworking
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudEdgeCloudNetworkingOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
