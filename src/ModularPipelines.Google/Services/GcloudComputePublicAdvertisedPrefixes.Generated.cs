...
public class GcloudComputePublicAdvertisedPrefixes
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputePublicAdvertisedPrefixesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputePublicAdvertisedPrefixesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
