...
public class GcloudAiPlatformJobs
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAiPlatformJobsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAiPlatformJobsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
