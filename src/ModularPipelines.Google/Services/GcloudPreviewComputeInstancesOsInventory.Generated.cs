...
public class GcloudPreviewComputeInstancesOsInventory
{
    ...
    public virtual async Task<CommandResult> ListInstances(
        GcloudPreviewComputeInstancesOsInventoryListInstancesOptions options = default,
        CommandExecutionOptions executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new GcloudPreviewComputeInstancesOsInventoryListInstancesOptions(), executionOptions, cancellationToken);
    }
