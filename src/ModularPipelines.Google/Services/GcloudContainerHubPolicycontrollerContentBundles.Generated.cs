...
public class GcloudContainerHubPolicycontrollerContentBundles
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerHubPolicycontrollerContentBundlesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
