...
public class GcloudComputeOsConfigOsPolicyAssignmentsOperations
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeOsConfigOsPolicyAssignmentsOperationsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
