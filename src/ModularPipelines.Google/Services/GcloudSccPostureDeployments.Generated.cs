...
public class GcloudSccPostureDeployments
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSccPostureDeploymentsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
