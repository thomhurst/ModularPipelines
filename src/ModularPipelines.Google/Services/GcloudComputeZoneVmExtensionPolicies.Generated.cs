...
public class GcloudComputeZoneVmExtensionPolicies
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeZoneVmExtensionPoliciesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeZoneVmExtensionPoliciesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
