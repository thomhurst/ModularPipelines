...
public class GcloudSpannerSamples
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSpannerSamplesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSpannerSamplesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
