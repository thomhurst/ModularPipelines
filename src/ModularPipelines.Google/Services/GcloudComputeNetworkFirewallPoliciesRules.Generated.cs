...
public class GcloudComputeNetworkFirewallPoliciesRules
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudComputeNetworkFirewallPoliciesRulesOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeNetworkFirewallPoliciesRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
