...
public class GcloudSqlSslCerts
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudSqlSslCertsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlSslCertsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlSslCertsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
