...
public class GcloudOracledatabaseAutonomousDbVersions
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudOracleDatabaseAutonomousDbVersionsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudOracleDatabaseAutonomousDbVersionsOptions(), executionOptions, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudOracleDatabaseAutonomousDbVersionsListOptions(), executionOptions, cancellationToken);
    }
