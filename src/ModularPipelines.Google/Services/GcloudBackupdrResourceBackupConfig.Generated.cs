...
public class GcloudBackupdrResourceBackupConfig
{
    ...
    /// </summary>
    public GcloudBackupdrResourceBackupConfig(ICommand command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> List(
        GcloudBackupDrResourceBackupConfigListOptions options = default,
        CommandExecutionOptions executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new GcloudBackupDrResourceBackupConfigListOptions(), executionOptions, cancellationToken);
    }
