...
public class GcloudNetworkSecuritySecureAccessConnect
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudNetworkSecuritySecureAccessConnectOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
