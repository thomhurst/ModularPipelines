...
public class GcloudStorageBucketsAnywhereCaches
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudStorageBucketsAnywhereCachesOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudStorageBucketsAnywhereCachesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
