...
public class GcloudAssetSavedQueries
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAssetSavedQueriesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAssetSavedQueriesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
