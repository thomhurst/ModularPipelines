...
public class GcloudDatastore : IGcloudDatastore
{
    ...
    /// </summary>
    public GcloudDatastore(ICommandContext command)
    {
        _command = command;
    }
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDatastoreOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
