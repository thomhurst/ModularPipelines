...
public class GcloudComputeInterconnectsAttachmentsDedicated
{
    ...
    /// </summary>
    public GcloudComputeInterconnectsAttachmentsDedicated(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudComputeInterconnectsAttachmentsDedicatedOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInterconnectsAttachmentsDedicatedOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
