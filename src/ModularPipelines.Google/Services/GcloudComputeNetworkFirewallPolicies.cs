...
public class GcloudComputeNetworkFirewallPolicies
{
    ...
    public virtual async Task<CommandResult> Associations(
        GcloudComputeNetworkFirewallPoliciesAssociationsOptions options,
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> MirroringRules(
        GcloudComputeNetworkFirewallPoliciesMirroringRulesOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Rules(
        GcloudComputeNetworkFirewallPoliciesRulesOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
