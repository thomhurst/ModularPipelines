...
public class GcloudPolicyIntelligence
{
    ...
    public virtual async Task<CommandResult> Simulate(
        GcloudPolicyIntelligenceSimulateOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> TroubleshootPolicy(
        GcloudPolicyIntelligenceTroubleshootPolicyOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
