...
public class GcloudPreviewComputeReservationsSubBlocks
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPreviewComputeReservationsSubBlocksOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
