...
public class GcloudContainerHubPolicycontrollerDeployment
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudContainerHubPolicycontrollerDeploymentOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerHubPolicycontrollerDeploymentOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
