...
public class GcloudCloudlocationfinder : IGcloudCloudlocationfinder
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudCloudlocationfinderOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
