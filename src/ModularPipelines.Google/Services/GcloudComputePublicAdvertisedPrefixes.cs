...
public class GcloudComputePublicAdvertisedPrefixes
{
    ...
    public virtual async Task<CommandResult> List(
        GcloudComputePublicAdvertisedPrefixesListOptions? options = default,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new GcloudComputePublicAdvertisedPrefixesListOptions(), executionOptions, cancellationToken);
    }
