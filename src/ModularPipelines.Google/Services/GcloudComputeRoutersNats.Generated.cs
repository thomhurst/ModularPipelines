...
public class GcloudComputeRoutersNats
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeRoutersNatsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeRoutersNatsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
