...
public class GcloudAiPlatformJobsSubmit
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAiPlatformJobsSubmitOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
