...
public class GcloudResourceManagerCapabilities
{
    ...
    /// </summary>
    public GcloudResourceManagerCapabilities(ICommandContext command)
    {
        _command = command;
    }
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudResourceManagerCapabilitiesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
