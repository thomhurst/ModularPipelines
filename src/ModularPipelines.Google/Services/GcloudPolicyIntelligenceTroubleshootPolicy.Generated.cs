...
public class GcloudPolicyIntelligenceTroubleshootPolicy
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudPolicyIntelligenceTroubleshootPolicyOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPolicyIntelligenceTroubleshootPolicyOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
