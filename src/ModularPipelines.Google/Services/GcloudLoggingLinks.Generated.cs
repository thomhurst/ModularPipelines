...
public class GcloudLoggingLinks
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudLoggingLinksOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudLoggingLinksOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudLoggingLinksListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
