...
public class GcloudComputeSharedVpc
{
    ...
    public virtual async Task<CommandResult> AssociatedProjects(
        GcloudComputeSharedVpcAssociatedProjectsOptions options,
    ...
    public virtual async Task<CommandResult> Organizations(
        GcloudComputeSharedVpcOrganizationsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
