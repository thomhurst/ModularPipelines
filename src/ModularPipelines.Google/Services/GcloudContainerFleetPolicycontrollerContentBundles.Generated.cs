...
public class GcloudContainerFleetPolicycontrollerContentBundles
{
    ...
    /// </summary>
    public GcloudContainerFleetPolicycontrollerContentBundles(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudContainerFleetPolicycontrollerContentBundlesOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudContainerFleetPolicycontrollerContentBundlesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
