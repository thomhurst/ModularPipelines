...
public class GcloudComputeInstanceGroupsManagedRollingAction
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInstanceGroupsManagedRollingActionOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
