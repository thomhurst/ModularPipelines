...
public class GcloudComputeSslCertificates
{
    ...
    /// </summary>
    public GcloudComputeSslCertificates(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudComputeSslCertificatesOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeSslCertificatesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        GcloudComputeSslCertificatesListOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeSslCertificatesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
