...
public class GcloudComputeSslCertificates
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeSslCertificatesOptions(), executionOptions, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeSslCertificatesListOptions(), executionOptions, cancellationToken);
    }
