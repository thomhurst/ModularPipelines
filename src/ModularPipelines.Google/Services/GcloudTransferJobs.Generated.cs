...
public class GcloudTransferJobs
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudTransferJobsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudTransferJobsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
