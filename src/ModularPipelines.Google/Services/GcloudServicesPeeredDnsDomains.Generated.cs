...
public class GcloudServicesPeeredDnsDomains
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudServicesPeeredDnsDomainsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudServicesPeeredDnsDomainsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
