...
public class GcloudComputeInstanceGroupsManagedInstanceConfigs
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInstanceGroupsManagedInstanceConfigsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
