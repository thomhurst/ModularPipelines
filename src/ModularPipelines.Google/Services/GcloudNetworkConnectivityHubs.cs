...
public class GcloudNetworkConnectivityHubs
{
    ...
    public virtual async Task<CommandResult> Groups(
        GcloudNetworkConnectivityHubsGroupsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> RouteTables(
        GcloudNetworkConnectivityHubsRouteTablesOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
