...
public class GcloudPubsubSnapshots
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudPubsubSnapshotsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPubsubSnapshotsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPubsubSnapshotsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
