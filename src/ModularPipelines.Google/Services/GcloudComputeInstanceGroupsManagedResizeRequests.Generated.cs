...
public class GcloudComputeInstanceGroupsManagedResizeRequests
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInstanceGroupsManagedResizeRequestsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
