...
public interface IGcloudAccessContextManager
{
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public Task<CommandResult> LookupConfiguredPerimeterAsync(GcloudAccessContextManagerLookupConfiguredPerimeterOptions options, CommandExecutionOptions? executionOptions = null, CancellationToken cancellationToken = default)
        => throw new System.NotSupportedException();
