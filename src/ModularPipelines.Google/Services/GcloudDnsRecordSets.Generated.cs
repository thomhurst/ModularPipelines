...
public class GcloudDnsRecordSets
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDnsRecordSetsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDnsRecordSetsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
