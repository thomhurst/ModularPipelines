...
public class GcloudDomainsRegistrationsAuthorizationCode
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDomainsRegistrationsAuthorizationCodeOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
