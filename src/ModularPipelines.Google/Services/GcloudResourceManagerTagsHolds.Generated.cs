...
public class GcloudResourceManagerTagsHolds
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudResourceManagerTagsHoldsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
