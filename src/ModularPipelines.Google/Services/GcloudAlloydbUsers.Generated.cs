...
public class GcloudAlloydbUsers
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAlloydbUsersOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAlloydbUsersListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
