...
public class GcloudAlloydb
{
    ...
    public virtual async Task<CommandResult> Backups(
        GcloudAlloydbBackupsOptions options,
        CancellationToken cancellationToken = default)
    {
    ...
    public virtual async Task<CommandResult> Clusters(
        GcloudAlloydbClustersOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Instances(
        GcloudAlloydbInstancesOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Operations(
        GcloudAlloydbOperationsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Users(
        GcloudAlloydbUsersOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
