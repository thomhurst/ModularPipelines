...
public class GcloudBillingProjects
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudBillingProjectsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudBillingProjectsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
