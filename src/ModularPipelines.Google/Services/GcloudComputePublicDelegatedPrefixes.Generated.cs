...
public class GcloudComputePublicDelegatedPrefixes
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputePublicDelegatedPrefixesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputePublicDelegatedPrefixesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
