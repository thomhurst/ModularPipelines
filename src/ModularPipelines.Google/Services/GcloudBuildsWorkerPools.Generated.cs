...
public class GcloudBuildsWorkerPools
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudBuildsWorkerPoolsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudBuildsWorkerPoolsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
