...
public class GcloudPreviewComputeAdvice
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPreviewComputeAdviceOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
