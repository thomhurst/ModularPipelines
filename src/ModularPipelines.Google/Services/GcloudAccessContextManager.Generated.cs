...
public class GcloudAccessContextManager : IGcloudAccessContextManager
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudAccessContextManagerOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
