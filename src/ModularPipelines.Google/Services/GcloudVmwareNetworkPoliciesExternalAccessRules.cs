...
public class GcloudVmwareNetworkPoliciesExternalAccessRules
{
    ...
    public virtual async Task<CommandResult> List(
        GcloudVmwareNetworkPoliciesExternalAccessRulesListOptions? options = default,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new GcloudVmwareNetworkPoliciesExternalAccessRulesListOptions(), executionOptions, cancellationToken);
    }
