...
public class GcloudComputeHealthChecksCreate
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudComputeHealthChecksCreateOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeHealthChecksCreateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
