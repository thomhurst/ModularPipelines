...
public class GcloudDataflowJobs
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDataflowJobsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDataflowJobsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
