...
public class GcloudComputeInterconnectsAttachmentsL2Forwarding
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInterconnectsAttachmentsL2ForwardingOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
