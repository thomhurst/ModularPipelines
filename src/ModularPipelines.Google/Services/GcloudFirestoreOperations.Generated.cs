...
public class GcloudFirestoreOperations
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudFirestoreOperationsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudFirestoreOperationsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
