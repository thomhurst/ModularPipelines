...
public class GcloudDataflowFlexTemplate
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudDataflowFlexTemplateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
