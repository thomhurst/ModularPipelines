...
public class GcloudComputeForwardingRules
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeForwardingRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeForwardingRulesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
