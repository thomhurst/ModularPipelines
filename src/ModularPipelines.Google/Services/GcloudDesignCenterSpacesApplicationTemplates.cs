...
public class GcloudDesignCenterSpacesApplicationTemplates
{
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> Components(
        GcloudDesignCenterSpacesApplicationTemplatesComponentsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Revisions(
        GcloudDesignCenterSpacesApplicationTemplatesRevisionsOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
