...
public class GcloudVmwarePrivateCloudsHcxActivationkeys
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudVmwarePrivateCloudsHcxActivationkeysOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
