...
public class GcloudNetworkSecuritySecureAccessConnectRealms
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudNetworkSecuritySecureAccessConnectRealmsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudNetworkSecuritySecureAccessConnectRealmsListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
