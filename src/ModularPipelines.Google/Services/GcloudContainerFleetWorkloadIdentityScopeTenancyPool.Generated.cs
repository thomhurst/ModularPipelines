...
public class GcloudContainerFleetWorkloadIdentityScopeTenancyPool
{
    ...
    /// </summary>
    public GcloudContainerFleetWorkloadIdentityScopeTenancyPool(ICommand command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> Set(
        GcloudContainerFleetWorkloadIdentityScopeTenancyPoolSetOptions options = default,
    ...
    public virtual async Task<CommandResult> Unset(
        GcloudContainerFleetWorkloadIdentityScopeTenancyPoolUnsetOptions options = default,
        CommandExecutionOptions executionOptions = null,
        CancellationToken cancellationToken = default)
    {
