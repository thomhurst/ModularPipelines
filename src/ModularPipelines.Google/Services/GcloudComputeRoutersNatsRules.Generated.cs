...
public class GcloudComputeRoutersNatsRules
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeRoutersNatsRulesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeRoutersNatsRulesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
