...
public class GcloudSqlDatabases
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlDatabasesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudSqlDatabasesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
