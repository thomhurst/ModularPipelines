...
public class GcloudComputeInstancesNetworkInterfaces
{
    ...
    public virtual async Task<CommandResult> ExecuteAsync(
        GcloudComputeInstancesNetworkInterfacesOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeInstancesNetworkInterfacesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
