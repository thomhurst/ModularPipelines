...
public class GcloudBmsSshKeys
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudBmsSshKeysOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudBmsSshKeysListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
