...
public class GcloudPreviewComputeSslPolicies
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPreviewComputeSslPoliciesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAvailableFeaturesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPreviewComputeSslPoliciesListAvailableFeaturesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudPreviewComputeSslPoliciesListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
