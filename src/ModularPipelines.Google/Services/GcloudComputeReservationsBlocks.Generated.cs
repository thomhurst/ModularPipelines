...
public class GcloudComputeReservationsBlocks
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GcloudComputeReservationsBlocksOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
