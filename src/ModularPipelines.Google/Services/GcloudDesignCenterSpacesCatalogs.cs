...
public class GcloudDesignCenterSpacesCatalogs
{
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> Shares(
        GcloudDesignCenterSpacesCatalogsSharesOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Templates(
        GcloudDesignCenterSpacesCatalogsTemplatesOptions options,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options, cancellationToken);
    }
