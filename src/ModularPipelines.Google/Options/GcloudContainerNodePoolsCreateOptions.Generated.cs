...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Whether to respect PDBs when deleting nodes in the node pool.    Specifies the reservation for the node pool.
    /// </summary>
    ...
    /// <summary>
    /// The type of the reservation for the node pool. RESERVATION_AFFINITY     must be one of: any, none, specific, any-reservation-then-fail.    Options to specify the node identity.    Scopes options.
    /// </summary>
