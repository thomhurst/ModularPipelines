...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. The cluster to add the node pool to. Overrides the default container/cluster property value for this command invocation.
    /// </summary>
    [CliOption("--cluster", Format = OptionFormat.EqualsSeparated)]
    public string? Cluster { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enable confidential nodes for the node pool. Enabling Confidential Nodes will create nodes using Confidential VM https://docs.cloud.google.com/compute/docs/about-confidential-vm. CONFIDENTIAL_NODE_TYPE must be one of: sev, sev_snp, tdx, disabled.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Set the duration after which the Cluster Autoscaler can scale down underutilized nodes. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --consolidation-delay=3600s
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Specifies the number of local SSDs to be utilized for GKE Data Cache in the node pool.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enables Cluster Autoscaler to treat the node pool as if it was autoprovisioned. Cluster Autoscaler will be able to delete the node pool if it's unneeded.
    /// </summary>
    [CliFlag("--enable-autoprovisioning")]
    public bool? EnableAutoprovisioning { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enable node autorepair feature for a node pool. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --enable-autorepair Node autorepair is enabled by default for node pools using COS, COS_CONTAINERD, UBUNTU or UBUNTU_CONTAINERD as a base image, use --no-enable-autorepair to disable. See https://cloud.google.com/kubernetes-engine/docs/how-to/node-auto-repair for more info.
    /// </summary>
    [CliFlag("--enable-autorepair")]
    public bool? EnableAutorepair { get; set; }

    /// <summary>
    /// Negates --enable-autorepair. Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enable node autorepair feature for a node pool. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --enable-autorepair Node autorepair is enabled by default for node pools using COS, COS_CONTAINERD, UBUNTU or UBUNTU_CONTAINERD as a base image, use --no-enable-autorepair to disable. See https://cloud.google.com/kubernetes-engine/docs/how-to/node-auto-repair for more info.
    /// </summary>
    [CliFlag("--no-enable-autorepair")]
    public bool? NoEnableAutorepair { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Sets autoupgrade feature for a node pool. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --enable-autoupgrade See https://cloud.google.com/kubernetes-engine/docs/node-auto-upgrades for more info. Enabled by default, use --no-enable-autoupgrade to disable.
    /// </summary>
    [CliFlag("--enable-autoupgrade")]
    public bool? EnableAutoupgrade { get; set; }

    /// <summary>
    /// Negates --enable-autoupgrade. Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Sets autoupgrade feature for a node pool. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --enable-autoupgrade See https://cloud.google.com/kubernetes-engine/docs/node-auto-upgrades for more info. Enabled by default, use --no-enable-autoupgrade to disable.
    /// </summary>
    [CliFlag("--no-enable-autoupgrade")]
    public bool? NoEnableAutoupgrade { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Changes node pool upgrade strategy to blue-green upgrade.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enable confidential storage for the node pool. Enabling Confidential Storage will create boot disk with confidential mode
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-insecure-kubelet-readonly-port. Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enables the Kubelet's insecure read only port. To disable the readonly port on a cluster or node-pool set the flag to --no-enable-insecure-kubelet-readonly-port.
    /// </summary>
    [CliFlag("--no-enable-insecure-kubelet-readonly-port")]
    public bool? NoEnableInsecureKubeletReadonlyPort { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enforces that kernel modules are signed on all nodes in the node pool. This setting overrides the cluster-level setting. For example, if the cluster disables enforcement, you can enable enforcement only for a specific node pool. When the policy is modified on an existing node pool, nodes will be immediately recreated to use the new policy. Use --no-enable-kernel-module-signature-enforcement to disable. Examples: $ gcloud container node-pools create node-pool-1 \ --enable-kernel-module-signature-enforcement
    /// </summary>
    [CliFlag("--enable-kernel-module-signature-enforcement")]
    public bool? EnableKernelModuleSignatureEnforcement { get; set; }

    /// <summary>
    /// Negates --enable-kernel-module-signature-enforcement. Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enforces that kernel modules are signed on all nodes in the node pool. This setting overrides the cluster-level setting. For example, if the cluster disables enforcement, you can enable enforcement only for a specific node pool. When the policy is modified on an existing node pool, nodes will be immediately recreated to use the new policy. Use --no-enable-kernel-module-signature-enforcement to disable. Examples: $ gcloud container node-pools create node-pool-1 \ --enable-kernel-module-signature-enforcement
    /// </summary>
    [CliFlag("--no-enable-kernel-module-signature-enforcement")]
    public bool? NoEnableKernelModuleSignatureEnforcement { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enables the use of nested virtualization on the node pool. Defaults to false. Can only be enabled on UBUNTU_CONTAINERD base image or COS_CONTAINERD base image with version 1.28.4-gke.1083000 and above.
    /// </summary>
    [CliFlag("--enable-nested-virtualization")]
    public bool? EnableNestedVirtualization { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enables provisioning nodes with private IP addresses only. The control plane still communicates with all nodes through private IP addresses only, regardless of whether private nodes are enabled or disabled.
    /// </summary>
    [CliFlag("--enable-private-nodes")]
    public bool? EnablePrivateNodes { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Mark the nodepool as Queued only. This means that all new nodes can be obtained only through queuing via ProvisioningRequest API. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --enable-queued-provisioning ... and other required parameters, for more details see: https://cloud.google.com/kubernetes-engine/docs/how-to/provisioningrequest
    /// </summary>
    [CliFlag("--enable-queued-provisioning")]
    public bool? EnableQueuedProvisioning { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Changes node pool upgrade strategy to surge upgrade.
    /// </summary>
    [CliFlag("--enable-surge-upgrade")]
    public bool? EnableSurgeUpgrade { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Start the node pool with Flex Start provisioning model. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --flex-start and other required parameters, for more details see: https://cloud.google.com/kubernetes-engine/docs/how-to/provisioningrequest
    /// </summary>
    [CliFlag("--flex-start")]
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. The image type to use for the node pool. Defaults to server-specified. Image Type specifies the base OS that the nodes in the node pool will run on. If an image type is specified, that will be assigned to the node pool and all future upgrades will use the specified image type. If it is not specified the server will pick the default image type. The default image type and the list of valid image types are available using the following command. $ gcloud container get-server-config
    /// </summary>
    [CliOption("--image-type", Format = OptionFormat.EqualsSeparated)]
    public string? ImageType { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Labels to apply to the Google Cloud resources of node pools in the Kubernetes Engine cluster. These are unrelated to Kubernetes labels. Warning: Updating this label will causes the node(s) to be recreated. Examples: $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --labels=label1=value1,label2=value2
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. When specified, the nodes for the new node pool will be scheduled on host with specified CPU architecture or a newer one. Examples: $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --min-cpu-platform=PLATFORM To list available CPU platforms in given zone, run: $ gcloud beta compute zones describe ZONE \ --format="value(availableCpuPlatforms)" CPU platform selection is available only in selected zones.
    /// </summary>
    [CliOption("--min-cpu-platform", Format = OptionFormat.EqualsSeparated)]
    public string? MinCpuPlatform { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Configures network performance settings for the node pool. If this flag is not specified, the pool will be created with its default network performance configuration. total-egress-bandwidth-tier Total egress bandwidth is the available outbound bandwidth from a VM, regardless of whether the traffic is going to internal IP or external IP destinations. The following tier values are allowed: [TIER_UNSPECIFIED,TIER_1]
    /// </summary>
    [CliOption("--network-performance-configs", Format = OptionFormat.EqualsSeparated)]
    public string? NetworkPerformanceConfigs { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Control how architecture taint should be applied to nodes in a new node pool. Supported values: * unspecified: Default behavior, currently the same as `arm`. * arm: kubernetes.io/arch=arm:NoSchedule taint will be added for ARM nodes. * none: No architecture taint will be applied. Examples: $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster \ --node-architecture-taint-behavior=none To read more about node-taints, see https://cloud.google.com/kubernetes-engine/docs/node-taints. NODE_ARCHITECTURE_TAINT_BEHAVIOR must be one of: unspecified, arm, none.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. The set of zones in which the node pool's nodes should be located. Multiple locations can be specified, separated by commas. For example: $ gcloud container node-pools create node-pool-1 \ --cluster=sample-cluster \ --node-locations=us-central1-a,us-central1-b Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Time in seconds to be spent waiting during blue-green upgrade before deleting the blue pool and completing the upgrade. $ gcloud container node-pools create example-cluster \ --node-pool-soak-duration=600s
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enables the requested sandbox on all nodes in the node pool. Examples: $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --sandbox="type=gvisor" The only supported type is 'gvisor'.
    /// </summary>
    [CliOption("--sandbox", Format = OptionFormat.EqualsSeparated)]
    public string? Sandbox { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Attaches secondary boot disks to all nodes in the node pool. Secondary Boot Disks (SBD) can accelerate container startup times by preloading container images or data onto disks attached to the nodes. Learn more about Using Secondary Boot Disks (https://cloud.google.com/kubernetes-engine/docs/how-to/data-container-image-preloading) for full requirements (including version, API enablement and source disk images). The value for this flag is a list of key=value pairs. Available keys are: disk-image (Required) The full resource path to the source disk image to create the secondary boot disks from (e.g., projects/my-project/global/images/my-disk-image). mode (Optional) The mode of the secondary boot disk. Supported values are: ▸ CONTAINER_IMAGE_CACHE: The disk is used to cache container images. This is the default if not specified. ▸ DATA: The disk is used to preload arbitrary data, accessible via hostPath volume mounts.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Create nodes using spot VM instances in the new node pool. $ gcloud container node-pools create node-pool-1 \ --cluster=example-cluster --spot New nodes, including ones created by resize or recreate, will use spot VM instances.
    /// </summary>
    [CliFlag("--spot")]
    public bool? Spot { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Standard rollout policy options for blue-green upgrade. Batch sizes are specified by one of, batch-node-count or batch-percent. The duration between batches is specified by batch-soak-duration. $ gcloud container node-pools create example-cluster \ --standard-rollout-policy=batch-node-count=3,\ batch-soak-duration=60s $ gcloud container node-pools create example-cluster \ --standard-rollout-policy=batch-percent=0.3,\ batch-soak-duration=60s
    /// </summary>
    [CliOption("--standard-rollout-policy", Format = OptionFormat.EqualsSeparated)]
    public string? StandardRolloutPolicy { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. A list of storage pools where the node pool's boot disks will be provisioned. STORAGE_POOL must be in the format projects/project/zones/zone/storagePools/storagePool Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Enable best effort provision for nodes
    /// </summary>
    [CliFlag("--enable-best-effort-provision")]
    public bool? EnableBestEffortProvision { get; set; }

    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Specifies the minimum number of nodes to be provisioned during creation
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. The grace period in seconds for nodes to drain before being forcefully removed.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. The timeout in seconds for the node pool to be drained.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. Whether to respect PDBs when deleting nodes in the node pool.
    /// </summary>
    ...
    /// <summary>
    /// Node pool maintenance exclusions Cluster autoscaling Specifies minimum number of nodes to be created when best effort provisioning enabled. Node drain settings Specifies the reservation for the node pool. Options to specify the node identity. Scopes options. The type of the reservation for the node pool. RESERVATION_AFFINITY must be one of: any, none, specific, any-reservation-then-fail.
    /// </summary>
