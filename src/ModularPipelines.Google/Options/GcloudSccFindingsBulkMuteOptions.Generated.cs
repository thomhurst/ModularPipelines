...
public record GcloudSccFindingsBulkMuteOptions(
    [property: CliOption("--filter", Format = OptionFormat.EqualsSeparated)] string Filter
) : GcloudOptions, IValidatableObject
{
    ...
    public GcloudMuteState? MuteState { get; set; }
