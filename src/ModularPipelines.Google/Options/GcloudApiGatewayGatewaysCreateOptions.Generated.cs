...
public record GcloudApiGatewayGatewaysCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Creates the gateway with response streaming enabled, which supports server-sent events, HTTP chunked transfer, WebSockets, and gRPC/HTTP2 bidirectional streaming. This can only be set when the gateway is created and cannot be changed afterwards. When omitted, API Gateway selects the streaming mode.
    /// </summary>
