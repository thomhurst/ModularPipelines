...
public record GcloudNetworkManagementNetworkMonitoringProvidersGenerateProviderAccessTokenOptions : GcloudOptions
{
    ...
    public GcloudNetworkManagementNetworkMonitoringProvidersGenerateProviderAccessTokenOptions(
        string GcpAccessToken,
        string NetworkMonitoringProvider
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(GcpAccessToken);
    ...
    public void Deconstruct(out string GcpAccessToken, out string NetworkMonitoringProvider)
    {
        GcpAccessToken = this.GcpAccessToken;
    ...
    /// </summary>
    [SecretValue]
    [CliOption("--gcp-access-token", Format = OptionFormat.EqualsSeparated)]
    public string GcpAccessToken { get; private init; }
