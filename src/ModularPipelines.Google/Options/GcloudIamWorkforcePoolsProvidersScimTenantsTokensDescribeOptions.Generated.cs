...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/scim-tenants/tokens/describe
...
[CliSubCommand("iam", "workforce-pools", "providers", "scim-tenants", "tokens", "describe")]
public record GcloudIamWorkforcePoolsProvidersScimTenantsTokensDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe an IAM workforce identity pool provider SCIM tenant token
    /// </summary>
    /// <param name="Token">Workforce pool provider scim token resource - The SCIM token to describe. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the workforce pool provider scim token or fully qualified identifier for the workforce pool provider scim token. To set the token attribute: ▸ provide the argument token on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamWorkforcePoolsProvidersScimTenantsTokensDescribeOptions(
        string Token
    )
    {
