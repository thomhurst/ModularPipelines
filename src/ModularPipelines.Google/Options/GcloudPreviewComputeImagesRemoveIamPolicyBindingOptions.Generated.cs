...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/images/remove-iam-policy-binding
...
[CliSubCommand("preview", "compute", "images", "remove-iam-policy-binding")]
public record GcloudPreviewComputeImagesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding from a Compute Engine image
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Image)
    {
        Member = this.Member;
        Role = this.Role;
        Image = this.Image;
    ...
    /// <summary>
    /// Image resource - The image for which to remove IAM policy binding from. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument image on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the image or fully qualified identifier for the image. To set the image attribute: ▸ provide the argument image on the command line.
    /// </summary>
