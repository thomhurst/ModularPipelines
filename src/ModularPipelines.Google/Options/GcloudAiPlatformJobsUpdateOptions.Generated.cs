...
public record GcloudAiPlatformJobsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update an AI Platform job
    /// </summary>
    /// <param name="Job">Name of the job.</param>
    public GcloudAiPlatformJobsUpdateOptions(
        string Job
    )
    {
