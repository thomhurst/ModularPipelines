...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/instances/send-diagnostic-interrupt
...
[CliSubCommand("compute", "instances", "send-diagnostic-interrupt")]
public record GcloudComputeInstancesSendDiagnosticInterruptOptions : GcloudOptions
{
    /// <summary>
    /// send a diagnostic     interrupt to a virtual machine instance
    /// </summary>
    ...
    public GcloudComputeInstancesSendDiagnosticInterruptOptions(
        string InstanceName
    )
    {
