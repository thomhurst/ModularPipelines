...
public record GcloudPreviewComputeOrgSecurityPoliciesRulesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a     Compute Engine organizationsecurity policy rule
    /// </summary>
    ...
    /// <param name="Priority">Priority of the security policy rule to create.</param>
    public GcloudPreviewComputeOrgSecurityPoliciesRulesCreateOptions(
        string Action,
    ...
    public void Deconstruct(out string Action, out string SecurityPolicy, out string Priority)
    {
        Action = this.Action;
    ...
    public GcloudPreviewComputeOrgSecurityPoliciesRulesCreateDirection? Direction { get; set; }
