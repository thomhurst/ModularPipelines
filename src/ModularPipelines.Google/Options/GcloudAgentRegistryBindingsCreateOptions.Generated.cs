...
public record GcloudAgentRegistryBindingsCreateOptions(
    [property: CliOption("--source-identifier", Format = OptionFormat.EqualsSeparated)] string SourceIdentifier,
    [property: CliOption("--target-identifier", Format = OptionFormat.EqualsSeparated)] string TargetIdentifier
) : GcloudOptions
{
    /// <summary>
