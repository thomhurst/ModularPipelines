...
public record GcloudComputeNetworkEndpointGroupsDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe a Compute Engine     network endpoint group
    /// </summary>
    /// <param name="Name">Name of the network endpoint group to operate on.</param>
    public GcloudComputeNetworkEndpointGroupsDescribeOptions(
        string Name
    )
    {
