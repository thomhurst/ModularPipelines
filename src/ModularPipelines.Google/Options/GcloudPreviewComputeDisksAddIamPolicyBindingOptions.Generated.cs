...
public record GcloudPreviewComputeDisksAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding to a Compute Engine disk
    /// </summary>
