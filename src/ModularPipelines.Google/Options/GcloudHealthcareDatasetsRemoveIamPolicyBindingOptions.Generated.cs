...
public record GcloudHealthcareDatasetsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM policy     binding to a Cloud Healthcare API dataset
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string DataSet)
    {
        Member = this.Member;
        Role = this.Role;
