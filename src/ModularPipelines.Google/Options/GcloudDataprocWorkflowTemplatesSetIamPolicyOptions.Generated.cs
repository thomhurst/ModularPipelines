...
public record GcloudDataprocWorkflowTemplatesSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudDataprocWorkflowTemplatesSetIamPolicyOptions(
        string Template,
        string PolicyFile
    )
    {
    ...
    public void Deconstruct(out string Template, out string PolicyFile)
    {
