...
public record GcloudComputeInstanceGroupsManagedResizeRequestsListOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list Compute     Engine managed instance group resize requests
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedResizeRequestsListOptions(
        string Name
    )
    {
