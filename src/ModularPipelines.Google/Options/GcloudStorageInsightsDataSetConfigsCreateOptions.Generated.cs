...
/// <param name="DataSetConfigName"></param>
...
public record GcloudStorageInsightsDataSetConfigsCreateOptions(
    ...
    [property: CliOption("--organization", Format = OptionFormat.EqualsSeparated)] int Organization,
    [property: CliOption("--retention-period-days", Format = OptionFormat.EqualsSeparated)] string RetentionPeriodDays,
