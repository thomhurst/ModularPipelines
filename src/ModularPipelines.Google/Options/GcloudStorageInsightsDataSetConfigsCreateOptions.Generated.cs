...
public record GcloudStorageInsightsDataSetConfigsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("Exactly one of EnableOrganizationScope, (SourceFolders or SourceFoldersFile), or (SourceProjects or SourceProjectsFile) must be specified.", [nameof(EnableOrganizationScope), nameof(SourceFolders), nameof(SourceFoldersFile), nameof(SourceProjects), nameof(SourceProjectsFile)]);
        }
