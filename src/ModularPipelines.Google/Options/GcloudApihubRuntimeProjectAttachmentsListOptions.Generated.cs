...
// Source: https://cloud.google.com/sdk/gcloud/reference/apihub/runtime-project-attachments/list
...
[CliSubCommand("apihub", "runtime-project-attachments", "list")]
public record GcloudApihubRuntimeProjectAttachmentsListOptions : GcloudOptions
{
    /// <summary>
    /// list Runtime Project     Attachments
    /// </summary>
    ...
    public GcloudApihubRuntimeProjectAttachmentsListOptions(
        string Location
    )
    {
    ...
    /// <summary>
    /// Location resource - The parent, which owns this collection of runtime project attachments. Format: projects/{project}/locations/{location} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --location on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the location or fully qualified identifier for the location. To set the location attribute: ▸ provide the argument --location on the command line.
    /// </summary>
