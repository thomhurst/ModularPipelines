...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/instances/set-machine-resources
...
[CliSubCommand("compute", "instances", "set-machine-resources")]
public record GcloudComputeInstancesSetMachineResourcesOptions : GcloudOptions
{
    /// <summary>
    /// set machine resources for     a Compute Engine virtual machine instance
    /// </summary>
    ...
    public GcloudComputeInstancesSetMachineResourcesOptions(
        string InstanceName
    )
    {
