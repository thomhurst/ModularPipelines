...
public record GcloudAssetSavedQueriesDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete a Cloud Asset Inventory saved     query
    /// </summary>
    /// <param name="QueryId">Asset saved query identifier to be deleted. It must be unique under the specified parent resource project/folder/organization.</param>
