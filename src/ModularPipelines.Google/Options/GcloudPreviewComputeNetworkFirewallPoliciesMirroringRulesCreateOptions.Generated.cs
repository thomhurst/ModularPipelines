...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/network-firewall-policies/mirroring-rules/create
...
public record GcloudPreviewComputeNetworkFirewallPoliciesMirroringRulesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesMirroringRulesCreateOptions(
        GcloudPreviewComputeNetworkFirewallPoliciesMirroringRulesCreateAction Action,
    ...
    public void Deconstruct(out GcloudPreviewComputeNetworkFirewallPoliciesMirroringRulesCreateAction Action, out string FirewallPolicy, out IEnumerable<string> Layer4Configs, out string Priority)
    {
        Action = this.Action;
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesMirroringRulesCreateAction Action { get; private init; }
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesMirroringRulesCreateDirection? Direction { get; set; }
