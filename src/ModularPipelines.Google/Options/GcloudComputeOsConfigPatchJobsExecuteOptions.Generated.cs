...
public record GcloudComputeOsConfigPatchJobsExecuteOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: List of Apt packages to exclude from update. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: An exclusive list of packages to be updated. These are the only packages that will be updated. If these packages are not installed, they will be ignored. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Disruption budget for this rollout. A running VM with an active agent is considered disrupted if its patching operation fails anytime between the time the agent is notified until the patch process completes. At most one of these can be specified: Number of VMs per zone to disrupt at any given moment.
    /// </summary>
    [CliOption("--rollout-disruption-budget", Format = OptionFormat.EqualsSeparated)]
    public string? RolloutDisruptionBudget { get; set; }

    /// <summary>
    /// Disruption budget for this rollout. A running VM with an active agent is considered disrupted if its patching operation fails anytime between the time the agent is notified until the patch process completes. At most one of these can be specified: Percentage of VMs per zone to disrupt at any given moment. The number of VMs calculated from multiplying the percentage by the total number of VMs in a zone is rounded up.
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Windows: At most one of these can be specified: An exclusive list of Knowledge Base (KB) IDs to be updated. These are the only patches that will be updated. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Windows: At most one of these can be specified: Or at least one of these can be specified: Windows patch options List of classifications to use to restrict the Windows update. Only patches of the given classifications are applied. If omitted, a default Windows update is performed. For more information on classifications, see: https://support.microsoft.com/en-us/help/824684. WINDOWS_CLASSIFICATIONS must be one of: critical, security, definition, driver, feature-pack, service-pack, tool, update-rollup, update.
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Windows: At most one of these can be specified: Or at least one of these can be specified: Windows patch options Optional list of Knowledge Base (KB) IDs to exclude from the update operation. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Yum: At most one of these can be specified: An exclusive list of packages to be updated. These are the only packages that will be updated. If these packages are not installed, they will be ignored. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Yum: At most one of these can be specified: Or at least one of these can be specified: Yum patch options Optional list of packages to exclude from updating. If this argument is specified, machines running Yum exclude the given list of packages using the Yum --exclude flag. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Yum: At most one of these can be specified: Or at least one of these can be specified: Yum patch options If specified, machines running Yum use the command yum update-minimal; otherwise the patch uses yum-update.
    /// </summary>
    [CliFlag("--yum-minimal")]
    public bool? YumMinimal { get; set; }

    /// <summary>
    /// Settings for machines running Yum: At most one of these can be specified: Or at least one of these can be specified: Yum patch options If specified, machines running Yum append the --security flag to the patch command.
    /// </summary>
    [CliFlag("--yum-security")]
    public bool? YumSecurity { get; set; }

    /// <summary>
    /// Settings for machines running Zypper: At most one of these can be specified: An exclusive list of patches to be updated. These are the only patches that will be installed using the 'zypper patch patch:&lt;patch_name&gt;' command. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Zypper: At most one of these can be specified: Or at least one of these can be specified: Zypper patch options If specified, machines running Zypper install only patches with the specified categories. Categories include security, recommended, and feature. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Zypper: At most one of these can be specified: Or at least one of these can be specified: Zypper patch options List of Zypper patches to exclude from the patch job. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Zypper: At most one of these can be specified: Or at least one of these can be specified: Zypper patch options If specified, machines running Zypper install only patch with the specified severities. Severities include critical, important, moderate, and low. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Settings for machines running Zypper: At most one of these can be specified: Or at least one of these can be specified: Zypper patch options If specified, machines running Zypper add the --with-optional flag to zypper patch.
    /// </summary>
    [CliFlag("--zypper-with-optional")]
    public bool? ZypperWithOptional { get; set; }

    /// <summary>
    /// Settings for machines running Zypper: At most one of these can be specified: Or at least one of these can be specified: Zypper patch options If specified, machines running Zypper add the --with-update flag to zypper patch.
    /// </summary>
