...
[CommandPrecedingArguments("container", "binauthz", "attestors", "remove-iam-policy-binding")]
public record GcloudContainerBinauthzAttestorsRemoveIamPolicyBindingOptions(
