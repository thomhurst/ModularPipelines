...
public record GcloudHealthcareHl7v2StoresRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Cloud Healthcare API HL7v2 store
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Hl7V2Store)
    {
        Member = this.Member;
        Role = this.Role;
