...
public record GcloudPreviewComputeInstanceGroupsManagedRollingActionStopProactiveUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// action     stop-proactive-update - stop the proactive update process of managed     instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedRollingActionStopProactiveUpdateOptions(
        string Name
    )
    {
