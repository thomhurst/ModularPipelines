...
[CliSubCommand("compute", "machine-types", "describe")]
public record GcloudComputeMachineTypesDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a Compute Engine machine     type
    /// </summary>
    /// <param name="Name">Name of the machine type to describe.</param>
    public GcloudComputeMachineTypesDescribeOptions(
        string Name
    )
    {
