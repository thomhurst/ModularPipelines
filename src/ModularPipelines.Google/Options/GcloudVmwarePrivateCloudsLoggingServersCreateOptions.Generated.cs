...
public record GcloudVmwarePrivateCloudsLoggingServersCreateOptions : GcloudOptions
{
    ...
    public GcloudVmwarePrivateCloudsLoggingServersCreateOptions(
        string Hostname,
        string Port,
        GcloudProtocol Protocol,
        GcloudSourceType SourceType,
    ...
    public void Deconstruct(out string Hostname, out string Port, out GcloudProtocol Protocol, out GcloudSourceType SourceType, out string LoggingServer)
    {
    ...
    public GcloudProtocol Protocol { get; private init; }
    ...
    public GcloudSourceType SourceType { get; private init; }
