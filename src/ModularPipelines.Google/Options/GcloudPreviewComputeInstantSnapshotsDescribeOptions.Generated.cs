...
public record GcloudPreviewComputeInstantSnapshotsDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe a Compute     Engine instant snapshot
    /// </summary>
    /// <param name="InstantSnapshotName">Name of the instant snapshot to describe.</param>
    public GcloudPreviewComputeInstantSnapshotsDescribeOptions(
    ...
    /// <summary>
    /// At most one of these can be specified: Zone of the instant snapshot to describe. If not specified and the compute/zone property isn't set, you might be prompted to select a zone (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/zone property: $ gcloud config set compute/zone ZONE A list of zones can be fetched by running: $ gcloud compute zones list To unset the property, run: $ gcloud config unset compute/zone Alternatively, the zone can be stored in the environment variable CLOUDSDK_COMPUTE_ZONE.
    /// </summary>
