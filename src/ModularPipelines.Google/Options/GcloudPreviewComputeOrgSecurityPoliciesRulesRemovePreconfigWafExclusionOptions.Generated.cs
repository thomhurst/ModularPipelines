...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/org-security-policies/rules/remove-preconfig-waf-exclusion
...
[CliSubCommand("preview", "compute", "org-security-policies", "rules", "remove-preconfig-waf-exclusion")]
public record GcloudPreviewComputeOrgSecurityPoliciesRulesRemovePreconfigWafExclusionOptions : GcloudOptions
{
    /// <summary>
    /// policies rules     remove-preconfig-waf-exclusion - remove an exclusion configuration for     preconfigured WAF evaluation from a security policy rule
    /// </summary>
    ...
    /// <param name="Priority">Priority of the security policy rule to remove preconfig WAF exclusion.</param>
    public GcloudPreviewComputeOrgSecurityPoliciesRulesRemovePreconfigWafExclusionOptions(
