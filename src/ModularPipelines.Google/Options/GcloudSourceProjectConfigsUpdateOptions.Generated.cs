...
public record GcloudSourceProjectConfigsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((DisablePushblock == true || EnablePushblock == true || (object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && ((object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && ((object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && (((!string.IsNullOrWhiteSpace(AddTopic)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(RemoveTopic)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(UpdateTopic)) ? 1 : 0) > 1))
        {
