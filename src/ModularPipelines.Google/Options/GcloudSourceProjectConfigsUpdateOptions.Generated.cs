...
public record GcloudSourceProjectConfigsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    ...
    public GcloudSourceProjectConfigsUpdateMessageFormat? MessageFormat { get; set; }
    ...
    {
        if ((DisablePushblock == true ? 1 : 0) + (EnablePushblock == true ? 1 : 0) + (((object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) ? 1 : 0) != 1)
        {
            yield return new ValidationResult("Exactly one of DisablePushblock, EnablePushblock, or (MessageFormat, ServiceAccount, TopicProject, AddTopic, RemoveTopic, or UpdateTopic) must be specified.", [nameof(DisablePushblock), nameof(EnablePushblock), nameof(MessageFormat), nameof(ServiceAccount), nameof(TopicProject), nameof(AddTopic), nameof(RemoveTopic), nameof(UpdateTopic)]);
        }
        if ((DisablePushblock == true || EnablePushblock == true || (object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && ((object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && ((object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && ((object?)MessageFormat is not null || !string.IsNullOrWhiteSpace(ServiceAccount) || !string.IsNullOrWhiteSpace(TopicProject) || !string.IsNullOrWhiteSpace(AddTopic) || !string.IsNullOrWhiteSpace(RemoveTopic) || !string.IsNullOrWhiteSpace(UpdateTopic)) && (((!string.IsNullOrWhiteSpace(AddTopic)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(RemoveTopic)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(UpdateTopic)) ? 1 : 0) > 1))
        {
