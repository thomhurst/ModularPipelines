...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-groups/managed/stop-instances
...
[CliSubCommand("preview", "compute", "instance-groups", "managed", "stop-instances")]
public record GcloudPreviewComputeInstanceGroupsManagedStopInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// stop     instances owned by a managed instance group
    /// </summary>
    /// <param name="Instances">Names of instances to stop. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedStopInstancesOptions(
    ...
    /// <summary>
    /// Names of instances to stop. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Immediately stop the specified instances, skipping the initial delay, if one is specified in the standby policy.
    /// </summary>
    [CliFlag("--force")]
