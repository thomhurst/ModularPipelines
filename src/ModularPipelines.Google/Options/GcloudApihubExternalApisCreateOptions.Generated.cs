...
public record GcloudApihubExternalApisCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Documentation details. List of endpoints on which this API is accessible. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--endpoints", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string>? Endpoints { get; set; }

    /// <summary>
    /// Documentation details. List of paths served by this API. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
