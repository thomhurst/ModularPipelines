...
public record GcloudComputeInstanceTemplatesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM     policy binding from a Compute Engine instance template
    /// </summary>
    ...
    public GcloudComputeInstanceTemplatesRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
