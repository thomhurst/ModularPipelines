...
public record GcloudAiEndpointsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: List of pairs of deployed model id and value to set as traffic split. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--traffic-split", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string>? TrafficSplit
    {
        get;
        set => field = value is { } values ? (object)values is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair> ? values : ((object)values is global::System.Collections.Generic.IEnumerable<char> ? values : ((object)values is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> keyValues ? new __TrafficSplitSnapshotKeyValue(values, default(global::System.Collections.Immutable.ImmutableArray<global::ModularPipelines.Models.KeyValue>).Equals((object)keyValues) ? global::System.Array.Empty<global::ModularPipelines.Models.KeyValue>() : keyValues) : (default(global::System.Collections.Immutable.ImmutableArray<string>).Equals((object)values) ? global::System.Array.Empty<string>() : global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(values))))) : default;
    }

    private sealed class __TrafficSplitSnapshotKeyValue(
        IEnumerable<string> source,
        global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> values)
        : IEnumerable<string>, global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>
    {
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((ClearTrafficSplit == true ? 1 : 0) + (((object?)TrafficSplit is global::System.Collections.Generic.IEnumerable<char> ? (object?)TrafficSplit is not string || !string.IsNullOrWhiteSpace(TrafficSplit?.ToString()) : ((object?)TrafficSplit is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)TrafficSplit, static item => item is not null) : (TrafficSplit is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)TrafficSplit), static item => item is not null)))) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of ClearTrafficSplit or TrafficSplit may be specified.", [nameof(ClearTrafficSplit), nameof(TrafficSplit)]);
        }
        if ((DisableRequestResponseLogging == true ? 1 : 0) + ((!string.IsNullOrWhiteSpace(RequestResponseLoggingRate) || !string.IsNullOrWhiteSpace(RequestResponseLoggingTable)) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of DisableRequestResponseLogging or (RequestResponseLoggingRate or RequestResponseLoggingTable) may be specified.", [nameof(DisableRequestResponseLogging), nameof(RequestResponseLoggingRate), nameof(RequestResponseLoggingTable)]);
        }
        yield break;
    }
