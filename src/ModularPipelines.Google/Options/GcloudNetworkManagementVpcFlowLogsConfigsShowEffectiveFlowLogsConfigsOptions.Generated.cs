...
public record GcloudNetworkManagementVpcFlowLogsConfigsShowEffectiveFlowLogsConfigsOptions : GcloudOptions
{
    ...
    public GcloudNetworkManagementVpcFlowLogsConfigsShowEffectiveFlowLogsConfigsOptions(
        string Location,
        string Resource
    )
    {
    ...
    public void Deconstruct(out string Location, out string Resource)
    {
    ...
    /// <summary>
    /// The resource to get the effective VPC Flow Logs configuration for. The resource must belong to the same project as the parent. The resource must be a network, subnetwork, interconnect attachment, VPN tunnel, or a project.
    /// </summary>
