...
public record GcloudLoggingBucketsDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete a bucket
    /// </summary>
    /// <param name="Location">Location of the bucket.</param>
    /// <param name="BucketId">ID of the bucket to delete.</param>
    public GcloudLoggingBucketsDeleteOptions(
        string Location,
        string BucketId
    )
    {
