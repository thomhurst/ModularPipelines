...
/// <param name="PropertiesCpuCoreCount">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. The Minimum number of OCPUs to be made available for this Deployment.</param>
/// <param name="PropertiesDescription">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. The description of the GoldengateDeployment.</param>
/// <param name="PropertiesEnvironmentType">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. The environment type of the GoldengateDeployment.</param>
/// <param name="PropertiesLicenseModel">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. The Oracle license model that applies to a Deployment. PROPERTIES_LICENSE_MODEL must be one of: bring-your-own-license The license model is bring your own license. license-included The license model is included.</param>
...
/// <param name="OggDataVersion">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. The Ogg data of the GoldengateDeployment. This must be specified. Version of OGG</param>
/// <param name="MaintenanceConfigBundleReleaseUpgradePeriodDays">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. Defines auto upgrade period for bundle releases. Manually configured period cannot be longer than service defined period for bundle releases. This period must be shorter or equal to major release upgrade period. Not passing this field during create will equate to using the service default.</param>
/// <param name="MaintenanceConfigInterimReleaseUpgradePeriodDays">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. Defines auto upgrade period for interim releases. This period must be shorter or equal to bundle release upgrade period.</param>
/// <param name="MaintenanceConfigMajorReleaseUpgradePeriodDays">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. Defines auto upgrade period for major releases. Manually configured period cannot be longer than service defined period for major releases. Not passing this field during create will equate to using the service default.</param>
/// <param name="MaintenanceConfigSecurityPatchUpgradePeriodDays">Properties of GoldengateDeployment. This must be specified. The maintenance configuration of the GoldengateDeployment. The maintenance window of the GoldengateDeployment. Defines auto upgrade period for releases with security fix. Manually configured period cannot be longer than service defined period for security releases. Not passing this field during create will equate to using the service default.</param>
...
public record GcloudOracleDatabaseGoldengateDeploymentsCreateOptions(
    ...
    [property: CliOption("--properties-cpu-core-count", Format = OptionFormat.EqualsSeparated)] int PropertiesCpuCoreCount,
    [property: CliOption("--properties-description", Format = OptionFormat.EqualsSeparated)] string PropertiesDescription,
    [property: CliOption("--properties-environment-type", Format = OptionFormat.EqualsSeparated)] string PropertiesEnvironmentType,
    ...
    [property: CliOption("--ogg-data-version", Format = OptionFormat.EqualsSeparated)] string OggDataVersion,
    [property: CliOption("--maintenance-config-bundle-release-upgrade-period-days", Format = OptionFormat.EqualsSeparated)] string MaintenanceConfigBundleReleaseUpgradePeriodDays,
    [property: CliOption("--maintenance-config-interim-release-upgrade-period-days", Format = OptionFormat.EqualsSeparated)] string MaintenanceConfigInterimReleaseUpgradePeriodDays,
    [property: CliOption("--maintenance-config-major-release-upgrade-period-days", Format = OptionFormat.EqualsSeparated)] string MaintenanceConfigMajorReleaseUpgradePeriodDays,
    [property: CliOption("--maintenance-config-security-patch-upgrade-period-days", Format = OptionFormat.EqualsSeparated)] string MaintenanceConfigSecurityPatchUpgradePeriodDays,
...
) : GcloudOptions, IValidatableObject
{
    ...
    {
        if (!(PropertiesIsAutoScalingEnabled == true))
        {
            yield return new ValidationResult("At least one of PropertiesIsAutoScalingEnabled must be specified.", [nameof(PropertiesIsAutoScalingEnabled)]);
        }
