...
public record GcloudOracleDatabaseGoldengateDeploymentsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public void Deconstruct(out string DisplayName, out string OdbSubnet, out string PropertiesDeploymentType, out string OggDataAdminUsername, out string OggDataDeployment, out string GoldengateDeployment)
    {
    ...
    /// <summary>
    /// Start hour for maintenance period. Hour is in UTC. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
