...
public record GcloudComputeBackendServicesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Compute Engine backend service
    /// </summary>
    ...
    public GcloudComputeBackendServicesRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
