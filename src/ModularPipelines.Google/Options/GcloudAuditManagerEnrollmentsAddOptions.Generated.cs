...
/// enroll a new scope
/// </summary>
/// <param name="EligibleGcsBuckets">Eligible cloud storage buckets where report and evidence can be uploaded.</param>
[GeneratedCode("ModularPipelines.OptionsGenerator", "2.0.0")]
[ExcludeFromCodeCoverage]
[CliSubCommand("audit-manager", "enrollments", "add")]
public record GcloudAuditManagerEnrollmentsAddOptions(
    [property: CliOption("--eligible-gcs-buckets", Format = OptionFormat.EqualsSeparated)] IEnumerable<string> EligibleGcsBuckets
