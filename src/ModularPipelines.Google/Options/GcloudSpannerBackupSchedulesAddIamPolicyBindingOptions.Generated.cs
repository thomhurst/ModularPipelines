...
public record GcloudSpannerBackupSchedulesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding to a Cloud Spanner backup schedule
    /// </summary>
