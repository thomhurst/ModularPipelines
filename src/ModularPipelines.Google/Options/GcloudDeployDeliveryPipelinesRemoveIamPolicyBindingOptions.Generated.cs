...
public record GcloudDeployDeliveryPipelinesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding for a Cloud Deploy delivery pipeline
    /// </summary>
    ...
    public GcloudDeployDeliveryPipelinesRemoveIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
