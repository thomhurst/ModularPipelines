...
public record GcloudPreviewComputeRoutersAddRoutePolicyTermOptions : GcloudOptions
{
    /// <summary>
    /// adds a new term to     an existing route policy of a Comute Engine router
    /// </summary>
    ...
    public GcloudPreviewComputeRoutersAddRoutePolicyTermOptions(
        string Match,
        string PolicyName,
        string Priority,
        string Name
    ...
    /// <summary>
    /// --actions=[ACTION;...] Semicolon separated CEL expressions for the actions to take when the rule matches. Name of the route policy to which to add the term.
    /// </summary>
