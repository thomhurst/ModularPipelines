...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/set-machine-resources
...
[CliSubCommand("preview", "compute", "instances", "set-machine-resources")]
public record GcloudPreviewComputeInstancesSetMachineResourcesOptions : GcloudOptions
{
    /// <summary>
    /// set machine     resources for a Compute Engine virtual machine instance
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesSetMachineResourcesOptions(
        string InstanceName
    )
    {
    ...
    /// <summary>
    /// The number of accelerators to attach to the instance.
    /// </summary>
    [CliOption("--accelerator-count", Format = OptionFormat.EqualsSeparated)]
    public int? AcceleratorCount { get; set; }

    /// <summary>
    /// The type of accelerator to attach to the instance.
    /// </summary>
