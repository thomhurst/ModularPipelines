...
public record GcloudFilestoreBackupsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Filestore backup
    /// </summary>
    /// <param name="Region">Compute region (e.g. us-central1) for the backup.</param>
    /// <param name="Backup">Arguments and flags that specify the Filestore backup you want to update.</param>
    public GcloudFilestoreBackupsUpdateOptions(
        string Region,
        string Backup
    )
    {
