...
public record GcloudDesignCenterSpacesApplicationTemplatesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Update saas_runtime_context_names. At most one of these can be specified: Set saas_runtime_context_names to new value. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Update saas_runtime_context_names. At most one of these can be specified: Or at least one of these can be specified: Add new value to saas_runtime_context_names list. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Update saas_runtime_context_names. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear saas_runtime_context_names value and set to empty list.
    /// </summary>
    [CliFlag("--clear-saas-runtime-context-names")]
    public bool? ClearSaasRuntimeContextNames { get; set; }

    /// <summary>
    /// Update saas_runtime_context_names. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from saas_runtime_context_names list. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Update root_input_variables. At most one of these can be specified: Set root_input_variables to new value. Root level input variables of the application template. componentUri Component to which this variable belongs. variable Name of the variable. Shorthand Example: --root-input-variables=componentUri=string,variable=string --root-input-variables=componentUri=string,variable=string JSON Example: --root-input-variables='[{"componentUri": "string", "variable": "string"}]' File Example: --root-input-variables=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update root_output_variables. At most one of these can be specified: Set root_output_variables to new value. Root level output variables of the application template. componentUri Component to which this variable belongs. variable Name of the variable. Shorthand Example: --root-output-variables=componentUri=string,variable=string --root-output-variables=componentUri=string,variable=string JSON Example: --root-output-variables='[{"componentUri": "string", "variable": "string"}]' File Example: --root-output-variables=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update root_output_variables. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear root_output_variables value and set to empty list.
    /// </summary>
    [CliFlag("--clear-root-output-variables")]
    public bool? ClearRootOutputVariables { get; set; }

    /// <summary>
    /// Update root_output_variables. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from root_output_variables list. Root level output variables of the application template. componentUri Component to which this variable belongs. variable Name of the variable. Shorthand Example: --remove-root-output-variables=componentUri=string,variable=string --remove-root-output-variables=componentUri=string,variable=string JSON Example: --remove-root-output-variables='[{"componentUri": "string", "variable": "string"}]' File Example: --remove-root-output-variables=path_to_file.(yaml|json)
    /// </summary>
