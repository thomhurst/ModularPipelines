...
public record GcloudSourceManagerInstancesSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudSourceManagerInstancesSetIamPolicyOptions(
        string Instance,
        string PolicyFile
    )
    {
