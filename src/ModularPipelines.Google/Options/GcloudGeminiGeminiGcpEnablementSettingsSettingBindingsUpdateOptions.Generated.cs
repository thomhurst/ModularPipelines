...
// Source: https://cloud.google.com/sdk/gcloud/reference/gemini/gemini-gcp-enablement-settings/setting-bindings/update
...
[CliSubCommand("gemini", "gemini-gcp-enablement-settings", "setting-bindings", "update")]
public record GcloudGeminiGeminiGcpEnablementSettingsSettingBindingsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update settingBindings
    /// </summary>
    ...
    public GcloudGeminiGeminiGcpEnablementSettingsSettingBindingsUpdateOptions(
    ...
    /// <summary>
    /// SettingBinding resource - Identifier. Name of the resource. Format:projects/{project}/locations/{location}/{settingType}/{setting}/settingBindings/{setting_binding} The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument setting_binding on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. The geminiGcpEnablementSetting id of the settingBinding resource. To set the gemini-gcp-enablement-setting attribute: ▸ provide the argument setting_binding on the command line with a fully specified name; ▸ provide the argument --gemini-gcp-enablement-setting on the command line.
    /// </summary>
