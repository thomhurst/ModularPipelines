...
public record GcloudKmsKeysVersionsImportOptions : GcloudOptions
{
    ...
    public GcloudKmsKeysVersionsImportOptions(
        string Algorithm,
        string ImportJob
    )
    {
    ...
    public void Deconstruct(out string Algorithm, out string ImportJob)
    {
    ...
    /// </summary>
    [CliOption("--import-job", Format = OptionFormat.EqualsSeparated)]
