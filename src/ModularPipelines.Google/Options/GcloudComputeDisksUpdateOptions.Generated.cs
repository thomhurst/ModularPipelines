...
public record GcloudComputeDisksUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine Hyperdisk or     Persistent Disk
    /// </summary>
    /// <param name="DiskName">Name of the disk to update.</param>
    public GcloudComputeDisksUpdateOptions(
        string DiskName
    )
    {
    ...
    public GcloudComputeDisksUpdateAccessMode? AccessMode { get; set; }
