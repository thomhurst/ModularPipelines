...
public record GcloudPreviewComputeHealthChecksCreateHttpOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a HTTP health     check to monitor load balanced instances
    /// </summary>
    /// <param name="Name">Name of the HTTP health check to create.</param>
    public GcloudPreviewComputeHealthChecksCreateHttpOptions(
        string Name
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: If set, the HTTP health check is global.
    /// </summary>
    [CliFlag("--global")]
    public bool? Global { get; set; }

    /// <summary>
    /// At most one of these can be specified: Region of the HTTP health check to create. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
