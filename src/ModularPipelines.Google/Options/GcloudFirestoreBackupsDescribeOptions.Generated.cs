...
public record GcloudFirestoreBackupsDescribeOptions : GcloudOptions
{
    ...
    public GcloudFirestoreBackupsDescribeOptions(
        string Backup,
        string Location
    )
    {
    ...
    /// <summary>
    /// The backup to operate on. For example, to operate on backup cf9f748a-7980-4703-b1a1-d1ffff591db0: $ gcloud firestore backups describe \ --backup='cf9f748a-7980-4703-b1a1-d1ffff591db0'
    /// </summary>
    [CliOption("--backup", Format = OptionFormat.EqualsSeparated)]
    public string Backup { get; private init; }

    /// <summary>
    /// The location to operate on. Available locations are listed at https://cloud.google.com/firestore/docs/locations. For example, to operate on location us-east1: $ gcloud firestore backups describe --location='us-east1'
    /// </summary>
