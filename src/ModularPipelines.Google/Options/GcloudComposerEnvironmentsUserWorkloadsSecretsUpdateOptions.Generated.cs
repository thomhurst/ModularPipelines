...
public record GcloudComposerEnvironmentsUserWorkloadsSecretsUpdateOptions(
    [property: CliOption("--secret-file-path", Format = OptionFormat.EqualsSeparated)] string SecretFilePath
) : GcloudOptions
{
    /// <summary>
