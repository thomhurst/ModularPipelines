...
public record GcloudBeyondcorpSecurityGatewaysAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM     policy binding to a security gateway
    /// </summary>
