...
public record GcloudComputeOsLoginSshKeysUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update an SSH public key in an OS     Login profile
    /// </summary>
    ...
    public GcloudComputeOsLoginSshKeysUpdateOptions(
        string Ttl
    )
    {
    ...
    public void Deconstruct(out string Ttl)
    {
        Ttl = this.Ttl;
    }
