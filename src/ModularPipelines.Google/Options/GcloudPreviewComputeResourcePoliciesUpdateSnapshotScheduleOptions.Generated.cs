...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/resource-policies/update/snapshot-schedule
...
public record GcloudPreviewComputeResourcePoliciesUpdateSnapshotScheduleOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update     a Compute Engine Snapshot Schedule Resource Policy
    /// </summary>
    /// <param name="Name">Name of the resource policy to operate on.</param>
    public GcloudPreviewComputeResourcePoliciesUpdateSnapshotScheduleOptions(
        string Name
    )
    {
    ...
    public GcloudPreviewComputeResourcePoliciesUpdateSnapshotScheduleWeeklySchedule? WeeklySchedule { get; set; }
