...
public record GcloudComputeInstanceGroupsManagedStopAutoscalingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// stop autoscaling     a managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedStopAutoscalingOptions(
        string Name
    )
    {
