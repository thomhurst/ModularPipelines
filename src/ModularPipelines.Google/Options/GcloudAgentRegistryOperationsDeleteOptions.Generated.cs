...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-registry/operations/delete
...
[CliSubCommand("agent-registry", "operations", "delete")]
public record GcloudAgentRegistryOperationsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete operations
    /// </summary>
    ...
    public GcloudAgentRegistryOperationsDeleteOptions(
        string Operation
    )
    {
