...
public record GcloudComputeInstanceGroupsManagedGetNamedPortsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// lists the named     ports for an instance group resource
    /// </summary>
    /// <param name="Name">Name of the instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedGetNamedPortsOptions(
        string Name
    )
    {
