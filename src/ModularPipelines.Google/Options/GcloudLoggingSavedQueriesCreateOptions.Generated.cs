...
public record GcloudLoggingSavedQueriesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public void Deconstruct(out string DisplayName, out string Location, out GcloudVisibility Visibility)
    {
    ...
    public GcloudVisibility Visibility { get; private init; }
