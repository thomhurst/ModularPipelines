...
public record GcloudIamWorkloadIdentityPoolsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding for a workload identity pool
    /// </summary>
