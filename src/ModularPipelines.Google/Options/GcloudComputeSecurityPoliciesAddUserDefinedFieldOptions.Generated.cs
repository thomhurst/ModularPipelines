...
public record GcloudComputeSecurityPoliciesAddUserDefinedFieldOptions : GcloudOptions
{
    ...
    public GcloudComputeSecurityPoliciesAddUserDefinedFieldOptions(
        GcloudComputeSecurityPoliciesAddUserDefinedFieldBase Base,
        string Offset,
        int Size,
    ...
    public void Deconstruct(out GcloudComputeSecurityPoliciesAddUserDefinedFieldBase Base, out string Offset, out int Size, out string UserDefinedFieldName, out string Name)
    {
        Base = this.Base;
        Offset = this.Offset;
        Size = this.Size;
    ...
    public GcloudComputeSecurityPoliciesAddUserDefinedFieldBase Base { get; private init; }
