...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/remove-iam-policy-binding
...
[CliSubCommand("preview", "compute", "reservations", "remove-iam-policy-binding")]
public record GcloudPreviewComputeReservationsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM     policy binding from a Compute Engine reservation
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Reservation)
    {
        Member = this.Member;
        Role = this.Role;
