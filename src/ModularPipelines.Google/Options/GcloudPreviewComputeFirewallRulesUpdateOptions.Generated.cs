...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/firewall-rules/update
...
[CliSubCommand("preview", "compute", "firewall-rules", "update")]
public record GcloudPreviewComputeFirewallRulesUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a firewall rule
    /// </summary>
    /// <param name="Name">Name of the firewall rule to update.</param>
    public GcloudPreviewComputeFirewallRulesUpdateOptions(
        string Name
    )
    {
    ...
    /// <summary>
    /// Negates --disabled. Disable a firewall rule and stop it from being enforced in the network. If a firewall rule is disabled, the associated network behaves as if the rule did not exist. To enable a disabled rule, use: $ gcloud preview compute firewall-rules update MY-RULE --no-disabled
    /// </summary>
    [CliFlag("--no-disabled")]
    ...
    /// <summary>
    /// Negates --enable-logging. Enable logging for the firewall rule. Logs will be exported to StackDriver. Firewall logging is disabled by default. To enable logging for an existing rule, run: $ gcloud preview compute firewall-rules update MY-RULE \ --enable-logging To disable logging on an existing rule, run: $ gcloud preview compute firewall-rules update MY-RULE \ --no-enable-logging Use --enable-logging to enable and --no-enable-logging to disable.
    /// </summary>
    ...
    public GcloudPreviewComputeFirewallRulesUpdateLoggingMetadata? LoggingMetadata { get; set; }
