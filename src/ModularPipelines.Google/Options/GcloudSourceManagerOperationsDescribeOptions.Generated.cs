...
// Source: https://cloud.google.com/sdk/gcloud/reference/source-manager/operations/describe
...
[CliSubCommand("source-manager", "operations", "describe")]
public record GcloudSourceManagerOperationsDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a Secure Source     Manager operation
    /// </summary>
    ...
    public GcloudSourceManagerOperationsDescribeOptions(
        string Operation
    )
    {
    ...
    /// <summary>
    /// Operation resource - The operation you want to describe. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument operation on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. Secure Source Manager location. To set the region attribute: ▸ provide the argument operation on the command line with a fully specified name; ▸ provide the argument --region on the command line.
    /// </summary>
