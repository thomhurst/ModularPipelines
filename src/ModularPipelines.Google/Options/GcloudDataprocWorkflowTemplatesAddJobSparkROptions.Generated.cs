...
public record GcloudDataprocWorkflowTemplatesAddJobSparkROptions : GcloudOptions
{
    /// <summary>
    /// add a SparkR job to     the workflow template
    /// </summary>
    ...
    /// <param name="RFile">Main .R file to run as the driver.</param>
    public GcloudDataprocWorkflowTemplatesAddJobSparkROptions(
        string StepId,
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(RFile);
        this.RFile = RFile;
    }

    public void Deconstruct(out string StepId, out string WorkflowTemplate, out string RFile)
    {
        StepId = this.StepId;
    ...
    /// <summary>
    /// List of key value pairs to configure SparkR. For a list of available properties, see: https://spark.apache.org/docs/latest/configuration.html#available-properties. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    public string RFile { get; private init; }
