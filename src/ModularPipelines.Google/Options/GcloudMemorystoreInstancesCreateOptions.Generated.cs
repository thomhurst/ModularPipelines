...
public record GcloudMemorystoreInstancesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Arguments for the acl policy. AclPolicy resource - The ACL policy for the instance. Format: projects/{project}/locations/{location}/aclPolicies/{acl_policy} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --acl-policy on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --acl-policy on the command line with a fully specified name; ◆ provide the argument --location on the command line. Return immediately, without waiting for the operation in progress to complete.
    /// </summary>
    [CliFlag("--async")]
    public bool? Async { get; set; }

    /// <summary>
    /// Arguments for the async instance endpoints deletion enabled. If true, instance endpoints that are created and registered by customers can be deleted asynchronously. That is, such an instance endpoint can be de-registered before the forwarding rules in the instance endpoint are deleted.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the rotate server certificate. Rotate the server certificates.
    /// </summary>
    [CliFlag("--rotate-server-certificate")]
    public bool? RotateServerCertificate { get; set; }

    /// <summary>
    /// Arguments for the server ca mode. The Server CA mode for the instance. SERVER_CA_MODE must be one of: customer-managed-cas-ca The instance uses a customer-managed CA from CAS. google-managed-per-instance-ca Each instance has its own Google-managed CA. google-managed-shared-ca The instance uses a Google-managed shared CA for the instance's region. server-ca-mode-customer-managed-cas-ca Deprecated: Use CUSTOMER_MANAGED_CAS_CA instead. server-ca-mode-google-managed-per-instance-ca Deprecated: Use GOOGLE_MANAGED_PER_INSTANCE_CA instead. server-ca-mode-google-managed-shared-ca Deprecated: Use GOOGLE_MANAGED_SHARED_CA instead.
    /// </summary>
    [CliOption("--server-ca-mode", Format = OptionFormat.EqualsSeparated)]
    public string? ServerCaMode { get; set; }

    /// <summary>
    /// Arguments for the server ca pool. CaPool resource - Customer-managed CA pool. The resource name of the Certificate Authority Service (CAS) CA Pool. Required and only applicable when --server-ca-mode is set to customer-managed-cas-ca. Format: projects/{project}/locations/{region}/caPools/{ca_pool} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --server-ca-pool on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --server-ca-pool on the command line with a fully specified name; ◆ provide the argument --location on the command line. ID of the caPool or fully qualified identifier for the caPool. To set the ca-pool attribute: ◆ provide the argument --server-ca-pool on the command line.
    /// </summary>
    [CliOption("--server-ca-pool", Format = OptionFormat.EqualsSeparated)]
    public string? ServerCaPool { get; set; }

    /// <summary>
    /// Arguments for the server ca pool. CaPool resource - Customer-managed CA pool. The resource name of the Certificate Authority Service (CAS) CA Pool. Required and only applicable when --server-ca-mode is set to customer-managed-cas-ca. Format: projects/{project}/locations/{region}/caPools/{ca_pool} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --server-ca-pool on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --server-ca-pool on the command line with a fully specified name; ◆ provide the argument --location on the command line. Number of shards for the instance.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the import sources. At most one of these can be specified: Backups that generated and managed by memorystore. Example: //memorystore.googleapis.com/projects/{project}/locations/{location}/backupCollections/{collection}/backups/{backup} A shorter version (without the prefix) of the backup name is also supported, like projects/{project}/locations/{location}/backupCollections/{collection}/backups/{backup_id} In this case, it assumes the backup is under memorystore.googleapis.com.
    /// </summary>
    ...
    {
        if (!(!string.IsNullOrWhiteSpace(FixedFrequencyScheduleStartTimeHours) || !string.IsNullOrWhiteSpace(FixedFrequencyScheduleStartTimeMinutes) || !string.IsNullOrWhiteSpace(FixedFrequencyScheduleStartTimeNanos) || (object?)FixedFrequencyScheduleStartTimeSeconds is not null))
        {
