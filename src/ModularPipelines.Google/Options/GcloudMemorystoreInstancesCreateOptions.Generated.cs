...
public record GcloudMemorystoreInstancesCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// For resources [instance, kms-key, primary-instance], provides fallback     value for resource location attribute. When the resource's full URI     path is not provided, location will fallback to this flag value.    Maintenance policy per instance.
    /// </summary>
