...
public record GcloudContainerFleetPolicycontrollerContentBundlesRemoveOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// removes a     bundle installation for Policy Controller content
    /// </summary>
    /// <param name="BundleName">The constraint bundle to remove from Policy Controller.</param>
    public GcloudContainerFleetPolicycontrollerContentBundlesRemoveOptions(
        string BundleName
    )
    {
