...
public record GcloudRunJobsUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. The GPU type to use.
    /// </summary>
    [CliOption("--gpu-type", Format = OptionFormat.EqualsSeparated)]
    public string? GpuType { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Set GPU zonal redundancy. Use --gpu-zonal-redundancy to enable and --no-gpu-zonal-redundancy to disable.
    /// </summary>
    [CliFlag("--gpu-zonal-redundancy")]
    public bool? GpuZonalRedundancy { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. CMEK key reference to encrypt the container with.
    /// </summary>
    [CliOption("--key", Format = OptionFormat.EqualsSeparated)]
    public string? Key { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Number of times a task is allowed to restart in case of failure before being failed permanently. This applies per-task, not per-job. If set to 0, tasks will only run once and never be retried on failure.
    /// </summary>
    [CliOption("--max-retries", Format = OptionFormat.EqualsSeparated)]
    public string? MaxRetries { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Number of tasks that may run concurrently. Must be less than or equal to the number of tasks. Set to 0 to unset.
    /// </summary>
    [CliOption("--parallelism", Format = OptionFormat.EqualsSeparated)]
    public string? Parallelism { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Region in which the resource can be found. Alternatively, set the property [run/region].
    /// </summary>
    [CliOption("--region", Format = OptionFormat.EqualsSeparated)]
    public string? Region { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. List of containers to remove.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Set the maximum time (deadline) a job task attempt can run for. In the case of retries, this deadline applies to each attempt of a task. If the task attempt does not complete within this time, it will be killed. It is specified as a duration; for example, "10m5s" is ten minutes, and five seconds. If you don't specify a unit, seconds is assumed. For example, "10" is 10 seconds.
    /// </summary>
    [CliOption("--task-timeout", Format = OptionFormat.EqualsSeparated)]
    public int? TaskTimeout { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Set a VPC connector for this resource.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Remove all existing volumes from the Cloud Run resource, including volumes mounted as secrets
    /// </summary>
    [CliFlag("--clear-volumes")]
    public bool? ClearVolumes { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Removes volumes from the Cloud Run resource.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Remove all existing mounts from the current container.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Set a CPU limit in Kubernetes cpu units. Cloud Run supports values fractional values below 1, 1, 2, 4, and 8. Some CPU values requires a minimum Memory --memory value.
    /// </summary>
    [CliOption("--cpu", Format = OptionFormat.EqualsSeparated)]
    public string? Cpu { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. List of container dependencies to add to the current container.
    /// </summary>
    [CliOption("--depends-on", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? DependsOn { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Cloud Run supports values 0 or 1. 1 gpu also requires a minimum 4 --cpu value and a minimum 16Gi --memory value.
    /// </summary>
    [CliOption("--gpu", Format = OptionFormat.EqualsSeparated)]
    public string? Gpu { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Name of the container image to deploy (e.g. us-docker.pkg.dev/cloudrun/container/job:latest).
    /// </summary>
    [CliOption("--image", Format = OptionFormat.EqualsSeparated)]
    public string? Image { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Set a memory limit. Ex: 1024Mi, 4Gi.
    /// </summary>
    [CliOption("--memory", Format = OptionFormat.EqualsSeparated)]
    public string? Memory { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. Removes the volume mounted at the specified path from the current container.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: Remove all environment variables.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: List of key-value pairs to set as environment variables. All existing environment variables will be removed first.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: Return immediately, without waiting for the operation in progress to complete.
    /// </summary>
    [CliFlag("--async")]
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: Binary Authorization policy to check against. This must be set to "default".
    /// </summary>
    [CliOption("--binary-authorization", Format = OptionFormat.EqualsSeparated)]
    public string? BinaryAuthorization { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: Remove any previously set Binary Authorization policy.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: List of label KEY=VALUE pairs to add. An alias to --update-labels.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container or --remove-containers flag is specified the following arguments may only be specified after a --container flag. At most one of these can be specified: Disconnect this Cloud Run job from the VPC network it is connected to.
    /// </summary>
    ...
    [Obsolete("Tasks is no longer supported by the installed CLI and has no effect.")]
