...
public record GcloudBigtableTablesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: Group for automated backup policy parameters. The retention period of automated backup in the format of 30d for 30 days. Min retention period is 3d and max is 90d. Setting this flag enables automated backup for the table.
    /// </summary>
