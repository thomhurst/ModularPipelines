...
public record GcloudMonitoringSnoozesCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Snooze Settings. If any of these are specified, they will overwrite fields in the --snooze-from-file flags if specified. The display name for the Snooze.
    /// </summary>
    [CliOption("--display-name", Format = OptionFormat.EqualsSeparated)]
    public string? DisplayName { get; set; }

    /// <summary>
    /// Snooze Settings. If any of these are specified, they will overwrite fields in the --snooze-from-file flags if specified. The end time for the Snooze.
    /// </summary>
    [CliOption("--end-time", Format = OptionFormat.EqualsSeparated)]
    public string? EndTime { get; set; }

    /// <summary>
    /// Snooze Settings. If any of these are specified, they will overwrite fields in the --snooze-from-file flags if specified. The start time for the Snooze.
    /// </summary>
