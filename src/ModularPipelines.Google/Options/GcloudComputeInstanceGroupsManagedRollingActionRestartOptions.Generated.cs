...
public record GcloudComputeInstanceGroupsManagedRollingActionRestartOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// restarts     instances in a managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedRollingActionRestartOptions(
        string Name
    )
    {
