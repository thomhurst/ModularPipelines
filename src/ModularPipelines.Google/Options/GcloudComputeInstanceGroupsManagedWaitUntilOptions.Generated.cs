...
public record GcloudComputeInstanceGroupsManagedWaitUntilOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// wait until the managed     instance group reaches the desired state
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedWaitUntilOptions(
        string Name
    )
    {
