...
// Source: https://cloud.google.com/sdk/gcloud/reference/developer-connect/operations/list
...
[CliSubCommand("developer-connect", "operations", "list")]
public record GcloudDeveloperConnectOperationsListOptions : GcloudOptions
{
    /// <summary>
    /// list operations
    /// </summary>
    ...
    public GcloudDeveloperConnectOperationsListOptions(
        string Location
    )
    {
    ...
    /// <summary>
    /// Location resource - The name of the operation's parent resource. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --location on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the location or fully qualified identifier for the location. To set the location attribute: ▸ provide the argument --location on the command line.
    /// </summary>
