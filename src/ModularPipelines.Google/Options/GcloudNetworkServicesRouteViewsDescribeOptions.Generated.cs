...
public record GcloudNetworkServicesRouteViewsDescribeOptions : GcloudOptions
{
    ...
    public GcloudNetworkServicesRouteViewsDescribeOptions(
        string RouteView
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(RouteView);
        this.RouteView = RouteView;
    }

    public void Deconstruct(out string RouteView)
    {
    ...
    public string RouteView { get; private init; }
