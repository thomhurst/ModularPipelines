...
public record GcloudContainerClustersCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Node autoprovisioning At most one of these can be specified: Or at least one of these can be specified: Flags to specify upgrade settings for autoprovisioned nodes: Number of extra (surge) nodes to be created on each upgrade of an autoprovisioned node pool.
    /// </summary>
    ...
    /// <summary>
    /// Node autoprovisioning At most one of these can be specified: Or at least one of these can be specified: Flags to specify upgrade settings for autoprovisioned nodes: Number of nodes that can be unavailable at the same time on each upgrade of an autoprovisioned node pool.
    /// </summary>
    ...
    /// <summary>
    /// Node autoprovisioning At most one of these can be specified: Or at least one of these can be specified: Flags to specify upgrade settings for autoprovisioned nodes: Flag group to choose the top level upgrade option: At most one of these can be specified: Whether to use blue-green upgrade for the autoprovisioned node pool.
    /// </summary>
    [CliFlag("--enable-autoprovisioning-blue-green-upgrade")]
    public bool? EnableAutoprovisioningBlueGreenUpgrade { get; set; }

    /// <summary>
    /// Node autoprovisioning At most one of these can be specified: Or at least one of these can be specified: Flags to specify upgrade settings for autoprovisioned nodes: Flag group to choose the top level upgrade option: At most one of these can be specified: Whether to use surge upgrade for the autoprovisioned node pool.
    /// </summary>
    ...
    /// <summary>
    /// Node autoprovisioning At most one of these can be specified: Or at least one of these can be specified: Flags to specify identity for autoprovisioned nodes: The Google Cloud Platform Service Account to be used by node VMs in autoprovisioned node pools. If not specified, the project default service account is used.
    /// </summary>
