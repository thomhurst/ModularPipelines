...
public record GcloudContainerClustersCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Negates --enable-autorepair. Enable node autorepair feature for a cluster's default node pool(s). $ gcloud container clusters create example-cluster \ --enable-autorepair Node autorepair is enabled by default for clusters using COS, COS_CONTAINERD, UBUNTU or UBUNTU_CONTAINERD as a base image, use --no-enable-autorepair to disable. See https://cloud.google.com/kubernetes-engine/docs/how-to/node-auto-repair for more info.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-autoupgrade. Sets autoupgrade feature for a cluster's default node pool(s). $ gcloud container clusters create example-cluster \ --enable-autoupgrade See https://cloud.google.com/kubernetes-engine/docs/node-auto-upgrades for more info. Enabled by default, use --no-enable-autoupgrade to disable.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-identity-service. Enable Identity Service component on the cluster. When enabled, users can authenticate to Kubernetes cluster with external identity providers. Identity Service is by default disabled when creating a new cluster. To disable Identity Service in an existing cluster, explicitly set flag --no-enable-identity-service.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-image-streaming. Enable Image Streaming for the cluster, allowing nodes to stream container image data from Artifact Registry on demand to reduce container start times. This flag sets the default for new node pools. It is enabled by default on Autopilot clusters. See Image Streaming documentation (https://cloud.google.com/kubernetes-engine/docs/how-to/image-streaming) for full requirements (including version, API enablement and Artifact Registry usage). To disable Image Streaming for the cluster, use --no-enable-image-streaming.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-ip-alias. --enable-ip-alias creates a VPC-native cluster. If you set this option, you can optionally specify the IP address ranges to use for Pods and Services. For instructions, see https://cloud.google.com/kubernetes-engine/docs/how-to/alias-ips. --no-enable-ip-alias creates a routes-based cluster. This type of cluster routes traffic between Pods using Google Cloud Routes. This option is not recommended; use the default VPC-native cluster type instead. For instructions, see https://cloud.google.com/kubernetes-engine/docs/how-to/routes-based-cluster Note: For IPv6-only clusters, these flags are a no-op as IP Aliases do not apply, and any specified IP address ranges for Pods and Services will be ignored. You can't specify both --enable-ip-alias and --no-enable-ip-alias. If you omit both --enable-ip-alias and --no-enable-ip-alias, the default is a VPC-native cluster.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-legacy-authorization. Enables the legacy ABAC authentication for the cluster. User rights are granted through the use of policies which combine attributes together. For a detailed look at these properties and related formats, see https://kubernetes.io/docs/admin/authorization/abac/. To use RBAC permissions instead, create or update your cluster with the option --no-enable-legacy-authorization.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-managed-prometheus. Enables managed collection for Managed Service for Prometheus in the cluster. See https://cloud.google.com/stackdriver/docs/managed-prometheus/setup-managed#enable-mgdcoll-gke for more info. Enabled by default for cluster versions 1.27 or greater, use --no-enable-managed-prometheus to disable.
    /// </summary>
    ...
    /// <summary>
    /// Enable Slice Controller for the cluster. Use --no-enable-slice-controller to disable.
    /// </summary>
    [CliFlag("--enable-slice-controller")]
    public bool? EnableSliceController { get; set; }

    /// <summary>
    /// Negates --enable-slice-controller. Enable Slice Controller for the cluster. Use --no-enable-slice-controller to disable.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: When specified, the nodes for the new cluster's default node pool will be scheduled on host with specified CPU architecture or a newer one. Examples: $ gcloud container clusters create example-cluster \ --min-cpu-platform=PLATFORM To list available CPU platforms in given zone, run: $ gcloud beta compute zones describe ZONE \ --format="value(availableCpuPlatforms)" CPU platform selection is available only in selected zones.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: The Compute Engine Network that the cluster will connect to. Google Kubernetes Engine will use this network when creating routes and firewalls for the clusters. Defaults to the 'default' network.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Indicates the desired resource policy to use. $ gcloud container clusters create node-pool-1 \ --cluster=example-cluster --placement-policy my-placement
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Sets the subnetwork GKE uses to provision the control plane's private endpoint.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: The name of the RBAC security group for use with Google security groups in Kubernetes RBAC (https://kubernetes.io/docs/reference/access-authn-authz/rbac/). To include group membership as part of the claims issued by Google during authentication, a group must be designated as a security group by including it as a direct member of this group. If unspecified, no groups will be returned for use with RBAC.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Set the secondary range to be used for services (e.g. ClusterIPs). NAME must be the name of an existing secondary range in the cluster subnetwork. Cannot be specified unless '--enable-ip-alias' option is also specified. Cannot be used with '--create-subnetwork' option.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Enables monitoring and attestation of the boot integrity of the instance. The attestation is performed against the integrity policy baseline. This baseline is initially derived from the implicitly trusted boot image when the instance is created.
    /// </summary>
    [CliFlag("--shielded-integrity-monitoring")]
    public bool? ShieldedIntegrityMonitoring { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: The instance will boot with secure boot enabled.
    /// </summary>
    [CliFlag("--shielded-secure-boot")]
    public bool? ShieldedSecureBoot { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Create nodes using spot VM instances in the new cluster. $ gcloud container clusters create example-cluster --spot New nodes, including ones created by resize or recreate, will use spot VM instances.
    /// </summary>
    [CliFlag("--spot")]
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: The number of visible threads per physical core for each node. To disable simultaneous multithreading (SMT) set this to 1.
    /// </summary>
    ...
    /// <summary>
    /// Configure boot disk options. Configure the Provisioned IOPS for the node pool boot disks. Only valid for hyperdisk-balanced boot disks.
    /// </summary>
    [CliOption("--boot-disk-provisioned-iops", Format = OptionFormat.EqualsSeparated)]
    public int? BootDiskProvisionedIops { get; set; }

    /// <summary>
    /// Configure boot disk options. Configure the Provisioned Throughput for the node pool boot disks. Only valid for hyperdisk-balanced boot disks.
    /// </summary>
    ...
    /// <summary>
    /// ClusterDNS DNS provider to use for this cluster. CLUSTER_DNS must be one of: clouddns Selects Cloud DNS as the DNS provider for the cluster. default Selects the default DNS provider (kube-dns) for the cluster. kubedns Selects Kube DNS as the DNS provider for the cluster.
    /// </summary>
    [CliOption("--cluster-dns", Format = OptionFormat.EqualsSeparated)]
    public string? ClusterDns { get; set; }

    /// <summary>
    /// ClusterDNS DNS domain for this cluster. The default value is cluster.local. This is configurable when --cluster-dns=clouddns and --cluster-dns-scope=vpc are set. The value must be a valid DNS subdomain as defined in RFC 1123.
    /// </summary>
    [CliOption("--cluster-dns-domain", Format = OptionFormat.EqualsSeparated)]
    public string? ClusterDnsDomain { get; set; }

    /// <summary>
    /// ClusterDNS DNS scope for the Cloud DNS zone created - valid only with --cluster-dns=clouddns. Defaults to cluster. CLUSTER_DNS_SCOPE must be one of: cluster Configures the Cloud DNS zone to be private to the cluster. vpc Configures the Cloud DNS zone to be private to the VPC Network.
    /// </summary>
    ...
    /// <summary>
    /// Node autoprovisioning Enables node autoprovisioning for a cluster. Cluster Autoscaler will be able to create new node pools. Requires maximum CPU and memory limits to be specified.
    /// </summary>
    ...
    /// <summary>
    /// Flags for Secret Sync configuration: Enables the Secret Sync component. For details, see Synchronize secrets to Kubernetes Secrets (https://docs.cloud.google.com/secret-manager/docs/sync-k8-secrets).
    /// </summary>
    [CliFlag("--enable-secret-sync")]
    public bool? EnableSecretSync { get; set; }

    /// <summary>
    /// Flags for Secret Sync configuration: Enables the rotation of secrets in the Secret Sync component.
    /// </summary>
    [CliFlag("--enable-secret-sync-rotation")]
    public bool? EnableSecretSyncRotation { get; set; }

    /// <summary>
    /// Flags for Secret Sync configuration: Set the rotation period for secrets in the Secret Sync component.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Flags for cluster disruption budget configuration: Set the minimum interval of time between minor version cluster upgrades.
    /// </summary>
    ...
    /// <summary>
    /// Flags for cluster disruption budget configuration: Set the minimum interval of time between patch version cluster upgrades.
    /// </summary>
    ...
    /// <summary>
    /// Basic auth The password to use for cluster auth. Defaults to a server-specified randomly-generated string.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Specifies the reservation for the default initial node pool. The name of the reservation, required when --reservation-affinity=specific.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(MaintenanceWindow) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of MaintenanceWindow or (MaintenanceWindowStart, MaintenanceWindowEnd, MaintenanceWindowRecurrence, or MaintenanceWindowDuration) may be specified.", [nameof(MaintenanceWindow), nameof(MaintenanceWindowStart), nameof(MaintenanceWindowEnd), nameof(MaintenanceWindowRecurrence), nameof(MaintenanceWindowDuration)]);
        }
        if ((!string.IsNullOrWhiteSpace(MaintenanceWindow) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!(!string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd))))
        {
            yield return new ValidationResult("At least one of MaintenanceWindowStart or MaintenanceWindowEnd must be specified.", [nameof(MaintenanceWindowStart), nameof(MaintenanceWindowEnd)]);
        }
        if ((!string.IsNullOrWhiteSpace(MaintenanceWindow) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd)) && (!(!string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(MaintenanceWindow) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd)) && (!(!string.IsNullOrWhiteSpace(MaintenanceWindowStart))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(MaintenanceWindow) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd) || !string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration)) && (!string.IsNullOrWhiteSpace(MaintenanceWindowRecurrence) || !string.IsNullOrWhiteSpace(MaintenanceWindowStart) || !string.IsNullOrWhiteSpace(MaintenanceWindowDuration) || !string.IsNullOrWhiteSpace(MaintenanceWindowEnd)) && ((!string.IsNullOrWhiteSpace(MaintenanceWindowDuration) ? 1 : 0) + (!string.IsNullOrWhiteSpace(MaintenanceWindowEnd) ? 1 : 0) != 1))
        {
        ...
        if (EnableAutoprovisioning == true && ((!string.IsNullOrWhiteSpace(AutoprovisioningConfigFile) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) ? 1 : 0) != 1))
        {
            yield return new ValidationResult("Exactly one of AutoprovisioningConfigFile or (AutoprovisioningImageType, AutoprovisioningLocations, AutoprovisioningMinCpuPlatform, MaxCpu, MaxMemory, MinCpu, MinMemory, AutoprovisioningMaxSurgeUpgrade, AutoprovisioningMaxUnavailableUpgrade, AutoprovisioningNodePoolSoakDuration, AutoprovisioningStandardRolloutPolicy, EnableAutoprovisioningBlueGreenUpgrade, EnableAutoprovisioningSurgeUpgrade, AutoprovisioningScopes, AutoprovisioningServiceAccount, EnableAutoprovisioningAutorepair, NoEnableAutoprovisioningAutorepair, EnableAutoprovisioningAutoupgrade, NoEnableAutoprovisioningAutoupgrade, MaxAccelerator, or MinAccelerator) must be specified.", [nameof(AutoprovisioningConfigFile), nameof(AutoprovisioningImageType), nameof(AutoprovisioningLocations), nameof(AutoprovisioningMinCpuPlatform), nameof(MaxCpu), nameof(MaxMemory), nameof(MinCpu), nameof(MinMemory), nameof(AutoprovisioningMaxSurgeUpgrade), nameof(AutoprovisioningMaxUnavailableUpgrade), nameof(AutoprovisioningNodePoolSoakDuration), nameof(AutoprovisioningStandardRolloutPolicy), nameof(EnableAutoprovisioningBlueGreenUpgrade), nameof(EnableAutoprovisioningSurgeUpgrade), nameof(AutoprovisioningScopes), nameof(AutoprovisioningServiceAccount), nameof(EnableAutoprovisioningAutorepair), nameof(NoEnableAutoprovisioningAutorepair), nameof(EnableAutoprovisioningAutoupgrade), nameof(NoEnableAutoprovisioningAutoupgrade), nameof(MaxAccelerator), nameof(MinAccelerator)]);
        }
        if (EnableAutoprovisioning == true && (!string.IsNullOrWhiteSpace(AutoprovisioningConfigFile) || !string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) && (!string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) && (!string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory)) && (!(!string.IsNullOrWhiteSpace(MaxCpu))))
        {
            yield return new ValidationResult("MaxCpu must be specified when other arguments in this group are specified.", [nameof(MaxCpu)]);
        }
        if (EnableAutoprovisioning == true && (!string.IsNullOrWhiteSpace(AutoprovisioningConfigFile) || !string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) && (!string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) && (!string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory)) && (!(!string.IsNullOrWhiteSpace(MaxMemory))))
        {
            yield return new ValidationResult("MaxMemory must be specified when other arguments in this group are specified.", [nameof(MaxMemory)]);
        }
        if (EnableAutoprovisioning == true && (!string.IsNullOrWhiteSpace(AutoprovisioningConfigFile) || !string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) && (!string.IsNullOrWhiteSpace(AutoprovisioningImageType) || ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningLocations is not string || !string.IsNullOrWhiteSpace(AutoprovisioningLocations?.ToString()) : ((object?)AutoprovisioningLocations is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningLocations, static item => item is not null) : (AutoprovisioningLocations is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningLocations), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningMinCpuPlatform) || !string.IsNullOrWhiteSpace(MaxCpu) || !string.IsNullOrWhiteSpace(MaxMemory) || !string.IsNullOrWhiteSpace(MinCpu) || !string.IsNullOrWhiteSpace(MinMemory) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true || ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)AutoprovisioningScopes is not string || !string.IsNullOrWhiteSpace(AutoprovisioningScopes?.ToString()) : ((object?)AutoprovisioningScopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AutoprovisioningScopes, static item => item is not null) : (AutoprovisioningScopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AutoprovisioningScopes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(AutoprovisioningServiceAccount) || EnableAutoprovisioningAutorepair == true || NoEnableAutoprovisioningAutorepair == true || EnableAutoprovisioningAutoupgrade == true || NoEnableAutoprovisioningAutoupgrade == true || !string.IsNullOrWhiteSpace(MaxAccelerator) || !string.IsNullOrWhiteSpace(MinAccelerator)) && (!string.IsNullOrWhiteSpace(AutoprovisioningMaxSurgeUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningMaxUnavailableUpgrade) || !string.IsNullOrWhiteSpace(AutoprovisioningNodePoolSoakDuration) || !string.IsNullOrWhiteSpace(AutoprovisioningStandardRolloutPolicy) || EnableAutoprovisioningBlueGreenUpgrade == true || EnableAutoprovisioningSurgeUpgrade == true) && ((EnableAutoprovisioningBlueGreenUpgrade == true ? 1 : 0) + (EnableAutoprovisioningSurgeUpgrade == true ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of EnableAutoprovisioningBlueGreenUpgrade or EnableAutoprovisioningSurgeUpgrade may be specified.", [nameof(EnableAutoprovisioningBlueGreenUpgrade), nameof(EnableAutoprovisioningSurgeUpgrade)]);
