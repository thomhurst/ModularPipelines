...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Addons (https://cloud.google.com/kubernetes-engine/docs/reference/rest/v1/projects.locations.clusters#Cluster.AddonsConfig) are additional Kubernetes cluster components. Addons specified by this flag will be enabled. The others will be disabled. Default addons: HttpLoadBalancing, HorizontalPodAutoscaling. The Istio addon is deprecated and removed. For more information and migration, see https://cloud.google.com/istio/docs/istio-on-gke/migrate-to-anthos-service-mesh. ADDON must be one of: HttpLoadBalancing, HorizontalPodAutoscaling, KubernetesDashboard, NetworkPolicy, NodeLocalDNS, ConfigConnector, GcePersistentDiskCsiDriver, GcpFilestoreCsiDriver, BackupRestore, GcsFuseCsiDriver, HighScaleCheckpointing, LustreCsiDriver, RayOperator, SlurmOperator, NodeReadinessController, CloudRun.
    /// </summary>
    [CliOption("--addons", Format = OptionFormat.EqualsSeparated)]
    public string? Addons { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Selectively enable or disable Kubernetes alpha and beta kubernetesfeature gates on alpha GKE cluster. Alpha clusters are not covered by the Kubernetes Engine SLA and should not be used for production workloads.
    /// </summary>
    [CliOption("--alpha-cluster-feature-gates", Format = OptionFormat.EqualsSeparated)]
    public string? AlphaClusterFeatureGates { get; set; }
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Add Autopilot workload policies to the cluster. Examples: $ gcloud container clusters create example-cluster \ --autopilot-workload-policies=allow-net-admin The only supported workload policy is 'allow-net-admin'.
    /// </summary>
    ...
    /// <summary>
    /// Negates --autoprovisioning-enable-insecure-kubelet-readonly-port. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables the Kubelet's insecure read only port for Autoprovisioned Node Pools. If not set, the value from nodePoolDefaults.nodeConfigDefaults will be used. To disable the readonly port --no-autoprovisioning-enable-insecure-kubelet-readonly-port.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Set autoscaling behaviour, choices are 'optimize-utilization' and 'balanced'. Default is 'balanced'.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Specifies the number of local SSDs to be utilized for GKE Data Cache in the cluster.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Size for node VM boot disks in GB. Defaults to 100GB.
    /// </summary>
    [CliOption("--disk-size", Format = OptionFormat.EqualsSeparated)]
    public int? DiskSize { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Type of the node VM boot disk. For version 1.24 and later, defaults to pd-balanced. For versions earlier than 1.24, defaults to pd-standard. DISK_TYPE must be one of: pd-standard, pd-ssd, pd-balanced, hyperdisk-balanced, hyperdisk-extreme, hyperdisk-throughput.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-agent-sandbox. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable the Agent Sandbox feature on the cluster. Use --no-enable-agent-sandbox to disable.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable node autorepair feature for a cluster's default node pool(s). $ gcloud container clusters create example-cluster \ --enable-autorepair Node autorepair is enabled by default for clusters using COS, COS_CONTAINERD, UBUNTU or UBUNTU_CONTAINERD as a base image, use --no-enable-autorepair to disable. See https://cloud.google.com/kubernetes-engine/docs/how-to/node-auto-repair for more info.
    /// </summary>
    [CliFlag("--enable-autorepair")]
    public bool? EnableAutorepair { get; set; }

    /// <summary>
    /// Negates --enable-autorepair. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable node autorepair feature for a cluster's default node pool(s). $ gcloud container clusters create example-cluster \ --enable-autorepair Node autorepair is enabled by default for clusters using COS, COS_CONTAINERD, UBUNTU or UBUNTU_CONTAINERD as a base image, use --no-enable-autorepair to disable. See https://cloud.google.com/kubernetes-engine/docs/how-to/node-auto-repair for more info.
    /// </summary>
    [CliFlag("--no-enable-autorepair")]
    public bool? NoEnableAutorepair { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Sets autoupgrade feature for a cluster's default node pool(s). $ gcloud container clusters create example-cluster \ --enable-autoupgrade See https://cloud.google.com/kubernetes-engine/docs/node-auto-upgrades for more info. Enabled by default, use --no-enable-autoupgrade to disable.
    /// </summary>
    [CliFlag("--enable-autoupgrade")]
    public bool? EnableAutoupgrade { get; set; }

    /// <summary>
    /// Negates --enable-autoupgrade. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Sets autoupgrade feature for a cluster's default node pool(s). $ gcloud container clusters create example-cluster \ --enable-autoupgrade See https://cloud.google.com/kubernetes-engine/docs/node-auto-upgrades for more info. Enabled by default, use --no-enable-autoupgrade to disable.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. (DEPRECATED) Automatically send logs from the cluster to the Google Cloud Logging API. Legacy Logging and Monitoring is deprecated. Thus, flag --enable-cloud-logging is also deprecated and will be removed in an upcoming release. Please use --logging (optionally with --monitoring). For more details, please read: https://cloud.google.com/kubernetes-engine/docs/concepts/about-logs and https://cloud.google.com/kubernetes-engine/docs/how-to/configure-metrics.
    /// </summary>
    [CliFlag("--enable-cloud-logging")]
    public bool? EnableCloudLogging { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. (DEPRECATED) Automatically send metrics from pods in the cluster to the Google Cloud Monitoring API. VM metrics will be collected by Google Compute Engine regardless of this setting. Legacy Logging and Monitoring is deprecated. Thus, flag --enable-cloud-monitoring is also deprecated. Please use --monitoring (optionally with --logging). For more details, please read: https://cloud.google.com/kubernetes-engine/docs/how-to/configure-metrics and https://cloud.google.com/kubernetes-engine/docs/concepts/about-logs.
    /// </summary>
    [CliFlag("--enable-cloud-monitoring")]
    public bool? EnableCloudMonitoring { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Cloud Run alpha features on this cluster. Selecting this option will result in the cluster having all Cloud Run alpha API groups and features turned on. Cloud Run alpha clusters are not covered by the Cloud Run SLA and should not be used for production workloads.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable confidential storage for the cluster. Enabling Confidential Storage will create boot disk with confidential mode
    /// </summary>
    [CliFlag("--enable-confidential-storage")]
    public bool? EnableConfidentialStorage { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable the cost management feature. When enabled, you can get informational GKE cost breakdowns by cluster, namespace and label in your billing data exported to BigQuery (https://cloud.google.com/billing/docs/how-to/export-data-bigquery).
    /// </summary>
    [CliFlag("--enable-cost-allocation")]
    public bool? EnableCostAllocation { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables the new eBPF dataplane for GKE clusters that is required for network security, scalability and visibility features.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-default-compute-class. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable the default compute class to use for the cluster. To disable Default Compute Class in an existing cluster, explicitly set flag --no-enable-default-compute-class.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable FQDN Network Policies on the cluster. FQDN Network Policies are disabled by default.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable the use of GVNIC for this cluster. Requires re-creation of nodes using either a node-pool upgrade or node-pool creation.
    /// </summary>
    [CliFlag("--enable-gvnic")]
    public bool? EnableGvnic { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Identity Service component on the cluster. When enabled, users can authenticate to Kubernetes cluster with external identity providers. Identity Service is by default disabled when creating a new cluster. To disable Identity Service in an existing cluster, explicitly set flag --no-enable-identity-service.
    /// </summary>
    [CliFlag("--enable-identity-service")]
    public bool? EnableIdentityService { get; set; }

    /// <summary>
    /// Negates --enable-identity-service. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Identity Service component on the cluster. When enabled, users can authenticate to Kubernetes cluster with external identity providers. Identity Service is by default disabled when creating a new cluster. To disable Identity Service in an existing cluster, explicitly set flag --no-enable-identity-service.
    /// </summary>
    [CliFlag("--no-enable-identity-service")]
    public bool? NoEnableIdentityService { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Image Streaming for the cluster, allowing nodes to stream container image data from Artifact Registry on demand to reduce container start times. This flag sets the default for new node pools. It is enabled by default on Autopilot clusters. See Image Streaming documentation (https://cloud.google.com/kubernetes-engine/docs/how-to/image-streaming) for full requirements (including version, API enablement and Artifact Registry usage). To disable Image Streaming for the cluster, use --no-enable-image-streaming.
    /// </summary>
    [CliFlag("--enable-image-streaming")]
    public bool? EnableImageStreaming { get; set; }

    /// <summary>
    /// Negates --enable-image-streaming. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Image Streaming for the cluster, allowing nodes to stream container image data from Artifact Registry on demand to reduce container start times. This flag sets the default for new node pools. It is enabled by default on Autopilot clusters. See Image Streaming documentation (https://cloud.google.com/kubernetes-engine/docs/how-to/image-streaming) for full requirements (including version, API enablement and Artifact Registry usage). To disable Image Streaming for the cluster, use --no-enable-image-streaming.
    /// </summary>
    [CliFlag("--no-enable-image-streaming")]
    public bool? NoEnableImageStreaming { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables the Kubelet's insecure read only port. To disable the readonly port on a cluster or node-pool set the flag to --no-enable-insecure-kubelet-readonly-port.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Intra-node visibility for this cluster. Enabling intra-node visibility makes your intra-node pod-to-pod traffic visible to the networking fabric. With this feature, you can use VPC flow logging or other VPC features for intra-node traffic. Enabling it on an existing cluster causes the cluster master and the cluster nodes to restart, which might cause a disruption.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-kernel-module-signature-enforcement. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enforces that kernel modules are signed on all new nodes in the cluster unless explicitly overridden with --no-enable-kernel-module-signature-enforcement when creating the nodepool. Use --no-enable-kernel-module-signature-enforcement to disable. Examples: $ gcloud container clusters create example-cluster \ --enable-kernel-module-signature-enforcement
    /// </summary>
    [CliFlag("--no-enable-kernel-module-signature-enforcement")]
    public bool? NoEnableKernelModuleSignatureEnforcement { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Kubernetes alpha features on this cluster. Selecting this option will result in the cluster having all Kubernetes alpha API groups and features turned on. Cluster upgrades (both manual and automatic) will be disabled and the cluster will be automatically deleted after 30 days. Alpha clusters are not covered by the Kubernetes Engine SLA and should not be used for production workloads.
    /// </summary>
    [CliFlag("--enable-kubernetes-alpha")]
    public bool? EnableKubernetesAlpha { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Kubernetes beta API features on this cluster. Beta APIs are not expected to be production ready and should be avoided in production-grade environments. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables managed collection for Managed Service for Prometheus in the cluster. See https://cloud.google.com/stackdriver/docs/managed-prometheus/setup-managed#enable-mgdcoll-gke for more info. Enabled by default for cluster versions 1.27 or greater, use --no-enable-managed-prometheus to disable.
    /// </summary>
    [CliFlag("--enable-managed-prometheus")]
    public bool? EnableManagedPrometheus { get; set; }

    /// <summary>
    /// Negates --enable-managed-prometheus. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables managed collection for Managed Service for Prometheus in the cluster. See https://cloud.google.com/stackdriver/docs/managed-prometheus/setup-managed#enable-mgdcoll-gke for more info. Enabled by default for cluster versions 1.27 or greater, use --no-enable-managed-prometheus to disable.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables the use of nested virtualization on the default initial node pool. Defaults to false. Can only be enabled on UBUNTU_CONTAINERD base image or COS_CONTAINERD base image with version 1.28.4-gke.1083000 and above.
    /// </summary>
    [CliFlag("--enable-nested-virtualization")]
    public bool? EnableNestedVirtualization { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable network policy enforcement for this cluster. If you are enabling network policy on an existing cluster the network policy addon must first be enabled on the master by using --update-addons=NetworkPolicy=ENABLED flag.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables use of services with externalIPs field.
    /// </summary>
    [CliFlag("--enable-service-externalips")]
    public bool? EnableServiceExternalips { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Shielded Nodes for this cluster. Enabling Shielded Nodes will enable a more secure Node credential bootstrapping implementation. Starting with version 1.18, clusters will have Shielded GKE nodes by default.
    /// </summary>
    [CliFlag("--enable-shielded-nodes")]
    public bool? EnableShieldedNodes { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Slice Controller for the cluster. Use --no-enable-slice-controller to disable.
    /// </summary>
    [CliFlag("--enable-slice-controller")]
    public bool? EnableSliceController { get; set; }

    /// <summary>
    /// Negates --enable-slice-controller. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Slice Controller for the cluster. Use --no-enable-slice-controller to disable.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enable Dataplane V2 in-transit encryption. Dataplane v2 in-transit encryption is disabled by default. IN_TRANSIT_ENCRYPTION must be one of: inter-node-transparent, none.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Compute Engine metadata to be made available to the guest operating system running on nodes within the node pool. Each metadata entry is a key/value pair separated by an equals sign. Metadata keys must be unique and less than 128 bytes in length. Values must be less than or equal to 32,768 bytes in length. The total size of all keys and values must be less than 512 KB. Multiple arguments can be passed to this flag. For example: --metadata key-1=value-1,key-2=value-2,key-3=value-3 Additionally, the following keys are reserved for use by Kubernetes Engine: ◆ cluster-location ◆ cluster-name ◆ cluster-uid ◆ configure-sh ◆ enable-os-login ◆ gci-update-strategy ◆ gci-ensure-gke-docker ◆ instance-template ◆ kube-env ◆ startup-script ◆ user-data Google Kubernetes Engine sets the following keys by default: ◆ serial-port-logging-enable See also Compute Engine's documentation (https://cloud.google.com/compute/docs/storing-retrieving-metadata) on storing and retrieving instance metadata.
    /// </summary>
    [CliOption("--metadata", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? Metadata { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Same as --metadata except that the value for the entry will be read from a local file. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. When specified, the nodes for the new cluster's default node pool will be scheduled on host with specified CPU architecture or a newer one. Examples: $ gcloud container clusters create example-cluster \ --min-cpu-platform=PLATFORM To list available CPU platforms in given zone, run: $ gcloud beta compute zones describe ZONE \ --format="value(availableCpuPlatforms)" CPU platform selection is available only in selected zones.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Enables monitoring and attestation of the boot integrity of the instance. The attestation is performed against the integrity policy baseline. This baseline is initially derived from the implicitly trusted boot image when the instance is created.
    /// </summary>
    [CliFlag("--shielded-integrity-monitoring")]
    public bool? ShieldedIntegrityMonitoring { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. The instance will boot with secure boot enabled.
    /// </summary>
    [CliFlag("--shielded-secure-boot")]
    public bool? ShieldedSecureBoot { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Create nodes using spot VM instances in the new cluster. $ gcloud container clusters create example-cluster --spot New nodes, including ones created by resize or recreate, will use spot VM instances.
    /// </summary>
    [CliFlag("--spot")]
    public bool? Spot { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. IP stack type of the cluster nodes. STACK_TYPE must be one of: ipv4, ipv4-ipv6.
    /// </summary>
    [CliOption("--stack-type", Format = OptionFormat.EqualsSeparated)]
    public GcloudStackType? StackType { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. A list of storage pools where the cluster's boot disks will be provisioned. STORAGE_POOL must be in the format projects/project/zones/zone/storagePools/storagePool Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Flags for Binary Authorization: At most one of these can be specified: Enable Binary Authorization for this cluster. BINAUTHZ_EVALUATION_MODE must be one of: disabled, project-singleton-policy-enforce.
    /// </summary>
    [CliOption("--binauthz-evaluation-mode", Format = OptionFormat.EqualsSeparated)]
    public string? BinauthzEvaluationMode { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Flags for Binary Authorization: At most one of these can be specified: (DEPRECATED) Enable Binary Authorization for this cluster. The --enable-binauthz flag is deprecated. Please use --binauthz-evaluation-mode instead.
    /// </summary>
    [CliFlag("--enable-binauthz")]
    public bool? EnableBinauthz { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Configure the Provisioned IOPS for the node pool boot disks. Only valid for hyperdisk-balanced boot disks.
    /// </summary>
    [CliOption("--boot-disk-provisioned-iops", Format = OptionFormat.EqualsSeparated)]
    public int? BootDiskProvisionedIops { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Configure the Provisioned Throughput for the node pool boot disks. Only valid for hyperdisk-balanced boot disks.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. DNS provider to use for this cluster. CLUSTER_DNS must be one of: clouddns Selects Cloud DNS as the DNS provider for the cluster. default Selects the default DNS provider (kube-dns) for the cluster. kubedns Selects Kube DNS as the DNS provider for the cluster.
    /// </summary>
    [CliOption("--cluster-dns", Format = OptionFormat.EqualsSeparated)]
    public string? ClusterDns { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. DNS domain for this cluster. The default value is cluster.local. This is configurable when --cluster-dns=clouddns and --cluster-dns-scope=vpc are set. The value must be a valid DNS subdomain as defined in RFC 1123.
    /// </summary>
    [CliOption("--cluster-dns-domain", Format = OptionFormat.EqualsSeparated)]
    public string? ClusterDnsDomain { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. DNS scope for the Cloud DNS zone created - valid only with --cluster-dns=clouddns. Defaults to cluster. CLUSTER_DNS_SCOPE must be one of: cluster Configures the Cloud DNS zone to be private to the cluster. vpc Configures the Cloud DNS zone to be private to the VPC Network.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. At most one of these can be specified: Stops exposing advanced datapath flow metrics on node port.
    /// </summary>
    [CliFlag("--disable-dataplane-v2-metrics")]
    public bool? DisableDataplaneV2Metrics { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. At most one of these can be specified: Exposes advanced datapath flow metrics on node port.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. At most one of these can be specified: Or at least one of these can be specified: Flags to configure autoprovisioned nodes Flags to specify upgrade settings for autoprovisioned nodes: Flags to specify identity for autoprovisioned nodes: Flags to specify node management settings for autoprovisioned nodes: Arguments to set limits on accelerators: Node Autoprovisioning will create new nodes with the specified image type
    /// </summary>
    [CliOption("--autoprovisioning-image-type", Format = OptionFormat.EqualsSeparated)]
    public string? AutoprovisioningImageType { get; set; }

    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. At most one of these can be specified: Or at least one of these can be specified: Flags to configure autoprovisioned nodes Flags to specify upgrade settings for autoprovisioned nodes: Flags to specify identity for autoprovisioned nodes: Flags to specify node management settings for autoprovisioned nodes: Arguments to set limits on accelerators: Set of zones where new node pools can be created by autoprovisioning. All zones must be in the same region as the cluster's master(s). Multiple locations can be specified, separated by commas. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-autoprovisioning-autorepair. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. At most one of these can be specified: Or at least one of these can be specified: Flags to configure autoprovisioned nodes Flags to specify upgrade settings for autoprovisioned nodes: Flags to specify identity for autoprovisioned nodes: Flags to specify node management settings for autoprovisioned nodes: Arguments to set limits on accelerators: Enable node autorepair for autoprovisioned node pools. Use --no-enable-autoprovisioning-autorepair to disable. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-autoprovisioning-autoupgrade. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. At most one of these can be specified: Or at least one of these can be specified: Flags to configure autoprovisioned nodes Flags to specify upgrade settings for autoprovisioned nodes: Flags to specify identity for autoprovisioned nodes: Flags to specify node management settings for autoprovisioned nodes: Arguments to set limits on accelerators: Enable node autoupgrade for autoprovisioned node pools. Use --no-enable-autoprovisioning-autoupgrade to disable. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-insecure-binding-system-authenticated. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Allow using system:authenticated as a subject in ClusterRoleBindings and RoleBindings. Allowing bindings that reference system:authenticated is a security risk and is not recommended. To disallow binding system:authenticated in a cluster, explicitly set the --no-enable-insecure-binding-system-authenticated flag instead.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-insecure-binding-system-unauthenticated. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Allow using system:unauthenticated and system:anonymous as subjects in ClusterRoleBindings and RoleBindings. Allowing bindings that reference system:unauthenticated and system:anonymous are a security risk and is not recommended. To disallow binding system:authenticated in a cluster, explicitly set the --no-enable-insecure-binding-system-unauthenticated flag instead.
    /// </summary>
    ...
    /// <summary>
    /// Negates --enable-master-authorized-networks. Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. Allow only specified set of CIDR blocks (specified by the --master-authorized-networks flag) to connect to Kubernetes master through HTTPS. Besides these blocks, the following have access as well: 1) The private network the cluster connects to if `--enable-private-nodes` is specified. 2) Google Compute Engine Public IPs if `--enable-private-nodes` is not specified. Use --no-enable-master-authorized-networks to disable. When disabled, public internet (0.0.0.0/0) is allowed to connect to Kubernetes master through HTTPS.
    /// </summary>
    ...
    /// <summary>
    /// Flags for vertical pod autoscaling: Control Plane Keys Configure boot disk options. ClusterDNS Node autoprovisioning Cluster autoscaling Master Authorized Networks Exports cluster's usage of cloud resources Private Clusters Flags for Secret Manager configuration: Flags for Secret Sync configuration: Flags for cluster disruption budget configuration: Basic auth Specifies the reservation for the default initial node pool. Options to specify the node identity. Scopes options. The password to use for cluster auth. Defaults to a server-specified randomly-generated string.
    /// </summary>
    [SecretValue]
