...
public record GcloudPreviewComputeInstancesNetworkInterfacesUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a     Compute Engine virtual machine network interface
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesNetworkInterfacesUpdateOptions(
        string InstanceName
    )
    {
