...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/reservations/remove-iam-policy-binding
...
[CliSubCommand("compute", "reservations", "remove-iam-policy-binding")]
public record GcloudComputeReservationsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding from a Compute Engine reservation
    /// </summary>
    ...
    public GcloudComputeReservationsRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string Reservation
    )
