...
public record GcloudComputeNetworkFirewallPoliciesMirroringRulesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudComputeNetworkFirewallPoliciesMirroringRulesCreateOptions(
        GcloudComputeNetworkFirewallPoliciesMirroringRulesCreateAction Action,
    ...
    public void Deconstruct(out GcloudComputeNetworkFirewallPoliciesMirroringRulesCreateAction Action, out string FirewallPolicy, out IEnumerable<string> Layer4Configs, out string Priority)
    {
        Action = this.Action;
    ...
    public GcloudComputeNetworkFirewallPoliciesMirroringRulesCreateAction Action { get; private init; }
    ...
    public GcloudComputeNetworkFirewallPoliciesMirroringRulesCreateDirection? Direction { get; set; }
