...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-identity/auth-providers/enable
...
[CliSubCommand("agent-identity", "auth-providers", "enable")]
public record GcloudAgentIdentityAuthProvidersEnableOptions : GcloudOptions
{
    /// <summary>
    /// enable an auth provider
    /// </summary>
    ...
    public GcloudAgentIdentityAuthProvidersEnableOptions(
        string AuthProvider
    )
    {
