...
public record GcloudActiveDirectoryDomainsUpdateLdapsSettingsOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((ClearCertificates == true || !string.IsNullOrWhiteSpace(CertificatePfxFile) || !string.IsNullOrWhiteSpace(CertificatePassword)) && (!string.IsNullOrWhiteSpace(CertificatePfxFile) || !string.IsNullOrWhiteSpace(CertificatePassword)) && (!(!string.IsNullOrWhiteSpace(CertificatePfxFile))))
        {
            yield return new ValidationResult("CertificatePfxFile must be specified when other arguments in this group are specified.", [nameof(CertificatePfxFile)]);
        }
        yield break;
    }
