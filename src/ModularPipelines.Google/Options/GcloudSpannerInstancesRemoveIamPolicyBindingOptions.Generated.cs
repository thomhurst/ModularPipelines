...
public record GcloudSpannerInstancesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding of a Cloud Spanner instance
    /// </summary>
    ...
    public GcloudSpannerInstancesRemoveIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
