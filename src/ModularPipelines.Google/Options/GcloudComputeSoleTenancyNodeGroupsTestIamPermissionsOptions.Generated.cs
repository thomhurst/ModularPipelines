...
public record GcloudComputeSoleTenancyNodeGroupsTestIamPermissionsOptions : GcloudOptions
{
    ...
    public void Deconstruct(out IEnumerable<string> Permissions, out string NodeGroup)
    {
