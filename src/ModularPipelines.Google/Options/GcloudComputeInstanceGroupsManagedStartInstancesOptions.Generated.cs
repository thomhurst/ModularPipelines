...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/instance-groups/managed/start-instances
...
[CliSubCommand("compute", "instance-groups", "managed", "start-instances")]
public record GcloudComputeInstanceGroupsManagedStartInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// start the stopped     instances in a managed instance group
    /// </summary>
    /// <param name="Instances">Names of instances to start. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedStartInstancesOptions(
    ...
    /// <summary>
    /// Names of instances to start. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
