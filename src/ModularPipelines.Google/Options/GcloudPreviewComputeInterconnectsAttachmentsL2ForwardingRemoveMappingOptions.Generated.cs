...
public record GcloudPreviewComputeInterconnectsAttachmentsL2ForwardingRemoveMappingOptions : GcloudOptions
{
    /// <summary>
    /// forwarding     remove-mapping - remove vlan to ip mapping rule to an L2-forwarding     attachment
    /// </summary>
    ...
    public GcloudPreviewComputeInterconnectsAttachmentsL2ForwardingRemoveMappingOptions(
        string VlanKey,
        string Name
    )
    {
