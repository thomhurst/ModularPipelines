...
public record GcloudContainerVmwareClustersUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Upgrade policy for the cluster. Anthos Cluster on VMware version for the cluster resource
    /// </summary>
    ...
    /// <summary>
    /// Control plane node configurations Megabytes of memory for each admin cluster node that serves as a control plane for this VMware User Cluster (default: 8192 MB memory).
    /// </summary>
