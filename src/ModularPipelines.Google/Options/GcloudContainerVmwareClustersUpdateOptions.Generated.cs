...
public record GcloudContainerVmwareClustersUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Anthos Cluster on VMware version for the cluster resource    At most one of these can be specified:     --add-annotations=[KEY1=VALUE1,KEY2=VALUE2,...]      Add the given key-value pairs to the current annotations, or update      its value if the key already exists.     --remove-annotations=[KEY1,KEY2,...]      Remove annotations of the given keys.    Control plane node configurations
    /// </summary>
