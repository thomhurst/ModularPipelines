...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/hub/policycontroller/deployment/set
...
[CliSubCommand("container", "hub", "policycontroller", "deployment", "set")]
public record GcloudContainerHubPolicycontrollerDeploymentSetOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// sets configuration     of the Policy Controller components
    /// </summary>
    ...
    public GcloudContainerHubPolicycontrollerDeploymentSetOptions(
        string Deployment,
        string Property,
        string Value
    )
    ...
    public GcloudContainerHubPolicycontrollerDeploymentSetEffect? Effect { get; set; }
