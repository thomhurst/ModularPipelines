...
public record GcloudSccFindingsSetMuteOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudSccFindingsSetMuteOptions(
        GcloudSccFindingsSetMuteMute Mute,
        string Finding
    )
    {
        this.Mute = Mute;
    ...
    public void Deconstruct(out GcloudSccFindingsSetMuteMute Mute, out string Finding)
    {
        Mute = this.Mute;
    ...
    public GcloudSccFindingsSetMuteMute Mute { get; private init; }
