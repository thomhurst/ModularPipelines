...
// Source: https://cloud.google.com/sdk/gcloud/reference/dataproc/workflow-templates/add-job/hive
...
public record GcloudDataprocWorkflowTemplatesAddJobHiveOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add a Hive job to the     workflow template
    /// </summary>
    ...
    public GcloudDataprocWorkflowTemplatesAddJobHiveOptions(
        string StepId,
    ...
    /// <summary>
    /// Comma separated list of jar files to be provided to the Hive and MR. May contain UDFs. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
