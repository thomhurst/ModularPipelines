...
public record GcloudDataplexLakesCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Settings to manage metadata publishing to a Hive Metastore from a lake. Validate the create action, but don't actually perform it.
    /// </summary>
