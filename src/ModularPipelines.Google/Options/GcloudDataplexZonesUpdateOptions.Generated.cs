...
public record GcloudDataplexZonesUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Settings to manage the metadata discovery and publishing. Determines when discovery jobs are triggered. Describe data formats. Describe CSV and similar semi-structured data formats. Describe JSON data format. Display Name
    /// </summary>
