...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/security-policies/rules/update
...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. If specified, the action will not be enforced. Use --preview to enable and --no-preview to disable.
    /// </summary>
    [CliFlag("--preview")]
    public bool? Preview { get; set; }

    /// <summary>
    /// Negates --preview. Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. If specified, the action will not be enforced. Use --preview to enable and --no-preview to disable.
    /// </summary>
    [CliFlag("--no-preview")]
    public bool? NoPreview { get; set; }

    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. Number of HTTP(S) requests for calculating the threshold for rate limiting requests.
    /// </summary>
    [CliOption("--rate-limit-threshold-count", Format = OptionFormat.EqualsSeparated)]
    public int? RateLimitThresholdCount { get; set; }

    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. Interval over which the threshold for rate limiting requests is computed.
    /// </summary>
    ...
    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. URL target for the redirect action. Must be specified if the redirect type is external-302. Cannot be specified if the redirect type is google-recaptcha.
    /// </summary>
    [CliOption("--redirect-target", Format = OptionFormat.EqualsSeparated)]
    public string? RedirectTarget { get; set; }

    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. Type for the redirect action. Default to external-302 if unspecified while --redirect-target is given. REDIRECT_TYPE must be one of: google-recaptcha, external-302.
    /// </summary>
    [CliOption("--redirect-type", Format = OptionFormat.EqualsSeparated)]
    public GcloudRedirectType? RedirectType { get; set; }

    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. Region of the security policy to update. If not specified, you might be prompted to select a region (interactive mode only). A list of regions can be fetched by running: $ gcloud compute regions list Overrides the default compute/region property value for this command invocation.
    /// </summary>
    ...
    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. The security policy that this rule belongs to.
    /// </summary>
    [CliOption("--security-policy", Format = OptionFormat.EqualsSeparated)]
    public string? SecurityPolicy { get; set; }

    /// <summary>
    /// Security policy rule matcher. --network-user-defined-fields=[NAME;VALUE:VALUE:...,...] Each element names a defined field and lists the matching values for that field. The Cloud Armor rules language expression to match for this rule.
    /// </summary>
