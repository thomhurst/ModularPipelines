...
) : GcloudOptions
{
    ...
    [Obsolete("AvailabilityDomain is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("CsekKeyFile is no longer supported by the installed CLI and has no effect.")]
    public string? CsekKeyFile { get; set; }

    [Obsolete("DeletionProtection is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("EnableDisplayDevice is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("EraseWindowsVssSignature is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("Hostname is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("Ipv6PublicPtrDomainValues is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("NodeProject is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("RequireCsekKeyCreate is no longer supported by the installed CLI and has no effect.")]
    public bool? RequireCsekKeyCreate { get; set; }

    [Obsolete("NoRequireCsekKeyCreate is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("SourceMachineImage is no longer supported by the installed CLI and has no effect.")]
    public string? SourceMachineImage { get; set; }

    [Obsolete("SourceMachineImageCsekKeyFile is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("ImageFamilyScope is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("SourceSnapshot is no longer supported by the installed CLI and has no effect.")]
    public string? SourceSnapshot { get; set; }

    [Obsolete("InstanceKmsKey is no longer supported by the installed CLI and has no effect.")]
    public string? InstanceKmsKey { get; set; }

    [Obsolete("InstanceKmsKeyring is no longer supported by the installed CLI and has no effect.")]
    public string? InstanceKmsKeyring { get; set; }

    [Obsolete("InstanceKmsLocation is no longer supported by the installed CLI and has no effect.")]
    public string? InstanceKmsLocation { get; set; }

    [Obsolete("InstanceKmsProject is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("Ipv6PublicPtrDomain is no longer supported by the installed CLI and has no effect.")]
