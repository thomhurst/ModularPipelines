...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/create
...
[CliSubCommand("preview", "compute", "instances", "create")]
public record GcloudPreviewComputeInstancesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create Compute Engine virtual     machine instances
    /// </summary>
    /// <param name="InstanceNames">Names of the instances to create. For details on valid instance names, refer to the criteria documented under the field 'name' at: https://cloud.google.com/compute/docs/reference/rest/v1/instances</param>
    public GcloudPreviewComputeInstancesCreateOptions(
    ...
    public GcloudPreviewComputeInstancesCreateNetworkTier? NetworkTier { get; set; }
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. At most one of these can be specified: (DEPRECATED) The instance boots with Confidential Computing enabled. Confidential Computing is based on Secure Encrypted Virtualization (SEV), an AMD virtualization feature for running confidential instances. The --confidential-compute flag will soon be deprecated. Please use --confidential-compute-type=SEV instead
    /// </summary>
    [CliFlag("--confidential-compute")]
    public bool? ConfidentialCompute { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. At most one of these can be specified: The instance boots with Confidential Computing enabled. Confidential Computing can be based on Secure Encrypted Virtualization (SEV) or Secure Encrypted Virtualization - Secure Nested Paging (SEV-SNP), both of which are AMD virtualization features for running confidential instances. Trust Domain eXtension based on Intel virtualization features for running confidential instances is also supported. Arm Confidential Compute Architecture for running confidential instances is also supported. Bare Metal Secure AI for running confidential instances is also supported. CONFIDENTIAL_COMPUTE_TYPE must be one of: BMSAI Bare Metal Secure AI CCA Arm Confidential Compute Architecture SEV Secure Encrypted Virtualization SEV_SNP Secure Encrypted Virtualization - Secure Nested Paging TDX Trust Domain eXtension
    /// </summary>
    [CliOption("--confidential-compute-type", Format = OptionFormat.EqualsSeparated)]
    public string? ConfidentialComputeType { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. A whole number value specifying the number of cores that are needed in the custom machine type. For some machine types, shared-core values can also be used. For example, for E2 machine types, you can specify micro, small, or medium. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--custom-cpu", Format = OptionFormat.EqualsSeparated)]
    public string? CustomCpu { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. A whole number value indicating how much memory is desired in the custom machine type. A size unit should be provided (eg. 3072MB or 9GB) - if no units are specified, GB is assumed. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--custom-memory", Format = OptionFormat.EqualsSeparated)]
    public string? CustomMemory { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Use the extended custom machine type.
    /// </summary>
    [CliFlag("--custom-extensions")]
    public bool? CustomExtensions { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies a custom machine type. The default is n1. For more information about custom machine types, see: https://cloud.google.com/compute/docs/general-purpose-machines#custom_machine_types
    /// </summary>
    [CliOption("--custom-vm-type", Format = OptionFormat.EqualsSeparated)]
    public string? CustomVmType { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Sets the scope for the --image-family flag. By default, when specifying an image family in a public image project, the zonal image family scope is used. All other projects default to the global image. Use this flag to override this behavior. IMAGE_FAMILY_SCOPE must be one of: zonal, global.
    /// </summary>
    [CliOption("--image-family-scope", Format = OptionFormat.EqualsSeparated)]
    public GcloudPreviewComputeInstancesCreateImageFamilyScope? ImageFamilyScope { get; set; }
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the instance. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Specifies the reservation for the instance. At most one of these can be specified: Create instance without scopes
    /// </summary>
    [CliFlag("--no-scopes")]
    public bool? NoScopes { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the instance. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Specifies the reservation for the instance. At most one of these can be specified: A service account is an identity attached to the instance. Its access tokens can be accessed through the instance metadata server and are used to authenticate applications on the instance. The account can be set using an email address corresponding to the required service account. If not provided, the instance will use the project's default service account.
    /// </summary>
    [CliOption("--service-account", Format = OptionFormat.EqualsSeparated)]
    public string? ServiceAccount { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the instance. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Specifies the reservation for the instance. At most one of these can be specified: Create instance without service account
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(BootDiskKmsKey) || !string.IsNullOrWhiteSpace(BootDiskKmsKeyring) || !string.IsNullOrWhiteSpace(BootDiskKmsLocation) || !string.IsNullOrWhiteSpace(BootDiskKmsProject) || !string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || (object?)ImageFamilyScope is not null || !string.IsNullOrWhiteSpace(ImageProject) || ConfidentialCompute == true || !string.IsNullOrWhiteSpace(ConfidentialComputeType) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || !string.IsNullOrWhiteSpace(SourceSnapshot)) && (!(!string.IsNullOrWhiteSpace(CustomCpu))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(BootDiskKmsKey) || !string.IsNullOrWhiteSpace(BootDiskKmsKeyring) || !string.IsNullOrWhiteSpace(BootDiskKmsLocation) || !string.IsNullOrWhiteSpace(BootDiskKmsProject) || !string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || (object?)ImageFamilyScope is not null || !string.IsNullOrWhiteSpace(ImageProject) || ConfidentialCompute == true || !string.IsNullOrWhiteSpace(ConfidentialComputeType) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || !string.IsNullOrWhiteSpace(SourceSnapshot)) && (!(!string.IsNullOrWhiteSpace(CustomMemory))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(BootDiskKmsKey) || !string.IsNullOrWhiteSpace(BootDiskKmsKeyring) || !string.IsNullOrWhiteSpace(BootDiskKmsLocation) || !string.IsNullOrWhiteSpace(BootDiskKmsProject) || !string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || (object?)ImageFamilyScope is not null || !string.IsNullOrWhiteSpace(ImageProject) || ConfidentialCompute == true || !string.IsNullOrWhiteSpace(ConfidentialComputeType) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || !string.IsNullOrWhiteSpace(SourceSnapshot)) && ((ConfidentialCompute == true ? 1 : 0) + (!string.IsNullOrWhiteSpace(ConfidentialComputeType) ? 1 : 0) > 1))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(BootDiskKmsKey) || !string.IsNullOrWhiteSpace(BootDiskKmsKeyring) || !string.IsNullOrWhiteSpace(BootDiskKmsLocation) || !string.IsNullOrWhiteSpace(BootDiskKmsProject) || !string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || (object?)ImageFamilyScope is not null || !string.IsNullOrWhiteSpace(ImageProject) || ConfidentialCompute == true || !string.IsNullOrWhiteSpace(ConfidentialComputeType) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || !string.IsNullOrWhiteSpace(SourceSnapshot)) && ((!string.IsNullOrWhiteSpace(Image) ? 1 : 0) + (!string.IsNullOrWhiteSpace(ImageFamily) ? 1 : 0) + (!string.IsNullOrWhiteSpace(SourceSnapshot) ? 1 : 0) > 1))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(InstanceKmsKey) || !string.IsNullOrWhiteSpace(InstanceKmsKeyring) || !string.IsNullOrWhiteSpace(InstanceKmsLocation) || !string.IsNullOrWhiteSpace(InstanceKmsProject) || !string.IsNullOrWhiteSpace(Reservation) || !string.IsNullOrWhiteSpace(ReservationAffinity) || !string.IsNullOrWhiteSpace(Node) || !string.IsNullOrWhiteSpace(NodeAffinityFile) || !string.IsNullOrWhiteSpace(NodeGroup) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true || ((object?)Scopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)Scopes is not string || !string.IsNullOrWhiteSpace(Scopes?.ToString()) : ((object?)Scopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Scopes, static item => item is not null) : (Scopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Scopes), static item => item is not null)))) || NoScopes == true || !string.IsNullOrWhiteSpace(ServiceAccount) || NoServiceAccount == true) && (!(!string.IsNullOrWhiteSpace(InstanceKmsKey))))
        {
            yield return new ValidationResult("InstanceKmsKey must be specified when other arguments in this group are specified.", [nameof(InstanceKmsKey)]);
        }
        ...
        if ((!string.IsNullOrWhiteSpace(InstanceKmsKey) || !string.IsNullOrWhiteSpace(InstanceKmsKeyring) || !string.IsNullOrWhiteSpace(InstanceKmsLocation) || !string.IsNullOrWhiteSpace(InstanceKmsProject) || !string.IsNullOrWhiteSpace(Reservation) || !string.IsNullOrWhiteSpace(ReservationAffinity) || !string.IsNullOrWhiteSpace(Node) || !string.IsNullOrWhiteSpace(NodeAffinityFile) || !string.IsNullOrWhiteSpace(NodeGroup) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true || ((object?)Scopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)Scopes is not string || !string.IsNullOrWhiteSpace(Scopes?.ToString()) : ((object?)Scopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Scopes, static item => item is not null) : (Scopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Scopes), static item => item is not null)))) || NoScopes == true || !string.IsNullOrWhiteSpace(ServiceAccount) || NoServiceAccount == true) && ((PublicPtr == true ? 1 : 0) + (NoPublicPtr == true ? 1 : 0) > 1))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(InstanceKmsKey) || !string.IsNullOrWhiteSpace(InstanceKmsKeyring) || !string.IsNullOrWhiteSpace(InstanceKmsLocation) || !string.IsNullOrWhiteSpace(InstanceKmsProject) || !string.IsNullOrWhiteSpace(Reservation) || !string.IsNullOrWhiteSpace(ReservationAffinity) || !string.IsNullOrWhiteSpace(Node) || !string.IsNullOrWhiteSpace(NodeAffinityFile) || !string.IsNullOrWhiteSpace(NodeGroup) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true || ((object?)Scopes is global::System.Collections.Generic.IEnumerable<char> ? (object?)Scopes is not string || !string.IsNullOrWhiteSpace(Scopes?.ToString()) : ((object?)Scopes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Scopes, static item => item is not null) : (Scopes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Scopes), static item => item is not null)))) || NoScopes == true || !string.IsNullOrWhiteSpace(ServiceAccount) || NoServiceAccount == true) && ((!string.IsNullOrWhiteSpace(PublicPtrDomain) ? 1 : 0) + (NoPublicPtrDomain == true ? 1 : 0) > 1))
        {
