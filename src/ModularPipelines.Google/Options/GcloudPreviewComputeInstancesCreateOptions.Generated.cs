...
) : GcloudOptions
{
    ...
    /// <summary>
    /// The Google Cloud project for the key. To set the kms-project attribute: * provide the argument --boot-disk-kms-key on the command line with a fully specified name; * provide the argument --boot-disk-kms-project on the command line; * set the property core/project.
    /// </summary>
    ...
    /// <summary>
    /// The name of the source disk snapshot that the instance boot disk will be created from. You can provide this as a full URL to the snapshot or just the snapshot name. For example, the following are valid values: + https://compute.googleapis.com/compute/v1/projects/myproject/global/snapshots/snapshot + snapshot
    /// </summary>
    ...
    /// <summary>
    /// The Google Cloud project for the key. To set the kms-project attribute: * provide the argument --instance-kms-key on the command line with a fully specified name; * provide the argument --instance-kms-project on the command line; * set the property core/project.
    /// </summary>
