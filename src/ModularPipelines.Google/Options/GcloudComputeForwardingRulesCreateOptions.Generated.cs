...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/forwarding-rules/create
...
[CliSubCommand("compute", "forwarding-rules", "create")]
public record GcloudComputeForwardingRulesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a forwarding rule to direct     network traffic to a load balancer
    /// </summary>
    /// <param name="Name">Name of the forwarding rule to create.</param>
    public GcloudComputeForwardingRulesCreateOptions(
        string Name
    )
    {
    ...
    public GcloudComputeForwardingRulesCreateIpProtocol? IpProtocol { get; set; }
    ...
    public GcloudComputeForwardingRulesCreateIpVersion? IpVersion { get; set; }
    ...
    public GcloudComputeForwardingRulesCreateNetworkTier? NetworkTier { get; set; }
