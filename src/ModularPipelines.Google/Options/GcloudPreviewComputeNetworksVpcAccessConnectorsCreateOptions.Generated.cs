...
public record GcloudPreviewComputeNetworksVpcAccessConnectorsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a VPC     Access connector
    /// </summary>
    ...
    public GcloudPreviewComputeNetworksVpcAccessConnectorsCreateOptions(
        string Connector
    )
    {
