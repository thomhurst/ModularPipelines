...
public record GcloudIamWorkforcePoolsProvidersUpdateSamlOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a new SAML     workforce pool provider
    /// </summary>
    ...
    public GcloudIamWorkforcePoolsProvidersUpdateSamlOptions(
        string Provider
    )
    {
    ...
    public GcloudIamWorkforcePoolsProvidersUpdateSamlExtraAttributesType? ExtraAttributesType { get; set; }
    ...
    public GcloudIamWorkforcePoolsProvidersUpdateSamlScimUsage? ScimUsage { get; set; }
