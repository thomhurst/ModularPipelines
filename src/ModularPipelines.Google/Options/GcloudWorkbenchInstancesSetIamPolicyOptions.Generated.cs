...
public record GcloudWorkbenchInstancesSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudWorkbenchInstancesSetIamPolicyOptions(
        string Instance,
        string PolicyFile
    )
    {
