...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-connectivity/spokes/gateways/update
...
public record GcloudNetworkConnectivitySpokesGatewaysUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// New gateway capacity of the spoke. CAPACITY must be one of: 10g, 1g.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud network-connectivity spokes gateways update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud network-connectivity spokes gateways update \ --clear-labels --update-labels foo=bar,baz=qux
    /// </summary>
