...
public record GcloudDataplexAspectTypesAddIamPolicyBindingOptions : GcloudOptions
{
    ...
    public void Deconstruct(out string Member, out string Role, out string AspectType)
    {
        Member = this.Member;
        Role = this.Role;
