...
// Source: https://cloud.google.com/sdk/gcloud/reference/vector-search/operations/cancel
...
[CliSubCommand("vector-search", "operations", "cancel")]
public record GcloudVectorSearchOperationsCancelOptions : GcloudOptions
{
    /// <summary>
    /// cancel an operation
    /// </summary>
    ...
    public GcloudVectorSearchOperationsCancelOptions(
        string Operation
    )
    {
