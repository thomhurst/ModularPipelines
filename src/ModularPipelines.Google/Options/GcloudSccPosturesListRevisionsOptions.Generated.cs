...
public record GcloudSccPosturesListRevisionsOptions : GcloudOptions
{
    ...
    /// list the revisions of a Cloud Security     Command Center posture
    /// </summary>
    /// <param name="Posture">Posture resource - The posture whose revisions are to be listed. For example organizations/&lt;organizationID&gt;/locations/&lt;location&gt;/postures/&lt;postureID&gt;. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the posture or fully qualified identifier for the posture. To set the posture attribute: ▸ provide the argument posture on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudSccPosturesListRevisionsOptions(
        string Posture
    )
    {
