...
public record GcloudOracleDatabaseCloudVmClustersCreateOptions(
    [property: CliOption("--exadata-infrastructure", Format = OptionFormat.EqualsSeparated)] string ExadataInfrastructure
) : GcloudOptions
{
    /// <summary>
