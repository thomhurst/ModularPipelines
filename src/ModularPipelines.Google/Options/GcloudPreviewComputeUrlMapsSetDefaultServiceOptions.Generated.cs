...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/url-maps/set-default-service
...
[CliSubCommand("preview", "compute", "url-maps", "set-default-service")]
public record GcloudPreviewComputeUrlMapsSetDefaultServiceOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// change the default     service or default bucket of a URL map
    /// </summary>
    /// <param name="UrlMap">Name of the URL map to operate on.</param>
    public GcloudPreviewComputeUrlMapsSetDefaultServiceOptions(
        string UrlMap
    )
    {
