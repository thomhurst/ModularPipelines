...
public record GcloudSpannerDatabasesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding of a Cloud Spanner database
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Database)
    {
        Member = this.Member;
        Role = this.Role;
    ...
    /// <summary>
    /// Database resource - The Cloud Spanner database to remove the IAM policy binding from. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument database on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. The name of the Cloud Spanner instance. To set the instance attribute: ▸ provide the argument database on the command line with a fully specified name; ▸ provide the argument --instance on the command line; ▸ set the property spanner/instance.
    /// </summary>
