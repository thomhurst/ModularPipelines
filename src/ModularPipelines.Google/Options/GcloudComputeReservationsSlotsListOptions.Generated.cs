...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/reservations/slots/list
...
[CliSubCommand("compute", "reservations", "slots", "list")]
public record GcloudComputeReservationsSlotsListOptions : GcloudOptions
{
    /// <summary>
    /// list Compute Engine reservation     slots
    /// </summary>
    ...
    public GcloudComputeReservationsSlotsListOptions(
        string BlockName,
        string SubBlockName,
        string Reservation
    )
