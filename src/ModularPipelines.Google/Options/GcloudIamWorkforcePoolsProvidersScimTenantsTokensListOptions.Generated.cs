...
public record GcloudIamWorkforcePoolsProvidersScimTenantsTokensListOptions(
    [property: CliOption("--scim-tenant", Format = OptionFormat.EqualsSeparated)] string ScimTenant
) : GcloudOptions
{
    /// <summary>
