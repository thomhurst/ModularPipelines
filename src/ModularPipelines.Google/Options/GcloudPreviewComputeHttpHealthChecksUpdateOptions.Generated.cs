...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/http-health-checks/update
...
[CliSubCommand("preview", "compute", "http-health-checks", "update")]
public record GcloudPreviewComputeHttpHealthChecksUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a legacy HTTP     health check
    /// </summary>
    /// <param name="Name">Name of the HTTP health check to update.</param>
    public GcloudPreviewComputeHttpHealthChecksUpdateOptions(
        string Name
    )
    {
