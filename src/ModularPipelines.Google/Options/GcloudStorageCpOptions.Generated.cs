...
) : GcloudOptions
{
    ...
    /// <summary>
    /// --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl Do not automatically decompress downloaded gzip files.
    /// </summary>
    ...
    /// <summary>
    /// --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl Prints the version-specific URL for each copied object.
    /// </summary>
    ...
    /// <summary>
    /// --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl Skip objects with unsupported object types.
    /// </summary>
