...
/// </summary>
/// <param name="Location">▸ provide the argument --connection-profile-name on the command line. Location resource - The location you want to list the connection profiles for. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --location on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the location or fully qualified identifier for the location. To set the location attribute: ▸ provide the argument --location on the command line.</param>
...
) : GcloudOptions, IValidatableObject
{
    ...
    {
        if ((!string.IsNullOrWhiteSpace(ConnectionProfileName) ? 1 : 0) != 1)
        {
            yield return new ValidationResult("Exactly one of ConnectionProfileName must be specified.", [nameof(ConnectionProfileName)]);
        }
    }
