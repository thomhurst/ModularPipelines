...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/os-inventory/describe
...
[CliSubCommand("preview", "compute", "instances", "os-inventory", "describe")]
public record GcloudPreviewComputeInstancesOsInventoryDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a Compute     Engine virtual instance's OS inventory data
    /// </summary>
    /// <param name="InstanceName">Name of the instance to describe. For details on valid instance names, refer to the criteria documented under the field 'name' at: https://cloud.google.com/compute/docs/reference/rest/v1/instances</param>
    public GcloudPreviewComputeInstancesOsInventoryDescribeOptions(
        string InstanceName
    )
    {
