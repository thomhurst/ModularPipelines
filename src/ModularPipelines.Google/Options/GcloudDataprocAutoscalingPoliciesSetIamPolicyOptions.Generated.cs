...
public record GcloudDataprocAutoscalingPoliciesSetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// set IAM policy for an     autoscaling policy
    /// </summary>
    ...
    public GcloudDataprocAutoscalingPoliciesSetIamPolicyOptions(
    ...
    public void Deconstruct(out string AutoscalingPolicy, out string PolicyFile)
    {
