...
public record GcloudNotebooksInstancesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: Use this VM image family to find the image; the newest image in this family will be used.
    /// </summary>
    [CliOption("--vm-image-family", Format = OptionFormat.EqualsSeparated)]
    public string? VmImageFamily { get; set; }

    /// <summary>
    /// At most one of these can be specified: Use this VM image name to find the image.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(Environment) || !string.IsNullOrWhiteSpace(EnvironmentLocation) || !string.IsNullOrWhiteSpace(VmImageProject)) && (!(!string.IsNullOrWhiteSpace(Environment))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(VmImageFamily) ? 1 : 0) + (!string.IsNullOrWhiteSpace(VmImageName) ? 1 : 0) > 1)
        {
