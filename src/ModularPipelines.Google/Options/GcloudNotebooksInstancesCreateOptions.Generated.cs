...
public record GcloudNotebooksInstancesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: At most one of these can be specified: Use this VM image family to find the image; the newest image in this family will be used.
    /// </summary>
    [CliOption("--vm-image-family", Format = OptionFormat.EqualsSeparated)]
    public string? VmImageFamily { get; set; }

    /// <summary>
    /// At most one of these can be specified: At most one of these can be specified: Use this VM image name to find the image.
    /// </summary>
    ...
    {
        if (((!string.IsNullOrWhiteSpace(ContainerRepository) || !string.IsNullOrWhiteSpace(ContainerTag)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(Environment) || !string.IsNullOrWhiteSpace(EnvironmentLocation)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(VmImageProject) || !string.IsNullOrWhiteSpace(VmImageFamily) || !string.IsNullOrWhiteSpace(VmImageName)) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of (ContainerRepository or ContainerTag), (Environment or EnvironmentLocation), or (VmImageProject, VmImageFamily, or VmImageName) may be specified.", [nameof(ContainerRepository), nameof(ContainerTag), nameof(Environment), nameof(EnvironmentLocation), nameof(VmImageProject), nameof(VmImageFamily), nameof(VmImageName)]);
        }
        if ((!string.IsNullOrWhiteSpace(ContainerRepository) || !string.IsNullOrWhiteSpace(ContainerTag) || !string.IsNullOrWhiteSpace(Environment) || !string.IsNullOrWhiteSpace(EnvironmentLocation) || !string.IsNullOrWhiteSpace(VmImageProject) || !string.IsNullOrWhiteSpace(VmImageFamily) || !string.IsNullOrWhiteSpace(VmImageName)) && (!string.IsNullOrWhiteSpace(ContainerRepository) || !string.IsNullOrWhiteSpace(ContainerTag)) && (!(!string.IsNullOrWhiteSpace(ContainerRepository))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(ContainerRepository) || !string.IsNullOrWhiteSpace(ContainerTag) || !string.IsNullOrWhiteSpace(Environment) || !string.IsNullOrWhiteSpace(EnvironmentLocation) || !string.IsNullOrWhiteSpace(VmImageProject) || !string.IsNullOrWhiteSpace(VmImageFamily) || !string.IsNullOrWhiteSpace(VmImageName)) && (!string.IsNullOrWhiteSpace(Environment) || !string.IsNullOrWhiteSpace(EnvironmentLocation)) && (!(!string.IsNullOrWhiteSpace(Environment))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(ContainerRepository) || !string.IsNullOrWhiteSpace(ContainerTag) || !string.IsNullOrWhiteSpace(Environment) || !string.IsNullOrWhiteSpace(EnvironmentLocation) || !string.IsNullOrWhiteSpace(VmImageProject) || !string.IsNullOrWhiteSpace(VmImageFamily) || !string.IsNullOrWhiteSpace(VmImageName)) && (!string.IsNullOrWhiteSpace(VmImageProject) || !string.IsNullOrWhiteSpace(VmImageFamily) || !string.IsNullOrWhiteSpace(VmImageName)) && ((!string.IsNullOrWhiteSpace(VmImageFamily) ? 1 : 0) + (!string.IsNullOrWhiteSpace(VmImageName) ? 1 : 0) > 1))
        {
