...
public record GcloudPreviewComputeInstanceGroupsUnmanagedRemoveInstancesOptions : GcloudOptions
{
    /// <summary>
    /// removes     resources from an unmanaged instance group by instance name
    /// </summary>
    /// <param name="Instances">The names of the instances to remove from the instance group. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="Name">Name of the instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsUnmanagedRemoveInstancesOptions(
    ...
    /// <summary>
    /// The names of the instances to remove from the instance group. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
