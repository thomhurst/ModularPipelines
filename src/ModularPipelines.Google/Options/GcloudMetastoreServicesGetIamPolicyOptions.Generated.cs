...
// Source: https://cloud.google.com/sdk/gcloud/reference/metastore/services/get-iam-policy
...
[CliSubCommand("metastore", "services", "get-iam-policy")]
public record GcloudMetastoreServicesGetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// get the IAM policy for the     service
    /// </summary>
    ...
    public GcloudMetastoreServicesGetIamPolicyOptions(
        string Service
    )
    {
