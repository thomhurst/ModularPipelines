...
{
    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Return immediately, without waiting for the operation in progress to complete.
    /// </summary>
    [CliFlag("--async")]
    public bool? Async { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. If true, the notebook instance will not register with the proxy.
    /// </summary>
    [CliFlag("--disable-proxy-access")]
    public bool? DisableProxyAccess { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. If true, the notebook instance will be created with managed end user credentials enabled.
    /// </summary>
    [CliFlag("--enable-managed-euc")]
    public bool? EnableManagedEuc { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. If true, the notebook instance provide a proxy endpoint which allows for third party identity.
    /// </summary>
    [CliFlag("--enable-third-party-identity")]
    public bool? EnableThirdPartyIdentity { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. The owners of this instance after creation. Format: alias@example.com. Currently supports one owner only. If not specified, all of the service account users of the VM instance's service account can use the instance.
    /// </summary>
    [CliOption("--instance-owners", Format = OptionFormat.EqualsSeparated)]
    public string? InstanceOwners { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Labels to apply to this instance. These can be later modified by the setLabels method.
    /// </summary>
    [CliOption("--labels", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? Labels { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. String. VM instance with CC (Confidential Compute) of type. Supported values: SEV.
    /// </summary>
    [CliOption("--confidential-compute-type", Format = OptionFormat.EqualsSeparated)]
    public string? ConfidentialComputeType { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. If specified, no public IP will be assigned to this instance.
    /// </summary>
    [CliFlag("--disable-public-ip")]
    public bool? DisablePublicIp { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. If specified, IP forwarding will be enabled for this instance.
    /// </summary>
    [CliFlag("--enable-ip-forwarding")]
    public bool? EnableIpForwarding { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. The Compute Engine machine type (https://cloud.google.com/sdk/gcloud/reference/compute/machine-types) of this instance.
    /// </summary>
    [CliOption("--machine-type", Format = OptionFormat.EqualsSeparated)]
    public string? MachineType { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Custom metadata to apply to this instance.
    /// </summary>
    [CliOption("--metadata", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? Metadata { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. The minimum CPU platform to use for this instance. The list of valid values can be found in https://cloud.google.com/compute/docs/instances/specify-min-cpu-platform#availablezones
    /// </summary>
    [CliOption("--min-cpu-platform", Format = OptionFormat.EqualsSeparated)]
    public string? MinCpuPlatform { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used.
    /// </summary>
    [CliOption("--service-account-email", Format = OptionFormat.EqualsSeparated)]
    public string? ServiceAccountEmail { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Tags to apply to this instance. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--tags", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string>? Tags { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Count of cores of this accelerator.
    /// </summary>
    [CliOption("--accelerator-core-count", Format = OptionFormat.EqualsSeparated)]
    public int? AcceleratorCoreCount { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Type of this accelerator. ACCELERATOR_TYPE must be one of: NVIDIA_TESLA_K80, NVIDIA_TESLA_P100, NVIDIA_TESLA_V100, NVIDIA_TESLA_P4, NVIDIA_TESLA_T4, NVIDIA_TESLA_A100, NVIDIA_A100_80GB, NVIDIA_TESLA_T4_VWS, NVIDIA_TESLA_P100_VWS, NVIDIA_TESLA_P4_VWS, NVIDIA_L4, NVIDIA_H100_80GB, NVIDIA_H100_MEGA_80GB, NVIDIA_H200_141GB, NVIDIA_B200, NVIDIA_RTX6000.
    /// </summary>
    [CliOption("--accelerator-type", Format = OptionFormat.EqualsSeparated)]
    public string? AcceleratorType { get; set; }

    /// <summary>
    /// Gce Setup for the instance The service account on this instance, giving access to other Google Cloud services. You can use any service account within the same project, but you must grant the service account user permission to use the instance. If not specified, the Compute Engine default service account is used. The hardware accelerator used on this instance. If you use accelerators, make sure that your configuration has enough vCPUs and memory to support the `machine_type` you have selected. Boot disk configurations. Disk encryption method used on the boot disk, defaults to GMEK. BOOT_DISK_ENCRYPTION must be one of: GMEK, CMEK.
    /// </summary>
