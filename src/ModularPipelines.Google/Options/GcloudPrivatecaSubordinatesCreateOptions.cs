...
[CommandPrecedingArguments("privateca", "subordinates", "create")]
...
[property: BooleanCommandSwitch("--create-csr")] bool CreateCsr,
[property: CommandSwitch("--csr-output-file")] string CsrOutputFile,
[property: CommandSwitch("--issuer-pool")] string IssuerPool,
[property: CommandSwitch("--issuer-location")] string IssuerLocation
) : GcloudOptions
{
