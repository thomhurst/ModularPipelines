...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/health-checks/update/http
...
[CliSubCommand("preview", "compute", "health-checks", "update", "http")]
public record GcloudPreviewComputeHealthChecksUpdateHttpOptions(
...
) : GcloudOptions
{
    ...
    /// <summary>
    /// These flags configure the port that the health check monitors. If both --port and --port-name are specified, --port takes precedence. A textual description for the HTTP health check. Pass in an empty string to unset.
    /// </summary>
    ...
    /// <summary>
    /// These flags configure the port that the health check monitors. If both --port and --port-name are specified, --port takes precedence. At most one of these can be specified: If set, the HTTP health check is global.
    /// </summary>
    [CliFlag("--global")]
    public bool? Global { get; set; }

    /// <summary>
    /// These flags configure the port that the health check monitors. If both --port and --port-name are specified, --port takes precedence. At most one of these can be specified: Region of the HTTP health check to update. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
