...
public record GcloudPreviewComputeHealthChecksUpdateHttpOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a HTTP health     check
    /// </summary>
    /// <param name="Name">Name of the HTTP health check to update.</param>
    public GcloudPreviewComputeHealthChecksUpdateHttpOptions(
        string Name
    )
    {
