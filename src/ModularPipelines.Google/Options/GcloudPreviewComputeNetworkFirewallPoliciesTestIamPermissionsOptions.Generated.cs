...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/network-firewall-policies/test-iam-permissions
...
[CliSubCommand("preview", "compute", "network-firewall-policies", "test-iam-permissions")]
public record GcloudPreviewComputeNetworkFirewallPoliciesTestIamPermissionsOptions : GcloudOptions
{
    /// <summary>
    /// test IAM permissions for a Compute Engine network firewall policy
    /// </summary>
    ...
    /// <summary>
    /// Firewall policy resource - The network firewall policy for which to test permissions. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument firewall_policy on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the firewall_policy or fully qualified identifier for the firewall_policy. To set the firewall_policy attribute: ▸ provide the argument firewall_policy on the command line.
    /// </summary>
