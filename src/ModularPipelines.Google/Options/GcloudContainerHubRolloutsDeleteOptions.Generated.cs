...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/hub/rollouts/delete
...
[CliSubCommand("container", "hub", "rollouts", "delete")]
public record GcloudContainerHubRolloutsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete a rollout resource
    /// </summary>
    ...
    public GcloudContainerHubRolloutsDeleteOptions(
        string Rollout
    )
    {
