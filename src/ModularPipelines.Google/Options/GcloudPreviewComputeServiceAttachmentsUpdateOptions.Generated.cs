...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/service-attachments/update
...
public record GcloudPreviewComputeServiceAttachmentsUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a Google Compute     Engine service attachment
    /// </summary>
    /// <param name="Name">Name of the service attachment to update.</param>
    public GcloudPreviewComputeServiceAttachmentsUpdateOptions(
        string Name
    )
    {
