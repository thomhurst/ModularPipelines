...
public record GcloudModelArmorFloorsettingsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Malicious uri filter settings. Manage integrated services to apply Model Armor floor settings. Integrated services will have Model Armor sanitization enabled project-wide. At most one of these can be specified: Clear all integrated services from the floor setting.
    /// </summary>
    ...
    /// <summary>
    /// Malicious uri filter settings. RAI filter settings. At most one of these can be specified: Add rai filter settings. Sets add_rai_settings_filters value. Shorthand Example: --add-rai-settings-filters=string,string JSON Example: --add-rai-settings-filters=["string"] File Example: --add-rai-settings-filters=path_to_file.(yaml|json)
    /// </summary>
    [CliOption("--add-rai-settings-filters", Format = OptionFormat.EqualsSeparated)]
    public string? AddRaiSettingsFilters { get; set; }

    /// <summary>
    /// Malicious uri filter settings. RAI filter settings. At most one of these can be specified: Clear all rai filter settings.
    /// </summary>
    [CliFlag("--clear-rai-settings-filters")]
    public bool? ClearRaiSettingsFilters { get; set; }

    /// <summary>
    /// Malicious uri filter settings. RAI filter settings. At most one of these can be specified: Set rai_settings_filters to new value. List of Responsible AI filters enabled for floor setting. Sets rai_settings_filters value. Shorthand Example: --rai-settings-filters=string,string JSON Example: --rai-settings-filters=["string"] File Example: --rai-settings-filters=path_to_file.(yaml|json)
    /// </summary>
    [CliOption("--rai-settings-filters", Format = OptionFormat.EqualsSeparated)]
    public string? RaiSettingsFilters { get; set; }

    /// <summary>
    /// Malicious uri filter settings. RAI filter settings. At most one of these can be specified: Remove rai filter settings. Sets remove_rai_settings_filters value. Shorthand Example: --remove-rai-settings-filters=string,string JSON Example: --remove-rai-settings-filters=["string"] File Example: --remove-rai-settings-filters=path_to_file.(yaml|json)
    /// </summary>
