...
public record GcloudComputeRoutersUploadNamedSetOptions : GcloudOptions
{
    /// <summary>
    /// upload a named set into a Compute     Engine router
    /// </summary>
    ...
    public GcloudComputeRoutersUploadNamedSetOptions(
        string FileName,
        string Name
    )
    {
    ...
    public GcloudComputeRoutersUploadNamedSetFileFormat? FileFormat { get; set; }
