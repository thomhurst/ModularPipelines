...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/sub-blocks/set-iam-policy
...
[CliSubCommand("preview", "compute", "reservations", "sub-blocks", "set-iam-policy")]
public record GcloudPreviewComputeReservationsSubBlocksSetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// set the IAM     policy binding for a Compute Engine reservation sub-block
    /// </summary>
    ...
    public GcloudPreviewComputeReservationsSubBlocksSetIamPolicyOptions(
        string BlockName,
        string SubBlockName,
        string Reservation,
        string PolicyFile
