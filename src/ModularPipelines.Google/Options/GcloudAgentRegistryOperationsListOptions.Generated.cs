...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-registry/operations/list
...
[CliSubCommand("agent-registry", "operations", "list")]
public record GcloudAgentRegistryOperationsListOptions : GcloudOptions
{
    /// <summary>
    /// list operations
    /// </summary>
    ...
    public GcloudAgentRegistryOperationsListOptions(
        string Location
    )
    {
