...
public record GcloudPreviewComputeHealthChecksUpdateHttpsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a HTTPS health     check
    /// </summary>
    /// <param name="Name">Name of the HTTPS health check to update.</param>
    public GcloudPreviewComputeHealthChecksUpdateHttpsOptions(
        string Name
    )
    {
