...
public record GcloudPreviewComputeInstanceGroupsManagedSetAutoscalingOptions(
    [property: CliOption("--max-num-replicas", Format = OptionFormat.EqualsSeparated)] string MaxNumReplicas,
