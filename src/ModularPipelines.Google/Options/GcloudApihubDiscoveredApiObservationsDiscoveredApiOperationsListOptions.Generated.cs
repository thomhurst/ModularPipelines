...
public record GcloudApihubDiscoveredApiObservationsDiscoveredApiOperationsListOptions(
    [property: CliOption("--discovered-api-observation", Format = OptionFormat.EqualsSeparated)] string DiscoveredApiObservation
) : GcloudOptions
{
    /// <summary>
