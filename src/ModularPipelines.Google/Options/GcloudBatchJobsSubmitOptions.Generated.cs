...
public record GcloudBatchJobsSubmitOptions : GcloudOptions, IValidatableObject
{
    ...
    {
        if (!(!string.IsNullOrWhiteSpace(Config) || !string.IsNullOrWhiteSpace(ContainerCommandsFile) || !string.IsNullOrWhiteSpace(ContainerEntrypoint) || !string.IsNullOrWhiteSpace(ContainerImageUri) || !string.IsNullOrWhiteSpace(ScriptFilePath) || !string.IsNullOrWhiteSpace(ScriptText)))
        {
            yield return new ValidationResult("At least one of Config, ContainerCommandsFile, ContainerEntrypoint, ContainerImageUri, ScriptFilePath, or ScriptText must be specified.", [nameof(Config), nameof(ContainerCommandsFile), nameof(ContainerEntrypoint), nameof(ContainerImageUri), nameof(ScriptFilePath), nameof(ScriptText)]);
        }
        if ((!string.IsNullOrWhiteSpace(Config) || !string.IsNullOrWhiteSpace(ContainerCommandsFile) || !string.IsNullOrWhiteSpace(ContainerEntrypoint) || !string.IsNullOrWhiteSpace(ContainerImageUri) || !string.IsNullOrWhiteSpace(ScriptFilePath) || !string.IsNullOrWhiteSpace(ScriptText)) && (((!string.IsNullOrWhiteSpace(ContainerCommandsFile) || !string.IsNullOrWhiteSpace(ContainerEntrypoint) || !string.IsNullOrWhiteSpace(ContainerImageUri) || !string.IsNullOrWhiteSpace(ScriptFilePath) || !string.IsNullOrWhiteSpace(ScriptText)) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of (ContainerCommandsFile, ContainerEntrypoint, ContainerImageUri, ScriptFilePath, or ScriptText) may be specified.", [nameof(ContainerCommandsFile), nameof(ContainerEntrypoint), nameof(ContainerImageUri), nameof(ScriptFilePath), nameof(ScriptText)]);
        }
        if ((!string.IsNullOrWhiteSpace(Config) || !string.IsNullOrWhiteSpace(ContainerCommandsFile) || !string.IsNullOrWhiteSpace(ContainerEntrypoint) || !string.IsNullOrWhiteSpace(ContainerImageUri) || !string.IsNullOrWhiteSpace(ScriptFilePath) || !string.IsNullOrWhiteSpace(ScriptText)) && (!string.IsNullOrWhiteSpace(ContainerCommandsFile) || !string.IsNullOrWhiteSpace(ContainerEntrypoint) || !string.IsNullOrWhiteSpace(ContainerImageUri) || !string.IsNullOrWhiteSpace(ScriptFilePath) || !string.IsNullOrWhiteSpace(ScriptText)) && (!string.IsNullOrWhiteSpace(ContainerCommandsFile) || !string.IsNullOrWhiteSpace(ContainerEntrypoint) || !string.IsNullOrWhiteSpace(ContainerImageUri) || !string.IsNullOrWhiteSpace(ScriptFilePath) || !string.IsNullOrWhiteSpace(ScriptText)) && ((!string.IsNullOrWhiteSpace(ScriptFilePath) ? 1 : 0) + (!string.IsNullOrWhiteSpace(ScriptText) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of ScriptFilePath or ScriptText may be specified.", [nameof(ScriptFilePath), nameof(ScriptText)]);
        }
