...
public record GcloudMlVideoDetectExplicitContentOptions : GcloudOptions
{
    /// <summary>
    /// detect explicit content in videos
    /// </summary>
    /// <param name="InputPath">Path to the video to be analyzed. Must be a local path or a Google Cloud Storage URI.</param>
    public GcloudMlVideoDetectExplicitContentOptions(
        string InputPath
    )
    {
    ...
    public GcloudMlVideoDetectExplicitContentRegion? Region { get; set; }
