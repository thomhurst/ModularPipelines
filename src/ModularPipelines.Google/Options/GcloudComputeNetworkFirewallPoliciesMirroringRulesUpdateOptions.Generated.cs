...
public record GcloudComputeNetworkFirewallPoliciesMirroringRulesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// updates a     Compute Engine network firewall policy packet mirroring rule
    /// </summary>
    ...
    public GcloudComputeNetworkFirewallPoliciesMirroringRulesUpdateOptions(
    ...
    public GcloudComputeNetworkFirewallPoliciesMirroringRulesUpdateAction? Action { get; set; }
    ...
    public GcloudComputeNetworkFirewallPoliciesMirroringRulesUpdateDirection? Direction { get; set; }
