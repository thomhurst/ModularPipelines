...
public record GcloudApihubPluginsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// The type of the gateway. GATEWAY_TYPE must be one of: api-discovery The gateway type is API Discovery. apigee-edge-private-cloud The gateway type is Apigee Edge Private Cloud. apigee-edge-public-cloud The gateway type is Apigee Edge Public Cloud. apigee-x-and-hybrid The gateway type is Apigee X and Hybrid. cloud-api-gateway The gateway type is Cloud API Gateway. cloud-endpoints The gateway type is Cloud Endpoints. others The gateway type for any other types of gateways.
    /// </summary>
