...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/add-metadata
...
[CliSubCommand("preview", "compute", "instances", "add-metadata")]
public record GcloudPreviewComputeInstancesAddMetadataOptions : GcloudOptions
{
    /// <summary>
    /// add or update instance     metadata
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesAddMetadataOptions(
        string InstanceName
    )
    {
