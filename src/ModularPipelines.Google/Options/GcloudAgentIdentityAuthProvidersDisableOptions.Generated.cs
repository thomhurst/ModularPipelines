...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-identity/auth-providers/disable
...
[CliSubCommand("agent-identity", "auth-providers", "disable")]
public record GcloudAgentIdentityAuthProvidersDisableOptions : GcloudOptions
{
    /// <summary>
    /// disable an auth provider
    /// </summary>
    ...
    public GcloudAgentIdentityAuthProvidersDisableOptions(
        string AuthProvider
    )
    {
