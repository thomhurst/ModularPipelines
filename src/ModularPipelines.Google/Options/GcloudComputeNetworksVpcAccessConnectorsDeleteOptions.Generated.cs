...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/networks/vpc-access/connectors/delete
...
[CliSubCommand("compute", "networks", "vpc-access", "connectors", "delete")]
public record GcloudComputeNetworksVpcAccessConnectorsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete a VPC Access     connector
    /// </summary>
    ...
    public GcloudComputeNetworksVpcAccessConnectorsDeleteOptions(
        string Connector
    )
    {
