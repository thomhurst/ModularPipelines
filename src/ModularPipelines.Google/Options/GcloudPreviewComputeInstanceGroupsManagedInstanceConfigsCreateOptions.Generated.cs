...
public record GcloudPreviewComputeInstanceGroupsManagedInstanceConfigsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a per-instance config for an instance in a managed instance     group
    /// </summary>
    /// <param name="Instance">URI/name of an existing instance in the managed instance group.</param>
    /// <param name="Name">Name of the managed instance group to create a per-instance config for.</param>
    public GcloudPreviewComputeInstanceGroupsManagedInstanceConfigsCreateOptions(
        string Instance,
        string Name
    )
    {
