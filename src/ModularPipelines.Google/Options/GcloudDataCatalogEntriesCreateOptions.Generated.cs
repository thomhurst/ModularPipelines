...
public record GcloudDataCatalogEntriesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(Type) || ((object?)GcsFilePatterns is global::System.Collections.Generic.IEnumerable<char> ? (object?)GcsFilePatterns is not string || !string.IsNullOrWhiteSpace(GcsFilePatterns?.ToString()) : ((object?)GcsFilePatterns is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)GcsFilePatterns, static item => item is not null) : (GcsFilePatterns is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)GcsFilePatterns), static item => item is not null)))) || !string.IsNullOrWhiteSpace(UserSpecifiedSystem) || !string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime)) && (!string.IsNullOrWhiteSpace(UserSpecifiedSystem) || !string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime)) && (!(!string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime))))
        {
            yield return new ValidationResult("At least one of UserSpecifiedType, LinkedResource, SourceSystemCreateTime, or SourceSystemUpdateTime must be specified.", [nameof(UserSpecifiedType), nameof(LinkedResource), nameof(SourceSystemCreateTime), nameof(SourceSystemUpdateTime)]);
        }
        if ((!string.IsNullOrWhiteSpace(Type) || ((object?)GcsFilePatterns is global::System.Collections.Generic.IEnumerable<char> ? (object?)GcsFilePatterns is not string || !string.IsNullOrWhiteSpace(GcsFilePatterns?.ToString()) : ((object?)GcsFilePatterns is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)GcsFilePatterns, static item => item is not null) : (GcsFilePatterns is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)GcsFilePatterns), static item => item is not null)))) || !string.IsNullOrWhiteSpace(UserSpecifiedSystem) || !string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime)) && (!string.IsNullOrWhiteSpace(UserSpecifiedSystem) || !string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime)) && (!string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime)) && (!string.IsNullOrWhiteSpace(UserSpecifiedType) || !string.IsNullOrWhiteSpace(LinkedResource) || !string.IsNullOrWhiteSpace(SourceSystemCreateTime) || !string.IsNullOrWhiteSpace(SourceSystemUpdateTime)) && (!(!string.IsNullOrWhiteSpace(UserSpecifiedType))))
        {
