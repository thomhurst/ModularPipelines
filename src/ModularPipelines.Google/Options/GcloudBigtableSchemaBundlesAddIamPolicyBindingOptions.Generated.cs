...
public record GcloudBigtableSchemaBundlesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy     binding to a Bigtable schema bundle
    /// </summary>
