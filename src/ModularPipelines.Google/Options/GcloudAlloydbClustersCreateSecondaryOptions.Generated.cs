...
public record GcloudAlloydbClustersCreateSecondaryOptions : GcloudOptions, IValidatableObject
{
    ...
    {
        if ((!string.IsNullOrWhiteSpace(AutomatedBackupEncryptionKey) || !string.IsNullOrWhiteSpace(AutomatedBackupEncryptionKeyKeyring) || !string.IsNullOrWhiteSpace(AutomatedBackupEncryptionKeyLocation) || !string.IsNullOrWhiteSpace(AutomatedBackupEncryptionKeyProject) || !string.IsNullOrWhiteSpace(ContinuousBackupRecoveryWindowDays) || EnableContinuousBackup == true || (object?)AutomatedBackupRetentionCount is not null || !string.IsNullOrWhiteSpace(AutomatedBackupRetentionPeriod)) && (!(!string.IsNullOrWhiteSpace(AutomatedBackupEncryptionKey))))
        {
