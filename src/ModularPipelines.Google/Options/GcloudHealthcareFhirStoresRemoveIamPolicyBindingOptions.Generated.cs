...
// Source: https://cloud.google.com/sdk/gcloud/reference/healthcare/fhir-stores/remove-iam-policy-binding
...
[CliSubCommand("healthcare", "fhir-stores", "remove-iam-policy-binding")]
public record GcloudHealthcareFhirStoresRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Cloud Healthcare API FHIR store
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string FhirStore)
    {
        Member = this.Member;
        Role = this.Role;
