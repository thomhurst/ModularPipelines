...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-identity/auth-providers/delete
...
[CliSubCommand("agent-identity", "auth-providers", "delete")]
public record GcloudAgentIdentityAuthProvidersDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete an auth provider
    /// </summary>
    ...
    public GcloudAgentIdentityAuthProvidersDeleteOptions(
        string AuthProvider
    )
    {
