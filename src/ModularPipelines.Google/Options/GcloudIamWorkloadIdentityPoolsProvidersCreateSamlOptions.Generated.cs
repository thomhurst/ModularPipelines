...
public record GcloudIamWorkloadIdentityPoolsProvidersCreateSamlOptions : GcloudOptions
{
    ...
    /// <param name="IdpMetadataPath">XML file with configuration metadata for the SAML identity provider. The metadata file must follow the SAML 2.0 metadata specification (https://www.oasis-open.org/committees/download.php/35391/sstc-saml-metadata-errata-2.0-wd-04-diff.pdf). Use a full or relative path to a local file containing the value of idp_metadata_path.</param>
    ...
    public GcloudIamWorkloadIdentityPoolsProvidersCreateSamlOptions(
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(IdpMetadataPath);
        this.IdpMetadataPath = IdpMetadataPath;
        global::System.ArgumentNullException.ThrowIfNull(Provider);
        this.Provider = Provider;
    }

    public void Deconstruct(out IReadOnlyList<KeyValue> AttributeMapping, out string IdpMetadataPath, out string Provider)
    {
        AttributeMapping = this.AttributeMapping;
        IdpMetadataPath = this.IdpMetadataPath;
    ...
    public string IdpMetadataPath { get; private init; }
