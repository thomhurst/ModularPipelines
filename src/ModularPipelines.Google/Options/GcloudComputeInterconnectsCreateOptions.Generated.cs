...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/interconnects/create
...
[CliSubCommand("compute", "interconnects", "create")]
public record GcloudComputeInterconnectsCreateOptions : GcloudOptions
{
    /// <summary>
    /// create a Compute Engine interconnect
    /// </summary>
    /// <param name="InterconnectType">Type of the interconnect. INTERCONNECT_TYPE must be one of: DEDICATED Dedicated private interconnect. PARTNER Partner interconnect. Only available to approved partners.</param>
    ...
    /// <param name="Location">The location for the interconnect. The locations can be listed by using the gcloud compute interconnects locations list command to find the appropriate location to use when creating an interconnect.</param>
    /// <param name="RequestedLinkCount">Target number of physical links in the link bundle.</param>
    /// <param name="Name">Name of the interconnect to create.</param>
    public GcloudComputeInterconnectsCreateOptions(
    ...
    {
        global::System.ArgumentNullException.ThrowIfNull(InterconnectType);
    ...
    public void Deconstruct(out string InterconnectType, out string LinkType, out string Location, out int RequestedLinkCount, out string Name)
    {
        InterconnectType = this.InterconnectType;
        LinkType = this.LinkType;
        Location = this.Location;
        RequestedLinkCount = this.RequestedLinkCount;
        Name = this.Name;
    }
    ...
    public string InterconnectType { get; private init; }
    ...
    public int RequestedLinkCount { get; private init; }
    ...
    /// <summary>
    /// The remote location for a Cross-Cloud Interconnect. The remote locations can be listed by using the gcloud compute interconnects remote-locations list command to find the appropriate remote location to use when creating a Cross-Cloud Interconnect.
    /// </summary>
