...
) : GcloudOptions
{
    ...
    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Delete extra files under DESTINATION not found under SOURCE. By default extra files are not deleted. Managed folders are not affected by this flag. Note: this option can delete data quickly if you specify the wrong source and destination combination.
    /// </summary>
    [CliFlag("--delete-unmatched-destination-objects")]
    public bool? DeleteUnmatchedDestinationObjects { get; set; }

    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Do not automatically decompress downloaded gzip files.
    /// </summary>
    [CliFlag("--do-not-decompress")]
    public bool? DoNotDecompress { get; set; }

    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Print what operations rsync would perform without actually executing them.
    /// </summary>
    [CliFlag("--dry-run")]
    ...
    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Applies gzip transport encoding to file uploads. This option works like the --gzip-in-flight option described above, but it applies to all uploaded files, regardless of extension. CAUTION: If some of the source files don't compress well, such as binary data, using this option may result in longer uploads.
    /// </summary>
    [CliFlag("--gzip-in-flight-all")]
    public bool? GzipInFlightAll { get; set; }

    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Ignore file symlinks instead of copying what they point to. Enabled by default, use --no-ignore-symlinks to disable.
    /// </summary>
    [CliFlag("--ignore-symlinks")]
    public bool? IgnoreSymlinks { get; set; }

    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Includes managed folders in command operations. For transfers, gcloud storage will set up managed folders in the destination with the same IAM policy bindings as the source. Managed folders are only included with recursive cloud-to-cloud transfers.
    /// </summary>
    ...
    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Skip operating on destination object if it has a newer modification time than the source.
    /// </summary>
    [CliFlag("--skip-if-dest-has-newer-mtime")]
    public bool? SkipIfDestHasNewerMtime { get; set; }

    /// <summary>
    /// --canned-acl=PREDEFINED_ACL, --predefined-acl=PREDEFINED_ACL, -a PREDEFINED_ACL Applies predefined, or "canned," ACLs to a resource. See docs for a list of predefined ACL constants: https://cloud.google.com/storage/docs/access-control/lists#predefined-acl --recursive, -R, -r Recursively copy the contents of any directories that match the source path expression. Skip objects with unsupported object types.
    /// </summary>
