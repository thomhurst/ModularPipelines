...
public record GcloudAccessContextManagerLevelsConditionsListOptions(
    [property: CliOption("--level", Format = OptionFormat.EqualsSeparated)] string Level
) : GcloudOptions
{
    /// <summary>
