...
public record GcloudNetworkConnectivityMulticloudDataTransferConfigsDestinationsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// configs destinations     update - update a destination
    /// </summary>
    ...
    public GcloudNetworkConnectivityMulticloudDataTransferConfigsDestinationsUpdateOptions(
        string Destination
    )
    {
