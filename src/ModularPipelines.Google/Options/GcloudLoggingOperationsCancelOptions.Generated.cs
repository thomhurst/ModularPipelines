...
public record GcloudLoggingOperationsCancelOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// cancel a long running operation
    /// </summary>
    ...
    public GcloudLoggingOperationsCancelOptions(
        string Location,
        string OperationId
    )
    {
