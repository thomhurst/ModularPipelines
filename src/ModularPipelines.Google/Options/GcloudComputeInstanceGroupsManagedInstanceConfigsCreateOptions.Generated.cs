...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/instance-groups/managed/instance-configs/create
...
[CliSubCommand("compute", "instance-groups", "managed", "instance-configs", "create")]
public record GcloudComputeInstanceGroupsManagedInstanceConfigsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a     per-instance config for an instance in a managed instance group
    /// </summary>
    ...
    public GcloudComputeInstanceGroupsManagedInstanceConfigsCreateOptions(
        string Instance,
        string Name
    )
    {
