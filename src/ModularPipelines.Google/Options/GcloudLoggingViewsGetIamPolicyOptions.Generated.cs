...
public record GcloudLoggingViewsGetIamPolicyOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// display the IAM policy for a view
    /// </summary>
    ...
    /// <param name="ViewId">ID of the view to fetch IAM policy</param>
    public GcloudLoggingViewsGetIamPolicyOptions(
        string Bucket,
        string Location,
        string ViewId
    )
