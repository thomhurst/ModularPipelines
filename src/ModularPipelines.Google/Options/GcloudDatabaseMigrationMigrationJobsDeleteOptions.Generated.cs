...
// Source: https://cloud.google.com/sdk/gcloud/reference/database-migration/migration-jobs/delete
...
public record GcloudDatabaseMigrationMigrationJobsDeleteOptions : GcloudOptions
{
    ...
    /// <summary>
    /// The destination Cloud SQL connection profile is always deleted with the migration job. In case of force delete, the destination Cloud SQL replica database is also deleted.
    /// </summary>
    [CliFlag("--force")]
