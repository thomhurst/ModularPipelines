...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/get-screenshot
...
public record GcloudPreviewComputeInstancesGetScreenshotOptions : GcloudOptions
{
    /// <summary>
    /// capture a screenshot     (JPEG image) of the virtual machine instance's display
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesGetScreenshotOptions(
        string InstanceName
    )
    {
