...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/resource-policies/create/instance-schedule
...
[CliSubCommand("preview", "compute", "resource-policies", "create", "instance-schedule")]
public record GcloudPreviewComputeResourcePoliciesCreateInstanceScheduleOptions : GcloudOptions
{
    /// <summary>
    /// create     a Compute Engine instance schedule resource policy
    /// </summary>
    /// <param name="Name">Name of the resource policy to operate on.</param>
    public GcloudPreviewComputeResourcePoliciesCreateInstanceScheduleOptions(
        string Name
    )
    {
