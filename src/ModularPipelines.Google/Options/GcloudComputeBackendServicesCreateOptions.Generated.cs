...
public record GcloudComputeBackendServicesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudComputeBackendServicesCreateCompressionMode? CompressionMode { get; set; }
    ...
    public GcloudComputeBackendServicesCreateConnectionPersistenceOnUnhealthyBackends? ConnectionPersistenceOnUnhealthyBackends { get; set; }
    ...
    public GcloudComputeBackendServicesCreateHaPolicyFastIpMove? HaPolicyFastIpMove { get; set; }
    ...
    public GcloudComputeBackendServicesCreateIpAddressSelectionPolicy? IpAddressSelectionPolicy { get; set; }
    ...
    public GcloudComputeBackendServicesCreateLoadBalancingScheme? LoadBalancingScheme { get; set; }
    ...
    public GcloudComputeBackendServicesCreateLocalityLbPolicy? LocalityLbPolicy { get; set; }
    ...
    public GcloudComputeBackendServicesCreateLoggingOptional? LoggingOptional { get; set; }
    ...
    public GcloudComputeBackendServicesCreateProtocol? Protocol { get; set; }
    ...
    public GcloudComputeBackendServicesCreateTrackingMode? TrackingMode { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Configuration for Backend Authenticated TLS and mTLS. May only be specified when the backend protocol is SSL, HTTPS or HTTP2. Example: $ gcloud compute backend-services create \ --tls-settings='sni=example.com,authenticationConfig=${AUTH_CONF\ IG_NAME}'
    /// </summary>
