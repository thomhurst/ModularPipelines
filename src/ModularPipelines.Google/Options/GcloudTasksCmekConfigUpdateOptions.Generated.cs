...
public record GcloudTasksCmekConfigUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    ...
    /// <summary>
    /// Flags for Clearing or Updating CMEK Resource At most one of these can be specified: Flags for clearing CMEK Resource key. Disables CMEK for Cloud Tasks in the specified location by clearing the Cloud KMS cryptokey from the Cloud Tasks project and CMEK configuration.
    /// </summary>
