...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/snapshots/update
...
[CliSubCommand("preview", "compute", "snapshots", "update")]
public record GcloudPreviewComputeSnapshotsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine snapshot
    /// </summary>
    /// <param name="SnapshotName">Name of the snapshot to update.</param>
    public GcloudPreviewComputeSnapshotsUpdateOptions(
        string SnapshotName
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud preview compute snapshots update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud preview compute snapshots update --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
