...
[CommandPrecedingArguments("compute", "instance-templates", "remove-iam-policy-binding")]
public record GcloudComputeInstanceTemplatesRemoveIamPolicyBindingOptions(
