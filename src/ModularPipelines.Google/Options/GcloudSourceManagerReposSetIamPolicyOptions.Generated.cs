...
public record GcloudSourceManagerReposSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudSourceManagerReposSetIamPolicyOptions(
        string Repository,
        string PolicyFile
    )
    {
