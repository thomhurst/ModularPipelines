...
{
    /// <summary>
    /// At most one of these can be specified: At most one of these can be specified: Removes the fleet default configuration for policy controller. Memberships configured with the fleet default will maintain their current configuration. $ gcloud container hub policycontroller disable \ --fleet-default-member-config
    /// </summary>
