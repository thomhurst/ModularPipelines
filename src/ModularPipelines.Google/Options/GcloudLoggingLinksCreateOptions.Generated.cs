...
public record GcloudLoggingLinksCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a linked dataset on an analytics log     bucket
    /// </summary>
    ...
    /// <param name="LinkId">ID of the linked dataset to create.</param>
    public GcloudLoggingLinksCreateOptions(
        string Bucket,
        string Location,
        string LinkId
    )
