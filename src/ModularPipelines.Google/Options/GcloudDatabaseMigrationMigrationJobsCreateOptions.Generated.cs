...
public record GcloudDatabaseMigrationMigrationJobsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Conversion workspace resource - Name of the conversion workspaces to be used for the migration job This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --conversion-workspace on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the region attribute: ◆ provide the argument --conversion-workspace on the command line with a fully specified name; ◆ provide the argument --region on the command line. Parallelization level during initial load of the migration job. If not specified, will be defaulted to OPTIMAL. Only applicable for MySQL to MySQL migrations. LOAD_PARALLEL_LEVEL must be one of: MIN, OPTIMAL, MAX.
    /// </summary>
    [CliOption("--load-parallel-level", Format = OptionFormat.EqualsSeparated)]
    public GcloudDatabaseMigrationMigrationJobsCreateLoadParallelLevel? LoadParallelLevel { get; set; }
