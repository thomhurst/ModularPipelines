...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/update
...
[CliSubCommand("network-security", "address-groups", "update")]
public record GcloudNetworkSecurityAddressGroupsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update an address group
    /// </summary>
    ...
    public GcloudNetworkSecurityAddressGroupsUpdateOptions(
        string AddressGroup
    )
    {
    ...
    public IEnumerable<GcloudNetworkSecurityAddressGroupsUpdatePurpose>? Purpose { get; set; }
