...
public record GcloudDataprocJobsSubmitSparkROptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// submit a SparkR job to a cluster
    /// </summary>
    /// <param name="RFile">Main .R file to run as the driver.</param>
    public GcloudDataprocJobsSubmitSparkROptions(
        string RFile
    )
    {
    ...
    public void Deconstruct(out string RFile)
    {
        RFile = this.RFile;
    }
