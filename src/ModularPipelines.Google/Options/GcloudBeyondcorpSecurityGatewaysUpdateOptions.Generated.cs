...
public record GcloudBeyondcorpSecurityGatewaysUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// The configuration information for the delegated user. Update proxy_protocol_config_allowed_client_headers. At most one of these can be specified: Set proxy_protocol_config_allowed_client_headers to new value. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// The configuration information for the delegated user. Update proxy_protocol_config_allowed_client_headers. At most one of these can be specified: Or at least one of these can be specified: Add new value to proxy_protocol_config_allowed_client_headers list. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// The configuration information for the delegated user. Update proxy_protocol_config_allowed_client_headers. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from proxy_protocol_config_allowed_client_headers list. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
