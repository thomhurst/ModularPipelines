...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/firewall-rules/create
...
[CliSubCommand("preview", "compute", "firewall-rules", "create")]
public record GcloudPreviewComputeFirewallRulesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute Engine     firewall rule
    /// </summary>
    /// <param name="Name">Name of the firewall rule to create.</param>
    public GcloudPreviewComputeFirewallRulesCreateOptions(
        string Name
    )
    {
    ...
    public GcloudPreviewComputeFirewallRulesCreateDirection? Direction { get; set; }

    /// <summary>
    /// Disable a firewall rule and stop it from being enforced in the network. If a firewall rule is disabled, the associated network behaves as if the rule did not exist. To enable a disabled rule, use: $ gcloud preview compute firewall-rules update MY-RULE --no-disabled Firewall rules are enabled by default.
    /// </summary>
    [CliFlag("--disabled")]
    public bool? Disabled { get; set; }

    /// <summary>
    /// Negates --disabled. Disable a firewall rule and stop it from being enforced in the network. If a firewall rule is disabled, the associated network behaves as if the rule did not exist. To enable a disabled rule, use: $ gcloud preview compute firewall-rules update MY-RULE --no-disabled Firewall rules are enabled by default.
    /// </summary>
    [CliFlag("--no-disabled")]
    public bool? NoDisabled { get; set; }

    /// <summary>
    /// Enable logging for the firewall rule. Logs will be exported to StackDriver. Firewall logging is disabled by default. To enable logging for an existing rule, run: $ gcloud preview compute firewall-rules create MY-RULE \ --enable-logging To disable logging on an existing rule, run: $ gcloud preview compute firewall-rules create MY-RULE \ --no-enable-logging Use --enable-logging to enable and --no-enable-logging to disable.
    /// </summary>
    [CliFlag("--enable-logging")]
    public bool? EnableLogging { get; set; }

    /// <summary>
    /// Negates --enable-logging. Enable logging for the firewall rule. Logs will be exported to StackDriver. Firewall logging is disabled by default. To enable logging for an existing rule, run: $ gcloud preview compute firewall-rules create MY-RULE \ --enable-logging To disable logging on an existing rule, run: $ gcloud preview compute firewall-rules create MY-RULE \ --no-enable-logging Use --enable-logging to enable and --no-enable-logging to disable.
    /// </summary>
    ...
    public GcloudPreviewComputeFirewallRulesCreateLoggingMetadata? LoggingMetadata { get; set; }
