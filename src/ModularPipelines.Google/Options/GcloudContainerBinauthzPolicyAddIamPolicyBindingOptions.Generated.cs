...
public record GcloudContainerBinauthzPolicyAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding to a Binary Authorization policy
    /// </summary>
    ...
    public GcloudContainerBinauthzPolicyAddIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
