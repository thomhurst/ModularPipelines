...
/// <param name="AllowedGoogleProducersResourceHierarchyLevel">List of projects, folders, or orgs where the producer instance can be located in the form "projects/123456789", folders/123456789", or "organizations/123456789".</param>
...
public record GcloudNetworkConnectivityServiceConnectionPoliciesCreateOptions(
    [property: CliOption("--service-class", Format = OptionFormat.EqualsSeparated)] string ServiceClass,
    [property: CliOption("--allowed-google-producers-resource-hierarchy-level", Format = OptionFormat.EqualsSeparated)] IEnumerable<string> AllowedGoogleProducersResourceHierarchyLevel,
    [property: CliOption("--producer-instance-location", Format = OptionFormat.EqualsSeparated)] string ProducerInstanceLocation,
    [property: CliOption("--psc-connection-limit", Format = OptionFormat.EqualsSeparated)] string PscConnectionLimit
) : GcloudOptions
{
    /// <summary>
