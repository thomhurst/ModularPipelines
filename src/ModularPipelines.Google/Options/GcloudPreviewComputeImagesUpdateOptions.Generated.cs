...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/images/update
...
public record GcloudPreviewComputeImagesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine image
    /// </summary>
    /// <param name="ImageName">Name of the disk image to update.</param>
    public GcloudPreviewComputeImagesUpdateOptions(
        string ImageName
    )
    {
    ...
    public GcloudPreviewComputeImagesUpdateArchitecture? Architecture { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud preview compute images update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud preview compute images update --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
