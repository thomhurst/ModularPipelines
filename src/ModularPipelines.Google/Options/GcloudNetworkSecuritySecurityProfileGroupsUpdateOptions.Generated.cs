...
public record GcloudNetworkSecuritySecurityProfileGroupsUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// ID of the Security Profile or fully qualified identifier for the     Security Profile.     To set the name attribute:     ◆ provide the argument --threat-prevention-profile on the command      line.     This flag argument must be specified if any of the other arguments in     this group are specified.
    /// </summary>
    [CliOption("--threat-prevention-profile", Format = OptionFormat.EqualsSeparated)]
    public string? ThreatPreventionProfile { get; set; }

    /// <summary>
    /// Location of the Security Profile. NOTE: Only global security profiles     are supported.     To set the location attribute:     ◆ provide the argument --threat-prevention-profile on the command      line with a fully specified name;     ◆ provide the argument --threat-prevention-profile-location on the      command line;     ◆ provide the argument --security-profile-location on the command      line;     ◆ provide the argument --location on the command line;     ◆ provide the argument      networksecurity.organizations.locations.securityProfileGroups on the      command line with a fully specified name.
    /// </summary>
    ...
    /// <summary>
    /// Organization ID of the Security Profile.     To set the organization attribute:     ◆ provide the argument --threat-prevention-profile on the command      line with a fully specified name;     ◆ provide the argument --threat-prevention-profile-organization on      the command line;     ◆ provide the argument --security-profile-organization on the command      line;     ◆ provide the argument --organization on the command line;     ◆ provide the argument      networksecurity.organizations.locations.securityProfileGroups on the      command line with a fully specified name.
    /// </summary>
