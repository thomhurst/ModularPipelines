...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-services/multicast-domains/update
...
public record GcloudNetworkServicesMulticastDomainsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud network-services multicast-domains update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud network-services multicast-domains update --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
