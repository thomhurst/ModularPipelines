...
public record GcloudComputeReservationsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding     to a Compute Engine reservation
    /// </summary>
    ...
    public GcloudComputeReservationsAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Reservation
    )
