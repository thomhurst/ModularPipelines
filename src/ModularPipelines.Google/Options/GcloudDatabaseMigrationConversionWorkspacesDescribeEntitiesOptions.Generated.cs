...
public record GcloudDatabaseMigrationConversionWorkspacesDescribeEntitiesOptions : GcloudOptions
{
    ...
    public void Deconstruct(out GcloudTreeType TreeType, out string ConversionWorkspace)
    {
    ...
    public GcloudTreeType TreeType { get; private init; }
