...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/sub-blocks/list
...
public record GcloudPreviewComputeReservationsSubBlocksListOptions : GcloudOptions
{
    /// <summary>
    /// list Compute Engine     reservation sub-blocks
    /// </summary>
    ...
    public GcloudPreviewComputeReservationsSubBlocksListOptions(
        string BlockName,
        string Reservation
    )
    {
