...
// Source: https://cloud.google.com/sdk/gcloud/reference/access-context-manager/perimeters/dry-run/describe
...
[CliSubCommand("access-context-manager", "perimeters", "dry-run", "describe")]
public record GcloudAccessContextManagerPerimetersDryRunDescribeOptions : GcloudOptions
{
    /// <summary>
    /// display the     dry-run mode configuration for a Service Perimeter
    /// </summary>
    /// <param name="Perimeter">Perimeter resource - The service perimeter to describe. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the perimeter or fully qualified identifier for the perimeter. To set the perimeter attribute: ▸ provide the argument perimeter on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudAccessContextManagerPerimetersDryRunDescribeOptions(
        string Perimeter
    )
    {
