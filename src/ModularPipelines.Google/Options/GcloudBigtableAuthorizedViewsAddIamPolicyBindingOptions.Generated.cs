...
public record GcloudBigtableAuthorizedViewsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy     binding to a Cloud Bigtable authorized view
    /// </summary>
