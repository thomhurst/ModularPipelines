...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/public-delegated-prefixes/describe
...
[CliSubCommand("preview", "compute", "public-delegated-prefixes", "describe")]
public record GcloudPreviewComputePublicDelegatedPrefixesDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describes a     Compute Engine public delegated prefix
    /// </summary>
    /// <param name="Name">Name of the public delegated prefix to operate on.</param>
    public GcloudPreviewComputePublicDelegatedPrefixesDescribeOptions(
        string Name
    )
    {
