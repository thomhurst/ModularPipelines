...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/interconnects/macsec/update
...
[CliSubCommand("preview", "compute", "interconnects", "macsec", "update")]
public record GcloudPreviewComputeInterconnectsMacsecUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a Compute     Engine interconnect MACsec configuration
    /// </summary>
    /// <param name="Name">Name of the interconnect to update.</param>
    public GcloudPreviewComputeInterconnectsMacsecUpdateOptions(
        string Name
    )
    {
    ...
    /// <summary>
    /// Negates --enabled. Enable or disable MACsec on this Interconnect. MACsec enablement will fail if the MACsec configuration is not specified. Use --no-enabled to disable it.
    /// </summary>
    [CliFlag("--no-enabled")]
    ...
    /// <summary>
    /// Negates --fail-open. If enabled, the Interconnect will be configured with a should-secure MACsec security policy, that allows the Google router to fallback to cleartext traffic if the MKA session cannot be established. By default, the Interconnect will be configured with a must-secure security policy that drops all traffic if the MKA session cannot be established with your router. Use --no-fail-open to disable it.
    /// </summary>
