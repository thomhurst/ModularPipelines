...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/slots/list
...
[CliSubCommand("preview", "compute", "reservations", "slots", "list")]
public record GcloudPreviewComputeReservationsSlotsListOptions : GcloudOptions
{
    /// <summary>
    /// list Compute Engine     reservation slots
    /// </summary>
    ...
    public GcloudPreviewComputeReservationsSlotsListOptions(
        string BlockName,
        string SubBlockName,
        string Reservation
    )
