...
public record GcloudComputeInterconnectsAttachmentsDedicatedCreateOptions : GcloudOptions
{
    /// <summary>
    /// create a     Compute Engine dedicated interconnect attachment
    /// </summary>
    ...
    public GcloudComputeInterconnectsAttachmentsDedicatedCreateOptions(
        string Interconnect,
        string Router,
        string Name
    )
    ...
    public GcloudComputeInterconnectsAttachmentsDedicatedCreateEncryption? Encryption { get; set; }
