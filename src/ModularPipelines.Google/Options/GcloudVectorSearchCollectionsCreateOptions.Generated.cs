...
public record GcloudVectorSearchCollectionsCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// User-specified display name of the collection    Represents a customer-managed encryption key specification that can be   applied to a Vector Search collection.
    /// </summary>
