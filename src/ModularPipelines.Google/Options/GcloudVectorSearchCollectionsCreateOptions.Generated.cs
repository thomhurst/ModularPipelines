...
public record GcloudVectorSearchCollectionsCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Represents a customer-managed encryption key specification that can be applied to a Vector Search collection. Resource name of the Cloud KMS key used to protect the resource. The Cloud KMS key must be in the same region as the resource. It must have the format projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}.
    /// </summary>
    [CliOption("--encryption-spec-crypto-key-name", Format = OptionFormat.EqualsSeparated)]
