...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-connectivity/spokes/linked-interconnect-attachments/create
...
public record GcloudNetworkConnectivitySpokesLinkedInterconnectAttachmentsCreateOptions : GcloudOptions
{
    ...
    public GcloudNetworkConnectivitySpokesLinkedInterconnectAttachmentsCreateOptions(
        string Hub,
        IEnumerable<string> InterconnectAttachments,
        string Spoke
    )
    {
        ...
        this.Hub = Hub;
        {
            global::System.ArgumentNullException.ThrowIfNull(InterconnectAttachments);
            var materialized = global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(InterconnectAttachments));
            if (!global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>(materialized), static value => value is not null))
            {
                throw new global::System.ArgumentException(
                    "Required collection must contain at least one value.",
                    nameof(InterconnectAttachments));
            }

            InterconnectAttachments = materialized;
        }
    ...
    public void Deconstruct(out string Hub, out IEnumerable<string> InterconnectAttachments, out string Spoke)
    {
        Hub = this.Hub;
        InterconnectAttachments = this.InterconnectAttachments;
        Spoke = this.Spoke;
    }
    ...
    /// <summary>
    /// VLAN attachments that the spoke provides connectivity to. The resources must already exist. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--interconnect-attachments", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string> InterconnectAttachments { get; private init; }
