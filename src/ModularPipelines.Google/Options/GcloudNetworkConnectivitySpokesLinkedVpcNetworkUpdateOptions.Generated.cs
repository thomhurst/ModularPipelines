...
public record GcloudNetworkConnectivitySpokesLinkedVpcNetworkUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a VPC     spoke
    /// </summary>
    ...
    public GcloudNetworkConnectivitySpokesLinkedVpcNetworkUpdateOptions(
        string Spoke
    )
    {
