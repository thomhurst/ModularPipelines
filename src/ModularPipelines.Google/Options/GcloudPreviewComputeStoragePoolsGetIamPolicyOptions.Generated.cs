...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/storage-pools/get-iam-policy
...
[CliSubCommand("preview", "compute", "storage-pools", "get-iam-policy")]
public record GcloudPreviewComputeStoragePoolsGetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// get the IAM policy of     a storage pool
    /// </summary>
    ...
    public GcloudPreviewComputeStoragePoolsGetIamPolicyOptions(
        string StoragePool
    )
    {
