...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/interconnects/macsec/add-key
...
[CliSubCommand("preview", "compute", "interconnects", "macsec", "add-key")]
public record GcloudPreviewComputeInterconnectsMacsecAddKeyOptions : GcloudOptions
{
    /// <summary>
    /// shared key to     a Compute Engine interconnect MACsec configuration
    /// </summary>
    ...
    public GcloudPreviewComputeInterconnectsMacsecAddKeyOptions(
        string KeyName,
        string Name
    )
    {
