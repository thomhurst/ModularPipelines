...
public record GcloudDataplexDatascansCreateDataDiscoveryOptions(
    [property: CliOption("--data-source-resource", Format = OptionFormat.EqualsSeparated)] string DataSourceResource
) : GcloudOptions
{
    /// <summary>
