...
// Source: https://cloud.google.com/sdk/gcloud/reference/dataproc/clusters/delete
...
[CliSubCommand("dataproc", "clusters", "delete")]
public record GcloudDataprocClustersDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete a cluster
    /// </summary>
    ...
    public GcloudDataprocClustersDeleteOptions(
        string Cluster
    )
    {
