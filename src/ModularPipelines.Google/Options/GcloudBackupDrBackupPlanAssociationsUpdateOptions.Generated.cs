...
public record GcloudBackupDrBackupPlanAssociationsUpdateOptions : GcloudOptions
{
    ...
    public GcloudBackupDrBackupPlanAssociationsUpdateOptions(
        string BackupPlan,
    ...
    public void Deconstruct(out string BackupPlan, out string BackupPlanAssociation)
    {
