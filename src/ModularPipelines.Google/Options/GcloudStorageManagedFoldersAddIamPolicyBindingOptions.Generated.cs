...
public record GcloudStorageManagedFoldersAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy     binding to a managed folder
    /// </summary>
    ...
    /// <param name="Url">URL of the managed folder to add IAM policy binding to.</param>
    public GcloudStorageManagedFoldersAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Url
    )
