...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/instance-templates/add-iam-policy-binding
...
[CliSubCommand("compute", "instance-templates", "add-iam-policy-binding")]
public record GcloudComputeInstanceTemplatesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding to a Compute Engine instance template
    /// </summary>
    ...
    public GcloudComputeInstanceTemplatesAddIamPolicyBindingOptions(
        string Member,
        string Role,
