...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Specifies a HTTP Header to be added by your load balancer. This flag can be repeated to specify multiple headers. For example: $ gcloud preview compute backend-services update NAME \ --custom-request-header "header-name: value" \ --custom-request-header "another-header:"
    /// </summary>
    ...
    /// <summary>
    /// Region of the backend service to update. Overrides the default compute/region property value for this command invocation.
    /// </summary>
    ...
    /// <summary>
    /// Region of the health checks to operate on. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
    ...
    /// <summary>
    /// Clears the maximum stream duration timeout on the backend service.
    /// </summary>
    ...
    /// <summary>
    /// The identifier of an access key used for AWS Signature Version 4 s3 bucket authentication.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// The name of the cloud region of your origin for AWS Signature Version 4 authentication (e.g., 'us-east-1').
    /// </summary>
    ...
    /// <summary>
    /// This URL refers to a network security.ClientTlsPolicy resource describing how clients should authenticate on backends for this service.
    /// </summary>
    ...
    /// <summary>
    /// Comma-separated list of Subject Alternative Names (SANs) verified by the client during mutual TLS handshake with a server/endpoint for this backend service.
    /// </summary>
    ...
    /// <summary>
    /// Configuration for Backend Authenticated TLS and mTLS. May only be specified when the backend protocol is SSL, HTTPS or HTTP2. Example: $ gcloud preview compute backend-services update \ --tls-settings='sni=example.com,authenticationConfig=${AUTH_CONF\ IG_NAME}'
    /// </summary>
