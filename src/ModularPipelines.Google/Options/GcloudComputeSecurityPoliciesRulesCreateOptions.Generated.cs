...
public record GcloudComputeSecurityPoliciesRulesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute Engine     security policy rule
    /// </summary>
    ...
    public GcloudComputeSecurityPoliciesRulesCreateOptions(
        string Action,
        string Priority
    )
    {
    ...
    public GcloudComputeSecurityPoliciesRulesCreateEnforceOnKey? EnforceOnKey { get; set; }
    ...
    public GcloudComputeSecurityPoliciesRulesCreateExceedAction? ExceedAction { get; set; }
    ...
    public GcloudComputeSecurityPoliciesRulesCreateExceedRedirectType? ExceedRedirectType { get; set; }
    ...
    public GcloudComputeSecurityPoliciesRulesCreateRedirectType? RedirectType { get; set; }
