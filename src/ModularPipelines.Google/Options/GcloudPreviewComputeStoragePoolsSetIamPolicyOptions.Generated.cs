...
public record GcloudPreviewComputeStoragePoolsSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudPreviewComputeStoragePoolsSetIamPolicyOptions(
        string StoragePool,
        string PolicyFile
    )
    {
    ...
    public void Deconstruct(out string StoragePool, out string PolicyFile)
    {
