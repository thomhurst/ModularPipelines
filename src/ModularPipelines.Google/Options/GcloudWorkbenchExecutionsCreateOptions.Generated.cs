...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The kernel name to use for the execution.
    /// </summary>
    ...
    /// <summary>
    /// Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The number of accelerators used by the runtime.
    /// </summary>
    ...
    /// <summary>
    /// Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The Compute Engine machine type selected for the runtime.
    /// </summary>
