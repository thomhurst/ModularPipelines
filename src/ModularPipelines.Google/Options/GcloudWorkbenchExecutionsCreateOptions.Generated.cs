...
public record GcloudWorkbenchExecutionsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudWorkbenchExecutionsCreateOptions(
        ...
        GcloudAcceleratorType AcceleratorType,
        string MachineType,
        int DiskSizeGb,
        GcloudDiskType DiskType
    )
    {
    ...
    public void Deconstruct(out string Region, out string DisplayName, out string GcsOutputUri, out string ServiceAccount, out int AcceleratorCount, out GcloudAcceleratorType AcceleratorType, out string MachineType, out int DiskSizeGb, out GcloudDiskType DiskType)
    {
        Region = this.Region;
    ...
    public GcloudAcceleratorType AcceleratorType { get; private init; }
    ...
    public GcloudDiskType DiskType { get; private init; }
