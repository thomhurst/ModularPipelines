...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/network-firewall-policies/describe
...
[CliSubCommand("preview", "compute", "network-firewall-policies", "describe")]
public record GcloudPreviewComputeNetworkFirewallPoliciesDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe a     Compute Engine network firewall policy
    /// </summary>
    /// <param name="FirewallPolicy">name of the network firewall policy to get.</param>
    public GcloudPreviewComputeNetworkFirewallPoliciesDescribeOptions(
