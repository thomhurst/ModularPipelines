...
public record GcloudDataprocWorkflowTemplatesAddJobPysparkOptions : GcloudOptions
{
    /// <summary>
    /// add a PySpark job to     the workflow template
    /// </summary>
    ...
    public GcloudDataprocWorkflowTemplatesAddJobPysparkOptions(
        string StepId,
    ...
    public void Deconstruct(out string StepId, out string WorkflowTemplate, out string PyFile)
    {
        StepId = this.StepId;
