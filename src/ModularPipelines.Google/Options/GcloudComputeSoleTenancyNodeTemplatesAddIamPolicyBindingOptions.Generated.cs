...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/sole-tenancy/node-templates/add-iam-policy-binding
...
[CliSubCommand("compute", "sole-tenancy", "node-templates", "add-iam-policy-binding")]
public record GcloudComputeSoleTenancyNodeTemplatesAddIamPolicyBindingOptions : GcloudOptions
{
    /// <summary>
    /// add IAM     policy binding to a Compute Engine node template
    /// </summary>
    ...
    public GcloudComputeSoleTenancyNodeTemplatesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string NodeTemplate
    )
