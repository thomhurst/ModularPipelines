...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/hub/policycontroller/deployment/remove
...
public record GcloudContainerHubPolicycontrollerDeploymentRemoveOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// removes     configuration properties from Policy Controller components
    /// </summary>
    ...
    public GcloudContainerHubPolicycontrollerDeploymentRemoveOptions(
        string Deployment,
        string Property
    )
    {
    ...
    public GcloudContainerHubPolicycontrollerDeploymentRemoveEffect? Effect { get; set; }
