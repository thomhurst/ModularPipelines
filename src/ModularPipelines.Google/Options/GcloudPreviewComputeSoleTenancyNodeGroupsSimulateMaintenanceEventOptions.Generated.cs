...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/sole-tenancy/node-groups/simulate-maintenance-event
...
[CliSubCommand("preview", "compute", "sole-tenancy", "node-groups", "simulate-maintenance-event")]
public record GcloudPreviewComputeSoleTenancyNodeGroupsSimulateMaintenanceEventOptions : GcloudOptions
{
    /// <summary>
    /// event     - simulate maintenance of a Compute Engine node group
    /// </summary>
    /// <param name="Name">Name of the node group to operate on.</param>
    public GcloudPreviewComputeSoleTenancyNodeGroupsSimulateMaintenanceEventOptions(
        string Name
    )
    {
