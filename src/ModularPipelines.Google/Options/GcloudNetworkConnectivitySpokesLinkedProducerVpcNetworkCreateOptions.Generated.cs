...
public record GcloudNetworkConnectivitySpokesLinkedProducerVpcNetworkCreateOptions(
    ...
    [property: CliOption("--peering", Format = OptionFormat.EqualsSeparated)] string Peering
) : GcloudOptions
{
    /// <summary>
