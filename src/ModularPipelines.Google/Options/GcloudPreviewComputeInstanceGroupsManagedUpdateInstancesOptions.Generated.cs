...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-groups/managed/update-instances
...
[CliSubCommand("preview", "compute", "instance-groups", "managed", "update-instances")]
public record GcloudPreviewComputeInstanceGroupsManagedUpdateInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// immediately update selected instances in a Compute Engine managed     instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedUpdateInstancesOptions(
        string Name
    )
    {
