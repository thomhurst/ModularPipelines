...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/hub/memberships/update
...
[CliSubCommand("container", "hub", "memberships", "update")]
public record GcloudContainerHubMembershipsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a membership
    /// </summary>
    ...
    public GcloudContainerHubMembershipsUpdateOptions(
        string Membership
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud container hub memberships update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud container hub memberships update --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
