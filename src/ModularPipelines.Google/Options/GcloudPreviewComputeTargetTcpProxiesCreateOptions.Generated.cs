...
public record GcloudPreviewComputeTargetTcpProxiesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a target TCP     proxy
    /// </summary>
    /// <param name="Name">Name of the target TCP proxy to create.</param>
    public GcloudPreviewComputeTargetTcpProxiesCreateOptions(
        string Name
    )
    {
