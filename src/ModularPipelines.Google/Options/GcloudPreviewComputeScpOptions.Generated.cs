...
public record GcloudPreviewComputeScpOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// copy files to and from Google Compute Engine     virtual machines via scp
    /// </summary>
    ...
    public GcloudPreviewComputeScpOptions(
    ...
    public GcloudPreviewComputeScpStrictHostKeyChecking? StrictHostKeyChecking { get; set; }
