...
public record GcloudApihubPluginsInstancesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// AuthConfig represents the authentication information. Arguments for the config. At most one of these can be specified: Parameters to support Oauth 2.0 client credentials grant authentication. See https://tools.ietf.org/html/rfc6749#section-1.3.4 for more details. Username.
    /// </summary>
    ...
    {
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(AuthConfigType))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (((!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of (ApiKeyConfigHttpElementLocation, ApiKeyConfigName, or ApiKeyConfigSecretVersion) or (Oauth2ClientCredentialsConfigId, UserPasswordConfigUsername, Oauth2ClientCredentialsConfigSecretVersion, or UserPasswordConfigSecretVersion) may be specified.", [nameof(ApiKeyConfigHttpElementLocation), nameof(ApiKeyConfigName), nameof(ApiKeyConfigSecretVersion), nameof(Oauth2ClientCredentialsConfigId), nameof(UserPasswordConfigUsername), nameof(Oauth2ClientCredentialsConfigSecretVersion), nameof(UserPasswordConfigSecretVersion)]);
        }
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(ApiKeyConfigName))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AuthConfigType) || !string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(ApiKeyConfigHttpElementLocation) || !string.IsNullOrWhiteSpace(ApiKeyConfigName) || !string.IsNullOrWhiteSpace(ApiKeyConfigSecretVersion) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigId) || !string.IsNullOrWhiteSpace(UserPasswordConfigUsername) || !string.IsNullOrWhiteSpace(Oauth2ClientCredentialsConfigSecretVersion) || !string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion)) && (!(!string.IsNullOrWhiteSpace(UserPasswordConfigSecretVersion))))
        {
