...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/https-health-checks/update
...
[CliSubCommand("preview", "compute", "https-health-checks", "update")]
public record GcloudPreviewComputeHttpsHealthChecksUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a legacy HTTPS     health check
    /// </summary>
    /// <param name="Name">Name of the HTTPS health check to update.</param>
    public GcloudPreviewComputeHttpsHealthChecksUpdateOptions(
        string Name
    )
    {
