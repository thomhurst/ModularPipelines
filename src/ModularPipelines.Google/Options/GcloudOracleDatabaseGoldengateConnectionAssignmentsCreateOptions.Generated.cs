...
public record GcloudOracleDatabaseGoldengateConnectionAssignmentsCreateOptions(
    [property: CliOption("--properties-goldengate-connection", Format = OptionFormat.EqualsSeparated)] string PropertiesGoldengateConnection,
    [property: CliOption("--properties-goldengate-deployment", Format = OptionFormat.EqualsSeparated)] string PropertiesGoldengateDeployment
) : GcloudOptions
{
    /// <summary>
