...
[CommandPrecedingArguments("access-context-manager", "policies", "remove-iam-policy-binding")]
public record GcloudAccessContextManagerPoliciesRemoveIamPolicyBindingOptions(
