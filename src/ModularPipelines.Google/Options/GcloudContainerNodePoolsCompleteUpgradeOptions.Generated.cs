...
public record GcloudContainerNodePoolsCompleteUpgradeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// complete a node pool upgrade
    /// </summary>
    /// <param name="Name">Name of the node pool for which the upgrade is to be completed.</param>
    public GcloudContainerNodePoolsCompleteUpgradeOptions(
        string Name
    )
    {
