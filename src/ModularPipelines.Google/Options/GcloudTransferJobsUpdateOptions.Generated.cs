...
) : GcloudOptions, IValidatableObject
{
    ...
    {
        if (!(ClearIncludePrefixes == true || ClearExcludePrefixes == true || ClearMatchGlob == true || ClearIncludeModifiedBeforeAbsolute == true || ClearIncludeModifiedAfterAbsolute == true || ClearIncludeModifiedBeforeRelative == true || ClearIncludeModifiedAfterRelative == true || IncludePrefixes?.Any() == true || ExcludePrefixes?.Any() == true || MatchGlob?.Any() == true || IncludeModifiedBeforeAbsolute?.Any() == true || IncludeModifiedAfterAbsolute?.Any() == true || IncludeModifiedBeforeRelative?.Any() == true || IncludeModifiedAfterRelative?.Any() == true || ClearDeleteFrom == true || ClearPreserveMetadata == true || ClearCustomStorageClass == true || OverwriteWhen is not null || DeleteFrom is not null || PreserveMetadata is not null || CustomStorageClass?.Any() == true || ClearNotificationConfig == true || ClearNotificationEventTypes == true || NotificationPubsubTopic?.Any() == true || NotificationEventTypes is not null || NotificationPayloadFormat is not null))
        {
            yield return new ValidationResult("At least one of ClearIncludePrefixes, ClearExcludePrefixes, ClearMatchGlob, ClearIncludeModifiedBeforeAbsolute, ClearIncludeModifiedAfterAbsolute, ClearIncludeModifiedBeforeRelative, ClearIncludeModifiedAfterRelative, IncludePrefixes, ExcludePrefixes, MatchGlob, IncludeModifiedBeforeAbsolute, IncludeModifiedAfterAbsolute, IncludeModifiedBeforeRelative, IncludeModifiedAfterRelative, ClearDeleteFrom, ClearPreserveMetadata, ClearCustomStorageClass, OverwriteWhen, DeleteFrom, PreserveMetadata, CustomStorageClass, ClearNotificationConfig, ClearNotificationEventTypes, NotificationPubsubTopic, NotificationEventTypes, or NotificationPayloadFormat must be specified.", [nameof(ClearIncludePrefixes), nameof(ClearExcludePrefixes), nameof(ClearMatchGlob), nameof(ClearIncludeModifiedBeforeAbsolute), nameof(ClearIncludeModifiedAfterAbsolute), nameof(ClearIncludeModifiedBeforeRelative), nameof(ClearIncludeModifiedAfterRelative), nameof(IncludePrefixes), nameof(ExcludePrefixes), nameof(MatchGlob), nameof(IncludeModifiedBeforeAbsolute), nameof(IncludeModifiedAfterAbsolute), nameof(IncludeModifiedBeforeRelative), nameof(IncludeModifiedAfterRelative), nameof(ClearDeleteFrom), nameof(ClearPreserveMetadata), nameof(ClearCustomStorageClass), nameof(OverwriteWhen), nameof(DeleteFrom), nameof(PreserveMetadata), nameof(CustomStorageClass), nameof(ClearNotificationConfig), nameof(ClearNotificationEventTypes), nameof(NotificationPubsubTopic), nameof(NotificationEventTypes), nameof(NotificationPayloadFormat)]);
        }
    }
