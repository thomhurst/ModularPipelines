...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/instances/add-iam-policy-binding
...
[CliSubCommand("compute", "instances", "add-iam-policy-binding")]
public record GcloudComputeInstancesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding to     a Compute Engine instance
    /// </summary>
    ...
    public GcloudComputeInstancesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Instance
    )
