...
public record GcloudComputeOrgSecurityPoliciesRulesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute Engine     organizationsecurity policy rule
    /// </summary>
    ...
    public GcloudComputeOrgSecurityPoliciesRulesCreateOptions(
        string Action,
    ...
    public GcloudComputeOrgSecurityPoliciesRulesCreateDirection? Direction { get; set; }
