...
public record GcloudPreviewComputeDisksStopAsyncReplicationOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// stop async     replication on a Compute Engine persistent disk
    /// </summary>
    /// <param name="DiskName">Name of the disk to stop async replication.</param>
    public GcloudPreviewComputeDisksStopAsyncReplicationOptions(
        string DiskName
    )
    {
