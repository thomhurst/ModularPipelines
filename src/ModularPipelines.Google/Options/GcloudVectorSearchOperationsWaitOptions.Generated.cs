...
// Source: https://cloud.google.com/sdk/gcloud/reference/vector-search/operations/wait
...
[CliSubCommand("vector-search", "operations", "wait")]
public record GcloudVectorSearchOperationsWaitOptions : GcloudOptions
{
    /// <summary>
    /// wait for an operation to complete
    /// </summary>
    ...
    public GcloudVectorSearchOperationsWaitOptions(
        string Operation
    )
    {
