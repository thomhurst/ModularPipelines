...
public record GcloudPreviewComputeImagesExportOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// export a Compute Engine image
    /// </summary>
    /// <param name="DestinationUri">The Cloud Storage URI destination for the exported virtual disk file.</param>
    public GcloudPreviewComputeImagesExportOptions(
        string DestinationUri
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(DestinationUri);
        this.DestinationUri = DestinationUri;
    }

    public void Deconstruct(out string DestinationUri)
    {
    ...
    /// </summary>
    [CliOption("--destination-uri", Format = OptionFormat.EqualsSeparated)]
    public string DestinationUri { get; private init; }
