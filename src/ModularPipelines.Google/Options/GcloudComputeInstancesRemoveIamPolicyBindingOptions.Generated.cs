...
public record GcloudComputeInstancesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding from a Compute Engine instance
    /// </summary>
    ...
    public GcloudComputeInstancesRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string Instance
    )
