...
// Source: https://cloud.google.com/sdk/gcloud/reference/vector-search/operations/list
...
[CliSubCommand("vector-search", "operations", "list")]
public record GcloudVectorSearchOperationsListOptions : GcloudOptions
{
    /// <summary>
    /// list operations
    /// </summary>
    ...
    public GcloudVectorSearchOperationsListOptions(
        string Location
    )
    {
