...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/update
...
public record GcloudPreviewComputeReservationsUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update Compute Engine     reservations
    /// </summary>
    /// <param name="Reservation">Name of the reservation to update.</param>
    public GcloudPreviewComputeReservationsUpdateOptions(
        string Reservation
    )
    {
