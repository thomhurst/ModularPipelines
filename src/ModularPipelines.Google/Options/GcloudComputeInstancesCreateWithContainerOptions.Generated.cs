...
public record GcloudComputeInstancesCreateWithContainerOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// creates Compute Engine     virtual machine instances running container images
    /// </summary>
    ...
    public GcloudComputeInstancesCreateWithContainerOptions(
    ...
    /// <summary>
    /// Negates --container-privileged. Specify whether to run container in privileged mode. Default: --no-container-privileged.
    /// </summary>
    ...
    public GcloudComputeInstancesCreateWithContainerContainerRestartPolicy? ContainerRestartPolicy { get; set; }
    ...
    /// <summary>
    /// Negates --container-stdin. Keep container STDIN open even if not attached. Default: --no-container-stdin.
    /// </summary>
    ...
    /// <summary>
    /// Negates --container-tty. Allocate a pseudo-TTY for the container. Default: --no-container-tty.
    /// </summary>
    ...
    public GcloudComputeInstancesCreateWithContainerNetworkTier? NetworkTier { get; set; }
    ...
    /// <summary>
    /// Custom machine type extensions. At most one of these can be specified: Creates a DNS PTR record for the external IP of the instance.
    /// </summary>
    [CliFlag("--public-ptr")]
    public bool? PublicPtr { get; set; }

    /// <summary>
    /// Custom machine type extensions. At most one of these can be specified: If provided, no DNS PTR record is created for the external IP of the instance. Mutually exclusive with public-ptr-domain.
    /// </summary>
    [CliFlag("--no-public-ptr")]
    public bool? NoPublicPtr { get; set; }

    /// <summary>
    /// Custom machine type extensions. At most one of these can be specified: Assigns a custom PTR domain for the external IP of the instance. Mutually exclusive with no-public-ptr.
    /// </summary>
    [CliOption("--public-ptr-domain", Format = OptionFormat.EqualsSeparated)]
    public string? PublicPtrDomain { get; set; }

    /// <summary>
    /// Custom machine type extensions. At most one of these can be specified: If both this flag and --public-ptr are specified, creates a DNS PTR record for the external IP of the instance with the PTR domain name being the DNS name of the instance.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the reservation for the instance. At most one of these can be specified: Create instance without scopes
    /// </summary>
    [CliFlag("--no-scopes")]
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true) && (!(!string.IsNullOrWhiteSpace(CustomCpu))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true) && (!(!string.IsNullOrWhiteSpace(CustomMemory))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true) && ((!string.IsNullOrWhiteSpace(Image) ? 1 : 0) + (!string.IsNullOrWhiteSpace(ImageFamily) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of Image or ImageFamily may be specified.", [nameof(Image), nameof(ImageFamily)]);
        }
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true) && ((PublicPtr == true ? 1 : 0) + (NoPublicPtr == true ? 1 : 0) > 1))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily) || PublicPtr == true || NoPublicPtr == true || !string.IsNullOrWhiteSpace(PublicPtrDomain) || NoPublicPtrDomain == true) && ((!string.IsNullOrWhiteSpace(PublicPtrDomain) ? 1 : 0) + (NoPublicPtrDomain == true ? 1 : 0) > 1))
        {
