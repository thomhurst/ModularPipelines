...
public record GcloudContainerClustersCreateAutoOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudContainerClustersCreateAutoAutoMonitoringScope? AutoMonitoringScope { get; set; }
    ...
    public GcloudContainerClustersCreateAutoAutopilotGeneralProfile? AutopilotGeneralProfile { get; set; }
    ...
    /// <summary>
    /// Flags for Binary Authorization: Enable Database Encryption. Enable database encryption that will be used to encrypt Kubernetes Secrets at the application layer. The key provided should be the resource ID in the format of projects/[KEY_PROJECT_ID]/locations/[LOCATION]/keyRings/[RING_NAME]/cryptoKeys/[KEY_NAME]. For more information, see https://cloud.google.com/kubernetes-engine/docs/how-to/encrypting-secrets.
    /// </summary>
    [CliOption("--database-encryption-key", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseEncryptionKey { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Disable reconciliation on the cluster for L4 Load Balancer VPC firewalls targeting ingress traffic.
    /// </summary>
    [CliFlag("--disable-l4-lb-firewall-reconciliation")]
    public bool? DisableL4LbFirewallReconciliation { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Disable the Lustre CSI driver to automatically detect and configure all suitable network interfaces on a node for Lustre IO.
    /// </summary>
    [CliFlag("--disable-multi-nic-lustre")]
    public bool? DisableMultiNicLustre { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable the Agent Sandbox feature on the cluster. Use --no-enable-agent-sandbox to disable.
    /// </summary>
    [CliFlag("--enable-agent-sandbox")]
    public bool? EnableAgentSandbox { get; set; }

    /// <summary>
    /// Negates --enable-agent-sandbox. Flags for Binary Authorization: Enable the Agent Sandbox feature on the cluster. Use --no-enable-agent-sandbox to disable.
    /// </summary>
    [CliFlag("--no-enable-agent-sandbox")]
    public bool? NoEnableAgentSandbox { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable enforcement of --master-authorized-networks CIDR ranges for traffic reaching cluster's control plane via private IP.
    /// </summary>
    [CliFlag("--enable-authorized-networks-on-private-endpoint")]
    public bool? EnableAuthorizedNetworksOnPrivateEndpoint { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable the Auto IP Address Management (Auto IPAM) feature for the cluster.
    /// </summary>
    [CliFlag("--enable-auto-ipam")]
    public bool? EnableAutoIpam { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable the Backup for GKE add-on. This add-on is disabled by default. To learn more, see the Backup for GKE overview: https://cloud.google.com/kubernetes-engine/docs/add-on/backup-for-gke/concepts/backup-for-gke.
    /// </summary>
    [CliFlag("--enable-backup-restore")]
    public bool? EnableBackupRestore { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable Cilium Clusterwide Network Policies on the cluster. Disabled by default.
    /// </summary>
    [CliFlag("--enable-cilium-clusterwide-network-policy")]
    public bool? EnableCiliumClusterwideNetworkPolicy { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable confidential nodes for the cluster. Enabling Confidential Nodes will create nodes using Confidential VM https://docs.cloud.google.com/compute/docs/about-confidential-vm.
    /// </summary>
    [CliFlag("--enable-confidential-nodes")]
    public bool? EnableConfidentialNodes { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable the default compute class to use for the cluster. To disable Default Compute Class in an existing cluster, explicitly set flag --no-enable-default-compute-class.
    /// </summary>
    [CliFlag("--enable-default-compute-class")]
    public bool? EnableDefaultComputeClass { get; set; }

    /// <summary>
    /// Negates --enable-default-compute-class. Flags for Binary Authorization: Enable the default compute class to use for the cluster. To disable Default Compute Class in an existing cluster, explicitly set flag --no-enable-default-compute-class.
    /// </summary>
    [CliFlag("--no-enable-default-compute-class")]
    public bool? NoEnableDefaultComputeClass { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable access to the cluster's control plane over DNS-based endpoint. DNS-based control plane access is recommended.
    /// </summary>
    [CliFlag("--enable-dns-access")]
    public bool? EnableDnsAccess { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Set cluster project as the fleet host project. This will register the cluster to the same project. To register the cluster to a fleet in a different project, please use --fleet-project=FLEET_HOST_PROJECT. Example: $ gcloud container clusters create-auto --enable-fleet
    /// </summary>
    [CliFlag("--enable-fleet")]
    public bool? EnableFleet { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: When you enable Google Cloud Access, any public IP addresses owned by Google Cloud can reach the public control plane endpoint of your cluster.
    /// </summary>
    [CliFlag("--enable-google-cloud-access")]
    public bool? EnableGoogleCloudAccess { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable access to the cluster's control plane over private IP and public IP if --enable-private-endpoint is not enabled.
    /// </summary>
    [CliFlag("--enable-ip-access")]
    public bool? EnableIpAccess { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable K8s client certificates Authentication to the cluster's control plane over DNS-based endpoint.
    /// </summary>
    [CliFlag("--enable-k8s-certs-via-dns")]
    public bool? EnableK8sCertsViaDns { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable K8s Service Account tokens Authentication to the cluster's control plane over DNS-based endpoint.
    /// </summary>
    [CliFlag("--enable-k8s-tokens-via-dns")]
    public bool? EnableK8sTokensViaDns { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enforces that kernel modules are signed on all new nodes in the cluster unless explicitly overridden with --no-enable-kernel-module-signature-enforcement when creating the nodepool. Use --no-enable-kernel-module-signature-enforcement to disable. Examples: $ gcloud container clusters create-auto example-cluster \ --enable-kernel-module-signature-enforcement
    /// </summary>
    [CliFlag("--enable-kernel-module-signature-enforcement")]
    public bool? EnableKernelModuleSignatureEnforcement { get; set; }

    /// <summary>
    /// Negates --enable-kernel-module-signature-enforcement. Flags for Binary Authorization: Enforces that kernel modules are signed on all new nodes in the cluster unless explicitly overridden with --no-enable-kernel-module-signature-enforcement when creating the nodepool. Use --no-enable-kernel-module-signature-enforcement to disable. Examples: $ gcloud container clusters create-auto example-cluster \ --enable-kernel-module-signature-enforcement
    /// </summary>
    ...
    /// <summary>
    /// Flags for Binary Authorization: Allow the Lustre CSI driver to initialize LNet (the virtual network layer for Lustre kernel module) using port 6988. This flag is required to workaround a port conflict with the gke-metadata-server on GKE nodes.
    /// </summary>
    [CliFlag("--enable-legacy-lustre-port")]
    public bool? EnableLegacyLustrePort { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable the Lustre CSI Driver GKE add-on. This add-on is disabled by default.
    /// </summary>
    [CliFlag("--enable-lustre-csi-driver")]
    public bool? EnableLustreCsiDriver { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Use with private clusters to allow access to the master's private endpoint from any Google Cloud region or on-premises environment regardless of the private cluster's region.
    /// </summary>
    [CliFlag("--enable-master-global-access")]
    public bool? EnableMasterGlobalAccess { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enables multi-networking on the cluster. Multi-networking is disabled by default.
    /// </summary>
    [CliFlag("--enable-multi-networking")]
    public bool? EnableMultiNetworking { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable automatic log processing sidecar for Ray clusters.
    /// </summary>
    [CliFlag("--enable-ray-cluster-logging")]
    public bool? EnableRayClusterLogging { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable automatic metrics collection for Ray clusters.
    /// </summary>
    [CliFlag("--enable-ray-cluster-monitoring")]
    public bool? EnableRayClusterMonitoring { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Enable the Ray Operator GKE add-on. This add-on is disabled by default.
    /// </summary>
    [CliFlag("--enable-ray-operator")]
    public bool? EnableRayOperator { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Sets fleet host project for the cluster. If specified, the current cluster will be registered as a fleet membership under the fleet host project. Example: $ gcloud container clusters create-auto --fleet-project=my-project
    /// </summary>
    [CliOption("--fleet-project", Format = OptionFormat.EqualsSeparated)]
    public int? FleetProject { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Set Horizontal Pod Autoscaler behavior. Accepted values are: none, performance. For more information, see https://cloud.google.com/kubernetes-engine/docs/how-to/horizontal-pod-autoscaling#hpa-profile.
    /// </summary>
    [CliOption("--hpa-profile", Format = OptionFormat.EqualsSeparated)]
    public string? HpaProfile { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: The Operating System image for the node pool. This is a private feature, please contact your Google account team for allowlisting this feature.
    /// </summary>
    [CliOption("--image", Format = OptionFormat.EqualsSeparated)]
    public string? Image { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: The Google Cloud project storing the Operating System image for the node pool. This is a private feature, please contact your Google account team for allowlisting this feature.
    /// </summary>
    [CliOption("--image-project", Format = OptionFormat.EqualsSeparated)]
    public string? ImageProject { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: The image type to use for the cluster. Defaults to server-specified. Image Type specifies the base OS that the nodes in the cluster will run on. If an image type is specified, that will be assigned to the cluster and all future upgrades will use the specified image type. If it is not specified the server will pick the default image type. The default image type and the list of valid image types are available using the following command. $ gcloud container get-server-config
    /// </summary>
    ...
    /// <summary>
    /// Flags for Binary Authorization: Specifies the scope of Managed OpenTelemetry within the cluster. COLLECTION_AND_INSTRUMENTATION_COMPONENTS: Enables GKE Managed OpenTelemetry Collector and other Instrumentations components like Instrumentation CRD within the cluster. NONE: Disables the GKE Managed OpenTelemetry. MANAGED_OTEL_SCOPE must be one of: COLLECTION_AND_INSTRUMENTATION_COMPONENTS, NONE.
    /// </summary>
    [CliOption("--managed-otel-scope", Format = OptionFormat.EqualsSeparated)]
    public string? ManagedOtelScope { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Specify a membership type for the cluster's fleet membership. Example: $ gcloud container clusters create-auto \ --membership-type=LIGHTWEIGHT. MEMBERSHIP_TYPE must be (only \ one value is supported): LIGHTWEIGHT Fleet membership representing this cluster will be lightweight.
    /// </summary>
    ...
    /// <summary>
    /// Flags for Binary Authorization: The Google Compute Engine subnetwork (https://cloud.google.com/compute/docs/subnetworks) to which the cluster is connected. The subnetwork must belong to the network specified by --network. Cannot be used with the "--create-subnetwork" option.
    /// </summary>
    [CliOption("--subnetwork", Format = OptionFormat.EqualsSeparated)]
    public string? Subnetwork { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: (DEPRECATED) Set the desired tier for the cluster. The --tier flag is deprecated. More info: https://cloud.google.com/kubernetes-engine/docs/release-notes#September_02_2025. TIER must be one of: standard, enterprise.
    /// </summary>
    [CliOption("--tier", Format = OptionFormat.EqualsSeparated)]
    public GcloudContainerClustersCreateAutoTier? Tier { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: Add Autopilot workload policies to the cluster. Examples: $ gcloud container clusters create-auto example-cluster \ --workload-policies=allow-net-admin The only supported workload policy is 'allow-net-admin'.
    /// </summary>
    ...
    public GcloudContainerClustersCreateAutoWorkloadVulnerabilityScanning? WorkloadVulnerabilityScanning { get; set; }

    /// <summary>
    /// Flags for Binary Authorization: At most one of these can be specified: The domain used in Additive VPC scope. Only works with Cluster Scope.
    /// </summary>
    ...
    /// <summary>
    /// Flags for Binary Authorization: At most one of these can be specified: Disables Additive VPC Scope.
    /// </summary>
