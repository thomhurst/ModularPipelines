...
public record GcloudLoggingViewsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a view
    /// </summary>
    ...
    /// <param name="ViewId">Id of the view to update.</param>
    public GcloudLoggingViewsUpdateOptions(
        string Bucket,
        string Location,
        string ViewId
    )
