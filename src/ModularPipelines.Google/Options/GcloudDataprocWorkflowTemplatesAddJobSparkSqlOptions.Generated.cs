...
public record GcloudDataprocWorkflowTemplatesAddJobSparkSqlOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add a SparkSql job     to the workflow template
    /// </summary>
    ...
    public GcloudDataprocWorkflowTemplatesAddJobSparkSqlOptions(
        string StepId,
    ...
    /// <summary>
    /// Exactly one of these must be specified: A Spark SQL query to execute as part of the job.
    /// </summary>
    [CliOption("--execute", Format = OptionFormat.EqualsSeparated)]
    public string? Execute { get; set; }

    /// <summary>
    /// Exactly one of these must be specified: HCFS URI of file containing Spark SQL script to execute as the job.
    /// </summary>
    ...
    /// <summary>
    /// Comma separated list of jar files to be provided to the executor and driver classpaths. May contain UDFs. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// A list of key value pairs to set variables in the Hive queries. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--params", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string>? Params { get; set; }

    /// <summary>
    /// A list of key value pairs to configure Hive. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
