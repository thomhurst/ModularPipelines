...
public record GcloudVmwareNetworkPoliciesExternalAccessRulesCreateOptions : GcloudOptions
{
    ...
    public void Deconstruct(out IEnumerable<string> DestinationRanges, out GcloudIpProtocol IpProtocol, out string Priority, out IEnumerable<string> SourceRanges, out string ExternalAccessRule)
    {
    ...
    public GcloudIpProtocol IpProtocol { get; private init; }
