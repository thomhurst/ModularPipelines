...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/security-policies/update
...
[CliSubCommand("preview", "compute", "security-policies", "update")]
public record GcloudPreviewComputeSecurityPoliciesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine     security policy
    /// </summary>
    /// <param name="Name">Name of the security policy to update.</param>
    public GcloudPreviewComputeSecurityPoliciesUpdateOptions(
        string Name
    )
    {
    ...
    public GcloudPreviewComputeSecurityPoliciesUpdateJsonParsing? JsonParsing { get; set; }
    ...
    public GcloudPreviewComputeSecurityPoliciesUpdateLayer7DdosDefenseRuleVisibility? Layer7DdosDefenseRuleVisibility { get; set; }
    ...
    public GcloudPreviewComputeSecurityPoliciesUpdateLogLevel? LogLevel { get; set; }
    ...
    public GcloudPreviewComputeSecurityPoliciesUpdateNetworkDdosProtection? NetworkDdosProtection { get; set; }
