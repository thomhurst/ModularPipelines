...
// Source: https://cloud.google.com/sdk/gcloud/reference/projects/add-iam-policy-binding
...
[CliSubCommand("projects", "add-iam-policy-binding")]
public record GcloudProjectsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding for a     project
    /// </summary>
    ...
    /// <param name="ProjectId">Project resource - The project to add the IAM policy binding. This represents a Cloud resource. This must be specified. ID of the project or fully qualified identifier for the project. To set the project_id attribute: ▸ provide the argument project_id on the command line.</param>
    public GcloudProjectsAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string ProjectId
    )
    ...
    /// <summary>
    /// Project resource - The project to add the IAM policy binding. This represents a Cloud resource. This must be specified. ID of the project or fully qualified identifier for the project. To set the project_id attribute: ▸ provide the argument project_id on the command line.
    /// </summary>
