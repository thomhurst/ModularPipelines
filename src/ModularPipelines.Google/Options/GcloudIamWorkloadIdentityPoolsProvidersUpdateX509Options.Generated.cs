...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/update-x509
...
[CliSubCommand("iam", "workload-identity-pools", "providers", "update-x509")]
public record GcloudIamWorkloadIdentityPoolsProvidersUpdateX509Options : GcloudOptions
{
    /// <summary>
    /// update an X.509     workload identity pool provider
    /// </summary>
    ...
    public GcloudIamWorkloadIdentityPoolsProvidersUpdateX509Options(
        string Provider
    )
    {
    ...
    public string? TrustStoreConfigPath { get; set; }
