...
public record GcloudComputeInstancesImportOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create Compute Engine virtual machine     instances from virtual appliance in OVA/OVF format
    /// </summary>
    ...
    public GcloudComputeInstancesImportOptions(
        string SourceUri,
        string InstanceName
    )
    {
    ...
    public GcloudComputeInstancesImportNetworkTier? NetworkTier { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Import instance without scopes
    /// </summary>
    [CliFlag("--no-scopes")]
    ...
    /// <summary>
    /// At most one of these can be specified: Import instance without service account
    /// </summary>
