...
public record GcloudDatalineageRunsCreateOptions : GcloudOptions
{
    ...
    public GcloudDatalineageRunsCreateOptions(
        string StartTime,
        GcloudDatalineageRunsCreateState State,
        string Run
    )
    {
    ...
    public void Deconstruct(out string StartTime, out GcloudDatalineageRunsCreateState State, out string Run)
    {
    ...
    public GcloudDatalineageRunsCreateState State { get; private init; }
