...
public record GcloudPreviewComputeUrlMapsDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe a URL map
    /// </summary>
    /// <param name="UrlMap">Name of the URL map to describe.</param>
    public GcloudPreviewComputeUrlMapsDescribeOptions(
        string UrlMap
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the URL map to describe. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
