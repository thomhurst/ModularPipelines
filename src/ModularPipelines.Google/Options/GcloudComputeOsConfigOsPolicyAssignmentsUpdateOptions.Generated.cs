...
public record GcloudComputeOsConfigOsPolicyAssignmentsUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update an OS policy     assignment
    /// </summary>
