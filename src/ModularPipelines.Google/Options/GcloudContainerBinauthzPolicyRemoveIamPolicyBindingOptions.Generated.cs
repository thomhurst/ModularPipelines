...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/binauthz/policy/remove-iam-policy-binding
...
[CliSubCommand("container", "binauthz", "policy", "remove-iam-policy-binding")]
public record GcloudContainerBinauthzPolicyRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM     policy binding of a Binary Authorization policy
    /// </summary>
    ...
    public GcloudContainerBinauthzPolicyRemoveIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
