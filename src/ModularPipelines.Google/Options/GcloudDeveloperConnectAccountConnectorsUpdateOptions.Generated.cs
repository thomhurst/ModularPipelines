...
public record GcloudDeveloperConnectAccountConnectorsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Negates --allow-missing. If set to true, and the accountConnector is not found a new accountConnector will be created. In this situation update_mask is ignored. The creation will succeed only if the input accountConnector has all the necessary. Use --allow-missing to enable and --no-allow-missing to disable.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the account connector config. At most one of these can be specified: Message for a customized OAuth config. Set accountConnector.customOauthConfig back to default value.
    /// </summary>
    [CliFlag("--clear-custom-oauth-config")]
    public bool? ClearCustomOauthConfig { get; set; }

    /// <summary>
    /// Arguments for the account connector config. At most one of these can be specified: Message for a customized OAuth config. Client ID of the OAuth application.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the account connector config. At most one of these can be specified: Message for a customized OAuth config. Client secret of the OAuth application. It will be provided as plain text, but encrypted and stored in developer connect. As INPUT_ONLY field, it will not be included in the output.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Arguments for the account connector config. At most one of these can be specified: Message for a customized OAuth config. Host URI of the OAuth application.
    /// </summary>
    [CliOption("--custom-oauth-config-host-uri", Format = OptionFormat.EqualsSeparated)]
    public string? CustomOauthConfigHostUri { get; set; }

    /// <summary>
    /// Arguments for the account connector config. At most one of these can be specified: Message for a customized OAuth config. Disable PKCE for this OAuth config. PKCE is enabled by default. Use --custom-oauth-config-pkce-disabled to enable and --no-custom-oauth-config-pkce-disabled to disable.
    /// </summary>
    [CliFlag("--custom-oauth-config-pkce-disabled")]
    public bool? CustomOauthConfigPkceDisabled { get; set; }

    /// <summary>
    /// Negates --custom-oauth-config-pkce-disabled. Arguments for the account connector config. At most one of these can be specified: Message for a customized OAuth config. Disable PKCE for this OAuth config. PKCE is enabled by default. Use --custom-oauth-config-pkce-disabled to enable and --no-custom-oauth-config-pkce-disabled to disable.
    /// </summary>
    ...
    /// <summary>
    /// Negates --proxy-config-enabled. Setting this to true allows the git and http proxies to perform actions on behalf of the user configured under the account connector. Use --proxy-config-enabled to enable and --no-proxy-config-enabled to disable.
    /// </summary>
