...
public record GcloudComputeBackendBucketsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a backend bucket
    /// </summary>
    /// <param name="GcsBucketName">The name of the Google Cloud Storage bucket to serve from. The storage bucket must be in the same project.</param>
    /// <param name="BackendBucketName">Name of the backend bucket to create.</param>
    public GcloudComputeBackendBucketsCreateOptions(
        string GcsBucketName,
        string BackendBucketName
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(GcsBucketName);
        this.GcsBucketName = GcsBucketName;
        global::System.ArgumentNullException.ThrowIfNull(BackendBucketName);
        this.BackendBucketName = BackendBucketName;
    }

    public void Deconstruct(out string GcsBucketName, out string BackendBucketName)
    {
    ...
    public string GcsBucketName { get; private init; }
    ...
    public GcloudComputeBackendBucketsCreateCompressionMode? CompressionMode { get; set; }
    ...
    public GcloudComputeBackendBucketsCreateLoadBalancingScheme? LoadBalancingScheme { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the backend bucket to create. Overrides the default compute/region property value for this command invocation.
    /// </summary>
