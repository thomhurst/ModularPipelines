...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The max running time of the execution job, as a duration. See '$ gcloud topic datetimes' for details on formatting the input duration.
    /// </summary>
    [CliOption("--execution-timeout", Format = OptionFormat.EqualsSeparated)]
    public string? ExecutionTimeout { get; set; }

    /// <summary>
    /// Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The kernel name to use for the execution.
    /// </summary>
    ...
    /// <summary>
    /// Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The number of accelerators used by the runtime.
    /// </summary>
    ...
    /// <summary>
    /// Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The Compute Engine machine type selected for the runtime.
    /// </summary>
