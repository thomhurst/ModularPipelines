...
/// <param name="ExecutionDisplayName">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The display name of the execution. This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="GcsOutputUri">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The Cloud Storage location to upload notebook execution results to. Format: gs://bucket-name. This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="ServiceAccount">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The service account to run the execution as This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="ExecutionTimeout">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The max running time of the execution job, as a duration. See '$ gcloud topic datetimes' for details on formatting the input duration.</param>
/// <param name="KernelName">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The kernel name to use for the execution.</param>
/// <param name="GcsNotebookUri">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. Source of the notebook to execute. This must be specified. The Cloud Storage notebook source. The Cloud Storage uri pointing to the notebook. Format: gs://bucket/notebook_file.ipynb This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="Generation">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. Source of the notebook to execute. This must be specified. The Cloud Storage notebook source. The version of the Cloud Storage object to read. If unset, the current version of the object will be used.</param>
/// <param name="AcceleratorCount">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The number of accelerators used by the runtime.</param>
/// <param name="AcceleratorType">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The type of hardware accelerator used by the runtime. If specified, --accelerator-count must also be specified. ACCELERATOR_TYPE must be one of: NVIDIA_TESLA_V100, NVIDIA_TESLA_T4, NVIDIA_TESLA_A100, NVIDIA_A100_80GB, NVIDIA_L4.</param>
/// <param name="MachineType">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The Compute Engine machine type selected for the runtime.</param>
/// <param name="DiskSizeGb">Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. The disk size of the runtime in GB. If specified, the --disk-type must also be specified. The minimum size is 10GB and the maximum is 65536GB.</param>
...
public record GcloudWorkbenchSchedulesCreateOptions(
...
) : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Negates --enable-internet-access. Configuration of the schedule. This must be specified. Configuration of the execution job. This must be specified. Compute configuration of the execution job. The machine configuration of the runtime. The configuration for the data disk of the runtime. The network configuration for the runtime. Enable public internet access for the runtime. Enabled by default, use --no-enable-internet-access to disable.
    /// </summary>
