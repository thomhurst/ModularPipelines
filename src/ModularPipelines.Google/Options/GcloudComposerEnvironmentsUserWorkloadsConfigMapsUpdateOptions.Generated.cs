...
public record GcloudComposerEnvironmentsUserWorkloadsConfigMapsUpdateOptions(
    [property: CliOption("--config-map-file-path", Format = OptionFormat.EqualsSeparated)] string ConfigMapFilePath
) : GcloudOptions
{
    /// <summary>
