...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/keys/describe
...
[CliSubCommand("iam", "workload-identity-pools", "providers", "keys", "describe")]
public record GcloudIamWorkloadIdentityPoolsProvidersKeysDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a     workload identity pool provider key
    /// </summary>
    /// <param name="Key">Workload identity pool provider key resource - The workload identity pool provider key to describe. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument key on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the workload identity pool provider key or fully qualified identifier for the workload identity pool provider key. To set the key attribute: ▸ provide the argument key on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamWorkloadIdentityPoolsProvidersKeysDescribeOptions(
        string Key
    )
    {
