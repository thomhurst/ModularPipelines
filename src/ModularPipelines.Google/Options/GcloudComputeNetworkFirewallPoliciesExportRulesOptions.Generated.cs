...
public record GcloudComputeNetworkFirewallPoliciesExportRulesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// export Compute     Engine network firewall policy rules
    /// </summary>
    /// <param name="FirewallPolicy">name of the network firewall policy to export rules from.</param>
    public GcloudComputeNetworkFirewallPoliciesExportRulesOptions(
