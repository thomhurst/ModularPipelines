...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/hub/rollouts/pause
...
[CliSubCommand("container", "hub", "rollouts", "pause")]
public record GcloudContainerHubRolloutsPauseOptions : GcloudOptions
{
    /// <summary>
    /// pause a rollout resource
    /// </summary>
    ...
    public GcloudContainerHubRolloutsPauseOptions(
        string Rollout
    )
    {
