...
public record GcloudSpannerBackupSchedulesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public void Deconstruct(out GcloudBackupType BackupType, out string Cron, out string RetentionDuration, out string BackupSchedule)
    {
    ...
    public GcloudBackupType BackupType { get; private init; }
