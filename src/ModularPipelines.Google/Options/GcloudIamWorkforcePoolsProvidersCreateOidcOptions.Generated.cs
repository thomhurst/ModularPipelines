...
public record GcloudIamWorkforcePoolsProvidersCreateOidcOptions(
    ...
    [property: CliOption("--client-id", Format = OptionFormat.EqualsSeparated)] string ClientId,
    [property: CliOption("--issuer-uri", Format = OptionFormat.EqualsSeparated)] string IssuerUri,
    [property: CliOption("--web-sso-assertion-claims-behavior", Format = OptionFormat.EqualsSeparated)] string WebSsoAssertionClaimsBehavior,
    [property: CliOption("--web-sso-response-type", Format = OptionFormat.EqualsSeparated)] GcloudWebSsoResponseType WebSsoResponseType,
    [property: CliOption("--web-sso-additional-scopes", Format = OptionFormat.EqualsSeparated)] IEnumerable<string> WebSsoAdditionalScopes
) : GcloudOptions
{
    /// <summary>
