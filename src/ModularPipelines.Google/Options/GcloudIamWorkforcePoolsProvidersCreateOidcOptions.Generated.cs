...
public record GcloudIamWorkforcePoolsProvidersCreateOidcOptions : GcloudOptions
{
    ...
    public GcloudIamWorkforcePoolsProvidersCreateOidcOptions(
        ...
        GcloudWebSsoResponseType WebSsoResponseType,
        string Provider
    )
    {
        {
    ...
    public void Deconstruct(out IReadOnlyList<KeyValue> AttributeMapping, out string ClientId, out string IssuerUri, out string WebSsoAssertionClaimsBehavior, out GcloudWebSsoResponseType WebSsoResponseType, out string Provider)
    {
    ...
    public GcloudWebSsoResponseType WebSsoResponseType { get; private init; }
