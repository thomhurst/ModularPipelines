...
public record GcloudComputeBackendBucketsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a backend bucket
    /// </summary>
    /// <param name="BackendBucketName">Name of the backend bucket to update.</param>
    public GcloudComputeBackendBucketsUpdateOptions(
    ...
    public GcloudComputeBackendBucketsUpdateCompressionMode? CompressionMode { get; set; }
