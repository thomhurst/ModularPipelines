...
public record GcloudOracleDatabaseAutonomousDatabasesCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// This field indicates if auto scaling is enabled for the Autonomous     Database storage.    Arguments for the local adg auto failover max data loss limit duration.
    /// </summary>
    ...
    /// <summary>
    /// Indicates whether the Autonomous Database has a local (in-region)     standby database. Not applicable to cross-region Data Guard or     dedicated Exadata infrastructure.
    /// </summary>
