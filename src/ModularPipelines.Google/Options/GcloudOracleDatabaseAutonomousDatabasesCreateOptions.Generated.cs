...
public record GcloudOracleDatabaseAutonomousDatabasesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// For resources [autonomous_database, encryption-key-kms, odb-network, odb-subnet, source-config-autonomous-database, source-config-autonomous-database-backup], provides fallback value for resource location attribute. When the resource's full URI path is not provided, location will fallback to this flag value.
    /// </summary>
    [CliOption("--location", Format = OptionFormat.EqualsSeparated)]
    public string? Location { get; set; }

    /// <summary>
    /// Network resource - The name of the VPC network used by the Autonomous Database in the following format: projects/{project}/global/networks/{network} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --network on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. ID of the network or fully qualified identifier for the network. To set the network attribute: ◆ provide the argument --network on the command line.
    /// </summary>
    [CliOption("--network", Format = OptionFormat.EqualsSeparated)]
    public string? Network { get; set; }

    /// <summary>
    /// Network resource - The name of the VPC network used by the Autonomous Database in the following format: projects/{project}/global/networks/{network} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --network on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. For resources [odb-network, odb-subnet], provides fallback value for resource odb-network attribute. When the resource's full URI path is not provided, odb-network will fallback to this flag value.
    /// </summary>
    [CliOption("--odb-network", Format = OptionFormat.EqualsSeparated)]
    public string? OdbNetwork { get; set; }

    /// <summary>
    /// OdbSubnet resource - The name of the OdbSubnet associated with the Autonomous Database. Format: projects/{project}/locations/{location}/odbNetworks/{odb_network}/odbSubnets/{odb_subnet} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --odb-subnet on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --odb-subnet on the command line with a fully specified name; ◆ provide the argument --location on the command line. To set the odb-network attribute: ◆ provide the argument --odb-subnet on the command line with a fully specified name; ◆ provide the argument --odb-network on the command line. ID of the odbSubnet or fully qualified identifier for the odbSubnet. To set the odb-subnet attribute: ◆ provide the argument --odb-subnet on the command line.
    /// </summary>
    [CliOption("--odb-subnet", Format = OptionFormat.EqualsSeparated)]
    public string? OdbSubnet { get; set; }

    /// <summary>
    /// OdbSubnet resource - The name of the OdbSubnet associated with the Autonomous Database. Format: projects/{project}/locations/{location}/odbNetworks/{odb_network}/odbSubnets/{odb_subnet} This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --odb-subnet on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --odb-subnet on the command line with a fully specified name; ◆ provide the argument --location on the command line. To set the odb-network attribute: ◆ provide the argument --odb-subnet on the command line with a fully specified name; ◆ provide the argument --odb-network on the command line. An optional ID to identify the request. This value is used to identify duplicate requests. If you make a request with the same request ID and the original request is still in progress or completed, the server ignores the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the local data guard enabled. This field specifies if the Autonomous Database requires mTLS connections.
    /// </summary>
    [CliFlag("--properties-mtls-connection-required")]
    public bool? PropertiesMtlsConnectionRequired { get; set; }

    /// <summary>
    /// Arguments for the local data guard enabled. The national character set for the Autonomous Database. The default is AL16UTF16.
    /// </summary>
    [CliOption("--properties-n-character-set", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesNCharacterSet { get; set; }

    /// <summary>
    /// Arguments for the local data guard enabled. The private endpoint IP address for the Autonomous Database.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the local data guard enabled. The private endpoint label for the Autonomous Database.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the auto refresh point lag seconds. The time, in seconds, the data of the automatic refreshable clone lags the primary database at the point of refresh.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the auto refresh point lag seconds. The date and time that auto-refreshing will begin for an Autonomous Database refreshable clone. This value controls only the start time for the first refresh operation.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the auto refresh point lag seconds. This field specifies if the replication of automatic backups is enabled when creating a Data Guard.
    /// </summary>
    ...
    /// <summary>
    /// AutonomousDatabase resource - The name of the primary Autonomous Database that is used to create a Peer Autonomous Database from a source. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database on the command line with a fully specified name; ◆ provide the argument --location on the command line. ID of the autonomousDatabase or fully qualified identifier for the autonomousDatabase. To set the autonomous-database attribute: ◆ provide the argument --source-config-autonomous-database on the command line.
    /// </summary>
    ...
    /// <summary>
    /// AutonomousDatabaseBackup resource - The name of the Autonomous Database Backup resource with the format: projects/{project}/locations/{region}/autonomousDatabaseBackups/{autonomous_database_backup} Required when source_type is BACKUP_FROM_ID. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --location on the command line. ID of the autonomousDatabaseBackup or fully qualified identifier for the autonomousDatabaseBackup. To set the autonomous-database-backup attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line.
    /// </summary>
    ...
    /// <summary>
    /// AutonomousDatabaseBackup resource - The name of the Autonomous Database Backup resource with the format: projects/{project}/locations/{region}/autonomousDatabaseBackups/{autonomous_database_backup} Required when source_type is BACKUP_FROM_ID. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --location on the command line. The timestamp specified for the point-in-time clone of the source Autonomous Database. This field is only applicable in case of BACKUP_FROM_TIMESTAMP source type and when use_latest_available_backup is false.
    /// </summary>
    [CliOption("--source-config-backup-time", Format = OptionFormat.EqualsSeparated)]
    public string? SourceConfigBackupTime { get; set; }

    /// <summary>
    /// AutonomousDatabaseBackup resource - The name of the Autonomous Database Backup resource with the format: projects/{project}/locations/{region}/autonomousDatabaseBackups/{autonomous_database_backup} Required when source_type is BACKUP_FROM_ID. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --location on the command line. The clone type of the Autonomous Database. This field is only applicable in case of cloning. SOURCE_CONFIG_CLONE_TYPE must be one of: full Creates a new database with the source database's data and metadata. metadata Creates a new database that includes all the source database schema metadata, but none of the source database data.
    /// </summary>
    [CliOption("--source-config-clone-type", Format = OptionFormat.EqualsSeparated)]
    public string? SourceConfigCloneType { get; set; }

    /// <summary>
    /// AutonomousDatabaseBackup resource - The name of the Autonomous Database Backup resource with the format: projects/{project}/locations/{region}/autonomousDatabaseBackups/{autonomous_database_backup} Required when source_type is BACKUP_FROM_ID. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --location on the command line. The refresh mode of the clone. SOURCE_CONFIG_REFRESHABLE_MODE must be one of: automatic Automatic refresh. manual Manual refresh.
    /// </summary>
    ...
    /// <summary>
    /// AutonomousDatabaseBackup resource - The name of the Autonomous Database Backup resource with the format: projects/{project}/locations/{region}/autonomousDatabaseBackups/{autonomous_database_backup} Required when source_type is BACKUP_FROM_ID. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --location on the command line. The source type of the Autonomous Database. SOURCE_CONFIG_TYPE must be one of: backup-from-id Create clone from the backup resource. backup-from-timestamp Create clone from backup specified by backup_time field, or use latest available backup if use_latest_available_backup is true. The autonomous_database field must specify the source database to clone from. clone-database Clone database from an existing database specified in autonomous_database field. clone-to-refreshable Create a refreshable clone from an existing database specified in autonomous_database field. cross-region-disaster-recovery Create a cross-region disaster recovery peer adb from an existing adb.
    /// </summary>
    [CliOption("--source-config-type", Format = OptionFormat.EqualsSeparated)]
    public string? SourceConfigType { get; set; }

    /// <summary>
    /// AutonomousDatabaseBackup resource - The name of the Autonomous Database Backup resource with the format: projects/{project}/locations/{region}/autonomousDatabaseBackups/{autonomous_database_backup} Required when source_type is BACKUP_FROM_ID. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --source-config-autonomous-database-backup on the command line with a fully specified name; ◆ provide the argument --location on the command line. Clone from latest available backup timestamp. This field is only applicable in case of BACKUP_FROM_TIMESTAMP source type.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(EncryptionKeyKms) || !string.IsNullOrWhiteSpace(KeyRing)) && (!(!string.IsNullOrWhiteSpace(EncryptionKeyKms))))
        {
