...
public record GcloudLoggingLinksListOptions : GcloudOptions
{
    ...
    /// <summary>
    /// At most one of these can be specified: Folder of the linked datasets to list.
    /// </summary>
    [CliOption("--folder", Format = OptionFormat.EqualsSeparated)]
    public string? Folder { get; set; }

    /// <summary>
    /// At most one of these can be specified: Organization of the linked datasets to list.
    /// </summary>
