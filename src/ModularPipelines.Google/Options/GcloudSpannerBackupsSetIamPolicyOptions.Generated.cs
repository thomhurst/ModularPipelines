...
public record GcloudSpannerBackupsSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudSpannerBackupsSetIamPolicyOptions(
        string Backup,
        string PolicyFile
    )
    {
