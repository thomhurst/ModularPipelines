...
public record GcloudDatabaseMigrationPrivateConnectionsDescribeOptions : GcloudOptions
{
    ...
    public GcloudDatabaseMigrationPrivateConnectionsDescribeOptions(
    ...
    /// <summary>
    /// Private connection resource - The private connection you want to get the details of. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument private_connection on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. The name of the region. To set the region attribute: ▸ provide the argument private_connection on the command line with a fully specified name; ▸ provide the argument --region on the command line.
    /// </summary>
