...
public record GcloudColabExecutionsCreateOptions(
    ...
    [property: CliOption("--notebook-runtime-template", Format = OptionFormat.EqualsSeparated)] string NotebookRuntimeTemplate
