...
public record GcloudComputeInterconnectsAttachmentsL2ForwardingUpdateMappingOptions : GcloudOptions
{
    /// <summary>
    /// update vlan to ip mapping rule to an L2-forwarding attachment
    /// </summary>
    ...
    public GcloudComputeInterconnectsAttachmentsL2ForwardingUpdateMappingOptions(
        string VlanKey,
        string Name
    )
    {
