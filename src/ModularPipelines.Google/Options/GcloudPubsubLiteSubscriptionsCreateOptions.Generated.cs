...
public record GcloudPubsubLiteSubscriptionsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudPubsubLiteSubscriptionsCreateDeliveryRequirement? DeliveryRequirement { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: The event time to which you seek a subscription. The subscription seeks to the first message with event time greater than or equal to the specified event time. Messages missing an event time use publish time as a fallback. As event times are user supplied, subsequent messages may have event times less than the specified event time and must be filtered by the client, if necessary. Run $ gcloud topic datetimes for information on time formats.
    /// </summary>
    [CliOption("--event-time", Format = OptionFormat.EqualsSeparated)]
    public string? EventTime { get; set; }

    /// <summary>
    /// At most one of these can be specified: The publish time to which you seek a subscription. Messages with publish time greater than or equal to the specified time are delivered after the seek operation. Run $ gcloud topic datetimes for information on time formats.
    /// </summary>
    [CliOption("--publish-time", Format = OptionFormat.EqualsSeparated)]
    public string? PublishTime { get; set; }

    /// <summary>
    /// At most one of these can be specified: The offset at which a newly created or seeked subscription starts receiving messages. A subscription can be initialized at the offset of the oldest retained message (beginning), or at the current HEAD offset (end). STARTING_OFFSET must be one of: beginning, end.
    /// </summary>
    [CliOption("--starting-offset", Format = OptionFormat.EqualsSeparated)]
    public GcloudPubsubLiteSubscriptionsCreateStartingOffset? StartingOffset { get; set; }
    ...
    public GcloudPubsubLiteSubscriptionsCreateExportDesiredState? ExportDesiredState { get; set; }
