...
{
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The request body associated with the HTTP POST request. Can only be set if --protocol is http or https.
    /// </summary>
    [CliOption("--body", Format = OptionFormat.EqualsSeparated)]
    public string? Body { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The content type header to use for the check, defaults to unspecified. Can only be set if --protocol is http or https. CONTENT_TYPE must be one of: unspecified Not specified url-encoded URL encoded user-provided User provided
    /// </summary>
    [CliOption("--content-type", Format = OptionFormat.EqualsSeparated)]
    public string? ContentType { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. A user-provided content type header to use for the check. Can only be set if --protocol is http or https.
    /// </summary>
    [CliOption("--custom-content-type", Format = OptionFormat.EqualsSeparated)]
    public string? CustomContentType { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Whether to encrypt the header information, defaults to false. Can only be set if --protocol is http or https.
    /// </summary>
    [CliOption("--mask-headers", Format = OptionFormat.EqualsSeparated)]
    public string? MaskHeaders { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The password to use when authenticating with the HTTP server. Can only be set if --protocol is http or https.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The path to the page against which to run the check, defaults to /. Can only be set if --protocol is http or https.
    /// </summary>
    [CliOption("--path", Format = OptionFormat.EqualsSeparated)]
    public string? Path { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Number of ICMP pings to send alongside the request.
    /// </summary>
    [CliOption("--pings-count", Format = OptionFormat.EqualsSeparated)]
    public int? PingsCount { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The port on the server against which to run the check. Defaults to 80 when --protocol is http. Defaults to 443 when --protocol is https. Required if --protocol is tcp.
    /// </summary>
    [CliOption("--port", Format = OptionFormat.EqualsSeparated)]
    public string? Port { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The HTTP request method to use, defaults to get. Can only be set if --protocol is http or https. REQUEST_METHOD must be one of: get HTTP GET method post HTTP POST method
    /// </summary>
    [CliOption("--request-method", Format = OptionFormat.EqualsSeparated)]
    public string? RequestMethod { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The type of authentication to use for the HTTP request. Can only be set if --protocol is https. SERVICE_AGENT_AUTH must be (only one value is supported): oidc-token OIDC Token authentication
    /// </summary>
    [CliOption("--service-agent-auth", Format = OptionFormat.EqualsSeparated)]
    public string? ServiceAgentAuth { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The username to use when authenticating with the HTTP server. Can only be set if --protocol is http or https.
    /// </summary>
    [CliOption("--username", Format = OptionFormat.EqualsSeparated)]
    public string? Username { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Whether to include SSL certificate validation as a part of the uptime check, defaults to false. Can only be set if --protocol is http or https.
    /// </summary>
    ...
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Uptime check status. At most one of these can be specified: Uptime check status classes. At most one of these can be specified: Clear all HTTP status classes on the uptime check. Setting this flag is the same as selecting only the 2xx status class.
    /// </summary>
    ...
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Uptime check status codes. At most one of these can be specified: Clear all HTTP status codes on the uptime check. Setting this flag is the same as selecting only the 2xx status class.
    /// </summary>
    ...
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The list of headers to add to the uptime check. Any existing headers with matching "key" are overridden by the provided values.
    /// </summary>
    [CliOption("--update-headers", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? UpdateHeaders { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Uptime check remove headers. At most one of these can be specified: Clear all headers on the uptime check.
    /// </summary>
    ...
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The display name for the uptime check or synthetic monitor.
    /// </summary>
    [CliOption("--display-name", Format = OptionFormat.EqualsSeparated)]
    public string? DisplayName { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The time between uptime check or synthetic monitor executions in minutes, defaults to 1. Can be set for synthetic monitors. PERIOD must be one of: 1 One minute 10 Ten minutes 15 Fifteen minutes 5 Five minutes
    /// </summary>
    [CliOption("--period", Format = OptionFormat.EqualsSeparated)]
    public string? Period { get; set; }

    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. The maximum amount of time in seconds to wait for the request to complete, defaults to 60. Can be set for synthetic monitors.
    /// </summary>
    ...
    /// <summary>
    /// Uptime check protocol settings. Uptime check service agent authorization. Uptime check headers. Settings. User labels. Can be set for synthetic monitors. Uptime check matcher settings. Uptime check matcher settings for JSON responses. Uptime check selected regions. At most one of these can be specified: Clear all regions on the uptime check. This setting acts the same as if all available regions were selected.
    /// </summary>
