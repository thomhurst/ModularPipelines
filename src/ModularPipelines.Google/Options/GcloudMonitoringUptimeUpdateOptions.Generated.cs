...
public record GcloudMonitoringUptimeUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Uptime check status codes. At most one of these can be specified: The list of HTTP status codes to add to the uptime check. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Uptime check status codes. At most one of these can be specified: Clear all HTTP status codes on the uptime check. Setting this flag is the same as selecting only the 2xx status class.
    /// </summary>
