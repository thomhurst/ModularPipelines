...
public record GcloudMonitoringUptimeUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Uptime check headers. Uptime check remove headers. At most one of these can be specified: Clear all headers on the uptime check.
    /// </summary>
