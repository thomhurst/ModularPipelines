...
public record GcloudAssetGetHistoryOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudAssetGetHistoryOptions(
        ...
        GcloudAssetGetHistoryContentType ContentType,
        string StartTime
    )
    {
        {
    ...
    public void Deconstruct(out IEnumerable<string> AssetNames, out GcloudAssetGetHistoryContentType ContentType, out string StartTime)
    {
    ...
    public GcloudAssetGetHistoryContentType ContentType { get; private init; }
