...
public record GcloudPreviewComputeInstancesTestIamPermissionsOptions(
    [property: CliOption("--permissions", Format = OptionFormat.EqualsSeparated)] string Permissions,
