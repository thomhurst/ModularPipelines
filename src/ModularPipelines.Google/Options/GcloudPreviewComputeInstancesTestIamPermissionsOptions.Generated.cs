...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/test-iam-permissions
...
[CliSubCommand("preview", "compute", "instances", "test-iam-permissions")]
public record GcloudPreviewComputeInstancesTestIamPermissionsOptions : GcloudOptions
{
    /// <summary>
    /// test IAM     permissions for a Compute Engine instance
    /// </summary>
    /// <param name="Permissions">Single IAM permission to test.</param>
    ...
    public GcloudPreviewComputeInstancesTestIamPermissionsOptions(
        string Permissions,
        string InstanceName
    )
    {
    ...
    public void Deconstruct(out string Permissions, out string InstanceName)
    {
