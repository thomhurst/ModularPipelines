...
public record GcloudContainerBinauthzAttestationsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    {
        if (((!string.IsNullOrWhiteSpace(Note) || !string.IsNullOrWhiteSpace(NoteProject)) ? 1 : 0) + ((Validate == true || !string.IsNullOrWhiteSpace(Attestor) || !string.IsNullOrWhiteSpace(AttestorProject)) ? 1 : 0) > 1)
        {
        ...
        if ((!string.IsNullOrWhiteSpace(Note) || !string.IsNullOrWhiteSpace(NoteProject) || Validate == true || !string.IsNullOrWhiteSpace(Attestor) || !string.IsNullOrWhiteSpace(AttestorProject)) && (Validate == true || !string.IsNullOrWhiteSpace(Attestor) || !string.IsNullOrWhiteSpace(AttestorProject)) && (!string.IsNullOrWhiteSpace(Attestor) || !string.IsNullOrWhiteSpace(AttestorProject)) && (!(!string.IsNullOrWhiteSpace(Attestor))))
        {
