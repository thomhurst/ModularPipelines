...
public record GcloudSccManageCustomModulesEtdDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// get the details of a Event     Threat Detection custom module
    /// </summary>
    /// <param name="ModuleIdOrName">The custom module ID or name. The expected format is {parent}/[locations/global]/eventThreatDetectionCustomModules/{module_id} or just {module_id}. Where module_id is a numeric identifier 1-20 characters in length. Parent is of the form organizations/{id}, projects/{id or name}, folders/{id}.</param>
    public GcloudSccManageCustomModulesEtdDescribeOptions(
