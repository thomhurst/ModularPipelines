...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/routers/upload-route-policy
...
public record GcloudPreviewComputeRoutersUploadRoutePolicyOptions : GcloudOptions
{
    /// <summary>
    /// upload a route policy     into a Compute Engine router
    /// </summary>
    ...
    public GcloudPreviewComputeRoutersUploadRoutePolicyOptions(
        string FileName,
        string Name
    )
    {
    ...
    public GcloudPreviewComputeRoutersUploadRoutePolicyFileFormat? FileFormat { get; set; }
