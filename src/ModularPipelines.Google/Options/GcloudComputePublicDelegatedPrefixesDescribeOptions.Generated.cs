...
public record GcloudComputePublicDelegatedPrefixesDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describes a Compute     Engine public delegated prefix
    /// </summary>
    /// <param name="Name">Name of the public delegated prefix to operate on.</param>
    public GcloudComputePublicDelegatedPrefixesDescribeOptions(
        string Name
    )
    {
