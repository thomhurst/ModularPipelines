...
// Source: https://cloud.google.com/sdk/gcloud/reference/apihub/attributes/list
...
[CliSubCommand("apihub", "attributes", "list")]
public record GcloudApihubAttributesListOptions : GcloudOptions
{
    /// <summary>
    /// list Attributes
    /// </summary>
    ...
    public GcloudApihubAttributesListOptions(
        string Location
    )
    {
