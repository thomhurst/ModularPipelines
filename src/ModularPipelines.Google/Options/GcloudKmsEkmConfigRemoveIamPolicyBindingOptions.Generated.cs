...
// Source: https://cloud.google.com/sdk/gcloud/reference/kms/ekm-config/remove-iam-policy-binding
...
[CliSubCommand("kms", "ekm-config", "remove-iam-policy-binding")]
public record GcloudKmsEkmConfigRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy binding     from an EkmConfig
    /// </summary>
    ...
    public GcloudKmsEkmConfigRemoveIamPolicyBindingOptions(
        string Location,
        string Member,
        string Role
    )
    ...
    public void Deconstruct(out string Location, out string Member, out string Role)
    {
