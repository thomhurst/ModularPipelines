...
public record GcloudComputeInstanceTemplatesCreateWithContainerOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// creates a Compute     Engine a virtual machine instance template that runs a Docker container
    /// </summary>
    /// <param name="Name">Name of the instance template to create.</param>
    public GcloudComputeInstanceTemplatesCreateWithContainerOptions(
        string Name
    )
    {
    ...
    public GcloudComputeInstanceTemplatesCreateWithContainerContainerRestartPolicy? ContainerRestartPolicy { get; set; }
    ...
    public GcloudComputeInstanceTemplatesCreateWithContainerNetworkTier? NetworkTier { get; set; }
    ...
    /// <summary>
    /// Region of the instance template to create. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily)) && (!(!string.IsNullOrWhiteSpace(CustomCpu))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(CustomCpu) || !string.IsNullOrWhiteSpace(CustomMemory) || CustomExtensions == true || !string.IsNullOrWhiteSpace(CustomVmType) || !string.IsNullOrWhiteSpace(ImageProject) || !string.IsNullOrWhiteSpace(Image) || !string.IsNullOrWhiteSpace(ImageFamily)) && (!(!string.IsNullOrWhiteSpace(CustomMemory))))
        {
