...
public record GcloudComputeBackendServicesUpdateBackendOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update an existing backend     of a load balancer or Traffic Director
    /// </summary>
    /// <param name="BackendServiceName">Name of the backend service to operate on.</param>
    public GcloudComputeBackendServicesUpdateBackendOptions(
