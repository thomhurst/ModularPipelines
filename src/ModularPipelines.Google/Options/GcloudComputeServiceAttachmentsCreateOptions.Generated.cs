...
/// </summary>
/// <param name="NatSubnets">The subnetworks provided by service producer to use for NAT</param>
...
public record GcloudComputeServiceAttachmentsCreateOptions(
    [property: CliOption("--nat-subnets", Format = OptionFormat.EqualsSeparated)] IEnumerable<string> NatSubnets,
...
) : GcloudOptions, IValidatableObject
{
    ...
    /// </summary>
    [CliOption("--domain-names", Format = OptionFormat.EqualsSeparated)]
