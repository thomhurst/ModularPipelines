...
public record GcloudPreviewComputeDisksCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudPreviewComputeDisksCreateAccessMode? AccessMode { get; set; }
    ...
    public GcloudPreviewComputeDisksCreateArchitecture? Architecture { get; set; }
    ...
    public IEnumerable<GcloudPreviewComputeDisksCreateGuestOsFeatures>? GuestOsFeatures { get; set; }
    ...
    public GcloudPreviewComputeDisksCreateImageFamilyScope? ImageFamilyScope { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the primary disk for asynchronous replication. The primary and secondary disks must not be in the same region. Overrides the default compute/region property value for this command invocation.
    /// </summary>
    [CliOption("--primary-disk-region", Format = OptionFormat.EqualsSeparated)]
    public string? PrimaryDiskRegion { get; set; }

    /// <summary>
    /// At most one of these can be specified: Zone of the primary disk for asynchronous replication. The primary and secondary disks must not be in the same region. Overrides the default compute/zone property value for this command invocation.
    /// </summary>
    [CliOption("--primary-disk-zone", Format = OptionFormat.EqualsSeparated)]
    public string? PrimaryDiskZone { get; set; }

    /// <summary>
    /// At most one of these can be specified: Region of the disks to create. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
    [CliOption("--region", Format = OptionFormat.EqualsSeparated)]
    public string? Region { get; set; }

    /// <summary>
    /// At most one of these can be specified: Zone of the disks to create. If not specified and the compute/zone property isn't set, you might be prompted to select a zone (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/zone property: $ gcloud config set compute/zone ZONE A list of zones can be fetched by running: $ gcloud compute zones list To unset the property, run: $ gcloud config unset compute/zone Alternatively, the zone can be stored in the environment variable CLOUDSDK_COMPUTE_ZONE.
    /// </summary>
    [CliOption("--zone", Format = OptionFormat.EqualsSeparated)]
    public string? Zone { get; set; }

    /// <summary>
    /// At most one of these can be specified: Region of the source disk. This argument is not required if the target disk is in the same region as the source disk. Overrides the default compute/region property value for this command invocation.
    /// </summary>
    [CliOption("--source-disk-region", Format = OptionFormat.EqualsSeparated)]
    public string? SourceDiskRegion { get; set; }

    /// <summary>
    /// At most one of these can be specified: Zone of the source disk. This argument is not required if the target disk is in the same zone as the source disk. Overrides the default compute/zone property value for this command invocation.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(PrimaryDiskRegion) ? 1 : 0) + (!string.IsNullOrWhiteSpace(PrimaryDiskZone) ? 1 : 0) > 1)
        {
