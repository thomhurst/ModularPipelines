...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/sole-tenancy/node-groups/list-nodes
...
public record GcloudComputeSoleTenancyNodeGroupsListNodesOptions : GcloudOptions
{
    /// <summary>
    /// list Compute Engine     sole-tenant nodes present in a nodegroup
    /// </summary>
    /// <param name="Name">Name of the node group to operate on.</param>
    public GcloudComputeSoleTenancyNodeGroupsListNodesOptions(
        string Name
    )
    {
