...
public record GcloudFilestoreInstancesUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Clears the NfsExportOptions. Must specify --file-share flag if     --clear-nfs-export-options is specified.    Deletion protection control options. When deletion protection is enabled,   the instance cannot be deleted.
    /// </summary>
