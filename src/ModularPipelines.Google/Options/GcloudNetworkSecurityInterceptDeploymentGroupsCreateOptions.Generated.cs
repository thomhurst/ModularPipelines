...
public record GcloudNetworkSecurityInterceptDeploymentGroupsCreateOptions : GcloudOptions
{
    ...
    public GcloudNetworkSecurityInterceptDeploymentGroupsCreateOptions(
        string Network,
    ...
    public void Deconstruct(out string Network, out string InterceptDeploymentGroup)
    {
