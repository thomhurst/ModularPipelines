...
/// </summary>
/// <param name="ServiceBindings">List of service binding names to be added to the backend service.</param>
/// <param name="BackendServiceName"></param>
[GeneratedCode("ModularPipelines.OptionsGenerator", "2.0.0")]
[ExcludeFromCodeCoverage]
[CliSubCommand("preview", "compute", "backend-services", "add-service-bindings")]
public record GcloudPreviewComputeBackendServicesAddServiceBindingsOptions(
