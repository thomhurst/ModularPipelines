...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/backend-services/add-service-bindings
...
[CliSubCommand("preview", "compute", "backend-services", "add-service-bindings")]
public record GcloudPreviewComputeBackendServicesAddServiceBindingsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add service     bindings to a backend service
    /// </summary>
    /// <param name="ServiceBindings">List of service binding names to be added to the backend service. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="BackendServiceName">Name of the backend service to operate on.</param>
    public GcloudPreviewComputeBackendServicesAddServiceBindingsOptions(
    ...
    /// <summary>
    /// List of service binding names to be added to the backend service. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
