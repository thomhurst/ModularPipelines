...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/backend-services/remove-iam-policy-binding
...
[CliSubCommand("preview", "compute", "backend-services", "remove-iam-policy-binding")]
public record GcloudPreviewComputeBackendServicesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove     an IAM policy binding from a Compute Engine backend service
    /// </summary>
    ...
    public GcloudPreviewComputeBackendServicesRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
