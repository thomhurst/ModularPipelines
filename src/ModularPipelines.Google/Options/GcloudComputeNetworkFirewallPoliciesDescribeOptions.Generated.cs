...
public record GcloudComputeNetworkFirewallPoliciesDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe a Compute     Engine network firewall policy
    /// </summary>
    /// <param name="FirewallPolicy">name of the network firewall policy to get.</param>
    public GcloudComputeNetworkFirewallPoliciesDescribeOptions(
