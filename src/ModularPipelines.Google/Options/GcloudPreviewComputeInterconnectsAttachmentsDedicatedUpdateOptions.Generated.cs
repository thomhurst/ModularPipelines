...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/interconnects/attachments/dedicated/update
...
[CliSubCommand("preview", "compute", "interconnects", "attachments", "dedicated", "update")]
public record GcloudPreviewComputeInterconnectsAttachmentsDedicatedUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update     a Compute Engine dedicated interconnect attachment
    /// </summary>
    /// <param name="Name">Name of the interconnect attachment to patch.</param>
    public GcloudPreviewComputeInterconnectsAttachmentsDedicatedUpdateOptions(
        string Name
    )
    {
