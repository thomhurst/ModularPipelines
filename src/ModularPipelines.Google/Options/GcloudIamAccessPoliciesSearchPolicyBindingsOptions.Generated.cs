...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/access-policies/search-policy-bindings
...
[CliSubCommand("iam", "access-policies", "search-policy-bindings")]
public record GcloudIamAccessPoliciesSearchPolicyBindingsOptions : GcloudOptions
{
    /// <summary>
    /// search accessPolicies
    /// </summary>
    /// <param name="AccessPolicy">AccessPolicy resource - The name of the access policy. Format: organizations/{organization_id}/locations/{location}/accessPolicies/{access_policy_id} folders/{folder_id}/locations/{location}/accessPolicies/{access_policy_id} projects/{project_id}/locations/{location}/accessPolicies/{access_policy_id} projects/{project_number}/locations/{location}/accessPolicies/{access_policy_id} The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument access_policy on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This resource can be one of the following types: [iam.folders.locations.accessPolicies, iam.organizations.locations.accessPolicies, iam.projects.locations.accessPolicies]. This must be specified. ID of the accessPolicy or fully qualified identifier for the accessPolicy. To set the access_policy attribute: ▸ provide the argument access_policy on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamAccessPoliciesSearchPolicyBindingsOptions(
        string AccessPolicy
    )
    {
