...
// Source: https://cloud.google.com/sdk/gcloud/reference/apihub/operations/delete
...
[CliSubCommand("apihub", "operations", "delete")]
public record GcloudApihubOperationsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete operations
    /// </summary>
    ...
    public GcloudApihubOperationsDeleteOptions(
        string Operation
    )
    {
