...
public record GcloudDesignCenterSpacesApplicationTemplatesComponentsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Update input_variable_aliases. At most one of these can be specified: Or at least one of these can be specified: Add new value to input_variable_aliases list. Input variable aliases defined on this live component. alias Alias for the variable name to be exposed at the root level of the composite template. variable Name of the input variable inside the component's underlying template or module. Shorthand Example: --add-input-variable-aliases=alias=string,variable=string --add-input-variable-aliases=alias=string,variable=string JSON Example: --add-input-variable-aliases='[{"alias": "string", "variable": "string"}]' File Example: --add-input-variable-aliases=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update input_variable_aliases. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear input_variable_aliases value and set to empty list.
    /// </summary>
    [CliFlag("--clear-input-variable-aliases")]
    public bool? ClearInputVariableAliases { get; set; }

    /// <summary>
    /// Update input_variable_aliases. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from input_variable_aliases list. Input variable aliases defined on this live component. alias Alias for the variable name to be exposed at the root level of the composite template. variable Name of the input variable inside the component's underlying template or module. Shorthand Example: --remove-input-variable-aliases=alias=string,variable=string --remove-input-variable-aliases=alias=string,variable=string JSON Example: --remove-input-variable-aliases='[{"alias": "string", "variable": "string"}]' File Example: --remove-input-variable-aliases=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update parameters. At most one of these can be specified: Set parameters to new value. The component parameters. key The key of the parameter. value The value of the parameter. Shorthand Example: --parameters=key=string,value={...} --parameters=key=string,value={...} JSON Example: --parameters='[{"key": "string", "value": {...}}]' File Example: --parameters=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update parameters. At most one of these can be specified: Or at least one of these can be specified: Add new value to parameters list. The component parameters. key The key of the parameter. value The value of the parameter. Shorthand Example: --add-parameters=key=string,value={...} --add-parameters=key=string,value={...} JSON Example: --add-parameters='[{"key": "string", "value": {...}}]' File Example: --add-parameters=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update parameters. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear parameters value and set to empty list.
    /// </summary>
    [CliFlag("--clear-parameters")]
    public bool? ClearParameters { get; set; }

    /// <summary>
    /// Update parameters. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from parameters list. The component parameters. key The key of the parameter. value The value of the parameter. Shorthand Example: --remove-parameters=key=string,value={...} --remove-parameters=key=string,value={...} JSON Example: --remove-parameters='[{"key": "string", "value": {...}}]' File Example: --remove-parameters=path_to_file.(yaml|json)
    /// </summary>
