...
public record GcloudSpannerInstancesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding to     a Cloud Spanner instance
    /// </summary>
    ...
    public GcloudSpannerInstancesAddIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
