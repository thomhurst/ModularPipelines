...
public record GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// creates a     Compute Engine network firewall policy rule
    /// </summary>
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateOptions(
        GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateAction Action,
    ...
    public void Deconstruct(out GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateAction Action, out string FirewallPolicy, out IEnumerable<string> Layer4Configs, out string Priority)
    {
        Action = this.Action;
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateAction Action { get; private init; }
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateDirection? Direction { get; set; }
    ...
    public GcloudPreviewComputeNetworkFirewallPoliciesRulesCreateTargetType? TargetType { get; set; }
