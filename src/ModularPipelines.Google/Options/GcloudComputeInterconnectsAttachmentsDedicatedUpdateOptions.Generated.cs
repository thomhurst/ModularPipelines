...
public record GcloudComputeInterconnectsAttachmentsDedicatedUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a     Compute Engine dedicated interconnect attachment
    /// </summary>
    /// <param name="Name">Name of the interconnect attachment to patch.</param>
    public GcloudComputeInterconnectsAttachmentsDedicatedUpdateOptions(
        string Name
    )
    {
