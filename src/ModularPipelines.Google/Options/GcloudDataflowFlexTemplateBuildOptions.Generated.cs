...
public record GcloudDataflowFlexTemplateBuildOptions : GcloudOptions, IValidatableObject
{
    ...
    public void Deconstruct(out GcloudSdkLanguage SdkLanguage, out string TemplateFileGcsPath)
    {
    ...
    public GcloudSdkLanguage SdkLanguage { get; private init; }
