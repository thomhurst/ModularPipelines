...
public record GcloudComputeInstanceGroupsManagedUpdateAutoscalingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update     autoscaling parameters of a managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedUpdateAutoscalingOptions(
        string Name
    )
    {
    ...
    /// </summary>
    [CliOption("--remove-schedule", Format = OptionFormat.EqualsSeparated)]
    public string? RemoveSchedule { get; set; }

    /// <summary>
    /// At most one of these can be specified: A unique name for the scaling schedule to be configured.
    /// </summary>
    [CliOption("--set-schedule", Format = OptionFormat.EqualsSeparated)]
    public string? SetSchedule { get; set; }

    /// <summary>
    /// At most one of these can be specified: Name of the scaling schedule to be updated.
    /// </summary>
    [CliOption("--update-schedule", Format = OptionFormat.EqualsSeparated)]
