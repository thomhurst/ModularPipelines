...
/// <param name="ControlPlaneLoadBalancerPort">Anthos on bare metal admin cluster load balancer configuration. This must be specified. Control plane load balancer port configuration. This must be specified. Control plane load balancer port configuration.</param>
/// <param name="ControlPlaneVip">VIPs used by the load balancer. This must be specified. VIP for the Kubernetes API of this cluster.</param>
...
public record GcloudContainerBareMetalAdminClustersCreateOptions(
    ...
    [property: CliOption("--control-plane-load-balancer-port", Format = OptionFormat.EqualsSeparated)] string ControlPlaneLoadBalancerPort,
