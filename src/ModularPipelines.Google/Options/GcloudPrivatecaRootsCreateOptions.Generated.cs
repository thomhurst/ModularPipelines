...
public record GcloudPrivatecaRootsCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: Or at least one of these can be specified: The list of extended key usages for this CA. This can only be provided if --use-preset-profile is not provided. EXTENDED_KEY_USAGES must be one of: server_auth, client_auth, code_signing, email_protection, time_stamping, ocsp_signing.
    /// </summary>
    ...
    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: Or at least one of these can be specified: The list of key usages for this CA. This can only be provided if --use-preset-profile is not provided. KEY_USAGES must be one of: digital_signature, content_commitment, key_encipherment, data_encipherment, key_agreement, cert_sign, crl_sign, encipher_only, decipher_only.
    /// </summary>
    [CliOption("--key-usages", Format = OptionFormat.EqualsSeparated)]
    public GcloudKeyUsages? KeyUsages { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Maximum depth of subordinate CAs allowed under this CA for a CA certificate. This can only be provided if neither --use-preset-profile nor --unconstrained-chain-length are provided.
    /// </summary>
    [CliOption("--max-chain-length", Format = OptionFormat.EqualsSeparated)]
    public string? MaxChainLength { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: If set, allows an unbounded number of subordinate CAs under this newly issued CA certificate. This can only be provided if neither --use-preset-profile nor --max-chain-length are provided.
    /// </summary>
    [CliFlag("--unconstrained-chain-length")]
    public bool? UnconstrainedChainLength { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations Indicates whether or not name constraints are marked as critical. Name constraints are considered critical unless explicitly set to false. Enabled by default, use --no-name-constraints-critical to disable.
    /// </summary>
    ...
    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated DNS names which are excluded from being issued certificates. Any DNS name that can be constructed by simply adding zero or more labels to the left-hand side of the name satisfies the name constraint. For example, example.com, www.example.com, www.sub.example.com would satisfy example.com, while example1.com does not.
    /// </summary>
    [CliOption("--name-excluded-dns", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NameExcludedDns { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated emails which are excluded from being issued certificates. The value can be a particular email address, a hostname to indicate all email addresses on that host or a domain with a leading period (e.g. .example.com) to indicate all email addresses in that domain.
    /// </summary>
    [CliOption("--name-excluded-email", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NameExcludedEmail { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated IP ranges which are excluded from being issued certificates. For IPv4 addresses, the ranges are expressed using CIDR notation as specified in RFC 4632. For IPv6 addresses, the ranges are expressed in similar encoding as IPv4
    /// </summary>
    [CliOption("--name-excluded-ip", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NameExcludedIp { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated URIs which are excluded from being issued certificates. The value can be a hostname or a domain with a leading period (like .example.com)
    /// </summary>
    [CliOption("--name-excluded-uri", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NameExcludedUri { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated DNS names which are permitted to be issued certificates. Any DNS name that can be constructed by simply adding zero or more labels to the left-hand side of the name satisfies the name constraint. For example, example.com, www.example.com, www.sub.example.com would satisfy example.com, while example1.com does not.
    /// </summary>
    [CliOption("--name-permitted-dns", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NamePermittedDns { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated email addresses which are permitted to be issued certificates. The value can be a particular email address, a hostname to indicate all email addresses on that host or a domain with a leading period (e.g. .example.com) to indicate all email addresses in that domain.
    /// </summary>
    [CliOption("--name-permitted-email", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NamePermittedEmail { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated IP ranges which are permitted to be issued certificates. For IPv4 addresses, the ranges are expressed using CIDR notation as specified in RFC 4632. For IPv6 addresses, the ranges are expressed in similar encoding as IPv4
    /// </summary>
    [CliOption("--name-permitted-ip", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? NamePermittedIp { get; set; }

    /// <summary>
    /// Source CA resource - An existing CA from which to copy configuration values for the new CA. You can still override any of those values by explicitly providing the appropriate flags. The specified existing CA must be part of the same pool as the one being created. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --location on the command line; ◆ set the property privateca/location. To set the pool attribute: ◆ provide the argument --from-ca on the command line with a fully specified name; ◆ provide the argument --pool on the command line. The X.509 configuration used for the CA certificate. At most one of these can be specified: The x509 name constraints configurations One or more comma-separated URIs which are permitted to be issued certificates. The value can be a hostname or a domain with a leading period (like .example.com)
    /// </summary>
