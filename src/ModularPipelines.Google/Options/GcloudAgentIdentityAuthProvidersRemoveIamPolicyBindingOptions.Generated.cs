...
public record GcloudAgentIdentityAuthProvidersRemoveIamPolicyBindingOptions : GcloudOptions
{
    ...
    public void Deconstruct(out string Member, out string Role, out string AuthProvider)
    {
        Member = this.Member;
        Role = this.Role;
