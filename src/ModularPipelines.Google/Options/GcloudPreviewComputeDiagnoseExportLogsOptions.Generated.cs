...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/diagnose/export-logs
...
[CliSubCommand("preview", "compute", "diagnose", "export-logs")]
public record GcloudPreviewComputeDiagnoseExportLogsOptions : GcloudOptions
{
    /// <summary>
    /// triggers instance to gather     logs and upload them to a Cloud Storage Bucket
    /// </summary>
    ...
    public GcloudPreviewComputeDiagnoseExportLogsOptions(
        string InstanceName
    )
    {
