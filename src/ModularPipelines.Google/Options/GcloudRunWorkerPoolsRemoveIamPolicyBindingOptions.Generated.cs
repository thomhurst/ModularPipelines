...
// Source: https://cloud.google.com/sdk/gcloud/reference/run/worker-pools/remove-iam-policy-binding
...
[CliSubCommand("run", "worker-pools", "remove-iam-policy-binding")]
public record GcloudRunWorkerPoolsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding of a Cloud Run worker pool
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Workerpool)
    {
        Member = this.Member;
        Role = this.Role;
