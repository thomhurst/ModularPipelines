...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/machine-images/set-iam-policy
...
[CliSubCommand("preview", "compute", "machine-images", "set-iam-policy")]
public record GcloudPreviewComputeMachineImagesSetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// set the IAM policy     for a Compute Engine machine image
    /// </summary>
    ...
    public GcloudPreviewComputeMachineImagesSetIamPolicyOptions(
        string MachineImage,
        string PolicyFile
    )
    {
