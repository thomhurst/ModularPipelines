...
public record GcloudPreviewComputeInstancesUpdateContainerOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// updates Compute Engine     virtual machine instances running container images
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesUpdateContainerOptions(
        string InstanceName
    )
    {
    ...
    public GcloudPreviewComputeInstancesUpdateContainerContainerRestartPolicy? ContainerRestartPolicy { get; set; }
