...
public record GcloudLoggingLinksDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete a linked dataset
    /// </summary>
    ...
    /// <param name="LinkId">ID of the linked dataset to delete.</param>
    public GcloudLoggingLinksDeleteOptions(
        string Bucket,
        string Location,
        string LinkId
    )
