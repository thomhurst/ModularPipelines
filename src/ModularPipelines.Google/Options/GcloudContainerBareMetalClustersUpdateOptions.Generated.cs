...
public record GcloudContainerBareMetalClustersUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Anthos on bare metal cluster security configuration. User cluster authorization configurations to bootstrap onto the admin cluster If set, and the Anthos cluster on bare metal is not found, the update request will try to create a new cluster with the provided configuration.
    /// </summary>
    ...
    /// <summary>
    /// Anthos on bare metal cluster maintenance configuration. Anthos cluster on bare metal version for the user cluster resource.
    /// </summary>
    [CliOption("--version", Format = OptionFormat.EqualsSeparated)]
    public string? Version { get; set; }

    /// <summary>
    /// Anthos on bare metal cluster maintenance configuration. At most one of these can be specified: Add the given key-value pairs to the current annotations, or update its value if the key already exists.
    /// </summary>
    [CliOption("--add-annotations", Format = OptionFormat.EqualsSeparated)]
    public string? AddAnnotations { get; set; }

    /// <summary>
    /// Anthos on bare metal cluster maintenance configuration. At most one of these can be specified: Remove annotations of the given keys.
    /// </summary>
    ...
    /// <summary>
    /// Modifiable kubelet configurations for bare metal machines. Modifiable kubelet configurations for bare metal machines. Maximum size of bursty pulls, temporarily allow pulls to burst to this number, while still not exceeding registry_pull_qps.
    /// </summary>
    ...
    /// <summary>
    /// Modifiable kubelet configurations for bare metal machines. Modifiable kubelet configurations for bare metal machines. Limit of registry pulls per second.
    /// </summary>
    ...
    /// <summary>
    /// Modifiable kubelet configurations for bare metal machines. Modifiable kubelet configurations for bare metal machines. At most one of these can be specified: If set, prevent the Kubelet from pulling multiple images at a time.
    /// </summary>
    [CliFlag("--disable-bgp-load-balancer-serialize-image-pulls")]
    public bool? DisableBgpLoadBalancerSerializeImagePulls { get; set; }

    /// <summary>
    /// Modifiable kubelet configurations for bare metal machines. Modifiable kubelet configurations for bare metal machines. At most one of these can be specified: If set, enable the Kubelet to pull multiple images at a time.
    /// </summary>
    ...
    /// <summary>
    /// Modifiable kubelet configurations for bare metal machines. Modifiable kubelet configurations for bare metal machines. Labels assigned to nodes of a MetalLB node pool.
    /// </summary>
    ...
    /// <summary>
    /// Modifiable kubelet configurations for bare metal machines. Modifiable kubelet configurations for bare metal machines. Node taint applied to every node in a MetalLB node pool.
    /// </summary>
    ...
    /// <summary>
    /// Anthos on bare metal cluster network configurations. Populate one of the network configs. Island mode CIDR network configuration. IPv4 address range for all services in the cluster.
    /// </summary>
    ...
    /// <summary>
    /// Anthos on bare metal cluster network configurations. Populate one of the network configs. Island mode CIDR network configuration. SR-IOV networking operator configurations. At most one of these can be specified: If set, the SR-IOV operator won't be installed.
    /// </summary>
    [CliFlag("--disable-sr-iov-config")]
    public bool? DisableSrIovConfig { get; set; }

    /// <summary>
    /// Anthos on bare metal cluster network configurations. Populate one of the network configs. Island mode CIDR network configuration. SR-IOV networking operator configurations. At most one of these can be specified: If set, install the SR-IOV operator.
    /// </summary>
