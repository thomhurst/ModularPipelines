...
public record GcloudComputeForwardingRulesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine forwarding     rule
    /// </summary>
    /// <param name="Name">Name of the forwarding rule to operate on.</param>
    public GcloudComputeForwardingRulesUpdateOptions(
        string Name
    )
    {
    ...
    public GcloudComputeForwardingRulesUpdateLoadBalancingScheme? LoadBalancingScheme { get; set; }
    ...
    public GcloudComputeForwardingRulesUpdateExternalManagedBackendBucketMigrationState? ExternalManagedBackendBucketMigrationState { get; set; }
