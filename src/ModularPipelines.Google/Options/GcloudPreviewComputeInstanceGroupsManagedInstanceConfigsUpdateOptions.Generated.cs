...
public record GcloudPreviewComputeInstanceGroupsManagedInstanceConfigsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update per-instance config of a managed instance group
    /// </summary>
    ...
    public GcloudPreviewComputeInstanceGroupsManagedInstanceConfigsUpdateOptions(
        string Instance,
        string Name
    )
    {
