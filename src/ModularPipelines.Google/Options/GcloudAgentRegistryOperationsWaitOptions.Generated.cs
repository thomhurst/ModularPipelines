...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-registry/operations/wait
...
[CliSubCommand("agent-registry", "operations", "wait")]
public record GcloudAgentRegistryOperationsWaitOptions : GcloudOptions
{
    /// <summary>
    /// wait operations
    /// </summary>
    ...
    public GcloudAgentRegistryOperationsWaitOptions(
        string Operation
    )
    {
