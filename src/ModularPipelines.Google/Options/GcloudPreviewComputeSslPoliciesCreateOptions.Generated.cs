...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/ssl-policies/create
...
public record GcloudPreviewComputeSslPoliciesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a new Compute Engine     SSL policy
    /// </summary>
    /// <param name="SslPolicy">Name of the SSL policy to create.</param>
    public GcloudPreviewComputeSslPoliciesCreateOptions(
        string SslPolicy
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the SSL policy to create. Overrides the default compute/region property value for this command invocation.
    /// </summary>
