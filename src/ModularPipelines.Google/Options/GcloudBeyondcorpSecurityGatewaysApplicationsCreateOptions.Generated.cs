...
public record GcloudBeyondcorpSecurityGatewaysApplicationsCreateOptions : GcloudOptions
{
    ...
    public IEnumerable<string>? EndpointMatchersValues { get; set; }
    ...
    [Obsolete("Use EndpointMatchersValues instead.")]
    public string? EndpointMatchers
    {
        get => EndpointMatchersValues?.FirstOrDefault();
        set => EndpointMatchersValues = value is null ? null : [value];
    }
