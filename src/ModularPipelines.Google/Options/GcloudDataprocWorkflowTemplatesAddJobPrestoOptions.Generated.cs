...
public record GcloudDataprocWorkflowTemplatesAddJobPrestoOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add a Presto job to the     workflow template
    /// </summary>
    ...
    public GcloudDataprocWorkflowTemplatesAddJobPrestoOptions(
        string StepId,
    ...
    /// <summary>
    /// A list of Presto client tags to attach to this query. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// A list of key value pairs to set Presto session properties. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
