...
public record GcloudPreviewComputeStoragePoolsCreateOptions(
    [property: CliOption("--provisioned-capacity", Format = OptionFormat.EqualsSeparated)] string ProvisionedCapacity,
    [property: CliOption("--storage-pool-type", Format = OptionFormat.EqualsSeparated)] string StoragePoolType
) : GcloudOptions
{
    /// <summary>
