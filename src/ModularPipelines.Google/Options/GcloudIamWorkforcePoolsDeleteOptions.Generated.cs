...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/delete
...
[CliSubCommand("iam", "workforce-pools", "delete")]
public record GcloudIamWorkforcePoolsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete a workforce pool
    /// </summary>
    /// <param name="WorkforcePool">Workforce pool resource - The workforce pool to delete. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the workforce pool or fully qualified identifier for the workforce pool. To set the workforce_pool attribute: ▸ provide the argument workforce_pool on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamWorkforcePoolsDeleteOptions(
