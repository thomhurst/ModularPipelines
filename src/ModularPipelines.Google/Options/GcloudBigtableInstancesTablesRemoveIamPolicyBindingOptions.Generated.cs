...
public record GcloudBigtableInstancesTablesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Cloud Bigtable table
    /// </summary>
    ...
    public GcloudBigtableInstancesTablesRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string Table
    )
