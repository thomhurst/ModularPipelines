...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/security-policies/rules/describe
...
[CliSubCommand("preview", "compute", "security-policies", "rules", "describe")]
public record GcloudPreviewComputeSecurityPoliciesRulesDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a     Compute Engine security policy rule
    /// </summary>
    ...
    public GcloudPreviewComputeSecurityPoliciesRulesDescribeOptions(
        string Priority
    )
    {
