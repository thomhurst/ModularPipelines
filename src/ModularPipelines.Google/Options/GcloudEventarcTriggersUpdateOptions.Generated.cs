...
public record GcloudEventarcTriggersUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if (((!string.IsNullOrWhiteSpace(DestinationGkeNamespace) || !string.IsNullOrWhiteSpace(DestinationGkeService) || ClearDestinationGkePath == true || !string.IsNullOrWhiteSpace(DestinationGkePath)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(DestinationRunRegion) || !string.IsNullOrWhiteSpace(DestinationRunService) || !string.IsNullOrWhiteSpace(DestinationWorkflow) || !string.IsNullOrWhiteSpace(DestinationWorkflowLocation) || ClearDestinationRunPath == true || !string.IsNullOrWhiteSpace(DestinationRunPath)) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of (DestinationGkeNamespace, DestinationGkeService, ClearDestinationGkePath, or DestinationGkePath) or (DestinationRunRegion, DestinationRunService, DestinationWorkflow, DestinationWorkflowLocation, ClearDestinationRunPath, or DestinationRunPath) may be specified.", [nameof(DestinationGkeNamespace), nameof(DestinationGkeService), nameof(ClearDestinationGkePath), nameof(DestinationGkePath), nameof(DestinationRunRegion), nameof(DestinationRunService), nameof(DestinationWorkflow), nameof(DestinationWorkflowLocation), nameof(ClearDestinationRunPath), nameof(DestinationRunPath)]);
        }
        if ((!string.IsNullOrWhiteSpace(DestinationGkeNamespace) || !string.IsNullOrWhiteSpace(DestinationGkeService) || ClearDestinationGkePath == true || !string.IsNullOrWhiteSpace(DestinationGkePath) || !string.IsNullOrWhiteSpace(DestinationRunRegion) || !string.IsNullOrWhiteSpace(DestinationRunService) || !string.IsNullOrWhiteSpace(DestinationWorkflow) || !string.IsNullOrWhiteSpace(DestinationWorkflowLocation) || ClearDestinationRunPath == true || !string.IsNullOrWhiteSpace(DestinationRunPath)) && (!string.IsNullOrWhiteSpace(DestinationGkeNamespace) || !string.IsNullOrWhiteSpace(DestinationGkeService) || ClearDestinationGkePath == true || !string.IsNullOrWhiteSpace(DestinationGkePath)) && ((ClearDestinationGkePath == true ? 1 : 0) + (!string.IsNullOrWhiteSpace(DestinationGkePath) ? 1 : 0) > 1))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(DestinationGkeNamespace) || !string.IsNullOrWhiteSpace(DestinationGkeService) || ClearDestinationGkePath == true || !string.IsNullOrWhiteSpace(DestinationGkePath) || !string.IsNullOrWhiteSpace(DestinationRunRegion) || !string.IsNullOrWhiteSpace(DestinationRunService) || !string.IsNullOrWhiteSpace(DestinationWorkflow) || !string.IsNullOrWhiteSpace(DestinationWorkflowLocation) || ClearDestinationRunPath == true || !string.IsNullOrWhiteSpace(DestinationRunPath)) && (!string.IsNullOrWhiteSpace(DestinationRunRegion) || !string.IsNullOrWhiteSpace(DestinationRunService) || !string.IsNullOrWhiteSpace(DestinationWorkflow) || !string.IsNullOrWhiteSpace(DestinationWorkflowLocation) || ClearDestinationRunPath == true || !string.IsNullOrWhiteSpace(DestinationRunPath)) && ((ClearDestinationRunPath == true ? 1 : 0) + (!string.IsNullOrWhiteSpace(DestinationRunPath) ? 1 : 0) > 1))
        {
