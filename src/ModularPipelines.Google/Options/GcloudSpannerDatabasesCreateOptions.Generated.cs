...
public record GcloudSpannerDatabasesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudSpannerDatabasesCreateDatabaseDialect? DatabaseDialect { get; set; }
