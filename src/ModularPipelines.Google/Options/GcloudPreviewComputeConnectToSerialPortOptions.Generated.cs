...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/connect-to-serial-port
...
[CliSubCommand("preview", "compute", "connect-to-serial-port")]
public record GcloudPreviewComputeConnectToSerialPortOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// connect to the serial port     of an instance
    /// </summary>
    ...
    public GcloudPreviewComputeConnectToSerialPortOptions(
        string UserInstance
    )
    {
