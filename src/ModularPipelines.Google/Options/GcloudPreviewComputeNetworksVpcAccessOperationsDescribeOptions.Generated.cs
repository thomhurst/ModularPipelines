...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/networks/vpc-access/operations/describe
...
[CliSubCommand("preview", "compute", "networks", "vpc-access", "operations", "describe")]
public record GcloudPreviewComputeNetworksVpcAccessOperationsDescribeOptions : GcloudOptions
{
    /// <summary>
    /// show     metadata for a VPC Access Service operation
    /// </summary>
    ...
    public GcloudPreviewComputeNetworksVpcAccessOperationsDescribeOptions(
        string Operation
    )
    {
    ...
    /// <summary>
    /// Operation resource - The operation to describe. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument operation on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. Compute region (e.g. us-central1) for the connector. To set the region attribute: ▸ provide the argument operation on the command line with a fully specified name; ▸ provide the argument --region on the command line.
    /// </summary>
