...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-templates/remove-iam-policy-binding
...
[CliSubCommand("preview", "compute", "instance-templates", "remove-iam-policy-binding")]
public record GcloudPreviewComputeInstanceTemplatesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy binding from a Compute Engine instance template
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string InstanceTemplate)
    {
        Member = this.Member;
        Role = this.Role;
