...
public record GcloudComputeOrgSecurityPoliciesAssociationsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a new     association between a security policy and an organization or folder     resource
    /// </summary>
    /// <param name="SecurityPolicy">Security policy ID of the association.</param>
    public GcloudComputeOrgSecurityPoliciesAssociationsCreateOptions(
