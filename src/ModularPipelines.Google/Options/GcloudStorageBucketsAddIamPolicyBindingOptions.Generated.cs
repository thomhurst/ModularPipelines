...
public record GcloudStorageBucketsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy binding     to a bucket
    /// </summary>
    ...
    /// <param name="Url">URL of bucket to add IAM policy binding to.</param>
    public GcloudStorageBucketsAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Url
    )
