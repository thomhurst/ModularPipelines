...
[CommandPrecedingArguments("builds", "triggers", "update", "pubsub")]
public record GcloudBuildsTriggersUpdatePubsubOptions(
...
[property: BooleanCommandSwitch("--clear-subscription-filter")] bool ClearSubscriptionFilter,
