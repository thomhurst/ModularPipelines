...
public record GcloudEventarcMessageBusesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudEventarcMessageBusesUpdateLoggingConfig? LoggingConfig { get; set; }
