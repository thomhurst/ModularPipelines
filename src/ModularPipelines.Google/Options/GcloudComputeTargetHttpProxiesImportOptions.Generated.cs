...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/target-http-proxies/import
...
[CliSubCommand("compute", "target-http-proxies", "import")]
public record GcloudComputeTargetHttpProxiesImportOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// import a target HTTP proxy
    /// </summary>
    /// <param name="Name">Name of the target HTTP proxy to import.</param>
    public GcloudComputeTargetHttpProxiesImportOptions(
        string Name
    )
    {
