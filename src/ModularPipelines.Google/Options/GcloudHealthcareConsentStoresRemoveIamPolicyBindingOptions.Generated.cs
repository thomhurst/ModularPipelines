...
public record GcloudHealthcareConsentStoresRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Cloud Healthcare API consent store
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string ConsentStore)
    {
        Member = this.Member;
        Role = this.Role;
