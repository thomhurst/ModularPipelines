...
public record GcloudWorkstationsConfigsCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Accelerator settings Encryption key settings Machine type determines the specifications of the Compute Engine machines that the workstations created under this configuration will run on.
    /// </summary>
    [CliOption("--machine-type", Format = OptionFormat.EqualsSeparated)]
    public string? MachineType { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings Maximum number of workstations under this configuration a user can have workstations.workstation.use permission on. If not specified, defaults to 0, which indicates a user can have unlimited number of workstations under this configuration.
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Encryption key settings Number of instances to pool for faster Workstation startup.
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Encryption key settings How long (in seconds) to wait before automatically stopping a workstation after it started. A value of 0 indicates that workstations using this config should never time out.
    /// </summary>
    [CliOption("--running-timeout", Format = OptionFormat.EqualsSeparated)]
    public int? RunningTimeout { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings Email address of the service account that will be used on VM instances used to support this config. This service account must have permission to pull the specified container image. If not set, VMs will run without a service account, in which case the image must be publicly accessible.
    /// </summary>
    [CliOption("--service-account", Format = OptionFormat.EqualsSeparated)]
    public string? ServiceAccount { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings Scopes to grant to the service_account. Various scopes are automatically added based on feature usage. When specified, users of workstations under this configuration must have iam.serviceAccounts.actAs on the service account.
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Encryption key settings Default value is false. If set, instances will have integrity monitoring enabled.
    /// </summary>
    [CliFlag("--shielded-integrity-monitoring")]
    public bool? ShieldedIntegrityMonitoring { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings Default value is false. If set, instances will have Secure Boot enabled.
    /// </summary>
    [CliFlag("--shielded-secure-boot")]
    public bool? ShieldedSecureBoot { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings Default value is false. If set, instances will have vTPM enabled.
    /// </summary>
    [CliFlag("--shielded-vtpm")]
    public bool? ShieldedVtpm { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings Link to the startup script stored in Cloud Storage. The script is executed on the workstation VM after it is booted. Example: $ gcloud workstations configs create \ --startup-script-uri=gs://{bucket-name}/{object-name}
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Encryption key settings The number of accelerator cards exposed to the instance. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--accelerator-count", Format = OptionFormat.EqualsSeparated)]
    public int? AcceleratorCount { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings The type of accelerator resource to attach to the instance, for example, "nvidia-tesla-p100".
    /// </summary>
    [CliOption("--accelerator-type", Format = OptionFormat.EqualsSeparated)]
    public string? AcceleratorType { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: A docker image for the workstation. This image must be accessible by the service account configured in this configuration (--service-account). If no service account is defined, this image must be public.
    /// </summary>
    [CliOption("--container-custom-image", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerCustomImage { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Code editor on base images. CONTAINER_PREDEFINED_IMAGE must be one of: base-image Base image - no IDE clion CLion codeoss Code OSS codeoss-cuda Code OSS + CUDA toolkit goland GoLand intellij IntelliJ IDEA Ultimate phpstorm PhpStorm pycharm PyCharm Professional rider Rider rubymine RubyMine webstorm WebStorm
    /// </summary>
    [CliOption("--container-predefined-image", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerPredefinedImage { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings The customer-managed encryption key to use for this config. If not specified, a Google-managed encryption key is used. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--kms-key", Format = OptionFormat.EqualsSeparated)]
    public string? KmsKey { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings The service account associated with the provided customer-managed encryption key.
    /// </summary>
    [CliOption("--kms-key-service-account", Format = OptionFormat.EqualsSeparated)]
    public string? KmsKeyServiceAccount { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: If set, workstations under this configuration will not have a persistent directory.
    /// </summary>
    [CliFlag("--no-persistent-storage")]
    public bool? NoPersistentStorage { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: Number of seconds to wait after initially creating or subsequently shutting down the workstation before converting its disk into a snapshot to save costs. A value of 0 indicates that the disk will never be archived.
    /// </summary>
    [CliOption("--disk-archive-timeout", Format = OptionFormat.EqualsSeparated)]
    public int? DiskArchiveTimeout { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: What should happen to the disk after the Workstation is deleted. DISK_RECLAIM_POLICY must be one of: delete The persistent disk will be deleted with the Workstation. retain The persistent disk will be remain after the workstation is deleted and the administrator must manually delete the disk.
    /// </summary>
    [CliOption("--disk-reclaim-policy", Format = OptionFormat.EqualsSeparated)]
    public string? DiskReclaimPolicy { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: Type of the persistent directory. DISK_TYPE must be one of: pd-standard, pd-balanced, pd-ssd, hyperdisk-balanced-ha.
    /// </summary>
    [CliOption("--disk-type", Format = OptionFormat.EqualsSeparated)]
    public GcloudDiskType? DiskType { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Size of the persistent directory in GB. DISK_SIZE must be one of: 10, 50, 100, 200, 500, 1000.
    /// </summary>
    [CliOption("--disk-size", Format = OptionFormat.EqualsSeparated)]
    public int? DiskSize { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Name of the snapshot to use as the source for the home disk.
    /// </summary>
    [CliOption("--disk-source-snapshot", Format = OptionFormat.EqualsSeparated)]
    public string? DiskSourceSnapshot { get; set; }

    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: Type of the persistent directory. PD_DISK_TYPE must be one of: pd-standard, pd-balanced, pd-ssd.
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Encryption key settings At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Size of the persistent directory in GB. PD_DISK_SIZE must be one of: 10, 50, 100, 200, 500, 1000.
    /// </summary>
