...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/network-attachments/set-iam-policy
...
[CliSubCommand("preview", "compute", "network-attachments", "set-iam-policy")]
public record GcloudPreviewComputeNetworkAttachmentsSetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// set the IAM     policy for a Compute Engine network attachment
    /// </summary>
    ...
    public GcloudPreviewComputeNetworkAttachmentsSetIamPolicyOptions(
