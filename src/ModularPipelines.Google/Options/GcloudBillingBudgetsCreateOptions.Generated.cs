...
public record GcloudBillingBudgetsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a budget
    /// </summary>
    /// <param name="BillingAccount">Billing account resource - Billing account under which to create the budget. This represents a Cloud resource. This must be specified. ID of the billing-account or fully qualified identifier for the billing-account. To set the billing-account attribute: ▸ provide the argument --billing-account on the command line.</param>
    /// <param name="DisplayName">User data for display name in UI. Must be less than or equal to 60 characters.</param>
    public GcloudBillingBudgetsCreateOptions(
    ...
    public void Deconstruct(out string BillingAccount, out string DisplayName)
    {
    ...
    /// <summary>
    /// Billing account resource - Billing account under which to create the budget. This represents a Cloud resource. This must be specified. ID of the billing-account or fully qualified identifier for the billing-account. To set the billing-account attribute: ▸ provide the argument --billing-account on the command line.
    /// </summary>
    ...
    /// <summary>
    /// Exactly one of these must be specified: Specify the amount of the budget. If a currency type is included, it must be the currency associated with the billing account. If excluded, the currency used will be the currency associated with the billing account.
    /// </summary>
    [CliOption("--budget-amount", Format = OptionFormat.EqualsSeparated)]
    public string? BudgetAmount { get; set; }

    /// <summary>
    /// Exactly one of these must be specified: Use the amount of last period's budget.
    /// </summary>
    ...
    public GcloudBillingBudgetsCreateCreditTypesTreatment? CreditTypesTreatment { get; set; }
    ...
    public GcloudBillingBudgetsCreateOwnershipScope? OwnershipScope { get; set; }

    /// <summary>
    /// Rule that triggers alerts (notifications of thresholds being crossed) when spend exceeds the specified percentages of the budget. This flag can be repeated to provide multiple thresholds above which an alert is sent. percent Number between 0.0 and 1.0. This is a 1.0-based percentage; for example 0.5 equals 50 percent. An alert is sent for anything above the value set. basis Type of basis used to determine if spend has passed the threshold. Must be one of: 'current-spend' or 'forecasted-spend'. Behavior defaults to 'current-spend' if not set.
    /// </summary>
    [CliOption("--threshold-rule", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? ThresholdRule { get; set; }
    ...
    public GcloudBillingBudgetsCreateCalendarPeriod? CalendarPeriod { get; set; }
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("Exactly one of BudgetAmount or LastPeriodAmount must be specified.", [nameof(BudgetAmount), nameof(LastPeriodAmount)]);
        }
