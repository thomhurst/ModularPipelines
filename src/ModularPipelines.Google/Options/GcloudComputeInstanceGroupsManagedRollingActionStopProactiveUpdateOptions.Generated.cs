...
public record GcloudComputeInstanceGroupsManagedRollingActionStopProactiveUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update     - stop the proactive update process of managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedRollingActionStopProactiveUpdateOptions(
        string Name
    )
    {
