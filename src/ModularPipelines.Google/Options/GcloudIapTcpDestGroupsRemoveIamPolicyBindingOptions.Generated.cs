...
public record GcloudIapTcpDestGroupsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding from an IAP TCP Destination Group resource
    /// </summary>
    ...
    public GcloudIapTcpDestGroupsRemoveIamPolicyBindingOptions(
        string DestGroup,
        string Member,
        string Region,
        string Role
    ...
    public void Deconstruct(out string DestGroup, out string Member, out string Region, out string Role)
    {
