...
public record GcloudPreviewComputeNetworksSubnetsCreateOptions : GcloudOptions
{
    /// <summary>
    /// define a subnet for a     network in custom subnet mode
    /// </summary>
    ...
    public GcloudPreviewComputeNetworksSubnetsCreateOptions(
        string Network,
        string Name
    )
    {
    ...
    public GcloudPreviewComputeNetworksSubnetsCreateLoggingAggregationInterval? LoggingAggregationInterval { get; set; }
    ...
    public GcloudPreviewComputeNetworksSubnetsCreateLoggingMetadata? LoggingMetadata { get; set; }
