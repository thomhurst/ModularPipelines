...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Adds a secondary IP range to the subnetwork for use in IP aliasing. For example, --secondary-range range1=192.168.64.0/24 adds a secondary range 192.168.64.0/24 with name range1. ◆ RANGE_NAME - Name of the secondary range. ◆ RANGE - IP range in CIDR format.
    /// </summary>
    [CliOption("--secondary-range", Format = OptionFormat.EqualsSeparated)]
    ...
    /// </summary>
    [CliOption("--secondary-range-with-reserved-internal-range", Format = OptionFormat.EqualsSeparated)]
