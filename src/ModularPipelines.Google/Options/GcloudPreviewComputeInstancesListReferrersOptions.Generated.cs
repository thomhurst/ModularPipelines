...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/list-referrers
...
[CliSubCommand("preview", "compute", "instances", "list-referrers")]
public record GcloudPreviewComputeInstancesListReferrersOptions : GcloudOptions
{
    /// <summary>
    /// list referrers to a     Compute Engine virtual machine instance
    /// </summary>
    /// <param name="InstanceName">Name of the instance to list referrers for. For details on valid instance names, refer to the criteria documented under the field 'name' at: https://cloud.google.com/compute/docs/reference/rest/v1/instances</param>
    public GcloudPreviewComputeInstancesListReferrersOptions(
        string InstanceName
    )
    {
