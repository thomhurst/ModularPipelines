...
public record GcloudNetworkSecurityMirroringDeploymentGroupsCreateOptions : GcloudOptions
{
    ...
    public GcloudNetworkSecurityMirroringDeploymentGroupsCreateOptions(
        string Network,
    ...
    public void Deconstruct(out string Network, out string MirroringDeploymentGroup)
    {
