...
public record GcloudComputeTpusQueuedResourcesSshOptions : GcloudOptions, IValidatableObject
{
    ...
    {
        if ((!string.IsNullOrWhiteSpace(Command) || !string.IsNullOrWhiteSpace(OutputDirectory)) && (!(!string.IsNullOrWhiteSpace(Command))))
        {
