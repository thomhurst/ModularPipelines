...
public record GcloudResourceManagerTagsKeysAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// adds a policy     binding to the IAM policy of a TagKey
    /// </summary>
    ...
    public GcloudResourceManagerTagsKeysAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string ResourceName
    )
