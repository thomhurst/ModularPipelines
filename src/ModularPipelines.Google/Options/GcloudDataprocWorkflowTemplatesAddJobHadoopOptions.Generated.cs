...
public record GcloudDataprocWorkflowTemplatesAddJobHadoopOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add a hadoop job to the     workflow template
    /// </summary>
    ...
    public GcloudDataprocWorkflowTemplatesAddJobHadoopOptions(
        string StepId,
    ...
    /// <summary>
    /// Comma separated list of file paths to be provided to the job. A file path can either be a path to a local file or a path to a file already in a Cloud Storage bucket. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--files", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string>? Files { get; set; }

    /// <summary>
    /// Comma separated list of jar files to be provided to the MR and driver classpaths. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// A list of key value pairs to configure Hadoop. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// The arguments to pass to the driver. The '--' argument must be specified between gcloud specific args on the left and JOB_ARGS on the right.
    /// </summary>
