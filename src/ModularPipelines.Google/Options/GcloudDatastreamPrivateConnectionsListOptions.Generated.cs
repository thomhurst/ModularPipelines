...
// Source: https://cloud.google.com/sdk/gcloud/reference/datastream/private-connections/list
...
[CliSubCommand("datastream", "private-connections", "list")]
public record GcloudDatastreamPrivateConnectionsListOptions : GcloudOptions
{
    /// <summary>
    /// list private connections
    /// </summary>
    /// <param name="Location">Location resource - The location you want to list the private connections for. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --location on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the location or fully qualified identifier for the location. To set the location attribute: ▸ provide the argument --location on the command line.</param>
    public GcloudDatastreamPrivateConnectionsListOptions(
        string Location
    )
    {
    ...
    /// <summary>
    /// Location resource - The location you want to list the private connections for. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --location on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the location or fully qualified identifier for the location. To set the location attribute: ▸ provide the argument --location on the command line.
    /// </summary>
