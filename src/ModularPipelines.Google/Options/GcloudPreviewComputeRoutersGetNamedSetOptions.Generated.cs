...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/routers/get-named-set
...
[CliSubCommand("preview", "compute", "routers", "get-named-set")]
public record GcloudPreviewComputeRoutersGetNamedSetOptions : GcloudOptions
{
    /// <summary>
    /// get a named set from a     Compute Engine router
    /// </summary>
    ...
    public GcloudPreviewComputeRoutersGetNamedSetOptions(
        string SetName,
        string Name
    )
    {
