...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/copy-files
...
[CliSubCommand("compute", "copy-files")]
public record GcloudComputeCopyFilesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// copy files to and from Google Compute Engine     virtual machines via scp
    /// </summary>
    ...
    public GcloudComputeCopyFilesOptions(
    ...
    public GcloudComputeCopyFilesStrictHostKeyChecking? StrictHostKeyChecking { get; set; }
