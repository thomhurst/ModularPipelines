...
public record GcloudComputeInstanceGroupsManagedDescribeInstanceOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe an     instance in a managed instance group
    /// </summary>
    ...
    public GcloudComputeInstanceGroupsManagedDescribeInstanceOptions(
        string Instance,
        string Name
    )
    {
