...
public record GcloudPreviewComputeNetworkEndpointGroupsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute     Engine network endpoint group
    /// </summary>
    /// <param name="Name">Name of the network endpoint group to operate on.</param>
    public GcloudPreviewComputeNetworkEndpointGroupsUpdateOptions(
        string Name
    )
    {
