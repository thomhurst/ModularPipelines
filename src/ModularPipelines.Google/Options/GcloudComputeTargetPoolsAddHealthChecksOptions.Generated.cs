...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/target-pools/add-health-checks
...
[CliSubCommand("compute", "target-pools", "add-health-checks")]
public record GcloudComputeTargetPoolsAddHealthChecksOptions : GcloudOptions
{
    /// <summary>
    /// add a legacy HTTP health     check to a target pool
    /// </summary>
    ...
    public GcloudComputeTargetPoolsAddHealthChecksOptions(
