...
public record GcloudDataprocClustersCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// A comma-separated list of compute zones (such as us-central1-a) to exclude when Dataproc Auto Zone placement (https://docs.cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone) picks the zone for the cluster.
    /// </summary>
    [CliOption("--auto-zone-exclude-zones", Format = OptionFormat.EqualsSeparated)]
    public string? AutoZoneExcludeZones { get; set; }

    /// <summary>
    /// The compute zone (such as us-central1-a) for the cluster. If empty and --region is set to a value other than global, Dataproc Auto Zone placement (https://docs.cloud.google.com/dataproc/docs/concepts/configuring-clusters/auto-zone) will pick a zone in the region. Overrides the default compute/zone property value for this command invocation.
    /// </summary>
    [CliOption("--zone", Format = OptionFormat.EqualsSeparated)]
    public string? Zone { get; set; }

    /// <summary>
    /// (DEPRECATED) Enables Confidential VM. See https://cloud.google.com/confidential-computing/confidential-vm/docs/ for more information. This flag uses AMD SEV confidential compute technology, which is only supported on N2D, C2D, C3D, and C4D machine types (https://cloud.google.com/compute/docs/machine-types). The --confidential-compute flag is deprecated. Please use --confidential-compute-type=SEV instead.
    /// </summary>
    ...
    /// <summary>
    /// The time when the cluster will be auto-deleted, such as "2017-08-29T18:52:51.142Z." See $ gcloud topic datetimes for information on time formats.
    /// </summary>
    [CliOption("--delete-expiration-time", Format = OptionFormat.EqualsSeparated)]
    public string? DeleteExpirationTime { get; set; }

    /// <summary>
    /// The lifespan of the cluster, with auto-deletion upon completion, such as "2h" or "1d". See $ gcloud topic datetimes for information on duration formats.
    /// </summary>
    ...
    /// <summary>
    /// The Google Cloud project for the key. To set the kms-project attribute: * provide the argument --gce-pd-kms-key on the command line with a fully specified name; * provide the argument --gce-pd-kms-key-project on the command line; * set the property core/project.
    /// </summary>
    ...
    /// <summary>
    /// ID of the key or fully qualified identifier for the key. To set the kms-key attribute: - provide the argument --kerberos-kms-key on the command line. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--kerberos-kms-key", Format = OptionFormat.EqualsSeparated)]
    public string? KerberosKmsKey { get; set; }

    /// <summary>
    /// The KMS keyring of the key. To set the kms-keyring attribute: - provide the argument --kerberos-kms-key on the command line with a fully specified name; - provide the argument --kerberos-kms-key-keyring on the command line.
    /// </summary>
    [CliOption("--kerberos-kms-key-keyring", Format = OptionFormat.EqualsSeparated)]
    public string? KerberosKmsKeyKeyring { get; set; }

    /// <summary>
    /// The Google Cloud location for the key. To set the kms-location attribute: - provide the argument --kerberos-kms-key on the command line with a fully specified name; - provide the argument --kerberos-kms-key-location on the command line.
    /// </summary>
    [CliOption("--kerberos-kms-key-location", Format = OptionFormat.EqualsSeparated)]
    public string? KerberosKmsKeyLocation { get; set; }

    /// <summary>
    /// The Google Cloud project for the key. To set the kms-project attribute: - provide the argument --kerberos-kms-key on the command line with a fully specified name; - provide the argument --kerberos-kms-key-project on the command line; - set the property core/project.
    /// </summary>
    ...
    /// <summary>
    /// Path to a YAML or JSON file containing the instance flexibility policy for the master node group.
    /// </summary>
    ...
    /// <summary>
    /// Specifies a list of tags to apply to the instance. These tags allow network firewall rules and routes to be applied to specified VM instances. See gcloud compute firewall-rules create(1) for more details. To read more about configuring network tags, read this guide: https://cloud.google.com/vpc/docs/add-remove-network-tags To list instances with their respective status and tags, run: $ gcloud compute instances list \
    /// </summary>
    ...
    /// <summary>
    /// Create a single node cluster. A single node cluster has all master and worker components. It cannot have any separate worker nodes. If this flag is not specified, a cluster with separate workers is created.
    /// </summary>
    [CliFlag("--single-node")]
    ...
    /// <summary>
    /// The time when the cluster will be auto-stopped, such as "2017-08-29T18:52:51.142Z." See $ gcloud topic datetimes for information on time formats.
    /// </summary>
    [CliOption("--stop-expiration-time", Format = OptionFormat.EqualsSeparated)]
    public string? StopExpirationTime { get; set; }

    /// <summary>
    /// The lifespan of the cluster, with auto-stop upon completion, such as "2h" or "1d". See $ gcloud topic datetimes for information on duration formats.
    /// </summary>
    [CliOption("--stop-max-age", Format = OptionFormat.EqualsSeparated)]
    public string? StopMaxAge { get; set; }

    /// <summary>
    /// Path to a YAML or JSON file containing the instance flexibility policy for the primary worker node group.
    /// </summary>
