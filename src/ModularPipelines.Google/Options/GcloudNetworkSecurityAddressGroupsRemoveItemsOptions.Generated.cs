...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-security/address-groups/remove-items
...
[CliSubCommand("network-security", "address-groups", "remove-items")]
public record GcloudNetworkSecurityAddressGroupsRemoveItemsOptions : GcloudOptions
{
    /// <summary>
    /// remove items from an     address group
    /// </summary>
    ...
    public GcloudNetworkSecurityAddressGroupsRemoveItemsOptions(
        string AddressGroup
    )
    {
