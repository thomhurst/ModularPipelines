...
public record GcloudDataplexDatascansCreateDataProfileOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Data profile scan execution settings. Description of the data profile scan.
    /// </summary>
    [CliOption("--description", Format = OptionFormat.EqualsSeparated)]
    public string? Description { get; set; }

    /// <summary>
    /// Data profile scan execution settings. Display name of the data profile scan.
    /// </summary>
    [CliOption("--display-name", Format = OptionFormat.EqualsSeparated)]
    public string? DisplayName { get; set; }

    /// <summary>
    /// Data profile scan execution settings. List of label KEY=VALUE pairs to add. Keys must start with a lowercase character and contain only hyphens (-), underscores (_), lowercase characters, and numbers. Values must contain only hyphens (-), underscores (_), lowercase characters, and numbers.
    /// </summary>
    [CliOption("--labels", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? Labels { get; set; }

    /// <summary>
    /// Data profile scan execution settings. At most one of --async | --validate-only can be specified. At most one of these can be specified: Return immediately, without waiting for the operation in progress to complete.
    /// </summary>
    [CliFlag("--async")]
    public bool? Async { get; set; }

    /// <summary>
    /// Data profile scan execution settings. At most one of --async | --validate-only can be specified. At most one of these can be specified: Validate the create action, but don't actually perform it.
    /// </summary>
    [CliFlag("--validate-only")]
    public bool? ValidateOnly { get; set; }

    /// <summary>
    /// Data profile scan execution settings. Data spec for the data profile scan. At most one of these can be specified: path to the JSON/YAML file containing the spec for the data profile scan. The JSON representation reference: https://cloud.google.com/dataplex/docs/reference/rest/v1/DataProfileSpec
    /// </summary>
    [CliOption("--data-profile-spec-file", Format = OptionFormat.EqualsSeparated)]
    public string? DataProfileSpecFile { get; set; }

    /// <summary>
    /// Data profile scan execution settings. Data spec for the data profile scan. At most one of these can be specified: Or at least one of these can be specified: Command line spec arguments for the data profile scan. Publish data profile results to Dataplex catalog.
    /// </summary>
    ...
    /// <summary>
    /// Data profile scan execution settings. Data spec for the data profile scan. At most one of these can be specified: Or at least one of these can be specified: Command line spec arguments for the data profile scan. A filter applied to all rows in a single data profile scan job.
    /// </summary>
    [CliOption("--row-filter", Format = OptionFormat.EqualsSeparated)]
    public string? RowFilter { get; set; }

    /// <summary>
    /// Data profile scan execution settings. Data spec for the data profile scan. At most one of these can be specified: Or at least one of these can be specified: Command line spec arguments for the data profile scan. The percentage of the records to be selected from the dataset for data profile scan.
    /// </summary>
