...
public record GcloudPreviewComputeInstanceGroupsManagedCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute     Engine managed instance group
    /// </summary>
    ...
    public GcloudPreviewComputeInstanceGroupsManagedCreateOptions(
        int Size,
        string Template,
        string Name
    )
