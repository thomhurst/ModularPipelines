...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Base name to use for the Compute Engine instances that will be created with the managed instance group. If not provided base instance name will be the prefix of instance group name.
    /// </summary>
    [CliOption("--base-instance-name", Format = OptionFormat.EqualsSeparated)]
    public string? BaseInstanceName { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the action that a MIG performs on a failed VM. If the value of the onFailedHealthCheck field is DEFAULT_ACTION, then the same action also applies to the VMs on which your application fails a health check. By default, the value of the flag is set to repair. ACTION_ON_VM_FAILURE must be one of: repair (Default) MIG automatically repairs a failed VM by recreating it. do-nothing MIG does not repair a failed VM.
    /// </summary>
    [CliOption("--default-action-on-vm-failure", Format = OptionFormat.EqualsSeparated)]
    public string? DefaultActionOnVmFailure { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. An optional description for this group.
    /// </summary>
    [CliOption("--description", Format = OptionFormat.EqualsSeparated)]
    public string? Description { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies whether to apply the group's latest configuration when repairing a VM. If you updated the group's instance template or per-instance configurations after the VM was created, then these changes are applied when VM is repaired. If this flag is disabled with -no-force-update-on-repair, then updates are applied in accordance with the group's update policy type. By default, this flag is disabled. Use --force-update-on-repair to enable and --no-force-update-on-repair to disable.
    /// </summary>
    [CliFlag("--force-update-on-repair")]
    public bool? ForceUpdateOnRepair { get; set; }

    /// <summary>
    /// Negates --force-update-on-repair. Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies whether to apply the group's latest configuration when repairing a VM. If you updated the group's instance template or per-instance configurations after the VM was created, then these changes are applied when VM is repaired. If this flag is disabled with -no-force-update-on-repair, then updates are applied in accordance with the group's update policy type. By default, this flag is disabled. Use --force-update-on-repair to enable and --no-force-update-on-repair to disable.
    /// </summary>
    [CliFlag("--no-force-update-on-repair")]
    public bool? NoForceUpdateOnRepair { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the number of seconds that a new VM takes to initialize and run its startup script. During a VM's initial delay period, the MIG ignores unsuccessful health checks because the VM might be in the startup process. This prevents the MIG from prematurely recreating a VM. If the health check receives a healthy response during the initial delay, it indicates that the startup process is complete and the VM is ready. The value of initial delay must be between 0 and 3600 seconds. The default value is 0. See $ gcloud topic datetimes for information on duration formats.
    /// </summary>
    [CliOption("--initial-delay", Format = OptionFormat.EqualsSeparated)]
    public string? InitialDelay { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Named selection of machine types with an optional rank. For example, --instance-selection="name=instance-selection-1,machine-type=e2-standard-8,machine-type=t2d-standard-8,rank=0"
    /// </summary>
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies whether the MIG can change a VM's zone during a repair. ON_REPAIR_ALLOW_CHANGING_ZONE must be one of: no (Default) MIG cannot change a VM's zone during a repair. yes MIG can select a different zone for the VM during a repair.
    /// </summary>
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the target size of stopped VMs in the group.
    /// </summary>
    [CliOption("--stopped-size", Format = OptionFormat.EqualsSeparated)]
    public int? StoppedSize { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the target size of suspended VMs in the group.
    /// </summary>
    [CliOption("--suspended-size", Format = OptionFormat.EqualsSeparated)]
    public int? SuspendedSize { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies any target pools you want the instances of this managed instance group to be part of.
    /// </summary>
    [CliOption("--target-pool", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? TargetPool { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the mode in which the MIG creates VMs in the group. TARGET_SIZE_POLICY_MODE must be one of: bulk MIG creates VMs all at once. If the MIG cannot create any VM to meet the specified ``size``, then the MIG waits until the resources become available to create all VMs. individual (Default) MIG creates VMs individually. If the MIG cannot create all VMs to meet the specified ``size``, then it creates VMs for which resources are available and continues to attempt to create the remaining ones until the target size is met.
    /// </summary>
    [CliOption("--target-size-policy-mode", Format = OptionFormat.EqualsSeparated)]
    public string? TargetSizePolicyMode { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the workload policy for the managed instance group. It can be a full or partial URL to a resource policy containing the workload policy.
    /// </summary>
    [CliOption("--workload-policy", Format = OptionFormat.EqualsSeparated)]
    public string? WorkloadPolicy { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. If this flag is specified a regional managed instance group will be created. The managed instance group will be in the same region as specified zones and will spread instances in it between specified zones. All zones must belong to the same region. You may specify --region flag but it must be the region to which zones belong. This flag is mutually exclusive with --zone flag.
    /// </summary>
    [CliOption("--zones", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? Zones { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Name of the health check to operate on.
    /// </summary>
    [CliOption("--health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HealthCheck { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. At most one of these can be specified: (DEPRECATED) HTTP health check object used for autohealing instances in this group. HttpHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    [CliOption("--http-health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HttpHealthCheck { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. At most one of these can be specified: (DEPRECATED) HTTPS health check object used for autohealing instances in this group. HttpsHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    [CliOption("--https-health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HttpsHealthCheck { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Specifies the type of the instance redistribution policy. An instance redistribution type lets you enable or disable automatic instance redistribution across zones to meet the group's target distribution shape. An instance redistribution type can be specified only for a non-autoscaled regional managed instance group. By default it is set to proactive. TYPE must be one of: none The managed instance group does not redistribute instances across zones. proactive The managed instance group proactively redistributes instances to meet its target distribution.
    /// </summary>
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Parameters for setting standby policy. Stateful policy settings for the managed instance group. Parameters for setting update policy for this managed instance group. Maximum additional number of VMs that can be created during the update process. This can be a fixed number (e.g. 5) or a percentage of size to the managed instance group (e.g. 10%).
    /// </summary>
