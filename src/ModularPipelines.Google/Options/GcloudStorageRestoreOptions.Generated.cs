...
public record GcloudStorageRestoreOptions : GcloudOptions
{
    ...
    /// <summary>
    /// BULK RESTORE OPTIONS If included, live objects will be overwritten. If versioning is enabled, this will result in a noncurrent object. If versioning is not enabled, this will result in a soft-deleted object.
    /// </summary>
    [CliFlag("--allow-overwrite")]
    public bool? AllowOverwrite { get; set; }

    /// <summary>
    /// BULK RESTORE OPTIONS Restores only the objects that were created after this time.
    /// </summary>
    [CliOption("--created-after-time", Format = OptionFormat.EqualsSeparated)]
    public string? CreatedAfterTime { get; set; }

    /// <summary>
    /// BULK RESTORE OPTIONS Restores only the objects that were created before this time.
    /// </summary>
    [CliOption("--created-before-time", Format = OptionFormat.EqualsSeparated)]
    public string? CreatedBeforeTime { get; set; }

    /// <summary>
    /// BULK RESTORE OPTIONS Restores only the objects that were soft-deleted after this time.
    /// </summary>
    [CliOption("--deleted-after-time", Format = OptionFormat.EqualsSeparated)]
    public string? DeletedAfterTime { get; set; }

    /// <summary>
    /// BULK RESTORE OPTIONS Restores only the objects that were soft-deleted before this time.
    /// </summary>
