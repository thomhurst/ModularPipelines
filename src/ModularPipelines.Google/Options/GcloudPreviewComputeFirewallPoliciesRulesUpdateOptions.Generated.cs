...
public record GcloudPreviewComputeFirewallPoliciesRulesUpdateOptions : GcloudOptions
{
    /// <summary>
    /// updates a Compute     Engine firewall policy rule
    /// </summary>
    /// <param name="FirewallPolicy">Short name of the firewall policy into which the rule should be updated.</param>
    /// <param name="Priority">Priority of the firewall policy rule to update.</param>
    public GcloudPreviewComputeFirewallPoliciesRulesUpdateOptions(
    ...
    public GcloudPreviewComputeFirewallPoliciesRulesUpdateAction? Action { get; set; }
    ...
    public GcloudPreviewComputeFirewallPoliciesRulesUpdateDirection? Direction { get; set; }
