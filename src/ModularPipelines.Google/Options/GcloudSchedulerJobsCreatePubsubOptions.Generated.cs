...
public record GcloudSchedulerJobsCreatePubsubOptions : GcloudOptions, IValidatableObject
{
    ...
    {
        if (!(((object?)Attributes is global::System.Collections.Generic.IEnumerable<char> ? (object?)Attributes is not string || !string.IsNullOrWhiteSpace(Attributes?.ToString()) : ((object?)Attributes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Attributes, static item => item is not null) : (Attributes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Attributes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(MessageBody) || !string.IsNullOrWhiteSpace(MessageBodyFromFile)))
        {
            yield return new ValidationResult("At least one of Attributes, MessageBody, or MessageBodyFromFile must be specified.", [nameof(Attributes), nameof(MessageBody), nameof(MessageBodyFromFile)]);
        }
        if ((((object?)Attributes is global::System.Collections.Generic.IEnumerable<char> ? (object?)Attributes is not string || !string.IsNullOrWhiteSpace(Attributes?.ToString()) : ((object?)Attributes is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Attributes, static item => item is not null) : (Attributes is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Attributes), static item => item is not null)))) || !string.IsNullOrWhiteSpace(MessageBody) || !string.IsNullOrWhiteSpace(MessageBodyFromFile)) && ((!string.IsNullOrWhiteSpace(MessageBody) ? 1 : 0) + (!string.IsNullOrWhiteSpace(MessageBodyFromFile) ? 1 : 0) > 1))
        {
