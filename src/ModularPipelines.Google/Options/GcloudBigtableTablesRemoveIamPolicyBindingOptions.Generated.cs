...
// Source: https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/remove-iam-policy-binding
...
[CliSubCommand("bigtable", "tables", "remove-iam-policy-binding")]
public record GcloudBigtableTablesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM policy     binding from a Cloud Bigtable table
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Table)
    {
        Member = this.Member;
        Role = this.Role;
        Table = this.Table;
