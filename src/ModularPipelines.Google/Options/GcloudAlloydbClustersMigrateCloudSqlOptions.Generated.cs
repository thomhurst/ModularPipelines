...
/// </summary>
/// <param name="CloudSqlBackupId">Migrate Cloud SQL strategy. This must be specified. Migrate CloudSQL instance to an AlloyDB cluster by restoring from an existing backup. CloudSQL backup ID to migrate from. This must be the backup ID (myBackup).</param>
/// <param name="CloudSqlInstanceId">Migrate Cloud SQL strategy. This must be specified. Migrate CloudSQL instance to an AlloyDB cluster by restoring from an existing backup. CloudSQL instance ID to migrate from. This must be the instance ID (myInstance).</param>
/// <param name="CloudSqlProjectId">Migrate Cloud SQL strategy. This must be specified. Migrate CloudSQL instance to an AlloyDB cluster by restoring from an existing backup. CloudSQL project to migrate from. This must be the project ID (myProject).</param>
/// <param name="Password">Migrate Cloud SQL strategy. This must be specified. Migrate CloudSQL instance to an AlloyDB cluster by restoring from an existing backup. Initial postgres user password to set up during cluster creation.</param>
/// <param name="Region">Migrate Cloud SQL strategy. This must be specified. Migrate CloudSQL instance to an AlloyDB cluster by restoring from an existing backup. Regional location (e.g. asia-east1, us-east1). See the full list of regions at https://cloud.google.com/sql/docs/instance-locations.</param>
...
public record GcloudAlloydbClustersMigrateCloudSqlOptions(
    [property: CliOption("--cloud-sql-backup-id", Format = OptionFormat.EqualsSeparated)] string CloudSqlBackupId,
