...
public record GcloudComputeSnapshotsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding from a Compute Engine snapshot
    /// </summary>
    ...
    public GcloudComputeSnapshotsRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string SnapshotName
    )
