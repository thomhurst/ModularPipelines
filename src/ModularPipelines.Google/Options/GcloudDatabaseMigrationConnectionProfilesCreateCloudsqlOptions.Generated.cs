...
public record GcloudDatabaseMigrationConnectionProfilesCreateCloudsqlOptions(
    [property: CliOption("--source-id", Format = OptionFormat.EqualsSeparated)] string SourceId,
    [property: CliOption("--tier", Format = OptionFormat.EqualsSeparated)] string Tier
) : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// List of external networks that are allowed to connect to the instance. Specify values in CIDR notation, also known as 'slash' notation (e.g.192.168.100.0/24).
    /// </summary>
