...
public record GcloudNetworkSecurityMirroringDeploymentsCreateOptions(
    [property: CliOption("--forwarding-rule", Format = OptionFormat.EqualsSeparated)] string ForwardingRule,
