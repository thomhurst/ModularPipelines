...
public record GcloudComputeInstanceGroupsManagedCreateInstanceOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a new     virtual machine instance in a managed instance group with a defined     name and optionally its stateful configuration
    /// </summary>
    ...
    public GcloudComputeInstanceGroupsManagedCreateInstanceOptions(
        string Instance,
        string Name
    )
    {
