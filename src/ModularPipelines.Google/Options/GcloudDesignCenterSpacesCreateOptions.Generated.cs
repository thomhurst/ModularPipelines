...
public record GcloudDesignCenterSpacesCreateOptions : GcloudOptions
{
    ...
    public GcloudDesignCenterSpacesCreateOptions(
        string Space
    )
    {
    ...
    /// <summary>
    /// Arguments for the enable gcp shared templates. Flag to enable Google opinionated shared templates.
    /// </summary>
