...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workload-identity-pools/providers/update-aws
...
[CliSubCommand("iam", "workload-identity-pools", "providers", "update-aws")]
public record GcloudIamWorkloadIdentityPoolsProvidersUpdateAwsOptions : GcloudOptions
{
    /// <summary>
    /// update an AWS     workload identity pool provider
    /// </summary>
    ...
    public GcloudIamWorkloadIdentityPoolsProvidersUpdateAwsOptions(
        string Provider
    )
    {
