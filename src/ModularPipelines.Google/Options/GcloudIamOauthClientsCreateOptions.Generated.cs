...
public record GcloudIamOauthClientsCreateOptions : GcloudOptions
{
    ...
    public GcloudIamOauthClientsCreateOptions(
        ...
        GcloudIamOauthClientsCreateClientType ClientType,
        string OauthClient
    )
    {
        {
    ...
    public void Deconstruct(out IEnumerable<string> AllowedGrantTypes, out IEnumerable<string> AllowedRedirectUris, out IEnumerable<string> AllowedScopes, out GcloudIamOauthClientsCreateClientType ClientType, out string OauthClient)
    {
    ...
    public GcloudIamOauthClientsCreateClientType ClientType { get; private init; }
