...
public record GcloudColabRuntimeTemplatesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Region resource - Cloud region to create runtime template. Please see https://cloud.google.com/colab/docs/locations for a list of supported regions. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --region on the command line with a fully specified name; ◆ set the property colab/region with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. Configuration of the runtime template The machine configuration of the runtime. The duration after which the runtime is automatically shut down. An input of 0s disables the idle shutdown feature, and a valid range is [10m, 24h]. See '$ gcloud topic datetimes' for details on formatting the input duration.
    /// </summary>
    [CliOption("--idle-shutdown-timeout", Format = OptionFormat.EqualsSeparated)]
    public string? IdleShutdownTimeout { get; set; }

    /// <summary>
    /// Region resource - Cloud region to create runtime template. Please see https://cloud.google.com/colab/docs/locations for a list of supported regions. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --region on the command line with a fully specified name; ◆ set the property colab/region with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. Configuration of the runtime template The machine configuration of the runtime. Add labels to identify and group the runtime template. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--labels", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IReadOnlyList<KeyValue>? Labels { get; set; }

    /// <summary>
    /// Region resource - Cloud region to create runtime template. Please see https://cloud.google.com/colab/docs/locations for a list of supported regions. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --region on the command line with a fully specified name; ◆ set the property colab/region with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. Configuration of the runtime template The machine configuration of the runtime. Applies the given Compute Engine tags to the runtime. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Region resource - Cloud region to create runtime template. Please see https://cloud.google.com/colab/docs/locations for a list of supported regions. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --region on the command line with a fully specified name; ◆ set the property colab/region with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. Configuration of the runtime template The machine configuration of the runtime. The number of accelerators used by the runtime.
    /// </summary>
    ...
    public GcloudColabRuntimeTemplatesCreateAcceleratorType? AcceleratorType { get; set; }

    /// <summary>
    /// Region resource - Cloud region to create runtime template. Please see https://cloud.google.com/colab/docs/locations for a list of supported regions. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --region on the command line with a fully specified name; ◆ set the property colab/region with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. Configuration of the runtime template The machine configuration of the runtime. The Compute Engine machine type selected for the runtime.
    /// </summary>
    ...
    public GcloudColabRuntimeTemplatesCreateDiskType? DiskType { get; set; }
