...
public record GcloudComputeBackendServicesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy     binding to a Compute Engine backend service
    /// </summary>
    ...
    public GcloudComputeBackendServicesAddIamPolicyBindingOptions(
        string Member,
        string Role,
