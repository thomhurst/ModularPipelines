...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/external-vpn-gateways/update
...
[CliSubCommand("compute", "external-vpn-gateways", "update")]
public record GcloudComputeExternalVpnGatewaysUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine     external VPN gateway
    /// </summary>
    /// <param name="Name">Name of the external VPN gateway to update.</param>
    public GcloudComputeExternalVpnGatewaysUpdateOptions(
        string Name
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud compute external-vpn-gateways update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud compute external-vpn-gateways update --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
