...
public record GcloudIamWorkforcePoolsSubjectsOperationsDescribeOptions : GcloudOptions
{
    ...
    /// describe a     workforce pool subject operation
    /// </summary>
    /// <param name="Operation">Workforce pool subject operation resource - The workforce pool subject long-running operation to describe. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the workforce pool subject operation or fully qualified identifier for the workforce pool subject operation. To set the operation attribute: ▸ provide the argument operation on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamWorkforcePoolsSubjectsOperationsDescribeOptions(
        string Operation
    )
    {
    ...
    /// <summary>
    /// Workforce pool subject operation resource - The workforce pool subject long-running operation to describe. The arguments in this group can be used to specify the attributes of this resource. This must be specified. The location for the workforce pool. To set the location attribute: ▸ provide the argument operation on the command line with a fully specified name; ▸ provide the argument --location on the command line.
    /// </summary>
    [CliOption("--location", Format = OptionFormat.EqualsSeparated)]
    public string? Location { get; set; }

    /// <summary>
    /// Workforce pool subject operation resource - The workforce pool subject long-running operation to describe. The arguments in this group can be used to specify the attributes of this resource. This must be specified. The ID to use for the workforce pool subject, which becomes the final component of the resource name. To set the subject attribute: ▸ provide the argument operation on the command line with a fully specified name; ▸ provide the argument --subject on the command line.
    /// </summary>
