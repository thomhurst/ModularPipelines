...
public record GcloudComputeInstanceGroupsManagedListInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list instances     present in the managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudComputeInstanceGroupsManagedListInstancesOptions(
        string Name
    )
    {
