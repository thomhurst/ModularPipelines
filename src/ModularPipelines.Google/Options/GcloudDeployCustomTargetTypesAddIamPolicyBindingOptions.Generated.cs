...
public record GcloudDeployCustomTargetTypesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding for a Cloud Deploy Custom Target Type
    /// </summary>
