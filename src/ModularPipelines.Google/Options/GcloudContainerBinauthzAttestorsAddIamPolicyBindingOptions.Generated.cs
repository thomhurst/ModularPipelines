...
public record GcloudContainerBinauthzAttestorsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding to a Binary Authorization attestor
    /// </summary>
    ...
    public GcloudContainerBinauthzAttestorsAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Attestor
    )
