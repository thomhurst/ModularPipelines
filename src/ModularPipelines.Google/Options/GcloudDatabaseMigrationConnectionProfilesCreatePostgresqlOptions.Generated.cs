...
public record GcloudDatabaseMigrationConnectionProfilesCreatePostgresqlOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudDatabaseMigrationConnectionProfilesCreatePostgresqlOptions(
    ...
    public GcloudDatabaseMigrationConnectionProfilesCreatePostgresqlRole? Role { get; set; }
    ...
    public GcloudDatabaseMigrationConnectionProfilesCreatePostgresqlSslType? SslType { get; set; }
    ...
    {
        if ((EnableIamAuthentication == true ? 1 : 0) + ((!string.IsNullOrWhiteSpace(Username) || !string.IsNullOrWhiteSpace(Password) || PromptForPassword == true) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of EnableIamAuthentication or (Username, Password, or PromptForPassword) may be specified.", [nameof(EnableIamAuthentication), nameof(Username), nameof(Password), nameof(PromptForPassword)]);
        }
        if ((EnableIamAuthentication == true || !string.IsNullOrWhiteSpace(Username) || !string.IsNullOrWhiteSpace(Password) || PromptForPassword == true) && (!string.IsNullOrWhiteSpace(Username) || !string.IsNullOrWhiteSpace(Password) || PromptForPassword == true) && ((!string.IsNullOrWhiteSpace(Password) ? 1 : 0) + (PromptForPassword == true ? 1 : 0) > 1))
        {
