...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/images/add-iam-policy-binding
...
[CliSubCommand("compute", "images", "add-iam-policy-binding")]
public record GcloudComputeImagesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding to a     Compute Engine image
    /// </summary>
    ...
    public GcloudComputeImagesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Image
    )
