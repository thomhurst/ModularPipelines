...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/target-http-proxies/import
...
[CliSubCommand("preview", "compute", "target-http-proxies", "import")]
public record GcloudPreviewComputeTargetHttpProxiesImportOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// import a target HTTP     proxy
    /// </summary>
    /// <param name="Name">Name of the target HTTP proxy to import.</param>
    public GcloudPreviewComputeTargetHttpProxiesImportOptions(
        string Name
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the target HTTP proxy to import. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
