...
public record GcloudComputePublicDelegatedPrefixesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// creates a Compute Engine     public delegated prefix
    /// </summary>
    ...
    public GcloudComputePublicDelegatedPrefixesCreateOptions(
        string Range,
        string Name
    )
    {
