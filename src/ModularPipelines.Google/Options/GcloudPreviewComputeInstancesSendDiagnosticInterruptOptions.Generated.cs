...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/send-diagnostic-interrupt
...
[CliSubCommand("preview", "compute", "instances", "send-diagnostic-interrupt")]
public record GcloudPreviewComputeInstancesSendDiagnosticInterruptOptions : GcloudOptions
{
    /// <summary>
    /// send a     diagnostic interrupt to a virtual machine instance
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesSendDiagnosticInterruptOptions(
        string InstanceName
    )
    {
