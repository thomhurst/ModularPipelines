...
public record GcloudIapWebRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy binding from     an IAP IAM resource
    /// </summary>
    ...
    public GcloudIapWebRemoveIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
    ...
    public GcloudIapWebRemoveIamPolicyBindingResourceType? ResourceType { get; set; }
