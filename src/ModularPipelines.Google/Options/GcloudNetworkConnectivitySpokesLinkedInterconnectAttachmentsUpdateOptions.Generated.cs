...
public record GcloudNetworkConnectivitySpokesLinkedInterconnectAttachmentsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a VLAN attachment spoke
    /// </summary>
    ...
    public GcloudNetworkConnectivitySpokesLinkedInterconnectAttachmentsUpdateOptions(
        string Spoke
    )
    {
