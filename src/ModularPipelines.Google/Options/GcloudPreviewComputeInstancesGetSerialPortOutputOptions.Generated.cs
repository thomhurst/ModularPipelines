...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/get-serial-port-output
...
[CliSubCommand("preview", "compute", "instances", "get-serial-port-output")]
public record GcloudPreviewComputeInstancesGetSerialPortOutputOptions : GcloudOptions
{
    /// <summary>
    /// read output from     a virtual machine instance's serial port
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesGetSerialPortOutputOptions(
        string InstanceName
    )
    {
