...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-connectivity/spokes/linked-producer-vpc-network/update
...
public record GcloudNetworkConnectivitySpokesLinkedProducerVpcNetworkUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud network-connectivity spokes linked-producer-vpc-network \ update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud network-connectivity spokes linked-producer-vpc-network \ update --clear-labels --update-labels foo=bar,baz=qux
    /// </summary>
    ...
    /// <summary>
    /// Spoke resource - Name of the spoke to update. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument spoke on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. To set the location attribute: ◆ provide the argument spoke on the command line with a fully specified name; ◆ provide the argument --global on the command line. This must be specified. ID of the spoke or fully qualified identifier for the spoke. To set the spoke attribute: ▸ provide the argument spoke on the command line.
    /// </summary>
