...
public record GcloudDesignCenterSpacesApplicationTemplatesComponentsConnectionsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Update destination_component_parameters. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear destination_component_parameters value and set to empty list.
    /// </summary>
    ...
    /// <summary>
    /// Update source_component_parameters. At most one of these can be specified: Set source_component_parameters to new value. The parameters of the connection associated with the source component. key The key of the parameter. value The value of the parameter. Shorthand Example: --source-component-parameters=key=string,value={...} --source-component-parameters=key=string,value={...} JSON Example: --source-component-parameters='[{"key": "string", "value": {...}}]' File Example: --source-component-parameters=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Update source_component_parameters. At most one of these can be specified: Or at least one of these can be specified: Add new value to source_component_parameters list. The parameters of the connection associated with the source component. key The key of the parameter. value The value of the parameter. Shorthand Example: --add-source-component-parameters=key=string,value={...} --add-source-component-parameters=key=string,value={...} JSON Example: --add-source-component-parameters='[{"key": "string", "value": {...}}]' File Example: --add-source-component-parameters=path_to_file.(yaml|json)
    /// </summary>
