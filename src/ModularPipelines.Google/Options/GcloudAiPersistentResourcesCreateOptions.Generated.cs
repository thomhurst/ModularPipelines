...
public record GcloudAiPersistentResourcesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a new persistent resource
    /// </summary>
    /// <param name="PersistentResourceId">User-specified ID of the Persistent Resource.</param>
    public GcloudAiPersistentResourcesCreateOptions(
        string PersistentResourceId
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(PersistentResourceId);
        this.PersistentResourceId = PersistentResourceId;
    }

    public void Deconstruct(out string PersistentResourceId)
    {
        PersistentResourceId = this.PersistentResourceId;
    }
    ...
    public string PersistentResourceId { get; private init; }
    ...
    {
        if (!(!string.IsNullOrWhiteSpace(Config) || ((object?)ResourcePoolSpec is global::System.Collections.Generic.IEnumerable<char> ? (object?)ResourcePoolSpec is not string || !string.IsNullOrWhiteSpace(ResourcePoolSpec?.ToString()) : ((object?)ResourcePoolSpec is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)ResourcePoolSpec, static item => item is not null) : (ResourcePoolSpec is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)ResourcePoolSpec), static item => item is not null))))))
        {
            yield return new ValidationResult("At least one of Config or ResourcePoolSpec must be specified.", [nameof(Config), nameof(ResourcePoolSpec)]);
        }
