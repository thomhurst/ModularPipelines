...
public record GcloudContainerOperationsWaitOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// poll an operation for completion
    /// </summary>
    /// <param name="OperationId">The operation id to poll.</param>
    public GcloudContainerOperationsWaitOptions(
        string OperationId
    )
    {
