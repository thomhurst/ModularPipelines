...
public record GcloudDataplexLakesRemoveIamPolicyBindingOptions : GcloudOptions
{
    ...
    public void Deconstruct(out string Member, out string Role, out string Lake)
    {
        Member = this.Member;
        Role = this.Role;
        Lake = this.Lake;
