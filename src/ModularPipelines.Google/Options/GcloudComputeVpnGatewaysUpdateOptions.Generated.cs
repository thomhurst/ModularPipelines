...
public record GcloudComputeVpnGatewaysUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine Highly     Available VPN gateway
    /// </summary>
    /// <param name="Name">Name of the VPN Gateway to update.</param>
    public GcloudComputeVpnGatewaysUpdateOptions(
        string Name
    )
    {
