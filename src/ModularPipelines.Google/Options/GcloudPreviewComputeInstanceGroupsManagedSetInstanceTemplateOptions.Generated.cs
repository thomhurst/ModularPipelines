...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-groups/managed/set-instance-template
...
[CliSubCommand("preview", "compute", "instance-groups", "managed", "set-instance-template")]
public record GcloudPreviewComputeInstanceGroupsManagedSetInstanceTemplateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// set     the instance template for a managed instance group
    /// </summary>
    ...
    public GcloudPreviewComputeInstanceGroupsManagedSetInstanceTemplateOptions(
        string Template,
        string Name
    )
    {
