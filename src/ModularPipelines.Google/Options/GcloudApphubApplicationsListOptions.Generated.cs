...
// Source: https://cloud.google.com/sdk/gcloud/reference/apphub/applications/list
...
[CliSubCommand("apphub", "applications", "list")]
public record GcloudApphubApplicationsListOptions : GcloudOptions
{
    /// <summary>
    /// list Apphub applications
    /// </summary>
    ...
    public GcloudApphubApplicationsListOptions(
        string Location
    )
    {
