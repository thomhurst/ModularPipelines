...
public record GcloudComputeFirewallPoliciesRulesCreateOptions : GcloudOptions
{
    /// <summary>
    /// creates a Compute Engine     firewall policy rule
    /// </summary>
    ...
    public GcloudComputeFirewallPoliciesRulesCreateOptions(
        GcloudComputeFirewallPoliciesRulesCreateAction Action,
    ...
    public void Deconstruct(out GcloudComputeFirewallPoliciesRulesCreateAction Action, out string FirewallPolicy, out IEnumerable<string> Layer4Configs, out string Priority)
    {
        Action = this.Action;
    ...
    public GcloudComputeFirewallPoliciesRulesCreateAction Action { get; private init; }
    ...
    public GcloudComputeFirewallPoliciesRulesCreateDirection? Direction { get; set; }
