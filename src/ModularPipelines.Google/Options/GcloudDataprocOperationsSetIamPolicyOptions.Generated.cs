...
public record GcloudDataprocOperationsSetIamPolicyOptions : GcloudOptions
{
    ...
    public GcloudDataprocOperationsSetIamPolicyOptions(
        string Operation,
        string PolicyFile
    )
    {
    ...
    public void Deconstruct(out string Operation, out string PolicyFile)
    {
