...
public record GcloudContainerFleetPolicycontrollerContentBundlesSetOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// sets bundle     installation for Policy Controller content
    /// </summary>
    /// <param name="BundleName">The constraint bundle to install in Policy Controller.</param>
    public GcloudContainerFleetPolicycontrollerContentBundlesSetOptions(
        string BundleName
    )
    {
    ...
    /// <summary>
    /// Exempted Namespaces flags. At most one of these can be specified: Exempted namespaces are ignored by Policy Controller when applying constraints added by this bundle.
    /// </summary>
    [CliOption("--exempted-namespaces", Format = OptionFormat.EqualsSeparated)]
    public string? ExemptedNamespaces { get; set; }

    /// <summary>
    /// Exempted Namespaces flags. At most one of these can be specified: Removes all exempted namespaces from the specified bundle.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(ExemptedNamespaces) ? 1 : 0) + (NoExemptedNamespaces == true ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of ExemptedNamespaces or NoExemptedNamespaces may be specified.", [nameof(ExemptedNamespaces), nameof(NoExemptedNamespaces)]);
        }
        yield break;
    }
