...
public record GcloudContainerFleetMembershipsBindingsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update the Binding in     a Membership
    /// </summary>
    ...
    public GcloudContainerFleetMembershipsBindingsUpdateOptions(
        string Scope,
        string Binding
    )
    {
