...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/networks/peerings/delete
...
[CliSubCommand("compute", "networks", "peerings", "delete")]
public record GcloudComputeNetworksPeeringsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete a Compute Engine network     peering
    /// </summary>
    ...
    public GcloudComputeNetworksPeeringsDeleteOptions(
        string Network,
        string Name
    )
    {
