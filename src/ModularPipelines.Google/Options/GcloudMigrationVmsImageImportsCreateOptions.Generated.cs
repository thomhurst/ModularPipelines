...
public record GcloudMigrationVmsImageImportsCreateOptions(
...
) : GcloudOptions
{
    ...
    /// <summary>
    /// OS adaptation parameters At most one of these can be specified: Guest OS features to enable on the imported image. This field does not change the OS of the image; it only marks the image with the specified features, so ensure they are compatible with the OS. If specified, --skip-os-adaptation must be specified.
    /// </summary>
