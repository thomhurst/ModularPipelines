...
public record GcloudBackupDrBackupPlansUpdateOptions : GcloudOptions
{
    ...
    /// </summary>
    [CliOption("--add-backup-rule", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? AddBackupRule { get; set; }
    ...
    /// <summary>
    /// Workload-specific properties for disk backups generated by this plan. guest-flush Indicates whether to perform a guest flush operation before taking a disk backup. When set to true, the system will attempt to ensure application-consistent backups. When set to false, the system will create crash-consistent backups. Default value is false. Example: --disk-properties=guest-flush=true Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--disk-properties", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string>? DiskProperties { get; set; }
    ...
    public IEnumerable<string>? RemoveBackupRule { get; set; }
