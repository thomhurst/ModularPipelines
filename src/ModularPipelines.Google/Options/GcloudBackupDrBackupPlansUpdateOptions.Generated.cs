...
public record GcloudBackupDrBackupPlansUpdateOptions : GcloudOptions
{
    ...
    public IEnumerable<string>? RemoveBackupRuleValues { get; set; }

    [Obsolete("Use RemoveBackupRuleValues instead.")]
    public string? RemoveBackupRule
    {
        get => RemoveBackupRuleValues?.FirstOrDefault();
        set => RemoveBackupRuleValues = value is null ? null : [value];
    }
