...
public record GcloudFirestoreFieldsTtlsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((DisableTtl == true || EnableTtl == true || !string.IsNullOrWhiteSpace(ExpirationOffset)) && (EnableTtl == true || !string.IsNullOrWhiteSpace(ExpirationOffset)) && (!(EnableTtl == true)))
        {
            yield return new ValidationResult("EnableTtl must be specified when other arguments in this group are specified.", [nameof(EnableTtl)]);
        }
        yield break;
    }
