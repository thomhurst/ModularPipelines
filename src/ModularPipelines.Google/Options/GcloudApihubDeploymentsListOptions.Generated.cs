...
// Source: https://cloud.google.com/sdk/gcloud/reference/apihub/deployments/list
...
[CliSubCommand("apihub", "deployments", "list")]
public record GcloudApihubDeploymentsListOptions : GcloudOptions
{
    /// <summary>
    /// list Deployments
    /// </summary>
    ...
    public GcloudApihubDeploymentsListOptions(
        string Location
    )
    {
