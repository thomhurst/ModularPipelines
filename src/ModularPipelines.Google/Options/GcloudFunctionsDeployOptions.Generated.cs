...
public record GcloudFunctionsDeployOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Specify which of the outbound traffic to send through Direct VPC     egress. Configuring Direct VPC network is required to use this flag.     DIRECT_VPC_EGRESS must be one of: private-ranges-only, all.
    /// </summary>
