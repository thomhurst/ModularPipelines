...
public record GcloudFunctionsDeployOptions : GcloudOptions
{
    ...
    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. If specified, latest function revision will be served all traffic.
    /// </summary>
    ...
    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. List of label KEY=VALUE pairs to update. If a label exists, its value is modified. Otherwise, a new label is created. Keys must start with a lowercase character and contain only hyphens (-), underscores (_), lowercase characters, and numbers. Values must contain only hyphens (-), underscores (_), lowercase characters, and numbers. Label keys starting with deployment are reserved for use by deployment tools and cannot be specified manually.
    /// </summary>
    [CliOption("--update-labels", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? UpdateLabels { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Name of the Binary Authorization policy that the function image should be checked against when deploying to Cloud Run. Example: default The flag is only applicable to 2nd gen functions.
    /// </summary>
    [CliOption("--binary-authorization", Format = OptionFormat.EqualsSeparated)]
    public GcloudBinaryAuthorization? BinaryAuthorization { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Clears the Binary Authorization policy field.
    /// </summary>
    [CliFlag("--clear-binary-authorization")]
    public bool? ClearBinaryAuthorization { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Path to a local YAML file with definitions for all build environment variables. All existing build environment variables will be removed before the new build environment variables are added.
    /// </summary>
    [CliOption("--build-env-vars-file", Format = OptionFormat.EqualsSeparated)]
    public GcloudBuildEnvVarsFile? BuildEnvVarsFile { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Remove all build environment variables.
    /// </summary>
    [CliFlag("--clear-build-env-vars")]
    public bool? ClearBuildEnvVars { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: List of key-value pairs to set as build environment variables. All existing build environment variables will be removed first.
    /// </summary>
    [CliOption("--set-build-env-vars", Format = OptionFormat.EqualsSeparated)]
    public GcloudSetBuildEnvVars? SetBuildEnvVars { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Or at least one of these can be specified: Only --update-build-env-vars and --remove-build-env-vars can be used together. If both are specified, --remove-build-env-vars will be applied first. List of build environment variables to be removed.
    /// </summary>
    [CliOption("--remove-build-env-vars", Format = OptionFormat.EqualsSeparated)]
    public GcloudRemoveBuildEnvVars? RemoveBuildEnvVars { get; set; }
    ...
    public GcloudUpdateEnvVars? UpdateEnvVars { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Clears the KMS crypto key used to encrypt the function.
    /// </summary>
    [CliFlag("--clear-kms-key")]
    public bool? ClearKmsKey { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Sets the user managed KMS crypto key used to encrypt the Cloud Function and its resources. The KMS crypto key name should match the pattern projects/${PROJECT}/locations/${LOCATION}/keyRings/${KEYRING}/cryptoKeys/${CRYPTOKEY} where ${PROJECT} is the project, ${LOCATION} is the location of the key ring, and ${KEYRING} is the key ring that contains the ${CRYPTOKEY} crypto key. If this flag is set, then a Docker repository created in Artifact Registry must be specified using the --docker-repository flag and the repository must be encrypted using the same KMS key.
    /// </summary>
    [CliOption("--kms-key", Format = OptionFormat.EqualsSeparated)]
    public GcloudKmsKey? KmsKey { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud functions deploy --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud functions deploy --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
    [CliFlag("--clear-labels")]
    public bool? ClearLabels { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: List of label keys to remove. If a label does not exist it is silently ignored. If --update-labels is also specified then --update-labels is applied first.Label keys starting with deployment are reserved for use by deployment tools and cannot be specified manually.
    /// </summary>
    [CliOption("--remove-labels", Format = OptionFormat.EqualsSeparated)]
    public GcloudRemoveLabels? RemoveLabels { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Clears the maximum instances setting for the function. If it's any 2nd gen function or a 1st gen HTTP function, this flag sets maximum instances to 0, which means there is no limit to maximum instances. If it's an event-driven 1st gen function, this flag sets maximum instances to 3000, which is the default value for 1st gen functions.
    /// </summary>
    ...
    public GcloudMaxInstances? MaxInstances { get; set; }

    /// <summary>
    /// --security-level=SECURITY_LEVEL; default="secure-always" Security level controls whether a function's URL supports HTTPS only or both HTTP and HTTPS. By default, secure-always will be used, meaning only HTTPS is supported. SECURITY_LEVEL must be one of: secure-always, secure-optional. At most one of these can be specified: Clears the minimum instances setting for the function.
    /// </summary>
    ...
    public GcloudTriggerTopic? TriggerTopic { get; set; }
    ...
    public GcloudTriggerEvent? TriggerEvent { get; set; }
    ...
    public GcloudTriggerResource? TriggerResource { get; set; }
    ...
    public GcloudTriggerEventFilters? TriggerEventFilters { get; set; }
    ...
    public GcloudTriggerEventFiltersPathPattern? TriggerEventFiltersPathPattern { get; set; }

    [Obsolete("SecurityLevel is no longer supported by the installed CLI and has no effect.")]
