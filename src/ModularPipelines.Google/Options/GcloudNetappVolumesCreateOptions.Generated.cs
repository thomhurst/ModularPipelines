...
/// <param name="Protocols">Type of File System protocols for the Cloud NetApp Volume. Valid component values are: NFSV3, NFSV4, SMB, ISCSI.</param>
...
public record GcloudNetappVolumesCreateOptions(
    ...
    [property: CliOption("--protocols", Format = OptionFormat.EqualsSeparated)] IEnumerable<string> Protocols,
    [property: CliOption("--storage-pool", Format = OptionFormat.EqualsSeparated)] string StoragePool
) : GcloudOptions
{
    /// <summary>
