...
public record GcloudHealthcareFhirStoresAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy     binding to a Cloud Healthcare API FHIR store
    /// </summary>
