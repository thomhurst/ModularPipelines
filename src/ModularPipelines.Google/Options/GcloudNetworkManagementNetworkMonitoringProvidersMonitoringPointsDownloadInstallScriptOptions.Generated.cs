...
public record GcloudNetworkManagementNetworkMonitoringProvidersMonitoringPointsDownloadInstallScriptOptions : GcloudOptions
{
    ...
    public GcloudNetworkManagementNetworkMonitoringProvidersMonitoringPointsDownloadInstallScriptOptions(
        string Hostname,
        string Location,
        GcloudMonitoringPointType MonitoringPointType,
    ...
    public void Deconstruct(out string Hostname, out string Location, out GcloudMonitoringPointType MonitoringPointType, out string NetworkMonitoringProvider, out string OutputFile)
    {
    ...
    public GcloudMonitoringPointType MonitoringPointType { get; private init; }
