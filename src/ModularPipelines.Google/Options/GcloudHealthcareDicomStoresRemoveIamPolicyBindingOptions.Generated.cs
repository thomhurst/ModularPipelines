...
public record GcloudHealthcareDicomStoresRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Cloud Healthcare API DICOM store
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string DicomStore)
    {
        Member = this.Member;
        Role = this.Role;
