...
public record GcloudNetworkSecurityAddressGroupsCreateOptions : GcloudOptions
{
    /// <summary>
    /// create an address group
    /// </summary>
    ...
    public GcloudNetworkSecurityAddressGroupsCreateOptions(
        string Capacity,
        GcloudNetworkSecurityAddressGroupsCreateType Type,
        string AddressGroup
    )
    {
    ...
    public void Deconstruct(out string Capacity, out GcloudNetworkSecurityAddressGroupsCreateType Type, out string AddressGroup)
    {
    ...
    public GcloudNetworkSecurityAddressGroupsCreateType Type { get; private init; }
    ...
    public IEnumerable<GcloudNetworkSecurityAddressGroupsCreatePurpose>? Purpose { get; set; }
