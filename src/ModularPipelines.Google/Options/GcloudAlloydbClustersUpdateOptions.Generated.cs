...
public record GcloudAlloydbClustersUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("At most one of ClearAutomatedBackup, DisableAutomatedBackup, or (AutomatedBackupDaysOfWeek, AutomatedBackupStartTimes, AutomatedBackupWindow, AutomatedBackupRetentionCount, AutomatedBackupRetentionPeriod, AutomatedBackupEncryptionKey, AutomatedBackupEncryptionKeyKeyring, AutomatedBackupEncryptionKeyLocation, or AutomatedBackupEncryptionKeyProject) may be specified.", [nameof(ClearAutomatedBackup), nameof(DisableAutomatedBackup), nameof(AutomatedBackupDaysOfWeek), nameof(AutomatedBackupStartTimes), nameof(AutomatedBackupWindow), nameof(AutomatedBackupRetentionCount), nameof(AutomatedBackupRetentionPeriod), nameof(AutomatedBackupEncryptionKey), nameof(AutomatedBackupEncryptionKeyKeyring), nameof(AutomatedBackupEncryptionKeyLocation), nameof(AutomatedBackupEncryptionKeyProject)]);
        }
