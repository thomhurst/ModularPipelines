...
public record GcloudKmsKeysCreateOptions : GcloudOptions
{
    ...
    public GcloudKmsKeysCreateOptions(
        GcloudKmsKeysCreatePurpose Purpose,
        string Key
    )
    {
    ...
    public void Deconstruct(out GcloudKmsKeysCreatePurpose Purpose, out string Key)
    {
    ...
    public GcloudKmsKeysCreatePurpose Purpose { get; private init; }
    ...
    public IEnumerable<GcloudKmsKeysCreateAllowedAccessReasons>? AllowedAccessReasons { get; set; }
    ...
    public GcloudKmsKeysCreateProtectionLevel? ProtectionLevel { get; set; }
