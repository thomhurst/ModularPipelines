...
public record GcloudOracleDatabaseExascaleDbStorageVaultsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public GcloudOracleDatabaseExascaleDbStorageVaultsCreateOptions(
        string DisplayName,
        string PropertiesAdditionalFlashCachePercent,
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(PropertiesAdditionalFlashCachePercent);
        this.PropertiesAdditionalFlashCachePercent = PropertiesAdditionalFlashCachePercent;
        global::System.ArgumentNullException.ThrowIfNull(PropertiesDescription);
    ...
    public void Deconstruct(out string DisplayName, out string PropertiesAdditionalFlashCachePercent, out string PropertiesDescription, out string ExascaleDbStorageVault)
    {
        DisplayName = this.DisplayName;
        PropertiesAdditionalFlashCachePercent = this.PropertiesAdditionalFlashCachePercent;
        PropertiesDescription = this.PropertiesDescription;
    ...
    public string PropertiesAdditionalFlashCachePercent { get; private init; }

    /// <summary>
    /// The description of the ExascaleDbStorageVault.
    /// </summary>
    [CliOption("--properties-description", Format = OptionFormat.EqualsSeparated)]
    public string PropertiesDescription { get; private init; }
