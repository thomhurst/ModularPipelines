...
public record GcloudApihubPluginsInstancesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Arguments for the config. At most one of these can be specified: Config for authentication with API key. Secret provides a reference to entries in Secret Manager. The resource name of the secret version in the format, format as: projects/*/secrets/*/versions/*.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the config. At most one of these can be specified: Parameters to support Username and Password Authentication. Username.
    /// </summary>
