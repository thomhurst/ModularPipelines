...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/public-advertised-prefixes/update
...
[CliSubCommand("preview", "compute", "public-advertised-prefixes", "update")]
public record GcloudPreviewComputePublicAdvertisedPrefixesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// updates a     Compute Engine public advertised prefix
    /// </summary>
    /// <param name="Name">Name of the public advertised prefix to operate on.</param>
    public GcloudPreviewComputePublicAdvertisedPrefixesUpdateOptions(
        string Name
    )
    {
