...
// Source: https://cloud.google.com/sdk/gcloud/reference/agent-identity/access-summaries/list
...
[CliSubCommand("agent-identity", "access-summaries", "list")]
public record GcloudAgentIdentityAccessSummariesListOptions : GcloudOptions
{
    /// <summary>
    /// list access summaries
    /// </summary>
    ...
    public GcloudAgentIdentityAccessSummariesListOptions(
        string Location
    )
    {
