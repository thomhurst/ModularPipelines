...
public record GcloudSccBqexportsListOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// Exactly one of these must be specified: Folder where the BigQuery export resides. Formatted as folders/456 or just 456.
    /// </summary>
    [CliOption("--folder", Format = OptionFormat.EqualsSeparated)]
    public string? Folder { get; set; }

    /// <summary>
    /// Exactly one of these must be specified: Organization where the BigQuery export resides. Formatted as organizations/123 or just 123.
    /// </summary>
    [CliOption("--organization", Format = OptionFormat.EqualsSeparated)]
    public string? Organization { get; set; }

    /// <summary>
    /// Exactly one of these must be specified: Project (id or number) where the BigQuery export resides. Formatted as projects/789 or just 789.
    /// </summary>
