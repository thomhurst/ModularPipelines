...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/perform-maintenance
...
[CliSubCommand("preview", "compute", "reservations", "perform-maintenance")]
public record GcloudPreviewComputeReservationsPerformMaintenanceOptions : GcloudOptions
{
    /// <summary>
    /// perform     maintenance on a reservation, only applicable to reservations with     reservation blocks
    /// </summary>
    /// <param name="Reservation">Name of the reservation to perform-maintenance.</param>
    public GcloudPreviewComputeReservationsPerformMaintenanceOptions(
        string Reservation
    )
    {
