...
public record GcloudComputeInterconnectsApplicationAwarenessUpdateOptions : GcloudOptions
{
    /// <summary>
    /// updates     application awareness configuration of a Compute Engine interconnect
    /// </summary>
    /// <param name="Name">Name of the interconnect to patch.</param>
    public GcloudComputeInterconnectsApplicationAwarenessUpdateOptions(
        string Name
    )
    {
