...
public record GcloudPreviewComputeInstanceGroupsManagedUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute     Engine managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to update.</param>
    public GcloudPreviewComputeInstanceGroupsManagedUpdateOptions(
        string Name
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Clears all autohealing policy fields for the managed instance group.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Name of the health check to operate on.
    /// </summary>
    [CliOption("--health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HealthCheck { get; set; }

    /// <summary>
    /// At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: (DEPRECATED) HTTP health check object used for autohealing instances in this group. HttpHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    [CliOption("--http-health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HttpHealthCheck { get; set; }

    /// <summary>
    /// At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: (DEPRECATED) HTTPS health check object used for autohealing instances in this group. HttpsHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
