...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Specifies the instance template that will replace the existing template used by the MIG. The MIG then uses this new template to create instances. Specifying the new template overrides any template versions that you've set for the MIG. Specify either a global or a regional instance template.
    /// </summary>
    ...
    /// <summary>
    /// (DEPRECATED) HTTP health check object used for autohealing instances in this group. HttpHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    [CliOption("--http-health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HttpHealthCheck { get; set; }

    /// <summary>
    /// (DEPRECATED) HTTPS health check object used for autohealing instances in this group. HttpsHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    ...
    /// <summary>
    /// Region of the managed instance group to update. If not specified, you might be prompted to select a region (interactive mode only). A list of regions can be fetched by running: $ gcloud compute regions list Overrides the default compute/region property value for this command invocation.
    /// </summary>
    [CliOption("--region", Format = OptionFormat.EqualsSeparated)]
    public string? Region { get; set; }

    /// <summary>
    /// Zone of the managed instance group to update. If not specified, you might be prompted to select a zone (interactive mode only). A list of zones can be fetched by running: $ gcloud compute zones list Overrides the default compute/zone property value for this command invocation.
    /// </summary>
    ...
    /// <summary>
    /// Type of replacement method. Specifies what action will be taken to update VMs. UPDATE_POLICY_REPLACEMENT_METHOD must be one of: recreate Recreate VMs and preserve the VM names. The VM IDs and creation timestamps might change. substitute Delete old VMs and create VMs with new names.
    /// </summary>
