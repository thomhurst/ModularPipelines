...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-groups/managed/update
...
[CliSubCommand("preview", "compute", "instance-groups", "managed", "update")]
public record GcloudPreviewComputeInstanceGroupsManagedUpdateOptions(
...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. An optional description for this group. To clear the description, set the value to an empty string.
    /// </summary>
    ...
    /// <summary>
    /// Negates --force-update-on-repair. Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. Specifies whether to apply the group's latest configuration when repairing a VM. If you updated the group's instance template or per-instance configurations after the VM was created, then these changes are applied when VM is repaired. If this flag is disabled with -no-force-update-on-repair, then updates are applied in accordance with the group's update policy type. By default, this flag is disabled. Use --force-update-on-repair to enable and --no-force-update-on-repair to disable.
    /// </summary>
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. Remove all instance selections from the instance flexibility policy.
    /// </summary>
    [CliFlag("--remove-instance-selections-all")]
    public bool? RemoveInstanceSelectionsAll { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. Target number of running instances in managed instance group.
    /// </summary>
    [CliOption("--size", Format = OptionFormat.EqualsSeparated)]
    public int? Size { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. Specifies the target size of stopped VMs in the group.
    /// </summary>
    [CliOption("--stopped-size", Format = OptionFormat.EqualsSeparated)]
    public int? StoppedSize { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. Specifies the target size of suspended VMs in the group.
    /// </summary>
    [CliOption("--suspended-size", Format = OptionFormat.EqualsSeparated)]
    public int? SuspendedSize { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. Specifies the instance template that will replace the existing template used by the MIG. The MIG then uses this new template to create instances. Specifying the new template overrides any template versions that you've set for the MIG. Specify either a global or a regional instance template.
    /// </summary>
    [CliOption("--template", Format = OptionFormat.EqualsSeparated)]
    public string? Template { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Clears all autohealing policy fields for the managed instance group.
    /// </summary>
    [CliFlag("--clear-autohealing")]
    public bool? ClearAutohealing { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Or at least one of these can be specified: Specifies the number of seconds that a new VM takes to initialize and run its startup script. During a VM's initial delay period, the MIG ignores unsuccessful health checks because the VM might be in the startup process. This prevents the MIG from prematurely recreating a VM. If the health check receives a healthy response during the initial delay, it indicates that the startup process is complete and the VM is ready. The value of initial delay must be between 0 and 3600 seconds. The default value is 0. See $ gcloud topic datetimes for information on duration formats.
    /// </summary>
    [CliOption("--initial-delay", Format = OptionFormat.EqualsSeparated)]
    public string? InitialDelay { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Name of the health check to operate on.
    /// </summary>
    [CliOption("--health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HealthCheck { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: (DEPRECATED) HTTP health check object used for autohealing instances in this group. HttpHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    [CliOption("--http-health-check", Format = OptionFormat.EqualsSeparated)]
    public string? HttpHealthCheck { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: (DEPRECATED) HTTPS health check object used for autohealing instances in this group. HttpsHealthCheck is deprecated. Use --health-check instead.
    /// </summary>
    ...
    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Detaches the workload policy from the managed instance group.
    /// </summary>
    [CliFlag("--remove-workload-policy")]
    public bool? RemoveWorkloadPolicy { get; set; }

    /// <summary>
    /// Parameters for setting distribution policy. Stateful policy settings for the managed instance group. Parameters for setting standby policy. Parameters for setting update policy for this managed instance group. At most one of these can be specified: Specifies the workload policy for the managed instance group. It can be a full or partial URL to a resource policy containing the workload policy.
    /// </summary>
