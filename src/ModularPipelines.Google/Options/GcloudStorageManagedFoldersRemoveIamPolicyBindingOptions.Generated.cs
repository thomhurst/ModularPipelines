...
public record GcloudStorageManagedFoldersRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a managed folder
    /// </summary>
    ...
    /// <param name="Url">URL of managed folder to remove IAM policy binding from.</param>
    public GcloudStorageManagedFoldersRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string Url
    )
    ...
    public void Deconstruct(out string Member, out string Role, out string Url)
    {
        Member = this.Member;
        Role = this.Role;
        Url = this.Url;
