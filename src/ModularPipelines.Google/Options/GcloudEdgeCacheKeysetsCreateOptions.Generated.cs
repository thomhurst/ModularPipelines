...
public record GcloudEdgeCacheKeysetsCreateOptions : GcloudOptions
{
    ...
    public IEnumerable<string>? PublicKeyValues { get; set; }
    ...
    [Obsolete("Use PublicKeyValues instead.")]
    public string? PublicKey
    {
        get => PublicKeyValues?.FirstOrDefault();
        set => PublicKeyValues = value is null ? null : [value];
    }
