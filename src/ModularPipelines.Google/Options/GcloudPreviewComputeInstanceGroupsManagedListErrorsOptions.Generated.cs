...
public record GcloudPreviewComputeInstanceGroupsManagedListErrorsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list errors     produced by managed instances in a managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedListErrorsOptions(
        string Name
    )
    {
