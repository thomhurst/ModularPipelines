...
public record GcloudPreviewComputeHealthChecksUpdateHttp2Options : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a HTTP2 health     check
    /// </summary>
    /// <param name="Name">Name of the HTTP2 health check to update.</param>
    public GcloudPreviewComputeHealthChecksUpdateHttp2Options(
        string Name
    )
    {
