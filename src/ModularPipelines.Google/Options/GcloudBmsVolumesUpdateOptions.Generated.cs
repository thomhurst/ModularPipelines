...
public record GcloudBmsVolumesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Bare Metal Solution volume
    /// </summary>
    ...
    public GcloudBmsVolumesUpdateOptions(
        string Volume
    )
    {
