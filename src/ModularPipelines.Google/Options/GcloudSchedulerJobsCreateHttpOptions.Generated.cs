...
) : GcloudOptions
{
    ...
    /// <summary>
    /// How the request sent to the target when executing the job should be authenticated. At most one of these can be specified: OAuth2 OpenId Connect The audience to be used when generating an OpenId Connect token to be included in the request sent to the target when executing the job. If not specified, the URI specified in target will be used.
    /// </summary>
    [SecretValue]
