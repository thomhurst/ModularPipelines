...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/remove-metadata
...
[CliSubCommand("preview", "compute", "instances", "remove-metadata")]
public record GcloudPreviewComputeInstancesRemoveMetadataOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove instance metadata
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesRemoveMetadataOptions(
        string InstanceName
    )
    {
