...
public record GcloudGeminiLoggingSettingsSettingBindingsListOptions(
    [property: CliOption("--logging-setting", Format = OptionFormat.EqualsSeparated)] string LoggingSetting
) : GcloudOptions
{
    /// <summary>
