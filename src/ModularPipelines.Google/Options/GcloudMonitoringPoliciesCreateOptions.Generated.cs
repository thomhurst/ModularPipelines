...
public record GcloudMonitoringPoliciesCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Documentation At most one of these can be specified: The documentation to be included with the policy.
    /// </summary>
    [CliOption("--documentation", Format = OptionFormat.EqualsSeparated)]
    public string? Documentation { get; set; }

    /// <summary>
    /// Documentation At most one of these can be specified: The path to a file containing the documentation to be included with the policy. Use a full or relative path to a local file containing the value of documentation.
    /// </summary>
    [CliOption("--documentation-from-file", Format = OptionFormat.EqualsSeparated)]
    public string? DocumentationFromFile { get; set; }

    /// <summary>
    /// Documentation At most one of these can be specified: The policy as a string. In either JSON or YAML format.
    /// </summary>
    [CliOption("--policy", Format = OptionFormat.EqualsSeparated)]
    public string? Policy { get; set; }

    /// <summary>
    /// Documentation At most one of these can be specified: The path to a JSON or YAML file containing the policy. Use a full or relative path to a local file containing the value of policy.
    /// </summary>
