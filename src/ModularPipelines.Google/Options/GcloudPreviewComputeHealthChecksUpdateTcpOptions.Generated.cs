...
public record GcloudPreviewComputeHealthChecksUpdateTcpOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a TCP health check
    /// </summary>
    /// <param name="Name">Name of the TCP health check to update.</param>
    public GcloudPreviewComputeHealthChecksUpdateTcpOptions(
        string Name
    )
    {
