...
public record GcloudOracleDatabaseAutonomousDatabasesUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Set autonomousDatabase.properties back to default value.    Arguments for the local adg auto failover max data loss limit duration.
    /// </summary>
    [CliFlag("--clear-properties")]
    public bool? ClearProperties { get; set; }

    /// <summary>
    /// This field indicates the maximum data loss limit for an Autonomous     Database, in seconds.    Arguments for the local data guard enabled.
    /// </summary>
