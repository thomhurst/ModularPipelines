...
// Source: https://cloud.google.com/sdk/gcloud/reference/service-directory/namespaces/remove-iam-policy-binding
...
[CliSubCommand("service-directory", "namespaces", "remove-iam-policy-binding")]
public record GcloudServiceDirectoryNamespacesRemoveIamPolicyBindingOptions : GcloudOptions
{
    /// <summary>
    /// removes IAM     policy binding from a namespace
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Namespace)
    {
        Member = this.Member;
        Role = this.Role;
