...
public record GcloudAgentIdentityAuthProvidersUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ApiKeyParams object. The API key for this auth_provider.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. The authorization endpoint to send users to for consenting to delegate to the agent. eg. "https://auth.atlassian.com/authorize"
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. The client ID of the OAuth client.
    /// </summary>
    [CliOption("--three-legged-oauth-client-id", Format = OptionFormat.EqualsSeparated)]
    public string? ThreeLeggedOauthClientId { get; set; }

    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. The client secret of the OAuth client.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. The default continue URI for 3LO flow to redirect end users after consent.
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. Enables Proof Key for Code Exchange (PKCE) for the OAuth flow to prevent authorization code interception attacks. Use --three-legged-oauth-enable-pkce to enable and --no-three-legged-oauth-enable-pkce to disable.
    /// </summary>
    [CliFlag("--three-legged-oauth-enable-pkce")]
    public bool? ThreeLeggedOauthEnablePkce { get; set; }

    /// <summary>
    /// Negates --three-legged-oauth-enable-pkce. Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. Enables Proof Key for Code Exchange (PKCE) for the OAuth flow to prevent authorization code interception attacks. Use --three-legged-oauth-enable-pkce to enable and --no-three-legged-oauth-enable-pkce to disable.
    /// </summary>
    [CliFlag("--no-three-legged-oauth-enable-pkce")]
    public bool? NoThreeLeggedOauthEnablePkce { get; set; }

    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing ThreeLeggedOAuth object. The token endpoint for requesting tokens on behalf of an end user. eg. "https://auth.atlassian.com/oauth/token"
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing TwoLeggedOAuth object. The client ID of the OAuth client.
    /// </summary>
    [CliOption("--two-legged-oauth-client-id", Format = OptionFormat.EqualsSeparated)]
    public string? TwoLeggedOauthClientId { get; set; }

    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing TwoLeggedOAuth object. The client secret of the OAuth client.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Arguments for the type. At most one of these can be specified: Message describing TwoLeggedOAuth object. The token endpoint of the OAuth client.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Update workload_ids. At most one of these can be specified: Set workload_ids to new value. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Update workload_ids. At most one of these can be specified: Or at least one of these can be specified: Add new value to workload_ids list. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Update workload_ids. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear workload_ids value and set to empty list.
    /// </summary>
    [CliFlag("--clear-workload-ids")]
    public bool? ClearWorkloadIds { get; set; }

    /// <summary>
    /// Update workload_ids. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from workload_ids list. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
