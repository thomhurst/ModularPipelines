...
public record GcloudComputeImagesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy binding     from a Compute Engine image
    /// </summary>
    ...
    public GcloudComputeImagesRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string Image
    )
