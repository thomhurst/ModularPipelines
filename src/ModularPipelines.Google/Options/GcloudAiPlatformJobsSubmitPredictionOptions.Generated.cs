...
public record GcloudAiPlatformJobsSubmitPredictionOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// start an AI Platform batch     prediction job
    /// </summary>
    ...
    /// <param name="Job">Name of the batch prediction job.</param>
    public GcloudAiPlatformJobsSubmitPredictionOptions(
        string DataFormat,
    ...
    )
    {
        ...
        {
            global::System.ArgumentNullException.ThrowIfNull(InputPaths);
            var materialized = global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(InputPaths));
    ...
    public void Deconstruct(out string DataFormat, out IEnumerable<string> InputPaths, out string OutputPath, out string Region, out string Job)
    {
    ...
    /// <summary>
    /// Data format of the input files. DATA_FORMAT must be one of: text Text and JSON files; for text files, see https://www.tensorflow.org/guide/datasets#consuming_text_data, for JSON files, see https://cloud.google.com/ai-platform/prediction/docs/overview#batch_prediction_input_data tf-record TFRecord files; see https://www.tensorflow.org/guide/datasets#consuming_tfrecord_data tf-record-gzip GZIP-compressed TFRecord files.
    /// </summary>
    ...
    /// </summary>
    [CliOption("--input-paths", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IEnumerable<string> InputPaths { get; private init; }
