...
public record GcloudPreviewComputeBackendServicesDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// display detailed     information about a backend service
    /// </summary>
    /// <param name="BackendServiceName">Name of the backend service to describe.</param>
    public GcloudPreviewComputeBackendServicesDescribeOptions(
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the backend service to describe. Overrides the default compute/region property value for this command invocation.
    /// </summary>
