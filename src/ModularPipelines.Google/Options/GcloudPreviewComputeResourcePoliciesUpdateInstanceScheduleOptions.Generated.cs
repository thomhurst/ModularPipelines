...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/resource-policies/update/instance-schedule
...
[CliSubCommand("preview", "compute", "resource-policies", "update", "instance-schedule")]
public record GcloudPreviewComputeResourcePoliciesUpdateInstanceScheduleOptions : GcloudOptions
{
    /// <summary>
    /// update     a Compute Engine Instance Schedule Resource Policy
    /// </summary>
    /// <param name="Name">Name of the resource policy to operate on.</param>
    public GcloudPreviewComputeResourcePoliciesUpdateInstanceScheduleOptions(
        string Name
    )
    {
