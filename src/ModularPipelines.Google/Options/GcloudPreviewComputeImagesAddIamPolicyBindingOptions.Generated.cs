...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/images/add-iam-policy-binding
...
[CliSubCommand("preview", "compute", "images", "add-iam-policy-binding")]
public record GcloudPreviewComputeImagesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding to a Compute Engine image
    /// </summary>
    ...
    /// <summary>
    /// Image resource - The image for which to add IAM policy binding to. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument image on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the image or fully qualified identifier for the image. To set the image attribute: ▸ provide the argument image on the command line.
    /// </summary>
