...
public record GcloudLoggingSinksDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// display information about a sink
    /// </summary>
    /// <param name="SinkName">The name of the sink to describe.</param>
    public GcloudLoggingSinksDescribeOptions(
        string SinkName
    )
    {
