...
public record GcloudWorkstationsConfigsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: If set, workstations disable SSH connections to the root VM.
    /// </summary>
    [CliFlag("--disable-ssh-to-vm")]
    public bool? DisableSshToVm { get; set; }

    /// <summary>
    /// At most one of these can be specified: If set, workstations enable SSH connections to the root VM.
    /// </summary>
    [CliFlag("--enable-ssh-to-vm")]
    public bool? EnableSshToVm { get; set; }

    /// <summary>
    /// At most one of these can be specified: If set, workstations don't allow plain TCP connections.
    /// </summary>
    [CliFlag("--disable-tcp-connections")]
    public bool? DisableTcpConnections { get; set; }

    /// <summary>
    /// At most one of these can be specified: If set, workstations allow plain TCP connections.
    /// </summary>
    [CliFlag("--enable-tcp-connections")]
    public bool? EnableTcpConnections { get; set; }

    /// <summary>
    /// At most one of these can be specified: Name of the snapshot to use as the source for the home disk.
    /// </summary>
    [CliOption("--disk-source-snapshot", Format = OptionFormat.EqualsSeparated)]
    public string? DiskSourceSnapshot { get; set; }

    /// <summary>
    /// At most one of these can be specified: Name of the snapshot to use as the source for the persistent directory.
    /// </summary>
    [CliOption("--pd-source-snapshot", Format = OptionFormat.EqualsSeparated)]
    public string? PdSourceSnapshot { get; set; }

    /// <summary>
    /// At most one of these can be specified: Or at least one of these can be specified: Size of the persistent directory in GB. DISK_SIZE must be one of: 10, 50, 100, 200, 500, 1000.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Or at least one of these can be specified: Size of the persistent directory in GB. PD_DISK_SIZE must be one of: 10, 50, 100, 200, 500, 1000.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((DisableSshToVm == true ? 1 : 0) + (EnableSshToVm == true ? 1 : 0) > 1)
        {
        ...
        if ((DisableTcpConnections == true ? 1 : 0) + (EnableTcpConnections == true ? 1 : 0) > 1)
        {
        ...
        if ((!string.IsNullOrWhiteSpace(DiskSourceSnapshot) ? 1 : 0) + (!string.IsNullOrWhiteSpace(PdSourceSnapshot) ? 1 : 0) + (((object?)DiskSize is not null || (object?)DiskType is not null) ? 1 : 0) + (((object?)PdDiskSize is not null || (object?)PdDiskType is not null) ? 1 : 0) > 1)
        {
