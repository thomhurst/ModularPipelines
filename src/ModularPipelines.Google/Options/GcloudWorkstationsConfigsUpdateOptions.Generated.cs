...
public record GcloudWorkstationsConfigsUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Accelerator settings If set, overrides the default ENTRYPOINT specified by the image. Example: $ gcloud workstations configs update \ --container-command=executable,parameter_1,parameter_2 Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Labels that are applied to the configuration and propagated to the underlying Compute Engine resources. Example: $ gcloud workstations configs update \ --labels=label1=value1,label2=value2 Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Network tags to add to the Google Compute Engine machines backing the Workstations. Example: $ gcloud workstations configs update --network-tags=tag_1,tag_2 Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Accelerator settings Resource manager tags to be bound to the instance. Tag keys and values have the same definition as https://cloud.google.com/resource-manager/docs/tags/tags-overview Example: $ gcloud workstations configs update \ --vm-tags=tagKeys/key1=tagValues/value1,tagKeys/key2=tagValues/\ value2 Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
