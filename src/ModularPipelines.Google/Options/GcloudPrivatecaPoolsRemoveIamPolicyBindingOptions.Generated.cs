...
public record GcloudPrivatecaPoolsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding for a CA pool
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Pool)
    {
        Member = this.Member;
        Role = this.Role;
        Pool = this.Pool;
