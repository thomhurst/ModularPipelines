...
public record GcloudPreviewComputeMachineImagesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute Engine     machine image
    /// </summary>
    /// <param name="SourceInstance">The source instance to create a machine image from.</param>
    /// <param name="Image">Name of the machineImage to create.</param>
    public GcloudPreviewComputeMachineImagesCreateOptions(
    ...
    public void Deconstruct(out string SourceInstance, out string Image)
    {
    ...
    public string SourceInstance { get; private init; }
    ...
    /// <summary>
    /// A comma-separated list of Resource Manager tags to apply to the machine image. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
