...
public record GcloudRunWorkerPoolsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding to     a Cloud Run worker pool
    /// </summary>
