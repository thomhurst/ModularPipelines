...
// Source: https://cloud.google.com/sdk/gcloud/reference/deploy/targets/remove-iam-policy-binding
...
[CliSubCommand("deploy", "targets", "remove-iam-policy-binding")]
public record GcloudDeployTargetsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM policy     binding for a Cloud Deploy target
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Target)
    {
        Member = this.Member;
        Role = this.Role;
        Target = this.Target;
