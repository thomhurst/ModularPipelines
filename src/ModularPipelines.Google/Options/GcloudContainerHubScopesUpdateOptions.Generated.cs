...
public record GcloudContainerHubScopesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// At most one of these can be specified: Clears the relationship between the current scope and its upstream scope in the rollout sequence. To remove the link between SCOPE_NAME and its upstream scope, run: $ gcloud container hub scopes update SCOPE_NAME \ --reset-upstream-scope
    /// </summary>
