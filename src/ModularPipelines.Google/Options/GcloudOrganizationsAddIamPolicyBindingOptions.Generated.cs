...
public record GcloudOrganizationsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding for an     organization
    /// </summary>
    ...
    /// <param name="Organization">Organization resource - The organization to add the IAM policy binding. This represents a Cloud resource. This must be specified. ID of the organization or fully qualified identifier for the organization. To set the organization attribute: ▸ provide the argument organization on the command line.</param>
    public GcloudOrganizationsAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Organization
    )
    ...
    /// <summary>
    /// Organization resource - The organization to add the IAM policy binding. This represents a Cloud resource. This must be specified. ID of the organization or fully qualified identifier for the organization. To set the organization attribute: ▸ provide the argument organization on the command line.
    /// </summary>
