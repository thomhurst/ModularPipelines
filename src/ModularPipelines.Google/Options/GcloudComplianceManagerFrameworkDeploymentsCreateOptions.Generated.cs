...
public record GcloudComplianceManagerFrameworkDeploymentsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// The name of the target resource or the configuration that's required to create a new target resource. This must be specified. Arguments for the resource config. At most one of these can be specified: Or at least one of these can be specified: The configuration that's required to create a target resource. Arguments for the resource creation config. At most one of these can be specified: The configuration that's required to create a project to be used as the target resource of a deployment. The billing account ID for the project. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    {
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) ? 1 : 0) != 1)
        {
            yield return new ValidationResult("Exactly one of TargetResourceConfigExisting or (TargetResourceCreationConfigFolderDisplayName, TargetResourceCreationConfigFolderParent, TargetResourceCreationConfigProjectBillingAccountId, TargetResourceCreationConfigProjectDisplayName, or TargetResourceCreationConfigProjectParent) must be specified.", [nameof(TargetResourceConfigExisting), nameof(TargetResourceCreationConfigFolderDisplayName), nameof(TargetResourceCreationConfigFolderParent), nameof(TargetResourceCreationConfigProjectBillingAccountId), nameof(TargetResourceCreationConfigProjectDisplayName), nameof(TargetResourceCreationConfigProjectParent)]);
        }
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (((!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of (TargetResourceCreationConfigFolderDisplayName or TargetResourceCreationConfigFolderParent) or (TargetResourceCreationConfigProjectBillingAccountId, TargetResourceCreationConfigProjectDisplayName, or TargetResourceCreationConfigProjectParent) may be specified.", [nameof(TargetResourceCreationConfigFolderDisplayName), nameof(TargetResourceCreationConfigFolderParent), nameof(TargetResourceCreationConfigProjectBillingAccountId), nameof(TargetResourceCreationConfigProjectDisplayName), nameof(TargetResourceCreationConfigProjectParent)]);
        }
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent)) && (!(!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName))))
        {
            yield return new ValidationResult("TargetResourceCreationConfigFolderDisplayName must be specified when other arguments in this group are specified.", [nameof(TargetResourceCreationConfigFolderDisplayName)]);
        }
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent)) && (!(!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent))))
        {
            yield return new ValidationResult("TargetResourceCreationConfigFolderParent must be specified when other arguments in this group are specified.", [nameof(TargetResourceCreationConfigFolderParent)]);
        }
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!(!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId))))
        {
            yield return new ValidationResult("TargetResourceCreationConfigProjectBillingAccountId must be specified when other arguments in this group are specified.", [nameof(TargetResourceCreationConfigProjectBillingAccountId)]);
        }
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!(!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName))))
        {
            yield return new ValidationResult("TargetResourceCreationConfigProjectDisplayName must be specified when other arguments in this group are specified.", [nameof(TargetResourceCreationConfigProjectDisplayName)]);
        }
        if ((!string.IsNullOrWhiteSpace(TargetResourceConfigExisting) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigFolderParent) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectBillingAccountId) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectDisplayName) || !string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent)) && (!(!string.IsNullOrWhiteSpace(TargetResourceCreationConfigProjectParent))))
        {
            yield return new ValidationResult("TargetResourceCreationConfigProjectParent must be specified when other arguments in this group are specified.", [nameof(TargetResourceCreationConfigProjectParent)]);
        }
        yield break;
    }
