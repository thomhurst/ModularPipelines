...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/snapshots/set-iam-policy
...
[CliSubCommand("preview", "compute", "snapshots", "set-iam-policy")]
public record GcloudPreviewComputeSnapshotsSetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// set the IAM policy for a     Compute Engine snapshot
    /// </summary>
    ...
    public GcloudPreviewComputeSnapshotsSetIamPolicyOptions(
        string SnapshotName,
        string PolicyFile
    )
    {
