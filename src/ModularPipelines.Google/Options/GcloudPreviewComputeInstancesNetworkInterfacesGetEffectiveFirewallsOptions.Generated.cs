...
public record GcloudPreviewComputeInstancesNetworkInterfacesGetEffectiveFirewallsOptions : GcloudOptions
{
    /// <summary>
    /// firewalls     - get the effective firewalls for a Compute Engine virtual machine     network interface
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesNetworkInterfacesGetEffectiveFirewallsOptions(
        string InstanceName
    )
    {
