...
// Source: https://cloud.google.com/sdk/gcloud/reference/bigtable/schema-bundles/remove-iam-policy-binding
...
[CliSubCommand("bigtable", "schema-bundles", "remove-iam-policy-binding")]
public record GcloudBigtableSchemaBundlesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Bigtable schema bundle
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string SchemaBundle)
    {
        Member = this.Member;
        Role = this.Role;
