...
public record GcloudContainerClustersCheckAutopilotCompatibilityOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// check autopilot     compatibility of a running cluster
    /// </summary>
    /// <param name="Name">The name of this cluster.</param>
    public GcloudContainerClustersCheckAutopilotCompatibilityOptions(
        string Name
    )
    {
