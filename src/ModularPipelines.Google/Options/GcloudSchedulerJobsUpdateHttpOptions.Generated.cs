...
public record GcloudSchedulerJobsUpdateHttpOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Cloud Scheduler job that     triggers an action via HTTP
    /// </summary>
    ...
    public GcloudSchedulerJobsUpdateHttpOptions(
        string Job
    )
    {
    ...
    public GcloudSchedulerJobsUpdateHttpHttpMethod? HttpMethod { get; set; }
    ...
    /// <summary>
    /// How the request sent to the target when executing the job should be authenticated. At most one of these can be specified: Clear the auth token fields: --oidc-service-account-email, --oidc-token-audience, --oauth-service-account-email, and --oauth-token-scope.
    /// </summary>
    ...
    {
        if ((ClearAuthToken == true ? 1 : 0) + ((!string.IsNullOrWhiteSpace(OauthServiceAccountEmail) || !string.IsNullOrWhiteSpace(OauthTokenScope)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(OidcServiceAccountEmail) || !string.IsNullOrWhiteSpace(OidcTokenAudience)) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of ClearAuthToken, (OauthServiceAccountEmail or OauthTokenScope), or (OidcServiceAccountEmail or OidcTokenAudience) may be specified.", [nameof(ClearAuthToken), nameof(OauthServiceAccountEmail), nameof(OauthTokenScope), nameof(OidcServiceAccountEmail), nameof(OidcTokenAudience)]);
        }
        if ((ClearAuthToken == true || !string.IsNullOrWhiteSpace(OauthServiceAccountEmail) || !string.IsNullOrWhiteSpace(OauthTokenScope) || !string.IsNullOrWhiteSpace(OidcServiceAccountEmail) || !string.IsNullOrWhiteSpace(OidcTokenAudience)) && (!string.IsNullOrWhiteSpace(OauthServiceAccountEmail) || !string.IsNullOrWhiteSpace(OauthTokenScope)) && (!string.IsNullOrWhiteSpace(OauthServiceAccountEmail) || !string.IsNullOrWhiteSpace(OauthTokenScope)) && (!(!string.IsNullOrWhiteSpace(OauthServiceAccountEmail))))
        {
        ...
        if ((ClearAuthToken == true || !string.IsNullOrWhiteSpace(OauthServiceAccountEmail) || !string.IsNullOrWhiteSpace(OauthTokenScope) || !string.IsNullOrWhiteSpace(OidcServiceAccountEmail) || !string.IsNullOrWhiteSpace(OidcTokenAudience)) && (!string.IsNullOrWhiteSpace(OidcServiceAccountEmail) || !string.IsNullOrWhiteSpace(OidcTokenAudience)) && (!string.IsNullOrWhiteSpace(OidcServiceAccountEmail) || !string.IsNullOrWhiteSpace(OidcTokenAudience)) && (!(!string.IsNullOrWhiteSpace(OidcServiceAccountEmail))))
        {
