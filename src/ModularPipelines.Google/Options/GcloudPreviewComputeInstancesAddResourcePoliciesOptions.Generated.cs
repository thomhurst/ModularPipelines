...
/// </summary>
/// <param name="ResourcePolicies">A list of resource policy names to be added to the instance. The policies must exist in the same region as the instance.</param>
