...
public record GcloudPreviewComputeInstancesAddResourcePoliciesOptions : GcloudOptions
{
    /// <summary>
    /// add resource     policies to Compute Engine VM instances
    /// </summary>
    /// <param name="ResourcePolicies">A list of resource policy names to be added to the instance. The policies must exist in the same region as the instance. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="InstanceName">Name of the instance to add resource policies to. For details on valid instance names, refer to the criteria documented under the field 'name' at: https://cloud.google.com/compute/docs/reference/rest/v1/instances</param>
    public GcloudPreviewComputeInstancesAddResourcePoliciesOptions(
