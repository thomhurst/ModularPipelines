...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-connectivity/spokes/linked-vpn-tunnels/update
...
[CliSubCommand("network-connectivity", "spokes", "linked-vpn-tunnels", "update")]
public record GcloudNetworkConnectivitySpokesLinkedVpnTunnelsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a VPN     spoke
    /// </summary>
    ...
    public GcloudNetworkConnectivitySpokesLinkedVpnTunnelsUpdateOptions(
        string Spoke
    )
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud network-connectivity spokes linked-vpn-tunnels update \ --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud network-connectivity spokes linked-vpn-tunnels update \ --clear-labels --update-labels foo=bar,baz=qux
    /// </summary>
