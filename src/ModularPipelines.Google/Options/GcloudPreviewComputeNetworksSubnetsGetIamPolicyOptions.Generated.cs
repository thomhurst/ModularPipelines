...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/networks/subnets/get-iam-policy
...
[CliSubCommand("preview", "compute", "networks", "subnets", "get-iam-policy")]
public record GcloudPreviewComputeNetworksSubnetsGetIamPolicyOptions : GcloudOptions
{
    /// <summary>
    /// get the IAM policy     for a Compute Engine subnetwork
    /// </summary>
    ...
    public GcloudPreviewComputeNetworksSubnetsGetIamPolicyOptions(
        string Subnetwork
    )
    {
