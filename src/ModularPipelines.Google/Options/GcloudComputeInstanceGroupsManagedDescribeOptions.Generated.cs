...
public record GcloudComputeInstanceGroupsManagedDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// display detailed     information about an instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to describe.</param>
    public GcloudComputeInstanceGroupsManagedDescribeOptions(
        string Name
    )
    {
