...
public record GcloudComputeMachineImagesImportOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute Engine machine     image from virtual appliance in OVA/OVF format
    /// </summary>
    ...
    public GcloudComputeMachineImagesImportOptions(
        string SourceUri,
        string Image
    )
    {
    ...
    public GcloudComputeMachineImagesImportNetworkTier? NetworkTier { get; set; }
    ...
    /// <summary>
    /// Custom machine type extensions. At most one of these can be specified: Import machine image without scopes
    /// </summary>
    [CliFlag("--no-scopes")]
