...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instances/update-from-file
...
[CliSubCommand("preview", "compute", "instances", "update-from-file")]
public record GcloudPreviewComputeInstancesUpdateFromFileOptions : GcloudOptions
{
    /// <summary>
    /// update a Compute Engine     virtual machine instance using a configuration file
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesUpdateFromFileOptions(
        string InstanceName
    )
    {
