...
public record GcloudStorageFoldersDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe hierarchical namesapace bucket     folders
    /// </summary>
    /// <param name="Url">The URL of the folder to describe.</param>
    public GcloudStorageFoldersDescribeOptions(
        string Url
    )
    {
