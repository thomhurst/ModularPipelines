...
public record GcloudPreviewComputeBackendServicesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a backend service
    /// </summary>
    /// <param name="BackendServiceName">Name of the backend service to create.</param>
    public GcloudPreviewComputeBackendServicesCreateOptions(
    ...
    public GcloudPreviewComputeBackendServicesCreateCompressionMode? CompressionMode { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateConnectionPersistenceOnUnhealthyBackends? ConnectionPersistenceOnUnhealthyBackends { get; set; }
    ...
    /// <summary>
    /// Specifies a HTTP Header to be added by your load balancer. This flag can be repeated to specify multiple headers. For example: $ gcloud preview compute backend-services create NAME \ --custom-request-header "header-name: value" \ --custom-request-header "another-header:"
    /// </summary>
    ...
    /// <summary>
    /// Fast IP move policy for high availability (HA). HA_POLICY_FAST_IP_MOVE must be one of: GARP_RA, DISABLED.
    /// </summary>
    [CliOption("--ha-policy-fast-ip-move", Format = OptionFormat.EqualsSeparated)]
    public GcloudPreviewComputeBackendServicesCreateHaPolicyFastIpMove? HaPolicyFastIpMove { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateIpAddressSelectionPolicy? IpAddressSelectionPolicy { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateLoadBalancingScheme? LoadBalancingScheme { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateLocalityLbPolicy? LocalityLbPolicy { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateLoggingOptional? LoggingOptional { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateProtocol? Protocol { get; set; }
    ...
    public GcloudPreviewComputeBackendServicesCreateTrackingMode? TrackingMode { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the backend service to create. Overrides the default compute/region property value for this command invocation.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the network endpoint group to create the backend service. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Zone of the network endpoint group to create the backend service. If not specified and the compute/zone property isn't set, you might be prompted to select a zone (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/zone property: $ gcloud config set compute/zone ZONE A list of zones can be fetched by running: $ gcloud compute zones list To unset the property, run: $ gcloud config unset compute/zone Alternatively, the zone can be stored in the environment variable CLOUDSDK_COMPUTE_ZONE.
    /// </summary>
