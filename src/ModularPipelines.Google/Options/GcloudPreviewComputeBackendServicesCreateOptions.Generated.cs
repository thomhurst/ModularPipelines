...
) : GcloudOptions
{
    ...
    public string? CustomMetricsFile { get; set; }
    ...
    /// <summary>
    /// Configuration for Backend Authenticated TLS and mTLS. May only be specified when the backend protocol is SSL, HTTPS or HTTP2. Example: $ gcloud preview compute backend-services create \ --tls-settings='sni=example.com,authenticationConfig=${AUTH_CONF\ IG_NAME}'
    /// </summary>
    ...
    public string? SecuritySettingsSubjectAltNames { get; set; }
