...
public record GcloudDesignCenterSpacesCatalogsSharesCreateOptions(
    [property: CliOption("--destination-space", Format = OptionFormat.EqualsSeparated)] string DestinationSpace
) : GcloudOptions
{
    /// <summary>
