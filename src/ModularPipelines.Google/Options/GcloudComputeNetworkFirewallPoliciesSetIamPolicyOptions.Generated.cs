...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/network-firewall-policies/set-iam-policy
...
[CliSubCommand("compute", "network-firewall-policies", "set-iam-policy")]
public record GcloudComputeNetworkFirewallPoliciesSetIamPolicyOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// set the IAM     policy binding for a Compute Engine network firewall policy
    /// </summary>
    ...
    public GcloudComputeNetworkFirewallPoliciesSetIamPolicyOptions(
