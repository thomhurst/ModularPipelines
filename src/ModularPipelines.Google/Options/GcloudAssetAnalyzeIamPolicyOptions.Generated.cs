...
public record GcloudAssetAnalyzeIamPolicyOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Specifies a resource for analysis. Leaving it empty means ANY. Specifies an identity for analysis. Leaving it empty means ANY. Specifies the name of a saved analysis query. The analysis options. Specifies roles or permissions for analysis. Leaving it empty means ANY. The full resource name.
    /// </summary>
    ...
    /// <summary>
    /// Specifies a resource for analysis. Leaving it empty means ANY. Specifies an identity for analysis. Leaving it empty means ANY. Specifies the name of a saved analysis query. The analysis options. Specifies roles or permissions for analysis. Leaving it empty means ANY. The roles to appear in the result. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
