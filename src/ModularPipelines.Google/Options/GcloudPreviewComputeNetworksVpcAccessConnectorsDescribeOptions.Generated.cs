...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/networks/vpc-access/connectors/describe
...
[CliSubCommand("preview", "compute", "networks", "vpc-access", "connectors", "describe")]
public record GcloudPreviewComputeNetworksVpcAccessConnectorsDescribeOptions : GcloudOptions
{
    /// <summary>
    /// show     metadata for a VPC Access connector
    /// </summary>
    ...
    public GcloudPreviewComputeNetworksVpcAccessConnectorsDescribeOptions(
        string Connector
    )
    {
