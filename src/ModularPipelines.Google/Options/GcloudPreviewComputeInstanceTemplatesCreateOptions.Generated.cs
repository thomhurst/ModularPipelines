...
{
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Attaches accelerators (e.g. GPUs) to the instances. type The specific type (e.g. nvidia-tesla-t4 for NVIDIA T4) of accelerator to attach to the instances. Use 'gcloud compute accelerator-types list' to learn about all available accelerator types. count Number of accelerators to attach to each instance. The default value is 1.
    /// </summary>
    [CliOption("--accelerator", Format = OptionFormat.EqualsSeparated)]
    public string? Accelerator { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Automatically delete boot disks when their instances are deleted. Enabled by default, use --no-boot-disk-auto-delete to disable.
    /// </summary>
    [CliFlag("--boot-disk-auto-delete")]
    public bool? BootDiskAutoDelete { get; set; }

    /// <summary>
    /// Negates --boot-disk-auto-delete. Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Automatically delete boot disks when their instances are deleted. Enabled by default, use --no-boot-disk-auto-delete to disable.
    /// </summary>
    [CliFlag("--no-boot-disk-auto-delete")]
    public bool? NoBootDiskAutoDelete { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The name the guest operating system will see for the boot disk. This option can only be specified if a new boot disk is being created (as opposed to mounting an existing persistent disk).
    /// </summary>
    [CliOption("--boot-disk-device-name", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskDeviceName { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Indicates the interface to use for the boot disk. The value must be one of the following: ◆ SCSI ◆ NVME
    /// </summary>
    [CliOption("--boot-disk-interface", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskInterface { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Indicates how many IOPS to provision for the disk. This sets the number of I/O operations per second that the disk can handle.
    /// </summary>
    [CliOption("--boot-disk-provisioned-iops", Format = OptionFormat.EqualsSeparated)]
    public int? BootDiskProvisionedIops { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Indicates how much throughput to provision for the disk. This sets the number of throughput mb per second that the disk can handle.
    /// </summary>
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Enables graceful shutdown for the instance.
    /// </summary>
    [CliFlag("--graceful-shutdown")]
    public bool? GracefulShutdown { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies the maximum time for the graceful shutdown. After this time, the instance is set to STOPPING even if tasks are still running. Specify the time as the number of hours, minutes, or seconds followed by h, m, and s respectively. For example, specify 30m for 30 minutes or 20m10s for 20 minutes and 10 seconds. The value must be between 1 second and 1 hour.
    /// </summary>
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The timeout in seconds for host error detection. The value must be set with 30 second increments, with a range of 90 to 330 seconds. If unset, the default behavior of the host error recovery is used.
    /// </summary>
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. A list of resource policy names (not URLs) to be added to each instance created using this instance template. If you attach any resource policies to an instance template, you can only use that instance template to create instances that are in the same region as the resource policies. Do not include resource policies that are located in different regions in the same instance template.
    /// </summary>
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. If enabled, then, when the instance is stopped or deleted, the instance is immediately stopped without giving time to the guest OS to cleanly shut down. Use --skip-guest-os-shutdown to enable and --no-skip-guest-os-shutdown to disable.
    /// </summary>
    [CliFlag("--skip-guest-os-shutdown")]
    public bool? SkipGuestOsShutdown { get; set; }

    /// <summary>
    /// Negates --skip-guest-os-shutdown. Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. If enabled, then, when the instance is stopped or deleted, the instance is immediately stopped without giving time to the guest OS to cleanly shut down. Use --skip-guest-os-shutdown to enable and --no-skip-guest-os-shutdown to disable.
    /// </summary>
    [CliFlag("--no-skip-guest-os-shutdown")]
    public bool? NoSkipGuestOsShutdown { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The name of the source instance that the instance template will be created from.
    /// </summary>
    [CliOption("--source-instance", Format = OptionFormat.EqualsSeparated)]
    public string? SourceInstance { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Zone of the instance to operate on. Overrides the default compute/zone property value for this command invocation.
    /// </summary>
    [CliOption("--source-instance-zone", Format = OptionFormat.EqualsSeparated)]
    public string? SourceInstanceZone { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies whether IPv6 is enabled on the default network interface. If not specified, IPV4_ONLY will be used. STACK_TYPE must be one of: IPV4_IPV6 The network interface can have both IPv4 and IPv6 addresses IPV4_ONLY The network interface will be assigned IPv4 addresses IPV6_ONLY The network interface will be assigned IPv6 addresses
    /// </summary>
    [CliOption("--stack-type", Format = OptionFormat.EqualsSeparated)]
    public string? StackType { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies the subnet that the VM instances are a part of. If --network is also specified, subnet must be a subnetwork of the network specified by the --network flag.
    /// </summary>
    [CliOption("--subnet", Format = OptionFormat.EqualsSeparated)]
    public string? Subnet { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies a list of tags to apply to the instance. These tags allow network firewall rules and routes to be applied to specified VM instances. See gcloud compute firewall-rules create(1) for more details. To read more about configuring network tags, read this guide: https://cloud.google.com/vpc/docs/add-remove-network-tags To list instances with their respective status and tags, run: $ gcloud compute instances list \ --format='table(name,status,tags.list())' To list instances tagged with a specific tag, tag1, run: $ gcloud compute instances list --filter='tags:tag1'
    /// </summary>
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The number of visible threads per physical core. To disable simultaneous multithreading (SMT) set this to 1. Valid values are: 1 or 2. For more information about configuring SMT, see: https://cloud.google.com/compute/docs/instances/configuring-simultaneous-multithreading.
    /// </summary>
    [CliOption("--threads-per-core", Format = OptionFormat.EqualsSeparated)]
    public string? ThreadsPerCore { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Turbo mode to use for the instance. Supported modes include: ◆ ALL_CORE_MAX To achieve all-core-turbo frequency for more consistent CPU performance, set the field to ALL_CORE_MAX. The field is unset by default, which results in maximum performance single-core boosting.
    /// </summary>
    [CliOption("--turbo-mode", Format = OptionFormat.EqualsSeparated)]
    public string? TurboMode { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The number of physical cores to expose to the instance's guest operating system. The number of virtual CPUs visible to the instance's guest operating system is this number of cores multiplied by the instance's count of visible threads per physical core.
    /// </summary>
    [CliOption("--visible-core-count", Format = OptionFormat.EqualsSeparated)]
    public int? VisibleCoreCount { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: Assigns the given external IP address to the instance that is created. This option can only be used when creating a single instance.
    /// </summary>
    [CliOption("--address", Format = OptionFormat.EqualsSeparated)]
    public string? Address { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: If provided, the instances are not assigned external IP addresses. To pull container images, you must configure private Google access if using Container Registry or configure Cloud NAT for instances to access container images directly. For more information, see: ▸ https://cloud.google.com/vpc/docs/configure-private-google-access ▸ https://cloud.google.com/nat/docs/using-nat
    /// </summary>
    [CliFlag("--no-address")]
    public bool? NoAddress { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. ID of the key or fully qualified identifier for the key. To set the kms-key attribute: ◆ provide the argument --boot-disk-kms-key on the command line. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--boot-disk-kms-key", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskKmsKey { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The KMS keyring of the key. To set the kms-keyring attribute: ◆ provide the argument --boot-disk-kms-key on the command line with a fully specified name; ◆ provide the argument --boot-disk-kms-keyring on the command line.
    /// </summary>
    ...
    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. The Google Cloud project for the key. To set the kms-project attribute: ◆ provide the argument --boot-disk-kms-key on the command line with a fully specified name; ◆ provide the argument --boot-disk-kms-project on the command line; ◆ set the property core/project.
    /// </summary>
    [CliOption("--boot-disk-kms-project", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskKmsProject { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: (DEPRECATED) The instance boots with Confidential Computing enabled. Confidential Computing is based on Secure Encrypted Virtualization (SEV), an AMD virtualization feature for running confidential instances. The --confidential-compute flag will soon be deprecated. Please use --confidential-compute-type=SEV instead
    /// </summary>
    [CliFlag("--confidential-compute")]
    public bool? ConfidentialCompute { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: The instance boots with Confidential Computing enabled. Confidential Computing can be based on Secure Encrypted Virtualization (SEV) or Secure Encrypted Virtualization - Secure Nested Paging (SEV-SNP), both of which are AMD virtualization features for running confidential instances. Trust Domain eXtension based on Intel virtualization features for running confidential instances is also supported. Arm Confidential Compute Architecture for running confidential instances is also supported. Bare Metal Secure AI for running confidential instances is also supported. CONFIDENTIAL_COMPUTE_TYPE must be one of: BMSAI Bare Metal Secure AI CCA Arm Confidential Compute Architecture SEV Secure Encrypted Virtualization SEV_SNP Secure Encrypted Virtualization - Secure Nested Paging TDX Trust Domain eXtension
    /// </summary>
    [CliOption("--confidential-compute-type", Format = OptionFormat.EqualsSeparated)]
    public string? ConfidentialComputeType { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. A whole number value specifying the number of cores that are needed in the custom machine type. For some machine types, shared-core values can also be used. For example, for E2 machine types, you can specify micro, small, or medium. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--custom-cpu", Format = OptionFormat.EqualsSeparated)]
    public string? CustomCpu { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. A whole number value indicating how much memory is desired in the custom machine type. A size unit should be provided (eg. 3072MB or 9GB) - if no units are specified, GB is assumed. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--custom-memory", Format = OptionFormat.EqualsSeparated)]
    public string? CustomMemory { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Use the extended custom machine type.
    /// </summary>
    [CliFlag("--custom-extensions")]
    public bool? CustomExtensions { get; set; }

    /// <summary>
    /// Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the disk. The 'Compute Engine Service Agent' service account must hold permission 'Cloud KMS CryptoKey Encrypter/Decrypter'. The arguments in this group can be used to specify the attributes of this resource. Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies a custom machine type. The default is n1. For more information about custom machine types, see: https://cloud.google.com/compute/docs/general-purpose-machines#custom_machine_types
    /// </summary>
