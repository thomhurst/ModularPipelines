...
) : GcloudOptions
{
    ...
    /// <summary>
    /// The type of reservation for instances created from this template. RESERVATION_AFFINITY must be one of: any Consume any available, matching reservation. none Do not consume from any reserved capacity. specific Must consume from a specific reservation.
    /// </summary>
