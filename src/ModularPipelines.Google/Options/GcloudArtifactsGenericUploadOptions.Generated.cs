...
public record GcloudArtifactsGenericUploadOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// uploads an artifact to a generic     repository
    /// </summary>
    ...
    public GcloudArtifactsGenericUploadOptions(
        string Package,
        string Version
    )
    {
    ...
    public void Deconstruct(out string Package, out string Version)
    {
    ...
    /// <summary>
    /// The version of the package. You cannot overwrite an existing version in the repository.
    /// </summary>
