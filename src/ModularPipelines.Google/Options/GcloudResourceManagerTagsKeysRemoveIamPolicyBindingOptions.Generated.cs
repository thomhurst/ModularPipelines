...
public record GcloudResourceManagerTagsKeysRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// removes a     policy binding from the IAM policy of a TagKey
    /// </summary>
    ...
    public GcloudResourceManagerTagsKeysRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string ResourceName
    )
