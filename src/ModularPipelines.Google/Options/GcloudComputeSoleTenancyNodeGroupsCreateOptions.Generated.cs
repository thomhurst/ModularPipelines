...
public record GcloudComputeSoleTenancyNodeGroupsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a Compute Engine     node group
    /// </summary>
    ...
    public GcloudComputeSoleTenancyNodeGroupsCreateOptions(
        string NodeTemplate,
        int TargetSize,
        string Name
    )
    ...
    public GcloudComputeSoleTenancyNodeGroupsCreateShareSetting? ShareSetting { get; set; }
