...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-services/multicast-domain-groups/update
...
[CliSubCommand("network-services", "multicast-domain-groups", "update")]
public record GcloudNetworkServicesMulticastDomainGroupsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a multicast     domain group
    /// </summary>
    /// <param name="MulticastDomainGroup">Multicast domain group resource - Name of the multicast domain group to be updated. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument multicast_domain_group on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the multicast domain group or fully qualified identifier for the multicast domain group. To set the multicast_domain_group attribute: ▸ provide the argument multicast_domain_group on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudNetworkServicesMulticastDomainGroupsUpdateOptions(
    ...
    /// <summary>
    /// At most one of these can be specified: Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud network-services multicast-domain-groups update \ --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud network-services multicast-domain-groups update \ --clear-labels --update-labels foo=bar,baz=qux
    /// </summary>
