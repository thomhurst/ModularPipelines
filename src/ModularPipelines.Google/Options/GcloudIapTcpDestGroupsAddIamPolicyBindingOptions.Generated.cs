...
public record GcloudIapTcpDestGroupsAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy binding     to an IAP TCP Tunnel Destination Group resource
    /// </summary>
    ...
    public GcloudIapTcpDestGroupsAddIamPolicyBindingOptions(
        string DestGroup,
        string Member,
        string Region,
        string Role
