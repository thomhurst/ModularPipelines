...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/backend-buckets/remove-iam-policy-binding
...
[CliSubCommand("compute", "backend-buckets", "remove-iam-policy-binding")]
public record GcloudComputeBackendBucketsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM     policy binding from a Compute Engine backend bucket
    /// </summary>
    ...
    public GcloudComputeBackendBucketsRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
