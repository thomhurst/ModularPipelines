...
public record GcloudComputeUrlMapsValidateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    ...
    public GcloudComputeUrlMapsValidateLoadBalancingScheme? LoadBalancingScheme { get; set; }
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the URL map to validate.
    /// </summary>
