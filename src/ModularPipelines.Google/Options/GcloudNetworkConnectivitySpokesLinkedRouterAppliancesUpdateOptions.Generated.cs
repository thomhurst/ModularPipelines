...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-connectivity/spokes/linked-router-appliances/update
...
[CliSubCommand("network-connectivity", "spokes", "linked-router-appliances", "update")]
public record GcloudNetworkConnectivitySpokesLinkedRouterAppliancesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update     a Router appliance spoke
    /// </summary>
    ...
    public GcloudNetworkConnectivitySpokesLinkedRouterAppliancesUpdateOptions(
        string Spoke
    )
    {
    ...
    public IEnumerable<string>? RouterAppliance { get; set; }
