...
public record GcloudArtifactsRepositoriesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy     binding to the IAM policy of an Artifact Registry repository
    /// </summary>
    ...
    public GcloudArtifactsRepositoriesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Repository
    )
