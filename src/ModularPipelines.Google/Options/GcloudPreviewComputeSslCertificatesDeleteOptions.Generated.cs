...
public record GcloudPreviewComputeSslCertificatesDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete Compute Engine SSL     certificates
    /// </summary>
    /// <param name="Name">Names of the SSL certificates to delete.</param>
    public GcloudPreviewComputeSslCertificatesDeleteOptions(
