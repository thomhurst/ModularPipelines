...
public record GcloudResourceManagerTagsValuesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// adds a policy     binding to the IAM policy of a TagValue
    /// </summary>
    ...
    public GcloudResourceManagerTagsValuesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string ResourceName
    )
