...
public record GcloudMetastoreServicesCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Encryption configuration for the metastore service. Information used to configure the Hive metastore service as a service principal in a Kerberos realm. The one hour maintenance window that specifies when Dataproc Metastore may perform system maintenance operation to the service, in UTC time. Network configuration for the metastore service. At most one of these can be specified: The name of the network on which the service can be accessed. This can be the network's ID, fully-qualified URL, or relative name in the form projects/{project_id}/global/networks/{network}. If "network", "consumer-subnetworks" and "network-config" are unspecified, the "default" network will be used.
    /// </summary>
    [CliOption("--network", Format = OptionFormat.EqualsSeparated)]
    public string? Network { get; set; }

    /// <summary>
    /// Encryption configuration for the metastore service. Information used to configure the Hive metastore service as a service principal in a Kerberos realm. The one hour maintenance window that specifies when Dataproc Metastore may perform system maintenance operation to the service, in UTC time. Network configuration for the metastore service. At most one of these can be specified: Path to a YAML file containing the network configuration for Dataproc Metastore instance. The contents of the file should be structured as follows: YAML: consumers: ▸ subnetwork: projects/{project_id}/regions/{region_id}/subnetworks/{subnetwork_id} ▸ subnetwork: projects/{project_id}/regions/{region_id}/subnetworks/{subnetwork_id} ...
    /// </summary>
    [CliOption("--network-config-from-file", Format = OptionFormat.EqualsSeparated)]
    public string? NetworkConfigFromFile { get; set; }

    /// <summary>
    /// Encryption configuration for the metastore service. Information used to configure the Hive metastore service as a service principal in a Kerberos realm. The one hour maintenance window that specifies when Dataproc Metastore may perform system maintenance operation to the service, in UTC time. Configuration properties specific to running Hive metastore software as the metastore service. At most one of these can be specified: A mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore.
    /// </summary>
    ...
    /// <summary>
    /// Encryption configuration for the metastore service. Information used to configure the Hive metastore service as a service principal in a Kerberos realm. The one hour maintenance window that specifies when Dataproc Metastore may perform system maintenance operation to the service, in UTC time. A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center. This is a Secret Manager secret version, and can be fully-qualified URL, or relative name in the form projects/{project_id}/secrets/{secret_id}/versions/{version_id}. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
