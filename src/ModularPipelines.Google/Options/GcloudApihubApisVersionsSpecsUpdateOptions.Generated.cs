...
public record GcloudApihubApisVersionsSpecsUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// LintResponse contains the response from the linter. Timestamp when the linting response was generated.
    /// </summary>
    [CliOption("--lint-response-create-time", Format = OptionFormat.EqualsSeparated)]
    public string? LintResponseCreateTime { get; set; }

    /// <summary>
    /// LintResponse contains the response from the linter. Name of the linter used. LINT_RESPONSE_LINTER must be one of: other Linter type other. spectral Linter type spectral.
    /// </summary>
    [CliOption("--lint-response-linter", Format = OptionFormat.EqualsSeparated)]
    public string? LintResponseLinter { get; set; }

    /// <summary>
    /// LintResponse contains the response from the linter. Name of the linting application.
    /// </summary>
    [CliOption("--lint-response-source", Format = OptionFormat.EqualsSeparated)]
    public string? LintResponseSource { get; set; }

    /// <summary>
    /// LintResponse contains the response from the linter. Lint state represents success or failure for linting. LINT_RESPONSE_STATE must be one of: lint-state-error Linting encountered errors. lint-state-success Linting was completed successfully.
    /// </summary>
    ...
    /// <summary>
    /// The attribute values associated with resource. Arguments for the Value. At most one of these can be specified: The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type enum. Update spec_type_enum_values. At most one of these can be specified: Set spec_type_enum_values to new value. The attribute values in case attribute data type is enum. description The detailed description of the allowed value. displayName The display name of the allowed value. id The ID of the allowed value. ◇ If provided, the same will be used. The service will throw an error if the specified id is already used by another allowed value in the same attribute resource. ◇ If not provided, a system generated id derived from the display name will be used. In this case, the service will handle conflict resolution by adding a system generated suffix in case of duplicates. This value should be 4-63 characters, and valid characters are /[a-z][0-9]-/. immutable When set to true, the allowed value cannot be updated or deleted by the user. It can only be true for System defined attributes. Shorthand Example: --spec-type-enum-values=description=string,displayName=string,id=string,immutable=boolean --spec-type-enum-values=description=string,displayName=string,id=string,immutable=boolean JSON Example: --spec-type-enum-values='[{"description": "string", "displayName": "string", "id": "string", "immutable": boolean}]' File Example: --spec-type-enum-values=path_to_file.(yaml|json)
    /// </summary>
    [CliOption("--spec-type-enum-values", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? SpecTypeEnumValues { get; set; }

    /// <summary>
    /// The attribute values associated with resource. Arguments for the Value. At most one of these can be specified: The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type enum. Update spec_type_enum_values. At most one of these can be specified: Or at least one of these can be specified: Add new value to spec_type_enum_values list. The attribute values in case attribute data type is enum. description The detailed description of the allowed value. displayName The display name of the allowed value. id The ID of the allowed value. ▹ If provided, the same will be used. The service will throw an error if the specified id is already used by another allowed value in the same attribute resource. ▹ If not provided, a system generated id derived from the display name will be used. In this case, the service will handle conflict resolution by adding a system generated suffix in case of duplicates. This value should be 4-63 characters, and valid characters are /[a-z][0-9]-/. immutable When set to true, the allowed value cannot be updated or deleted by the user. It can only be true for System defined attributes. Shorthand Example: --add-spec-type-enum-values=description=string,displayName=string,id=string,immutable=boolean --add-spec-type-enum-values=description=string,displayName=string,id=string,immutable=boolean JSON Example: --add-spec-type-enum-values='[{"description": "string", "displayName": "string", "id": "string", "immutable": boolean}]' File Example: --add-spec-type-enum-values=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// The attribute values associated with resource. Arguments for the Value. At most one of these can be specified: The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type enum. Update spec_type_enum_values. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear spec_type_enum_values value and set to empty list.
    /// </summary>
    [CliFlag("--clear-spec-type-enum-values")]
    public bool? ClearSpecTypeEnumValues { get; set; }

    /// <summary>
    /// The attribute values associated with resource. Arguments for the Value. At most one of these can be specified: The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type string or JSON. The attribute values of data type enum. Update spec_type_enum_values. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from spec_type_enum_values list. The attribute values in case attribute data type is enum. description The detailed description of the allowed value. displayName The display name of the allowed value. id The ID of the allowed value. ▪ If provided, the same will be used. The service will throw an error if the specified id is already used by another allowed value in the same attribute resource. ▪ If not provided, a system generated id derived from the display name will be used. In this case, the service will handle conflict resolution by adding a system generated suffix in case of duplicates. This value should be 4-63 characters, and valid characters are /[a-z][0-9]-/. immutable When set to true, the allowed value cannot be updated or deleted by the user. It can only be true for System defined attributes. Shorthand Example: --remove-spec-type-enum-values=description=string,displayName=string,id=string,immutable=boolean --remove-spec-type-enum-values=description=string,displayName=string,id=string,immutable=boolean JSON Example: --remove-spec-type-enum-values='[{"description": "string", "displayName": "string", "id": "string", "immutable": boolean}]' File Example: --remove-spec-type-enum-values=path_to_file.(yaml|json)
    /// </summary>
