...
public record GcloudApihubApisVersionsSpecsUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// The spec contents. Documentation details. LintResponse contains the response from the linter. Update lint_response_issues. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear lint_response_issues value and set to empty list.
    /// </summary>
    ...
    /// <summary>
    /// The spec contents. Documentation details. LintResponse contains the response from the linter. Update lint_response_summary. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Clear lint_response_summary value and set to empty list.
    /// </summary>
    [CliFlag("--clear-lint-response-summary")]
    public bool? ClearLintResponseSummary { get; set; }

    /// <summary>
    /// The spec contents. Documentation details. LintResponse contains the response from the linter. Update lint_response_summary. At most one of these can be specified: Or at least one of these can be specified: At most one of these can be specified: Remove existing value from lint_response_summary list. Summary of all issue types and counts for each severity level. count Count of issues with the given severity. severity Severity of the issue. Shorthand Example: --remove-lint-response-summary=count=int,severity=string --remove-lint-response-summary=count=int,severity=string JSON Example: --remove-lint-response-summary='[{"count": int, "severity": "string"}]' File Example: --remove-lint-response-summary=path_to_file.(yaml|json)
    /// </summary>
