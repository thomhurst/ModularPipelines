...
public record GcloudApihubApisVersionsOperationsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Arguments for the operation. At most one of these can be specified: The operation schema needed for an operation. Arguments for the value. The name of the tool, unique within its parent scope (version).
    /// </summary>
    ...
    /// <summary>
    /// Arguments for the operation. At most one of these can be specified: The operation schema needed for an operation. Arguments for the value. Optional title for the tool.
    /// </summary>
    [CliOption("--mcp-tool-title", Format = OptionFormat.EqualsSeparated)]
    public string? McpToolTitle { get; set; }

    /// <summary>
    /// Arguments for the operation. At most one of these can be specified: Annotations for a Tool. Arguments for the destructive hint. Hint indicating if the tool may have destructive side effects. Use --mcp-tool-annotations-destructive-hint to enable and --no-mcp-tool-annotations-destructive-hint to disable.
    /// </summary>
    [CliFlag("--mcp-tool-annotations-destructive-hint")]
    public bool? McpToolAnnotationsDestructiveHint { get; set; }

    /// <summary>
    /// Negates --mcp-tool-annotations-destructive-hint. Arguments for the operation. At most one of these can be specified: Annotations for a Tool. Arguments for the destructive hint. Hint indicating if the tool may have destructive side effects. Use --mcp-tool-annotations-destructive-hint to enable and --no-mcp-tool-annotations-destructive-hint to disable.
    /// </summary>
    [CliFlag("--no-mcp-tool-annotations-destructive-hint")]
    public bool? NoMcpToolAnnotationsDestructiveHint { get; set; }

    /// <summary>
    /// Arguments for the operation. At most one of these can be specified: Arguments for the idempotent hint. Hint indicating if the tool is idempotent. Use --mcp-tool-annotations-idempotent-hint to enable and --no-mcp-tool-annotations-idempotent-hint to disable.
    /// </summary>
    [CliFlag("--mcp-tool-annotations-idempotent-hint")]
    public bool? McpToolAnnotationsIdempotentHint { get; set; }

    /// <summary>
    /// Negates --mcp-tool-annotations-idempotent-hint. Arguments for the operation. At most one of these can be specified: Arguments for the idempotent hint. Hint indicating if the tool is idempotent. Use --mcp-tool-annotations-idempotent-hint to enable and --no-mcp-tool-annotations-idempotent-hint to disable.
    /// </summary>
    [CliFlag("--no-mcp-tool-annotations-idempotent-hint")]
    public bool? NoMcpToolAnnotationsIdempotentHint { get; set; }

    /// <summary>
    /// Arguments for the operation. At most one of these can be specified: Arguments for the open world hint. Hint indicating if the tool interacts with the open world (e.g., internet). Use --mcp-tool-annotations-open-world-hint to enable and --no-mcp-tool-annotations-open-world-hint to disable.
    /// </summary>
    [CliFlag("--mcp-tool-annotations-open-world-hint")]
    public bool? McpToolAnnotationsOpenWorldHint { get; set; }

    /// <summary>
    /// Negates --mcp-tool-annotations-open-world-hint. Arguments for the operation. At most one of these can be specified: Arguments for the open world hint. Hint indicating if the tool interacts with the open world (e.g., internet). Use --mcp-tool-annotations-open-world-hint to enable and --no-mcp-tool-annotations-open-world-hint to disable.
    /// </summary>
    [CliFlag("--no-mcp-tool-annotations-open-world-hint")]
    public bool? NoMcpToolAnnotationsOpenWorldHint { get; set; }

    /// <summary>
    /// Arguments for the operation. At most one of these can be specified: Arguments for the read only hint. Hint indicating if the tool is read-only. Use --mcp-tool-annotations-read-only-hint to enable and --no-mcp-tool-annotations-read-only-hint to disable.
    /// </summary>
    [CliFlag("--mcp-tool-annotations-read-only-hint")]
    public bool? McpToolAnnotationsReadOnlyHint { get; set; }

    /// <summary>
    /// Negates --mcp-tool-annotations-read-only-hint. Arguments for the operation. At most one of these can be specified: Arguments for the read only hint. Hint indicating if the tool is read-only. Use --mcp-tool-annotations-read-only-hint to enable and --no-mcp-tool-annotations-read-only-hint to disable.
    /// </summary>
