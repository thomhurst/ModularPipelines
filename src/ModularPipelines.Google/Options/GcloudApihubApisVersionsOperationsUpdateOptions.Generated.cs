...
public record GcloudApihubApisVersionsOperationsUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Negates --details-deprecated. For OpenAPI spec, this will be set if operation.deprecated`is marked as true in the spec. Use *--details-deprecated* to enable and *--no-details-deprecated* to disable.
    /// </summary>
