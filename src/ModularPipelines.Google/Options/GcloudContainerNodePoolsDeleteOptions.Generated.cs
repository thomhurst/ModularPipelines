...
public record GcloudContainerNodePoolsDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete an existing node pool in a     running cluster
    /// </summary>
    /// <param name="Name">The name of the node pool to delete.</param>
    public GcloudContainerNodePoolsDeleteOptions(
        string Name
    )
    {
