...
public record GcloudContainerFleetMeshUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    {
        if ((!string.IsNullOrWhiteSpace(FleetDefaultMemberConfig) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(Origin) || (object?)ConfigApi is not null || (object?)ControlPlane is not null || (object?)Management is not null || ((object?)Memberships is global::System.Collections.Generic.IEnumerable<char> ? (object?)Memberships is not string || !string.IsNullOrWhiteSpace(Memberships?.ToString()) : ((object?)Memberships is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Memberships, static item => item is not null) : (Memberships is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Memberships), static item => item is not null)))) || !string.IsNullOrWhiteSpace(Location)) ? 1 : 0) != 1)
        {
            yield return new ValidationResult("Exactly one of FleetDefaultMemberConfig or (Origin, ConfigApi, ControlPlane, Management, Memberships, or Location) must be specified.", [nameof(FleetDefaultMemberConfig), nameof(Origin), nameof(ConfigApi), nameof(ControlPlane), nameof(Management), nameof(Memberships), nameof(Location)]);
        }
        if ((!string.IsNullOrWhiteSpace(FleetDefaultMemberConfig) || !string.IsNullOrWhiteSpace(Origin) || (object?)ConfigApi is not null || (object?)ControlPlane is not null || (object?)Management is not null || ((object?)Memberships is global::System.Collections.Generic.IEnumerable<char> ? (object?)Memberships is not string || !string.IsNullOrWhiteSpace(Memberships?.ToString()) : ((object?)Memberships is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Memberships, static item => item is not null) : (Memberships is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Memberships), static item => item is not null)))) || !string.IsNullOrWhiteSpace(Location)) && (!string.IsNullOrWhiteSpace(Origin) || (object?)ConfigApi is not null || (object?)ControlPlane is not null || (object?)Management is not null || ((object?)Memberships is global::System.Collections.Generic.IEnumerable<char> ? (object?)Memberships is not string || !string.IsNullOrWhiteSpace(Memberships?.ToString()) : ((object?)Memberships is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)Memberships, static item => item is not null) : (Memberships is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)Memberships), static item => item is not null)))) || !string.IsNullOrWhiteSpace(Location)) && (!string.IsNullOrWhiteSpace(Origin) || (object?)ConfigApi is not null || (object?)ControlPlane is not null || (object?)Management is not null) && (((object?)ConfigApi is not null ? 1 : 0) + ((object?)ControlPlane is not null ? 1 : 0) + ((object?)Management is not null ? 1 : 0) > 1))
        {
