...
public record GcloudPubsubSubscriptionsCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// creates one or more Cloud Pub/Sub     subscriptions
    /// </summary>
    ...
    public void Deconstruct(out string Topic, out IEnumerable<string> Subscription)
    {
        Topic = this.Topic;
    ...
    /// <summary>
    /// Negates --enable-message-ordering. Whether to receive messages with the same ordering key in order. If set, messages with the same ordering key are sent to subscribers in the order that Pub/Sub receives them. Use --no-enable-message-ordering to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Expression to filter messages. If set, Pub/Sub only delivers the messages that match the filter. The expression must be a non-empty string in the Pub/Sub filtering language (https://cloud.google.com/pubsub/docs/filtering).
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. A BigQuery table of the form {project}:{dataset_name}.{table_name} to which to write messages for this subscription. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--bigquery-table", Format = OptionFormat.EqualsSeparated)]
    public string? BigqueryTable { get; set; }

    /// <summary>
    /// At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. The service account email to use when writing to BigQuery. If unspecified, uses the Pub/Sub service agent (https://cloud.google.com/iam/docs/service-account-types#service-agents).
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. If either --use-topic-schema or --use-table-schema is set, whether or not to ignore fields in the message that do not appear in the BigQuery table schema. Use --no-drop-unknown-fields to disable this flag.
    /// </summary>
    [CliFlag("--drop-unknown-fields")]
    public bool? DropUnknownFields { get; set; }

    /// <summary>
    /// Negates --drop-unknown-fields. At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. If either --use-topic-schema or --use-table-schema is set, whether or not to ignore fields in the message that do not appear in the BigQuery table schema. Use --no-drop-unknown-fields to disable this flag.
    /// </summary>
    [CliFlag("--no-drop-unknown-fields")]
    public bool? NoDropUnknownFields { get; set; }

    /// <summary>
    /// At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. Whether or not to write message metadata including message ID, publish timestamp, ordering key, and attributes to BigQuery. The subscription name, message_id, and publish_time fields are put in their own columns while all other message properties other than data (for example, an ordering_key, if present) are written to a JSON object in the attributes column. Use --no-write-metadata to disable this flag.
    /// </summary>
    [CliFlag("--write-metadata")]
    public bool? WriteMetadata { get; set; }

    /// <summary>
    /// Negates --write-metadata. At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. Whether or not to write message metadata including message ID, publish timestamp, ordering key, and attributes to BigQuery. The subscription name, message_id, and publish_time fields are put in their own columns while all other message properties other than data (for example, an ordering_key, if present) are written to a JSON object in the attributes column. Use --no-write-metadata to disable this flag.
    /// </summary>
    [CliFlag("--no-write-metadata")]
    public bool? NoWriteMetadata { get; set; }

    /// <summary>
    /// At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. At most one of these can be specified: Whether or not to use the BigQuery table schema when writing messages to BigQuery. Use --no-use-table-schema to disable this flag.
    /// </summary>
    [CliFlag("--use-table-schema")]
    public bool? UseTableSchema { get; set; }

    /// <summary>
    /// Negates --use-table-schema. At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. At most one of these can be specified: Whether or not to use the BigQuery table schema when writing messages to BigQuery. Use --no-use-table-schema to disable this flag.
    /// </summary>
    [CliFlag("--no-use-table-schema")]
    public bool? NoUseTableSchema { get; set; }

    /// <summary>
    /// At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. At most one of these can be specified: Whether or not to use the schema for the subscription's topic (if it exists) when writing messages to BigQuery. If --drop-unknown-fields is not set, then the BigQuery schema must contain all fields that are present in the topic schema. Use --no-use-topic-schema to disable this flag.
    /// </summary>
    [CliFlag("--use-topic-schema")]
    public bool? UseTopicSchema { get; set; }

    /// <summary>
    /// Negates --use-topic-schema. At most one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. At most one of these can be specified: Whether or not to use the schema for the subscription's topic (if it exists) when writing messages to BigQuery. If --drop-unknown-fields is not set, then the BigQuery schema must contain all fields that are present in the topic schema. Use --no-use-topic-schema to disable this flag.
    /// </summary>
    ...
    public GcloudPubsubSubscriptionsCreateCloudStorageOutputFormat? CloudStorageOutputFormat { get; set; }
    ...
    /// <summary>
    /// Negates --push-no-wrapper. Dead letter topic resource - Name of the topic to publish dead letter messages to. The arguments in this group can be used to specify the attributes of this resource. Retry Policy Options. Retry policy specifies how Cloud Pub/Sub retries message delivery for this subscription. Push Config Options. Configuration for a push delivery endpoint. NoWrapper Config Options. When set, the message data is delivered directly as the HTTP body. Use --no-push-no-wrapper to disable this flag. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    /// <summary>
    /// Negates --push-no-wrapper-write-metadata. Dead letter topic resource - Name of the topic to publish dead letter messages to. The arguments in this group can be used to specify the attributes of this resource. Retry Policy Options. Retry policy specifies how Cloud Pub/Sub retries message delivery for this subscription. Push Config Options. Configuration for a push delivery endpoint. NoWrapper Config Options. When true, writes the Pub/Sub message metadata to x-goog-pubsub-&lt;KEY&gt;:&lt;VAL&gt; headers of the HTTP request. Writes the Pub/Sub message attributes to &lt;KEY&gt;:&lt;VAL&gt; headers of the HTTP request. Use --no-push-no-wrapper-write-metadata to disable this flag.
    /// </summary>
    [CliFlag("--no-push-no-wrapper-write-metadata")]
    public bool? NoPushNoWrapperWriteMetadata { get; set; }

    /// <summary>
    /// Subscription resource - One or more subscriptions to create. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument subscription on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. IDs of the subscriptions or fully qualified identifiers for the subscriptions. To set the subscription attribute: ▸ provide the argument subscription on the command line.
    /// </summary>
    ...
    {
        if (((!string.IsNullOrWhiteSpace(BigqueryTable) || !string.IsNullOrWhiteSpace(BigqueryServiceAccountEmail) || UseTableSchema == true || NoUseTableSchema == true || UseTopicSchema == true || NoUseTopicSchema == true || DropUnknownFields == true || NoDropUnknownFields == true || WriteMetadata == true || NoWriteMetadata == true) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(CloudStorageBucket) || !string.IsNullOrWhiteSpace(CloudStorageFileDatetimeFormat) || !string.IsNullOrWhiteSpace(CloudStorageFilePrefix) || !string.IsNullOrWhiteSpace(CloudStorageFileSuffix) || !string.IsNullOrWhiteSpace(CloudStorageMaxBytes) || !string.IsNullOrWhiteSpace(CloudStorageMaxDuration) || !string.IsNullOrWhiteSpace(CloudStorageMaxMessages) || (object?)CloudStorageOutputFormat is not null || !string.IsNullOrWhiteSpace(CloudStorageServiceAccountEmail) || CloudStorageUseTopicSchema == true || NoCloudStorageUseTopicSchema == true || CloudStorageWriteMetadata == true || NoCloudStorageWriteMetadata == true) ? 1 : 0) > 1)
        {
            yield return new ValidationResult("At most one of (BigqueryTable, BigqueryServiceAccountEmail, UseTableSchema, NoUseTableSchema, UseTopicSchema, NoUseTopicSchema, DropUnknownFields, NoDropUnknownFields, WriteMetadata, or NoWriteMetadata) or (CloudStorageBucket, CloudStorageFileDatetimeFormat, CloudStorageFilePrefix, CloudStorageFileSuffix, CloudStorageMaxBytes, CloudStorageMaxDuration, CloudStorageMaxMessages, CloudStorageOutputFormat, CloudStorageServiceAccountEmail, CloudStorageUseTopicSchema, NoCloudStorageUseTopicSchema, CloudStorageWriteMetadata, or NoCloudStorageWriteMetadata) may be specified.", [nameof(BigqueryTable), nameof(BigqueryServiceAccountEmail), nameof(UseTableSchema), nameof(NoUseTableSchema), nameof(UseTopicSchema), nameof(NoUseTopicSchema), nameof(DropUnknownFields), nameof(NoDropUnknownFields), nameof(WriteMetadata), nameof(NoWriteMetadata), nameof(CloudStorageBucket), nameof(CloudStorageFileDatetimeFormat), nameof(CloudStorageFilePrefix), nameof(CloudStorageFileSuffix), nameof(CloudStorageMaxBytes), nameof(CloudStorageMaxDuration), nameof(CloudStorageMaxMessages), nameof(CloudStorageOutputFormat), nameof(CloudStorageServiceAccountEmail), nameof(CloudStorageUseTopicSchema), nameof(NoCloudStorageUseTopicSchema), nameof(CloudStorageWriteMetadata), nameof(NoCloudStorageWriteMetadata)]);
        }
        if ((!string.IsNullOrWhiteSpace(BigqueryTable) || !string.IsNullOrWhiteSpace(BigqueryServiceAccountEmail) || UseTableSchema == true || NoUseTableSchema == true || UseTopicSchema == true || NoUseTopicSchema == true || DropUnknownFields == true || NoDropUnknownFields == true || WriteMetadata == true || NoWriteMetadata == true || !string.IsNullOrWhiteSpace(CloudStorageBucket) || !string.IsNullOrWhiteSpace(CloudStorageFileDatetimeFormat) || !string.IsNullOrWhiteSpace(CloudStorageFilePrefix) || !string.IsNullOrWhiteSpace(CloudStorageFileSuffix) || !string.IsNullOrWhiteSpace(CloudStorageMaxBytes) || !string.IsNullOrWhiteSpace(CloudStorageMaxDuration) || !string.IsNullOrWhiteSpace(CloudStorageMaxMessages) || (object?)CloudStorageOutputFormat is not null || !string.IsNullOrWhiteSpace(CloudStorageServiceAccountEmail) || CloudStorageUseTopicSchema == true || NoCloudStorageUseTopicSchema == true || CloudStorageWriteMetadata == true || NoCloudStorageWriteMetadata == true) && (!string.IsNullOrWhiteSpace(BigqueryTable) || !string.IsNullOrWhiteSpace(BigqueryServiceAccountEmail) || UseTableSchema == true || NoUseTableSchema == true || UseTopicSchema == true || NoUseTopicSchema == true || DropUnknownFields == true || NoDropUnknownFields == true || WriteMetadata == true || NoWriteMetadata == true) && (!(!string.IsNullOrWhiteSpace(BigqueryTable))))
        {
