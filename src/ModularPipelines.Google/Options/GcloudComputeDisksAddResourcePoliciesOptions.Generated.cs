...
public record GcloudComputeDisksAddResourcePoliciesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add resource policies to a     Compute Engine disk
    /// </summary>
    /// <param name="ResourcePolicies">A list of resource policy names to be added to the disk. The policies must exist in the same region as the disk. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="DiskName">Name of the disk to add resource policies to.</param>
    public GcloudComputeDisksAddResourcePoliciesOptions(
