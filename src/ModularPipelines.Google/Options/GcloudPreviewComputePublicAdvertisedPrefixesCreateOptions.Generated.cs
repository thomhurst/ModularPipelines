...
public record GcloudPreviewComputePublicAdvertisedPrefixesCreateOptions : GcloudOptions
{
    /// <summary>
    /// creates a     Compute Engine public advertised prefix
    /// </summary>
    ...
    public GcloudPreviewComputePublicAdvertisedPrefixesCreateOptions(
        string Range,
        string Name
    )
    {
    ...
    public GcloudPreviewComputePublicAdvertisedPrefixesCreateIpv6AccessType? Ipv6AccessType { get; set; }
    ...
    public GcloudPreviewComputePublicAdvertisedPrefixesCreatePdpScope? PdpScope { get; set; }
