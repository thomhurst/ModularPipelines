...
public record GcloudComposerEnvironmentsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Private Clusters Environment cluster is managed using the private IP address of the master API endpoint. Therefore access to the master endpoint must be from internal IP addresses. If not specified, the master API endpoint will be accessible by its public IP address. Cannot be specified unless --enable-private-environment is also specified.
    /// </summary>
    [CliFlag("--enable-private-endpoint")]
    public bool? EnablePrivateEndpoint { get; set; }

    /// <summary>
    /// Private Clusters Disables internet connection from any Composer component. When used with Composer 2, the environment cluster is created with no public IP addresses on the cluster nodes. If not specified, cluster nodes will be assigned public IP addresses. When used with Composer 1.x, cannot be specified unless --enable-ip-alias is also specified.
    /// </summary>
    [CliFlag("--enable-private-environment")]
    public bool? EnablePrivateEnvironment { get; set; }

    /// <summary>
    /// Private Clusters When enabled GKE pods and services may use public(non-RFC1918) IP ranges privately. The ranges are specified by '--cluster-ipv4-cidr' and --services-ipv4-cidr flags. Cannot be specified unless --enable-private-environment is also specified.
    /// </summary>
    [CliFlag("--enable-privately-used-public-ips")]
    public bool? EnablePrivatelyUsedPublicIps { get; set; }

    /// <summary>
    /// Private Clusters IPv4 CIDR range to use for the cluster master network. This should have a size of the netmask between 23 and 28. Cannot be specified unless --enable-private-environment is also specified.
    /// </summary>
    [CliOption("--master-ipv4-cidr", Format = OptionFormat.EqualsSeparated)]
    public string? MasterIpv4Cidr { get; set; }

    /// <summary>
    /// Private Clusters IPv4 CIDR range to use for the Airflow web server network. This should have a size of the netmask between 24 and 29. Cannot be specified unless --enable-private-environment is also specified.
    /// </summary>
    [CliOption("--web-server-ipv4-cidr", Format = OptionFormat.EqualsSeparated)]
    public string? WebServerIpv4Cidr { get; set; }

    /// <summary>
    /// IP Alias (VPC-native) IP address range for the pods in this cluster in CIDR notation (e.g. 10.0.0.0/14). When used with Composer 1.x, cannot be specified unless --enable-ip-alias is also specified.
    /// </summary>
    [CliOption("--cluster-ipv4-cidr", Format = OptionFormat.EqualsSeparated)]
    public string? ClusterIpv4Cidr { get; set; }

    /// <summary>
    /// IP Alias (VPC-native) Secondary range to be used as the source for pod IPs. Alias ranges will be allocated from this secondary range. NAME must be the name of an existing secondary range in the cluster subnetwork. When used with Composer 1.x, cannot be specified unless --enable-ip-alias is also specified.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Disable Cloud Data Lineage integration, supported for Composer 2 Environments.
    /// </summary>
    [CliFlag("--disable-cloud-data-lineage-integration")]
    public bool? DisableCloudDataLineageIntegration { get; set; }

    /// <summary>
    /// At most one of these can be specified: Enable Cloud Data Lineage integration, supported for Composer 2 Environments.
    /// </summary>
    [CliFlag("--enable-cloud-data-lineage-integration")]
    public bool? EnableCloudDataLineageIntegration { get; set; }

    /// <summary>
    /// At most one of these can be specified: Builds performed during operations that install Python packages have an access to the internet, supported in Composer 3 or greater.
    /// </summary>
    [CliFlag("--disable-private-builds-only")]
    public bool? DisablePrivateBuildsOnly { get; set; }

    /// <summary>
    /// At most one of these can be specified: Builds performed during operations that install Python packages have only private connectivity to Google services, supported in Composer 3 or greater.
    /// </summary>
    ...
    /// <summary>
    /// Group of arguments for setting scheduled snapshots settings in Composer 2.0.32 or greater. When specified, snapshots of the environment will be created according to a schedule. Can be specified for Composer 2.0.32 or greater. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliFlag("--enable-scheduled-snapshot-creation")]
    public bool? EnableScheduledSnapshotCreation { get; set; }

    /// <summary>
    /// Group of arguments for setting scheduled snapshots settings in Composer 2.0.32 or greater. Cron expression specifying when snapshots of the environment should be created. Can be specified for Composer 2.0.32 or greater. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--snapshot-creation-schedule", Format = OptionFormat.EqualsSeparated)]
    public string? SnapshotCreationSchedule { get; set; }

    /// <summary>
    /// Group of arguments for setting scheduled snapshots settings in Composer 2.0.32 or greater. The Cloud Storage location for storing automatically created snapshots. Can be specified for Composer 2.0.32 or greater. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--snapshot-location", Format = OptionFormat.EqualsSeparated)]
    public string? SnapshotLocation { get; set; }

    /// <summary>
    /// Group of arguments for setting scheduled snapshots settings in Composer 2.0.32 or greater. Timezone that sets the context to interpret snapshot_creation_schedule. Can be specified for Composer 2.0.32 or greater. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--snapshot-schedule-timezone", Format = OptionFormat.EqualsSeparated)]
    public string? SnapshotScheduleTimezone { get; set; }

    /// <summary>
    /// Group of arguments for setting triggerer settings in Composer 2.0.31 or greater. (DEPRECATED) Enable use of a triggerer, supported in the Environments with Composer 2.0.31 and Airflow 2.2.5 and greater. This flag is deprecated. Use --triggerer-count instead.
    /// </summary>
    [CliFlag("--enable-triggerer")]
    public bool? EnableTriggerer { get; set; }

    /// <summary>
    /// Group of arguments for setting triggerer settings in Composer 2.0.31 or greater. Number of triggerers, supported in the Environments with Composer 2.0.31 and Airflow 2.2.5 and greater.
    /// </summary>
    [CliOption("--triggerer-count", Format = OptionFormat.EqualsSeparated)]
    public int? TriggererCount { get; set; }

    /// <summary>
    /// Group of arguments for setting triggerer settings in Composer 2.0.31 or greater. CPU allocated to Airflow triggerer. Supported in the Environments with Composer 2.0.31 and Airflow 2.2.5 and greater.
    /// </summary>
    [CliOption("--triggerer-cpu", Format = OptionFormat.EqualsSeparated)]
    public string? TriggererCpu { get; set; }

    /// <summary>
    /// Group of arguments for setting triggerer settings in Composer 2.0.31 or greater. Memory allocated to Airflow triggerer, ex. 512MB, 3GB, 2. If units are not provided, defaults to GB. Supported in the Environments with Composer 2.0.31 and Airflow 2.2.5 and greater.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Allows all IP addresses to access the Airflow web server.
    /// </summary>
    ...
    /// <summary>
    /// At most one of these can be specified: Denies all incoming traffic to the Airflow web server.
    /// </summary>
