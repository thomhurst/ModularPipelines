...
public record GcloudComputeSnapshotsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute Engine snapshot
    /// </summary>
    /// <param name="SnapshotName">Name of the snapshot to update.</param>
    public GcloudComputeSnapshotsUpdateOptions(
        string SnapshotName
    )
    {
