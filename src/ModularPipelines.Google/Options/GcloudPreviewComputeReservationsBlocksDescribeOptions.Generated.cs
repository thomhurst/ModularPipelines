...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/reservations/blocks/describe
...
[CliSubCommand("preview", "compute", "reservations", "blocks", "describe")]
public record GcloudPreviewComputeReservationsBlocksDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a Compute     Engine reservation block
    /// </summary>
    ...
    public GcloudPreviewComputeReservationsBlocksDescribeOptions(
        string BlockName,
        string Reservation
    )
    {
