...
public record GcloudPreviewComputePreviewFeaturesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a preview feature's     activation status
    /// </summary>
    ...
    public GcloudPreviewComputePreviewFeaturesUpdateOptions(
        GcloudPreviewComputePreviewFeaturesUpdateActivationStatus ActivationStatus,
    ...
    public void Deconstruct(out GcloudPreviewComputePreviewFeaturesUpdateActivationStatus ActivationStatus, out string PreviewFeature)
    {
    ...
    public GcloudPreviewComputePreviewFeaturesUpdateActivationStatus ActivationStatus { get; private init; }
    ...
    public GcloudPreviewComputePreviewFeaturesUpdateRolloutPlan? RolloutPlan { get; set; }
