...
public record GcloudAppFirewallRulesCreateOptions : GcloudOptions
{
    ...
    public GcloudAppFirewallRulesCreateOptions(
        GcloudAppFirewallRulesCreateAction Action,
        string SourceRange,
        string Priority
    )
    {
    ...
    public void Deconstruct(out GcloudAppFirewallRulesCreateAction Action, out string SourceRange, out string Priority)
    {
        Action = this.Action;
    ...
    public GcloudAppFirewallRulesCreateAction Action { get; private init; }
