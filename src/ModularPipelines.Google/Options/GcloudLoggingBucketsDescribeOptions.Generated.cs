...
public record GcloudLoggingBucketsDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// display information about a bucket
    /// </summary>
    /// <param name="Location">Location of the bucket.</param>
    /// <param name="BucketId">The id of the bucket to describe.</param>
    public GcloudLoggingBucketsDescribeOptions(
        string Location,
        string BucketId
    )
    {
