...
public record GcloudIamWorkloadIdentityPoolsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM     policy binding from a workload identity pool
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string WorkloadIdentityPool)
    {
        Member = this.Member;
        Role = this.Role;
