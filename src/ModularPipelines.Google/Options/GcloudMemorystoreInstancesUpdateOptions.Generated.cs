...
public record GcloudMemorystoreInstancesUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// For resources [instance, acl-policy, kms-key, primary-instance],     provides fallback value for resource location attribute. When the     resource's full URI path is not provided, location will fallback to     this flag value.    Arguments for the maintenance version.
    /// </summary>
