...
{
    /// <summary>
    /// Return immediately, without waiting for the operation in progress to     complete.    Arguments for the async instance endpoints deletion enabled.
    /// </summary>
    [CliFlag("--async")]
    ...
    /// <summary>
    /// For resources [instance, kms-key, primary-instance], provides fallback     value for resource location attribute. When the resource's full URI     path is not provided, location will fallback to this flag value.    Arguments for the maintenance version.
    /// </summary>
    ...
    /// <summary>
    /// Machine type for individual nodes of the instance. NODE_TYPE must be     one of:      highmem-medium       High memory medium.     highmem-xlarge       High memory extra large.     shared-core-nano       Shared core nano.     standard-small       Standard small.    Arguments for the ondemand maintenance.
    /// </summary>
    ...
    /// <summary>
    /// Current persistence mode. PERSISTENCE_CONFIG_MODE must be one of:      aof       AOF based persistence is enabled.     disabled       Persistence is disabled, and any snapshot data is deleted.     rdb       RDB based persistence is enabled.    Configuration for RDB based persistence.
    /// </summary>
    ...
    /// <summary>
    /// Time that the first snapshot was/will be attempted, and to which future     snapshots will be aligned. If not provided, the current time will be     used.    The automated backup config for an instance.
    /// </summary>
    ...
    /// <summary>
    /// Set instance.automatedBackupConfig back to default value.    Arguments for the schedule.    This schedule allows the backup to be triggered at a fixed frequency   (currently only daily is supported).    Represents a time of day. The date and time zone are either not   significant or are specified elsewhere. An API may choose to allow leap   seconds. Related types are [google.type.Date][google.type.Date] and   google.protobuf.Timestamp.
    /// </summary>
    ...
    /// <summary>
    /// Seconds of a minute. Must be greater than or equal to 0 and typically     must be less than or equal to 59. An API may allow the value 60 if it     allows leap-seconds.    Cross instance replication config.
    /// </summary>
