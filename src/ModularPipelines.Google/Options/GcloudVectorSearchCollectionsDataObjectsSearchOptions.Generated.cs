...
public record GcloudVectorSearchCollectionsDataObjectsSearchOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Output fields Search Hint At most one of these can be specified: If set to true, the search will use the system's default K-Nearest Neighbor (KNN) index engine. This flag is compatible only with Semantic Search and Vector Search.
    /// </summary>
    [CliFlag("--use-knn")]
