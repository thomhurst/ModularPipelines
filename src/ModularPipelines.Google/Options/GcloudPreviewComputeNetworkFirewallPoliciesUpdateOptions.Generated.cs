...
public record GcloudPreviewComputeNetworkFirewallPoliciesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Compute     Engine network firewall policy
    /// </summary>
    /// <param name="FirewallPolicy">name of the network firewall policy to update.</param>
    public GcloudPreviewComputeNetworkFirewallPoliciesUpdateOptions(
