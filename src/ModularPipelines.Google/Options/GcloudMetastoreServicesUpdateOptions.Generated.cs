...
public record GcloudMetastoreServicesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a Dataproc Metastore service
    /// </summary>
    ...
    public GcloudMetastoreServicesUpdateOptions(
        string Service
    )
    {
    ...
    /// <summary>
    /// Information used to configure the Hive metastore service as a service principal in a Kerberos realm. A Kerberos principal that exists in the KDC to authenticate as. A typical principal is of the form "primary/instance@REALM", but there is no exact format.
    /// </summary>
    [CliOption("--kerberos-principal", Format = OptionFormat.EqualsSeparated)]
    public string? KerberosPrincipal { get; set; }

    /// <summary>
    /// Information used to configure the Hive metastore service as a service principal in a Kerberos realm. A Kerberos keytab file that can be used to authenticate a service principal with a Kerberos Key Distribution Center. This is a Secret Manager secret version, and can be fully-qualified URL, or relative name in the form projects/{project_id}/secrets/{secret_id}/versions/{version_id}.
    /// </summary>
    [CliOption("--keytab", Format = OptionFormat.EqualsSeparated)]
    public string? Keytab { get; set; }

    /// <summary>
    /// Information used to configure the Hive metastore service as a service principal in a Kerberos realm. A Cloud Storage URI that specifies the path to a krb5.conf file. It is of the form gs://{bucket_name}/path/krb5.conf, although the file does not need to be named krb5.conf explicitly.
    /// </summary>
    ...
    public GcloudMetastoreServicesUpdateMaintenanceWindowDay? MaintenanceWindowDay { get; set; }
    ...
    public IEnumerable<string>? AddAuxiliaryVersions
    {
        get;
        set => field = value is { } values ? (object)values is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair> ? values : ((object)values is global::System.Collections.Generic.IEnumerable<char> ? values : ((object)values is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> keyValues ? new __AddAuxiliaryVersionsSnapshotKeyValue(values, default(global::System.Collections.Immutable.ImmutableArray<global::ModularPipelines.Models.KeyValue>).Equals((object)keyValues) ? global::System.Array.Empty<global::ModularPipelines.Models.KeyValue>() : keyValues) : (default(global::System.Collections.Immutable.ImmutableArray<string>).Equals((object)values) ? global::System.Array.Empty<string>() : global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(values))))) : default;
    }

    private sealed class __AddAuxiliaryVersionsSnapshotKeyValue(
        IEnumerable<string> source,
        global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> values)
        : IEnumerable<string>, global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>
    {
    ...
    /// <summary>
    /// The one hour maintenance window that specifies when Dataproc Metastore may perform system maintenance operation to the service, in UTC time. Configuration properties specific to running Hive metastore software as the metastore service. At most one of these can be specified: Or at least one of these can be specified: Modify the Hive metastore configuration properties by passing key-value pairs in through the flags. Comma-separated list of Hive metastore configurations. Each configuration has the form "NAME=VALUE". Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    [CliOption("--update-hive-metastore-configs", Format = OptionFormat.EqualsSeparated, CollectionSeparator = ",")]
    public IReadOnlyList<KeyValue>? UpdateHiveMetastoreConfigs
    {
        get;
    ...
    public IEnumerable<string>? RemoveHiveMetastoreConfigs
    {
        get;
        set => field = value is { } values ? (object)values is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair> ? values : ((object)values is global::System.Collections.Generic.IEnumerable<char> ? values : ((object)values is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> keyValues ? new __RemoveHiveMetastoreConfigsSnapshotKeyValue(values, default(global::System.Collections.Immutable.ImmutableArray<global::ModularPipelines.Models.KeyValue>).Equals((object)keyValues) ? global::System.Array.Empty<global::ModularPipelines.Models.KeyValue>() : keyValues) : (default(global::System.Collections.Immutable.ImmutableArray<string>).Equals((object)values) ? global::System.Array.Empty<string>() : global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(values))))) : default;
    }

    private sealed class __RemoveHiveMetastoreConfigsSnapshotKeyValue(
        IEnumerable<string> source,
        global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> values)
        : IEnumerable<string>, global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>
    {
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if (((object?)MaintenanceWindowDay is not null || !string.IsNullOrWhiteSpace(MaintenanceWindowHour) || !string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) || EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation) || !string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) || ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && (!((object?)MaintenanceWindowDay is not null)))
        {
        ...
        if (((object?)MaintenanceWindowDay is not null || !string.IsNullOrWhiteSpace(MaintenanceWindowHour) || !string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) || EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation) || !string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) || ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && (!(!string.IsNullOrWhiteSpace(MaintenanceWindowHour))))
        {
        ...
        if (((object?)MaintenanceWindowDay is not null || !string.IsNullOrWhiteSpace(MaintenanceWindowHour) || !string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) || EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation) || !string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) || ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && ((!string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) ? 1 : 0) + ((EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation)) ? 1 : 0) > 1))
        {
        ...
        if (((object?)MaintenanceWindowDay is not null || !string.IsNullOrWhiteSpace(MaintenanceWindowHour) || !string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) || EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation) || !string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) || ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && ((!string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) ? 1 : 0) + ((((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of UpdateAuxiliaryVersionsFromFile or (AddAuxiliaryVersions or ClearAuxiliaryVersions) may be specified.", [nameof(UpdateAuxiliaryVersionsFromFile), nameof(AddAuxiliaryVersions), nameof(ClearAuxiliaryVersions)]);
        }
        if (((object?)MaintenanceWindowDay is not null || !string.IsNullOrWhiteSpace(MaintenanceWindowHour) || !string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) || EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation) || !string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) || ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && ((!string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) ? 1 : 0) + ((((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of UpdateHiveMetastoreConfigsFromFile or (UpdateHiveMetastoreConfigs, ClearHiveMetastoreConfigs, or RemoveHiveMetastoreConfigs) may be specified.", [nameof(UpdateHiveMetastoreConfigsFromFile), nameof(UpdateHiveMetastoreConfigs), nameof(ClearHiveMetastoreConfigs), nameof(RemoveHiveMetastoreConfigs)]);
        }
        if (((object?)MaintenanceWindowDay is not null || !string.IsNullOrWhiteSpace(MaintenanceWindowHour) || !string.IsNullOrWhiteSpace(ScheduledBackupConfigsFromFile) || EnableScheduledBackup == true || !string.IsNullOrWhiteSpace(ScheduledBackupCron) || !string.IsNullOrWhiteSpace(ScheduledBackupLocation) || !string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) || ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && (!string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigsFromFile) || ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && (((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && (((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)UpdateHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(UpdateHiveMetastoreConfigs?.ToString()) : ((object?)UpdateHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)UpdateHiveMetastoreConfigs, static item => item is not null) : (UpdateHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)UpdateHiveMetastoreConfigs), static item => item is not null)))) || ClearHiveMetastoreConfigs == true || ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null))))) && ((ClearHiveMetastoreConfigs == true ? 1 : 0) + (((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<char> ? (object?)RemoveHiveMetastoreConfigs is not string || !string.IsNullOrWhiteSpace(RemoveHiveMetastoreConfigs?.ToString()) : ((object?)RemoveHiveMetastoreConfigs is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)RemoveHiveMetastoreConfigs, static item => item is not null) : (RemoveHiveMetastoreConfigs is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)RemoveHiveMetastoreConfigs), static item => item is not null)))) ? 1 : 0) > 1))
        {
            yield return new ValidationResult("At most one of ClearHiveMetastoreConfigs or RemoveHiveMetastoreConfigs may be specified.", [nameof(ClearHiveMetastoreConfigs), nameof(RemoveHiveMetastoreConfigs)]);
        }
        yield break;
    }
