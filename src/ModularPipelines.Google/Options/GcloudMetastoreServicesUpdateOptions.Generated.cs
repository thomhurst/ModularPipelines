...
public record GcloudMetastoreServicesUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Path to a XML file containing a mapping of Hive metastore configuration key-value pairs to apply to the Hive metastore. For example: hive-site.xml &lt;configuration&gt; &lt;property&gt; &lt;name&gt;hive.metastore.warehouse.dir&lt;/name&gt; &lt;value&gt;${test.warehouse.dir}&lt;/value&gt; &lt;description&gt;&lt;/description&gt; &lt;/property&gt; &lt;/configuration&gt; Use a full or relative path to a local file containing the value of update_hive_metastore_configs.
    /// </summary>
