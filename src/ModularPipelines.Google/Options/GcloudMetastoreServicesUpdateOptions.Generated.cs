...
public record GcloudMetastoreServicesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Auxiliary versions configuration for the Dataproc Metastore service. When specified, a secondary Hive metastore service is created along with the primary service. At most one of these can be specified: Or at least one of these can be specified: Comma-separated list of auxiliary Hive metastore versions to deploy. Auxiliary Hive metastore versions must be less than the primary Hive metastore service's version. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Auxiliary versions configuration for the Dataproc Metastore service. When specified, a secondary Hive metastore service is created along with the primary service. At most one of these can be specified: Or at least one of these can be specified: Clears the existing auxiliary services attached to the primary Hive metastore services. If --add-auxiliary-versions is also specified, --clear-auxiliary-versions is applied first.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(UpdateAuxiliaryVersionsFromFile) ? 1 : 0) + ((((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<char> ? (object?)AddAuxiliaryVersions is not string || !string.IsNullOrWhiteSpace(AddAuxiliaryVersions?.ToString()) : ((object?)AddAuxiliaryVersions is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)AddAuxiliaryVersions, static item => item is not null) : (AddAuxiliaryVersions is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)AddAuxiliaryVersions), static item => item is not null)))) || ClearAuxiliaryVersions == true) ? 1 : 0) > 1)
        {
