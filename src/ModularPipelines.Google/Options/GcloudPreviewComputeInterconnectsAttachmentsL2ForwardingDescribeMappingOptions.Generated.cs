...
public record GcloudPreviewComputeInterconnectsAttachmentsL2ForwardingDescribeMappingOptions : GcloudOptions
{
    /// <summary>
    /// forwarding     describe-mapping - describe a Compute Engine L2 forwarding interconnect     attachment
    /// </summary>
    ...
    public GcloudPreviewComputeInterconnectsAttachmentsL2ForwardingDescribeMappingOptions(
        string VlanKey,
        string Name
    )
    {
