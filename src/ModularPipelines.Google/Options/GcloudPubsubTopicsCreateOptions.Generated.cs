...
public record GcloudPubsubTopicsCreateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. Indicates the minimum duration to retain a message after it is published to the topic. If this field is set, messages published to the topic in the last MESSAGE_RETENTION_DURATION are always available to subscribers. For instance, it allows any attached subscription to seek to a timestamp that is up to MESSAGE_RETENTION_DURATION in the past. If this field is not set, message retention is controlled by settings on individual subscriptions. The minimum is 10 minutes and the maximum is 31 days. Valid values are strings of the form INTEGER[UNIT], where UNIT is one of "s", "m", "h", and "d" for seconds, minutes, hours, and days, respectively. If the unit is omitted, seconds is assumed.
    /// </summary>
    [CliOption("--message-retention-duration", Format = OptionFormat.EqualsSeparated)]
    public string? MessageRetentionDuration { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. Path to YAML or JSON file containing message transforms.
    /// </summary>
    [CliOption("--message-transforms-file", Format = OptionFormat.EqualsSeparated)]
    public string? MessageTransformsFile { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. List of tags KEY=VALUE pairs to bind. Each item must be expressed as &lt;tag-key-namespaced-name&gt;=&lt;tag-value-short-name&gt;. Example: 123/environment=production,123/costCenter=marketing
    /// </summary>
    [CliOption("--tags", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? Tags { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. Log severity to use for ingestion.
    /// </summary>
    [CliOption("--ingestion-log-severity", Format = OptionFormat.EqualsSeparated)]
    public string? IngestionLogSeverity { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. At most one of these can be specified: Flags that specify settings for an import topic from Amazon Web Services (AWS) Managed Streaming for Apache Kafka (MSK) Flags that specify settings for an import topic from Azure Event Hubs Flags that specify settings for an import topic from Cloud Storage Flags that specify settings for an import topic from Confluent Cloud Flags that specify settings for an import topic from Amazon Web Services (AWS) Kinesis Data Streams AWS role ARN to be used for Federated Identity authentication with MSK. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. The encoding of messages validated against the schema. ENCODING must be one of: json, binary. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--message-encoding", Format = OptionFormat.EqualsSeparated)]
    public GcloudMessageEncoding? MessageEncoding { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. The id of the oldest revision allowed for the specified schema.
    /// </summary>
    [CliOption("--first-revision-id", Format = OptionFormat.EqualsSeparated)]
    public string? FirstRevisionId { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. The id of the most recent revision allowed for the specified schema
    /// </summary>
    ...
    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. Options for explicitly specifying the message storage policy (https://cloud.google.com/pubsub/docs/resource-location-restriction) for a topic. Whether or not to enforce in-transit guarantees for this topic using the allowed regions. This ensures that publishing, pulling, and push delivery are only handled in allowed Cloud regions.
    /// </summary>
    [CliFlag("--message-storage-policy-enforce-in-transit")]
    public bool? MessageStoragePolicyEnforceInTransit { get; set; }

    /// <summary>
    /// Following flags are for specifying the data source settings for an import topic Schema settings. The schema that messages published to this topic must conform to and the expected message encoding. Key resource - The Cloud KMS (Key Management Service) cryptokey that will be used to protect the topic. The specified Cloud KMS key should have purpose set to "ENCRYPT_DECRYPT". The service account, "service-${CONSUMER_PROJECT_NUMBER}@gcp-sa-pubsub.iam.gserviceaccount.com" requires the IAM cryptoKeyEncrypterDecrypter role for the given Cloud KMS key. CONSUMER_PROJECT_NUMBER is the project number of the project that is the parent of the topic being created. The arguments in this group can be used to specify the attributes of this resource. ID of the key or fully qualified identifier for the key. To set the kms-key attribute: ◆ provide the argument --topic-encryption-key on the command line. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
