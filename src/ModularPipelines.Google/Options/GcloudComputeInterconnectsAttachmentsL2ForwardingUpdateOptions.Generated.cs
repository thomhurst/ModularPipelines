...
public record GcloudComputeInterconnectsAttachmentsL2ForwardingUpdateOptions : GcloudOptions
{
    /// <summary>
    /// update a     Compute Engine L2 forwarding interconnect attachment
    /// </summary>
    /// <param name="Name">Name of the interconnect attachment to patch.</param>
    public GcloudComputeInterconnectsAttachmentsL2ForwardingUpdateOptions(
        string Name
    )
    {
