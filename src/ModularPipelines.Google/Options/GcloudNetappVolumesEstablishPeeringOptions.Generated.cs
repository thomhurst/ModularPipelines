...
public record GcloudNetappVolumesEstablishPeeringOptions : GcloudOptions
{
    ...
    public void Deconstruct(out string PeerClusterName, out string PeerSvmName, out string PeerVolumeName, out string Volume)
    {
