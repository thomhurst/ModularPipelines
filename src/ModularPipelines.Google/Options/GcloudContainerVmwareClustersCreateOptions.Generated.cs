...
public record GcloudContainerVmwareClustersCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <param name="ControlPlaneIpBlock">Control plane v2 mode configurations. Static IP addresses for the control plane nodes. The number of IP addresses should match the number of replicas for the control plane nodes, specified by --replicas. To specify the control plane IP block, $ gcloud gcloud container vmware clusters create --control-plane-ip-block 'gateway=192.168.0.1,netmask=255.255.255.0,ips=192.168.1.1;0.0.0.0 localhost;'</param>
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(ControlPlaneIpBlock);
    ...
    public void Deconstruct(out string Version, out string AdminClusterMembership, out string ControlPlaneVip, out string IngressVip, out string ControlPlaneNodePort, out string IngressHttpNodePort, out string IngressHttpsNodePort, out string KonnectivityServerNodePort, out string PodAddressCidrBlocks, out string ServiceAddressCidrBlocks, out string ControlPlaneIpBlock, out IEnumerable<string> DnsSearchDomains, out IEnumerable<string> DnsServers, out IEnumerable<string> NtpServers, out string Cluster)
    {
        ...
        ControlPlaneIpBlock = this.ControlPlaneIpBlock;
    ...
    public string ControlPlaneIpBlock { get; private init; }
