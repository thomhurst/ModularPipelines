...
public record GcloudContainerVmwareClustersCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    public void Deconstruct(out string Version, out string AdminClusterMembership, out string ControlPlaneVip, out string IngressVip, out string PodAddressCidrBlocks, out string ServiceAddressCidrBlocks, out string Cluster)
    {
    ...
    /// <summary>
    /// Annotations on the VMware user cluster. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
