...
// Source: https://cloud.google.com/sdk/gcloud/reference/metastore/federations/remove-iam-policy-binding
...
[CliSubCommand("metastore", "federations", "remove-iam-policy-binding")]
public record GcloudMetastoreFederationsRemoveIamPolicyBindingOptions : GcloudOptions
{
    /// <summary>
    /// remove an IAM     policy binding from a federation
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Federation)
    {
        Member = this.Member;
        Role = this.Role;
