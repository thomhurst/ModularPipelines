...
public record GcloudRunServicesUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Remove all labels. If --update-labels is also specified then --clear-labels is applied first. For example, to remove all labels: $ gcloud run services update --clear-labels To remove all existing labels and create two new labels, foo and baz: $ gcloud run services update --clear-labels \ --update-labels foo=bar,baz=qux
    /// </summary>
