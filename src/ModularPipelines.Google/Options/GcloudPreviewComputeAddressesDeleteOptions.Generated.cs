...
public record GcloudPreviewComputeAddressesDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// release reserved IP addresses
    /// </summary>
    /// <param name="Name">Names of the addresses to delete.</param>
    public GcloudPreviewComputeAddressesDeleteOptions(
