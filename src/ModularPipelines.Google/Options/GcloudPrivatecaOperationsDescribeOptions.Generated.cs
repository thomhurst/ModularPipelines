...
// Source: https://cloud.google.com/sdk/gcloud/reference/privateca/operations/describe
...
[CliSubCommand("privateca", "operations", "describe")]
public record GcloudPrivatecaOperationsDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe an operation ran on the     Private CA API
    /// </summary>
    ...
    public GcloudPrivatecaOperationsDescribeOptions(
        string Operation
    )
    {
    ...
    /// <summary>
    /// Operation resource - The operation to describe. The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument operation on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. The location of the operation to describe. To set the location attribute: ▸ provide the argument operation on the command line with a fully specified name; ▸ provide the argument --location on the command line.
    /// </summary>
