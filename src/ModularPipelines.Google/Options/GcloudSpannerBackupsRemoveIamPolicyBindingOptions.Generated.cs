...
public record GcloudSpannerBackupsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding of a Cloud Spanner backup
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Backup)
    {
        Member = this.Member;
        Role = this.Role;
        Backup = this.Backup;
