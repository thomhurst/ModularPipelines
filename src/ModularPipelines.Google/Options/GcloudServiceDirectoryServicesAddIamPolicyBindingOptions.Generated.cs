...
// Source: https://cloud.google.com/sdk/gcloud/reference/service-directory/services/add-iam-policy-binding
...
[CliSubCommand("service-directory", "services", "add-iam-policy-binding")]
public record GcloudServiceDirectoryServicesAddIamPolicyBindingOptions : GcloudOptions
{
    /// <summary>
    /// adds IAM policy     binding to a service
    /// </summary>
    ...
    public GcloudServiceDirectoryServicesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Service
    )
