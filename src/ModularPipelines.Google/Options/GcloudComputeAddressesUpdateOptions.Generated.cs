...
public record GcloudComputeAddressesUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update an address's labels
    /// </summary>
    /// <param name="Name">Name of the address to operate on.</param>
    public GcloudComputeAddressesUpdateOptions(
        string Name
    )
    {
