...
public record GcloudPreviewComputeHealthChecksUpdateSslOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a SSL health check
    /// </summary>
    /// <param name="Name">Name of the SSL health check to update.</param>
    public GcloudPreviewComputeHealthChecksUpdateSslOptions(
        string Name
    )
    {
