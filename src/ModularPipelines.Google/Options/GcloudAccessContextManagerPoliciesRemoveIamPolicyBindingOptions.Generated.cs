...
// Source: https://cloud.google.com/sdk/gcloud/reference/access-context-manager/policies/remove-iam-policy-binding
...
[CliSubCommand("access-context-manager", "policies", "remove-iam-policy-binding")]
public record GcloudAccessContextManagerPoliciesRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove     IAM policy binding for an access policy
    /// </summary>
    ...
    public GcloudAccessContextManagerPoliciesRemoveIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
