...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-groups/managed/suspend-instances
...
[CliSubCommand("preview", "compute", "instance-groups", "managed", "suspend-instances")]
public record GcloudPreviewComputeInstanceGroupsManagedSuspendInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// suspend     instances owned by a managed instance group
    /// </summary>
    /// <param name="Instances">Names of instances to suspend. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedSuspendInstancesOptions(
    ...
    /// <summary>
    /// Names of instances to suspend. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
