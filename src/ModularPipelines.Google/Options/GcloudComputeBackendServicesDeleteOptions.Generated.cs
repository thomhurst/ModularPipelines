...
public record GcloudComputeBackendServicesDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete backend services
    /// </summary>
    /// <param name="BackendServiceName">Names of the backend services to delete.</param>
    public GcloudComputeBackendServicesDeleteOptions(
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the backend services to delete. Overrides the default compute/region property value for this command invocation.
    /// </summary>
