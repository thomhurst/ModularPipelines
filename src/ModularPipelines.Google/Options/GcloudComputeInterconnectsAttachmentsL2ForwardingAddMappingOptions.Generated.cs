...
public record GcloudComputeInterconnectsAttachmentsL2ForwardingAddMappingOptions : GcloudOptions
{
    /// <summary>
    /// add     new vlan to ip mapping rule to an L2-forwarding attachment
    /// </summary>
    ...
    public GcloudComputeInterconnectsAttachmentsL2ForwardingAddMappingOptions(
        string VlanKey,
        string Name
    )
    {
