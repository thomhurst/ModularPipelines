...
public record GcloudComputeOsConfigOsPolicyAssignmentsOperationsCancelOptions : GcloudOptions
{
    /// <summary>
    /// cancel     an OS policy assignment operation
    /// </summary>
    ...
    public GcloudComputeOsConfigOsPolicyAssignmentsOperationsCancelOptions(
        string Operation
    )
    {
