...
{
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Automatically delete boot disks when their instances are deleted. Enabled by default, use --no-boot-disk-auto-delete to disable.
    /// </summary>
    [CliFlag("--boot-disk-auto-delete")]
    public bool? BootDiskAutoDelete { get; set; }

    /// <summary>
    /// Negates --boot-disk-auto-delete. Custom machine type extensions. Specifies the reservation for instances created from this template. Automatically delete boot disks when their instances are deleted. Enabled by default, use --no-boot-disk-auto-delete to disable.
    /// </summary>
    [CliFlag("--no-boot-disk-auto-delete")]
    public bool? NoBootDiskAutoDelete { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. The name the guest operating system will see for the boot disk. This option can only be specified if a new boot disk is being created (as opposed to mounting an existing persistent disk).
    /// </summary>
    [CliOption("--boot-disk-device-name", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskDeviceName { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Indicates the interface to use for the boot disk. The value must be one of the following: ◆ SCSI ◆ NVME
    /// </summary>
    [CliOption("--boot-disk-interface", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskInterface { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Indicates how many IOPS to provision for the disk. This sets the number of I/O operations per second that the disk can handle.
    /// </summary>
    [CliOption("--boot-disk-provisioned-iops", Format = OptionFormat.EqualsSeparated)]
    public int? BootDiskProvisionedIops { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Indicates how much throughput to provision for the disk. This sets the number of throughput mb per second that the disk can handle.
    /// </summary>
    ...
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Mounts empty tmpfs into container at MOUNTPATH. mount-path Path on container to mount to. Mount paths with spaces and commas (and other special characters) are not supported by this command.
    /// </summary>
    [CliOption("--container-mount-tmpfs", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerMountTmpfs { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Specify whether to run container in privileged mode. Default: --no-container-privileged.
    /// </summary>
    [CliFlag("--container-privileged")]
    public bool? ContainerPrivileged { get; set; }

    /// <summary>
    /// Negates --container-privileged. Custom machine type extensions. Specifies the reservation for instances created from this template. Specify whether to run container in privileged mode. Default: --no-container-privileged.
    /// </summary>
    [CliFlag("--no-container-privileged")]
    public bool? NoContainerPrivileged { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Specify whether to restart a container on exit. POLICY must be one of: never, on-failure, always.
    /// </summary>
    ...
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. If enabled, then, when the instance is stopped or deleted, the instance is immediately stopped without giving time to the guest OS to cleanly shut down. Use --skip-guest-os-shutdown to enable and --no-skip-guest-os-shutdown to disable.
    /// </summary>
    [CliFlag("--skip-guest-os-shutdown")]
    public bool? SkipGuestOsShutdown { get; set; }

    /// <summary>
    /// Negates --skip-guest-os-shutdown. Custom machine type extensions. Specifies the reservation for instances created from this template. If enabled, then, when the instance is stopped or deleted, the instance is immediately stopped without giving time to the guest OS to cleanly shut down. Use --skip-guest-os-shutdown to enable and --no-skip-guest-os-shutdown to disable.
    /// </summary>
    [CliFlag("--no-skip-guest-os-shutdown")]
    public bool? NoSkipGuestOsShutdown { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies whether IPv6 is enabled on the default network interface. If not specified, IPV4_ONLY will be used. STACK_TYPE must be one of: IPV4_IPV6 The network interface can have both IPv4 and IPv6 addresses IPV4_ONLY The network interface will be assigned IPv4 addresses IPV6_ONLY The network interface will be assigned IPv6 addresses
    /// </summary>
    [CliOption("--stack-type", Format = OptionFormat.EqualsSeparated)]
    public string? StackType { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies the subnet that the VM instances are a part of. If --network is also specified, subnet must be a subnetwork of the network specified by the --network flag.
    /// </summary>
    [CliOption("--subnet", Format = OptionFormat.EqualsSeparated)]
    public string? Subnet { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies a list of tags to apply to the instance. These tags allow network firewall rules and routes to be applied to specified VM instances. See gcloud compute firewall-rules create(1) for more details. To read more about configuring network tags, read this guide: https://cloud.google.com/vpc/docs/add-remove-network-tags To list instances with their respective status and tags, run: $ gcloud compute instances list \ --format='table(name,status,tags.list())' To list instances tagged with a specific tag, tag1, run: $ gcloud compute instances list --filter='tags:tag1'
    /// </summary>
    [CliOption("--tags", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? Tags { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: Assigns the given external IP address to the instance that is created. This option can only be used when creating a single instance.
    /// </summary>
    [CliOption("--address", Format = OptionFormat.EqualsSeparated)]
    public string? Address { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: If provided, the instances are not assigned external IP addresses. To pull container images, you must configure private Google access if using Container Registry or configure Cloud NAT for instances to access container images directly. For more information, see: ▸ https://cloud.google.com/vpc/docs/configure-private-google-access ▸ https://cloud.google.com/nat/docs/using-nat
    /// </summary>
    [CliFlag("--no-address")]
    public bool? NoAddress { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: (DEPRECATED) The instance boots with Confidential Computing enabled. Confidential Computing is based on Secure Encrypted Virtualization (SEV), an AMD virtualization feature for running confidential instances. The --confidential-compute flag will soon be deprecated. Please use --confidential-compute-type=SEV instead
    /// </summary>
    [CliFlag("--confidential-compute")]
    public bool? ConfidentialCompute { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. At most one of these can be specified: The instance boots with Confidential Computing enabled. Confidential Computing can be based on Secure Encrypted Virtualization (SEV) or Secure Encrypted Virtualization - Secure Nested Paging (SEV-SNP), both of which are AMD virtualization features for running confidential instances. Trust Domain eXtension based on Intel virtualization features for running confidential instances is also supported. Arm Confidential Compute Architecture for running confidential instances is also supported. Bare Metal Secure AI for running confidential instances is also supported. CONFIDENTIAL_COMPUTE_TYPE must be one of: BMSAI Bare Metal Secure AI CCA Arm Confidential Compute Architecture SEV Secure Encrypted Virtualization SEV_SNP Secure Encrypted Virtualization - Secure Nested Paging TDX Trust Domain eXtension
    /// </summary>
    [CliOption("--confidential-compute-type", Format = OptionFormat.EqualsSeparated)]
    public string? ConfidentialComputeType { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. A whole number value specifying the number of cores that are needed in the custom machine type. For some machine types, shared-core values can also be used. For example, for E2 machine types, you can specify micro, small, or medium. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--custom-cpu", Format = OptionFormat.EqualsSeparated)]
    public string? CustomCpu { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. A whole number value indicating how much memory is desired in the custom machine type. A size unit should be provided (eg. 3072MB or 9GB) - if no units are specified, GB is assumed. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--custom-memory", Format = OptionFormat.EqualsSeparated)]
    public string? CustomMemory { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Use the extended custom machine type.
    /// </summary>
    [CliFlag("--custom-extensions")]
    public bool? CustomExtensions { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Specifies a custom machine type. The default is n1. For more information about custom machine types, see: https://cloud.google.com/compute/docs/general-purpose-machines#custom_machine_types
    /// </summary>
