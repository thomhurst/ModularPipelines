...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for instances created from this template. Same as --metadata except that the value for the entry will be read from a local file. This is useful for values that are too large such as startup-script contents. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
