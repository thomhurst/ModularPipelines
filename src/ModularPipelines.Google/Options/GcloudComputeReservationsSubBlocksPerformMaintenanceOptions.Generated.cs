...
public record GcloudComputeReservationsSubBlocksPerformMaintenanceOptions : GcloudOptions
{
    /// <summary>
    /// perform     maintenance on a reservation sub-block
    /// </summary>
    ...
    public GcloudComputeReservationsSubBlocksPerformMaintenanceOptions(
        string BlockName,
        string SubBlockName,
        string Reservation
    )
