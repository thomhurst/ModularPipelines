...
// Source: https://cloud.google.com/sdk/gcloud/reference/container/binauthz/attestors/remove-iam-policy-binding
...
[CliSubCommand("container", "binauthz", "attestors", "remove-iam-policy-binding")]
public record GcloudContainerBinauthzAttestorsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM     policy binding of a Binary Authorization attestor
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Attestor)
    {
        Member = this.Member;
        Role = this.Role;
    ...
    /// <summary>
    /// Attestor resource - The Binary Authorization attestor whose IAM policy to remove an IAM policy binding from. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument attestor on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the attestor or fully qualified identifier for the attestor. To set the attestor attribute: ▸ provide the argument attestor on the command line.
    /// </summary>
