...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instant-snapshots/test-iam-permissions
...
[CliSubCommand("preview", "compute", "instant-snapshots", "test-iam-permissions")]
public record GcloudPreviewComputeInstantSnapshotsTestIamPermissionsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// test IAM     permissions for a Compute Engine instant snapshot
    /// </summary>
    ...
    /// <param name="InstantSnapshotName">Name of the instant snapshot to test IAM permissions for.</param>
    public GcloudPreviewComputeInstantSnapshotsTestIamPermissionsOptions(
    ...
    public void Deconstruct(out IEnumerable<string> Permissions, out string InstantSnapshotName)
    {
    ...
    /// <summary>
    /// At most one of these can be specified: Region of the instant snapshot to test IAM permissions for. If not specified, you might be prompted to select a region (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/region property: $ gcloud config set compute/region REGION A list of regions can be fetched by running: $ gcloud compute regions list To unset the property, run: $ gcloud config unset compute/region Alternatively, the region can be stored in the environment variable CLOUDSDK_COMPUTE_REGION.
    /// </summary>
    [CliOption("--region", Format = OptionFormat.EqualsSeparated)]
    public string? Region { get; set; }

    /// <summary>
    /// At most one of these can be specified: Zone of the instant snapshot to test IAM permissions for. If not specified and the compute/zone property isn't set, you might be prompted to select a zone (interactive mode only). To avoid prompting when this flag is omitted, you can set the compute/zone property: $ gcloud config set compute/zone ZONE A list of zones can be fetched by running: $ gcloud compute zones list To unset the property, run: $ gcloud config unset compute/zone Alternatively, the zone can be stored in the environment variable CLOUDSDK_COMPUTE_ZONE.
    /// </summary>
    [CliOption("--zone", Format = OptionFormat.EqualsSeparated)]
    public string? Zone { get; set; }

    /// <summary>
    /// Name of the instant snapshot to test IAM permissions for.
    /// </summary>
