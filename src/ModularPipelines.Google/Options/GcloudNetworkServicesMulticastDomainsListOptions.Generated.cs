...
// Source: https://cloud.google.com/sdk/gcloud/reference/network-services/multicast-domains/list
...
[CliSubCommand("network-services", "multicast-domains", "list")]
public record GcloudNetworkServicesMulticastDomainsListOptions : GcloudOptions
{
    /// <summary>
    /// list multicast domains
    /// </summary>
    ...
    public GcloudNetworkServicesMulticastDomainsListOptions(
        string Location
    )
    {
