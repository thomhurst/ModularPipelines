...
public record GcloudComputeInstanceGroupsManagedAllInstancesConfigDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete     values defined in the all-instances configuration of a managed instance     group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to delete the all instances configuration for.</param>
    public GcloudComputeInstanceGroupsManagedAllInstancesConfigDeleteOptions(
        string Name
    )
    {
