...
public record GcloudPreviewComputeInstancesAttachDiskOptions : GcloudOptions
{
    /// <summary>
    /// attach a disk to an instance
    /// </summary>
    ...
    public GcloudPreviewComputeInstancesAttachDiskOptions(
        string Disk,
        string InstanceName
    )
    {
    ...
    public void Deconstruct(out string Disk, out string InstanceName)
    {
        Disk = this.Disk;
