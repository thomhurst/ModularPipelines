...
// Source: https://cloud.google.com/sdk/gcloud/reference/compute/reset-windows-password
...
[CliSubCommand("compute", "reset-windows-password")]
public record GcloudComputeResetWindowsPasswordOptions(
    [property: CliArgument(0, Name = "INSTANCE_NAME")] string InstanceName
) : GcloudOptions
{
    /// <summary>
    /// USER specifies the username to get the password for. If omitted, the     username is derived from your authenticated account email address.
    /// </summary>
