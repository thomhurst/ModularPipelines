...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/public-delegated-prefixes/delete
...
[CliSubCommand("preview", "compute", "public-delegated-prefixes", "delete")]
public record GcloudPreviewComputePublicDelegatedPrefixesDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// deletes a Compute     Engine public delegated prefix
    /// </summary>
    /// <param name="Name">Name of the public delegated prefix to operate on.</param>
    public GcloudPreviewComputePublicDelegatedPrefixesDeleteOptions(
        string Name
    )
    {
