...
public record GcloudLoggingViewsListOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list the defined views
    /// </summary>
    ...
    public GcloudLoggingViewsListOptions(
        string Bucket,
        string Location
    )
    {
