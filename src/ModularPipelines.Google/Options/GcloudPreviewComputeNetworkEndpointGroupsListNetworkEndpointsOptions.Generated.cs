...
public record GcloudPreviewComputeNetworkEndpointGroupsListNetworkEndpointsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list network endpoints in a network endpoint group
    /// </summary>
    /// <param name="Name">Name of the network endpoint group to operate on.</param>
    public GcloudPreviewComputeNetworkEndpointGroupsListNetworkEndpointsOptions(
        string Name
    )
    {
