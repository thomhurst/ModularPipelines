...
public record GcloudLoggingBucketsUndeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// undelete a bucket
    /// </summary>
    /// <param name="Location">Location of the bucket.</param>
    /// <param name="BucketId">ID of the bucket to undelete.</param>
    public GcloudLoggingBucketsUndeleteOptions(
        string Location,
        string BucketId
    )
    {
