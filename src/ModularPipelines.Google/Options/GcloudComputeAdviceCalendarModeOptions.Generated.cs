...
public record GcloudComputeAdviceCalendarModeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    ...
    {
        if ((((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) ? 1 : 0) != 1)
        {
            yield return new ValidationResult("Exactly one of (ChipCount, TpuVersion, or WorkloadType) or (MachineType, VmCount, or LocalSsd) must be specified.", [nameof(ChipCount), nameof(TpuVersion), nameof(WorkloadType), nameof(MachineType), nameof(VmCount), nameof(LocalSsd)]);
        }
        if (((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType) || !string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) && ((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType)) && (!((object?)ChipCount is not null)))
        {
            yield return new ValidationResult("ChipCount must be specified when other arguments in this group are specified.", [nameof(ChipCount)]);
        }
        if (((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType) || !string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) && ((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType)) && (!(!string.IsNullOrWhiteSpace(TpuVersion))))
        {
        ...
        if (((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType) || !string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) && (!string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) && (!(!string.IsNullOrWhiteSpace(MachineType))))
        {
        ...
        if (((object?)ChipCount is not null || !string.IsNullOrWhiteSpace(TpuVersion) || !string.IsNullOrWhiteSpace(WorkloadType) || !string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) && (!string.IsNullOrWhiteSpace(MachineType) || (object?)VmCount is not null || !string.IsNullOrWhiteSpace(LocalSsd)) && (!((object?)VmCount is not null)))
        {
            yield return new ValidationResult("VmCount must be specified when other arguments in this group are specified.", [nameof(VmCount)]);
        }
        yield break;
    }
