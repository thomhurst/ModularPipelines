...
public record GcloudNetworkConnectivityHubsRouteTablesRoutesListOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Id of the hub.     To set the hub attribute:     ◆ provide the argument --route_table on the command line with a fully      specified name;     ◆ if route table is empty, will use wildcard '-' to list all route      tables with a fully specified name;     ◆ provide the argument --hub on the command line;     ◆ if hub is empty, will use the wildcard '-' to indicate all hubs.
    /// </summary>
    [CliOption("--hub", Format = OptionFormat.EqualsSeparated)]
    public string? Hub { get; set; }

    /// <summary>
    /// ID of the route table or fully qualified identifier for the route     table.     To set the route_table attribute:     ◆ provide the argument --route_table on the command line;     ◆ if route table is empty, will use wildcard '-' to list all route      tables .
    /// </summary>
