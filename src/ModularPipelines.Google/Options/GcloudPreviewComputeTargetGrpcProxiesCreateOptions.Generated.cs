...
public record GcloudPreviewComputeTargetGrpcProxiesCreateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// create a target gRPC     proxy
    /// </summary>
    ...
    public GcloudPreviewComputeTargetGrpcProxiesCreateOptions(
        string UrlMap,
        string Name
    )
    {
