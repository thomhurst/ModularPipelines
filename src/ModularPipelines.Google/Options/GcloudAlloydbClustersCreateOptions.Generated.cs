...
) : GcloudOptions
{
    ...
    /// <summary>
    /// Continuous Backup configuration. If unspecified, continuous backups are enabled. The resource name of the BackupDR backup plan to associate with the cluster. The format should be projects/{project}/locations/{location}/backupPlans/{backupPlanId}. This flag cannot be used with the --async flag.
    /// </summary>
