...
public record GcloudAlloydbClustersCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("At most one of DisableAutomatedBackup or (AutomatedBackupDaysOfWeek, AutomatedBackupStartTimes, AutomatedBackupWindow, AutomatedBackupEncryptionKey, AutomatedBackupEncryptionKeyKeyring, AutomatedBackupEncryptionKeyLocation, AutomatedBackupEncryptionKeyProject, AutomatedBackupRetentionCount, or AutomatedBackupRetentionPeriod) may be specified.", [nameof(DisableAutomatedBackup), nameof(AutomatedBackupDaysOfWeek), nameof(AutomatedBackupStartTimes), nameof(AutomatedBackupWindow), nameof(AutomatedBackupEncryptionKey), nameof(AutomatedBackupEncryptionKeyKeyring), nameof(AutomatedBackupEncryptionKeyLocation), nameof(AutomatedBackupEncryptionKeyProject), nameof(AutomatedBackupRetentionCount), nameof(AutomatedBackupRetentionPeriod)]);
        }
