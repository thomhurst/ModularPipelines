...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/keys/undelete
...
[CliSubCommand("iam", "workforce-pools", "providers", "keys", "undelete")]
public record GcloudIamWorkforcePoolsProvidersKeysUndeleteOptions : GcloudOptions
{
    /// <summary>
    /// undelete a workforce     pool provider key
    /// </summary>
    /// <param name="Key">Workforce pool provider key resource - The workforce pool provider key to undelete. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the workforce pool provider key or fully qualified identifier for the workforce pool provider key. To set the key attribute: ▸ provide the argument key on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamWorkforcePoolsProvidersKeysUndeleteOptions(
        string Key
    )
    {
