...
public record GcloudApihubHostProjectRegistrationsListOptions : GcloudOptions
{
    ...
    public GcloudApihubHostProjectRegistrationsListOptions(
        string Location
    )
    {
    ...
    /// <summary>
    /// Location resource - The parent, which owns this collection of host projects. Format: projects/*/locations/* This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument --location on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the location or fully qualified identifier for the location. To set the location attribute: ▸ provide the argument --location on the command line.
    /// </summary>
