...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/target-pools/create
...
[CliSubCommand("preview", "compute", "target-pools", "create")]
public record GcloudPreviewComputeTargetPoolsCreateOptions : GcloudOptions
{
    /// <summary>
    /// balanced pool of     virtual machine instances
    /// </summary>
    /// <param name="Name">The name of the target pool.</param>
    public GcloudPreviewComputeTargetPoolsCreateOptions(
        string Name
    )
    {
