...
public record GcloudComputeScpOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// copy files to and from Google Compute Engine virtual     machines via scp
    /// </summary>
    ...
    public GcloudComputeScpOptions(
    ...
    public GcloudComputeScpStrictHostKeyChecking? StrictHostKeyChecking { get; set; }
