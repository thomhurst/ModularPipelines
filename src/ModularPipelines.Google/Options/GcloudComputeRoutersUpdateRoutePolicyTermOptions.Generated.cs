...
public record GcloudComputeRoutersUpdateRoutePolicyTermOptions : GcloudOptions
{
    /// <summary>
    /// updates a term of an     existing route policy of a Comute Engine router
    /// </summary>
    ...
    public GcloudComputeRoutersUpdateRoutePolicyTermOptions(
        string Match,
        string PolicyName,
        string Priority,
        string Name
    ...
    /// <summary>
    /// --actions=[ACTION;...] Semicolon separated CEL expressions for the actions to take when the rule matches. Name of the route policy to which the term should be updated.
    /// </summary>
    [CliOption("--policy-name", Format = OptionFormat.EqualsSeparated)]
    public string PolicyName { get; private init; }

    /// <summary>
    /// --actions=[ACTION;...] Semicolon separated CEL expressions for the actions to take when the rule matches. Order of the term within the policy.
    /// </summary>
