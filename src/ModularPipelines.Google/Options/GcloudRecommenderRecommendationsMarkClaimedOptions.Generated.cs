...
public record GcloudRecommenderRecommendationsMarkClaimedOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// mark a recommendation's     state as CLAIMED
    /// </summary>
    ...
    /// <param name="Recommendation">Recommendation id which will be marked as claimed</param>
