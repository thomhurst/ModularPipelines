...
public record GcloudDataplexTasksUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Spec related to how a task is executed. Spec related to how often and when a task should be triggered. At most one of these can be specified: List of label keys to remove. If a label does not exist it is silently ignored. If --update-labels is also specified then --update-labels is applied first. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
    ...
    /// <summary>
    /// Spec related to how a task is executed. Spec related to how often and when a task should be triggered. Select which task you want to schedule and provide the required arguments:- ◆ spark tasks ◆ notebook tasks At most one of these can be specified: Config related to running custom Notebook tasks. Compute resources needed for a Task when using Dataproc Serverless. Container Image Runtime Configuration. Cloud VPC Network used to run the infrastructure. Config related to running custom Spark tasks. Compute resources needed for a Task when using Dataproc Serverless. Container Image Runtime Configuration. Cloud VPC Network used to run the infrastructure. The Cloud VPC network identifier. List of network tags to apply to the job. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
