...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/interconnects/attachments/dedicated/create
...
[CliSubCommand("preview", "compute", "interconnects", "attachments", "dedicated", "create")]
public record GcloudPreviewComputeInterconnectsAttachmentsDedicatedCreateOptions : GcloudOptions
{
    /// <summary>
    /// create     a Compute Engine dedicated interconnect attachment
    /// </summary>
    ...
    public GcloudPreviewComputeInterconnectsAttachmentsDedicatedCreateOptions(
        string Interconnect,
        string Router,
        string Name
    )
    ...
    public void Deconstruct(out string Interconnect, out string Router, out string Name)
    {
    ...
    public GcloudPreviewComputeInterconnectsAttachmentsDedicatedCreateEncryption? Encryption { get; set; }
