...
{
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Binary Authorization policy to check against. This must be set to "default".
    /// </summary>
    [CliOption("--binary-authorization", Format = OptionFormat.EqualsSeparated)]
    public string? BinaryAuthorization { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Justification to bypass Binary Authorization policy constraints and allow the operation. See https://cloud.google.com/binary-authorization/docs/using-breakglass for more information. Next update or deploy command will automatically clear existing breakglass justification.
    /// </summary>
    [CliOption("--breakglass", Format = OptionFormat.EqualsSeparated)]
    public string? Breakglass { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Specifies a container by name. Flags following --container will apply to the specified container. Flags that are not container-specific must be specified before --container.
    /// </summary>
    [CliOption("--container", Format = OptionFormat.EqualsSeparated)]
    public string? Container { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. The GPU type to use.
    /// </summary>
    [CliOption("--gpu-type", Format = OptionFormat.EqualsSeparated)]
    public string? GpuType { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Set GPU zonal redundancy. Use --gpu-zonal-redundancy to enable and --no-gpu-zonal-redundancy to disable.
    /// </summary>
    [CliFlag("--gpu-zonal-redundancy")]
    public bool? GpuZonalRedundancy { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. CMEK key reference to encrypt the container with.
    /// </summary>
    [CliOption("--key", Format = OptionFormat.EqualsSeparated)]
    public string? Key { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. List of label KEY=VALUE pairs to add.
    /// </summary>
    [CliOption("--labels", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? Labels { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Number of times a task is allowed to restart in case of failure before being failed permanently. This applies per-task, not per-job. If set to 0, tasks will only run once and never be retried on failure.
    /// </summary>
    [CliOption("--max-retries", Format = OptionFormat.EqualsSeparated)]
    public string? MaxRetries { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Number of tasks that may run concurrently. Must be less than or equal to the number of tasks. Set to 0 to unset.
    /// </summary>
    [CliOption("--parallelism", Format = OptionFormat.EqualsSeparated)]
    public string? Parallelism { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Region in which the resource can be found. Alternatively, set the property [run/region].
    /// </summary>
    [CliOption("--region", Format = OptionFormat.EqualsSeparated)]
    public string? Region { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. the email address of an IAM service account associated with the revision of the service. The service account represents the identity of the running revision, and determines what permissions the revision has.
    /// </summary>
    [CliOption("--service-account", Format = OptionFormat.EqualsSeparated)]
    public int? ServiceAccount { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. You can specify a name of a Cloud SQL instance if it's in the same project and region as your Cloud Run resource; otherwise specify &lt;project&gt;:&lt;region&gt;:&lt;instance&gt; for the instance.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Remove all existing mounts from the current container.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. List of container dependencies to add to the current container.
    /// </summary>
    [CliOption("--depends-on", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? DependsOn { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Cloud Run supports values 0 or 1. 1 gpu also requires a minimum 4 --cpu value and a minimum 16Gi --memory value.
    /// </summary>
    [CliOption("--gpu", Format = OptionFormat.EqualsSeparated)]
    public string? Gpu { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Name of the container image to deploy (e.g. us-docker.pkg.dev/cloudrun/container/job:latest).
    /// </summary>
    [CliOption("--image", Format = OptionFormat.EqualsSeparated)]
    public string? Image { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Set a memory limit. Ex: 1024Mi, 4Gi.
    /// </summary>
    [CliOption("--memory", Format = OptionFormat.EqualsSeparated)]
    public string? Memory { get; set; }

    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Removes the volume mounted at the specified path from the current container.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. At most one of these can be specified: Remove all environment variables.
    /// </summary>
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. At most one of these can be specified: Return immediately, without waiting for the operation in progress to complete.
    /// </summary>
    [CliFlag("--async")]
    ...
    /// <summary>
    /// --tasks=TASKS; default=1 Number of tasks that must run to completion for the execution to be considered done. Container Flags If the --container is specified the following arguments may only be specified after a --container flag. Direct VPC egress setting flags group. Applies the given network tags (comma separated) to the Cloud Run job. To clear existing tags, use --clear-network-tags.
    /// </summary>
