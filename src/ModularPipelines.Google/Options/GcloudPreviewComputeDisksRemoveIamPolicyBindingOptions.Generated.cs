...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/disks/remove-iam-policy-binding
...
[CliSubCommand("preview", "compute", "disks", "remove-iam-policy-binding")]
public record GcloudPreviewComputeDisksRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove IAM policy     binding from a Compute Engine disk
    /// </summary>
    ...
    public void Deconstruct(out string Member, out string Role, out string Disk)
    {
        Member = this.Member;
        Role = this.Role;
        Disk = this.Disk;
