...
[CommandPrecedingArguments("access-context-manager", "policies", "add-iam-policy-binding")]
public record GcloudAccessContextManagerPoliciesAddIamPolicyBindingOptions(
