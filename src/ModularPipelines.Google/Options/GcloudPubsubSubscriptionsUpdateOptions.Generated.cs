...
public record GcloudPubsubSubscriptionsUpdateOptions : GcloudOptions
{
    ...
    /// <summary>
    /// Negates --enable-exactly-once-delivery. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. Whether or not to enable exactly-once delivery on the subscription. If true, Pub/Sub provides the following guarantees for the delivery of a message with a given value of message_id on this subscription: The message sent to a subscriber is guaranteed not to be resent before the message's acknowledgment deadline expires. An acknowledged message will not be resent to a subscriber. Use --no-enable-exactly-once-delivery to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --retain-acked-messages. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. Whether or not to retain acknowledged messages. If true, messages are not expunged from the subscription's backlog until they fall out of the --message-retention-duration window. Acknowledged messages are not retained by default. Use --no-retain-acked-messages to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --drop-unknown-fields. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: At most one of these can be specified: Or at least one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. When updating BigQueryConfig flags, all BigQueryConfig flags must be specified. Otherwise, any omitted BigQueryConfig flags revert to their default value. If either --use-topic-schema or --use-table-schema is set, whether or not to ignore fields in the message that do not appear in the BigQuery table schema. Use --no-drop-unknown-fields to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --write-metadata. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: At most one of these can be specified: Or at least one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. When updating BigQueryConfig flags, all BigQueryConfig flags must be specified. Otherwise, any omitted BigQueryConfig flags revert to their default value. Whether or not to write message metadata including message ID, publish timestamp, ordering key, and attributes to BigQuery. The subscription name, message_id, and publish_time fields are put in their own columns while all other message properties other than data (for example, an ordering_key, if present) are written to a JSON object in the attributes column. Use --no-write-metadata to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --use-table-schema. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: At most one of these can be specified: Or at least one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. When updating BigQueryConfig flags, all BigQueryConfig flags must be specified. Otherwise, any omitted BigQueryConfig flags revert to their default value. At most one of these can be specified: Whether or not to use the BigQuery table schema when writing messages to BigQuery. Use --no-use-table-schema to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --use-topic-schema. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: At most one of these can be specified: Or at least one of these can be specified: BigQuery Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this BigQuery table. When updating BigQueryConfig flags, all BigQueryConfig flags must be specified. Otherwise, any omitted BigQueryConfig flags revert to their default value. At most one of these can be specified: Whether or not to use the schema for the subscription's topic (if it exists) when writing messages to BigQuery. If --drop-unknown-fields is not set, then the BigQuery schema must contain all fields that are present in the topic schema. Use --no-use-topic-schema to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --clear-cloud-storage-config. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: If set, clear the Cloud Storage config from the subscription. Use --no-clear-cloud-storage-config to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --cloud-storage-use-topic-schema. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: Or at least one of these can be specified: Cloud Storage Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this Cloud Storage bucket and to read this bucket's metadata. When updating CloudStorageConfig flags, all CloudStorageConfig flags must be specified. Otherwise, any omitted CloudStorageConfig flags revert to their default value. Note that an update to the Cloud Storage config will replace it with a new config containing only the flags that are passed in the update CLI. Whether or not to use the schema for the subscription's topic (if it exists) when writing messages to Cloud Storage. This has an effect only for subscriptions with --cloud-storage-output-format=avro. Use --no-cloud-storage-use-topic-schema to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --cloud-storage-write-metadata. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: Or at least one of these can be specified: Cloud Storage Config Options. The Cloud Pub/Sub service account associated with the enclosing subscription's parent project (i.e., service-{project_number}@gcp-sa-pubsub.iam.gserviceaccount.com) must have permission to write to this Cloud Storage bucket and to read this bucket's metadata. When updating CloudStorageConfig flags, all CloudStorageConfig flags must be specified. Otherwise, any omitted CloudStorageConfig flags revert to their default value. Note that an update to the Cloud Storage config will replace it with a new config containing only the flags that are passed in the update CLI. Whether or not to write the subscription name, message_id, publish_time, attributes, and ordering_key as additional fields in the output. The subscription name, message_id, and publish_time fields are put in their own fields while all other message properties other than data (for example, an ordering_key, if present) are added as entries in the attributes map. This has an effect only for subscriptions with --cloud-storage-output-format=avro. Use --no-cloud-storage-write-metadata to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --clear-dead-letter-policy. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: If set, clear the dead letter policy from the subscription. Use --no-clear-dead-letter-policy to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --clear-message-transforms. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: If set, clears the message transforms field. Use --no-clear-message-transforms to disable this flag.
    /// </summary>
    ...
    /// <summary>
    /// Negates --clear-retry-policy. Push Config Options. Configuration for a push delivery endpoint. When updating PushConfig flags, all PushConfig flags must be specified. Otherwise, any omitted PushConfig flags revert to their default value. At most one of these can be specified: If set, clear the retry policy from the subscription. Use --no-clear-retry-policy to disable this flag.
    /// </summary>
