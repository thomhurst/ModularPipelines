...
public record GcloudComputeNetworkFirewallPoliciesGetIamPolicyOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// get the IAM     policy for a Compute Engine network firewall policy
    /// </summary>
    /// <param name="FirewallPolicy">name of the network firewall policy to get IAM policy.</param>
    public GcloudComputeNetworkFirewallPoliciesGetIamPolicyOptions(
