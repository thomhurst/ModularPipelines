...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/interconnects/application-awareness/configure-bandwidth-percentage-policy
...
[CliSubCommand("preview", "compute", "interconnects", "application-awareness", "configure-bandwidth-percentage-policy")]
public record GcloudPreviewComputeInterconnectsApplicationAwarenessConfigureBandwidthPercentagePolicyOptions : GcloudOptions
{
    /// <summary>
    /// awareness     configure-bandwidth-percentage-policy - configure bandwidth percentage     policy for application awareness configuration of a Compute Engine     interconnect
    /// </summary>
    ...
    public GcloudPreviewComputeInterconnectsApplicationAwarenessConfigureBandwidthPercentagePolicyOptions(
