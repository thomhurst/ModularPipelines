...
public record GcloudPreviewComputeInterconnectsApplicationAwarenessConfigureBandwidthPercentagePolicyOptions(
    [property: CliOption("--bandwidth-percentages", Format = OptionFormat.EqualsSeparated)] string BandwidthPercentages,
