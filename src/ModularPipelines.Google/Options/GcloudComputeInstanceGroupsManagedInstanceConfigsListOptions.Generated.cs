...
public record GcloudComputeInstanceGroupsManagedInstanceConfigsListOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list     per-instance configs of a managed instance group
    /// </summary>
    /// <param name="Name">Name of the managed instance group to list instance configs for.</param>
    public GcloudComputeInstanceGroupsManagedInstanceConfigsListOptions(
        string Name
    )
    {
