...
public record GcloudPreviewComputeHealthChecksUpdateGrpcOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a gRPC health     check
    /// </summary>
    /// <param name="Name">Name of the gRPC health check to update.</param>
    public GcloudPreviewComputeHealthChecksUpdateGrpcOptions(
        string Name
    )
    {
