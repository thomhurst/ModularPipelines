...
// Source: https://cloud.google.com/sdk/gcloud/reference/resource-manager/folders/add-iam-policy-binding
...
[CliSubCommand("resource-manager", "folders", "add-iam-policy-binding")]
public record GcloudResourceManagerFoldersAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM policy     binding for a folder
    /// </summary>
    ...
    /// <param name="Folder">Folder resource - The ID of the folder to add the IAM binding. This represents a Cloud resource. This must be specified. ID of the folder or fully qualified identifier for the folder. To set the folder attribute: ▸ provide the argument folder on the command line.</param>
    public GcloudResourceManagerFoldersAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Folder
    )
    ...
    /// <summary>
    /// Folder resource - The ID of the folder to add the IAM binding. This represents a Cloud resource. This must be specified. ID of the folder or fully qualified identifier for the folder. To set the folder attribute: ▸ provide the argument folder on the command line.
    /// </summary>
