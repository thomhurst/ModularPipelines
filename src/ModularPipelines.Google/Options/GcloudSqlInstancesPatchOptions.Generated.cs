...
public record GcloudSqlInstancesPatchOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((NoBackup == true ? 1 : 0) + (((BackupLocation == string.Empty || !string.IsNullOrWhiteSpace(BackupLocation)) || !string.IsNullOrWhiteSpace(BackupStartTime) || (object?)RetainedBackupsCount is not null || !string.IsNullOrWhiteSpace(RetainedTransactionLogDays)) ? 1 : 0) > 1)
        {
