...
public record GcloudPreviewComputeInstanceGroupsManagedWaitUntilStableOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// waits     until state of managed instance group is stable
    /// </summary>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedWaitUntilStableOptions(
        string Name
    )
    {
