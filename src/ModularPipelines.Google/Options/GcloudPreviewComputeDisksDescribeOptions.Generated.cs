...
public record GcloudPreviewComputeDisksDescribeOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// describe a Compute Engine disk
    /// </summary>
    /// <param name="DiskName">Name of the disk to describe.</param>
    public GcloudPreviewComputeDisksDescribeOptions(
        string DiskName
    )
    {
