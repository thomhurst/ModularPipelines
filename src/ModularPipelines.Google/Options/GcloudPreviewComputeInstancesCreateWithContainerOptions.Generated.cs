...
{
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Attaches accelerators (e.g. GPUs) to the instances. type The specific type (e.g. nvidia-tesla-t4 for NVIDIA T4) of accelerator to attach to the instances. Use 'gcloud compute accelerator-types list' to learn about all available accelerator types. count Number of accelerators to attach to each instance. The default value is 1.
    /// </summary>
    [CliOption("--accelerator", Format = OptionFormat.EqualsSeparated)]
    public string? Accelerator { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Automatically delete boot disks when their instances are deleted. Enabled by default, use --no-boot-disk-auto-delete to disable.
    /// </summary>
    [CliFlag("--boot-disk-auto-delete")]
    public bool? BootDiskAutoDelete { get; set; }

    /// <summary>
    /// Negates --boot-disk-auto-delete. Custom machine type extensions. Specifies the reservation for the instance. Automatically delete boot disks when their instances are deleted. Enabled by default, use --no-boot-disk-auto-delete to disable.
    /// </summary>
    [CliFlag("--no-boot-disk-auto-delete")]
    public bool? NoBootDiskAutoDelete { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The name the guest operating system will see for the boot disk. This option can only be specified if a new boot disk is being created (as opposed to mounting an existing persistent disk).
    /// </summary>
    [CliOption("--boot-disk-device-name", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskDeviceName { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Indicates the interface to use for the boot disk. The value must be one of the following: ◆ SCSI ◆ NVME
    /// </summary>
    [CliOption("--boot-disk-interface", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskInterface { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Indicates how many IOPS to provision for the disk. This sets the number of I/O operations per second that the disk can handle.
    /// </summary>
    [CliOption("--boot-disk-provisioned-iops", Format = OptionFormat.EqualsSeparated)]
    public int? BootDiskProvisionedIops { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Indicates how much throughput to provision for the disk. This sets the number of throughput mb per second that the disk can handle.
    /// </summary>
    ...
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The size of the boot disk. This option can only be specified if a new boot disk is being created (as opposed to mounting an existing persistent disk). The value must be a whole number followed by a size unit of KB for kilobyte, MB for megabyte, GB for gigabyte, or TB for terabyte. For example, 10GB will produce a 10 gigabyte disk. Disk size must be a multiple of 1 GB. Default size unit is GB.
    /// </summary>
    [CliOption("--boot-disk-size", Format = OptionFormat.EqualsSeparated)]
    public int? BootDiskSize { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The type of the boot disk. This option can only be specified if a new boot disk is being created (as opposed to mounting an existing persistent disk). To get a list of available disk types, run $ gcloud compute disk-types list.
    /// </summary>
    [CliOption("--boot-disk-type", Format = OptionFormat.EqualsSeparated)]
    public string? BootDiskType { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. If provided, allows the instances to send and receive packets with non-matching destination or source IP addresses.
    /// </summary>
    [CliFlag("--can-ip-forward")]
    public bool? CanIpForward { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Argument to append to container entrypoint or to override container CMD. Each argument must have a separate flag. Arguments are appended in the order of flags. Example: Assuming the default entry point of the container (or an entry point overridden with --container-command flag) is a Bourne shell-compatible executable, in order to execute 'ls -l' command in the container, the user could use: --container-arg="-c" --container-arg="ls -l" Caveat: due to the nature of the argument parsing, it's impossible to provide the flag value that starts with a dash (-) without the = sign (that is, --container-arg "-c" will not work correctly). Default: None. (no arguments appended)
    /// </summary>
    [CliOption("--container-arg", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerArg { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies what executable to run when the container starts (overrides default entrypoint), eg. nc. Default: None (default container entrypoint is used)
    /// </summary>
    [CliOption("--container-command", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerCommand { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Declare environment variables KEY with value VALUE passed to container. Only the last value of KEY is taken when KEY is repeated more than once. Values, declared with --container-env flag override those with the same KEY from file, provided in --container-env-file.
    /// </summary>
    [CliOption("--container-env", Format = OptionFormat.EqualsSeparated)]
    public IReadOnlyList<KeyValue>? ContainerEnv { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Declare environment variables in a file. Values, declared with --container-env flag override those with the same KEY from file. File with environment variables in format used by docker (almost). This means: ◆ Lines are in format KEY=VALUE. ◆ Values must contain equality signs. ◆ Variables without values are not supported (this is different from docker format). ◆ If # is first non-whitespace character in a line the line is ignored as a comment. ◆ Lines with nothing but whitespace are ignored.
    /// </summary>
    [CliOption("--container-env-file", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerEnvFile { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Full container image name, which should be pulled onto VM instance, eg. docker.io/tomcat.
    /// </summary>
    [CliOption("--container-image", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerImage { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Mounts a disk to the specified mount path in the container. Multiple ' flags are allowed. Must be used with --disk or --create-disk. name Name of the disk. If exactly one additional disk is attached to the instance using --disk or --create-disk, specifying disk name here is optional. The name of the single additional disk will be used by default. mount-path Path on container to mount to. Mount paths with spaces and commas (and other special characters) are not supported by this command. partition Optional. The partition of the disk to mount. Multiple partitions of a disk can be mounted. Can't be used with --create-disk. mode Volume mount mode: rw (read/write) or ro (read-only). Defaults to rw. Fails if the disk mode is ro and volume mount mode is rw.
    /// </summary>
    [CliOption("--container-mount-disk", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerMountDisk { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Mounts a volume by using host-path. host-path Path on host to mount from. mount-path Path on container to mount to. Mount paths with spaces and commas (and other special characters) are not supported by this command. mode Volume mount mode: rw (read/write) or ro (read-only). Default: rw.
    /// </summary>
    [CliOption("--container-mount-host-path", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerMountHostPath { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Mounts empty tmpfs into container at MOUNTPATH. mount-path Path on container to mount to. Mount paths with spaces and commas (and other special characters) are not supported by this command.
    /// </summary>
    [CliOption("--container-mount-tmpfs", Format = OptionFormat.EqualsSeparated)]
    public string? ContainerMountTmpfs { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specify whether to run container in privileged mode. Default: --no-container-privileged.
    /// </summary>
    [CliFlag("--container-privileged")]
    public bool? ContainerPrivileged { get; set; }

    /// <summary>
    /// Negates --container-privileged. Custom machine type extensions. Specifies the reservation for the instance. Specify whether to run container in privileged mode. Default: --no-container-privileged.
    /// </summary>
    [CliFlag("--no-container-privileged")]
    public bool? NoContainerPrivileged { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specify whether to restart a container on exit. POLICY must be one of: never, on-failure, always.
    /// </summary>
    ...
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Enables graceful shutdown for the instance.
    /// </summary>
    [CliFlag("--graceful-shutdown")]
    public bool? GracefulShutdown { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies the maximum time for the graceful shutdown. After this time, the instance is set to STOPPING even if tasks are still running. Specify the time as the number of hours, minutes, or seconds followed by h, m, and s respectively. For example, specify 30m for 30 minutes or 20m10s for 20 minutes and 10 seconds. The value must be between 1 second and 1 hour.
    /// </summary>
    ...
    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies the RFC1918 IP to assign to the instance. The IP should be in the subnet or legacy network IP range.
    /// </summary>
    [CliOption("--private-network-ip", Format = OptionFormat.EqualsSeparated)]
    public string? PrivateNetworkIp { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies the provisioning model for your VM instances. This choice affects the price, availability, and how long your VM instances can run. PROVISIONING_MODEL must be one of: FLEX_START The VM instance is provisioned using the Flex Start provisioning model and has a limited runtime. RESERVATION_BOUND The VM instances run for the entire duration of their associated reservation. You can only specify this provisioning model if you want your VM instances to consume a specific reservation with either a calendar reservation mode or a dense deployment type. SPOT Compute Engine may stop a Spot VM instance whenever it needs capacity. Because Spot VM instances don't have a guaranteed runtime, they come at a discounted price. STANDARD The default option. The STANDARD provisioning model gives you full control over your VM instances' runtime.
    /// </summary>
    [CliOption("--provisioning-model", Format = OptionFormat.EqualsSeparated)]
    public string? ProvisioningModel { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. When you create an instance by using the FLEX_START provisioning model, you can specify the duration to wait for available resources. If the instance creation request is still pending after this duration, then the request fails. You specify a duration by using numbers followed by h, m, and s for hours, minutes, and seconds, respectively. For example, specify 30m for a duration of 30 minutes, or 1h2m3s for 1 hour, 2 minutes, and 3 seconds. Longer durations give you higher chances that your instance creation request succeeds when resources are in high demand.
    /// </summary>
    [CliOption("--request-valid-for-duration", Format = OptionFormat.EqualsSeparated)]
    public string? RequestValidForDuration { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. A list of resource policy names to be added to the instance. The policies must exist in the same region as the instance.
    /// </summary>
    [CliOption("--resource-policies", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? ResourcePolicies { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The instances will be restarted if they are terminated by Compute Engine. This does not affect terminations performed by the user. Enabled by default, use --no-restart-on-failure to disable.
    /// </summary>
    [CliFlag("--restart-on-failure")]
    public bool? RestartOnFailure { get; set; }

    /// <summary>
    /// Negates --restart-on-failure. Custom machine type extensions. Specifies the reservation for the instance. The instances will be restarted if they are terminated by Compute Engine. This does not affect terminations performed by the user. Enabled by default, use --no-restart-on-failure to disable.
    /// </summary>
    [CliFlag("--no-restart-on-failure")]
    public bool? NoRestartOnFailure { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Enables monitoring and attestation of the boot integrity of the instance. The attestation is performed against the integrity policy baseline. This baseline is initially derived from the implicitly trusted boot image when the instance is created. This baseline can be updated by using gcloud compute instances update-container --shielded-learn-integrity-policy. On Shielded VM instances, integrity monitoring is enabled by default. For information about how to modify Shielded VM options, see https://cloud.google.com/compute/docs/instances/modifying-shielded-vm. For information about monitoring integrity on Shielded VM instances, see https://cloud.google.com/compute/docs/instances/integrity-monitoring."
    /// </summary>
    [CliFlag("--shielded-integrity-monitoring")]
    public bool? ShieldedIntegrityMonitoring { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The instance boots with secure boot enabled. On Shielded VM instances, Secure Boot is not enabled by default. For information about how to modify Shielded VM options, see https://cloud.google.com/compute/docs/instances/modifying-shielded-vm.
    /// </summary>
    [CliFlag("--shielded-secure-boot")]
    public bool? ShieldedSecureBoot { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The instance boots with the TPM (Trusted Platform Module) enabled. A TPM is a hardware module that can be used for different security operations such as remote attestation, encryption, and sealing of keys. On Shielded VM instances, vTPM is enabled by default. For information about how to modify Shielded VM options, see https://cloud.google.com/compute/docs/instances/modifying-shielded-vm.
    /// </summary>
    [CliFlag("--shielded-vtpm")]
    public bool? ShieldedVtpm { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. If enabled, then, when the instance is stopped or deleted, the instance is immediately stopped without giving time to the guest OS to cleanly shut down. Use --skip-guest-os-shutdown to enable and --no-skip-guest-os-shutdown to disable.
    /// </summary>
    [CliFlag("--skip-guest-os-shutdown")]
    public bool? SkipGuestOsShutdown { get; set; }

    /// <summary>
    /// Negates --skip-guest-os-shutdown. Custom machine type extensions. Specifies the reservation for the instance. If enabled, then, when the instance is stopped or deleted, the instance is immediately stopped without giving time to the guest OS to cleanly shut down. Use --skip-guest-os-shutdown to enable and --no-skip-guest-os-shutdown to disable.
    /// </summary>
    [CliFlag("--no-skip-guest-os-shutdown")]
    public bool? NoSkipGuestOsShutdown { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. The name of the instance template that the instance will be created from. An instance template can be a global/regional resource. Users can override instance properties using other flags.
    /// </summary>
    [CliOption("--source-instance-template", Format = OptionFormat.EqualsSeparated)]
    public string? SourceInstanceTemplate { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies whether IPv6 is enabled on the default network interface. If not specified, IPV4_ONLY will be used. STACK_TYPE must be one of: IPV4_IPV6 The network interface can have both IPv4 and IPv6 addresses IPV4_ONLY The network interface will be assigned IPv4 addresses IPV6_ONLY The network interface will be assigned IPv6 addresses
    /// </summary>
    [CliOption("--stack-type", Format = OptionFormat.EqualsSeparated)]
    public string? StackType { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies the subnet that the VM instances are a part of. If --network is also specified, subnet must be a subnetwork of the network specified by the --network flag.
    /// </summary>
    [CliOption("--subnet", Format = OptionFormat.EqualsSeparated)]
    public string? Subnet { get; set; }

    /// <summary>
    /// Custom machine type extensions. Specifies the reservation for the instance. Specifies a list of tags to apply to the instance. These tags allow network firewall rules and routes to be applied to specified VM instances. See gcloud compute firewall-rules create(1) for more details. To read more about configuring network tags, read this guide: https://cloud.google.com/vpc/docs/add-remove-network-tags To list instances with their respective status and tags, run: $ gcloud compute instances list \ --format='table(name,status,tags.list())' To list instances tagged with a specific tag, tag1, run: $ gcloud compute instances list --filter='tags:tag1'
    /// </summary>
