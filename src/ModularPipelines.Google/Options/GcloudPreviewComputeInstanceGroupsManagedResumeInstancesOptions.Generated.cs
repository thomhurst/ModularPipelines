...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/instance-groups/managed/resume-instances
...
[CliSubCommand("preview", "compute", "instance-groups", "managed", "resume-instances")]
public record GcloudPreviewComputeInstanceGroupsManagedResumeInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// resume     the suspended instances in a managed instance group
    /// </summary>
    /// <param name="Instances">Names of instances to resume. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).</param>
    /// <param name="Name">Name of the managed instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsManagedResumeInstancesOptions(
    ...
    /// <summary>
    /// Names of instances to resume. Collection entries are joined with commas into one option value. For entries containing commas, supply one pre-escaped list value using gcloud topic escaping (https://cloud.google.com/sdk/gcloud/reference/topic/escaping).
    /// </summary>
