...
// Source: https://cloud.google.com/sdk/gcloud/reference/composer/environments/user-workloads-config-maps/delete
...
[CliSubCommand("composer", "environments", "user-workloads-config-maps", "delete")]
public record GcloudComposerEnvironmentsUserWorkloadsConfigMapsDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete a     user workloads ConfigMap
    /// </summary>
    ...
    public GcloudComposerEnvironmentsUserWorkloadsConfigMapsDeleteOptions(
        string Environment
    )
    {
