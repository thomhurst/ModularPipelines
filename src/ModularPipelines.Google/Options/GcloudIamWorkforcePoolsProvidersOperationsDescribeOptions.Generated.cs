...
// Source: https://cloud.google.com/sdk/gcloud/reference/iam/workforce-pools/providers/operations/describe
...
[CliSubCommand("iam", "workforce-pools", "providers", "operations", "describe")]
public record GcloudIamWorkforcePoolsProvidersOperationsDescribeOptions : GcloudOptions
{
    /// <summary>
    /// describe a     workforce pool provider operation
    /// </summary>
    /// <param name="Operation">Workforce pool provider operation resource - The workforce pool provider long-running operation to describe. The arguments in this group can be used to specify the attributes of this resource. This must be specified. ID of the workforce pool provider operation or fully qualified identifier for the workforce pool provider operation. To set the operation attribute: ▸ provide the argument operation on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudIamWorkforcePoolsProvidersOperationsDescribeOptions(
        string Operation
    )
    {
