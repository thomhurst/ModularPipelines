...
public record GcloudPreviewComputeReservationsSubBlocksPerformMaintenanceOptions : GcloudOptions
{
    /// <summary>
    /// perform maintenance on a reservation sub-block
    /// </summary>
    ...
    public GcloudPreviewComputeReservationsSubBlocksPerformMaintenanceOptions(
        string BlockName,
        string SubBlockName,
        string Reservation
    )
