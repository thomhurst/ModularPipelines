...
public record GcloudDataplexEntriesCreateOptions : GcloudOptions
{
    ...
    public GcloudDataplexEntriesCreateOptions(
        string EntryType,
        string Entry
    )
    {
    ...
    public void Deconstruct(out string EntryType, out string Entry)
    {
    ...
    /// </summary>
    [CliOption("--entry-type", Format = OptionFormat.EqualsSeparated)]
