...
public record GcloudPrivatecaTemplatesUpdateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Constraints on requested X.509 extensions. At most one of these can be specified: Or at least one of these can be specified: Constraints on known extensions. At most one of these can be specified: If this is set, then all known extensions will be removed from the template, prohibiting any known x509 extensions to be specified by the requester.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("At most one of CopyAllRequestedExtensions or (CopyExtensionsByOid, DropOidExtensions, CopyKnownExtensions, or DropKnownExtensions) may be specified.", [nameof(CopyAllRequestedExtensions), nameof(CopyExtensionsByOid), nameof(DropOidExtensions), nameof(CopyKnownExtensions), nameof(DropKnownExtensions)]);
        }
