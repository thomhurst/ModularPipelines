...
public record GcloudComputeHealthChecksUpdateGrpcWithTlsOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// update a gRPC with TLS     health check
    /// </summary>
    /// <param name="Name">Name of the gRPC with TLS health check to update.</param>
    public GcloudComputeHealthChecksUpdateGrpcWithTlsOptions(
        string Name
    )
    {
