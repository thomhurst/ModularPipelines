...
public record GcloudBeyondcorpSecurityGatewaysApplicationsListOptions(
    [property: CliOption("--security-gateway", Format = OptionFormat.EqualsSeparated)] string SecurityGateway
) : GcloudOptions
{
    /// <summary>
