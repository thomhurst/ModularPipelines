...
public record GcloudComputeNetworksSubnetsUpdateOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// updates properties of an existing     Compute Engine subnetwork
    /// </summary>
    /// <param name="Name">Name of the subnetwork to update.</param>
    public GcloudComputeNetworksSubnetsUpdateOptions(
        string Name
    )
    {
    ...
    public GcloudComputeNetworksSubnetsUpdateLoggingAggregationInterval? LoggingAggregationInterval { get; set; }
    ...
    public GcloudComputeNetworksSubnetsUpdateLoggingMetadata? LoggingMetadata { get; set; }
