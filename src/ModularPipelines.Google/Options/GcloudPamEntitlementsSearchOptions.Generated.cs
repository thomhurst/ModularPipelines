...
public record GcloudPamEntitlementsSearchOptions : GcloudOptions
{
    ...
    public GcloudPamEntitlementsSearchOptions(
        GcloudPamEntitlementsSearchCallerAccessType CallerAccessType,
        string Location
    )
    {
    ...
    public void Deconstruct(out GcloudPamEntitlementsSearchCallerAccessType CallerAccessType, out string Location)
    {
    ...
    public GcloudPamEntitlementsSearchCallerAccessType CallerAccessType { get; private init; }
