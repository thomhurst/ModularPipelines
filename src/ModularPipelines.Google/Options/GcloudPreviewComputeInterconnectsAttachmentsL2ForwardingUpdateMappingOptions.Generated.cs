...
public record GcloudPreviewComputeInterconnectsAttachmentsL2ForwardingUpdateMappingOptions : GcloudOptions
{
    /// <summary>
    /// forwarding     update-mapping - update vlan to ip mapping rule to an L2-forwarding     attachment
    /// </summary>
    ...
    public GcloudPreviewComputeInterconnectsAttachmentsL2ForwardingUpdateMappingOptions(
        string VlanKey,
        string Name
    )
    {
