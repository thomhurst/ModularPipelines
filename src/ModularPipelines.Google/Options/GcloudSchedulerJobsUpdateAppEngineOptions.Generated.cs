...
public record GcloudSchedulerJobsUpdateAppEngineOptions : GcloudOptions
{
    ...
    /// <summary>
    /// --http-method=HTTP_METHOD; default="post" HTTP method to use for the request. HTTP_METHOD must be one of: delete, get, head, post, put. Version of the App Engine service to send the request to.
    /// </summary>
    ...
    /// <summary>
    /// --http-method=HTTP_METHOD; default="post" HTTP method to use for the request. HTTP_METHOD must be one of: delete, get, head, post, put. --min-backoff=MIN_BACKOFF; default="5s" Minimum amount of time to wait before retrying a job after it fails. For example, 10s. Default is 5s. At most one of these can be specified: Clear the field corresponding to --relative-url.
    /// </summary>
    [CliFlag("--clear-relative-url")]
    public bool? ClearRelativeUrl { get; set; }

    /// <summary>
    /// --http-method=HTTP_METHOD; default="post" HTTP method to use for the request. HTTP_METHOD must be one of: delete, get, head, post, put. --relative-url=RELATIVE_URL; default="/" Relative URL to use for the request (beginning with "/"). At most one of these can be specified: Clear the field corresponding to --service.
    /// </summary>
    [CliFlag("--clear-service")]
    public bool? ClearService { get; set; }

    /// <summary>
    /// --http-method=HTTP_METHOD; default="post" HTTP method to use for the request. HTTP_METHOD must be one of: delete, get, head, post, put. --service=SERVICE; default="default" ID of the App Engine service to send the request to. At most one of these can be specified: Clear the field corresponding to --time-zone.
    /// </summary>
