...
public record GcloudStorageBucketsRemoveIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// remove an IAM policy     binding from a bucket
    /// </summary>
    ...
    /// <param name="Url">URL of bucket to remove IAM policy binding from.</param>
    public GcloudStorageBucketsRemoveIamPolicyBindingOptions(
        string Member,
        string Role,
        string Url
    )
