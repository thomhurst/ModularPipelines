...
// Source: https://cloud.google.com/sdk/gcloud/reference/preview/compute/external-vpn-gateways/test-iam-permissions
...
[CliSubCommand("preview", "compute", "external-vpn-gateways", "test-iam-permissions")]
public record GcloudPreviewComputeExternalVpnGatewaysTestIamPermissionsOptions : GcloudOptions
{
    /// <summary>
    /// test     IAM permissions for a Compute Engine external VPN gateway
    /// </summary>
    ...
    /// <param name="Name">Name of the external VPN gateway to test IAM permissions for.</param>
    public GcloudPreviewComputeExternalVpnGatewaysTestIamPermissionsOptions(
