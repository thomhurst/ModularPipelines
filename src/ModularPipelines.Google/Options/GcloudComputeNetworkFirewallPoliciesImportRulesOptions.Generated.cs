...
public record GcloudComputeNetworkFirewallPoliciesImportRulesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// import a Compute     Engine network firewall policy rules
    /// </summary>
    /// <param name="FirewallPolicy">name of the network firewall policy to import rules to.</param>
    public GcloudComputeNetworkFirewallPoliciesImportRulesOptions(
