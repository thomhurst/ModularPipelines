...
public record GcloudOracleDatabaseDbSystemsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The password for the default ADMIN user. Note: Only one of admin_password_secret_version or admin_password can be populated.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The character set for the database. The default is AL32UTF8.
    /// </summary>
    [CliOption("--database-character-set", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseCharacterSet { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The name of the DbHome resource associated with the Database.
    /// </summary>
    [CliOption("--database-db-home-name", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseDbHomeName { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The database name. The name must begin with an alphabetic character and can contain a maximum of eight alphanumeric characters. Special characters are not permitted.
    /// </summary>
    [CliOption("--database-db-name", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseDbName { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The DB_UNIQUE_NAME of the Oracle Database being backed up.
    /// </summary>
    [CliOption("--database-db-unique-name", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseDbUniqueName { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The database ID of the Database.
    /// </summary>
    [CliOption("--database-id", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseId { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. Identifier. The name of the Database resource in the following format: projects/{project}/locations/{region}/databases/{database}
    /// </summary>
    [CliOption("--database-name", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseName { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The national character set for the database. The default is AL16UTF16.
    /// </summary>
    [CliOption("--database-ncharacter-set", Format = OptionFormat.EqualsSeparated)]
    public string? DatabaseNcharacterSet { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The ID of the pluggable database associated with the Database. The ID must be unique within the project and location.
    /// </summary>
    [CliOption("--database-pluggable-id", Format = OptionFormat.EqualsSeparated)]
    public string? DatabasePluggableId { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The pluggable database associated with the Database. The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters.
    /// </summary>
    [CliOption("--database-pluggable-name", Format = OptionFormat.EqualsSeparated)]
    public string? DatabasePluggableName { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The TDE wallet password for the database. Note: Only one of tde_wallet_password_secret_version or tde_wallet_password can be populated.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. SecretVersion resource - The resource name of a secret version in Secret Manager which contains the TDE wallet password for the database. Format: projects/{project}/secrets/{secret}/versions/{version}. Note: Only one of tde_wallet_password_secret_version or tde_wallet_password can be populated. This represents a Cloud resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ▸ provide the argument --database-tde-wallet-password-secret-version on the command line with a fully specified name; ▸ provide the argument --project on the command line; ▸ set the property core/project. To set the secret attribute: ▸ provide the argument --database-tde-wallet-password-secret-version on the command line with a fully specified name; ▸ provide the argument --secret on the command line. ID of the secretVersion or fully qualified identifier for the secretVersion. To set the secret-version attribute: ▸ provide the argument --database-tde-wallet-password-secret-version on the command line.
    /// </summary>
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The Oracle Database version. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--properties-db-version", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesDbVersion { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. If set to true, enables automatic backups on the database.
    /// </summary>
    [CliFlag("--db-backup-config-auto-enabled")]
    public bool? DbBackupConfigAutoEnabled { get; set; }

    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The day of the week on which the full backup should be performed on the database. If no value is provided, it will default to Sunday. DB_BACKUP_CONFIG_AUTO_FULL_DAY must be one of: friday Friday monday Monday saturday Saturday sunday Sunday thursday Thursday tuesday Tuesday wednesday Wednesday
    /// </summary>
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The window in which the full backup should be performed on the database. If no value is provided, the default is anytime. DB_BACKUP_CONFIG_AUTO_FULL_WINDOW must be one of: slot-eight 2:00 PM - 4:00 PM slot-eleven 8:00 PM - 10:00 PM slot-five 8:00 AM - 10:00 AM slot-four 6:00 AM - 8:00 AM slot-nine 4:00 PM - 6:00 PM slot-one 12:00 AM - 2:00 AM slot-seven 12:00 PM - 2:00 PM slot-six 10:00 AM - 12:00 PM slot-ten 6:00 PM - 8:00 PM slot-three 4:00 AM - 6:00 AM slot-twelve 10:00 PM - 12:00 AM slot-two 2:00 AM - 4:00 AM
    /// </summary>
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The window in which the incremental backup should be performed on the database. If no value is provided, the default is anytime except the auto full backup day. DB_BACKUP_CONFIG_AUTO_INCREMENTAL_WINDOW must be one of: slot-eight 2:00 PM - 4:00 PM slot-eleven 8:00 PM - 10:00 PM slot-five 8:00 AM - 10:00 AM slot-four 6:00 AM - 8:00 AM slot-nine 4:00 PM - 6:00 PM slot-one 12:00 AM - 2:00 AM slot-seven 12:00 PM - 2:00 PM slot-six 10:00 AM - 12:00 PM slot-ten 6:00 PM - 8:00 PM slot-three 4:00 AM - 6:00 AM slot-twelve 10:00 PM - 12:00 AM slot-two 2:00 AM - 4:00 AM
    /// </summary>
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. Details of the database backup destinations. type The type of the database backup destination. Shorthand Example: --db-backup-config-destination-details=type=string --db-backup-config-destination-details=type=string JSON Example: --db-backup-config-destination-details='[{"type": "string"}]' File Example: --db-backup-config-destination-details=path_to_file.(yaml|json)
    /// </summary>
    ...
    /// <summary>
    /// Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The properties of a Database. Backup Options for the Database. The number of days an automatic backup is retained before being automatically deleted. This value determines the earliest point in time to which a database can be restored. Min: 1, Max: 60.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(DbHomeVersion) || !string.IsNullOrWhiteSpace(DbHomeDisplayName) || DbHomeIsUnifiedAuditingEnabled == true || !string.IsNullOrWhiteSpace(TimeZoneId) || !string.IsNullOrWhiteSpace(TimeZoneVersion) || !string.IsNullOrWhiteSpace(DatabaseAdminPassword) || !string.IsNullOrWhiteSpace(DatabaseCharacterSet) || !string.IsNullOrWhiteSpace(DatabaseDbHomeName) || !string.IsNullOrWhiteSpace(DatabaseDbName) || !string.IsNullOrWhiteSpace(DatabaseDbUniqueName) || !string.IsNullOrWhiteSpace(DatabaseId) || !string.IsNullOrWhiteSpace(DatabaseName) || !string.IsNullOrWhiteSpace(DatabaseNcharacterSet) || !string.IsNullOrWhiteSpace(DatabasePluggableId) || !string.IsNullOrWhiteSpace(DatabasePluggableName) || !string.IsNullOrWhiteSpace(DatabaseTdeWalletPassword) || !string.IsNullOrWhiteSpace(PropertiesDbVersion) || DbBackupConfigAutoEnabled == true || !string.IsNullOrWhiteSpace(DbBackupConfigAutoFullDay) || !string.IsNullOrWhiteSpace(DbBackupConfigAutoFullWindow) || !string.IsNullOrWhiteSpace(DbBackupConfigAutoIncrementalWindow) || !string.IsNullOrWhiteSpace(DbBackupConfigDeletionPolicy) || ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair>)(object)DbBackupConfigDestinationDetails, static item => item is not null) : ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<char> ? (object?)DbBackupConfigDestinationDetails is not string || !string.IsNullOrWhiteSpace(DbBackupConfigDestinationDetails?.ToString()) : ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)DbBackupConfigDestinationDetails, static item => item is not null) : (DbBackupConfigDestinationDetails is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)DbBackupConfigDestinationDetails), static item => item is not null))))) || !string.IsNullOrWhiteSpace(DbBackupConfigRetentionPeriodDays) || !string.IsNullOrWhiteSpace(DatabaseAdminPasswordSecretVersion) || !string.IsNullOrWhiteSpace(DatabaseTdeWalletPasswordSecretVersion)) && (!(!string.IsNullOrWhiteSpace(DbHomeVersion))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(DbHomeVersion) || !string.IsNullOrWhiteSpace(DbHomeDisplayName) || DbHomeIsUnifiedAuditingEnabled == true || !string.IsNullOrWhiteSpace(TimeZoneId) || !string.IsNullOrWhiteSpace(TimeZoneVersion) || !string.IsNullOrWhiteSpace(DatabaseAdminPassword) || !string.IsNullOrWhiteSpace(DatabaseCharacterSet) || !string.IsNullOrWhiteSpace(DatabaseDbHomeName) || !string.IsNullOrWhiteSpace(DatabaseDbName) || !string.IsNullOrWhiteSpace(DatabaseDbUniqueName) || !string.IsNullOrWhiteSpace(DatabaseId) || !string.IsNullOrWhiteSpace(DatabaseName) || !string.IsNullOrWhiteSpace(DatabaseNcharacterSet) || !string.IsNullOrWhiteSpace(DatabasePluggableId) || !string.IsNullOrWhiteSpace(DatabasePluggableName) || !string.IsNullOrWhiteSpace(DatabaseTdeWalletPassword) || !string.IsNullOrWhiteSpace(PropertiesDbVersion) || DbBackupConfigAutoEnabled == true || !string.IsNullOrWhiteSpace(DbBackupConfigAutoFullDay) || !string.IsNullOrWhiteSpace(DbBackupConfigAutoFullWindow) || !string.IsNullOrWhiteSpace(DbBackupConfigAutoIncrementalWindow) || !string.IsNullOrWhiteSpace(DbBackupConfigDeletionPolicy) || ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair>)(object)DbBackupConfigDestinationDetails, static item => item is not null) : ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<char> ? (object?)DbBackupConfigDestinationDetails is not string || !string.IsNullOrWhiteSpace(DbBackupConfigDestinationDetails?.ToString()) : ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)DbBackupConfigDestinationDetails, static item => item is not null) : (DbBackupConfigDestinationDetails is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)DbBackupConfigDestinationDetails), static item => item is not null))))) || !string.IsNullOrWhiteSpace(DbBackupConfigRetentionPeriodDays) || !string.IsNullOrWhiteSpace(DatabaseAdminPasswordSecretVersion) || !string.IsNullOrWhiteSpace(DatabaseTdeWalletPasswordSecretVersion)) && (!(!string.IsNullOrWhiteSpace(DatabaseAdminPassword) || !string.IsNullOrWhiteSpace(DatabaseCharacterSet) || !string.IsNullOrWhiteSpace(DatabaseDbHomeName) || !string.IsNullOrWhiteSpace(DatabaseDbName) || !string.IsNullOrWhiteSpace(DatabaseDbUniqueName) || !string.IsNullOrWhiteSpace(DatabaseId) || !string.IsNullOrWhiteSpace(DatabaseName) || !string.IsNullOrWhiteSpace(DatabaseNcharacterSet) || !string.IsNullOrWhiteSpace(DatabasePluggableId) || !string.IsNullOrWhiteSpace(DatabasePluggableName) || !string.IsNullOrWhiteSpace(DatabaseTdeWalletPassword) || !string.IsNullOrWhiteSpace(PropertiesDbVersion) || DbBackupConfigAutoEnabled == true || !string.IsNullOrWhiteSpace(DbBackupConfigAutoFullDay) || !string.IsNullOrWhiteSpace(DbBackupConfigAutoFullWindow) || !string.IsNullOrWhiteSpace(DbBackupConfigAutoIncrementalWindow) || !string.IsNullOrWhiteSpace(DbBackupConfigDeletionPolicy) || ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.CliValuePair>)(object)DbBackupConfigDestinationDetails, static item => item is not null) : ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<char> ? (object?)DbBackupConfigDestinationDetails is not string || !string.IsNullOrWhiteSpace(DbBackupConfigDestinationDetails?.ToString()) : ((object?)DbBackupConfigDestinationDetails is global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue> ? global::System.Linq.Enumerable.Any((global::System.Collections.Generic.IEnumerable<global::ModularPipelines.Models.KeyValue>)(object)DbBackupConfigDestinationDetails, static item => item is not null) : (DbBackupConfigDestinationDetails is not null && global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>((global::System.Collections.IEnumerable)(object)DbBackupConfigDestinationDetails), static item => item is not null))))) || !string.IsNullOrWhiteSpace(DbBackupConfigRetentionPeriodDays) || !string.IsNullOrWhiteSpace(DatabaseAdminPasswordSecretVersion) || !string.IsNullOrWhiteSpace(DatabaseTdeWalletPasswordSecretVersion))))
        {
            yield return new ValidationResult("At least one of DatabaseAdminPassword, DatabaseCharacterSet, DatabaseDbHomeName, DatabaseDbName, DatabaseDbUniqueName, DatabaseId, DatabaseName, DatabaseNcharacterSet, DatabasePluggableId, DatabasePluggableName, DatabaseTdeWalletPassword, PropertiesDbVersion, DbBackupConfigAutoEnabled, DbBackupConfigAutoFullDay, DbBackupConfigAutoFullWindow, DbBackupConfigAutoIncrementalWindow, DbBackupConfigDeletionPolicy, DbBackupConfigDestinationDetails, DbBackupConfigRetentionPeriodDays, DatabaseAdminPasswordSecretVersion, or DatabaseTdeWalletPasswordSecretVersion must be specified.", [nameof(DatabaseAdminPassword), nameof(DatabaseCharacterSet), nameof(DatabaseDbHomeName), nameof(DatabaseDbName), nameof(DatabaseDbUniqueName), nameof(DatabaseId), nameof(DatabaseName), nameof(DatabaseNcharacterSet), nameof(DatabasePluggableId), nameof(DatabasePluggableName), nameof(DatabaseTdeWalletPassword), nameof(PropertiesDbVersion), nameof(DbBackupConfigAutoEnabled), nameof(DbBackupConfigAutoFullDay), nameof(DbBackupConfigAutoFullWindow), nameof(DbBackupConfigAutoIncrementalWindow), nameof(DbBackupConfigDeletionPolicy), nameof(DbBackupConfigDestinationDetails), nameof(DbBackupConfigRetentionPeriodDays), nameof(DatabaseAdminPasswordSecretVersion), nameof(DatabaseTdeWalletPasswordSecretVersion)]);
        }
        yield break;
    }
