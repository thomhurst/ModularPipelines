...
public record GcloudOracleDatabaseDbSystemsCreateOptions(
...
{
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Return immediately, without waiting for the operation in progress to complete.
    /// </summary>
    [CliFlag("--async")]
    public bool? Async { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The GCP Oracle zone where Oracle DbSystem is hosted. Example: us-east4-b-r2. If not specified, the system will pick a zone based on availability.
    /// </summary>
    [CliOption("--gcp-oracle-zone", Format = OptionFormat.EqualsSeparated)]
    public string? GcpOracleZone { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The labels or tags associated with the DbSystem. KEY Keys must start with a lowercase character and contain only hyphens (-), underscores (_), lowercase characters, and numbers. VALUE Values must contain only hyphens (-), underscores (_), lowercase characters, and numbers. Shorthand Example: --labels=string=string JSON Example: --labels='{"string": "string"}' File Example: --labels=path_to_file.(yaml|json)
    /// </summary>
    [CliOption("--labels", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? Labels { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. For resources [db_system, odb-network, odb-subnet], provides fallback value for resource location attribute. When the resource's full URI path is not provided, location will fallback to this flag value.
    /// </summary>
    [CliOption("--location", Format = OptionFormat.EqualsSeparated)]
    public string? Location { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. For resources [odb-network, odb-subnet], provides fallback value for resource odb-network attribute. When the resource's full URI path is not provided, odb-network will fallback to this flag value.
    /// </summary>
    [CliOption("--odb-network", Format = OptionFormat.EqualsSeparated)]
    public string? OdbNetwork { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
    /// </summary>
    [CliOption("--request-id", Format = OptionFormat.EqualsSeparated)]
    public string? RequestId { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. For resources [database-admin-password-secret-version, database-tde-wallet-password-secret-version], provides fallback value for resource secret attribute. When the resource's full URI path is not provided, secret will fallback to this flag value.
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The number of CPU cores to enable for the DbSystem. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--properties-compute-count", Format = OptionFormat.EqualsSeparated)]
    public int? PropertiesComputeCount { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The database edition of the DbSystem. PROPERTIES_DATABASE_EDITION must be one of: enterprise-edition The database edition is Enterprise. enterprise-edition-high-performance The database edition is Enterprise Edition. standard-edition The database edition is Standard. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--properties-database-edition", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesDatabaseEdition { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The initial data storage size in GB. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The license model of the DbSystem. PROPERTIES_LICENSE_MODEL must be one of: bring-your-own-license The license model is bring your own license. license-included The license model is included. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--properties-license-model", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesLicenseModel { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Shape of DB System. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--properties-shape", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesShape { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. SSH public keys to be stored with the DbSystem. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The storage option used in DB system. DB_SYSTEM_OPTIONS_STORAGE_MANAGEMENT must be one of: asm Automatic storage management. This option is not supported. Only LVM is supported. lvm Logical Volume management.
    /// </summary>
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The compute model of the DbSystem. PROPERTIES_COMPUTE_MODEL must be one of: ecpu The compute model is virtual. ocpu Deprecated: This option is not supported. Please use ECPU instead. The compute model is physical.
    /// </summary>
    [CliOption("--properties-compute-model", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesComputeModel { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The data storage size in GB that is currently available to DbSystems. The value is same as initial_data_storage_size_gb. This can be modified from OCI console.
    /// </summary>
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The host domain name of the DbSystem.
    /// </summary>
    [CliOption("--properties-domain", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesDomain { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Prefix for DB System host names.
    /// </summary>
    [CliOption("--properties-hostname-prefix", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesHostnamePrefix { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The memory size in GB. This value can not be set and is automatically calculated based on the number of ECPUs allocated to the DbSystem.
    /// </summary>
    [CliOption("--properties-memory-size-gb", Format = OptionFormat.EqualsSeparated)]
    public int? PropertiesMemorySizeGb { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The number of nodes to launch for a virtual machine DbSystem. By default this will be set to 1.
    /// </summary>
    [CliOption("--properties-node-count", Format = OptionFormat.EqualsSeparated)]
    public int? PropertiesNodeCount { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The private IP address of the DbSystem.
    /// </summary>
    [CliOption("--properties-private-ip", Format = OptionFormat.EqualsSeparated)]
    public string? PropertiesPrivateIp { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. The reco/redo storage size in GB. The value for recovery storage size is based on the available data storage size.
    /// </summary>
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Indicates whether to enable data collection for diagnostics.
    /// </summary>
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Indicates whether to enable incident logs and trace collection.
    /// </summary>
    [CliFlag("--data-collection-options-is-incident-logs-enabled")]
    public bool? DataCollectionOptionsIsIncidentLogsEnabled { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). A valid Oracle Database version. For a list of supported versions, use the ListDbVersions operation. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--db-home-version", Format = OptionFormat.EqualsSeparated)]
    public string? DbHomeVersion { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). The display name for the Database Home. The name does not have to be unique within your project.
    /// </summary>
    [CliOption("--db-home-display-name", Format = OptionFormat.EqualsSeparated)]
    public string? DbHomeDisplayName { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Whether unified auditing is enabled for the Database Home.
    /// </summary>
    [CliFlag("--db-home-is-unified-auditing-enabled")]
    public bool? DbHomeIsUnifiedAuditingEnabled { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). Details of the Database resource. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/Database/ At least one of these must be specified: The password for the default ADMIN user. Note: Only one of admin_password_secret_version or admin_password can be populated.
    /// </summary>
    [SecretValue]
    ...
    public IEnumerable<string>? DbBackupConfigDestinationDetails { get; set; }
    ...
    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). IANA Time Zone Database time zone. For example "America/New_York".
    /// </summary>
    [CliOption("--time-zone-id", Format = OptionFormat.EqualsSeparated)]
    public string? TimeZoneId { get; set; }

    /// <summary>
    /// The properties of a DbSystem. Details of the DbSystem Options. Data collection options for DbSystem. Details of the Database Home resource. Represents a time zone from the IANA Time Zone Database (https://www.iana.org/time-zones). IANA Time Zone Database version number. For example "2019a".
    /// </summary>
