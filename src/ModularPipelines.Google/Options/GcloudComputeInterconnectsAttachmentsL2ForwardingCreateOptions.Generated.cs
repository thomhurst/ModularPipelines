...
public record GcloudComputeInterconnectsAttachmentsL2ForwardingCreateOptions : GcloudOptions
{
    /// <summary>
    /// create a     Compute Engine L2 forwarding interconnect attachment
    /// </summary>
    ...
    public GcloudComputeInterconnectsAttachmentsL2ForwardingCreateOptions(
        string GeneveVni,
        string Interconnect,
        string Network,
