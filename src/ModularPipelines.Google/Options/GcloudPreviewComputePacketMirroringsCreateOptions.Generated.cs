...
public record GcloudPreviewComputePacketMirroringsCreateOptions : GcloudOptions
{
    /// <summary>
    /// create a Compute Engine     packet mirroring policy
    /// </summary>
    ...
    public GcloudPreviewComputePacketMirroringsCreateOptions(
        string CollectorIlb,
        string Network,
        string Name
    )
    ...
    public GcloudPreviewComputePacketMirroringsCreateFilterDirection? FilterDirection { get; set; }
