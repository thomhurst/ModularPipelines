...
public record GcloudDesignCenterSpacesApplicationsCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Holds parameters that are specific to composite applications. Connection configuration for the application. connectionUri The connection URI. destinationComponentParameters The parameters of the connection associated with the destination component. key The key of the parameter. value The value of the parameter. sourceComponentParameters The parameters of the connection associated with the source component. key The key of the parameter. value The value of the parameter. Shorthand Example: --connection-configs=connectionUri=string,destinationComponentParameters=[{key=string,value={...}}],sourceComponentParameters=[{key=string,value={...}}] --connection-configs=connectionUri=string,destinationComponentParameters=[{key=string,value={...}}],sourceComponentParameters=[{key=string,value={...}}] JSON Example: --connection-configs='[{"connectionUri": "string", "destinationComponentParameters": [{"key": "string", "value": {...}}], "sourceComponentParameters": [{"key": "string", "value": {...}}]}]' File Example: --connection-configs=path_to_file.(yaml|json)
    /// </summary>
    [CliOption("--connection-configs", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? ConnectionConfigs { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. Deployment project of the application.
    /// </summary>
    [CliOption("--deployment-project", Format = OptionFormat.EqualsSeparated)]
    public string? DeploymentProject { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. The region where the application is deployed.
    /// </summary>
    [CliOption("--deployment-region", Format = OptionFormat.EqualsSeparated)]
    public string? DeploymentRegion { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. Description of the application.
    /// </summary>
    [CliOption("--description", Format = OptionFormat.EqualsSeparated)]
    public string? Description { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. Display name of the application.
    /// </summary>
    [CliOption("--display-name", Format = OptionFormat.EqualsSeparated)]
    public string? DisplayName { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. Import existing resources into the application.
    /// </summary>
    [CliFlag("--import-existing-resources")]
    public bool? ImportExistingResources { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. Specifies the strategy to use when updating the application parameters while updating the application template revision. PARAMS_UPDATE_STRATEGY must be (only one value is supported): replace Replaces the existing field values with the provided ones.
    /// </summary>
    [CliOption("--params-update-strategy", Format = OptionFormat.EqualsSeparated)]
    public string? ParamsUpdateStrategy { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. Your own service account that you use to deploy an application.
    /// </summary>
    [CliOption("--service-account", Format = OptionFormat.EqualsSeparated)]
    public string? ServiceAccount { get; set; }

    /// <summary>
    /// Holds parameters that are specific to composite applications. The type of the application. TYPE must be one of: helm-app Application type is helm application. terraform-app Application type is terraform application.
    /// </summary>
