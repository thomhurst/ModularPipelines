...
/// </summary>
/// <param name="ScopeType">Scope of an application. This must be specified. Scope Type. SCOPE_TYPE must be one of: global Global type. regional Regional type.</param>
[GeneratedCode("ModularPipelines.OptionsGenerator", "2.0.0")]
[ExcludeFromCodeCoverage]
[CliSubCommand("design-center", "spaces", "applications", "create")]
public record GcloudDesignCenterSpacesApplicationsCreateOptions(
    [property: CliOption("--scope-type", Format = OptionFormat.EqualsSeparated)] string ScopeType
) : GcloudOptions
{
    /// <summary>
    /// Scope of an application. This must be specified. Source template information for the deployment. This must be specified. Arguments for the source. At most one of these can be specified: Application template revision URI.
    /// </summary>
    ...
    /// <summary>
    /// Scope of an application. This must be specified. Source template information for the deployment. This must be specified. Arguments for the source. At most one of these can be specified: Shared template revision URI.
    /// </summary>
