...
/// </summary>
/// <param name="AwsAccessKeyId">Image import from AWS. Access key ID for a temporary AWS credential. This ID must be generated using the AWS Security Token Service. This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="AwsRegion">Image import from AWS. AWS region of the image that you want to import. This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="AwsSecretAccessKey">Image import from AWS. Secret access key for a temporary AWS credential. This key must be generated using the AWS Security Token Service. This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="AwsSessionToken">Image import from AWS. Session token for a temporary AWS credential. This session token must be generated using the AWS Security Token Service. This flag argument must be specified if any of the other arguments in this group are specified.</param>
/// <param name="ImageName"></param>
[GeneratedCode("ModularPipelines.OptionsGenerator", "2.0.0")]
[ExcludeFromCodeCoverage]
[CliSubCommand("preview", "compute", "images", "import")]
public record GcloudPreviewComputeImagesImportOptions(
    [property: CliOption("--aws-access-key-id", Format = OptionFormat.EqualsSeparated)] string AwsAccessKeyId,
    [property: CliOption("--aws-region", Format = OptionFormat.EqualsSeparated)] string AwsRegion,
    [property: SecretValue, CliOption("--aws-secret-access-key", Format = OptionFormat.EqualsSeparated)] string AwsSecretAccessKey,
    [property: SecretValue, CliOption("--aws-session-token", Format = OptionFormat.EqualsSeparated)] string AwsSessionToken,
