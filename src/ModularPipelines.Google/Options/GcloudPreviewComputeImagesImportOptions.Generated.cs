...
public record GcloudPreviewComputeImagesImportOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Image import from AWS. Specify whether to import from an AMI or disk image. Exactly one of these must be specified: If importing a disk image, specify the following: S3 resource path of the exported image file that you want to import.
    /// </summary>
    ...
    /// <summary>
    /// Image import from AWS. Specify whether to import from an AMI or disk image. Exactly one of these must be specified: If importing an AMI, specify the following two flags: AWS AMI ID of the image to import. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsAccessKeyId) || !string.IsNullOrWhiteSpace(AwsRegion) || !string.IsNullOrWhiteSpace(AwsSecretAccessKey) || !string.IsNullOrWhiteSpace(AwsSessionToken) || !string.IsNullOrWhiteSpace(AwsSourceAmiFilePath) || !string.IsNullOrWhiteSpace(AwsAmiExportLocation) || !string.IsNullOrWhiteSpace(AwsAmiId)) && (!(!string.IsNullOrWhiteSpace(AwsAccessKeyId))))
        {
