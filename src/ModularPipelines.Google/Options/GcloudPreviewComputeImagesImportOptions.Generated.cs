...
public record GcloudPreviewComputeImagesImportOptions : GcloudOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Specify whether to import from an AMI or disk image. Exactly one of these must be specified: If importing a disk image, specify the following: S3 resource path of the exported image file that you want to import.
    /// </summary>
    [CliOption("--aws-source-ami-file-path", Format = OptionFormat.EqualsSeparated)]
    public string? AwsSourceAmiFilePath { get; set; }

    /// <summary>
    /// Specify whether to import from an AMI or disk image. Exactly one of these must be specified: If importing an AMI, specify the following two flags: An AWS S3 bucket location where the converted image file can be temporarily exported to before the import to Cloud Storage. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    [CliOption("--aws-ami-export-location", Format = OptionFormat.EqualsSeparated)]
    public string? AwsAmiExportLocation { get; set; }

    /// <summary>
    /// Specify whether to import from an AMI or disk image. Exactly one of these must be specified: If importing an AMI, specify the following two flags: AWS AMI ID of the image to import. This flag argument must be specified if any of the other arguments in this group are specified.
    /// </summary>
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsAccessKeyId) || !string.IsNullOrWhiteSpace(AwsRegion) || !string.IsNullOrWhiteSpace(AwsSecretAccessKey) || !string.IsNullOrWhiteSpace(AwsSessionToken)) && (!(!string.IsNullOrWhiteSpace(AwsAccessKeyId))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsAccessKeyId) || !string.IsNullOrWhiteSpace(AwsRegion) || !string.IsNullOrWhiteSpace(AwsSecretAccessKey) || !string.IsNullOrWhiteSpace(AwsSessionToken)) && (!(!string.IsNullOrWhiteSpace(AwsRegion))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsAccessKeyId) || !string.IsNullOrWhiteSpace(AwsRegion) || !string.IsNullOrWhiteSpace(AwsSecretAccessKey) || !string.IsNullOrWhiteSpace(AwsSessionToken)) && (!(!string.IsNullOrWhiteSpace(AwsSecretAccessKey))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsAccessKeyId) || !string.IsNullOrWhiteSpace(AwsRegion) || !string.IsNullOrWhiteSpace(AwsSecretAccessKey) || !string.IsNullOrWhiteSpace(AwsSessionToken)) && (!(!string.IsNullOrWhiteSpace(AwsSessionToken))))
        {
        ...
        if (((!string.IsNullOrWhiteSpace(AwsSourceAmiFilePath)) ? 1 : 0) + ((!string.IsNullOrWhiteSpace(AwsAmiExportLocation) || !string.IsNullOrWhiteSpace(AwsAmiId)) ? 1 : 0) != 1)
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsSourceAmiFilePath) || !string.IsNullOrWhiteSpace(AwsAmiExportLocation) || !string.IsNullOrWhiteSpace(AwsAmiId)) && (!string.IsNullOrWhiteSpace(AwsAmiExportLocation) || !string.IsNullOrWhiteSpace(AwsAmiId)) && (!(!string.IsNullOrWhiteSpace(AwsAmiExportLocation))))
        {
        ...
        if ((!string.IsNullOrWhiteSpace(AwsSourceAmiFilePath) || !string.IsNullOrWhiteSpace(AwsAmiExportLocation) || !string.IsNullOrWhiteSpace(AwsAmiId)) && (!string.IsNullOrWhiteSpace(AwsAmiExportLocation) || !string.IsNullOrWhiteSpace(AwsAmiId)) && (!(!string.IsNullOrWhiteSpace(AwsAmiId))))
        {
