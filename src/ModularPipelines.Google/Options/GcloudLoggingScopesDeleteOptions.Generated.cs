...
// Source: https://cloud.google.com/sdk/gcloud/reference/logging/scopes/delete
...
[CliSubCommand("logging", "scopes", "delete")]
public record GcloudLoggingScopesDeleteOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// delete a log scope
    /// </summary>
    /// <param name="LogScopeId">ID of the log scope to delete.</param>
    public GcloudLoggingScopesDeleteOptions(
        string LogScopeId
    )
    {
