...
// Source: https://cloud.google.com/sdk/gcloud/reference/beyondcorp/security-gateways/delete
...
[CliSubCommand("beyondcorp", "security-gateways", "delete")]
public record GcloudBeyondcorpSecurityGatewaysDeleteOptions : GcloudOptions
{
    /// <summary>
    /// delete securityGateways
    /// </summary>
    /// <param name="SecurityGateway">SecurityGateway resource - BeyondCorp SecurityGateway name using the form: projects/{project_id}/locations/{location_id}/securityGateways/{security_gateway_id} The arguments in this group can be used to specify the attributes of this resource. (NOTE) Some attributes are not given arguments in this group but can be set in other ways. To set the project attribute: ◆ provide the argument security_gateway on the command line with a fully specified name; ◆ provide the argument --project on the command line; ◆ set the property core/project. This must be specified. ID of the securityGateway or fully qualified identifier for the securityGateway. To set the security_gateway attribute: ▸ provide the argument security_gateway on the command line. This positional argument must be specified if any of the other arguments in this group are specified.</param>
    public GcloudBeyondcorpSecurityGatewaysDeleteOptions(
