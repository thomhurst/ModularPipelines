...
// Source: https://cloud.google.com/sdk/gcloud/reference/access-context-manager/policies/add-iam-policy-binding
...
[CliSubCommand("access-context-manager", "policies", "add-iam-policy-binding")]
public record GcloudAccessContextManagerPoliciesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add IAM     policy binding for an access policy
    /// </summary>
    ...
    public GcloudAccessContextManagerPoliciesAddIamPolicyBindingOptions(
        string Member,
        string Role
    )
    {
