...
public record GcloudNotebooksRuntimesCreateOptions : GcloudOptions, IValidatableObject
{
    ...
    IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
    {
        ...
        if ((!string.IsNullOrWhiteSpace(RuntimeType) || !string.IsNullOrWhiteSpace(MachineType) || !string.IsNullOrWhiteSpace(Interface) || !string.IsNullOrWhiteSpace(Mode) || !string.IsNullOrWhiteSpace(Source) || !string.IsNullOrWhiteSpace(Type)) && (!string.IsNullOrWhiteSpace(MachineType) || !string.IsNullOrWhiteSpace(Interface) || !string.IsNullOrWhiteSpace(Mode) || !string.IsNullOrWhiteSpace(Source) || !string.IsNullOrWhiteSpace(Type)) && (!(!string.IsNullOrWhiteSpace(MachineType))))
        {
