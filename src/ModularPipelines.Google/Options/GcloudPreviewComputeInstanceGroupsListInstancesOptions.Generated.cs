...
public record GcloudPreviewComputeInstanceGroupsListInstancesOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// list instances     present in the instance group
    /// </summary>
    /// <param name="Name">Name of the instance group to operate on.</param>
    public GcloudPreviewComputeInstanceGroupsListInstancesOptions(
        string Name
    )
    {
