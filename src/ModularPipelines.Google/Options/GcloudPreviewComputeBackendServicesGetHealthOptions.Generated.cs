...
public record GcloudPreviewComputeBackendServicesGetHealthOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// get backend health     statuses from a backend service
    /// </summary>
    /// <param name="BackendServiceName">Name of the backend service to operate on.</param>
    public GcloudPreviewComputeBackendServicesGetHealthOptions(
