...
// Source: https://cloud.google.com/sdk/gcloud/reference/bigtable/tables/add-iam-policy-binding
...
[CliSubCommand("bigtable", "tables", "add-iam-policy-binding")]
public record GcloudBigtableTablesAddIamPolicyBindingOptions : GcloudOptions, IValidatableObject
{
    /// <summary>
    /// add an IAM policy binding     to a Cloud Bigtable table
    /// </summary>
    ...
    public GcloudBigtableTablesAddIamPolicyBindingOptions(
        string Member,
        string Role,
        string Table
    )
