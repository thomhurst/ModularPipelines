...
public interface IAwsKinesisVideoMedia
{
    ...
    public Task<CommandResult> GetMediaAsync(AwsKinesisVideoMediaGetMediaOptions options, CommandExecutionOptions? executionOptions = null, CancellationToken cancellationToken = default)
