...
public class AwsMarketplaceAgreement : IAwsMarketplaceAgreement
{
    private readonly ICommandContext _command;

    /// <summary>
    /// Initializes a new instance of the <see cref="AwsMarketplaceAgreement"/> class.
    /// </summary>
    public AwsMarketplaceAgreement(ICommandContext command)
    {
        _command = command;
    }
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> ListAgreementChargesAsync(
        AwsMarketplaceAgreementListAgreementChargesOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> ListBillingAdjustmentRequestsAsync(
        AwsMarketplaceAgreementListBillingAdjustmentRequestsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <returns>The command result.</returns>
    public virtual async Task<CommandResult> SearchAgreementsAsync(
        AwsMarketplaceAgreementSearchAgreementsOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
