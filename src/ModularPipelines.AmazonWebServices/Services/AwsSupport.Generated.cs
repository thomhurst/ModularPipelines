...
public class AwsSupport : IAwsSupport
{
    ...
    public virtual async Task<CommandResult> AddAttachmentsToSetAsync(
        AwsSupportAddAttachmentsToSetOptions options,
    ...
    public virtual async Task<CommandResult> AddCommunicationToCaseAsync(
        AwsSupportAddCommunicationToCaseOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> CompleteAttachmentUploadAsync(
        AwsSupportCompleteAttachmentUploadOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> CreateCaseAsync(
        AwsSupportCreateCaseOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeAttachmentAsync(
        AwsSupportDescribeAttachmentOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeAttachmentUploadStatusAsync(
        AwsSupportDescribeAttachmentUploadStatusOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeCasesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AwsSupportDescribeCasesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> DescribeCommunicationsAsync(
        AwsSupportDescribeCommunicationsOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeCreateCaseOptionsAsync(
        AwsSupportDescribeCreateCaseOptionsOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeServicesAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AwsSupportDescribeServicesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> DescribeSeverityLevelsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AwsSupportDescribeSeverityLevelsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> DescribeSupportedLanguagesAsync(
        AwsSupportDescribeSupportedLanguagesOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeTrustedAdvisorCheckRefreshStatusesAsync(
        AwsSupportDescribeTrustedAdvisorCheckRefreshStatusesOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeTrustedAdvisorCheckResultAsync(
        AwsSupportDescribeTrustedAdvisorCheckResultOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeTrustedAdvisorChecksAsync(
        AwsSupportDescribeTrustedAdvisorChecksOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> DescribeTrustedAdvisorCheckSummariesAsync(
        AwsSupportDescribeTrustedAdvisorCheckSummariesOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> GetAttachmentDownloadLinkAsync(
        AwsSupportGetAttachmentDownloadLinkOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> GetAttachmentUploadLinksAsync(
        AwsSupportGetAttachmentUploadLinksOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> RefreshTrustedAdvisorCheckAsync(
        AwsSupportRefreshTrustedAdvisorCheckOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken).ConfigureAwait(false);
    ...
    public virtual async Task<CommandResult> ResolveCaseAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AwsSupportResolveCaseOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
