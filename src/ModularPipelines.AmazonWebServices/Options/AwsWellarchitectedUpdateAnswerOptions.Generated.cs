...
public record AwsWellarchitectedUpdateAnswerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedUpdateAnswerOptions(
        string WorkloadId,
        string LensAlias,
        string QuestionId
    )
    ...
    private AwsWellarchitectedUpdateAnswerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedUpdateAnswerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedUpdateAnswerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--choice-updates", CollectionSeparator = ",")]
