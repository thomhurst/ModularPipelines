...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53-recovery-readiness/get-readiness-check-status/index.html
...
[CliSubCommand("route53-recovery-readiness", "get-readiness-check-status")]
public record AwsRoute53RecoveryReadinessGetReadinessCheckStatusOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRoute53RecoveryReadinessGetReadinessCheckStatusOptions(
    ...
    private AwsRoute53RecoveryReadinessGetReadinessCheckStatusOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRoute53RecoveryReadinessGetReadinessCheckStatusOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRoute53RecoveryReadinessGetReadinessCheckStatusOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
