...
public record AwsWellarchitectedExportLensOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedExportLensOptions(
        string LensAlias
    )
    {
    ...
    private AwsWellarchitectedExportLensOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedExportLensOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedExportLensOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
