...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-authorizers/index.html
...
[CliSubCommand("iot", "list-authorizers")]
public record AwsIotListAuthorizersOptions : AwsOptions
{
    ...
    /// <summary>
    /// The status of the list authorizers request. Possible values: o ACTIVE o INACTIVE
    /// </summary>
    [CliOption("--status")]
    public AwsIotListAuthorizersStatus? Status { get; set; }
