...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-routing-profile-queues/index.html
...
[CliSubCommand("connect", "list-routing-profile-queues")]
public record AwsConnectListRoutingProfileQueuesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListRoutingProfileQueuesOptions(
        string InstanceId,
    ...
    private AwsConnectListRoutingProfileQueuesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListRoutingProfileQueuesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListRoutingProfileQueuesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
