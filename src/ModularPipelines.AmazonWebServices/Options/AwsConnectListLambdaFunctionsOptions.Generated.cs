...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-lambda-functions/index.html
...
[CliSubCommand("connect", "list-lambda-functions")]
public record AwsConnectListLambdaFunctionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListLambdaFunctionsOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListLambdaFunctionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListLambdaFunctionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListLambdaFunctionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
