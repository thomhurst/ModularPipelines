...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/forecast/create-predictor-backtest-export-job/index.html
...
[CliSubCommand("forecast", "create-predictor-backtest-export-job")]
public record AwsForecastCreatePredictorBacktestExportJobOptions : AwsOptions, IValidatableObject
{
    ...
    /// Exports backtest forecasts and accuracy metrics generated by the Cre- ateAutoPredictor or CreatePredictor operations. Two folders containing CSV or Parquet files are exported to your specified S3 bucket. The export file names will match the following conventions: &lt;ExportJobName&gt;_&lt;ExportTimestamp&gt;_&lt;PartNumber&gt;.csv The &lt;ExportTimestamp&gt; component is in Java SimpleDate format (yyyy-MM-ddTHH-mm-ssZ). You must specify a DataDestination object that includes an Amazon S3 bucket and an Identity and Acce...
    /// </summary>
    /// <param name="PredictorBacktestExportJobName">The name for the backtest export job. Constraints: o min: 1 o max: 63 o pattern: ^[a-zA-Z][a-zA-Z0-9_]*</param>
    /// <param name="PredictorArn">The Amazon Resource Name (ARN) of the predictor that you want to ex- port. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):forecast:.*:.*:.+</param>
    ...
    public AwsForecastCreatePredictorBacktestExportJobOptions(
        string PredictorBacktestExportJobName,
        string PredictorArn,
        string Destination
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(PredictorBacktestExportJobName);
    ...
    private AwsForecastCreatePredictorBacktestExportJobOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsForecastCreatePredictorBacktestExportJobOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsForecastCreatePredictorBacktestExportJobOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name for the backtest export job. Constraints: o min: 1 o max: 63 o pattern: ^[a-zA-Z][a-zA-Z0-9_]*
    /// </summary>
    [CliOption("--predictor-backtest-export-job-name")]
    public string? PredictorBacktestExportJobName { get; private init; }

    /// <summary>
    /// The Amazon Resource Name (ARN) of the predictor that you want to ex- port. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):forecast:.*:.*:.+
    /// </summary>
