...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/list-experiment-run-events/index.html
...
[CliSubCommand("appconfig", "list-experiment-run-events")]
public record AwsAppConfigListExperimentRunEventsOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Run">The run number. Constraints: o min: 1</param>
    public AwsAppConfigListExperimentRunEventsOptions(
    ...
    private AwsAppConfigListExperimentRunEventsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppConfigListExperimentRunEventsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppConfigListExperimentRunEventsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The run number. Constraints: o min: 1
    /// </summary>
    [CliOption("--run")]
