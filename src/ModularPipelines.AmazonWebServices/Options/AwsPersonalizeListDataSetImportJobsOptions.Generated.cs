...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-dataset-import-jobs/index.html
...
[CliSubCommand("personalize", "list-dataset-import-jobs")]
public record AwsPersonalizeListDataSetImportJobsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the dataset to list the dataset import jobs for. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
