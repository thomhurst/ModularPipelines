...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/describe-ssl-policies/index.html
...
[CliSubCommand("elbv2", "describe-ssl-policies")]
public record AwsElbv2DescribeSslPoliciesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The type of load balancer. The default lists the SSL policies for all load balancers. Possible values: o application o network o gateway
    /// </summary>
    [CliOption("--load-balancer-type")]
    public AwsElbv2DescribeSslPoliciesLoadBalancerType? LoadBalancerType { get; set; }
