...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-budgets/index.html
...
[CliSubCommand("deadline", "list-budgets")]
public record AwsDeadlineListBudgetsOptions : AwsOptions, IValidatableObject
{
    ...
    /// A list of budgets in a farm. See also: AWS API Documentation list-budgets is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: budgets
    /// </summary>
    /// <param name="FarmId">The farm ID associated with the budgets. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    public AwsDeadlineListBudgetsOptions(
        string FarmId
    )
    {
    ...
    private AwsDeadlineListBudgetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListBudgetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListBudgetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID associated with the budgets. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    public string? FarmId { get; private init; }

    /// <summary>
    /// The status to list for the budgets. Possible values: o ACTIVE o INACTIVE
    /// </summary>
    [CliOption("--status")]
    public AwsDeadlineListBudgetsStatus? Status { get; set; }
