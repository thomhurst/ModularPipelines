...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds-data/delete-user/index.html
...
[CliSubCommand("ds-data", "delete-user")]
public record AwsDsDataDeleteUserOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDsDataDeleteUserOptions(
        string DirectoryId,
    ...
    private AwsDsDataDeleteUserOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsDataDeleteUserOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsDataDeleteUserOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
