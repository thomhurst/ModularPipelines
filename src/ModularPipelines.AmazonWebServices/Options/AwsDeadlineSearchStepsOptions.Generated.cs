...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/search-steps/index.html
...
[CliSubCommand("deadline", "search-steps")]
public record AwsDeadlineSearchStepsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Searches for steps. See also: AWS API Documentation
    /// </summary>
    /// <param name="FarmId">The farm ID to use for the step search. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    /// <param name="ItemOffset">The offset for the search results. Constraints: o min: 0 o max: 10000</param>
    /// <param name="QueueIds">The queue IDs in the step search. Constraints: o min: 1 o max: 10 (string) Constraints: o pattern: queue-[0-9a-f]{32} Syntax: "string" "string" ...</param>
    public AwsDeadlineSearchStepsOptions(
        string FarmId,
        int ItemOffset,
    ...
    private AwsDeadlineSearchStepsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineSearchStepsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineSearchStepsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID to use for the step search. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    ...
    /// <summary>
    /// The queue IDs in the step search. Constraints: o min: 1 o max: 10 (string) Constraints: o pattern: queue-[0-9a-f]{32} Syntax: "string" "string" ...
    /// </summary>
    ...
    /// <summary>
    /// The job ID to use in the step search. Constraints: o pattern: job-[0-9a-f]{32}
    /// </summary>
    [CliOption("--job-id")]
