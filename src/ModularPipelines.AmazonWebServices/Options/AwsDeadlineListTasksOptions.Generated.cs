...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-tasks/index.html
...
[CliSubCommand("deadline", "list-tasks")]
public record AwsDeadlineListTasksOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists tasks for a job. See also: AWS API Documentation list-tasks is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: tasks
    /// </summary>
    /// <param name="FarmId">The farm ID connected to the tasks. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    /// <param name="QueueId">The queue ID connected to the tasks. Constraints: o pattern: queue-[0-9a-f]{32}</param>
    /// <param name="JobId">The job ID for the tasks. Constraints: o pattern: job-[0-9a-f]{32}</param>
    /// <param name="StepId">The step ID for the tasks. Constraints: o pattern: step-[0-9a-f]{32}</param>
    public AwsDeadlineListTasksOptions(
        string FarmId,
        string QueueId,
        string JobId,
        string StepId
    ...
    private AwsDeadlineListTasksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListTasksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListTasksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID connected to the tasks. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    public string? FarmId { get; private init; }

    /// <summary>
    /// The queue ID connected to the tasks. Constraints: o pattern: queue-[0-9a-f]{32}
    /// </summary>
    [CliOption("--queue-id")]
    public string? QueueId { get; private init; }

    /// <summary>
    /// The job ID for the tasks. Constraints: o pattern: job-[0-9a-f]{32}
    /// </summary>
    [CliOption("--job-id")]
    public string? JobId { get; private init; }

    /// <summary>
    /// The step ID for the tasks. Constraints: o pattern: step-[0-9a-f]{32}
    /// </summary>
    [CliOption("--step-id")]
