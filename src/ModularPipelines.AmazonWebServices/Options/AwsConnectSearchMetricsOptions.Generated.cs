...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/search-metrics/index.html
...
public record AwsConnectSearchMetricsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The search criteria to filter the metrics. OrConditions -&gt; (list) A list of conditions to be met, where at least one condition must be satisfied. (structure) Defines the search criteria for filtering metrics. OrConditions -&gt; (list) A list of conditions to be met, where at least one condi- tion must be satisfied. ( ... recursive ... ) AndConditions -&gt; (list) A list of conditions that must all be satisfied. ( ... recursive ... ) StringCondition -&gt; (structure) A leaf node condition which can be used to specify a string condition. FieldName -&gt; (string) The name of the field in the string condition. Value -&gt; (string) The value of the string. ComparisonType -&gt; (string) The type of comparison to be made when evaluating the string condition. Possible values: o STARTS_WITH o CONTAINS o EXACT BooleanCondition -&gt; (structure) A boolean search condition for Search APIs. FieldName -&gt; (string) A name of the property to be searched. ComparisonType -&gt; (string) Boolean property comparison type. Possible values: o IS_TRUE o IS_FALSE AndConditions -&gt; (list) A list of conditions that must all be satisfied. (structure) Defines the search criteria for filtering metrics. OrConditions -&gt; (list) A list of conditions to be met, where at least one condi- tion must be satisfied. ( ... recursive ... ) AndConditions -&gt; (list) A list of conditions that must all be satisfied. ( ... recursive ... ) StringCondition -&gt; (structure) A leaf node condition which can be used to specify a string condition. FieldName -&gt; (string) The name of the field in the string condition. Value -&gt; (string) The value of the string. ComparisonType -&gt; (string) The type of comparison to be made when evaluating the string condition. Possible values: o STARTS_WITH o CONTAINS o EXACT BooleanCondition -&gt; (structure) A boolean search condition for Search APIs. FieldName -&gt; (string) A name of the property to be searched. ComparisonType -&gt; (string) Boolean property comparison type. Possible values: o IS_TRUE o IS_FALSE StringCondition -&gt; (structure) A leaf node condition which can be used to specify a string con- dition. FieldName -&gt; (string) The name of the field in the string condition. Value -&gt; (string) The value of the string. ComparisonType -&gt; (string) The type of comparison to be made when evaluating the string condition. Possible values: o STARTS_WITH o CONTAINS o EXACT BooleanCondition -&gt; (structure) A boolean search condition for Search APIs. FieldName -&gt; (string) A name of the property to be searched. ComparisonType -&gt; (string) Boolean property comparison type. Possible values: o IS_TRUE o IS_FALSE JSON Syntax: { "OrConditions": [ { "OrConditions": [ { ... recursive ... } ... ], "AndConditions": [ { ... recursive ... } ... ], "StringCondition": { "FieldName": "string", "Value": "string", "ComparisonType": "STARTS_WITH"|"CONTAINS"|"EXACT" }, "BooleanCondition": { "FieldName": "string", "ComparisonType": "IS_TRUE"|"IS_FALSE" } } ... ], "AndConditions": [ { "OrConditions": [ { ... recursive ... } ... ], "AndConditions": [ { ... recursive ... } ... ], "StringCondition": { "FieldName": "string", "Value": "string", "ComparisonType": "STARTS_WITH"|"CONTAINS"|"EXACT" }, "BooleanCondition": { "FieldName": "string", "ComparisonType": "IS_TRUE"|"IS_FALSE" } } ... ], "StringCondition": { "FieldName": "string", "Value": "string", "ComparisonType": "STARTS_WITH"|"CONTAINS"|"EXACT" }, "BooleanCondition": { "FieldName": "string", "ComparisonType": "IS_TRUE"|"IS_FALSE" } }
    /// </summary>
