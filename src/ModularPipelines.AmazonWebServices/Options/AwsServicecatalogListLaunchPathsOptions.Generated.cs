...
public record AwsServicecatalogListLaunchPathsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsServicecatalogListLaunchPathsOptions(
        string ProductId
    )
    {
    ...
    private AwsServicecatalogListLaunchPathsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsServicecatalogListLaunchPathsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsServicecatalogListLaunchPathsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
