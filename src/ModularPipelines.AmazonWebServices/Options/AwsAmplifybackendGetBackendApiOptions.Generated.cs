...
public record AwsAmplifybackendGetBackendApiOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifybackendGetBackendApiOptions(
        string AppId,
    ...
    private AwsAmplifybackendGetBackendApiOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifybackendGetBackendApiOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifybackendGetBackendApiOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
