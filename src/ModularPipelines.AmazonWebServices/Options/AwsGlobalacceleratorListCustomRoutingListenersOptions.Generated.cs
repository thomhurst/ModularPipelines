...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/list-custom-routing-listeners/index.html
...
[CliSubCommand("globalaccelerator", "list-custom-routing-listeners")]
public record AwsGlobalacceleratorListCustomRoutingListenersOptions : AwsOptions, IValidatableObject
{
    ...
    /// List the listeners for a custom routing accelerator. See also: AWS API Documentation list-custom-routing-listeners is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: Listeners
    /// </summary>
    /// <param name="AcceleratorArn">The Amazon Resource Name (ARN) of the accelerator to list listeners for. Constraints: o max: 255</param>
    public AwsGlobalacceleratorListCustomRoutingListenersOptions(
    ...
    private AwsGlobalacceleratorListCustomRoutingListenersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlobalacceleratorListCustomRoutingListenersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlobalacceleratorListCustomRoutingListenersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the accelerator to list listeners for. Constraints: o max: 255
    /// </summary>
