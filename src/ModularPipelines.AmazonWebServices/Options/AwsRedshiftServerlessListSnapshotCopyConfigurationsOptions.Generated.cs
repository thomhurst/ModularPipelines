...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/list-snapshot-copy-configurations/index.html
...
[CliSubCommand("redshift-serverless", "list-snapshot-copy-configurations")]
public record AwsRedshiftServerlessListSnapshotCopyConfigurationsOptions : AwsOptions
{
    /// <summary>
    /// The namespace from which to list all snapshot copy configurations. Constraints: o min: 3 o max: 64 o pattern: ^[a-z0-9-]+$
    /// </summary>
