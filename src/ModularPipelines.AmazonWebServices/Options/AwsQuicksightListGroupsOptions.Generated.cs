...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-groups/index.html
...
[CliSubCommand("quicksight", "list-groups")]
public record AwsQuicksightListGroupsOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Namespace">The namespace that you want a list of groups from. Constraints: o max: 64 o pattern: ^[a-zA-Z0-9._-]*$</param>
    public AwsQuicksightListGroupsOptions(
        string AwsAccountId,
        string Namespace
    )
    {
    ...
    private AwsQuicksightListGroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListGroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListGroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The namespace that you want a list of groups from. Constraints: o max: 64 o pattern: ^[a-zA-Z0-9._-]*$
    /// </summary>
    [CliOption("--namespace")]
