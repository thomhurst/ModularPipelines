...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/get-policy/index.html
...
[CliSubCommand("lambda", "get-policy")]
public record AwsLambdaGetPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaGetPolicyOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaGetPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaGetPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaGetPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Specify a version or alias to get the policy for that resource. Constraints: o min: 1 o max: 128 o pattern: \$(LATEST(\.PUBLISHED)?)|[a-zA-Z0-9-_$]+
    /// </summary>
    [CliOption("--qualifier")]
