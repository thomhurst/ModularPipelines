...
public record AwsMediapackagev2GetChannelPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMediapackagev2GetChannelPolicyOptions(
    ...
    private AwsMediapackagev2GetChannelPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediapackagev2GetChannelPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediapackagev2GetChannelPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
