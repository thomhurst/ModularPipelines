...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/marketplace-agreement/get-agreement-entitlements/index.html
...
[CliSubCommand("marketplace-agreement", "get-agreement-entitlements")]
public record AwsMarketplaceAgreementGetAgreementEntitlementsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMarketplaceAgreementGetAgreementEntitlementsOptions(
        string AgreementId
    )
    {
    ...
    private AwsMarketplaceAgreementGetAgreementEntitlementsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMarketplaceAgreementGetAgreementEntitlementsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMarketplaceAgreementGetAgreementEntitlementsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
