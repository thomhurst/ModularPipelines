...
public record AwsMturkListAssignmentsForHitOptions : AwsOptions, IValidatableObject
{
    ...
    /// The ListAssignmentsForHIT operation retrieves completed assignments for a HIT. You can use this operation to retrieve the results for a HIT. You can get assignments for a HIT at any time, even if the HIT is not yet Reviewable. If a HIT requested multiple assignments, and has re- ceived some results but has not yet become Reviewable, you can still retrieve the partial results with this operation. Use the AssignmentStatus parameter to control which set of assignments for a HIT are returned. The Li...
    /// </summary>
    /// <param name="HitId">The ID of the HIT. Constraints: o min: 1 o max: 64 o pattern: ^[A-Z0-9]+$</param>
    public AwsMturkListAssignmentsForHitOptions(
        string HitId
    )
    {
    ...
    private AwsMturkListAssignmentsForHitOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMturkListAssignmentsForHitOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMturkListAssignmentsForHitOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the HIT. Constraints: o min: 1 o max: 64 o pattern: ^[A-Z0-9]+$
    /// </summary>
    [CliOption("--hit-id")]
