...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/describe-reserved-elasticsearch-instances/index.html
...
[CliSubCommand("es", "describe-reserved-elasticsearch-instances")]
public record AwsEsDescribeReservedElasticsearchInstancesOptions : AwsOptions
{
    /// <summary>
    /// The reserved instance identifier filter value. Use this parameter to show only the reservation that matches the specified reserved Elas- ticsearch instance ID. Constraints: o pattern: \p{XDigit}{8}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{4}-\p{XDigit}{12}
    /// </summary>
