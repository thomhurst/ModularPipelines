...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-devices/index.html
...
[CliSubCommand("sagemaker", "list-devices")]
public record AwsSagemakerListDevicesOptions : AwsOptions
{
    ...
    public string? LatestHeartbeatAfter { get; set; }

    /// <summary>
    /// A filter that searches devices that contains this name in any of their models. Constraints: o min: 1 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
    [CliOption("--model-name")]
    public string? ModelName { get; set; }

    /// <summary>
    /// Filter for fleets containing this name in their device fleet name. Constraints: o min: 1 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
