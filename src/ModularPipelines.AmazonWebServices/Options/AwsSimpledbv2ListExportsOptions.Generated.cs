...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/simpledbv2/list-exports/index.html
...
[CliSubCommand("simpledbv2", "list-exports")]
public record AwsSimpledbv2ListExportsOptions : AwsOptions
{
    /// <summary>
    /// The name of the domain to filter exports. If not provided, exports for all the domains will be listed. Constraints: o min: 1
    /// </summary>
