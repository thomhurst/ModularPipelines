...
public record AwsWafDeleteSqlInjectionMatchSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafDeleteSqlInjectionMatchSetOptions(
    ...
    private AwsWafDeleteSqlInjectionMatchSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafDeleteSqlInjectionMatchSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafDeleteSqlInjectionMatchSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
