...
public record AwsIamListServerCertificateTagsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsIamListServerCertificateTagsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamListServerCertificateTagsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamListServerCertificateTagsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
