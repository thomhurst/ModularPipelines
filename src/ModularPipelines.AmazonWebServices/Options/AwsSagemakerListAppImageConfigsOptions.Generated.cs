...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-app-image-configs/index.html
...
[CliSubCommand("sagemaker", "list-app-image-configs")]
public record AwsSagemakerListAppImageConfigsOptions : AwsOptions
{
    /// <summary>
    /// A filter that returns only AppImageConfigs whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
    ...
    /// <summary>
    /// The property used to sort results. The default value is CreationTime . Possible values: o CreationTime o LastModifiedTime o Name
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListAppImageConfigsSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order. The default value is Descending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListAppImageConfigsSortOrder? SortOrder { get; set; }
