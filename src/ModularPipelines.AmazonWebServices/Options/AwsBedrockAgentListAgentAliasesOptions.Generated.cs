...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent/list-agent-aliases/index.html
...
[CliSubCommand("bedrock-agent", "list-agent-aliases")]
public record AwsBedrockAgentListAgentAliasesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBedrockAgentListAgentAliasesOptions(
        string AgentId
    )
    {
    ...
    private AwsBedrockAgentListAgentAliasesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentListAgentAliasesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentListAgentAliasesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
