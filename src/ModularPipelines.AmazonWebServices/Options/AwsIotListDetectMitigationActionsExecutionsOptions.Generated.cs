...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-detect-mitigation-actions-executions/index.html
...
[CliSubCommand("iot", "list-detect-mitigation-actions-executions")]
public record AwsIotListDetectMitigationActionsExecutionsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The unique identifier of the violation. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9\-]+
    /// </summary>
    [CliOption("--violation-id")]
    public string? ViolationId { get; set; }

    /// <summary>
    /// The name of the thing whose mitigation actions are listed. Constraints: o min: 1 o max: 128
    /// </summary>
