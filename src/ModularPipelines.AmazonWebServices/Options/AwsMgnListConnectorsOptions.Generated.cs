...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-connectors/index.html
...
[CliSubCommand("mgn", "list-connectors")]
public record AwsMgnListConnectorsOptions : AwsOptions
{
    /// <summary>
    /// List Connectors Request filters. connectorIDs -&gt; (list) List Connectors Request Filters connector IDs. Constraints: o min: 0 o max: 20 (string) Constraints: o min: 27 o max: 27 o pattern: connector-[0-9a-zA-Z]{17} Shorthand Syntax: connectorIDs=string,string JSON Syntax: { "connectorIDs": ["string", ...] }
    /// </summary>
    [CliOption("--filters")]
