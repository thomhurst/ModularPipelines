...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-transit-gateway-metering-policy/index.html
...
[CliSubCommand("ec2", "create-transit-gateway-metering-policy")]
public record AwsEc2CreateTransitGatewayMeteringPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a metering policy for a transit gateway to track and measure network traffic. See also: AWS API Documentation
    /// </summary>
    /// <param name="TransitGatewayId">The ID of the transit gateway for which to create the metering pol- icy.</param>
    public AwsEc2CreateTransitGatewayMeteringPolicyOptions(
    ...
    private AwsEc2CreateTransitGatewayMeteringPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateTransitGatewayMeteringPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateTransitGatewayMeteringPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
