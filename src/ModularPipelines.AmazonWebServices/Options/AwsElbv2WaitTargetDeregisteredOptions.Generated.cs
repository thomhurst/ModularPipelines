...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/wait/target-deregistered/index.html
...
[CliSubCommand("elbv2", "wait", "target-deregistered")]
public record AwsElbv2WaitTargetDeregisteredOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsElbv2WaitTargetDeregisteredOptions(
    ...
    private AwsElbv2WaitTargetDeregisteredOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsElbv2WaitTargetDeregisteredOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsElbv2WaitTargetDeregisteredOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
