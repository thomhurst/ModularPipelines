...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/list-resource-scans/index.html
...
[CliSubCommand("cloudformation", "list-resource-scans")]
public record AwsCloudformationListResourceScansOptions : AwsOptions
{
    /// <summary>
    /// The scan type that you want to get summary information about. The default is FULL . Possible values: o FULL o PARTIAL
    /// </summary>
    [CliOption("--scan-type-filter")]
    public AwsCloudformationListResourceScansScanTypeFilter? ScanTypeFilter { get; set; }
