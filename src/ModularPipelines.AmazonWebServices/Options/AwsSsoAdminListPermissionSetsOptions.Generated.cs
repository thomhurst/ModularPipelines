...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-permission-sets/index.html
...
[CliSubCommand("sso-admin", "list-permission-sets")]
public record AwsSsoAdminListPermissionSetsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminListPermissionSetsOptions(
        string InstanceArn
    )
    {
    ...
    private AwsSsoAdminListPermissionSetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListPermissionSetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListPermissionSetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
