...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-security-keys/index.html
...
[CliSubCommand("connect", "list-security-keys")]
public record AwsConnectListSecurityKeysOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListSecurityKeysOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListSecurityKeysOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListSecurityKeysOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListSecurityKeysOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
