...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-extraction-definitions/index.html
...
[CliSubCommand("connect", "list-extraction-definitions")]
public record AwsConnectListExtractionDefinitionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListExtractionDefinitionsOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListExtractionDefinitionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListExtractionDefinitionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListExtractionDefinitionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
