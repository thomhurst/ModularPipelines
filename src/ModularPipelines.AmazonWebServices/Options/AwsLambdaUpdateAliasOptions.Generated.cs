...
public record AwsLambdaUpdateAliasOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaUpdateAliasOptions(
        string FunctionName,
        string Name
    )
    {
    ...
    private AwsLambdaUpdateAliasOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaUpdateAliasOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaUpdateAliasOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
