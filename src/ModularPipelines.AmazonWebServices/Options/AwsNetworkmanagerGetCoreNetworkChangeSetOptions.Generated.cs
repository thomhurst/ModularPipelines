...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-core-network-change-set/index.html
...
[CliSubCommand("networkmanager", "get-core-network-change-set")]
public record AwsNetworkmanagerGetCoreNetworkChangeSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerGetCoreNetworkChangeSetOptions(
    ...
    private AwsNetworkmanagerGetCoreNetworkChangeSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerGetCoreNetworkChangeSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerGetCoreNetworkChangeSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
