...
public record AwsS3apiGetObjectRetentionOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Key">The key name for the object whose retention settings you want to re- trieve. Constraints: o min: 1</param>
    public AwsS3apiGetObjectRetentionOptions(
        string Bucket,
        string Key
    )
    {
    ...
    private AwsS3apiGetObjectRetentionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3apiGetObjectRetentionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3apiGetObjectRetentionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The key name for the object whose retention settings you want to re- trieve. Constraints: o min: 1
    /// </summary>
    [CliOption("--key")]
