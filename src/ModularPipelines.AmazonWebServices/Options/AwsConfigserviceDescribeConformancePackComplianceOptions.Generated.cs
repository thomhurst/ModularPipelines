...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-conformance-pack-compliance/index.html
...
[CliSubCommand("configservice", "describe-conformance-pack-compliance")]
public record AwsConfigserviceDescribeConformancePackComplianceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConfigserviceDescribeConformancePackComplianceOptions(
    ...
    private AwsConfigserviceDescribeConformancePackComplianceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConfigserviceDescribeConformancePackComplianceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConfigserviceDescribeConformancePackComplianceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// A ConformancePackComplianceFilters object. ConfigRuleNames -&gt; (list) Filters the results by Config rule names. Constraints: o min: 0 o max: 10 (string) Constraints: o min: 1 o max: 64 ComplianceType -&gt; (string) Filters the results by compliance. The allowed values are COMPLIANT and NON_COMPLIANT . INSUFFI- CIENT_DATA is not supported. Possible values: o COMPLIANT o NON_COMPLIANT o INSUFFICIENT_DATA Shorthand Syntax: ConfigRuleNames=string,string,ComplianceType=string JSON Syntax: { "ConfigRuleNames": ["string", ...], "ComplianceType": "COMPLIANT"|"NON_COMPLIANT"|"INSUFFICIENT_DATA" }
    /// </summary>
    [CliOption("--filters")]
