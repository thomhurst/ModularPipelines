...
public record AwsLambdaGetFunctionCodeSigningConfigOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaGetFunctionCodeSigningConfigOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaGetFunctionCodeSigningConfigOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaGetFunctionCodeSigningConfigOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaGetFunctionCodeSigningConfigOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
