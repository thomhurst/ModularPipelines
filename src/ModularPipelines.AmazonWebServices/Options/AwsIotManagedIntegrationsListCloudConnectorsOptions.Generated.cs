...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/list-cloud-connectors/index.html
...
[CliSubCommand("iot-managed-integrations", "list-cloud-connectors")]
public record AwsIotManagedIntegrationsListCloudConnectorsOptions : AwsOptions
{
    /// <summary>
    /// The type of cloud connectors to filter by when listing available connectors. Possible values: o LISTED o UNLISTED
    /// </summary>
    [CliOption("--type")]
    public AwsIotManagedIntegrationsListCloudConnectorsType? Type { get; set; }

    /// <summary>
    /// The Amazon Resource Name (ARN) of the Lambda function to filter cloud connectors by. Constraints: o pattern: (arn:aws:lambda:[0-9a-zA-Z-]+:[0-9]+:func- tion:)?([a-zA-Z0-9-_]+(:(\$LATEST|[a-zA-Z0-9-_]+))?)
    /// </summary>
    [CliOption("--lambda-arn")]
