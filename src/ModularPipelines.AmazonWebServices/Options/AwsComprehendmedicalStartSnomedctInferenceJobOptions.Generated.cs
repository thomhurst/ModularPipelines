...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehendmedical/start-snomedct-inference-job/index.html
...
public record AwsComprehendmedicalStartSnomedctInferenceJobOptions : AwsOptions
{
    ...
    /// <summary>
    /// An AWS Key Management Service key used to encrypt your output files. If you do not specify a key, the files are written in plain text. Constraints: o min: 1 o max: 2048 o pattern: .*
    /// </summary>
    [CliOption("--kms-key")]
