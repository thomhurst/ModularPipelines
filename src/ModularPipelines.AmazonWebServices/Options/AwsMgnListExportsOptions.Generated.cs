...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-exports/index.html
...
[CliSubCommand("mgn", "list-exports")]
public record AwsMgnListExportsOptions : AwsOptions
{
    /// <summary>
    /// List exports request filters. exportIDs -&gt; (list) List exports request filters export ids. Constraints: o min: 0 o max: 10 (string) Constraints: o min: 24 o max: 24 o pattern: export-[0-9a-zA-Z]{17} Shorthand Syntax: exportIDs=string,string JSON Syntax: { "exportIDs": ["string", ...] }
    /// </summary>
    [CliOption("--filters")]
