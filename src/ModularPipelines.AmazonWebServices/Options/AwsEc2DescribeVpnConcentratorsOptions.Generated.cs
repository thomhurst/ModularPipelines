...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-vpn-concentrators/index.html
...
[CliSubCommand("ec2", "describe-vpn-concentrators")]
public record AwsEc2DescribeVpnConcentratorsOptions : AwsOptions
{
    /// <summary>
    /// One or more VPN concentrator IDs. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--vpn-concentrator-ids", GroupValues = true)]
    public IEnumerable<string>? VpnConcentratorIds { get; set; }
