...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-managed-prefix-list-associations/index.html
...
[CliSubCommand("ec2", "get-managed-prefix-list-associations")]
public record AwsEc2GetManagedPrefixListAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetManagedPrefixListAssociationsOptions(
        string PrefixListId
    )
    {
    ...
    private AwsEc2GetManagedPrefixListAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetManagedPrefixListAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetManagedPrefixListAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
