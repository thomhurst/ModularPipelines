...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-route-responses/index.html
...
[CliSubCommand("apigatewayv2", "get-route-responses")]
public record AwsApigatewayv2GetRouteResponsesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetRouteResponsesOptions(
        string ApiId,
        string RouteId
    )
    {
    ...
    private AwsApigatewayv2GetRouteResponsesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetRouteResponsesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetRouteResponsesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
