...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-transit-gateway-route-table-associations/index.html
...
[CliSubCommand("ec2", "get-transit-gateway-route-table-associations")]
public record AwsEc2GetTransitGatewayRouteTableAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetTransitGatewayRouteTableAssociationsOptions(
    ...
    private AwsEc2GetTransitGatewayRouteTableAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetTransitGatewayRouteTableAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetTransitGatewayRouteTableAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
