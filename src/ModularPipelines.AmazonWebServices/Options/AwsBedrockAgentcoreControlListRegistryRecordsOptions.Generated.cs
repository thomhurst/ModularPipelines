...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore-control/list-registry-records/index.html
...
public record AwsBedrockAgentcoreControlListRegistryRecordsOptions : AwsOptions
{
    ...
    /// <summary>
    /// Filter registry records by their current status. Possible values in- clude CREATING , DRAFT , APPROVED , PENDING_APPROVAL , REJECTED , DEPRECATED , UPDATING , CREATE_FAILED , and UPDATE_FAILED . Possible values: o DRAFT o PENDING_APPROVAL o APPROVED o REJECTED o DEPRECATED o CREATING o UPDATING o CREATE_FAILED o UPDATE_FAILED
    /// </summary>
    [CliOption("--status")]
    public AwsBedrockAgentcoreControlListRegistryRecordsStatus? Status { get; set; }

    /// <summary>
    /// Filter registry records by their descriptor type. Possible values are MCP , A2A , CUSTOM , and AGENT_SKILLS . Possible values: o MCP o A2A o CUSTOM o AGENT_SKILLS
    /// </summary>
    [CliOption("--descriptor-type")]
    public AwsBedrockAgentcoreControlListRegistryRecordsDescriptorType? DescriptorType { get; set; }
