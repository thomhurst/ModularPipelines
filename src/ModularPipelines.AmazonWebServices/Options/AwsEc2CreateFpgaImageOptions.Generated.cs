...
public record AwsEc2CreateFpgaImageOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates an Amazon FPGA Image (AFI) from the specified design checkpoint (DCP). The create operation is asynchronous. To verify that the AFI was suc- cessfully created and is ready for use, check the output logs. An AFI contains the FPGA bitstream that is ready to download to an FPGA. You can securely deploy an AFI on multiple FPGA-accelerated in- stances. For more information, see the Amazon Web Services FPGA Hard- ware Development Kit . See also: AWS API Documentation
    /// </summary>
    /// <param name="InputStorageLocation">The location of the encrypted design checkpoint in Amazon S3. The input must be a tarball. Bucket -&gt; (string) The name of the S3 bucket. Key -&gt; (string) The key. Shorthand Syntax: Bucket=string,Key=string JSON Syntax: { "Bucket": "string", "Key": "string" }</param>
    public AwsEc2CreateFpgaImageOptions(
        string InputStorageLocation
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(InputStorageLocation);
        this.InputStorageLocation = InputStorageLocation;
    }

    private AwsEc2CreateFpgaImageOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateFpgaImageOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateFpgaImageOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The location of the encrypted design checkpoint in Amazon S3. The input must be a tarball. Bucket -&gt; (string) The name of the S3 bucket. Key -&gt; (string) The key. Shorthand Syntax: Bucket=string,Key=string JSON Syntax: { "Bucket": "string", "Key": "string" }
    /// </summary>
    [CliOption("--input-storage-location")]
    public string? InputStorageLocation { get; private init; }
