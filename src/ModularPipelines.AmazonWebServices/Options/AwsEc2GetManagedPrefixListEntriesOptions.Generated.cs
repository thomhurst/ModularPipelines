...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-managed-prefix-list-entries/index.html
...
[CliSubCommand("ec2", "get-managed-prefix-list-entries")]
public record AwsEc2GetManagedPrefixListEntriesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetManagedPrefixListEntriesOptions(
        string PrefixListId
    )
    {
    ...
    private AwsEc2GetManagedPrefixListEntriesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetManagedPrefixListEntriesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetManagedPrefixListEntriesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
