...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medical-imaging/list-datastores/index.html
...
[CliSubCommand("medical-imaging", "list-datastores")]
public record AwsMedicalImagingListDatastoresOptions : AwsOptions
{
    /// <summary>
    /// The data store status. Possible values: o CREATING o CREATE_FAILED o ACTIVE o DELETING o DELETED
    /// </summary>
    [CliOption("--datastore-status")]
    public AwsMedicalImagingListDatastoresDatastoreStatus? DatastoreStatus { get; set; }
