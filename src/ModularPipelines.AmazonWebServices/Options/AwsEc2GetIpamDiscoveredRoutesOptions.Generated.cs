...
public record AwsEc2GetIpamDiscoveredRoutesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves Border Gateway Protocol (BGP) routes discovered by IPAM re- source discovery for a specified Region. Use this operation to view the Bring Your Own IP (BYOIP) address ranges that are currently advertised through BGP. We recommend using pagination to ensure that the operation returns quickly and successfully. See also: AWS API Documentation
    /// </summary>
    /// <param name="IpamResourceDiscoveryId">The ID of the IPAM resource discovery.</param>
    /// <param name="ResourceRegion">The Amazon Web Services Region to retrieve discovered routes for.</param>
    public AwsEc2GetIpamDiscoveredRoutesOptions(
    ...
    private AwsEc2GetIpamDiscoveredRoutesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetIpamDiscoveredRoutesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetIpamDiscoveredRoutesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
