...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/get-knowledge-base/index.html
...
[CliSubCommand("wisdom", "get-knowledge-base")]
public record AwsWisdomGetKnowledgeBaseOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomGetKnowledgeBaseOptions(
    ...
    private AwsWisdomGetKnowledgeBaseOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomGetKnowledgeBaseOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomGetKnowledgeBaseOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
