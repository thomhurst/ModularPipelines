...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda-microvms/list-microvm-images/index.html
...
[CliSubCommand("lambda-microvms", "list-microvm-images")]
public record AwsLambdaMicrovmsListMicrovmImagesOptions : AwsOptions
{
    /// <summary>
    /// Filters images whose name contains the specified string. Constraints: o min: 1 o max: 2048 o pattern: [^\s]+
    /// </summary>
