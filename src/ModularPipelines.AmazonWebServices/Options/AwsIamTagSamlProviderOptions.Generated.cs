...
public record AwsIamTagSamlProviderOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsIamTagSamlProviderOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamTagSamlProviderOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamTagSamlProviderOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
