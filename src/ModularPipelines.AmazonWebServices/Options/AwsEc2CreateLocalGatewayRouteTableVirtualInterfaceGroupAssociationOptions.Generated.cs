...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-local-gateway-route-table-virtual-interface-group-association/index.html
...
[CliSubCommand("ec2", "create-local-gateway-route-table-virtual-interface-group-association")]
public record AwsEc2CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="LocalGatewayVirtualInterfaceGroupId">The ID of the local gateway route table virtual interface group as- sociation.</param>
    public AwsEc2CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOptions(
    ...
    private AwsEc2CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
