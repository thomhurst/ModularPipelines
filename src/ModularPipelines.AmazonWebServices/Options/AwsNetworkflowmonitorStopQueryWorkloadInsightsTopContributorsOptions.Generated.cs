...
public record AwsNetworkflowmonitorStopQueryWorkloadInsightsTopContributorsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkflowmonitorStopQueryWorkloadInsightsTopContributorsOptions(
        string ScopeId,
        string QueryId
    )
    {
    ...
    private AwsNetworkflowmonitorStopQueryWorkloadInsightsTopContributorsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkflowmonitorStopQueryWorkloadInsightsTopContributorsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkflowmonitorStopQueryWorkloadInsightsTopContributorsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
