...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-models/index.html
...
[CliSubCommand("sagemaker", "list-models")]
public record AwsSagemakerListModelsOptions : AwsOptions
{
    /// <summary>
    /// Sorts the list of results. The default is CreationTime . Possible values: o Name o CreationTime
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListModelsSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order for results. The default is Descending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListModelsSortOrder? SortOrder { get; set; }

    /// <summary>
    /// A string in the model name. This filter returns only models whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9-]+
    /// </summary>
