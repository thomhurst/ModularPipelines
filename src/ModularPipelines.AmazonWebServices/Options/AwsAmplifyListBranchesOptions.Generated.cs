...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/list-branches/index.html
...
[CliSubCommand("amplify", "list-branches")]
public record AwsAmplifyListBranchesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyListBranchesOptions(
        string AppId
    )
    {
    ...
    private AwsAmplifyListBranchesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyListBranchesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyListBranchesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
