...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-authorizers/index.html
...
[CliSubCommand("apigateway", "get-authorizers")]
public record AwsApigatewayGetAuthorizersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayGetAuthorizersOptions(
        string RestApiId
    )
    {
    ...
    private AwsApigatewayGetAuthorizersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayGetAuthorizersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayGetAuthorizersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
