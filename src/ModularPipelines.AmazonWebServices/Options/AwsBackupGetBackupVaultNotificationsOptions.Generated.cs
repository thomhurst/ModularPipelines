...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/get-backup-vault-notifications/index.html
...
[CliSubCommand("backup", "get-backup-vault-notifications")]
public record AwsBackupGetBackupVaultNotificationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBackupGetBackupVaultNotificationsOptions(
    ...
    private AwsBackupGetBackupVaultNotificationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBackupGetBackupVaultNotificationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBackupGetBackupVaultNotificationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
