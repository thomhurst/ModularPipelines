...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/agent-registry-control/get-registry-record/index.html
...
[CliSubCommand("agent-registry-control", "get-registry-record")]
public record AwsAgentRegistryControlGetRegistryRecordOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAgentRegistryControlGetRegistryRecordOptions(
        string RegistryId,
        string RecordId
    )
    {
    ...
    private AwsAgentRegistryControlGetRegistryRecordOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAgentRegistryControlGetRegistryRecordOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAgentRegistryControlGetRegistryRecordOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
