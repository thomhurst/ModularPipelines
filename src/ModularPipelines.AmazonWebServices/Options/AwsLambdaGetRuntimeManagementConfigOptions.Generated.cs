...
public record AwsLambdaGetRuntimeManagementConfigOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaGetRuntimeManagementConfigOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaGetRuntimeManagementConfigOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaGetRuntimeManagementConfigOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaGetRuntimeManagementConfigOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
