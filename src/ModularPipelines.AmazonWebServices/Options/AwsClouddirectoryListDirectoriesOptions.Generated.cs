...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/list-directories/index.html
...
[CliSubCommand("clouddirectory", "list-directories")]
public record AwsClouddirectoryListDirectoriesOptions : AwsOptions
{
    /// <summary>
    /// The state of the directories in the list. Can be either Enabled, Disabled, or Deleted. Possible values: o ENABLED o DISABLED o DELETED
    /// </summary>
    [CliOption("--state")]
    public AwsClouddirectoryListDirectoriesState? State { get; set; }
