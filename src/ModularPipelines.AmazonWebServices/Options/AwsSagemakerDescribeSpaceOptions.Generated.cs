...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/describe-space/index.html
...
[CliSubCommand("sagemaker", "describe-space")]
public record AwsSagemakerDescribeSpaceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSagemakerDescribeSpaceOptions(
        string DomainId,
        string SpaceName
    )
    {
    ...
    private AwsSagemakerDescribeSpaceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSagemakerDescribeSpaceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSagemakerDescribeSpaceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
