...
public record AwsWafRegionalUpdateGeoMatchSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafRegionalUpdateGeoMatchSetOptions(
    ...
    private AwsWafRegionalUpdateGeoMatchSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafRegionalUpdateGeoMatchSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafRegionalUpdateGeoMatchSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
