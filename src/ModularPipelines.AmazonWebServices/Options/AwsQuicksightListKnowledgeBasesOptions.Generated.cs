...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-knowledge-bases/index.html
...
[CliSubCommand("quicksight", "list-knowledge-bases")]
public record AwsQuicksightListKnowledgeBasesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListKnowledgeBasesOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListKnowledgeBasesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListKnowledgeBasesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListKnowledgeBasesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
