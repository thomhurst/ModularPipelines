...
public record AwsMailmanagerUpdateTrafficPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    /// Update attributes of an already provisioned traffic policy resource. See also: AWS API Documentation
    /// </summary>
    /// <param name="TrafficPolicyId">The identifier of the traffic policy that you want to update. Constraints: o min: 1 o max: 100</param>
    public AwsMailmanagerUpdateTrafficPolicyOptions(
    ...
    private AwsMailmanagerUpdateTrafficPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMailmanagerUpdateTrafficPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMailmanagerUpdateTrafficPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The identifier of the traffic policy that you want to update. Constraints: o min: 1 o max: 100
    /// </summary>
