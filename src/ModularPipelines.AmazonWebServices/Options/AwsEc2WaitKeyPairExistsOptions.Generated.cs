...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/wait/key-pair-exists/index.html
...
[CliSubCommand("ec2", "wait", "key-pair-exists")]
public record AwsEc2WaitKeyPairExistsOptions : AwsOptions
{
    /// <summary>
    /// The key pair names. Default: Describes all of your key pairs. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--key-names", GroupValues = true)]
    public IEnumerable<string>? KeyNames { get; set; }

    /// <summary>
    /// The IDs of the key pairs. (string) Syntax: "string" "string" ...
    /// </summary>
