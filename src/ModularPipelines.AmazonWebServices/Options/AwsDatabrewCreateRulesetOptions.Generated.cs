...
public record AwsDatabrewCreateRulesetOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a new ruleset that can be used in a profile job to validate the data quality of a dataset. See also: AWS API Documentation
    /// </summary>
    /// <param name="Name">The name of the ruleset to be created. Valid characters are alphanu- meric (A-Z, a-z, 0-9), hyphen (-), period (.), and space. Constraints: o min: 1 o max: 255</param>
    /// <param name="TargetArn">The Amazon Resource Name (ARN) of a resource (dataset) that the ruleset is associated with. Constraints: o min: 20 o max: 2048</param>
    ...
    public AwsDatabrewCreateRulesetOptions(
        string Name,
        string TargetArn,
    ...
    private AwsDatabrewCreateRulesetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDatabrewCreateRulesetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDatabrewCreateRulesetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the ruleset to be created. Valid characters are alphanu- meric (A-Z, a-z, 0-9), hyphen (-), period (.), and space. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--name")]
    public string? Name { get; private init; }

    /// <summary>
    /// The Amazon Resource Name (ARN) of a resource (dataset) that the ruleset is associated with. Constraints: o min: 20 o max: 2048
    /// </summary>
