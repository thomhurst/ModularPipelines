...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backupsearch/list-search-jobs/index.html
...
[CliSubCommand("backupsearch", "list-search-jobs")]
public record AwsBackupsearchListSearchJobsOptions : AwsOptions
{
    /// <summary>
    /// Include this parameter to filter list by search job status. Possible values: o RUNNING o COMPLETED o STOPPING o STOPPED o FAILED
    /// </summary>
    [CliOption("--by-status")]
    public AwsBackupsearchListSearchJobsByStatus? ByStatus { get; set; }
