...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dataexchange/list-data-set-revisions/index.html
...
[CliSubCommand("dataexchange", "list-data-set-revisions")]
public record AwsDataexchangeListDataSetRevisionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDataexchangeListDataSetRevisionsOptions(
        string DataSetId
    )
    {
    ...
    private AwsDataexchangeListDataSetRevisionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDataexchangeListDataSetRevisionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDataexchangeListDataSetRevisionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
