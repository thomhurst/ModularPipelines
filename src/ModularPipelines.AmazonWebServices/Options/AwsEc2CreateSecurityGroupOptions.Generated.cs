...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-security-group/index.html
...
[CliSubCommand("ec2", "create-security-group")]
public record AwsEc2CreateSecurityGroupOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="GroupName">The name of the security group. Names are case-insensitive and must be unique within the VPC. Constraints: Up to 255 characters in length. Can't start with sg- . Valid characters: a-z, A-Z, 0-9, spaces, and ._-:/()#,@[]+=&amp;;{}!$*</param>
    public AwsEc2CreateSecurityGroupOptions(
        string Description,
        string GroupName
    )
    {
    ...
    private AwsEc2CreateSecurityGroupOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateSecurityGroupOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateSecurityGroupOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
