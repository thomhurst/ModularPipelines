...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/get-job/index.html
...
[CliSubCommand("amplify", "get-job")]
public record AwsAmplifyGetJobOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyGetJobOptions(
        string AppId,
        string BranchName,
        string JobId
    )
    ...
    private AwsAmplifyGetJobOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyGetJobOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyGetJobOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
