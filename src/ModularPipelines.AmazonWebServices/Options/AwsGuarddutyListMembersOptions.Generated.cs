...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/list-members/index.html
...
[CliSubCommand("guardduty", "list-members")]
public record AwsGuarddutyListMembersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists details about all member accounts for the current GuardDuty ad- ministrator account. See also: AWS API Documentation list-members is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: Members
    /// </summary>
    /// <param name="DetectorId">The unique ID of the detector that is associated with the member. To find the detectorId in the current Region, see the Settings page in the GuardDuty console, or run the ListDetectors API. Constraints: o min: 1 o max: 300</param>
    public AwsGuarddutyListMembersOptions(
        string DetectorId
    )
    {
    ...
    private AwsGuarddutyListMembersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGuarddutyListMembersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGuarddutyListMembersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique ID of the detector that is associated with the member. To find the detectorId in the current Region, see the Settings page in the GuardDuty console, or run the ListDetectors API. Constraints: o min: 1 o max: 300
    /// </summary>
