...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/list-input-sources/index.html
...
[CliSubCommand("resiliencehubv2", "list-input-sources")]
public record AwsResiliencehubv2ListInputSourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2ListInputSourcesOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2ListInputSourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2ListInputSourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2ListInputSourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Filter input sources by type. Possible values: o CFN_STACK o TAGS o EKS o TERRAFORM o DESIGN_FILE o MONITORING
    /// </summary>
    [CliOption("--type")]
    public AwsResiliencehubv2ListInputSourcesType? Type { get; set; }
