...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-ota-updates/index.html
...
[CliSubCommand("iot", "list-ota-updates")]
public record AwsIotListOtaUpdatesOptions : AwsOptions
{
    /// <summary>
    /// The OTA update job status. Possible values: o CREATE_PENDING o CREATE_IN_PROGRESS o CREATE_COMPLETE o CREATE_FAILED o DELETE_IN_PROGRESS o DELETE_FAILED
    /// </summary>
    [CliOption("--ota-update-status")]
    public AwsIotListOtaUpdatesOtaUpdateStatus? OtaUpdateStatus { get; set; }
