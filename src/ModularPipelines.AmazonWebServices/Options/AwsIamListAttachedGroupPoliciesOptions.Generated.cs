...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/list-attached-group-policies/index.html
...
[CliSubCommand("iam", "list-attached-group-policies")]
public record AwsIamListAttachedGroupPoliciesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists all managed policies that are attached to the specified IAM group. An IAM group can also have inline policies embedded with it. To list the inline policies for a group, use ListGroupPolicies . For informa- tion about policies, see Managed policies and inline policies in the IAM User Guide . You can paginate the results using the MaxItems and Marker parameters. You can use the PathPrefix parameter to limit the list of policies to only those matching the specified path prefix. If there are n...
    /// </summary>
    /// <param name="GroupName">The name (friendly name, not ARN) of the group to list attached policies for. This parameter allows (through its regex pattern ) a string of char- acters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following charac- ters: _+=,.@- Constraints: o min: 1 o max: 128 o pattern: [\w+=,.@-]+</param>
    public AwsIamListAttachedGroupPoliciesOptions(
        string GroupName
    )
    {
    ...
    private AwsIamListAttachedGroupPoliciesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamListAttachedGroupPoliciesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamListAttachedGroupPoliciesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
