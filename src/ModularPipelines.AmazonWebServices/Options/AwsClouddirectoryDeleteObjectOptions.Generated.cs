...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/delete-object/index.html
...
[CliSubCommand("clouddirectory", "delete-object")]
public record AwsClouddirectoryDeleteObjectOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsClouddirectoryDeleteObjectOptions(
        string DirectoryArn,
    ...
    private AwsClouddirectoryDeleteObjectOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsClouddirectoryDeleteObjectOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsClouddirectoryDeleteObjectOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
