...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-domain-name/index.html
...
[CliSubCommand("apigateway", "update-domain-name")]
public record AwsApigatewayUpdateDomainNameOptions : AwsOptions, IValidatableObject
{
    ...
    /// Changes information about the DomainName resource. See also: AWS API Documentation
    /// </summary>
    /// <param name="DomainName">The name of the DomainName resource to be changed.</param>
    public AwsApigatewayUpdateDomainNameOptions(
        string DomainName
    )
    {
    ...
    private AwsApigatewayUpdateDomainNameOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateDomainNameOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateDomainNameOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
