...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/delete-regex-pattern-set/index.html
...
[CliSubCommand("wafv2", "delete-regex-pattern-set")]
public record AwsWafv2DeleteRegexPatternSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2DeleteRegexPatternSetOptions(
        string Name,
        AwsWafv2DeleteRegexPatternSetScope Scope,
        string Id,
        string LockToken
    )
    {
    ...
    private AwsWafv2DeleteRegexPatternSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2DeleteRegexPatternSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2DeleteRegexPatternSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2DeleteRegexPatternSetScope? Scope { get; private init; }
