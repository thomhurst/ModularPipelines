...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/list-aliases/index.html
...
[CliSubCommand("lambda", "list-aliases")]
public record AwsLambdaListAliasesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaListAliasesOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaListAliasesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaListAliasesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaListAliasesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Specify a function version to only list aliases that invoke that version. Constraints: o min: 1 o max: 1024 o pattern: (\$LATEST(\.PUBLISHED)?|[0-9]+)
    /// </summary>
