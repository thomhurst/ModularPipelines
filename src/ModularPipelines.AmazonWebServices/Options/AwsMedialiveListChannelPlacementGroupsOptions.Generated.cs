...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/list-channel-placement-groups/index.html
...
[CliSubCommand("medialive", "list-channel-placement-groups")]
public record AwsMedialiveListChannelPlacementGroupsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMedialiveListChannelPlacementGroupsOptions(
        string ClusterId
    )
    {
    ...
    private AwsMedialiveListChannelPlacementGroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMedialiveListChannelPlacementGroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMedialiveListChannelPlacementGroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
