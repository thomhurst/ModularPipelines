...
public record AwsAppfabricGetIngestionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppfabricGetIngestionOptions(
    ...
    private AwsAppfabricGetIngestionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppfabricGetIngestionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppfabricGetIngestionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
