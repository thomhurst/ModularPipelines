...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/list-service-functions/index.html
...
[CliSubCommand("resiliencehubv2", "list-service-functions")]
public record AwsResiliencehubv2ListServiceFunctionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2ListServiceFunctionsOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2ListServiceFunctionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2ListServiceFunctionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2ListServiceFunctionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
