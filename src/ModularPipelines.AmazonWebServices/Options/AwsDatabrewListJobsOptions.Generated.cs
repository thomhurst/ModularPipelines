...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/list-jobs/index.html
...
[CliSubCommand("databrew", "list-jobs")]
public record AwsDatabrewListJobsOptions : AwsOptions
{
    /// <summary>
    /// The name of a dataset. Using this parameter indicates to return only those jobs that act on the specified dataset. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--dataset-name")]
    public string? DataSetName { get; set; }

    /// <summary>
    /// The name of a project. Using this parameter indicates to return only those jobs that are associated with the specified project. Constraints: o min: 1 o max: 255
    /// </summary>
