...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/voice-id/list-speakers/index.html
...
[CliSubCommand("voice-id", "list-speakers")]
public record AwsVoiceIdListSpeakersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsVoiceIdListSpeakersOptions(
        string DomainId
    )
    {
    ...
    private AwsVoiceIdListSpeakersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsVoiceIdListSpeakersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsVoiceIdListSpeakersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
