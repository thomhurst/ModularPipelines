...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-device-definition-versions/index.html
...
[CliSubCommand("greengrass", "list-device-definition-versions")]
public record AwsGreengrassListDeviceDefinitionVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListDeviceDefinitionVersionsOptions(
    ...
    private AwsGreengrassListDeviceDefinitionVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListDeviceDefinitionVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListDeviceDefinitionVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
