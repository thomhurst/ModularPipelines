...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codebuild/list-sandboxes/index.html
...
[CliSubCommand("codebuild", "list-sandboxes")]
public record AwsCodebuildListSandboxesOptions : AwsOptions
{
    /// <summary>
    /// The order in which sandbox records should be retrieved. Possible values: o ASCENDING o DESCENDING
    /// </summary>
    [CliOption("--sort-order")]
    public AwsCodebuildListSandboxesSortOrder? SortOrder { get; set; }
