...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appfabric/list-ingestions/index.html
...
[CliSubCommand("appfabric", "list-ingestions")]
public record AwsAppfabricListIngestionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppfabricListIngestionsOptions(
    ...
    private AwsAppfabricListIngestionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppfabricListIngestionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppfabricListIngestionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
