...
public record AwsConnectDescribeWorkspaceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectDescribeWorkspaceOptions(
        string InstanceId,
        string WorkspaceId
    )
    {
    ...
    private AwsConnectDescribeWorkspaceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectDescribeWorkspaceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectDescribeWorkspaceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
