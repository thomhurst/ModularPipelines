...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/snow-device-management/list-tasks/index.html
...
[CliSubCommand("snow-device-management", "list-tasks")]
public record AwsSnowDeviceManagementListTasksOptions : AwsOptions
{
    /// <summary>
    /// A structure used to filter the list of tasks. Possible values: o IN_PROGRESS o CANCELED o COMPLETED
    /// </summary>
    [CliOption("--state")]
    public AwsSnowDeviceManagementListTasksState? State { get; set; }
