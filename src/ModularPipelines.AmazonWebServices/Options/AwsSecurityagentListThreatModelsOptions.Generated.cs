...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityagent/list-threat-models/index.html
...
[CliSubCommand("securityagent", "list-threat-models")]
public record AwsSecurityagentListThreatModelsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a paginated list of threat model summaries for the specified agent space. See also: AWS API Documentation list-threat-models is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: threatModelSummaries
    /// </summary>
    /// <param name="AgentSpaceId">The unique identifier of the agent space to list threat models for.</param>
    public AwsSecurityagentListThreatModelsOptions(
        string AgentSpaceId
    )
    {
    ...
    private AwsSecurityagentListThreatModelsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSecurityagentListThreatModelsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSecurityagentListThreatModelsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
