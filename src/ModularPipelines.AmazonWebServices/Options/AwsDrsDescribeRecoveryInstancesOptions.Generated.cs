...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/drs/describe-recovery-instances/index.html
...
[CliSubCommand("drs", "describe-recovery-instances")]
public record AwsDrsDescribeRecoveryInstancesOptions : AwsOptions
{
    /// <summary>
    /// A set of filters by which to return Recovery Instances. recoveryInstanceIDs -&gt; (list) An array of Recovery Instance IDs that should be returned. An empty array means all Recovery Instances. Constraints: o min: 0 o max: 200 (string) Constraints: o min: 10 o max: 19 o pattern: i-[0-9a-fA-F]{8,} sourceServerIDs -&gt; (list) An array of Source Server IDs for which associated Recovery In- stances should be returned. (string) Constraints: o min: 19 o max: 19 o pattern: s-[0-9a-zA-Z]{17} Shorthand Syntax: recoveryInstanceIDs=string,string,sourceServerIDs=string,string JSON Syntax: { "recoveryInstanceIDs": ["string", ...], "sourceServerIDs": ["string", ...] }
    /// </summary>
    [CliOption("--filters")]
