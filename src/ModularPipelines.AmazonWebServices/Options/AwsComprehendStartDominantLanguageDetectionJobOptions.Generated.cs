...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/start-dominant-language-detection-job/index.html
...
[CliSubCommand("comprehend", "start-dominant-language-detection-job")]
public record AwsComprehendStartDominantLanguageDetectionJobOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsComprehendStartDominantLanguageDetectionJobOptions(
    ...
    private AwsComprehendStartDominantLanguageDetectionJobOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsComprehendStartDominantLanguageDetectionJobOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsComprehendStartDominantLanguageDetectionJobOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// An identifier for the job. Constraints: o min: 1 o max: 256 o pattern: ^([\p{L}\p{Z}\p{N}_.:/=+\-%@]*)$
    /// </summary>
    [CliOption("--job-name")]
