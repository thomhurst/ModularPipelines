...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore-control/list-browser-profiles/index.html
...
[CliSubCommand("bedrock-agentcore-control", "list-browser-profiles")]
public record AwsBedrockAgentcoreControlListBrowserProfilesOptions : AwsOptions
{
    /// <summary>
    /// The name of the browser profile to filter results by. Constraints: o pattern: [a-zA-Z][a-zA-Z0-9_]{0,47}
    /// </summary>
    [CliOption("--name")]
