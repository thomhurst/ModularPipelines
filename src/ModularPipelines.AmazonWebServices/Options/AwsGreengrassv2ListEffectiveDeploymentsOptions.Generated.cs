...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrassv2/list-effective-deployments/index.html
...
[CliSubCommand("greengrassv2", "list-effective-deployments")]
public record AwsGreengrassv2ListEffectiveDeploymentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassv2ListEffectiveDeploymentsOptions(
    ...
    private AwsGreengrassv2ListEffectiveDeploymentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassv2ListEffectiveDeploymentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassv2ListEffectiveDeploymentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
