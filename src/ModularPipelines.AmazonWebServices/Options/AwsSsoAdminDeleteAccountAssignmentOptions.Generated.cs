...
public record AwsSsoAdminDeleteAccountAssignmentOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="TargetType">The entity type for which the assignment will be deleted. Possible values: o AWS_ACCOUNT</param>
    /// <param name="PermissionSetArn">The ARN of the permission set that will be used to remove access. Constraints: o min: 10 o max: 1224 o pattern: arn:aws(-[a-z]{1,5}){0,3}:sso:::permission- Set/(sso)?ins-[a-zA-Z0-9-.]{16}/ps-[a-zA-Z0-9-./]{16}</param>
    ...
    public AwsSsoAdminDeleteAccountAssignmentOptions(
        string InstanceArn,
        string TargetId,
        AwsSsoAdminDeleteAccountAssignmentTargetType TargetType,
        string PermissionSetArn,
        AwsSsoAdminDeleteAccountAssignmentPrincipalType PrincipalType,
        string PrincipalId
    )
    {
    ...
    private AwsSsoAdminDeleteAccountAssignmentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminDeleteAccountAssignmentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminDeleteAccountAssignmentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The entity type for which the assignment will be deleted. Possible values: o AWS_ACCOUNT
    /// </summary>
    [CliOption("--target-type")]
    public AwsSsoAdminDeleteAccountAssignmentTargetType? TargetType { get; private init; }

    /// <summary>
    /// The ARN of the permission set that will be used to remove access. Constraints: o min: 10 o max: 1224 o pattern: arn:aws(-[a-z]{1,5}){0,3}:sso:::permission- Set/(sso)?ins-[a-zA-Z0-9-.]{16}/ps-[a-zA-Z0-9-./]{16}
    /// </summary>
    ...
    public AwsSsoAdminDeleteAccountAssignmentPrincipalType? PrincipalType { get; private init; }
