...
public record AwsBudgetsDeleteBudgetActionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBudgetsDeleteBudgetActionOptions(
        string AccountId,
        string BudgetName,
        string ActionId
    )
    ...
    private AwsBudgetsDeleteBudgetActionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBudgetsDeleteBudgetActionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBudgetsDeleteBudgetActionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
