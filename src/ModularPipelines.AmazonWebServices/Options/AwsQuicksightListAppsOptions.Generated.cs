...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-apps/index.html
...
[CliSubCommand("quicksight", "list-apps")]
public record AwsQuicksightListAppsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists the apps in an Amazon Web Services account. Results are pagi- nated; use the NextToken parameter to retrieve additional results. See also: AWS API Documentation list-apps is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagi- nation by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query ar- gument must extract data from the results of the f...
    /// </summary>
    /// <param name="AwsAccountId">The ID of the Amazon Web Services account that contains the apps. Constraints: o min: 12 o max: 12 o pattern: ^[0-9]{12}$</param>
    public AwsQuicksightListAppsOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListAppsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListAppsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListAppsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the Amazon Web Services account that contains the apps. Constraints: o min: 12 o max: 12 o pattern: ^[0-9]{12}$
    /// </summary>
