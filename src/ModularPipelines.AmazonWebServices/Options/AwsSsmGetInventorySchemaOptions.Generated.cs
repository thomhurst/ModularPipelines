...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/get-inventory-schema/index.html
...
[CliSubCommand("ssm", "get-inventory-schema")]
public record AwsSsmGetInventorySchemaOptions : AwsOptions
{
    /// <summary>
    /// The type of inventory item to return. Constraints: o min: 0 o max: 100
    /// </summary>
    [CliOption("--type-name")]
