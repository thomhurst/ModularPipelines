...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-ingestions/index.html
...
[CliSubCommand("quicksight", "list-ingestions")]
public record AwsQuicksightListIngestionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListIngestionsOptions(
        string DataSetId,
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListIngestionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListIngestionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListIngestionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
