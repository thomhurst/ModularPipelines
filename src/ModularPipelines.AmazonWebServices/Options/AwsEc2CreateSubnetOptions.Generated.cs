...
public record AwsEc2CreateSubnetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateSubnetOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateSubnetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateSubnetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateSubnetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
