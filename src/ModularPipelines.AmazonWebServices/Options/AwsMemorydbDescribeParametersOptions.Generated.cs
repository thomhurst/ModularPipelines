...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/memorydb/describe-parameters/index.html
...
[CliSubCommand("memorydb", "describe-parameters")]
public record AwsMemorydbDescribeParametersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns the detailed parameter list for a particular parameter group. See also: AWS API Documentation describe-parameters is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: Parameters
    /// </summary>
    /// <param name="ParameterGroupName">he name of a specific parameter group to return details for.</param>
    public AwsMemorydbDescribeParametersOptions(
    ...
    private AwsMemorydbDescribeParametersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMemorydbDescribeParametersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMemorydbDescribeParametersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
