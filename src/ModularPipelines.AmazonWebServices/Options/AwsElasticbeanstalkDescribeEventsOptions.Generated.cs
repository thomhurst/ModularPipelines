...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticbeanstalk/describe-events/index.html
...
[CliSubCommand("elasticbeanstalk", "describe-events")]
public record AwsElasticbeanstalkDescribeEventsOptions : AwsOptions
{
    ...
    /// <summary>
    /// If specified, limits the events returned from this call to include only those with the specified severity or higher. Possible values: o TRACE o DEBUG o INFO o WARN o ERROR o FATAL
    /// </summary>
    [CliOption("--severity")]
