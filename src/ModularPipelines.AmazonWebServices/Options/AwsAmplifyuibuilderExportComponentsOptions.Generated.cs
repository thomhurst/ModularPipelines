...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifyuibuilder/export-components/index.html
...
[CliSubCommand("amplifyuibuilder", "export-components")]
public record AwsAmplifyuibuilderExportComponentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyuibuilderExportComponentsOptions(
        string AppId,
    ...
    private AwsAmplifyuibuilderExportComponentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyuibuilderExportComponentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyuibuilderExportComponentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
