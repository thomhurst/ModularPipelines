...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-projects/index.html
...
[CliSubCommand("datazone", "list-projects")]
public record AwsDatazoneListProjectsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDatazoneListProjectsOptions(
    ...
    private AwsDatazoneListProjectsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDatazoneListProjectsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDatazoneListProjectsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the project. Constraints: o min: 1 o max: 64 o pattern: [\w -]+
    /// </summary>
    [CliOption("--name")]
