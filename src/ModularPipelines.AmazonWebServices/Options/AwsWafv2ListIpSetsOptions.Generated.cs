...
public record AwsWafv2ListIpSetsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2ListIpSetsOptions(
    ...
    private AwsWafv2ListIpSetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2ListIpSetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2ListIpSetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2ListIpSetsScope? Scope { get; private init; }
