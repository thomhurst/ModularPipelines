...
public record AwsWisdomDeleteContentOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomDeleteContentOptions(
        string ContentId,
    ...
    private AwsWisdomDeleteContentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomDeleteContentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomDeleteContentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
