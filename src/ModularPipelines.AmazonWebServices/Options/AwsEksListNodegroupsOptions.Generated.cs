...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-nodegroups/index.html
...
[CliSubCommand("eks", "list-nodegroups")]
public record AwsEksListNodegroupsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEksListNodegroupsOptions(
        string ClusterName
    )
    {
    ...
    private AwsEksListNodegroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEksListNodegroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEksListNodegroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
