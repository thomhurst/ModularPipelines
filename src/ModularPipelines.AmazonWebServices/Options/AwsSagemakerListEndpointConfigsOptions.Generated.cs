...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-endpoint-configs/index.html
...
[CliSubCommand("sagemaker", "list-endpoint-configs")]
public record AwsSagemakerListEndpointConfigsOptions : AwsOptions
{
    ...
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListEndpointConfigsSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order for results. The default is Descending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListEndpointConfigsSortOrder? SortOrder { get; set; }

    /// <summary>
    /// A string in the endpoint configuration name. This filter returns only endpoint configurations whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9-]+
    /// </summary>
