...
public record AwsPinpointEmailCreateDedicatedIpPoolOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPinpointEmailCreateDedicatedIpPoolOptions(
        string PoolName
    )
    {
    ...
    private AwsPinpointEmailCreateDedicatedIpPoolOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPinpointEmailCreateDedicatedIpPoolOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPinpointEmailCreateDedicatedIpPoolOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
