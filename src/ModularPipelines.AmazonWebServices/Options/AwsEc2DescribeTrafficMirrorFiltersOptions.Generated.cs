...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-traffic-mirror-filters/index.html
...
[CliSubCommand("ec2", "describe-traffic-mirror-filters")]
public record AwsEc2DescribeTrafficMirrorFiltersOptions : AwsOptions
{
    /// <summary>
    /// The ID of the Traffic Mirror filter. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--traffic-mirror-filter-ids", GroupValues = true)]
    public IEnumerable<string>? TrafficMirrorFilterIds { get; set; }
