...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/license-manager-user-subscriptions/deregister-identity-provider/index.html
...
public record AwsLicenseManagerUserSubscriptionsDeregisterIdentityProviderOptions : AwsOptions
{
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) that identifies the identity provider to deregister. Constraints: o pattern: arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{1,63}:[a-zA-Z0-9-\.]{1,510}/[a-zA-Z0-9-\.]{1,510}
    /// </summary>
