...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/list-run-groups/index.html
...
[CliSubCommand("omics", "list-run-groups")]
public record AwsOmicsListRunGroupsOptions : AwsOptions
{
    /// <summary>
    /// The run groups' name. Constraints: o min: 1 o max: 128 o pattern: [\p{L}||\p{M}||\p{Z}||\p{S}||\p{N}||\p{P}]+
    /// </summary>
    [CliOption("--name")]
