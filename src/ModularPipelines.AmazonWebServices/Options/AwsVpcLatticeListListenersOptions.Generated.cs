...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/list-listeners/index.html
...
[CliSubCommand("vpc-lattice", "list-listeners")]
public record AwsVpcLatticeListListenersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsVpcLatticeListListenersOptions(
    ...
    private AwsVpcLatticeListListenersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsVpcLatticeListListenersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsVpcLatticeListListenersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
