...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-configuration-revisions/index.html
...
[CliSubCommand("kafka", "list-configuration-revisions")]
public record AwsKafkaListConfigurationRevisionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsKafkaListConfigurationRevisionsOptions(
        string Arn
    )
    {
    ...
    private AwsKafkaListConfigurationRevisionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKafkaListConfigurationRevisionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKafkaListConfigurationRevisionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
