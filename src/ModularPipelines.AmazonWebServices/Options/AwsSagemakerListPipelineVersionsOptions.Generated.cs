...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-pipeline-versions/index.html
...
[CliSubCommand("sagemaker", "list-pipeline-versions")]
public record AwsSagemakerListPipelineVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Gets a list of all versions of the pipeline. See also: AWS API Documentation list-pipeline-versions is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: PipelineVersionSummaries
    /// </summary>
    /// <param name="PipelineName">The Amazon Resource Name (ARN) of the pipeline. Constraints: o min: 1 o max: 2048 o pattern: (arn:aws[a-z\-]*:sage- maker:[a-z0-9\-]*:([0-9]{12}|aws):pipeline/.*)?([a-zA-Z0-9](-*[a-zA-Z0-9]){0,255})</param>
    public AwsSagemakerListPipelineVersionsOptions(
        string PipelineName
    )
    {
    ...
    private AwsSagemakerListPipelineVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSagemakerListPipelineVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSagemakerListPipelineVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the pipeline. Constraints: o min: 1 o max: 2048 o pattern: (arn:aws[a-z\-]*:sage- maker:[a-z0-9\-]*:([0-9]{12}|aws):pipeline/.*)?([a-zA-Z0-9](-*[a-zA-Z0-9]){0,255})
    /// </summary>
    ...
    public AwsSagemakerListPipelineVersionsSortOrder? SortOrder { get; set; }
