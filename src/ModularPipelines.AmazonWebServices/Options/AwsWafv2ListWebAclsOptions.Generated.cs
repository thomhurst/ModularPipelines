...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-web-acls/index.html
...
[CliSubCommand("wafv2", "list-web-acls")]
public record AwsWafv2ListWebAclsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2ListWebAclsOptions(
    ...
    private AwsWafv2ListWebAclsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2ListWebAclsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2ListWebAclsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2ListWebAclsScope? Scope { get; private init; }
