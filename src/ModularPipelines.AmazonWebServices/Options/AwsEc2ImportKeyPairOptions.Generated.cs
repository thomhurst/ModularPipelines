...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/import-key-pair/index.html
...
[CliSubCommand("ec2", "import-key-pair")]
public record AwsEc2ImportKeyPairOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2ImportKeyPairOptions(
        string KeyName,
    ...
    private AwsEc2ImportKeyPairOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2ImportKeyPairOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2ImportKeyPairOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
