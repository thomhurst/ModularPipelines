...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-hours-of-operation-overrides/index.html
...
[CliSubCommand("connect", "list-hours-of-operation-overrides")]
public record AwsConnectListHoursOfOperationOverridesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListHoursOfOperationOverridesOptions(
        string InstanceId,
    ...
    private AwsConnectListHoursOfOperationOverridesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListHoursOfOperationOverridesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListHoursOfOperationOverridesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
