...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/list-decoder-manifests/index.html
...
[CliSubCommand("iotfleetwise", "list-decoder-manifests")]
public record AwsIotfleetwiseListDecoderManifestsOptions : AwsOptions
{
    ...
    /// <summary>
    /// When you set the listResponseScope parameter to METADATA_ONLY , the list response includes: decoder manifest name, Amazon Resource Name (ARN), creation time, and last modification time. Possible values: o METADATA_ONLY
    /// </summary>
    [CliOption("--list-response-scope")]
    public AwsIotfleetwiseListDecoderManifestsListResponseScope? ListResponseScope { get; set; }
