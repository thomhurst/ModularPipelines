...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediatailor/list-live-sources/index.html
...
[CliSubCommand("mediatailor", "list-live-sources")]
public record AwsMediatailorListLiveSourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMediatailorListLiveSourcesOptions(
    ...
    private AwsMediatailorListLiveSourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediatailorListLiveSourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediatailorListLiveSourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
