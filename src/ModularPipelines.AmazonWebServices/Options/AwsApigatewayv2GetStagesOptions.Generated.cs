...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-stages/index.html
...
[CliSubCommand("apigatewayv2", "get-stages")]
public record AwsApigatewayv2GetStagesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetStagesOptions(
        string ApiId
    )
    {
    ...
    private AwsApigatewayv2GetStagesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetStagesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetStagesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
