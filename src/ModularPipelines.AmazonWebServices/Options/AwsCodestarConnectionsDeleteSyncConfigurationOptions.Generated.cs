...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar-connections/delete-sync-configuration/index.html
...
[CliSubCommand("codestar-connections", "delete-sync-configuration")]
public record AwsCodestarConnectionsDeleteSyncConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsCodestarConnectionsDeleteSyncConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodestarConnectionsDeleteSyncConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodestarConnectionsDeleteSyncConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
