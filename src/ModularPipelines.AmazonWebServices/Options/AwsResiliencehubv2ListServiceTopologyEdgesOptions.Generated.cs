...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/list-service-topology-edges/index.html
...
[CliSubCommand("resiliencehubv2", "list-service-topology-edges")]
public record AwsResiliencehubv2ListServiceTopologyEdgesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2ListServiceTopologyEdgesOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2ListServiceTopologyEdgesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2ListServiceTopologyEdgesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2ListServiceTopologyEdgesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
