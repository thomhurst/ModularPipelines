...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cleanrooms/list-memberships/index.html
...
[CliSubCommand("cleanrooms", "list-memberships")]
public record AwsCleanroomsListMembershipsOptions : AwsOptions
{
    /// <summary>
    /// A filter which will return only memberships in the specified status. Possible values: o ACTIVE o REMOVED o COLLABORATION_DELETED
    /// </summary>
    [CliOption("--status")]
    public AwsCleanroomsListMembershipsStatus? Status { get; set; }
