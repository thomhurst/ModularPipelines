...
public record AwsQappsListQAppsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQappsListQAppsOptions(
        string InstanceId
    )
    {
    ...
    private AwsQappsListQAppsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQappsListQAppsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQappsListQAppsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
