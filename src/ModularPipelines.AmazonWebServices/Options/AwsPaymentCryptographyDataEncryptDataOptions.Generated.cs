...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/payment-cryptography-data/encrypt-data/index.html
...
[CliSubCommand("payment-cryptography-data", "encrypt-data")]
public record AwsPaymentCryptographyDataEncryptDataOptions : AwsOptions, IValidatableObject
{
    ...
    /// Encrypts plaintext data to ciphertext using a symmetric (TDES, AES), asymmetric (RSA), or derived (DUKPT or EMV) encryption key scheme. For more information, see Encrypt data in the Amazon Web Services Payment Cryptography User Guide . You can generate an encryption key within Amazon Web Services Payment Cryptography by calling CreateKey . You can import your own encryption key by calling ImportKey . For this operation, the key must have KeyModesOfUse set to Encrypt . In asymmetric encryption, p...
    /// </summary>
    /// <param name="KeyIdentifier">The keyARN of the encryption key that Amazon Web Services Payment Cryptography uses for plaintext encryption. When a WrappedKeyBlock is provided, this value will be the identi- fier to the key wrapping key. Otherwise, it is the key identifier used to perform the operation. Constraints: o min: 7 o max: 322 o pattern: arn:aws:payment-cryptogra- phy:[a-z]{2}-[a-z]{1,16}-[0-9]+:[0-9]{12}:(key/[0-9a-zA-Z]{16,64}|alias/[a-zA-Z0-9/_-]+)$|^alias/[a-zA-Z0-9/_-]+</param>
    /// <param name="PlainText">The plaintext to be encrypted. NOTE: For encryption using asymmetric keys, plaintext data length is constrained by encryption key strength that you define in KeyAl- gorithm and padding type that you define in AsymmetricEncryp- tionAttributes . For more information, see Encrypt data in the Amazon Web Services Payment Cryptography User Guide . Constraints: o min: 2 o max: 4096 o pattern: (?:[0-9a-fA-F][0-9a-fA-F])+</param>
    /// <param name="EncryptionAttributes">The encryption key type and attributes for plaintext encryption. NOTE: This is a Tagged Union structure. Only one of the following top level keys can be set: Symmetric, Asymmetric, Dukpt, Emv. Symmetric -&gt; (structure) Parameters that are required to perform encryption and decryp- tion using symmetric keys. Mode -&gt; (string) [required] The block cipher method to use for encryption. Possible values: o ECB o CBC o CFB o CFB1 o CFB8 o CFB64 o CFB128 o OFB InitializationVector -&gt; (string) An input used to provide the intial state. If no value is provided, Amazon Web Services Payment Cryptography defaults it to zero. Constraints: o min: 16 o max: 32 o pattern: (?:[0-9a-fA-F]{16}|[0-9a-fA-F]{32}) PaddingType -&gt; (string) The padding to be included with the data. Possible values: o PKCS1 o OAEP_SHA1 o OAEP_SHA256 o OAEP_SHA512 Asymmetric -&gt; (structure) Parameters for plaintext encryption using asymmetric keys. PaddingType -&gt; (string) The padding to be included with the data. Possible values: o PKCS1 o OAEP_SHA1 o OAEP_SHA256 o OAEP_SHA512 Dukpt -&gt; (structure) Parameters that are required to encrypt plaintext data using DUKPT. KeySerialNumber -&gt; (string) [required] The unique identifier known as Key Serial Number (KSN) that comes from an encrypting device using DUKPT encryption method. The KSN is derived from the encrypting device unique identifier and an internal transaction counter. Constraints: o min: 16 o max: 24 o pattern: (?:[0-9a-fA-F]{16}|[0-9a-fA-F]{20}|[0-9a-fA-F]{24}) Mode -&gt; (string) The block cipher method to use for encryption. The default is CBC. Possible values: o ECB o CBC DukptKeyDerivationType -&gt; (string) The key type encrypted using DUKPT from a Base Derivation Key (BDK) and Key Serial Number (KSN). This must be less than or equal to the strength of the BDK. For example, you can't use AES_128 as a derivation type for a BDK of AES_128 or TDES_2KEY Possible values: o TDES_2KEY o TDES_3KEY o AES_128 o AES_192 o AES_256 DukptKeyVariant -&gt; (string) The type of use of DUKPT, which can be incoming data decryp- tion, outgoing data encryption, or both. Possible values: o BIDIRECTIONAL o REQUEST o RESPONSE InitializationVector -&gt; (string) An input used to provide the intial state. If no value is provided, Amazon Web Services Payment Cryptography defaults it to zero. Constraints: o min: 16 o max: 32 o pattern: (?:[0-9a-fA-F]{16}|[0-9a-fA-F]{32}) Emv -&gt; (structure) Parameters for plaintext encryption using EMV keys. MajorKeyDerivationMode -&gt; (string) [required] The EMV derivation mode to use for ICC master key derivation as per EMV version 4.3 book 2. Possible values: o EMV_OPTION_A o EMV_OPTION_B PrimaryAccountNumber -&gt; (string) [required] The Primary Account Number (PAN), a unique identifier for a payment credit or debit card and associates the card to a specific account holder. Constraints: o min: 12 o max: 19 o pattern: [0-9]+ PanSequenceNumber -&gt; (string) [required] A number that identifies and differentiates payment cards with the same Primary Account Number (PAN). Typically 00 is used, if no value is provided by the terminal. Constraints: o min: 2 o max: 2 o pattern: [0-9]+ SessionDerivationData -&gt; (string) [required] The derivation value used to derive the ICC session key. It is typically the application transaction counter value padded with zeros or previous ARQC value padded with zeros as per EMV version 4.3 book 2. Constraints: o min: 16 o max: 16 o pattern: [0-9a-fA-F]+ Mode -&gt; (string) The block cipher method to use for encryption. Possible values: o ECB o CBC InitializationVector -&gt; (string) An input used to provide the intial state. If no value is provided, Amazon Web Services Payment Cryptography defaults it to zero. Constraints: o min: 16 o max: 32 o pattern: (?:[0-9a-fA-F]{16}|[0-9a-fA-F]{32}) Shorthand Syntax: Symmetric={Mode=string,InitializationVector=string,PaddingType=string},Asymmetric={PaddingType=string},Dukpt={KeySerialNumber=string,Mode=string,DukptKeyDerivationType=string,DukptKeyVariant=string,InitializationVector=string},Emv={MajorKeyDerivationMode=string,PrimaryAccountNumber=string,PanSequenceNumber=string,SessionDerivationData=string,Mode=string,InitializationVector=string} JSON Syntax: { "Symmetric": { "Mode": "ECB"|"CBC"|"CFB"|"CFB1"|"CFB8"|"CFB64"|"CFB128"|"OFB", "InitializationVector": "string", "PaddingType": "PKCS1"|"OAEP_SHA1"|"OAEP_SHA256"|"OAEP_SHA512" }, "Asymmetric": { "PaddingType": "PKCS1"|"OAEP_SHA1"|"OAEP_SHA256"|"OAEP_SHA512" }, "Dukpt": { "KeySerialNumber": "string", "Mode": "ECB"|"CBC", "DukptKeyDerivationType": "TDES_2KEY"|"TDES_3KEY"|"AES_128"|"AES_192"|"AES_256", "DukptKeyVariant": "BIDIRECTIONAL"|"REQUEST"|"RESPONSE", "InitializationVector": "string" }, "Emv": { "MajorKeyDerivationMode": "EMV_OPTION_A"|"EMV_OPTION_B", "PrimaryAccountNumber": "string", "PanSequenceNumber": "string", "SessionDerivationData": "string", "Mode": "ECB"|"CBC", "InitializationVector": "string" } }</param>
    public AwsPaymentCryptographyDataEncryptDataOptions(
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(EncryptionAttributes);
        this.EncryptionAttributes = EncryptionAttributes;
    }

    private AwsPaymentCryptographyDataEncryptDataOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPaymentCryptographyDataEncryptDataOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPaymentCryptographyDataEncryptDataOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
