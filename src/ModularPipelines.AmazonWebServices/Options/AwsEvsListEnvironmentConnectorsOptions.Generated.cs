...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/evs/list-environment-connectors/index.html
...
[CliSubCommand("evs", "list-environment-connectors")]
public record AwsEvsListEnvironmentConnectorsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEvsListEnvironmentConnectorsOptions(
    ...
    private AwsEvsListEnvironmentConnectorsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEvsListEnvironmentConnectorsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEvsListEnvironmentConnectorsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
