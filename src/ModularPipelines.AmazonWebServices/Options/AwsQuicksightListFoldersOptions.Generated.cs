...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-folders/index.html
...
[CliSubCommand("quicksight", "list-folders")]
public record AwsQuicksightListFoldersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListFoldersOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListFoldersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListFoldersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListFoldersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
