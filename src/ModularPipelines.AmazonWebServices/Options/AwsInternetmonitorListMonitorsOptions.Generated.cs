...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/internetmonitor/list-monitors/index.html
...
[CliSubCommand("internetmonitor", "list-monitors")]
public record AwsInternetmonitorListMonitorsOptions : AwsOptions
{
    /// <summary>
    /// The status of a monitor. This includes the status of the data pro- cessing for the monitor and the status of the monitor itself. For information about the statuses for a monitor, see Monitor .
    /// </summary>
