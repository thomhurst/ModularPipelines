...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/wait/project-version-training-completed/index.html
...
[CliSubCommand("rekognition", "wait", "project-version-training-completed")]
public record AwsRekognitionWaitProjectVersionTrainingCompletedOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRekognitionWaitProjectVersionTrainingCompletedOptions(
        string ProjectArn
    )
    {
    ...
    private AwsRekognitionWaitProjectVersionTrainingCompletedOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRekognitionWaitProjectVersionTrainingCompletedOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRekognitionWaitProjectVersionTrainingCompletedOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
