...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-logger-definition-versions/index.html
...
[CliSubCommand("greengrass", "list-logger-definition-versions")]
public record AwsGreengrassListLoggerDefinitionVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListLoggerDefinitionVersionsOptions(
    ...
    private AwsGreengrassListLoggerDefinitionVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListLoggerDefinitionVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListLoggerDefinitionVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
