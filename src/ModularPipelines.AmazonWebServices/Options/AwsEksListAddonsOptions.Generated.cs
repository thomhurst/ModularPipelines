...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-addons/index.html
...
[CliSubCommand("eks", "list-addons")]
public record AwsEksListAddonsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEksListAddonsOptions(
        string ClusterName
    )
    {
    ...
    private AwsEksListAddonsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEksListAddonsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEksListAddonsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
