...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-views/index.html
...
[CliSubCommand("connect", "list-views")]
public record AwsConnectListViewsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListViewsOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListViewsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListViewsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListViewsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The type of the view. Possible values: o CUSTOMER_MANAGED o AWS_MANAGED
    /// </summary>
    [CliOption("--type")]
    public AwsConnectListViewsType? Type { get; set; }
