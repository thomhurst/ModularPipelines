...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pca-connector-ad/list-service-principal-names/index.html
...
[CliSubCommand("pca-connector-ad", "list-service-principal-names")]
public record AwsPcaConnectorAdListServicePrincipalNamesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPcaConnectorAdListServicePrincipalNamesOptions(
    ...
    private AwsPcaConnectorAdListServicePrincipalNamesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPcaConnectorAdListServicePrincipalNamesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPcaConnectorAdListServicePrincipalNamesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
