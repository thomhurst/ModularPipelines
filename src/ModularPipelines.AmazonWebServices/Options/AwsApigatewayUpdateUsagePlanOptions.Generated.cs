...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-usage-plan/index.html
...
[CliSubCommand("apigateway", "update-usage-plan")]
public record AwsApigatewayUpdateUsagePlanOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayUpdateUsagePlanOptions(
        string UsagePlanId
    )
    {
    ...
    private AwsApigatewayUpdateUsagePlanOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateUsagePlanOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateUsagePlanOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
