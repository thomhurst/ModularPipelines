...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-imports/index.html
...
[CliSubCommand("mgn", "list-imports")]
public record AwsMgnListImportsOptions : AwsOptions
{
    /// <summary>
    /// List imports request filters. importIDs -&gt; (list) List imports request filters import IDs. Constraints: o min: 0 o max: 10 (string) Constraints: o min: 24 o max: 24 o pattern: import-[0-9a-zA-Z]{17} Shorthand Syntax: importIDs=string,string JSON Syntax: { "importIDs": ["string", ...] }
    /// </summary>
    [CliOption("--filters")]
