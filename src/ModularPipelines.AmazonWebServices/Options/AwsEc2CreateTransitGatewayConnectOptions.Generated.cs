...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-transit-gateway-connect/index.html
...
[CliSubCommand("ec2", "create-transit-gateway-connect")]
public record AwsEc2CreateTransitGatewayConnectOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a Connect attachment from a specified transit gateway attach- ment. A Connect attachment is a GRE-based tunnel attachment that you can use to establish a connection between a transit gateway and an ap- pliance. A Connect attachment uses an existing VPC or Amazon Web Services Direct Connect attachment as the underlying transport mechanism. See also: AWS API Documentation
    /// </summary>
    /// <param name="TransportTransitGatewayAttachmentId">The ID of the transit gateway attachment. You can specify a VPC at- tachment or Amazon Web Services Direct Connect attachment.</param>
    /// <param name="Options">The Connect attachment options. Protocol -&gt; (string) [required] The tunnel protocol. Possible values: o gre Shorthand Syntax: Protocol=string JSON Syntax: { "Protocol": "gre" }</param>
    public AwsEc2CreateTransitGatewayConnectOptions(
        string TransportTransitGatewayAttachmentId,
        string Options
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(TransportTransitGatewayAttachmentId);
    ...
    private AwsEc2CreateTransitGatewayConnectOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateTransitGatewayConnectOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateTransitGatewayConnectOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
