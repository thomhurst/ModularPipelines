...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-web-acl/index.html
...
[CliSubCommand("waf-regional", "update-web-acl")]
public record AwsWafRegionalUpdateWebAclOptions : AwsOptions, IValidatableObject
{
    ...
    /// NOTE: This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide. For the latest version of AWS WAF , use the AWS WAFV2 API and see the AWS WAF Developer Guide . With the latest version, AWS WAF has a single set of endpoints for regional and global use. Inserts or deletes ActivatedRule objects in a WebACL . Each Rule iden- tifies web requests that you want to allow, block, or count. When you update a WebACL , you specify the following values: o A defa...
    /// </summary>
    /// <param name="WebAclId">The WebACLId of the WebACL that you want to update. WebACLId is re- turned by CreateWebACL and by ListWebACLs . Constraints: o min: 1 o max: 128 o pattern: .*\S.*</param>
    ...
    public AwsWafRegionalUpdateWebAclOptions(
        string WebAclId,
        string ChangeToken
    )
    {
    ...
    private AwsWafRegionalUpdateWebAclOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafRegionalUpdateWebAclOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafRegionalUpdateWebAclOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The WebACLId of the WebACL that you want to update. WebACLId is re- turned by CreateWebACL and by ListWebACLs . Constraints: o min: 1 o max: 128 o pattern: .*\S.*
    /// </summary>
