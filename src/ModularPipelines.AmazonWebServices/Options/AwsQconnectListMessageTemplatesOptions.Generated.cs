...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-message-templates/index.html
...
[CliSubCommand("qconnect", "list-message-templates")]
public record AwsQconnectListMessageTemplatesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListMessageTemplatesOptions(
    ...
    private AwsQconnectListMessageTemplatesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListMessageTemplatesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListMessageTemplatesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
