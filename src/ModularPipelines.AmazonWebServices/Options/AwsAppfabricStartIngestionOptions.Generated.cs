...
public record AwsAppfabricStartIngestionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppfabricStartIngestionOptions(
    ...
    private AwsAppfabricStartIngestionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppfabricStartIngestionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppfabricStartIngestionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
