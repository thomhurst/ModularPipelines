...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-traffic-mirror-filter-rule/index.html
...
public record AwsEc2CreateTrafficMirrorFilterRuleOptions : AwsOptions
{
    ...
    /// <summary>
    /// The source port range. FromPort -&gt; (integer) The first port in the Traffic Mirror port range. This applies to the TCP and UDP protocols. ToPort -&gt; (integer) The last port in the Traffic Mirror port range. This applies to the TCP and UDP protocols. Shorthand Syntax: FromPort=integer,ToPort=integer JSON Syntax: { "FromPort": integer, "ToPort": integer }
    /// </summary>
