...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-verified-access-groups/index.html
...
[CliSubCommand("ec2", "describe-verified-access-groups")]
public record AwsEc2DescribeVerifiedAccessGroupsOptions : AwsOptions
{
    /// <summary>
    /// The ID of the Verified Access groups. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--verified-access-group-ids", GroupValues = true)]
    public IEnumerable<string>? VerifiedAccessGroupIds { get; set; }
