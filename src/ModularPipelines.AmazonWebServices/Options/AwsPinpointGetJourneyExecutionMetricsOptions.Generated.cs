...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/get-journey-execution-metrics/index.html
...
[CliSubCommand("pinpoint", "get-journey-execution-metrics")]
public record AwsPinpointGetJourneyExecutionMetricsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPinpointGetJourneyExecutionMetricsOptions(
    ...
    private AwsPinpointGetJourneyExecutionMetricsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPinpointGetJourneyExecutionMetricsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPinpointGetJourneyExecutionMetricsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
