...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/get-recovery-point-restore-metadata/index.html
...
[CliSubCommand("backup", "get-recovery-point-restore-metadata")]
public record AwsBackupGetRecoveryPointRestoreMetadataOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBackupGetRecoveryPointRestoreMetadataOptions(
    ...
    private AwsBackupGetRecoveryPointRestoreMetadataOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBackupGetRecoveryPointRestoreMetadataOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBackupGetRecoveryPointRestoreMetadataOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
