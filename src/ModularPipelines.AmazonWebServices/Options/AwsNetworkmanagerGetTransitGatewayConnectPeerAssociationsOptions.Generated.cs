...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-transit-gateway-connect-peer-associations/index.html
...
[CliSubCommand("networkmanager", "get-transit-gateway-connect-peer-associations")]
public record AwsNetworkmanagerGetTransitGatewayConnectPeerAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerGetTransitGatewayConnectPeerAssociationsOptions(
    ...
    private AwsNetworkmanagerGetTransitGatewayConnectPeerAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerGetTransitGatewayConnectPeerAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerGetTransitGatewayConnectPeerAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
