...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/compute-optimizer-automation/update-automation-rule/index.html
...
public record AwsComputeOptimizerAutomationUpdateAutomationRuleOptions : AwsOptions, IValidatableObject
{
    ...
    /// <summary>
    /// The updated description of the automation rule. Can be up to 1024 characters long and contain alphanumeric characters, underscores, hyphens, spaces, and certain special characters. Constraints: o min: 0 o max: 1024 o pattern: [a-zA-Z0-9_\-\s@\.]*
    /// </summary>
    [CliOption("--description")]
    public string? Description { get; set; }

    /// <summary>
    /// The updated type of automation rule. Can be either OrganizationRule for organization-wide rules or AccountRule for account-specific rules. Possible values: o OrganizationRule o AccountRule
    /// </summary>
    [CliOption("--rule-type")]
    public AwsComputeOptimizerAutomationUpdateAutomationRuleRuleType? RuleType { get; set; }

    /// <summary>
    /// Updated configuration settings for organization-wide rules, includ- ing rule application order and target account IDs. ruleApplyOrder -&gt; (string) Specifies when organization rules should be applied relative to account rules. Possible values: o BeforeAccountRules o AfterAccountRules accountIds -&gt; (list) List of specific Amazon Web Services account IDs where the orga- nization rule should be applied. Constraints: o min: 1 o max: 50 (string) Constraints: o pattern: [0-9]{12} Shorthand Syntax: ruleApplyOrder=string,accountIds=string,string JSON Syntax: { "ruleApplyOrder": "BeforeAccountRules"|"AfterAccountRules", "accountIds": ["string", ...] }
    /// </summary>
