...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/update-integration-table-properties/index.html
...
[CliSubCommand("glue", "update-integration-table-properties")]
public record AwsGlueUpdateIntegrationTablePropertiesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueUpdateIntegrationTablePropertiesOptions(
        string ResourceArn,
        string TableName
    )
    {
    ...
    private AwsGlueUpdateIntegrationTablePropertiesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueUpdateIntegrationTablePropertiesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueUpdateIntegrationTablePropertiesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
