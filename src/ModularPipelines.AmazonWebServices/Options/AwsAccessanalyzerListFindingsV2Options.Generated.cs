...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/accessanalyzer/list-findings-v2/index.html
...
[CliSubCommand("accessanalyzer", "list-findings-v2")]
public record AwsAccessanalyzerListFindingsV2Options : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves a list of findings generated by the specified analyzer. ListFindings and ListFindingsV2 both use access-analyzer:ListFindings in the Action element of an IAM policy statement. You must have permis- sion to perform the access-analyzer:ListFindings action. To learn about filter keys that you can use to retrieve a list of find- ings, see IAM Access Analyzer filter keys in the IAM User Guide . See also: AWS API Documentation list-findings-v2 is a paginated operation. Multiple API calls may...
    /// </summary>
    /// <param name="AnalyzerArn">The ARN of the analyzer to retrieve findings from. Constraints: o pattern: [^:]*:[^:]*:[^:]*:[^:]*:[^:]*:analyzer/.{1,255}</param>
    public AwsAccessanalyzerListFindingsV2Options(
        string AnalyzerArn
    )
    {
    ...
    private AwsAccessanalyzerListFindingsV2Options()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAccessanalyzerListFindingsV2Options FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAccessanalyzerListFindingsV2Options ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ARN of the analyzer to retrieve findings from. Constraints: o pattern: [^:]*:[^:]*:[^:]*:[^:]*:[^:]*:analyzer/.{1,255}
    /// </summary>
    ...
    /// <summary>
    /// The criteria used to sort. attributeName -&gt; (string) The name of the attribute to sort on. orderBy -&gt; (string) The sort order, ascending or descending. Possible values: o ASC o DESC Shorthand Syntax: attributeName=string,orderBy=string JSON Syntax: { "attributeName": "string", "orderBy": "ASC"|"DESC" }
    /// </summary>
    [CliOption("--sort")]
