...
public record AwsElbv2CreateLoadBalancerOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates an Application Load Balancer, Network Load Balancer, or Gateway Load Balancer. For more information, see the following: o Application Load Balancers o Network Load Balancers o Gateway Load Balancers This operation is idempotent, which means that it completes at most one time. If you attempt to create multiple load balancers with the same settings, each call succeeds. See also: AWS API Documentation
    /// </summary>
    /// <param name="Name">The name of the load balancer. This name must be unique per region per account, can have a maximum of 32 characters, must contain only alphanumeric characters or hy- phens, must not begin or end with a hyphen, and must not begin with "internal-".</param>
    public AwsElbv2CreateLoadBalancerOptions(
        string Name
    )
    {
    ...
    private AwsElbv2CreateLoadBalancerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsElbv2CreateLoadBalancerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsElbv2CreateLoadBalancerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the load balancer. This name must be unique per region per account, can have a maximum of 32 characters, must contain only alphanumeric characters or hy- phens, must not begin or end with a hyphen, and must not begin with "internal-".
    /// </summary>
    [CliOption("--name")]
