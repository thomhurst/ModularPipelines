...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/describe-notification-subscriptions/index.html
...
[CliSubCommand("workdocs", "describe-notification-subscriptions")]
public record AwsWorkdocsDescribeNotificationSubscriptionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWorkdocsDescribeNotificationSubscriptionsOptions(
    ...
    private AwsWorkdocsDescribeNotificationSubscriptionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWorkdocsDescribeNotificationSubscriptionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWorkdocsDescribeNotificationSubscriptionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
