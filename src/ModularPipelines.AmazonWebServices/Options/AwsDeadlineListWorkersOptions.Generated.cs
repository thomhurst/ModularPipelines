...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-workers/index.html
...
[CliSubCommand("deadline", "list-workers")]
public record AwsDeadlineListWorkersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists workers. See also: AWS API Documentation list-workers is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: workers
    /// </summary>
    /// <param name="FarmId">The farm ID connected to the workers. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    /// <param name="FleetId">The fleet ID of the workers. Constraints: o pattern: fleet-[0-9a-f]{32}</param>
    public AwsDeadlineListWorkersOptions(
        string FarmId,
        string FleetId
    )
    {
    ...
    private AwsDeadlineListWorkersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListWorkersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListWorkersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID connected to the workers. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    public string? FarmId { get; private init; }

    /// <summary>
    /// The fleet ID of the workers. Constraints: o pattern: fleet-[0-9a-f]{32}
    /// </summary>
    [CliOption("--fleet-id")]
