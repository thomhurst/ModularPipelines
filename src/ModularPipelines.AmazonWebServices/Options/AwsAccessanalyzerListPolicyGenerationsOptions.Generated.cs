...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/accessanalyzer/list-policy-generations/index.html
...
[CliSubCommand("accessanalyzer", "list-policy-generations")]
public record AwsAccessanalyzerListPolicyGenerationsOptions : AwsOptions
{
    /// <summary>
    /// The ARN of the IAM entity (user or role) for which you are generat- ing a policy. Use this with ListGeneratedPolicies to filter the re- sults to only include results for a specific principal. Constraints: o pattern: arn:[^:]*:iam::[^:]*:(role|user)/.{1,576}
    /// </summary>
