...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/list-access-keys/index.html
...
[CliSubCommand("iam", "list-access-keys")]
public record AwsIamListAccessKeysOptions : AwsOptions
{
    /// <summary>
    /// The name of the user. This parameter allows (through its regex pattern ) a string of char- acters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following charac- ters: _+=,.@- Constraints: o min: 1 o max: 128 o pattern: [\w+=,.@-]+
    /// </summary>
    [CliOption("--user-name")]
