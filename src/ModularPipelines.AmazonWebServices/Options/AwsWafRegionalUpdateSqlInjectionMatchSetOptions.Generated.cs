...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf-regional/update-sql-injection-match-set/index.html
...
[CliSubCommand("waf-regional", "update-sql-injection-match-set")]
public record AwsWafRegionalUpdateSqlInjectionMatchSetOptions : AwsOptions, IValidatableObject
{
    ...
    /// NOTE: This is AWS WAF Classic documentation. For more information, see AWS WAF Classic in the developer guide. For the latest version of AWS WAF , use the AWS WAFV2 API and see the AWS WAF Developer Guide . With the latest version, AWS WAF has a single set of endpoints for regional and global use. Inserts or deletes SqlInjectionMatchTuple objects (filters) in a SqlInjectionMatchSet . For each SqlInjectionMatchTuple object, you specify the following values: o Action : Whether to insert the object...
    /// </summary>
    /// <param name="SqlInjectionMatchSetId">The SqlInjectionMatchSetId of the SqlInjectionMatchSet that you want to update. SqlInjectionMatchSetId is returned by CreateSqlInjec- tionMatchSet and by ListSqlInjectionMatchSets . Constraints: o min: 1 o max: 128 o pattern: .*\S.*</param>
    ...
    private AwsWafRegionalUpdateSqlInjectionMatchSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafRegionalUpdateSqlInjectionMatchSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafRegionalUpdateSqlInjectionMatchSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The SqlInjectionMatchSetId of the SqlInjectionMatchSet that you want to update. SqlInjectionMatchSetId is returned by CreateSqlInjec- tionMatchSet and by ListSqlInjectionMatchSets . Constraints: o min: 1 o max: 128 o pattern: .*\S.*
    /// </summary>
