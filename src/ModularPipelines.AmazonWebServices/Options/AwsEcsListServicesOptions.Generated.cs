...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecs/list-services/index.html
...
[CliSubCommand("ecs", "list-services")]
public record AwsEcsListServicesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The launch type to use when filtering the ListServices results. Possible values: o EC2 o FARGATE o EXTERNAL o MANAGED_INSTANCES
    /// </summary>
    [CliOption("--launch-type")]
    public AwsEcsListServicesLaunchType? LaunchType { get; set; }

    /// <summary>
    /// The scheduling strategy to use when filtering the ListServices re- sults. Possible values: o REPLICA o DAEMON
    /// </summary>
    [CliOption("--scheduling-strategy")]
    public AwsEcsListServicesSchedulingStrategy? SchedulingStrategy { get; set; }

    /// <summary>
    /// The resourceManagementType type to use when filtering the ListSer- vices results. Possible values: o CUSTOMER o ECS
    /// </summary>
    [CliOption("--resource-management-type")]
    public AwsEcsListServicesResourceManagementType? ResourceManagementType { get; set; }
