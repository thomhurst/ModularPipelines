...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeartifact/list-package-groups/index.html
...
public record AwsCodeartifactListPackageGroupsOptions : AwsOptions
{
    ...
    /// <summary>
    /// A prefix for which to search package groups. When included, List- PackageGroups will return only package groups with patterns that match the prefix. Constraints: o min: 0 o max: 520 o pattern: \P{C}*
    /// </summary>
    [CliOption("--prefix")]
