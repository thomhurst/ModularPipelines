...
public record AwsEc2ModifyIpamPrefixListResolverOptions : AwsOptions, IValidatableObject
{
    ...
    /// Modifies an IPAM prefix list resolver. You can update the description and CIDR selection rules. Changes to rules will trigger re-evaluation and potential updates to associated prefix lists. See also: AWS API Documentation
    /// </summary>
    /// <param name="IpamPrefixListResolverId">The ID of the IPAM prefix list resolver to modify.</param>
    public AwsEc2ModifyIpamPrefixListResolverOptions(
    ...
    private AwsEc2ModifyIpamPrefixListResolverOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2ModifyIpamPrefixListResolverOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2ModifyIpamPrefixListResolverOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
