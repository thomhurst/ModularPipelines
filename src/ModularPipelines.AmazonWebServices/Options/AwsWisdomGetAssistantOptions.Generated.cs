...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/get-assistant/index.html
...
[CliSubCommand("wisdom", "get-assistant")]
public record AwsWisdomGetAssistantOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomGetAssistantOptions(
        string AssistantId
    )
    {
    ...
    private AwsWisdomGetAssistantOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomGetAssistantOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomGetAssistantOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
