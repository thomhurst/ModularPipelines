...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/update-column-statistics-for-partition/index.html
...
[CliSubCommand("glue", "update-column-statistics-for-partition")]
public record AwsGlueUpdateColumnStatisticsForPartitionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueUpdateColumnStatisticsForPartitionOptions(
        string DatabaseName,
        string TableName,
    ...
    private AwsGlueUpdateColumnStatisticsForPartitionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueUpdateColumnStatisticsForPartitionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueUpdateColumnStatisticsForPartitionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
