...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cost-optimization-hub/list-enrollment-statuses/index.html
...
public record AwsCostOptimizationHubListEnrollmentStatusesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The account ID of a member account in the organization. Constraints: o pattern: [0-9]{12}
    /// </summary>
