...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-domain-layouts/index.html
...
[CliSubCommand("customer-profiles", "list-domain-layouts")]
public record AwsCustomerProfilesListDomainLayoutsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListDomainLayoutsOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListDomainLayoutsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListDomainLayoutsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListDomainLayoutsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
