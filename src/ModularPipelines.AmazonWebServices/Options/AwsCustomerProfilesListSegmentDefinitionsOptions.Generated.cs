...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-segment-definitions/index.html
...
[CliSubCommand("customer-profiles", "list-segment-definitions")]
public record AwsCustomerProfilesListSegmentDefinitionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListSegmentDefinitionsOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListSegmentDefinitionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListSegmentDefinitionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListSegmentDefinitionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
