...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-event-trackers/index.html
...
[CliSubCommand("personalize", "list-event-trackers")]
public record AwsPersonalizeListEventTrackersOptions : AwsOptions
{
    /// <summary>
    /// The ARN of a dataset group used to filter the response. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
