...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/list-recipes/index.html
...
[CliSubCommand("databrew", "list-recipes")]
public record AwsDatabrewListRecipesOptions : AwsOptions
{
    /// <summary>
    /// Return only those recipes with a version identifier of LATEST_WORK- ING or LATEST_PUBLISHED . If RecipeVersion is omitted, ListRecipes returns all of the LATEST_PUBLISHED recipe versions. Valid values: LATEST_WORKING | LATEST_PUBLISHED Constraints: o min: 1 o max: 16
    /// </summary>
