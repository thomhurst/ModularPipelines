...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-metadata-model-conversions/index.html
...
[CliSubCommand("dms", "describe-metadata-model-conversions")]
public record AwsDmsDescribeMetadataModelConversionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDmsDescribeMetadataModelConversionsOptions(
    ...
    private AwsDmsDescribeMetadataModelConversionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDmsDescribeMetadataModelConversionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDmsDescribeMetadataModelConversionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
