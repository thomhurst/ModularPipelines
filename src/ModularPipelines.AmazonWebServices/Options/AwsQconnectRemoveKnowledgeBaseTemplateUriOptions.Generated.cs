...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/remove-knowledge-base-template-uri/index.html
...
[CliSubCommand("qconnect", "remove-knowledge-base-template-uri")]
public record AwsQconnectRemoveKnowledgeBaseTemplateUriOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectRemoveKnowledgeBaseTemplateUriOptions(
    ...
    private AwsQconnectRemoveKnowledgeBaseTemplateUriOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectRemoveKnowledgeBaseTemplateUriOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectRemoveKnowledgeBaseTemplateUriOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
