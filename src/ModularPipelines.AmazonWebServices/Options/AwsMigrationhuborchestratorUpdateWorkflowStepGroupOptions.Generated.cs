...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/migrationhuborchestrator/update-workflow-step-group/index.html
...
[CliSubCommand("migrationhuborchestrator", "update-workflow-step-group")]
public record AwsMigrationhuborchestratorUpdateWorkflowStepGroupOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Id">The ID of the step group. Constraints: o min: 1 o max: 100 o pattern: [a-zA-Z0-9-]+</param>
    public AwsMigrationhuborchestratorUpdateWorkflowStepGroupOptions(
        string WorkflowId,
        string Id
    )
    {
    ...
    private AwsMigrationhuborchestratorUpdateWorkflowStepGroupOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMigrationhuborchestratorUpdateWorkflowStepGroupOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMigrationhuborchestratorUpdateWorkflowStepGroupOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
