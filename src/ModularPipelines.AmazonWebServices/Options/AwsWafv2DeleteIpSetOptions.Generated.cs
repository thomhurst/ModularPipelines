...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/delete-ip-set/index.html
...
[CliSubCommand("wafv2", "delete-ip-set")]
public record AwsWafv2DeleteIpSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2DeleteIpSetOptions(
        string Name,
        AwsWafv2DeleteIpSetScope Scope,
        string Id,
        string LockToken
    )
    {
    ...
    private AwsWafv2DeleteIpSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2DeleteIpSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2DeleteIpSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2DeleteIpSetScope? Scope { get; private init; }
