...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-asset-bundle-export-jobs/index.html
...
[CliSubCommand("quicksight", "list-asset-bundle-export-jobs")]
public record AwsQuicksightListAssetBundleExportJobsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists all asset bundle export jobs that have been taken place in the last 14 days. Jobs created more than 14 days ago are deleted forever and are not returned. If you are using the same job ID for multiple jobs, ListAssetBundleExportJobs only returns the most recent job that uses the repeated job ID. See also: AWS API Documentation list-asset-bundle-export-jobs is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagina...
    /// </summary>
    /// <param name="AwsAccountId">The ID of the Amazon Web Services account that the export jobs were executed in. Constraints: o min: 12 o max: 12 o pattern: ^[0-9]{12}$</param>
    public AwsQuicksightListAssetBundleExportJobsOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListAssetBundleExportJobsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListAssetBundleExportJobsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListAssetBundleExportJobsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the Amazon Web Services account that the export jobs were executed in. Constraints: o min: 12 o max: 12 o pattern: ^[0-9]{12}$
    /// </summary>
