...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pipes/list-pipes/index.html
...
[CliSubCommand("pipes", "list-pipes")]
public record AwsPipesListPipesOptions : AwsOptions
{
    /// <summary>
    /// A value that will return a subset of the pipes associated with this account. For example, "NamePrefix": "ABC" will return all endpoints with "ABC" in the name. Constraints: o min: 1 o max: 64 o pattern: [\.\-_A-Za-z0-9]+
    /// </summary>
    [CliOption("--name-prefix")]
    public string? NamePrefix { get; set; }

    /// <summary>
    /// The state the pipe should be in. Possible values: o RUNNING o STOPPED
    /// </summary>
    [CliOption("--desired-state")]
    public AwsPipesListPipesDesiredState? DesiredState { get; set; }
    ...
    /// <summary>
    /// The prefix matching the pipe target. Constraints: o min: 1 o max: 1600
    /// </summary>
