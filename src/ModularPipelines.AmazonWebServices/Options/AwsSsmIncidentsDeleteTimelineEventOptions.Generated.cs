...
public record AwsSsmIncidentsDeleteTimelineEventOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsmIncidentsDeleteTimelineEventOptions(
        string EventId,
    ...
    private AwsSsmIncidentsDeleteTimelineEventOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsmIncidentsDeleteTimelineEventOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsmIncidentsDeleteTimelineEventOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
