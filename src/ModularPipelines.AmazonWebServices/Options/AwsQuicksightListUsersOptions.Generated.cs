...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-users/index.html
...
[CliSubCommand("quicksight", "list-users")]
public record AwsQuicksightListUsersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListUsersOptions(
        string AwsAccountId,
        string Namespace
    )
    {
    ...
    private AwsQuicksightListUsersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListUsersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListUsersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
