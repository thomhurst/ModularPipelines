...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/create-profile-job/index.html
...
public record AwsDatabrewCreateProfileJobOptions : AwsOptions
{
    ...
    /// <summary>
    /// The encryption mode for the job, which can be one of the following: o SSE-KMS - SSE-KMS - Server-side encryption with KMS-managed keys. o SSE-S3 - Server-side encryption with keys managed by Amazon S3. Possible values: o SSE-KMS o SSE-S3
    /// </summary>
    ...
    public AwsDatabrewCreateProfileJobLogSubscription? LogSubscription { get; set; }
