...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cognito-idp/resend-confirmation-code/index.html
...
[CliSubCommand("cognito-idp", "resend-confirmation-code")]
public record AwsCognitoIdpResendConfirmationCodeOptions : AwsOptions, IValidatableObject
{
    ...
    /// Resends the code that confirms a new account for a user who has signed up in your user pool. Amazon Cognito sends confirmation codes to the user attribute in the AutoVerifiedAttributes property of your user pool. When you prompt new users for the confirmation code, include a "Resend code" option that generates a call to this API operation. NOTE: Amazon Cognito doesn't evaluate Identity and Access Management (IAM) policies in requests for this API operation. For this operation, you can't use IAM ...
    /// </summary>
    /// <param name="ClientId">The ID of the user pool app client where the user signed up. Constraints: o min: 1 o max: 128 o pattern: [\w+]+</param>
    ...
    public AwsCognitoIdpResendConfirmationCodeOptions(
        string ClientId,
        string Username
    )
    {
    ...
    private AwsCognitoIdpResendConfirmationCodeOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCognitoIdpResendConfirmationCodeOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCognitoIdpResendConfirmationCodeOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the user pool app client where the user signed up. Constraints: o min: 1 o max: 128 o pattern: [\w+]+
    /// </summary>
    [CliOption("--client-id")]
