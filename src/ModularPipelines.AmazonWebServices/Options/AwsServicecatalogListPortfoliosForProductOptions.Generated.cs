...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog/list-portfolios-for-product/index.html
...
[CliSubCommand("servicecatalog", "list-portfolios-for-product")]
public record AwsServicecatalogListPortfoliosForProductOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsServicecatalogListPortfoliosForProductOptions(
        string ProductId
    )
    {
    ...
    private AwsServicecatalogListPortfoliosForProductOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsServicecatalogListPortfoliosForProductOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsServicecatalogListPortfoliosForProductOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
