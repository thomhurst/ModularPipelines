...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codestar-connections/create-connection/index.html
...
[CliSubCommand("codestar-connections", "create-connection")]
public record AwsCodestarConnectionsCreateConnectionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCodestarConnectionsCreateConnectionOptions(
    ...
    private AwsCodestarConnectionsCreateConnectionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodestarConnectionsCreateConnectionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodestarConnectionsCreateConnectionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the external provider where your third-party code repos- itory is configured. Possible values: o Bitbucket o GitHub o GitHubEnterpriseServer o GitLab o GitLabSelfManaged
    /// </summary>
    [CliOption("--provider-type")]
    public AwsCodestarConnectionsCreateConnectionProviderType? ProviderType { get; set; }
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the host associated with the con- nection to be created. Constraints: o min: 0 o max: 256 o pattern: arn:aws(-[\w]+)*:codestar-connec- tions:.+:[0-9]{12}:host\/.+
    /// </summary>
    [CliOption("--host-arn")]
