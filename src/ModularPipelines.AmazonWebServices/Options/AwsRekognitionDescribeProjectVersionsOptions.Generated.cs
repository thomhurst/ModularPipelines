...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rekognition/describe-project-versions/index.html
...
[CliSubCommand("rekognition", "describe-project-versions")]
public record AwsRekognitionDescribeProjectVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRekognitionDescribeProjectVersionsOptions(
        string ProjectArn
    )
    {
    ...
    private AwsRekognitionDescribeProjectVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRekognitionDescribeProjectVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRekognitionDescribeProjectVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
