...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-rule-based-matches/index.html
...
[CliSubCommand("customer-profiles", "list-rule-based-matches")]
public record AwsCustomerProfilesListRuleBasedMatchesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListRuleBasedMatchesOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListRuleBasedMatchesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListRuleBasedMatchesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListRuleBasedMatchesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
