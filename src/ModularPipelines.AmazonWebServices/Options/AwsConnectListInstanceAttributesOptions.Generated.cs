...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-instance-attributes/index.html
...
[CliSubCommand("connect", "list-instance-attributes")]
public record AwsConnectListInstanceAttributesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListInstanceAttributesOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListInstanceAttributesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListInstanceAttributesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListInstanceAttributesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
