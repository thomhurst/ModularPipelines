...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-local-gateway-virtual-interface/index.html
...
public record AwsEc2CreateLocalGatewayVirtualInterfaceOptions : AwsOptions
{
    ...
    /// <summary>
    /// The extended 32-bit ASN of the BGP peer for use with larger ASN val- ues.
    /// </summary>
    [CliOption("--peer-bgp-asn-extended")]
    public int? PeerBgpAsnExtended { get; set; }
