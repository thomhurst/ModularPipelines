...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bcm-pricing-calculator/list-workload-estimate-usage/index.html
...
[CliSubCommand("bcm-pricing-calculator", "list-workload-estimate-usage")]
public record AwsBcmPricingCalculatorListWorkloadEstimateUsageOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists the usage associated with a workload estimate. See also: AWS API Documentation list-workload-estimate-usage is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: items
    /// </summary>
    /// <param name="WorkloadEstimateId">The unique identifier of the workload estimate to list usage for. Constraints: o min: 36 o max: 36 o pattern: [a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}</param>
    public AwsBcmPricingCalculatorListWorkloadEstimateUsageOptions(
    ...
    private AwsBcmPricingCalculatorListWorkloadEstimateUsageOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBcmPricingCalculatorListWorkloadEstimateUsageOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBcmPricingCalculatorListWorkloadEstimateUsageOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
