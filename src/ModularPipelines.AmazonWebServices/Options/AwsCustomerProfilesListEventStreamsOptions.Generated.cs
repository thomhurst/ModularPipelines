...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-event-streams/index.html
...
[CliSubCommand("customer-profiles", "list-event-streams")]
public record AwsCustomerProfilesListEventStreamsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListEventStreamsOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListEventStreamsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListEventStreamsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListEventStreamsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
