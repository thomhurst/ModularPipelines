...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-connection-functions/index.html
...
[CliSubCommand("cloudfront", "list-connection-functions")]
public record AwsCloudfrontListConnectionFunctionsOptions : AwsOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--stage")]
    public AwsCloudfrontListConnectionFunctionsStage? Stage { get; set; }
