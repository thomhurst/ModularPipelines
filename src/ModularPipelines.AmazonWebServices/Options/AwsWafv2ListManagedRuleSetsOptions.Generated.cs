...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-managed-rule-sets/index.html
...
[CliSubCommand("wafv2", "list-managed-rule-sets")]
public record AwsWafv2ListManagedRuleSetsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2ListManagedRuleSetsOptions(
        AwsWafv2ListManagedRuleSetsScope Scope
    )
    {
        this.Scope = Scope;
    }

    private AwsWafv2ListManagedRuleSetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2ListManagedRuleSetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2ListManagedRuleSetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2ListManagedRuleSetsScope? Scope { get; private init; }
