...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrassv2/list-client-devices-associated-with-core-device/index.html
...
[CliSubCommand("greengrassv2", "list-client-devices-associated-with-core-device")]
public record AwsGreengrassv2ListClientDevicesAssociatedWithCoreDeviceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassv2ListClientDevicesAssociatedWithCoreDeviceOptions(
    ...
    private AwsGreengrassv2ListClientDevicesAssociatedWithCoreDeviceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassv2ListClientDevicesAssociatedWithCoreDeviceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassv2ListClientDevicesAssociatedWithCoreDeviceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
