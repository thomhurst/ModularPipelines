...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/servicecatalog-appregistry/list-associated-attribute-groups/index.html
...
[CliSubCommand("servicecatalog-appregistry", "list-associated-attribute-groups")]
public record AwsServicecatalogAppregistryListAssociatedAttributeGroupsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsServicecatalogAppregistryListAssociatedAttributeGroupsOptions(
        string Application
    )
    {
    ...
    private AwsServicecatalogAppregistryListAssociatedAttributeGroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsServicecatalogAppregistryListAssociatedAttributeGroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsServicecatalogAppregistryListAssociatedAttributeGroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
