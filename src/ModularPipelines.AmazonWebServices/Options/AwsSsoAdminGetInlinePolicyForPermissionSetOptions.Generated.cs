...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/get-inline-policy-for-permission-set/index.html
...
[CliSubCommand("sso-admin", "get-inline-policy-for-permission-set")]
public record AwsSsoAdminGetInlinePolicyForPermissionSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminGetInlinePolicyForPermissionSetOptions(
        string InstanceArn,
    ...
    private AwsSsoAdminGetInlinePolicyForPermissionSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminGetInlinePolicyForPermissionSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminGetInlinePolicyForPermissionSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
