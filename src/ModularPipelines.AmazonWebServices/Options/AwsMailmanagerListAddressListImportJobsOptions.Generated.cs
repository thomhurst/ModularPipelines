...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mailmanager/list-address-list-import-jobs/index.html
...
[CliSubCommand("mailmanager", "list-address-list-import-jobs")]
public record AwsMailmanagerListAddressListImportJobsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists jobs for an address list. See also: AWS API Documentation list-address-list-import-jobs is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: ImportJobs
    /// </summary>
    /// <param name="AddressListId">The unique identifier of the address list for listing import jobs. Constraints: o min: 1 o max: 255 o pattern: [a-zA-Z0-9-]+</param>
    public AwsMailmanagerListAddressListImportJobsOptions(
    ...
    private AwsMailmanagerListAddressListImportJobsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMailmanagerListAddressListImportJobsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMailmanagerListAddressListImportJobsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique identifier of the address list for listing import jobs. Constraints: o min: 1 o max: 255 o pattern: [a-zA-Z0-9-]+
    /// </summary>
