...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/get-work-units/index.html
...
[CliSubCommand("lakeformation", "get-work-units")]
public record AwsLakeformationGetWorkUnitsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLakeformationGetWorkUnitsOptions(
        string QueryId
    )
    {
    ...
    private AwsLakeformationGetWorkUnitsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLakeformationGetWorkUnitsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLakeformationGetWorkUnitsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
