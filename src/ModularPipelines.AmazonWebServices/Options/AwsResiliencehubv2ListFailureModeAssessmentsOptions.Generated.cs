...
public record AwsResiliencehubv2ListFailureModeAssessmentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2ListFailureModeAssessmentsOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2ListFailureModeAssessmentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2ListFailureModeAssessmentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2ListFailureModeAssessmentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
