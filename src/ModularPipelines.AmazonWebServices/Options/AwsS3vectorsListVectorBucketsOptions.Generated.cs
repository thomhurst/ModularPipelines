...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3vectors/list-vector-buckets/index.html
...
[CliSubCommand("s3vectors", "list-vector-buckets")]
public record AwsS3vectorsListVectorBucketsOptions : AwsOptions
{
    /// <summary>
    /// Limits the response to vector buckets that begin with the specified prefix. Constraints: o min: 1 o max: 63
    /// </summary>
    [CliOption("--prefix")]
