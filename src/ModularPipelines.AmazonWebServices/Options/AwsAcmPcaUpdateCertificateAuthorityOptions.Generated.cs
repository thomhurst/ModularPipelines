...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm-pca/update-certificate-authority/index.html
...
public record AwsAcmPcaUpdateCertificateAuthorityOptions : AwsOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Status of your private CA. Possible values: o CREATING o PENDING_CERTIFICATE o ACTIVE o DELETED o DISABLED o EXPIRED o FAILED
    /// </summary>
    [CliOption("--status")]
    public AwsAcmPcaUpdateCertificateAuthorityStatus? Status { get; set; }
