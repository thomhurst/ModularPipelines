...
public record AwsBudgetsUpdateBudgetActionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBudgetsUpdateBudgetActionOptions(
        string AccountId,
        string BudgetName,
        string ActionId
    )
    ...
    private AwsBudgetsUpdateBudgetActionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBudgetsUpdateBudgetActionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBudgetsUpdateBudgetActionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
