...
public record AwsNotificationsUntagResourceOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsNotificationsUntagResourceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNotificationsUntagResourceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNotificationsUntagResourceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The tag keys to use to untag a resource. Constraints: o min: 0 o max: 200 (string) Constraints: o pattern: (?!aws:).{1,128} Syntax: "string" "string" ...
    /// </summary>
