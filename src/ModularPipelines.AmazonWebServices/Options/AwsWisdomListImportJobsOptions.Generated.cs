...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/list-import-jobs/index.html
...
[CliSubCommand("wisdom", "list-import-jobs")]
public record AwsWisdomListImportJobsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomListImportJobsOptions(
    ...
    private AwsWisdomListImportJobsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomListImportJobsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomListImportJobsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
