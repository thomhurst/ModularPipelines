...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3files/list-file-systems/index.html
...
[CliSubCommand("s3files", "list-file-systems")]
public record AwsS3filesListFileSystemsOptions : AwsOptions
{
    /// <summary>
    /// Optional filter to list only file systems associated with the speci- fied S3 bucket Amazon Resource Name (ARN). If provided, only file systems that provide access to this bucket will be returned in the response. Constraints: o pattern: (arn:aws[a-zA-Z0-9-]*:s3:::.+)
    /// </summary>
    [CliOption("--bucket")]
