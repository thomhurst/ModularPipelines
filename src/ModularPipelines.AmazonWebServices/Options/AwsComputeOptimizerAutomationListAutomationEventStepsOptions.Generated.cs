...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/compute-optimizer-automation/list-automation-event-steps/index.html
...
[CliSubCommand("compute-optimizer-automation", "list-automation-event-steps")]
public record AwsComputeOptimizerAutomationListAutomationEventStepsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists the steps for a specific automation event. You can only list steps for events created within the past year. See also: AWS API Documentation list-automation-event-steps is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the foll...
    /// </summary>
    /// <param name="EventId">The ID of the automation event. Constraints: o pattern: [0-9A-Za-z]{16}</param>
    public AwsComputeOptimizerAutomationListAutomationEventStepsOptions(
        string EventId
    )
    {
    ...
    private AwsComputeOptimizerAutomationListAutomationEventStepsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsComputeOptimizerAutomationListAutomationEventStepsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsComputeOptimizerAutomationListAutomationEventStepsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the automation event. Constraints: o pattern: [0-9A-Za-z]{16}
    /// </summary>
    [CliOption("--event-id")]
