...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-ipam-scope/index.html
...
[CliSubCommand("ec2", "create-ipam-scope")]
public record AwsEc2CreateIpamScopeOptions : AwsOptions, IValidatableObject
{
    ...
    /// Create an IPAM scope. In IPAM, a scope is the highest-level container within IPAM. An IPAM contains two default scopes. Each scope represents the IP space for a single network. The private scope is intended for all private IP address space. The public scope is intended for all pub- lic IP address space. Scopes enable you to reuse IP addresses across multiple unconnected networks without causing IP address overlap or conflict. For more information, see Add a scope in the Amazon VPC IPAM User Guid...
    /// </summary>
    /// <param name="IpamId">The ID of the IPAM for which you're creating this scope.</param>
    public AwsEc2CreateIpamScopeOptions(
        string IpamId
    )
    {
    ...
    private AwsEc2CreateIpamScopeOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateIpamScopeOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateIpamScopeOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
