...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-network-acl/index.html
...
[CliSubCommand("ec2", "create-network-acl")]
public record AwsEc2CreateNetworkAclOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateNetworkAclOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateNetworkAclOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateNetworkAclOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateNetworkAclOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
