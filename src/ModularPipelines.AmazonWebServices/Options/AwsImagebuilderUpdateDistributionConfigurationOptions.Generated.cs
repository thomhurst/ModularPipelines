...
public record AwsImagebuilderUpdateDistributionConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    /// Updates a distribution configuration. Distribution configurations de- fine and configure the outputs of your pipeline. See also: AWS API Documentation
    /// </summary>
    /// <param name="DistributionConfigurationArn">The Amazon Resource Name (ARN) of the distribution configuration that you want to update. Constraints: o pattern: ^arn:aws[^:]*:imagebuilder:[^:]+:(?:[0-9]{12}|aws):dis- tribution-configuration/[a-z0-9-_]+$</param>
    ...
    public AwsImagebuilderUpdateDistributionConfigurationOptions(
    ...
    private AwsImagebuilderUpdateDistributionConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsImagebuilderUpdateDistributionConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsImagebuilderUpdateDistributionConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the distribution configuration that you want to update. Constraints: o pattern: ^arn:aws[^:]*:imagebuilder:[^:]+:(?:[0-9]{12}|aws):dis- tribution-configuration/[a-z0-9-_]+$
    /// </summary>
