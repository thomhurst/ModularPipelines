...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-ipam/index.html
...
public record AwsEc2CreateIpamOptions : AwsOptions
{
    ...
    /// </summary>
    [CliOption("--operating-regions", GroupValues = true)]
    public IEnumerable<string>? OperatingRegions { get; set; }
    ...
    /// </summary>
    [CliOption("--tier")]
    public AwsEc2CreateIpamTier? Tier { get; set; }
