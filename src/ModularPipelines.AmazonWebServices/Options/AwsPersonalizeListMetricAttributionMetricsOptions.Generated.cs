...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-metric-attribution-metrics/index.html
...
[CliSubCommand("personalize", "list-metric-attribution-metrics")]
public record AwsPersonalizeListMetricAttributionMetricsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the metric attribution to retrieve attributes for. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
