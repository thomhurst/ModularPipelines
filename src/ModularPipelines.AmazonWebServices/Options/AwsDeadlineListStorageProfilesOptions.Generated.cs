...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-storage-profiles/index.html
...
[CliSubCommand("deadline", "list-storage-profiles")]
public record AwsDeadlineListStorageProfilesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists storage profiles. See also: AWS API Documentation list-storage-profiles is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: storageProfiles
    /// </summary>
    /// <param name="FarmId">The farm ID of the storage profile. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    public AwsDeadlineListStorageProfilesOptions(
        string FarmId
    )
    {
    ...
    private AwsDeadlineListStorageProfilesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListStorageProfilesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListStorageProfilesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID of the storage profile. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
