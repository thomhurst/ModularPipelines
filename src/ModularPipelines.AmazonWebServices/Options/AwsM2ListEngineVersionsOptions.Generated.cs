...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-engine-versions/index.html
...
[CliSubCommand("m2", "list-engine-versions")]
public record AwsM2ListEngineVersionsOptions : AwsOptions
{
    /// <summary>
    /// The type of target platform. Possible values: o microfocus o bluage
    /// </summary>
    [CliOption("--engine-type")]
    public AwsM2ListEngineVersionsEngineType? EngineType { get; set; }
