...
public record AwsAppstreamUpdateApplicationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppstreamUpdateApplicationOptions(
        string Name
    )
    {
    ...
    private AwsAppstreamUpdateApplicationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppstreamUpdateApplicationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppstreamUpdateApplicationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
