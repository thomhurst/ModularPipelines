...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/associate-ipam-resource-discovery/index.html
...
[CliSubCommand("ec2", "associate-ipam-resource-discovery")]
public record AwsEc2AssociateIpamResourceDiscoveryOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2AssociateIpamResourceDiscoveryOptions(
        string IpamId,
    ...
    private AwsEc2AssociateIpamResourceDiscoveryOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2AssociateIpamResourceDiscoveryOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2AssociateIpamResourceDiscoveryOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
