...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-reserved-node-exchange-status/index.html
...
[CliSubCommand("redshift", "describe-reserved-node-exchange-status")]
public record AwsRedshiftDescribeReservedNodeExchangeStatusOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the source reserved node in a reserved-node ex- change request. Constraints: o max: 2147483647
    /// </summary>
    [CliOption("--reserved-node-id")]
    public string? ReservedNodeId { get; set; }

    /// <summary>
    /// The identifier of the reserved-node exchange request. Constraints: o max: 2147483647
    /// </summary>
