...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/delete-assistant/index.html
...
[CliSubCommand("wisdom", "delete-assistant")]
public record AwsWisdomDeleteAssistantOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomDeleteAssistantOptions(
        string AssistantId
    )
    {
    ...
    private AwsWisdomDeleteAssistantOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomDeleteAssistantOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomDeleteAssistantOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
