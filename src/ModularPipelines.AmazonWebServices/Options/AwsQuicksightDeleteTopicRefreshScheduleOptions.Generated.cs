...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/delete-topic-refresh-schedule/index.html
...
[CliSubCommand("quicksight", "delete-topic-refresh-schedule")]
public record AwsQuicksightDeleteTopicRefreshScheduleOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightDeleteTopicRefreshScheduleOptions(
        string AwsAccountId,
        string TopicId,
        string DataSetId
    )
    ...
    private AwsQuicksightDeleteTopicRefreshScheduleOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightDeleteTopicRefreshScheduleOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightDeleteTopicRefreshScheduleOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
