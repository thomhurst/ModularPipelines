...
public record AwsAccessanalyzerListFindingsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAccessanalyzerListFindingsOptions(
        string AnalyzerArn
    )
    {
    ...
    private AwsAccessanalyzerListFindingsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAccessanalyzerListFindingsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAccessanalyzerListFindingsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
