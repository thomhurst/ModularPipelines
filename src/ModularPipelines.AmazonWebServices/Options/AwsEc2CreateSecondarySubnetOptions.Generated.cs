...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-secondary-subnet/index.html
...
[CliSubCommand("ec2", "create-secondary-subnet")]
public record AwsEc2CreateSecondarySubnetOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a secondary subnet in a secondary network. A secondary subnet CIDR block must not overlap with the CIDR block of an existing secondary subnet in the secondary network. After you create a secondary subnet, you can't change its CIDR block. The allowed size for a secondary subnet CIDR block is between /28 net- mask (16 IP addresses) and /12 netmask (1,048,576 IP addresses). Amazon reserves the first four IP addresses and the last IP address in each secondary subnet for internal use. See als...
    /// </summary>
    /// <param name="Ipv4CidrBlock">The IPv4 CIDR block for the secondary subnet. The CIDR block size must be between /12 and /28.</param>
    /// <param name="SecondaryNetworkId">The ID of the secondary network in which to create the secondary subnet.</param>
    public AwsEc2CreateSecondarySubnetOptions(
    ...
    private AwsEc2CreateSecondarySubnetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateSecondarySubnetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateSecondarySubnetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--ipv4-cidr-block")]
    public string? Ipv4CidrBlock { get; private init; }
    ...
    /// <summary>
    /// The ID of the Availability Zone for the secondary subnet. This op- tion is preferred over AvailabilityZone as it provides a consistent identifier across Amazon Web Services accounts. You cannot specify both AvailabilityZone and AvailabilityZoneId in the same request.
    /// </summary>
