...
public record AwsAccessanalyzerListAccessPreviewFindingsOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="AnalyzerArn">The ARN of the analyzer used to generate the access. Constraints: o pattern: [^:]*:[^:]*:[^:]*:[^:]*:[^:]*:analyzer/.{1,255}</param>
    public AwsAccessanalyzerListAccessPreviewFindingsOptions(
    ...
    private AwsAccessanalyzerListAccessPreviewFindingsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAccessanalyzerListAccessPreviewFindingsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAccessanalyzerListAccessPreviewFindingsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ARN of the analyzer used to generate the access. Constraints: o pattern: [^:]*:[^:]*:[^:]*:[^:]*:[^:]*:analyzer/.{1,255}
    /// </summary>
