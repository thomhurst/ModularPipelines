...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/purchase-capacity-block/index.html
...
[CliSubCommand("ec2", "purchase-capacity-block")]
public record AwsEc2PurchaseCapacityBlockOptions : AwsOptions, IValidatableObject
{
    ...
    /// Purchase the Capacity Block for use with your account. With Capacity Blocks you ensure GPU capacity is available for machine learning (ML) workloads. You must specify the ID of the Capacity Block offering you are purchasing. See also: AWS API Documentation
    /// </summary>
    /// <param name="CapacityBlockOfferingId">The ID of the Capacity Block offering.</param>
    ...
    public AwsEc2PurchaseCapacityBlockOptions(
        string CapacityBlockOfferingId,
        string InstancePlatform
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(CapacityBlockOfferingId);
    ...
    private AwsEc2PurchaseCapacityBlockOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2PurchaseCapacityBlockOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2PurchaseCapacityBlockOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--capacity-block-offering-id")]
    public string? CapacityBlockOfferingId { get; private init; }
