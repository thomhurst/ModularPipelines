...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/healthlake/list-data-transformation-jobs/index.html
...
[CliSubCommand("healthlake", "list-data-transformation-jobs")]
public record AwsHealthlakeListDataTransformationJobsOptions : AwsOptions
{
    /// <summary>
    /// Filters the results to include only jobs with the specified status. Possible values: o SUBMITTED o QUEUED o IN_PROGRESS o COMPLETED o COMPLETED_WITH_ERRORS o FAILED
    /// </summary>
    [CliOption("--job-status")]
    public AwsHealthlakeListDataTransformationJobsJobStatus? JobStatus { get; set; }

    /// <summary>
    /// Filters the results to include only jobs with the specified name. Constraints: o min: 1 o max: 64 o pattern: [\p{L}\p{Z}\p{N}_.:/=+\-%@]*
    /// </summary>
    [CliOption("--job-name")]
