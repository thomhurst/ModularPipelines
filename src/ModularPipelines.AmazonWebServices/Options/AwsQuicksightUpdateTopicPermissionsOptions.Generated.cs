...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/update-topic-permissions/index.html
...
[CliSubCommand("quicksight", "update-topic-permissions")]
public record AwsQuicksightUpdateTopicPermissionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightUpdateTopicPermissionsOptions(
        string AwsAccountId,
        string TopicId
    )
    {
    ...
    private AwsQuicksightUpdateTopicPermissionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightUpdateTopicPermissionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightUpdateTopicPermissionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
