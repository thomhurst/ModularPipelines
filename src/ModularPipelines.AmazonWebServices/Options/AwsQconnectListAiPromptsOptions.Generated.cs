...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-ai-prompts/index.html
...
[CliSubCommand("qconnect", "list-ai-prompts")]
public record AwsQconnectListAiPromptsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListAiPromptsOptions(
        string AssistantId
    )
    {
    ...
    private AwsQconnectListAiPromptsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListAiPromptsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListAiPromptsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The origin of the AI Prompts to be listed. SYSTEM for a default AI Agent created by Q in Connect or CUSTOMER for an AI Agent created by calling AI Agent creation APIs. Possible values: o SYSTEM o CUSTOMER
    /// </summary>
    [CliOption("--origin")]
    public AwsQconnectListAiPromptsOrigin? Origin { get; set; }
