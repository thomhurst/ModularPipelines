...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-deployments/index.html
...
[CliSubCommand("apigateway", "get-deployments")]
public record AwsApigatewayGetDeploymentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayGetDeploymentsOptions(
        string RestApiId
    )
    {
    ...
    private AwsApigatewayGetDeploymentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayGetDeploymentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayGetDeploymentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
