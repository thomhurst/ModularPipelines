...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/wait/function-updated-v2/index.html
...
[CliSubCommand("lambda", "wait", "function-updated-v2")]
public record AwsLambdaWaitFunctionUpdatedV2Options : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaWaitFunctionUpdatedV2Options(
        string FunctionName
    )
    {
    ...
    private AwsLambdaWaitFunctionUpdatedV2Options()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaWaitFunctionUpdatedV2Options FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaWaitFunctionUpdatedV2Options ForCliSkeleton(string generateCliSkeleton = "input") =>
