...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront-keyvaluestore/list-keys/index.html
...
[CliSubCommand("cloudfront-keyvaluestore", "list-keys")]
public record AwsCloudfrontKeyvaluestoreListKeysOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCloudfrontKeyvaluestoreListKeysOptions(
        string KvsArn
    )
    {
    ...
    private AwsCloudfrontKeyvaluestoreListKeysOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCloudfrontKeyvaluestoreListKeysOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCloudfrontKeyvaluestoreListKeysOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
