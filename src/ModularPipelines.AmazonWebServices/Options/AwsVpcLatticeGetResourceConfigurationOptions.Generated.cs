...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/get-resource-configuration/index.html
...
[CliSubCommand("vpc-lattice", "get-resource-configuration")]
public record AwsVpcLatticeGetResourceConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsVpcLatticeGetResourceConfigurationOptions(
    ...
    private AwsVpcLatticeGetResourceConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsVpcLatticeGetResourceConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsVpcLatticeGetResourceConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
