...
public record AwsMediatailorUpdateSourceLocationOptions : AwsOptions, IValidatableObject
{
    ...
    /// Updates a source location. A source location is a container for sources. For more information about source locations, see Working with source locations in the MediaTailor User Guide . See also: AWS API Documentation
    /// </summary>
    /// <param name="HttpConfiguration">The HTTP configuration for the source location. BaseUrl -&gt; (string) [required] The base URL for the source location host server. This string must include the protocol, such as https:// . Shorthand Syntax: BaseUrl=string JSON Syntax: { "BaseUrl": "string" }</param>
    /// <param name="SourceLocationName">The name of the source location.</param>
    public AwsMediatailorUpdateSourceLocationOptions(
    ...
    private AwsMediatailorUpdateSourceLocationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediatailorUpdateSourceLocationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediatailorUpdateSourceLocationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The HTTP configuration for the source location. BaseUrl -&gt; (string) [required] The base URL for the source location host server. This string must include the protocol, such as https:// . Shorthand Syntax: BaseUrl=string JSON Syntax: { "BaseUrl": "string" }
    /// </summary>
