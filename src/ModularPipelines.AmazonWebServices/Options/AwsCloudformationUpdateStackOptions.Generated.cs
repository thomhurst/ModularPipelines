...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/update-stack/index.html
...
public record AwsCloudformationUpdateStackOptions : AwsOptions
{
    ...
    /// <summary>
    /// Structure that contains the temporary overriding stack policy body. You can specify either the StackPolicyDuringUpdateBody or the Stack- PolicyDuringUpdateURL parameter, but not both. If you want to update protected resources, specify a temporary over- riding stack policy during this update. If you don't specify a stack policy, the current policy that is associated with the stack will be used. Constraints: o min: 1 o max: 16384
    /// </summary>
    [CliOption("--stack-policy-during-update-body")]
    public string? StackPolicyDuringUpdateBody { get; set; }

    /// <summary>
    /// Location of a file that contains the temporary overriding stack pol- icy. The URL must point to a policy (max size: 16KB) located in an S3 bucket in the same Region as the stack. The location for an Ama- zon S3 bucket must start with https:// . URLs from S3 static web- sites are not supported. You can specify either the StackPolicyDuringUpdateBody or the Stack- PolicyDuringUpdateURL parameter, but not both. If you want to update protected resources, specify a temporary over- riding stack policy during this update. If you don't specify a stack policy, the current policy that is associated with the stack will be used. Constraints: o min: 1 o max: 5120
    /// </summary>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of an IAM role that CloudFormation assumes to update the stack. CloudFormation uses the role's creden- tials to make calls on your behalf. CloudFormation always uses this role for all future operations on the stack. Provided that users have permission to operate on the stack, CloudFormation uses this role even if the users don't have permission to pass it. Ensure that the role grants least privilege. If you don't specify a value, CloudFormation uses the role that was previously associated with the stack. If no role is available, CloudFormation uses a temporary session that is generated from your user credentials. Constraints: o min: 20 o max: 2048
    /// </summary>
    [CliOption("--role-arn")]
    ...
    /// <summary>
    /// Structure that contains a new stack policy body. You can specify ei- ther the StackPolicyBody or the StackPolicyURL parameter, but not both. You might update the stack policy, for example, in order to protect a new resource that you created during a stack update. If you don't specify a stack policy, the current policy that is associated with the stack is unchanged. Constraints: o min: 1 o max: 16384
    /// </summary>
    [CliOption("--stack-policy-body")]
    public string? StackPolicyBody { get; set; }

    /// <summary>
    /// Location of a file that contains the updated stack policy. The URL must point to a policy (max size: 16KB) located in an S3 bucket in the same Region as the stack. The location for an Amazon S3 bucket must start with https:// . URLs from S3 static websites are not sup- ported. You can specify either the StackPolicyBody or the StackPolicyURL pa- rameter, but not both. You might update the stack policy, for example, in order to protect a new resource that you created during a stack update. If you don't specify a stack policy, the current policy that is associated with the stack is unchanged. Constraints: o min: 1 o max: 5120
    /// </summary>
