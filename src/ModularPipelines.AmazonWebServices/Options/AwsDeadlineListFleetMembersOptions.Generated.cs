...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-fleet-members/index.html
...
[CliSubCommand("deadline", "list-fleet-members")]
public record AwsDeadlineListFleetMembersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists fleet members. See also: AWS API Documentation list-fleet-members is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: members
    /// </summary>
    /// <param name="FarmId">The farm ID of the fleet. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    /// <param name="FleetId">The fleet ID to include on the list. Constraints: o pattern: fleet-[0-9a-f]{32}</param>
    public AwsDeadlineListFleetMembersOptions(
        string FarmId,
        string FleetId
    )
    {
    ...
    private AwsDeadlineListFleetMembersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListFleetMembersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListFleetMembersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID of the fleet. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    public string? FarmId { get; private init; }

    /// <summary>
    /// The fleet ID to include on the list. Constraints: o pattern: fleet-[0-9a-f]{32}
    /// </summary>
    [CliOption("--fleet-id")]
