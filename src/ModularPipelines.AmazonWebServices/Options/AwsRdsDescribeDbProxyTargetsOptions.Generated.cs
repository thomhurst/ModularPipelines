...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/describe-db-proxy-targets/index.html
...
[CliSubCommand("rds", "describe-db-proxy-targets")]
public record AwsRdsDescribeDbProxyTargetsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns information about DBProxyTarget objects. This API supports pag- ination. See also: AWS API Documentation describe-db-proxy-targets is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the follow- ing query expressions: Targets
    /// </summary>
    /// <param name="DbProxyName">The identifier of the DBProxyTarget to describe. Constraints: o min: 1 o max: 63 o pattern: [a-zA-Z](?:-?[a-zA-Z0-9]+)*</param>
    public AwsRdsDescribeDbProxyTargetsOptions(
        string DbProxyName
    )
    {
    ...
    private AwsRdsDescribeDbProxyTargetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRdsDescribeDbProxyTargetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRdsDescribeDbProxyTargetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The identifier of the DBProxyTarget to describe. Constraints: o min: 1 o max: 63 o pattern: [a-zA-Z](?:-?[a-zA-Z0-9]+)*
    /// </summary>
    [CliOption("--db-proxy-name")]
    public string? DbProxyName { get; private init; }

    /// <summary>
    /// The identifier of the DBProxyTargetGroup to describe. Constraints: o min: 1 o max: 63 o pattern: [a-zA-Z](?:-?[a-zA-Z0-9]+)*
    /// </summary>
