...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifybackend/update-backend-api/index.html
...
[CliSubCommand("amplifybackend", "update-backend-api")]
public record AwsAmplifybackendUpdateBackendApiOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifybackendUpdateBackendApiOptions(
        string AppId,
    ...
    private AwsAmplifybackendUpdateBackendApiOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifybackendUpdateBackendApiOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifybackendUpdateBackendApiOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
