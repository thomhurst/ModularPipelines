...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/delete-workspace/index.html
...
[CliSubCommand("connect", "delete-workspace")]
public record AwsConnectDeleteWorkspaceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectDeleteWorkspaceOptions(
        string InstanceId,
        string WorkspaceId
    )
    {
    ...
    private AwsConnectDeleteWorkspaceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectDeleteWorkspaceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectDeleteWorkspaceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
