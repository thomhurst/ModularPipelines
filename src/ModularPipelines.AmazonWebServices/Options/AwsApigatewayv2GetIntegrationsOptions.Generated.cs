...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-integrations/index.html
...
[CliSubCommand("apigatewayv2", "get-integrations")]
public record AwsApigatewayv2GetIntegrationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetIntegrationsOptions(
        string ApiId
    )
    {
    ...
    private AwsApigatewayv2GetIntegrationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetIntegrationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetIntegrationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
