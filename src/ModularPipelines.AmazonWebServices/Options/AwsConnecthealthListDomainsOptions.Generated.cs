...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connecthealth/list-domains/index.html
...
[CliSubCommand("connecthealth", "list-domains")]
public record AwsConnecthealthListDomainsOptions : AwsOptions
{
    /// <summary>
    /// Filter by Domain status. Possible values: o ACTIVE o DELETING o DELETED
    /// </summary>
    [CliOption("--status")]
    public AwsConnecthealthListDomainsStatus? Status { get; set; }
