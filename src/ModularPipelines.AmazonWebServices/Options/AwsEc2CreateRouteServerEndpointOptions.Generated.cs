...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-route-server-endpoint/index.html
...
[CliSubCommand("ec2", "create-route-server-endpoint")]
public record AwsEc2CreateRouteServerEndpointOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a new endpoint for a route server in a specified subnet. A route server endpoint is an Amazon Web Services-managed component in- side a subnet that facilitates BGP (Border Gateway Protocol) connec- tions between your route server and your BGP peers. For more information see Dynamic routing in your VPC with VPC Route Server in the Amazon VPC User Guide . See also: AWS API Documentation
    /// </summary>
    /// <param name="RouteServerId">The ID of the route server for which to create an endpoint.</param>
    /// <param name="SubnetId">The ID of the subnet in which to create the route server endpoint.</param>
    public AwsEc2CreateRouteServerEndpointOptions(
    ...
    private AwsEc2CreateRouteServerEndpointOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateRouteServerEndpointOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateRouteServerEndpointOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
