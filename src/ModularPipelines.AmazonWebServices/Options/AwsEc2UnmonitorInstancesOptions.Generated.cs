...
public record AwsEc2UnmonitorInstancesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2UnmonitorInstancesOptions(
    ...
    private AwsEc2UnmonitorInstancesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2UnmonitorInstancesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2UnmonitorInstancesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
