...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mailmanager/list-archive-searches/index.html
...
[CliSubCommand("mailmanager", "list-archive-searches")]
public record AwsMailmanagerListArchiveSearchesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a list of email archive search jobs. See also: AWS API Documentation list-archive-searches is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: Searches
    /// </summary>
    /// <param name="ArchiveId">The identifier of the archive. Constraints: o min: 3 o max: 66 o pattern: a-[\w]{1,64}</param>
    public AwsMailmanagerListArchiveSearchesOptions(
        string ArchiveId
    )
    {
    ...
    private AwsMailmanagerListArchiveSearchesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMailmanagerListArchiveSearchesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMailmanagerListArchiveSearchesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The identifier of the archive. Constraints: o min: 3 o max: 66 o pattern: a-[\w]{1,64}
    /// </summary>
