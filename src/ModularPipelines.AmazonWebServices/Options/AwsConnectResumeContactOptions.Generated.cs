...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/resume-contact/index.html
...
[CliSubCommand("connect", "resume-contact")]
public record AwsConnectResumeContactOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectResumeContactOptions(
        string ContactId,
        string InstanceId
    )
    {
    ...
    private AwsConnectResumeContactOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectResumeContactOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectResumeContactOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
