...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecommit/get-merge-commit/index.html
...
[CliSubCommand("codecommit", "get-merge-commit")]
public record AwsCodecommitGetMergeCommitOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns information about a specified merge commit. See also: AWS API Documentation
    /// </summary>
    /// <param name="RepositoryName">The name of the repository that contains the merge commit about which you want to get information. Constraints: o min: 1 o max: 100 o pattern: [\w\.-]+</param>
    ...
    public AwsCodecommitGetMergeCommitOptions(
    ...
    private AwsCodecommitGetMergeCommitOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodecommitGetMergeCommitOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodecommitGetMergeCommitOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the repository that contains the merge commit about which you want to get information. Constraints: o min: 1 o max: 100 o pattern: [\w\.-]+
    /// </summary>
    ...
    public AwsCodecommitGetMergeCommitConflictDetailLevel? ConflictDetailLevel { get; set; }
    ...
    public AwsCodecommitGetMergeCommitConflictResolutionStrategy? ConflictResolutionStrategy { get; set; }
