...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-core-definition-versions/index.html
...
[CliSubCommand("greengrass", "list-core-definition-versions")]
public record AwsGreengrassListCoreDefinitionVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListCoreDefinitionVersionsOptions(
    ...
    private AwsGreengrassListCoreDefinitionVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListCoreDefinitionVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListCoreDefinitionVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
