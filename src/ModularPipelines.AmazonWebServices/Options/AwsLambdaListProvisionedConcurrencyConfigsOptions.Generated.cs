...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/list-provisioned-concurrency-configs/index.html
...
[CliSubCommand("lambda", "list-provisioned-concurrency-configs")]
public record AwsLambdaListProvisionedConcurrencyConfigsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaListProvisionedConcurrencyConfigsOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaListProvisionedConcurrencyConfigsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaListProvisionedConcurrencyConfigsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaListProvisionedConcurrencyConfigsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
