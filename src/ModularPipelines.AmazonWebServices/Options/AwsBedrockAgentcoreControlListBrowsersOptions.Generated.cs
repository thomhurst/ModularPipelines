...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore-control/list-browsers/index.html
...
[CliSubCommand("bedrock-agentcore-control", "list-browsers")]
public record AwsBedrockAgentcoreControlListBrowsersOptions : AwsOptions
{
    /// <summary>
    /// The type of browsers to list. If not specified, all browser types are returned. Possible values: o SYSTEM o CUSTOM
    /// </summary>
    [CliOption("--type")]
    public AwsBedrockAgentcoreControlListBrowsersType? Type { get; set; }
