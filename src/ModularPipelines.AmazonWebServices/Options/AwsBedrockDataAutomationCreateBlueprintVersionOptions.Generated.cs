...
public record AwsBedrockDataAutomationCreateBlueprintVersionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBedrockDataAutomationCreateBlueprintVersionOptions(
        string BlueprintArn
    )
    {
    ...
    private AwsBedrockDataAutomationCreateBlueprintVersionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockDataAutomationCreateBlueprintVersionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockDataAutomationCreateBlueprintVersionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
