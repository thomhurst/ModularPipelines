...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-connection-groups/index.html
...
[CliSubCommand("cloudfront", "list-connection-groups")]
public record AwsCloudfrontListConnectionGroupsOptions : AwsOptions
{
    /// <summary>
    /// Filter by associated Anycast IP list ID. AnycastIpListId -&gt; (string) The ID of the Anycast static IP list. Shorthand Syntax: AnycastIpListId=string JSON Syntax: { "AnycastIpListId": "string" }
    /// </summary>
