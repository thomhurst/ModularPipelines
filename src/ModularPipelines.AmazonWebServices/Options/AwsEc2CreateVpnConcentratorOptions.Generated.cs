...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-vpn-concentrator/index.html
...
[CliSubCommand("ec2", "create-vpn-concentrator")]
public record AwsEc2CreateVpnConcentratorOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a VPN concentrator that aggregates multiple VPN connections to a transit gateway. See also: AWS API Documentation
    /// </summary>
    /// <param name="Type">The type of VPN concentrator to create. Possible values: o ipsec.1</param>
    public AwsEc2CreateVpnConcentratorOptions(
        AwsEc2CreateVpnConcentratorType Type
    )
    {
    ...
    private AwsEc2CreateVpnConcentratorOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateVpnConcentratorOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateVpnConcentratorOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The type of VPN concentrator to create. Possible values: o ipsec.1
    /// </summary>
    [CliOption("--type")]
    public AwsEc2CreateVpnConcentratorType? Type { get; private init; }
