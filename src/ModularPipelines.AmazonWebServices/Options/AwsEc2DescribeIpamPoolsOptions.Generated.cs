...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-ipam-pools/index.html
...
[CliSubCommand("ec2", "describe-ipam-pools")]
public record AwsEc2DescribeIpamPoolsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The IDs of the IPAM pools you would like information on. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--ipam-pool-ids", GroupValues = true)]
    public IEnumerable<string>? IpamPoolIds { get; set; }
