...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/list-environments/index.html
...
[CliSubCommand("appconfig", "list-environments")]
public record AwsAppConfigListEnvironmentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppConfigListEnvironmentsOptions(
    ...
    private AwsAppConfigListEnvironmentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppConfigListEnvironmentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppConfigListEnvironmentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
