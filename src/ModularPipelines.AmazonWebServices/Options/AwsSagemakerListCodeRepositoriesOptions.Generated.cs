...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-code-repositories/index.html
...
[CliSubCommand("sagemaker", "list-code-repositories")]
public record AwsSagemakerListCodeRepositoriesOptions : AwsOptions
{
    ...
    /// <summary>
    /// A string in the Git repositories name. This filter returns only repositories whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9-]+
    /// </summary>
    [CliOption("--name-contains")]
    public string? NameContains { get; set; }

    /// <summary>
    /// The field to sort results by. The default is Name . Possible values: o Name o CreationTime o LastModifiedTime
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListCodeRepositoriesSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order for results. The default is Ascending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListCodeRepositoriesSortOrder? SortOrder { get; set; }
