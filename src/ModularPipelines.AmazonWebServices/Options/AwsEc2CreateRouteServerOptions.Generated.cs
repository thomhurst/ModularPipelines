...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-route-server/index.html
...
public record AwsEc2CreateRouteServerOptions : AwsOptions
{
    ...
    /// <summary>
    /// Indicates whether routes should be persisted after all BGP sessions are terminated. Possible values: o enable o disable o reset
    /// </summary>
    [CliOption("--persist-routes")]
    public AwsEc2CreateRouteServerPersistRoutes? PersistRoutes { get; set; }
