...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-updates/index.html
...
[CliSubCommand("eks", "list-updates")]
public record AwsEksListUpdatesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEksListUpdatesOptions(
        string Name
    )
    {
    ...
    private AwsEksListUpdatesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEksListUpdatesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEksListUpdatesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
