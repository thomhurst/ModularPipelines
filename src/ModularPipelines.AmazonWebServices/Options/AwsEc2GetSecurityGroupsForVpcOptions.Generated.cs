...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-security-groups-for-vpc/index.html
...
[CliSubCommand("ec2", "get-security-groups-for-vpc")]
public record AwsEc2GetSecurityGroupsForVpcOptions : AwsOptions, IValidatableObject
{
    ...
    /// Gets security groups that can be associated by the Amazon Web Services account making the request with network interfaces in the specified VPC. See also: AWS API Documentation get-security-groups-for-vpc is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract dat...
    /// </summary>
    /// <param name="VpcId">The VPC ID where the security group can be used.</param>
    public AwsEc2GetSecurityGroupsForVpcOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2GetSecurityGroupsForVpcOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetSecurityGroupsForVpcOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetSecurityGroupsForVpcOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
