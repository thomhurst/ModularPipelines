...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/list-assistant-associations/index.html
...
[CliSubCommand("wisdom", "list-assistant-associations")]
public record AwsWisdomListAssistantAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomListAssistantAssociationsOptions(
        string AssistantId
    )
    {
    ...
    private AwsWisdomListAssistantAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomListAssistantAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomListAssistantAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
