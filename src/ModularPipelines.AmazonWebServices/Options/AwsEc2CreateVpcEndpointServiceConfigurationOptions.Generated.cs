...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-vpc-endpoint-service-configuration/index.html
...
public record AwsEc2CreateVpcEndpointServiceConfigurationOptions : AwsOptions
{
    ...
    /// <summary>
    /// The Amazon Resource Names (ARNs) of the Network Load Balancers. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--network-load-balancer-arns", GroupValues = true)]
    public IEnumerable<string>? NetworkLoadBalancerArns { get; set; }

    /// <summary>
    /// The Amazon Resource Names (ARNs) of the Gateway Load Balancers. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--gateway-load-balancer-arns", GroupValues = true)]
    public IEnumerable<string>? GatewayLoadBalancerArns { get; set; }

    /// <summary>
    /// The supported IP address types. The possible values are ipv4 and ipv6 . (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--supported-ip-address-types", GroupValues = true)]
    public IEnumerable<string>? SupportedIpAddressTypes { get; set; }

    /// <summary>
    /// The Regions from which service consumers can access the service. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--supported-regions", GroupValues = true)]
    public IEnumerable<string>? SupportedRegions { get; set; }
