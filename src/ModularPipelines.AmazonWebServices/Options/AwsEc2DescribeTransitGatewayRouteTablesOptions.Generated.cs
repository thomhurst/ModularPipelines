...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-transit-gateway-route-tables/index.html
...
[CliSubCommand("ec2", "describe-transit-gateway-route-tables")]
public record AwsEc2DescribeTransitGatewayRouteTablesOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the transit gateway route tables. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--transit-gateway-route-table-ids", GroupValues = true)]
    public IEnumerable<string>? TransitGatewayRouteTableIds { get; set; }

    /// <summary>
    /// One or more filters. The possible values are: o default-association-route-table - Indicates whether this is the default association route table for the transit gateway (true | false ). o default-propagation-route-table - Indicates whether this is the default propagation route table for the transit gateway (true | false ). o state - The state of the route table (available | deleting | deleted | pending ). o transit-gateway-id - The ID of the transit gateway. o transit-gateway-route-table-id - The ID of the transit gateway route table. (structure) A filter name and value pair that is used to return a more spe- cific list of results from a describe operation. Filters can be used to match a set of resources by specific criteria, such as tags, attributes, or IDs. If you specify multiple filters, the filters are joined with an AND , and the request returns only results that match all of the specified filters. For more information, see List and filter using the CLI and API in the Amazon EC2 User Guide . Name -&gt; (string) The name of the filter. Filter names are case-sensitive. Values -&gt; (list) The filter values. Filter values are case-sensitive. If you specify multiple values for a filter, the values are joined with an OR , and the request returns all results that match any of the specified values. (string) Shorthand Syntax: Name=string,Values=string,string ... JSON Syntax: [ { "Name": "string", "Values": ["string", ...] } ... ]
    /// </summary>
