...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/fis/list-target-account-configurations/index.html
...
[CliSubCommand("fis", "list-target-account-configurations")]
public record AwsFisListTargetAccountConfigurationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsFisListTargetAccountConfigurationsOptions(
    ...
    private AwsFisListTargetAccountConfigurationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsFisListTargetAccountConfigurationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsFisListTargetAccountConfigurationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
