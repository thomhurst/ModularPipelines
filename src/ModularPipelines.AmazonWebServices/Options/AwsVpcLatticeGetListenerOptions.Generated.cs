...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/get-listener/index.html
...
[CliSubCommand("vpc-lattice", "get-listener")]
public record AwsVpcLatticeGetListenerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsVpcLatticeGetListenerOptions(
    ...
    private AwsVpcLatticeGetListenerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsVpcLatticeGetListenerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsVpcLatticeGetListenerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
