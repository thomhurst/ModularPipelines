...
public record AwsRdsCreateEventSubscriptionOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsRdsCreateEventSubscriptionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRdsCreateEventSubscriptionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRdsCreateEventSubscriptionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
