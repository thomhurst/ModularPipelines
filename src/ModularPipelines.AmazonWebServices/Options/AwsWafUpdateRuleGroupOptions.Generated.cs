...
public record AwsWafUpdateRuleGroupOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafUpdateRuleGroupOptions(
        string RuleGroupId,
    ...
    private AwsWafUpdateRuleGroupOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafUpdateRuleGroupOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafUpdateRuleGroupOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
