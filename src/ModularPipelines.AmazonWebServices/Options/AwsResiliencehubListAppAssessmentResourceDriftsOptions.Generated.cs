...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/list-app-assessment-resource-drifts/index.html
...
[CliSubCommand("resiliencehub", "list-app-assessment-resource-drifts")]
public record AwsResiliencehubListAppAssessmentResourceDriftsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubListAppAssessmentResourceDriftsOptions(
    ...
    private AwsResiliencehubListAppAssessmentResourceDriftsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubListAppAssessmentResourceDriftsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubListAppAssessmentResourceDriftsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
