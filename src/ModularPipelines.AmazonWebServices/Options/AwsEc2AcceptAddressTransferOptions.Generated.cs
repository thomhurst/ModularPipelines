...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/accept-address-transfer/index.html
...
[CliSubCommand("ec2", "accept-address-transfer")]
public record AwsEc2AcceptAddressTransferOptions : AwsOptions, IValidatableObject
{
    ...
    /// Accepts an Elastic IP address transfer. For more information, see Accept a transferred Elastic IP address in the Amazon VPC User Guide . See also: AWS API Documentation
    /// </summary>
    /// <param name="Address">The Elastic IP address you are accepting for transfer.</param>
    public AwsEc2AcceptAddressTransferOptions(
        string Address
    )
    {
    ...
    private AwsEc2AcceptAddressTransferOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2AcceptAddressTransferOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2AcceptAddressTransferOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
