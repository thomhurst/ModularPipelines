...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/wait/object-not-exists/index.html
...
[CliSubCommand("s3api", "wait", "object-not-exists")]
public record AwsS3apiWaitObjectNotExistsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3apiWaitObjectNotExistsOptions(
        string Bucket,
        string Key
    )
    {
    ...
    private AwsS3apiWaitObjectNotExistsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3apiWaitObjectNotExistsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3apiWaitObjectNotExistsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public AwsS3apiWaitObjectNotExistsRequestPayer? RequestPayer { get; set; }
    ...
    public AwsS3apiWaitObjectNotExistsChecksumMode? ChecksumMode { get; set; }
