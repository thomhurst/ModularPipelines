...
public record AwsDevicefarmUpdateDevicePoolOptions : AwsOptions, IValidatableObject
{
    ...
    /// Modifies the name, description, and rules in a device pool given the attributes and the pool ARN. Rule updates are all-or-nothing, meaning they can only be updated as a whole (or not at all). See also: AWS API Documentation
    /// </summary>
    /// <param name="Arn">The Amazon Resource Name (ARN) of the Device Farm device pool to up- date. Constraints: o min: 32 o max: 1011 o pattern: ^arn:aws:devicefarm:.+</param>
    public AwsDevicefarmUpdateDevicePoolOptions(
        string Arn
    )
    {
    ...
    private AwsDevicefarmUpdateDevicePoolOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDevicefarmUpdateDevicePoolOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDevicefarmUpdateDevicePoolOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the Device Farm device pool to up- date. Constraints: o min: 32 o max: 1011 o pattern: ^arn:aws:devicefarm:.+
    /// </summary>
    [CliOption("--arn")]
