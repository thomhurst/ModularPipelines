...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/arc-region-switch/get-plan-execution/index.html
...
[CliSubCommand("arc-region-switch", "get-plan-execution")]
public record AwsArcRegionSwitchGetPlanExecutionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsArcRegionSwitchGetPlanExecutionOptions(
        string PlanArn,
        string ExecutionId
    )
    {
    ...
    private AwsArcRegionSwitchGetPlanExecutionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsArcRegionSwitchGetPlanExecutionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsArcRegionSwitchGetPlanExecutionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
