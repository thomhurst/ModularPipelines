...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/drs/describe-launch-configuration-templates/index.html
...
[CliSubCommand("drs", "describe-launch-configuration-templates")]
public record AwsDrsDescribeLaunchConfigurationTemplatesOptions : AwsOptions
{
    /// <summary>
    /// Request to filter Launch Configuration Templates list by Launch Con- figuration Template ID. Constraints: o min: 0 o max: 1 (string) Constraints: o min: 21 o max: 21 o pattern: lct-[0-9a-zA-Z]{17} Syntax: "string" "string" ...
    /// </summary>
