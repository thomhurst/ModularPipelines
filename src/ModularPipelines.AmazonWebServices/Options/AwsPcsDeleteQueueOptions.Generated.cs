...
public record AwsPcsDeleteQueueOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="QueueIdentifier">The name or ID of the queue to delete. Constraints: o pattern: (pcs_[a-zA-Z0-9]+|[A-Za-z][A-Za-z0-9-]{2,25})</param>
    public AwsPcsDeleteQueueOptions(
    ...
    private AwsPcsDeleteQueueOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPcsDeleteQueueOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPcsDeleteQueueOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name or ID of the queue to delete. Constraints: o pattern: (pcs_[a-zA-Z0-9]+|[A-Za-z][A-Za-z0-9-]{2,25})
    /// </summary>
