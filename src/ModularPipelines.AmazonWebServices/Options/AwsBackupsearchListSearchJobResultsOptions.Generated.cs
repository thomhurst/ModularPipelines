...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backupsearch/list-search-job-results/index.html
...
[CliSubCommand("backupsearch", "list-search-job-results")]
public record AwsBackupsearchListSearchJobResultsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBackupsearchListSearchJobResultsOptions(
    ...
    private AwsBackupsearchListSearchJobResultsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBackupsearchListSearchJobResultsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBackupsearchListSearchJobResultsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
