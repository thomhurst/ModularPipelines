...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-nodes/index.html
...
[CliSubCommand("kafka", "list-nodes")]
public record AwsKafkaListNodesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsKafkaListNodesOptions(
        string ClusterArn
    )
    {
    ...
    private AwsKafkaListNodesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKafkaListNodesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKafkaListNodesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
