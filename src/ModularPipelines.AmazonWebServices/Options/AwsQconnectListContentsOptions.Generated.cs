...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-contents/index.html
...
[CliSubCommand("qconnect", "list-contents")]
public record AwsQconnectListContentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListContentsOptions(
    ...
    private AwsQconnectListContentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListContentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListContentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
