...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-ipam-pool-allocations/index.html
...
[CliSubCommand("ec2", "describe-ipam-pool-allocations")]
public record AwsEc2DescribeIpamPoolAllocationsOptions : AwsOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The IDs of the IPAM pool allocations you want to describe. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--ipam-pool-allocation-ids", GroupValues = true)]
    public IEnumerable<string>? IpamPoolAllocationIds { get; set; }
