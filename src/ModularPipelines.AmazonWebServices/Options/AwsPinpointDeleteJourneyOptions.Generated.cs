...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/delete-journey/index.html
...
[CliSubCommand("pinpoint", "delete-journey")]
public record AwsPinpointDeleteJourneyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPinpointDeleteJourneyOptions(
    ...
    private AwsPinpointDeleteJourneyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPinpointDeleteJourneyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPinpointDeleteJourneyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
