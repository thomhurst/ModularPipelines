...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-thing-principals-v2/index.html
...
[CliSubCommand("iot", "list-thing-principals-v2")]
public record AwsIotListThingPrincipalsV2Options : AwsOptions, IValidatableObject
{
    ...
    public AwsIotListThingPrincipalsV2Options(
        string ThingName
    )
    {
    ...
    private AwsIotListThingPrincipalsV2Options()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIotListThingPrincipalsV2Options FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIotListThingPrincipalsV2Options ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The type of the relation you want to filter in the response. If no value is provided in this field, the response will list all princi- pals, including both the EXCLUSIVE_THING and NON_EXCLUSIVE_THING at- tachment types. o EXCLUSIVE_THING - Attaches the specified principal to the speci- fied thing, exclusively. The thing will be the only thing thats attached to the principal. o NON_EXCLUSIVE_THING - Attaches the specified principal to the specified thing. Multiple things can be attached to the principal. Possible values: o EXCLUSIVE_THING o NON_EXCLUSIVE_THING
    /// </summary>
    [CliOption("--thing-principal-type")]
    public AwsIotListThingPrincipalsV2ThingPrincipalType? ThingPrincipalType { get; set; }
