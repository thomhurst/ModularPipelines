...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/list-table-restore-status/index.html
...
[CliSubCommand("redshift-serverless", "list-table-restore-status")]
public record AwsRedshiftServerlessListTableRestoreStatusOptions : AwsOptions
{
    /// <summary>
    /// The namespace from which to list all of the statuses of Re- storeTableFromSnapshot operations .
    /// </summary>
    [CliOption("--namespace-name")]
    public string? NamespaceName { get; set; }

    /// <summary>
    /// The workgroup from which to list all of the statuses of Re- storeTableFromSnapshot operations.
    /// </summary>
