...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime-sdk-messaging/update-channel-read-marker/index.html
...
[CliSubCommand("chime-sdk-messaging", "update-channel-read-marker")]
public record AwsChimeSdkMessagingUpdateChannelReadMarkerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsChimeSdkMessagingUpdateChannelReadMarkerOptions(
        string ChannelArn,
        string ChimeBearer
    )
    {
    ...
    private AwsChimeSdkMessagingUpdateChannelReadMarkerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsChimeSdkMessagingUpdateChannelReadMarkerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsChimeSdkMessagingUpdateChannelReadMarkerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
