...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/list-lifecycle-executions/index.html
...
[CliSubCommand("imagebuilder", "list-lifecycle-executions")]
public record AwsImagebuilderListLifecycleExecutionsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsImagebuilderListLifecycleExecutionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsImagebuilderListLifecycleExecutionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsImagebuilderListLifecycleExecutionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
