...
public record AwsS3tablesGetTableMaintenanceConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3tablesGetTableMaintenanceConfigurationOptions(
    ...
    private AwsS3tablesGetTableMaintenanceConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3tablesGetTableMaintenanceConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3tablesGetTableMaintenanceConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
