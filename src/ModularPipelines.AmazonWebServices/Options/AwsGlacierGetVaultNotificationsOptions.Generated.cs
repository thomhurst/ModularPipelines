...
public record AwsGlacierGetVaultNotificationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlacierGetVaultNotificationsOptions(
        string AccountId,
        string VaultName
    )
    {
    ...
    private AwsGlacierGetVaultNotificationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlacierGetVaultNotificationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlacierGetVaultNotificationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
