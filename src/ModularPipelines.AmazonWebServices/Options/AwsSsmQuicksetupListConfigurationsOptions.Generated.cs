...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-quicksetup/list-configurations/index.html
...
[CliSubCommand("ssm-quicksetup", "list-configurations")]
public record AwsSsmQuicksetupListConfigurationsOptions : AwsOptions
{
    /// <summary>
    /// The ID of the configuration definition. Constraints: o pattern: ^[a-z0-9-]{1,20}$
    /// </summary>
    [CliOption("--configuration-definition-id")]
