...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-image-usage-report/index.html
...
public record AwsEc2CreateImageUsageReportOptions : AwsOptions
{
    ...
    /// <summary>
    /// A unique, case-sensitive identifier that you provide to ensure idem- potency of the request. Constraints: o min: 0 o max: 128
    /// </summary>
    [SecretValue]
