...
public record AwsKendraDisassociateEntitiesFromExperienceOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsKendraDisassociateEntitiesFromExperienceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKendraDisassociateEntitiesFromExperienceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKendraDisassociateEntitiesFromExperienceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
