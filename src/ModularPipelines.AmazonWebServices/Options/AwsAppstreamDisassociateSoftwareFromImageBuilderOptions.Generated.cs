...
public record AwsAppstreamDisassociateSoftwareFromImageBuilderOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsAppstreamDisassociateSoftwareFromImageBuilderOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppstreamDisassociateSoftwareFromImageBuilderOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppstreamDisassociateSoftwareFromImageBuilderOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
