...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/shield/delete-protection-group/index.html
...
[CliSubCommand("shield", "delete-protection-group")]
public record AwsShieldDeleteProtectionGroupOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsShieldDeleteProtectionGroupOptions(
    ...
    private AwsShieldDeleteProtectionGroupOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsShieldDeleteProtectionGroupOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsShieldDeleteProtectionGroupOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
