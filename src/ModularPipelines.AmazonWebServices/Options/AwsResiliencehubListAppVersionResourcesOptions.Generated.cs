...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/list-app-version-resources/index.html
...
[CliSubCommand("resiliencehub", "list-app-version-resources")]
public record AwsResiliencehubListAppVersionResourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubListAppVersionResourcesOptions(
        string AppArn,
        string AppVersion
    )
    {
    ...
    private AwsResiliencehubListAppVersionResourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubListAppVersionResourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubListAppVersionResourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
