...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/list-signal-maps/index.html
...
[CliSubCommand("medialive", "list-signal-maps")]
public record AwsMedialiveListSignalMapsOptions : AwsOptions
{
    [CliOption("--cloud-watch-alarm-template-group-identifier")]
    public string? CloudWatchAlarmTemplateGroupIdentifier { get; set; }

    [CliOption("--event-bridge-rule-template-group-identifier")]
    public string? EventBridgeRuleTemplateGroupIdentifier { get; set; }
