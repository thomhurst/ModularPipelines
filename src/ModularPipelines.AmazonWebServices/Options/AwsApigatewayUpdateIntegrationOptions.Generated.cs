...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-integration/index.html
...
[CliSubCommand("apigateway", "update-integration")]
public record AwsApigatewayUpdateIntegrationOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="ResourceId">Represents an update integration request's resource identifier.</param>
    /// <param name="HttpMethod">Represents an update integration request's HTTP method.</param>
    public AwsApigatewayUpdateIntegrationOptions(
        string RestApiId,
        string ResourceId,
        string HttpMethod
    )
    ...
    private AwsApigatewayUpdateIntegrationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateIntegrationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateIntegrationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
