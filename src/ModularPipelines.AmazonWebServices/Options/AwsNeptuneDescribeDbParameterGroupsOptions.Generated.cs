...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/describe-db-parameter-groups/index.html
...
[CliSubCommand("neptune", "describe-db-parameter-groups")]
public record AwsNeptuneDescribeDbParameterGroupsOptions : AwsOptions
{
    /// <summary>
    /// The name of a specific DB parameter group to return details for. Constraints: o If supplied, must match the name of an existing DBClusterParame- terGroup.
    /// </summary>
