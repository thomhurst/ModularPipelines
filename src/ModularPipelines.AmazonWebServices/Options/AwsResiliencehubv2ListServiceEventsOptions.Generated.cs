...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/list-service-events/index.html
...
[CliSubCommand("resiliencehubv2", "list-service-events")]
public record AwsResiliencehubv2ListServiceEventsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2ListServiceEventsOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2ListServiceEventsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2ListServiceEventsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2ListServiceEventsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The type of events to include in the results. (string) Possible values: o SERVICE_CREATED o SERVICE_DELETED o SERVICE_SYSTEM_ASSOCIATED o SERVICE_SYSTEM_DISASSOCIATED o SERVICE_RESOURCES_ASSOCIATED o SERVICE_RESOURCES_DISASSOCIATED o SERVICE_WORKFLOW_UPDATED o SERVICE_INPUT_SOURCES_UPDATED o SERVICE_POLICY_ASSOCIATED o SERVICE_POLICY_DISASSOCIATED o SERVICE_FUNCTION_CREATED o SERVICE_FUNCTION_UPDATED o SERVICE_FUNCTION_DELETED o SERVICE_FUNCTION_RESOURCES_ADDED o SERVICE_FUNCTION_RESOURCES_REMOVED o SERVICE_ACHIEVABILITY_UPDATED o ASSERTION_CREATED o ASSERTION_UPDATED o ASSERTION_DELETED Syntax: "string" "string" ...
    /// </summary>
