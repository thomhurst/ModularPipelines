...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/list-contents/index.html
...
[CliSubCommand("wisdom", "list-contents")]
public record AwsWisdomListContentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomListContentsOptions(
    ...
    private AwsWisdomListContentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomListContentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomListContentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
