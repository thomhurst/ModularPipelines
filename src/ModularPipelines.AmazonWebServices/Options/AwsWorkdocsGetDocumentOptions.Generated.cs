...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/get-document/index.html
...
[CliSubCommand("workdocs", "get-document")]
public record AwsWorkdocsGetDocumentOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWorkdocsGetDocumentOptions(
        string DocumentId
    )
    {
    ...
    private AwsWorkdocsGetDocumentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWorkdocsGetDocumentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWorkdocsGetDocumentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
