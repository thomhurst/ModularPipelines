...
public record AwsApplicationSignalsDeleteInstrumentationConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    /// Deletes the specified instrumentation configuration. SDKs remove the instrumentation during their next sync after the configuration is deleted or expires. See also: AWS API Documentation
    /// </summary>
    /// <param name="InstrumentationType">Type of instrumentation configuration (BREAKPOINT or PROBE). Re- quired to identify the configuration to delete. Possible values: o BREAKPOINT o PROBE</param>
    ...
    public AwsApplicationSignalsDeleteInstrumentationConfigurationOptions(
    ...
    private AwsApplicationSignalsDeleteInstrumentationConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApplicationSignalsDeleteInstrumentationConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApplicationSignalsDeleteInstrumentationConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Type of instrumentation configuration (BREAKPOINT or PROBE). Re- quired to identify the configuration to delete. Possible values: o BREAKPOINT o PROBE
    /// </summary>
    [CliOption("--instrumentation-type")]
    public AwsApplicationSignalsDeleteInstrumentationConfigurationInstrumentationType? InstrumentationType { get; private init; }
