...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3tables/list-tables/index.html
...
[CliSubCommand("s3tables", "list-tables")]
public record AwsS3tablesListTablesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3tablesListTablesOptions(
    ...
    private AwsS3tablesListTablesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3tablesListTablesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3tablesListTablesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The namespace of the tables. Constraints: o min: 1 o max: 255 o pattern: [0-9a-z_]*
    /// </summary>
    [CliOption("--namespace")]
    public string? Namespace { get; set; }

    /// <summary>
    /// The prefix of the tables. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--prefix")]
