...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-group-versions/index.html
...
[CliSubCommand("greengrass", "list-group-versions")]
public record AwsGreengrassListGroupVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListGroupVersionsOptions(
        string GroupId
    )
    {
    ...
    private AwsGreengrassListGroupVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListGroupVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListGroupVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
