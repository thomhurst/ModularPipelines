...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/accessanalyzer/list-analyzers/index.html
...
[CliSubCommand("accessanalyzer", "list-analyzers")]
public record AwsAccessanalyzerListAnalyzersOptions : AwsOptions
{
    /// <summary>
    /// The type of analyzer. Possible values: o ACCOUNT o ORGANIZATION o ACCOUNT_UNUSED_ACCESS o ORGANIZATION_UNUSED_ACCESS o ACCOUNT_INTERNAL_ACCESS o ORGANIZATION_INTERNAL_ACCESS
    /// </summary>
    [CliOption("--type")]
    public AwsAccessanalyzerListAnalyzersType? Type { get; set; }
