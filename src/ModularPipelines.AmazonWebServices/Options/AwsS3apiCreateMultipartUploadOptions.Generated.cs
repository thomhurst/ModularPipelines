...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/create-multipart-upload/index.html
...
public record AwsS3apiCreateMultipartUploadOptions : AwsOptions
{
    ...
    /// <summary>
    /// Specify access permissions explicitly to give the grantee READ, READ_ACP, and WRITE_ACP permissions on the object. By default, all objects are private. Only the owner has full access control. When uploading an object, you can use this header to ex- plicitly grant access permissions to specific Amazon Web Services accounts or groups. This header maps to specific permissions that Amazon S3 supports in an ACL. For more information, see Access Con- trol List (ACL) Overview in the Amazon S3 User Guide . You specify each grantee as a type=value pair, where the type is one of the following: o id if the value specified is the canonical user ID of an Amazon Web Services account o uri if you are granting permissions to a predefined group o emailAddress if the value specified is the email address of an Amazon Web Services account NOTE: Using email addresses to specify a grantee is only supported in the following Amazon Web Services Regions: o US East (N. Virginia) o US West (N. California) o US West (Oregon) o Asia Pacific (Singapore) o Asia Pacific (Sydney) o Asia Pacific (Tokyo) o Europe (Ireland) o South America (So Paulo) For a list of all the Amazon S3 supported Regions and endpoints, see Regions and Endpoints in the Amazon Web Services General Reference. For example, the following x-amz-grant-read header grants the Amazon Web Services accounts identified by account IDs permissions to read object data and its metadata: x-amz-grant-read: id="11112222333", id="444455556666" NOTE: o This functionality is not supported for directory buckets. o This functionality is not supported for Amazon S3 on Outposts.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the 128-bit MD5 digest of the customer-provided encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error. NOTE: This functionality is not supported for directory buckets.
    /// </summary>
    ...
    public AwsS3apiCreateMultipartUploadRequestPayer? RequestPayer { get; set; }

    /// <summary>
    /// The tag-set for the object. The tag-set must be encoded as URL Query parameters. NOTE: This functionality is not supported for directory buckets.
    /// </summary>
    [CliOption("--tagging")]
    public string? Tagging { get; set; }

    /// <summary>
    /// Specifies the Object Lock mode that you want to apply to the up- loaded object. NOTE: This functionality is not supported for directory buckets. Possible values: o GOVERNANCE o COMPLIANCE
    /// </summary>
    [CliOption("--object-lock-mode")]
    public AwsS3apiCreateMultipartUploadObjectLockMode? ObjectLockMode { get; set; }

    /// <summary>
    /// Specifies the date and time when you want the Object Lock to expire. NOTE: This functionality is not supported for directory buckets.
    /// </summary>
    [CliOption("--object-lock-retain-until-date")]
    public string? ObjectLockRetainUntilDate { get; set; }

    /// <summary>
    /// Specifies whether you want to apply a legal hold to the uploaded ob- ject. NOTE: This functionality is not supported for directory buckets. Possible values: o ON o OFF
    /// </summary>
    ...
    /// <summary>
    /// Indicates the algorithm that you want Amazon S3 to use to create the checksum for the object. For more information, see Checking object integrity in the Amazon S3 User Guide . Possible values: o CRC32 o CRC32C o SHA1 o SHA256 o CRC64NVME o SHA512 o MD5 o XXHASH64 o XXHASH3 o XXHASH128
    /// </summary>
    [CliOption("--checksum-algorithm")]
    public AwsS3apiCreateMultipartUploadChecksumAlgorithm? ChecksumAlgorithm { get; set; }

    /// <summary>
    /// Indicates the checksum type that you want Amazon S3 to use to calcu- late the objects checksum value. For more information, see Checking object integrity in the Amazon S3 User Guide . Possible values: o COMPOSITE o FULL_OBJECT
    /// </summary>
    [CliOption("--checksum-type")]
    public AwsS3apiCreateMultipartUploadChecksumType? ChecksumType { get; set; }
