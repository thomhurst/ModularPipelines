...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/groundstation/list-ground-stations/index.html
...
[CliSubCommand("groundstation", "list-ground-stations")]
public record AwsGroundstationListGroundStationsOptions : AwsOptions
{
    /// <summary>
    /// Satellite ID to retrieve on-boarded ground stations. Constraints: o min: 36 o max: 36 o pattern: [a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}
    /// </summary>
