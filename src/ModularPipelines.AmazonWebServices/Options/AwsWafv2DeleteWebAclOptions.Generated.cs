...
public record AwsWafv2DeleteWebAclOptions : AwsOptions, IValidatableObject
{
    ...
    /// Deletes the specified WebACL . You can only use this if ManagedByFirewallManager is false in the web ACL. NOTE: Before deleting any web ACL, first disassociate it from all re- sources. o To retrieve a list of the resources that are associated with a web ACL, use the following calls: o For Amazon CloudFront distributions, use the CloudFront call ListDistributionsByWebACLId . For information, see ListDistributionsByWebACLId in the Amazon CloudFront API Refer- ence . o For all other resources, call...
    /// </summary>
    /// <param name="Name">The name of the web ACL. You cannot change the name of a web ACL af- ter you create it. Constraints: o min: 1 o max: 128 o pattern: ^[\w\-]+$</param>
    ...
    /// <param name="Id">The unique identifier for the web ACL. This ID is returned in the responses to create and list commands. You provide it to operations like update and delete. Constraints: o min: 1 o max: 36 o pattern: ^[0-9a-f]{8}-(?:[0-9a-f]{4}-){3}[0-9a-f]{12}$</param>
    ...
    public AwsWafv2DeleteWebAclOptions(
        string Name,
        AwsWafv2DeleteWebAclScope Scope,
        string Id,
        string LockToken
    )
    {
    ...
    private AwsWafv2DeleteWebAclOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2DeleteWebAclOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2DeleteWebAclOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2DeleteWebAclScope? Scope { get; private init; }
