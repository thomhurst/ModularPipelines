...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-farm-members/index.html
...
[CliSubCommand("deadline", "list-farm-members")]
public record AwsDeadlineListFarmMembersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists the members of a farm. See also: AWS API Documentation list-farm-members is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: members
    /// </summary>
    /// <param name="FarmId">The farm ID. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    public AwsDeadlineListFarmMembersOptions(
        string FarmId
    )
    {
    ...
    private AwsDeadlineListFarmMembersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListFarmMembersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListFarmMembersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
