...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm-pca/list-certificate-authorities/index.html
...
[CliSubCommand("acm-pca", "list-certificate-authorities")]
public record AwsAcmPcaListCertificateAuthoritiesOptions : AwsOptions
{
    /// <summary>
    /// Use this parameter to filter the returned set of certificate author- ities based on their owner. The default is SELF. Possible values: o SELF o OTHER_ACCOUNTS
    /// </summary>
    [CliOption("--resource-owner")]
    public AwsAcmPcaListCertificateAuthoritiesResourceOwner? ResourceOwner { get; set; }
