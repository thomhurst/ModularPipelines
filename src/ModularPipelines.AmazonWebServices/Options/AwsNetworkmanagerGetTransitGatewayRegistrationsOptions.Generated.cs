...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-transit-gateway-registrations/index.html
...
[CliSubCommand("networkmanager", "get-transit-gateway-registrations")]
public record AwsNetworkmanagerGetTransitGatewayRegistrationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerGetTransitGatewayRegistrationsOptions(
    ...
    private AwsNetworkmanagerGetTransitGatewayRegistrationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerGetTransitGatewayRegistrationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerGetTransitGatewayRegistrationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
