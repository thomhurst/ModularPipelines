...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/list-quick-responses/index.html
...
[CliSubCommand("wisdom", "list-quick-responses")]
public record AwsWisdomListQuickResponsesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomListQuickResponsesOptions(
    ...
    private AwsWisdomListQuickResponsesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomListQuickResponsesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomListQuickResponsesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
