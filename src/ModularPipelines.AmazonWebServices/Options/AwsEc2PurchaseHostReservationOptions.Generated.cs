...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/purchase-host-reservation/index.html
...
[CliSubCommand("ec2", "purchase-host-reservation")]
public record AwsEc2PurchaseHostReservationOptions : AwsOptions, IValidatableObject
{
    ...
    /// Purchase a reservation with configurations that match those of your Dedicated Host. You must have active Dedicated Hosts in your account before you purchase a reservation. This action results in the specified reservation being purchased and charged to your account. See also: AWS API Documentation
    /// </summary>
    /// <param name="HostIdSet">The IDs of the Dedicated Hosts with which the reservation will be associated. (string) Syntax: "string" "string" ...</param>
    /// <param name="OfferingId">The ID of the offering.</param>
    public AwsEc2PurchaseHostReservationOptions(
    ...
    private AwsEc2PurchaseHostReservationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2PurchaseHostReservationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2PurchaseHostReservationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The IDs of the Dedicated Hosts with which the reservation will be associated. (string) Syntax: "string" "string" ...
    /// </summary>
