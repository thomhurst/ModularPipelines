...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifybackend/delete-backend-api/index.html
...
[CliSubCommand("amplifybackend", "delete-backend-api")]
public record AwsAmplifybackendDeleteBackendApiOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifybackendDeleteBackendApiOptions(
        string AppId,
    ...
    private AwsAmplifybackendDeleteBackendApiOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifybackendDeleteBackendApiOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifybackendDeleteBackendApiOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
