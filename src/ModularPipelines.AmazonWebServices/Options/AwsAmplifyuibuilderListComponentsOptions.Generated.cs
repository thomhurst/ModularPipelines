...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifyuibuilder/list-components/index.html
...
[CliSubCommand("amplifyuibuilder", "list-components")]
public record AwsAmplifyuibuilderListComponentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyuibuilderListComponentsOptions(
        string AppId,
    ...
    private AwsAmplifyuibuilderListComponentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyuibuilderListComponentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyuibuilderListComponentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
