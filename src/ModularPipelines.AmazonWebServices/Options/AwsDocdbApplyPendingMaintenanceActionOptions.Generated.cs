...
public record AwsDocdbApplyPendingMaintenanceActionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDocdbApplyPendingMaintenanceActionOptions(
        string ResourceIdentifier,
        AwsDocdbApplyPendingMaintenanceActionApplyAction ApplyAction,
        string OptInType
    )
    {
    ...
    private AwsDocdbApplyPendingMaintenanceActionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDocdbApplyPendingMaintenanceActionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDocdbApplyPendingMaintenanceActionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public AwsDocdbApplyPendingMaintenanceActionApplyAction? ApplyAction { get; private init; }
