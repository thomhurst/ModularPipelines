...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecatalyst/list-source-repositories/index.html
...
[CliSubCommand("codecatalyst", "list-source-repositories")]
public record AwsCodecatalystListSourceRepositoriesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCodecatalystListSourceRepositoriesOptions(
        string SpaceName,
        string ProjectName
    )
    {
    ...
    private AwsCodecatalystListSourceRepositoriesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodecatalystListSourceRepositoriesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodecatalystListSourceRepositoriesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
