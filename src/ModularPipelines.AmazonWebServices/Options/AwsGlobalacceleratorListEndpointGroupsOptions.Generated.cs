...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/globalaccelerator/list-endpoint-groups/index.html
...
[CliSubCommand("globalaccelerator", "list-endpoint-groups")]
public record AwsGlobalacceleratorListEndpointGroupsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlobalacceleratorListEndpointGroupsOptions(
        string ListenerArn
    )
    {
    ...
    private AwsGlobalacceleratorListEndpointGroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlobalacceleratorListEndpointGroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlobalacceleratorListEndpointGroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
