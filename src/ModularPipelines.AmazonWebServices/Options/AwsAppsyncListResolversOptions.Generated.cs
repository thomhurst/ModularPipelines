...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-resolvers/index.html
...
[CliSubCommand("appsync", "list-resolvers")]
public record AwsAppsyncListResolversOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppsyncListResolversOptions(
        string ApiId,
        string TypeName
    )
    {
    ...
    private AwsAppsyncListResolversOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppsyncListResolversOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppsyncListResolversOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
