...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm/list-acme-external-account-bindings/index.html
...
[CliSubCommand("acm", "list-acme-external-account-bindings")]
public record AwsAcmListAcmeExternalAccountBindingsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAcmListAcmeExternalAccountBindingsOptions(
    ...
    private AwsAcmListAcmeExternalAccountBindingsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAcmListAcmeExternalAccountBindingsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAcmListAcmeExternalAccountBindingsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
