...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-resource/index.html
...
[CliSubCommand("apigateway", "update-resource")]
public record AwsApigatewayUpdateResourceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayUpdateResourceOptions(
        string RestApiId,
        string ResourceId
    )
    {
    ...
    private AwsApigatewayUpdateResourceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateResourceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateResourceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
