...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/list-tags-for-resource/index.html
...
[CliSubCommand("notifications", "list-tags-for-resource")]
public record AwsNotificationsListTagsForResourceOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsNotificationsListTagsForResourceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNotificationsListTagsForResourceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNotificationsListTagsForResourceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
