...
public record AwsMediapackagev2DeleteChannelPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMediapackagev2DeleteChannelPolicyOptions(
    ...
    private AwsMediapackagev2DeleteChannelPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediapackagev2DeleteChannelPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediapackagev2DeleteChannelPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
