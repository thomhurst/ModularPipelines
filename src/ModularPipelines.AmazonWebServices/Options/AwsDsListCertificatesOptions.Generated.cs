...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/list-certificates/index.html
...
[CliSubCommand("ds", "list-certificates")]
public record AwsDsListCertificatesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDsListCertificatesOptions(
        string DirectoryId
    )
    {
    ...
    private AwsDsListCertificatesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsListCertificatesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsListCertificatesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
