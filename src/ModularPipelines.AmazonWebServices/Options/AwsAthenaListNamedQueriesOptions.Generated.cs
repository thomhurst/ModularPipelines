...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/athena/list-named-queries/index.html
...
[CliSubCommand("athena", "list-named-queries")]
public record AwsAthenaListNamedQueriesOptions : AwsOptions
{
    /// <summary>
    /// The name of the workgroup from which the named queries are being re- turned. If a workgroup is not specified, the saved queries for the primary workgroup are returned. Constraints: o pattern: [a-zA-Z0-9._-]{1,128}
    /// </summary>
