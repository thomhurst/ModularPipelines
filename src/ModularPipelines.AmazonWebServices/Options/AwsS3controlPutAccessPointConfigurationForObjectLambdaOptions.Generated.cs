...
public record AwsS3controlPutAccessPointConfigurationForObjectLambdaOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsS3controlPutAccessPointConfigurationForObjectLambdaOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3controlPutAccessPointConfigurationForObjectLambdaOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3controlPutAccessPointConfigurationForObjectLambdaOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The account ID for the account that owns the specified Object Lambda Access Point. Constraints: o max: 64 o pattern: ^\d{12}$
    /// </summary>
    [CliOption("--account-id")]
    public string? AccountId { get; private init; }

    /// <summary>
    /// The name of the Object Lambda Access Point. Constraints: o min: 3 o max: 45 o pattern: ^[a-z0-9]([a-z0-9\-]*[a-z0-9])?$
    /// </summary>
    [CliOption("--name")]
