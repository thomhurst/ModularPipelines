...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediastore-data/list-items/index.html
...
[CliSubCommand("mediastore-data", "list-items")]
public record AwsMediastoreDataListItemsOptions : AwsOptions
{
    /// <summary>
    /// The path in the container from which to retrieve items. Format: &lt;folder name&gt;/&lt;folder name&gt;/&lt;file name&gt; Constraints: o min: 0 o max: 900 o pattern: /?(?:[A-Za-z0-9_\.\-\~]+/){0,10}(?:[A-Za-z0-9_\.\-\~]+)?/?
    /// </summary>
    [CliOption("--path")]
