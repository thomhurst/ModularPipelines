...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-verified-access-endpoints/index.html
...
[CliSubCommand("ec2", "describe-verified-access-endpoints")]
public record AwsEc2DescribeVerifiedAccessEndpointsOptions : AwsOptions
{
    /// <summary>
    /// The ID of the Verified Access endpoint. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--verified-access-endpoint-ids", GroupValues = true)]
    public IEnumerable<string>? VerifiedAccessEndpointIds { get; set; }
