...
public record AwsConnectStopTestCaseExecutionOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="TestCaseExecutionId">The identifier of the test case execution to stop. Constraints: o max: 500</param>
    /// <param name="TestCaseId">The identifier of the test case. Constraints: o max: 500</param>
    public AwsConnectStopTestCaseExecutionOptions(
        string InstanceId,
    ...
    private AwsConnectStopTestCaseExecutionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectStopTestCaseExecutionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectStopTestCaseExecutionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The identifier of the test case execution to stop. Constraints: o max: 500
    /// </summary>
