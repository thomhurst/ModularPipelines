...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-data-sources/index.html
...
[CliSubCommand("appsync", "list-data-sources")]
public record AwsAppsyncListDataSourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppsyncListDataSourcesOptions(
        string ApiId
    )
    {
    ...
    private AwsAppsyncListDataSourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppsyncListDataSourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppsyncListDataSourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
