...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-usage-plan-keys/index.html
...
[CliSubCommand("apigateway", "get-usage-plan-keys")]
public record AwsApigatewayGetUsagePlanKeysOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayGetUsagePlanKeysOptions(
        string UsagePlanId
    )
    {
    ...
    private AwsApigatewayGetUsagePlanKeysOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayGetUsagePlanKeysOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayGetUsagePlanKeysOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
