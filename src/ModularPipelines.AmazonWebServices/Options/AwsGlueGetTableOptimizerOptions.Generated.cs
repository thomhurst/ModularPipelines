...
public record AwsGlueGetTableOptimizerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueGetTableOptimizerOptions(
        string CatalogId,
        string DatabaseName,
        string TableName,
        AwsGlueGetTableOptimizerType Type
    )
    {
    ...
    private AwsGlueGetTableOptimizerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueGetTableOptimizerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueGetTableOptimizerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--type")]
    public AwsGlueGetTableOptimizerType? Type { get; private init; }
