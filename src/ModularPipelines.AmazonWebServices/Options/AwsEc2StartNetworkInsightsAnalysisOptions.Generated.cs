...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/start-network-insights-analysis/index.html
...
[CliSubCommand("ec2", "start-network-insights-analysis")]
public record AwsEc2StartNetworkInsightsAnalysisOptions : AwsOptions, IValidatableObject
{
    ...
    /// Starts analyzing the specified path. If the path is reachable, the op- eration returns the shortest feasible path. See also: AWS API Documentation
    /// </summary>
    /// <param name="NetworkInsightsPathId">The ID of the path.</param>
    public AwsEc2StartNetworkInsightsAnalysisOptions(
        string NetworkInsightsPathId
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(NetworkInsightsPathId);
        this.NetworkInsightsPathId = NetworkInsightsPathId;
    }

    private AwsEc2StartNetworkInsightsAnalysisOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2StartNetworkInsightsAnalysisOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2StartNetworkInsightsAnalysisOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public string? NetworkInsightsPathId { get; private init; }

    /// <summary>
    /// The member accounts that contain resources that the path can tra- verse. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--additional-accounts", GroupValues = true)]
    public IEnumerable<string>? AdditionalAccounts { get; set; }

    /// <summary>
    /// The Amazon Resource Names (ARN) of the resources that the path must traverse. (string) Constraints: o min: 1 o max: 1283 Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--filter-in-arns", GroupValues = true)]
    public IEnumerable<string>? FilterInArns { get; set; }

    /// <summary>
    /// The Amazon Resource Names (ARN) of the resources that the path will ignore. (string) Constraints: o min: 1 o max: 1283 Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--filter-out-arns", GroupValues = true)]
    public IEnumerable<string>? FilterOutArns { get; set; }
