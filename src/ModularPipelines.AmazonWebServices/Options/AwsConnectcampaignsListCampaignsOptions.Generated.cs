...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connectcampaigns/list-campaigns/index.html
...
[CliSubCommand("connectcampaigns", "list-campaigns")]
public record AwsConnectcampaignsListCampaignsOptions : AwsOptions
{
    /// <summary>
    /// Filter model by type instanceIdFilter -&gt; (structure) Connect instance identifier filter value -&gt; (string) [required] Amazon Connect Instance Id Constraints: o min: 0 o max: 256 o pattern: [a-zA-Z0-9_\-.]* operator -&gt; (string) [required] Operators for Connect instance identifier filter Possible values: o Eq Shorthand Syntax: instanceIdFilter={value=string,operator=string} JSON Syntax: { "instanceIdFilter": { "value": "string", "operator": "Eq" } }
    /// </summary>
    [CliOption("--filters")]
