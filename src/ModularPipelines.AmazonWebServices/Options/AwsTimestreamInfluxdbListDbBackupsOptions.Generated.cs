...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/timestream-influxdb/list-db-backups/index.html
...
[CliSubCommand("timestream-influxdb", "list-db-backups")]
public record AwsTimestreamInfluxdbListDbBackupsOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the DB instance or DB cluster to list backups for. If not specified, returns all backups in the account and region. Constraints: o min: 3 o max: 64 o pattern: [a-zA-Z0-9]+
    /// </summary>
