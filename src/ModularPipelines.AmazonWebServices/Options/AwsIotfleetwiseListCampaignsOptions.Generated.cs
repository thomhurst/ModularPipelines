...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/list-campaigns/index.html
...
[CliSubCommand("iotfleetwise", "list-campaigns")]
public record AwsIotfleetwiseListCampaignsOptions : AwsOptions
{
    /// <summary>
    /// An optional parameter to filter the results by the status of each created campaign in your account. The status can be one of: CREATING , WAITING_FOR_APPROVAL , RUNNING , or SUSPENDED . Constraints: o min: 1 o max: 20 o pattern: [A-Z_]*
    /// </summary>
    [CliOption("--status")]
