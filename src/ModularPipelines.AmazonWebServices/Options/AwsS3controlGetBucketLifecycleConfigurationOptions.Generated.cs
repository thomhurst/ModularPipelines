...
public record AwsS3controlGetBucketLifecycleConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3controlGetBucketLifecycleConfigurationOptions(
        string AccountId,
        string Bucket
    )
    {
    ...
    private AwsS3controlGetBucketLifecycleConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3controlGetBucketLifecycleConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3controlGetBucketLifecycleConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
