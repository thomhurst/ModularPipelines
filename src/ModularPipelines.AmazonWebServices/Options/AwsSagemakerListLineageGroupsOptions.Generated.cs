...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-lineage-groups/index.html
...
[CliSubCommand("sagemaker", "list-lineage-groups")]
public record AwsSagemakerListLineageGroupsOptions : AwsOptions
{
    ...
    /// <summary>
    /// A timestamp to filter against lineage groups created before a cer- tain point in time.
    /// </summary>
    ...
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListLineageGroupsSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order for the results. The default is Ascending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListLineageGroupsSortOrder? SortOrder { get; set; }
