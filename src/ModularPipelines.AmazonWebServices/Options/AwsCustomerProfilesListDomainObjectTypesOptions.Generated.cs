...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-domain-object-types/index.html
...
[CliSubCommand("customer-profiles", "list-domain-object-types")]
public record AwsCustomerProfilesListDomainObjectTypesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListDomainObjectTypesOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListDomainObjectTypesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListDomainObjectTypesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListDomainObjectTypesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
