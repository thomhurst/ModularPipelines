...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lakeformation/search-databases-by-lf-tags/index.html
...
[CliSubCommand("lakeformation", "search-databases-by-lf-tags")]
public record AwsLakeformationSearchDatabasesByLfTagsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsLakeformationSearchDatabasesByLfTagsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLakeformationSearchDatabasesByLfTagsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLakeformationSearchDatabasesByLfTagsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
