...
public record AwsCodestarConnectionsListRepositorySyncDefinitionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCodestarConnectionsListRepositorySyncDefinitionsOptions(
        string RepositoryLinkId,
        AwsCodestarConnectionsListRepositorySyncDefinitionsSyncType SyncType
    )
    {
    ...
    private AwsCodestarConnectionsListRepositorySyncDefinitionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodestarConnectionsListRepositorySyncDefinitionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodestarConnectionsListRepositorySyncDefinitionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--sync-type")]
    public AwsCodestarConnectionsListRepositorySyncDefinitionsSyncType? SyncType { get; private init; }
