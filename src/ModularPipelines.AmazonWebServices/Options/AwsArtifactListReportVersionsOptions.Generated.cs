...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/artifact/list-report-versions/index.html
...
[CliSubCommand("artifact", "list-report-versions")]
public record AwsArtifactListReportVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsArtifactListReportVersionsOptions(
        string ReportId
    )
    {
    ...
    private AwsArtifactListReportVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsArtifactListReportVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsArtifactListReportVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
