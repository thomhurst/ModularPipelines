...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/scheduler/list-schedule-groups/index.html
...
[CliSubCommand("scheduler", "list-schedule-groups")]
public record AwsSchedulerListScheduleGroupsOptions : AwsOptions
{
    /// <summary>
    /// The name prefix that you can use to return a filtered list of your schedule groups. Constraints: o min: 1 o max: 64 o pattern: ^[0-9a-zA-Z-_.]+$
    /// </summary>
