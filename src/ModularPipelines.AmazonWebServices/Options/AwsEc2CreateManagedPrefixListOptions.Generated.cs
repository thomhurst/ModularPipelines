...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-managed-prefix-list/index.html
...
[CliSubCommand("ec2", "create-managed-prefix-list")]
public record AwsEc2CreateManagedPrefixListOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a managed prefix list. You can specify entries for the prefix list. Each entry consists of a CIDR block and an optional description. See also: AWS API Documentation
    /// </summary>
    /// <param name="PrefixListName">A name for the prefix list. Constraints: Up to 255 characters in length. The name cannot start with com.amazonaws .</param>
    /// <param name="MaxEntries">The maximum number of entries for the prefix list.</param>
    /// <param name="AddressFamily">The IP address type. Valid Values: IPv4 | IPv6</param>
    public AwsEc2CreateManagedPrefixListOptions(
        string PrefixListName,
        int MaxEntries,
        string AddressFamily
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(PrefixListName);
    ...
    private AwsEc2CreateManagedPrefixListOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateManagedPrefixListOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateManagedPrefixListOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public string? PrefixListName { get; private init; }

    /// <summary>
    /// The maximum number of entries for the prefix list.
    /// </summary>
    [CliOption("--max-entries")]
    public int? MaxEntries { get; private init; }
