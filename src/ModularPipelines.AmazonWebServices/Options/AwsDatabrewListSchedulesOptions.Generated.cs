...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/list-schedules/index.html
...
[CliSubCommand("databrew", "list-schedules")]
public record AwsDatabrewListSchedulesOptions : AwsOptions
{
    /// <summary>
    /// The name of the job that these schedules apply to. Constraints: o min: 1 o max: 240
    /// </summary>
    [CliOption("--job-name")]
