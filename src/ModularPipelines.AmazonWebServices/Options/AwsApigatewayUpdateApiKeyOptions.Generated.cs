...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-api-key/index.html
...
[CliSubCommand("apigateway", "update-api-key")]
public record AwsApigatewayUpdateApiKeyOptions : AwsOptions, IValidatableObject
{
    ...
    /// Changes information about an ApiKey resource. See also: AWS API Documentation
    /// </summary>
    /// <param name="ApiKey">The identifier of the ApiKey resource to be updated.</param>
    public AwsApigatewayUpdateApiKeyOptions(
        string ApiKey
    )
    {
    ...
    private AwsApigatewayUpdateApiKeyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateApiKeyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateApiKeyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
