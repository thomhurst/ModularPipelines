...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/list-extension-associations/index.html
...
[CliSubCommand("appconfig", "list-extension-associations")]
public record AwsAppConfigListExtensionAssociationsOptions : AwsOptions
{
    /// <summary>
    /// The ARN of an application, configuration profile, or environment. Constraints: o min: 20 o max: 2048 o pattern: arn:(aws[a-zA-Z-]*)?:[a-z]+:((eusc-)?[a-z]{2}((-gov)|(-iso([a-z]?)))?-[a-z]+-\d{1})?:(\d{12})?:[a-zA-Z0-9-_/:.]+
    /// </summary>
