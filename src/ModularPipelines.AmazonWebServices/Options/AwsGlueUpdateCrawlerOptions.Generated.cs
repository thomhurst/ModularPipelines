...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/update-crawler/index.html
...
[CliSubCommand("glue", "update-crawler")]
public record AwsGlueUpdateCrawlerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueUpdateCrawlerOptions(
        string Name
    )
    {
    ...
    private AwsGlueUpdateCrawlerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueUpdateCrawlerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueUpdateCrawlerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Glue database where results are stored, such as: arn:aws:day- light:us-east-1::database/sometable/* .
    /// </summary>
