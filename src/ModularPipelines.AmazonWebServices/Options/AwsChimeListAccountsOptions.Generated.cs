...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chime/list-accounts/index.html
...
[CliSubCommand("chime", "list-accounts")]
public record AwsChimeListAccountsOptions : AwsOptions
{
    /// <summary>
    /// Amazon Chime account name prefix with which to filter results. Constraints: o min: 1 o max: 100 o pattern: .*\S.*
    /// </summary>
    [CliOption("--name")]
    public string? Name { get; set; }

    /// <summary>
    /// User email address with which to filter results. Constraints: o pattern: .+@.+\..+
    /// </summary>
