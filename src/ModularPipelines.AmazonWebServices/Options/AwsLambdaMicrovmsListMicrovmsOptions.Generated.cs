...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda-microvms/list-microvms/index.html
...
[CliSubCommand("lambda-microvms", "list-microvms")]
public record AwsLambdaMicrovmsListMicrovmsOptions : AwsOptions
{
    /// <summary>
    /// Optional filter to list only MicroVMs running the specified image. Constraints: o min: 1 o max: 256
    /// </summary>
