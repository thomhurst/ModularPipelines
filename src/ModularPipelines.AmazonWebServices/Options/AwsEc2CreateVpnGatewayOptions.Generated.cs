...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-vpn-gateway/index.html
...
[CliSubCommand("ec2", "create-vpn-gateway")]
public record AwsEc2CreateVpnGatewayOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsEc2CreateVpnGatewayOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateVpnGatewayOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateVpnGatewayOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
