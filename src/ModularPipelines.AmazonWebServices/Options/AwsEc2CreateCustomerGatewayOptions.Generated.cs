...
public record AwsEc2CreateCustomerGatewayOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsEc2CreateCustomerGatewayOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateCustomerGatewayOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateCustomerGatewayOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
