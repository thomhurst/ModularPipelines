...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticache/describe-serverless-caches/index.html
...
[CliSubCommand("elasticache", "describe-serverless-caches")]
public record AwsElasticacheDescribeServerlessCachesOptions : AwsOptions
{
    /// <summary>
    /// The identifier for the serverless cache. If this parameter is speci- fied, only information about that specific serverless cache is re- turned. Default: NULL
    /// </summary>
