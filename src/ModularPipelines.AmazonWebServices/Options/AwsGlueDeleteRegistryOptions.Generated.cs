...
public record AwsGlueDeleteRegistryOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueDeleteRegistryOptions(
        string RegistryId
    )
    {
    ...
    private AwsGlueDeleteRegistryOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueDeleteRegistryOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueDeleteRegistryOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
