...
public record AwsResiliencehubv2UpdateServiceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2UpdateServiceOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2UpdateServiceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2UpdateServiceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2UpdateServiceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
