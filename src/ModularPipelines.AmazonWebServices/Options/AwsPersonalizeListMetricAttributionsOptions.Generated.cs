...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-metric-attributions/index.html
...
[CliSubCommand("personalize", "list-metric-attributions")]
public record AwsPersonalizeListMetricAttributionsOptions : AwsOptions
{
    /// <summary>
    /// The metric attributions' dataset group Amazon Resource Name (ARN). Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
