...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-message-template-versions/index.html
...
[CliSubCommand("qconnect", "list-message-template-versions")]
public record AwsQconnectListMessageTemplateVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListMessageTemplateVersionsOptions(
    ...
    private AwsQconnectListMessageTemplateVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListMessageTemplateVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListMessageTemplateVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
