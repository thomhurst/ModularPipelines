...
public record AwsResiliencehubListAppVersionResourceMappingsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubListAppVersionResourceMappingsOptions(
        string AppArn,
        string AppVersion
    )
    {
    ...
    private AwsResiliencehubListAppVersionResourceMappingsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubListAppVersionResourceMappingsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubListAppVersionResourceMappingsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
