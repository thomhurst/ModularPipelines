...
public record AwsDsDataListGroupMembersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDsDataListGroupMembersOptions(
        string DirectoryId,
    ...
    private AwsDsDataListGroupMembersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsDataListGroupMembersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsDataListGroupMembersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
