...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-security-profile-ai-agents/index.html
...
[CliSubCommand("connect", "list-security-profile-ai-agents")]
public record AwsConnectListSecurityProfileAiAgentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListSecurityProfileAiAgentsOptions(
    ...
    private AwsConnectListSecurityProfileAiAgentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListSecurityProfileAiAgentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListSecurityProfileAiAgentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
