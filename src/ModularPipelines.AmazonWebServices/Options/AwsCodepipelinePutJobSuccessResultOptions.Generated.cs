...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codepipeline/put-job-success-result/index.html
...
public record AwsCodepipelinePutJobSuccessResultOptions : AwsOptions
{
    ...
    /// <summary>
    /// A token generated by a job worker, such as a CodeDeploy deployment ID, that a successful job provides to identify a custom action in progress. Future jobs use this token to identify the running in- stance of the action. It can be reused to return more information about the progress of the custom action. When the action is com- plete, no continuation token should be supplied. Constraints: o min: 1 o max: 2048
    /// </summary>
    [SecretValue]
    ...
    /// <summary>
    /// The execution details of the successful job, such as the actions taken by the job worker. summary -&gt; (string) The summary of the current status of the actions. Constraints: o min: 1 o max: 2048 externalExecutionId -&gt; (string) The system-generated unique ID of this action used to identify this job worker in any external systems, such as CodeDeploy. Constraints: o min: 1 o max: 1500 percentComplete -&gt; (integer) The percentage of work completed on the action, represented on a scale of 0 to 100 percent. Constraints: o min: 0 o max: 100 Shorthand Syntax: summary=string,externalExecutionId=string,percentComplete=integer JSON Syntax: { "summary": "string", "externalExecutionId": "string", "percentComplete": integer }
    /// </summary>
