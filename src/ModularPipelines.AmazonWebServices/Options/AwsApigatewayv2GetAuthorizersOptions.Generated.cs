...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-authorizers/index.html
...
[CliSubCommand("apigatewayv2", "get-authorizers")]
public record AwsApigatewayv2GetAuthorizersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetAuthorizersOptions(
        string ApiId
    )
    {
    ...
    private AwsApigatewayv2GetAuthorizersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetAuthorizersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetAuthorizersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
