...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/configservice/describe-organization-config-rules/index.html
...
[CliSubCommand("configservice", "describe-organization-config-rules")]
public record AwsConfigserviceDescribeOrganizationConfigRulesOptions : AwsOptions
{
    /// <summary>
    /// The names of organization Config rules for which you want details. If you do not specify any names, Config returns details for all your organization Config rules. Constraints: o min: 0 o max: 25 (string) Constraints: o min: 1 o max: 64 Syntax: "string" "string" ...
    /// </summary>
