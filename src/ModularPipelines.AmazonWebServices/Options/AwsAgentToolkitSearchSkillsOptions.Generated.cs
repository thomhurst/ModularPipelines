...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/agent-toolkit/search-skills/index.html
...
[CliSubCommand("agent-toolkit", "search-skills")]
public record AwsAgentToolkitSearchSkillsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Searches the remote catalog for skills matching a query. See also: AWS API Documentation search-skills is a paginated operation. Multiple API calls may be is- sued in order to retrieve the entire data set of results. You can dis- able pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: skills
    /// </summary>
    /// <param name="SearchQuery">Constraints: o min: 1 o max: 1000 o pattern: [a-zA-Z0-9\-_ .,;:?!'"()/&amp;@#+]+</param>
    public AwsAgentToolkitSearchSkillsOptions(
        string SearchQuery
    )
    {
    ...
    private AwsAgentToolkitSearchSkillsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAgentToolkitSearchSkillsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAgentToolkitSearchSkillsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Constraints: o min: 1 o max: 1000 o pattern: [a-zA-Z0-9\-_ .,;:?!'"()/&amp;@#+]+
    /// </summary>
