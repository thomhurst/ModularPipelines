...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-documentation-versions/index.html
...
[CliSubCommand("apigateway", "get-documentation-versions")]
public record AwsApigatewayGetDocumentationVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayGetDocumentationVersionsOptions(
        string RestApiId
    )
    {
    ...
    private AwsApigatewayGetDocumentationVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayGetDocumentationVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayGetDocumentationVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
