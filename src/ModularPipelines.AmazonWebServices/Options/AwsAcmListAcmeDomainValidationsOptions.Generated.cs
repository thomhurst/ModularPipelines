...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/acm/list-acme-domain-validations/index.html
...
[CliSubCommand("acm", "list-acme-domain-validations")]
public record AwsAcmListAcmeDomainValidationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAcmListAcmeDomainValidationsOptions(
    ...
    private AwsAcmListAcmeDomainValidationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAcmListAcmeDomainValidationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAcmListAcmeDomainValidationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
