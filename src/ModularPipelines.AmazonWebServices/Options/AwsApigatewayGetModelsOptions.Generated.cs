...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-models/index.html
...
[CliSubCommand("apigateway", "get-models")]
public record AwsApigatewayGetModelsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayGetModelsOptions(
        string RestApiId
    )
    {
    ...
    private AwsApigatewayGetModelsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayGetModelsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayGetModelsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
