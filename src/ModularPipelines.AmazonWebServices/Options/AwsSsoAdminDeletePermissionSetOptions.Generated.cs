...
public record AwsSsoAdminDeletePermissionSetOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="PermissionSetArn">The ARN of the permission set that should be deleted. Constraints: o min: 10 o max: 1224 o pattern: arn:aws(-[a-z]{1,5}){0,3}:sso:::permission- Set/(sso)?ins-[a-zA-Z0-9-.]{16}/ps-[a-zA-Z0-9-./]{16}</param>
    public AwsSsoAdminDeletePermissionSetOptions(
        string InstanceArn,
    ...
    private AwsSsoAdminDeletePermissionSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminDeletePermissionSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminDeletePermissionSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ARN of the permission set that should be deleted. Constraints: o min: 10 o max: 1224 o pattern: arn:aws(-[a-z]{1,5}){0,3}:sso:::permission- Set/(sso)?ins-[a-zA-Z0-9-.]{16}/ps-[a-zA-Z0-9-./]{16}
    /// </summary>
