...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appmesh/list-virtual-routers/index.html
...
[CliSubCommand("appmesh", "list-virtual-routers")]
public record AwsAppmeshListVirtualRoutersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a list of existing virtual routers in a service mesh. See also: AWS API Documentation list-virtual-routers is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: virtualRouters
    /// </summary>
    /// <param name="MeshName">The name of the service mesh to list virtual routers in. Constraints: o min: 1 o max: 255</param>
    public AwsAppmeshListVirtualRoutersOptions(
        string MeshName
    )
    {
    ...
    private AwsAppmeshListVirtualRoutersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppmeshListVirtualRoutersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppmeshListVirtualRoutersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the service mesh to list virtual routers in. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--mesh-name")]
