...
public record AwsBillingUpdateBillingViewOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBillingUpdateBillingViewOptions(
        string Arn
    )
    {
    ...
    private AwsBillingUpdateBillingViewOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBillingUpdateBillingViewOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBillingUpdateBillingViewOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
