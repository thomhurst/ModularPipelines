...
public record AwsElbv2RegisterTargetsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsElbv2RegisterTargetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsElbv2RegisterTargetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsElbv2RegisterTargetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
