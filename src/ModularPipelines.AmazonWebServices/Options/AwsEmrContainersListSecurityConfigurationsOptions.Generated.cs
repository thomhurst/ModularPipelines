...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/emr-containers/list-security-configurations/index.html
...
[CliSubCommand("emr-containers", "list-security-configurations")]
public record AwsEmrContainersListSecurityConfigurationsOptions : AwsOptions
{
    /// <summary>
    /// The date and time after which the security configuration was cre- ated.
    /// </summary>
    [CliOption("--created-after")]
    public string? CreatedAfter { get; set; }

    /// <summary>
    /// The date and time before which the security configuration was cre- ated.
    /// </summary>
