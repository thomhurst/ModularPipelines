...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/list-managed-notification-channel-associations/index.html
...
[CliSubCommand("notifications", "list-managed-notification-channel-associations")]
public record AwsNotificationsListManagedNotificationChannelAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsNotificationsListManagedNotificationChannelAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNotificationsListManagedNotificationChannelAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNotificationsListManagedNotificationChannelAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
