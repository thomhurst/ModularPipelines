...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore-control/list-code-interpreters/index.html
...
[CliSubCommand("bedrock-agentcore-control", "list-code-interpreters")]
public record AwsBedrockAgentcoreControlListCodeInterpretersOptions : AwsOptions
{
    /// <summary>
    /// The type of code interpreters to list. Possible values: o SYSTEM o CUSTOM
    /// </summary>
    [CliOption("--type")]
    public AwsBedrockAgentcoreControlListCodeInterpretersType? Type { get; set; }
