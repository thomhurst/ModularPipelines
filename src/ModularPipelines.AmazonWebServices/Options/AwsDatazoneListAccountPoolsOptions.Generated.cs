...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-account-pools/index.html
...
[CliSubCommand("datazone", "list-account-pools")]
public record AwsDatazoneListAccountPoolsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists existing account pools. See also: AWS API Documentation list-account-pools is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: items
    /// </summary>
    /// <param name="DomainIdentifier">The ID of the domain where exsting account pools are to be listed. Constraints: o pattern: dzd[-_][a-zA-Z0-9_-]{1,36}</param>
    public AwsDatazoneListAccountPoolsOptions(
    ...
    private AwsDatazoneListAccountPoolsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDatazoneListAccountPoolsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDatazoneListAccountPoolsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the domain where exsting account pools are to be listed. Constraints: o pattern: dzd[-_][a-zA-Z0-9_-]{1,36}
    /// </summary>
    [CliOption("--domain-identifier")]
    public string? DomainIdentifier { get; private init; }

    /// <summary>
    /// The name of the account pool to be listed. Constraints: o min: 1 o max: 64 o pattern: [\w -]+
    /// </summary>
    [CliOption("--name")]
    ...
    public AwsDatazoneListAccountPoolsSortOrder? SortOrder { get; set; }
