...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/supplychain/update-data-integration-flow/index.html
...
[CliSubCommand("supplychain", "update-data-integration-flow")]
public record AwsSupplychainUpdateDataIntegrationFlowOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Name">The name of the DataIntegrationFlow to be updated. Constraints: o min: 1 o max: 256 o pattern: [A-Za-z0-9-]+</param>
    public AwsSupplychainUpdateDataIntegrationFlowOptions(
        string InstanceId,
        string Name
    )
    {
    ...
    private AwsSupplychainUpdateDataIntegrationFlowOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSupplychainUpdateDataIntegrationFlowOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSupplychainUpdateDataIntegrationFlowOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
