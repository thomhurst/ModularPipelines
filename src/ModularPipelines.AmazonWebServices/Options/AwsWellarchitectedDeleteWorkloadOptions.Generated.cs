...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/delete-workload/index.html
...
[CliSubCommand("wellarchitected", "delete-workload")]
public record AwsWellarchitectedDeleteWorkloadOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedDeleteWorkloadOptions(
        string WorkloadId
    )
    {
    ...
    private AwsWellarchitectedDeleteWorkloadOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedDeleteWorkloadOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedDeleteWorkloadOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
