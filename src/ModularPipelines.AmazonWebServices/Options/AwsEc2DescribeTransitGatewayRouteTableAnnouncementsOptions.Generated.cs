...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-transit-gateway-route-table-announcements/index.html
...
[CliSubCommand("ec2", "describe-transit-gateway-route-table-announcements")]
public record AwsEc2DescribeTransitGatewayRouteTableAnnouncementsOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the transit gateway route tables that are being adver- tised. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--transit-gateway-route-table-announcement-ids", GroupValues = true)]
    public IEnumerable<string>? TransitGatewayRouteTableAnnouncementIds { get; set; }
