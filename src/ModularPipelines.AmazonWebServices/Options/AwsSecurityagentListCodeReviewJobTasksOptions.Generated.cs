...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityagent/list-code-review-job-tasks/index.html
...
[CliSubCommand("securityagent", "list-code-review-job-tasks")]
public record AwsSecurityagentListCodeReviewJobTasksOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSecurityagentListCodeReviewJobTasksOptions(
        string AgentSpaceId
    )
    {
    ...
    private AwsSecurityagentListCodeReviewJobTasksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSecurityagentListCodeReviewJobTasksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSecurityagentListCodeReviewJobTasksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Filter tasks by step name. Possible values: o PREFLIGHT o STATIC_ANALYSIS o PENTEST o FINALIZING o VALIDATION
    /// </summary>
    [CliOption("--step-name")]
    public AwsSecurityagentListCodeReviewJobTasksStepName? StepName { get; set; }
