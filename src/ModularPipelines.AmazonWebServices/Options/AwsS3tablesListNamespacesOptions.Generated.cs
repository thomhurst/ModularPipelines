...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3tables/list-namespaces/index.html
...
[CliSubCommand("s3tables", "list-namespaces")]
public record AwsS3tablesListNamespacesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3tablesListNamespacesOptions(
    ...
    private AwsS3tablesListNamespacesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3tablesListNamespacesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3tablesListNamespacesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The prefix of the namespaces. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--prefix")]
