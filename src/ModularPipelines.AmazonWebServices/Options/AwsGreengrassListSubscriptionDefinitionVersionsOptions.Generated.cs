...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-subscription-definition-versions/index.html
...
[CliSubCommand("greengrass", "list-subscription-definition-versions")]
public record AwsGreengrassListSubscriptionDefinitionVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListSubscriptionDefinitionVersionsOptions(
    ...
    private AwsGreengrassListSubscriptionDefinitionVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListSubscriptionDefinitionVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListSubscriptionDefinitionVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
