...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-approved-origins/index.html
...
[CliSubCommand("connect", "list-approved-origins")]
public record AwsConnectListApprovedOriginsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListApprovedOriginsOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListApprovedOriginsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListApprovedOriginsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListApprovedOriginsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
