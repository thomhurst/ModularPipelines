...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-attached-files-configurations/index.html
...
[CliSubCommand("connect", "list-attached-files-configurations")]
public record AwsConnectListAttachedFilesConfigurationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListAttachedFilesConfigurationsOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListAttachedFilesConfigurationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListAttachedFilesConfigurationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListAttachedFilesConfigurationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
