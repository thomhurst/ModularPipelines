...
public record AwsRedshiftAddPartnerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRedshiftAddPartnerOptions(
        string AccountId,
    ...
    private AwsRedshiftAddPartnerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRedshiftAddPartnerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRedshiftAddPartnerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
