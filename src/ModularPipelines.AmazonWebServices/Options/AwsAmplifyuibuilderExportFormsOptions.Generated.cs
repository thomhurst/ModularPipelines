...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifyuibuilder/export-forms/index.html
...
[CliSubCommand("amplifyuibuilder", "export-forms")]
public record AwsAmplifyuibuilderExportFormsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyuibuilderExportFormsOptions(
        string AppId,
    ...
    private AwsAmplifyuibuilderExportFormsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyuibuilderExportFormsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyuibuilderExportFormsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
