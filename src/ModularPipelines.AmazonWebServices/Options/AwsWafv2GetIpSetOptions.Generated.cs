...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/get-ip-set/index.html
...
[CliSubCommand("wafv2", "get-ip-set")]
public record AwsWafv2GetIpSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2GetIpSetOptions(
        string Name,
        AwsWafv2GetIpSetScope Scope,
        string Id
    )
    {
    ...
    private AwsWafv2GetIpSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2GetIpSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2GetIpSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2GetIpSetScope? Scope { get; private init; }
