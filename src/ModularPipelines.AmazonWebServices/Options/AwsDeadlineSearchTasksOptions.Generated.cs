...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/search-tasks/index.html
...
[CliSubCommand("deadline", "search-tasks")]
public record AwsDeadlineSearchTasksOptions : AwsOptions, IValidatableObject
{
    ...
    /// Searches for tasks. See also: AWS API Documentation
    /// </summary>
    /// <param name="FarmId">The farm ID of the task. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    /// <param name="ItemOffset">The offset for the search results. Constraints: o min: 0 o max: 10000</param>
    /// <param name="QueueIds">The queue IDs to include in the search. Constraints: o min: 1 o max: 10 (string) Constraints: o pattern: queue-[0-9a-f]{32} Syntax: "string" "string" ...</param>
    public AwsDeadlineSearchTasksOptions(
        string FarmId,
        int ItemOffset,
    ...
    private AwsDeadlineSearchTasksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineSearchTasksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineSearchTasksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID of the task. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    ...
    /// <summary>
    /// The queue IDs to include in the search. Constraints: o min: 1 o max: 10 (string) Constraints: o pattern: queue-[0-9a-f]{32} Syntax: "string" "string" ...
    /// </summary>
    ...
    /// <summary>
    /// The job ID for the task search. Constraints: o pattern: job-[0-9a-f]{32}
    /// </summary>
    [CliOption("--job-id")]
