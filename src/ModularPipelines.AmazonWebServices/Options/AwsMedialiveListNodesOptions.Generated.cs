...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/list-nodes/index.html
...
[CliSubCommand("medialive", "list-nodes")]
public record AwsMedialiveListNodesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMedialiveListNodesOptions(
        string ClusterId
    )
    {
    ...
    private AwsMedialiveListNodesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMedialiveListNodesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMedialiveListNodesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
