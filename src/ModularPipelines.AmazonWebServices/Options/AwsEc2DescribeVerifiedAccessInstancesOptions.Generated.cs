...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-verified-access-instances/index.html
...
[CliSubCommand("ec2", "describe-verified-access-instances")]
public record AwsEc2DescribeVerifiedAccessInstancesOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the Verified Access instances. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--verified-access-instance-ids", GroupValues = true)]
    public IEnumerable<string>? VerifiedAccessInstanceIds { get; set; }
