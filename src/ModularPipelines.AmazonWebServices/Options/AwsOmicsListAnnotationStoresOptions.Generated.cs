...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/list-annotation-stores/index.html
...
[CliSubCommand("omics", "list-annotation-stores")]
public record AwsOmicsListAnnotationStoresOptions : AwsOptions
{
    /// <summary>
    /// IDs of stores to list. Constraints: o min: 1 o max: 20 (string) Constraints: o min: 1 o max: 50 Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--ids")]
    public IEnumerable<string>? Ids { get; set; }

    /// <summary>
    /// A filter to apply to the list. status -&gt; (string) A status to filter on. Possible values: o CREATING o UPDATING o DELETING o ACTIVE o FAILED Shorthand Syntax: status=string JSON Syntax: { "status": "CREATING"|"UPDATING"|"DELETING"|"ACTIVE"|"FAILED" }
    /// </summary>
    [CliOption("--filter")]
