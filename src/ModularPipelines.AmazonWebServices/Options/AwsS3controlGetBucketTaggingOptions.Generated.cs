...
public record AwsS3controlGetBucketTaggingOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3controlGetBucketTaggingOptions(
        string AccountId,
        string Bucket
    )
    {
    ...
    private AwsS3controlGetBucketTaggingOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3controlGetBucketTaggingOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3controlGetBucketTaggingOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
