...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-data-quality-job-definitions/index.html
...
[CliSubCommand("sagemaker", "list-data-quality-job-definitions")]
public record AwsSagemakerListDataQualityJobDefinitionsOptions : AwsOptions
{
    /// <summary>
    /// A filter that lists the data quality job definitions associated with the specified endpoint. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
    ...
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListDataQualityJobDefinitionsSortBy? SortBy { get; set; }
    ...
    public AwsSagemakerListDataQualityJobDefinitionsSortOrder? SortOrder { get; set; }

    /// <summary>
    /// A string in the data quality monitoring job definition name. This filter returns only data quality monitoring job definitions whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9\-]+
    /// </summary>
