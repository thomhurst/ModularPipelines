...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-vpc-encryption-control/index.html
...
[CliSubCommand("ec2", "create-vpc-encryption-control")]
public record AwsEc2CreateVpcEncryptionControlOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a VPC Encryption Control configuration for a specified VPC. VPC Encryption Control enables you to enforce encryption for all data in transit within and between VPCs to meet compliance requirements for standards like HIPAA, FedRAMP, and PCI DSS. For more information, see Enforce VPC encryption in transit in the Ama- zon VPC User Guide . See also: AWS API Documentation
    /// </summary>
    /// <param name="VpcId">The ID of the VPC for which to create the encryption control config- uration.</param>
    public AwsEc2CreateVpcEncryptionControlOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateVpcEncryptionControlOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateVpcEncryptionControlOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateVpcEncryptionControlOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the VPC for which to create the encryption control config- uration.
    /// </summary>
    [CliOption("--vpc-id")]
