...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53-recovery-control-config/list-safety-rules/index.html
...
[CliSubCommand("route53-recovery-control-config", "list-safety-rules")]
public record AwsRoute53RecoveryControlConfigListSafetyRulesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRoute53RecoveryControlConfigListSafetyRulesOptions(
    ...
    private AwsRoute53RecoveryControlConfigListSafetyRulesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRoute53RecoveryControlConfigListSafetyRulesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRoute53RecoveryControlConfigListSafetyRulesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
