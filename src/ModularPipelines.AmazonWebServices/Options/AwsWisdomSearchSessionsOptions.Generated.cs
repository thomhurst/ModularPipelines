...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/search-sessions/index.html
...
[CliSubCommand("wisdom", "search-sessions")]
public record AwsWisdomSearchSessionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomSearchSessionsOptions(
        string AssistantId,
    ...
    private AwsWisdomSearchSessionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomSearchSessionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomSearchSessionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
