...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/list-alarm-recommendations/index.html
...
[CliSubCommand("resiliencehub", "list-alarm-recommendations")]
public record AwsResiliencehubListAlarmRecommendationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubListAlarmRecommendationsOptions(
    ...
    private AwsResiliencehubListAlarmRecommendationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubListAlarmRecommendationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubListAlarmRecommendationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
