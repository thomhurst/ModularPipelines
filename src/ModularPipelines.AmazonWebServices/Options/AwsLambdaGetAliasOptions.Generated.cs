...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/get-alias/index.html
...
[CliSubCommand("lambda", "get-alias")]
public record AwsLambdaGetAliasOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaGetAliasOptions(
        string FunctionName,
        string Name
    )
    {
    ...
    private AwsLambdaGetAliasOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaGetAliasOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaGetAliasOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
