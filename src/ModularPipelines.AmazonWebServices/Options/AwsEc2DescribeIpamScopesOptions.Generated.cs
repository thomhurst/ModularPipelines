...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-ipam-scopes/index.html
...
[CliSubCommand("ec2", "describe-ipam-scopes")]
public record AwsEc2DescribeIpamScopesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The IDs of the scopes you want information on. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--ipam-scope-ids", GroupValues = true)]
    public IEnumerable<string>? IpamScopeIds { get; set; }
