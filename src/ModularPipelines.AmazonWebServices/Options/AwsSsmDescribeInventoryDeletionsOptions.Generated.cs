...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/describe-inventory-deletions/index.html
...
[CliSubCommand("ssm", "describe-inventory-deletions")]
public record AwsSsmDescribeInventoryDeletionsOptions : AwsOptions
{
    /// <summary>
    /// Specify the delete inventory ID for which you want information. This ID was returned by the DeleteInventory operation. Constraints: o pattern: [a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}
    /// </summary>
