...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-spaces/index.html
...
[CliSubCommand("sagemaker", "list-spaces")]
public record AwsSagemakerListSpacesOptions : AwsOptions
{
    ...
    public AwsSagemakerListSpacesSortOrder? SortOrder { get; set; }
    ...
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListSpacesSortBy? SortBy { get; set; }
