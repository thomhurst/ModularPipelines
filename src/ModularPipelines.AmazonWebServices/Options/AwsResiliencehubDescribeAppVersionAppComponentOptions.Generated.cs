...
public record AwsResiliencehubDescribeAppVersionAppComponentOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubDescribeAppVersionAppComponentOptions(
        string AppArn,
        string AppVersion,
        string Id
    )
    ...
    private AwsResiliencehubDescribeAppVersionAppComponentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubDescribeAppVersionAppComponentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubDescribeAppVersionAppComponentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
