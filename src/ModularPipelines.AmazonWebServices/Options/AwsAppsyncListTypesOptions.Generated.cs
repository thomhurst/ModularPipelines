...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-types/index.html
...
[CliSubCommand("appsync", "list-types")]
public record AwsAppsyncListTypesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppsyncListTypesOptions(
        string ApiId,
        AwsAppsyncListTypesFormat Format
    )
    {
    ...
    private AwsAppsyncListTypesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppsyncListTypesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppsyncListTypesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--format")]
    public AwsAppsyncListTypesFormat? Format { get; private init; }
