...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/describe-instance-patch-states/index.html
...
[CliSubCommand("ssm", "describe-instance-patch-states")]
public record AwsSsmDescribeInstancePatchStatesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves the high-level patch state of one or more managed nodes. See also: AWS API Documentation describe-instance-patch-states is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: InstancePatchStates
    /// </summary>
    /// <param name="InstanceIds">The ID of the managed node for which patch state information should be retrieved. Constraints: o min: 0 o max: 50 (string) Constraints: o pattern: (^i-(\w{8}|\w{17})$)|(^mi-\w{17}$) Syntax: "string" "string" ...</param>
    public AwsSsmDescribeInstancePatchStatesOptions(
    ...
    private AwsSsmDescribeInstancePatchStatesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsmDescribeInstancePatchStatesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsmDescribeInstancePatchStatesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the managed node for which patch state information should be retrieved. Constraints: o min: 0 o max: 50 (string) Constraints: o pattern: (^i-(\w{8}|\w{17})$)|(^mi-\w{17}$) Syntax: "string" "string" ...
    /// </summary>
