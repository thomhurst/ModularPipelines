...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/evs/list-environment-hosts/index.html
...
[CliSubCommand("evs", "list-environment-hosts")]
public record AwsEvsListEnvironmentHostsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEvsListEnvironmentHostsOptions(
    ...
    private AwsEvsListEnvironmentHostsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEvsListEnvironmentHostsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEvsListEnvironmentHostsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
