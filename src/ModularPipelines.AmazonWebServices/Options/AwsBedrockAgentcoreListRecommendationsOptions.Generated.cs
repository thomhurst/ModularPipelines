...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore/list-recommendations/index.html
...
[CliSubCommand("bedrock-agentcore", "list-recommendations")]
public record AwsBedrockAgentcoreListRecommendationsOptions : AwsOptions
{
    /// <summary>
    /// Optional filter to return only recommendations with the specified status. Possible values: o PENDING o IN_PROGRESS o COMPLETED o FAILED o DELETING
    /// </summary>
    [CliOption("--status-filter")]
    public AwsBedrockAgentcoreListRecommendationsStatusFilter? StatusFilter { get; set; }
