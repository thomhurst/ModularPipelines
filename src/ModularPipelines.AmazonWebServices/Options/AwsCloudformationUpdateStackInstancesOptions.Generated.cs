...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudformation/update-stack-instances/index.html
...
[CliSubCommand("cloudformation", "update-stack-instances")]
public record AwsCloudformationUpdateStackInstancesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Updates the parameter values for stack instances for the specified ac- counts, within the specified Amazon Web Services Regions. A stack in- stance refers to a stack in a specific account and Region. You can only update stack instances in Amazon Web Services Regions and accounts where they already exist; to create additional stack in- stances, use CreateStackInstances . During StackSet updates, any parameters overridden for a stack instance aren't updated, but retain their overridden value. You ...
    /// </summary>
    /// <param name="StackSetName">The name or unique ID of the StackSet associated with the stack in- stances. Constraints: o pattern: [a-zA-Z][-a-zA-Z0-9]*(?::[a-zA-Z0-9]{8}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{12})?</param>
    /// <param name="Regions">The names of one or more Amazon Web Services Regions in which you want to update parameter values for stack instances. The overridden parameter values will be applied to all stack instances in the spec- ified accounts and Amazon Web Services Regions. (string) Constraints: o pattern: ^[a-zA-Z0-9-]{1,128}$ Syntax: "string" "string" ...</param>
    public AwsCloudformationUpdateStackInstancesOptions(
        string StackSetName,
    ...
    private AwsCloudformationUpdateStackInstancesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCloudformationUpdateStackInstancesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCloudformationUpdateStackInstancesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name or unique ID of the StackSet associated with the stack in- stances. Constraints: o pattern: [a-zA-Z][-a-zA-Z0-9]*(?::[a-zA-Z0-9]{8}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{4}-[a-zA-Z0-9]{12})?
    /// </summary>
    [CliOption("--stack-set-name")]
    public string? StackSetName { get; private init; }

    /// <summary>
    /// The names of one or more Amazon Web Services Regions in which you want to update parameter values for stack instances. The overridden parameter values will be applied to all stack instances in the spec- ified accounts and Amazon Web Services Regions. (string) Constraints: o pattern: ^[a-zA-Z0-9-]{1,128}$ Syntax: "string" "string" ...
    /// </summary>
    ...
    /// </summary>
    [CliOption("--call-as")]
    public AwsCloudformationUpdateStackInstancesCallAs? CallAs { get; set; }
