...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/schemas/list-registries/index.html
...
[CliSubCommand("schemas", "list-registries")]
public record AwsSchemasListRegistriesOptions : AwsOptions
{
    ...
    /// <summary>
    /// Can be set to Local or AWS to limit responses to your custom reg- istries, or the ones provided by AWS.
    /// </summary>
    [CliOption("--scope")]
