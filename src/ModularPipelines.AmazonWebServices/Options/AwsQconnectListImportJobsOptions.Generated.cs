...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-import-jobs/index.html
...
[CliSubCommand("qconnect", "list-import-jobs")]
public record AwsQconnectListImportJobsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListImportJobsOptions(
    ...
    private AwsQconnectListImportJobsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListImportJobsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListImportJobsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
