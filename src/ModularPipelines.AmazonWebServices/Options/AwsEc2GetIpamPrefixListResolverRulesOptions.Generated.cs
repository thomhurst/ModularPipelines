...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-ipam-prefix-list-resolver-rules/index.html
...
[CliSubCommand("ec2", "get-ipam-prefix-list-resolver-rules")]
public record AwsEc2GetIpamPrefixListResolverRulesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves the CIDR selection rules for an IPAM prefix list resolver. Use this operation to view the business logic that determines which CIDRs are selected for synchronization with prefix lists. See also: AWS API Documentation get-ipam-prefix-list-resolver-rules is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on ...
    /// </summary>
    /// <param name="IpamPrefixListResolverId">The ID of the IPAM prefix list resolver whose rules you want to re- trieve.</param>
    public AwsEc2GetIpamPrefixListResolverRulesOptions(
    ...
    private AwsEc2GetIpamPrefixListResolverRulesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetIpamPrefixListResolverRulesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetIpamPrefixListResolverRulesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the IPAM prefix list resolver whose rules you want to re- trieve.
    /// </summary>
