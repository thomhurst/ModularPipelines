...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/list-deployments/index.html
...
[CliSubCommand("appconfig", "list-deployments")]
public record AwsAppConfigListDeploymentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppConfigListDeploymentsOptions(
    ...
    private AwsAppConfigListDeploymentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppConfigListDeploymentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppConfigListDeploymentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
