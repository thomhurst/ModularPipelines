...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/drs/describe-replication-configuration-templates/index.html
...
[CliSubCommand("drs", "describe-replication-configuration-templates")]
public record AwsDrsDescribeReplicationConfigurationTemplatesOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the Replication Configuration Templates to retrieve. An empty list means all Replication Configuration Templates. Constraints: o min: 0 o max: 200 (string) Constraints: o min: 21 o max: 21 o pattern: rct-[0-9a-zA-Z]{17} Syntax: "string" "string" ...
    /// </summary>
