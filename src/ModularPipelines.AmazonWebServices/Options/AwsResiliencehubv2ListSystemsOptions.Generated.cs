...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/list-systems/index.html
...
[CliSubCommand("resiliencehubv2", "list-systems")]
public record AwsResiliencehubv2ListSystemsOptions : AwsOptions
{
    /// <summary>
    /// Filter systems by organizational unit (OU) identifier. Constraints: o min: 16 o max: 68 o pattern: ou-[a-z0-9]{4,32}-[a-z0-9]{8,32}
    /// </summary>
    [CliOption("--ou-id")]
