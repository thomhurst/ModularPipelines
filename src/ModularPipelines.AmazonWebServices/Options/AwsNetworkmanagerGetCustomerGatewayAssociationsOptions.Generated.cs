...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-customer-gateway-associations/index.html
...
[CliSubCommand("networkmanager", "get-customer-gateway-associations")]
public record AwsNetworkmanagerGetCustomerGatewayAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerGetCustomerGatewayAssociationsOptions(
    ...
    private AwsNetworkmanagerGetCustomerGatewayAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerGetCustomerGatewayAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerGetCustomerGatewayAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
