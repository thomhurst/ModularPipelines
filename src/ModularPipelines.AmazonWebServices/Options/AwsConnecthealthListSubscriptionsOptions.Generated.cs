...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connecthealth/list-subscriptions/index.html
...
[CliSubCommand("connecthealth", "list-subscriptions")]
public record AwsConnecthealthListSubscriptionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnecthealthListSubscriptionsOptions(
        string DomainId
    )
    {
    ...
    private AwsConnecthealthListSubscriptionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnecthealthListSubscriptionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnecthealthListSubscriptionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
