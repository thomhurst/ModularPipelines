...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityhub/list-security-control-definitions/index.html
...
[CliSubCommand("securityhub", "list-security-control-definitions")]
public record AwsSecurityhubListSecurityControlDefinitionsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the standard that you want to view controls for. Constraints: o pattern: .*\S.*
    /// </summary>
