...
[CommandPrecedingArguments("comprehend", "start-entities-detection-job")]
public record AwsComprehendStartEntitiesDetectionJobOptions(
...
) : AwsOptions
{
    ...
    [CommandSwitch("--entity-recognizer-arn")]
