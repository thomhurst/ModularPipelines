...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/observabilityadmin/list-telemetry-rules/index.html
...
[CliSubCommand("observabilityadmin", "list-telemetry-rules")]
public record AwsObservabilityadminListTelemetryRulesOptions : AwsOptions
{
    /// <summary>
    /// A string to filter telemetry rules whose names begin with the speci- fied prefix.
    /// </summary>
