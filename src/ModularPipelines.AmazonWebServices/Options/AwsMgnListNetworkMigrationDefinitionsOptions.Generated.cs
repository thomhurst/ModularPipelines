...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-network-migration-definitions/index.html
...
[CliSubCommand("mgn", "list-network-migration-definitions")]
public record AwsMgnListNetworkMigrationDefinitionsOptions : AwsOptions
{
    /// <summary>
    /// Filters to apply when listing network migration definitions. networkMigrationDefinitionIDs -&gt; (list) A list of definition IDs to filter by. Constraints: o min: 0 o max: 20 (string) Constraints: o min: 21 o max: 21 o pattern: nmd-[0-9a-zA-Z]{17} Shorthand Syntax: networkMigrationDefinitionIDs=string,string JSON Syntax: { "networkMigrationDefinitionIDs": ["string", ...] }
    /// </summary>
    [CliOption("--filters")]
