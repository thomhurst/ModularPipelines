...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs-realtime/list-ingest-configurations/index.html
...
[CliSubCommand("ivs-realtime", "list-ingest-configurations")]
public record AwsIvsRealtimeListIngestConfigurationsOptions : AwsOptions
{
    /// <summary>
    /// Filters the response list to match the specified stage ARN. Only one filter (by stage ARN or by state) can be used at a time. Constraints: o min: 1 o max: 128 o pattern: arn:aws:ivs:[a-z0-9-]+:[0-9]+:stage/[a-zA-Z0-9-]+
    /// </summary>
    [CliOption("--filter-by-stage-arn")]
    public string? FilterByStageArn { get; set; }

    /// <summary>
    /// Filters the response list to match the specified state. Only one filter (by stage ARN or by state) can be used at a time. Possible values: o ACTIVE o INACTIVE
    /// </summary>
    [CliOption("--filter-by-state")]
    public AwsIvsRealtimeListIngestConfigurationsFilterByState? FilterByState { get; set; }
