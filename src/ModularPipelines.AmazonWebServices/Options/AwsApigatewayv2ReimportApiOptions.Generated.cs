...
public record AwsApigatewayv2ReimportApiOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2ReimportApiOptions(
        string ApiId,
        string Body
    )
    {
    ...
    private AwsApigatewayv2ReimportApiOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2ReimportApiOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2ReimportApiOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
