...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-routes/index.html
...
[CliSubCommand("apigatewayv2", "get-routes")]
public record AwsApigatewayv2GetRoutesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetRoutesOptions(
        string ApiId
    )
    {
    ...
    private AwsApigatewayv2GetRoutesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetRoutesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetRoutesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
