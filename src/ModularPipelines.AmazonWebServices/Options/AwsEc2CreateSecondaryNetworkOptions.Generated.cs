...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-secondary-network/index.html
...
[CliSubCommand("ec2", "create-secondary-network")]
public record AwsEc2CreateSecondaryNetworkOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a secondary network. The allowed size for a secondary network CIDR block is between /28 net- mask (16 IP addresses) and /12 netmask (1,048,576 IP addresses). See also: AWS API Documentation
    /// </summary>
    /// <param name="Ipv4CidrBlock">The IPv4 CIDR block for the secondary network. The CIDR block size must be between /12 and /28.</param>
    ...
    private AwsEc2CreateSecondaryNetworkOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateSecondaryNetworkOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateSecondaryNetworkOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
