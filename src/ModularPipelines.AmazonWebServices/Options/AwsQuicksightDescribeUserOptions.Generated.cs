...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/describe-user/index.html
...
[CliSubCommand("quicksight", "describe-user")]
public record AwsQuicksightDescribeUserOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns information about a user, given the user name. See also: AWS API Documentation
    /// </summary>
    /// <param name="UserName">The name of the user that you want to describe. Constraints: o min: 1 o pattern: [\u0020-\u00FF]+</param>
    ...
    public AwsQuicksightDescribeUserOptions(
        string UserName,
        string AwsAccountId,
        string Namespace
    )
    ...
    private AwsQuicksightDescribeUserOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightDescribeUserOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightDescribeUserOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the user that you want to describe. Constraints: o min: 1 o pattern: [\u0020-\u00FF]+
    /// </summary>
    [CliOption("--user-name")]
