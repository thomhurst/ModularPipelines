...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/describe-db-clusters/index.html
...
[CliSubCommand("neptune", "describe-db-clusters")]
public record AwsNeptuneDescribeDbClustersOptions : AwsOptions
{
    /// <summary>
    /// The user-supplied DB cluster identifier. If this parameter is speci- fied, information from only the specific DB cluster is returned. This parameter isn't case-sensitive. Constraints: o If supplied, must match an existing DBClusterIdentifier.
    /// </summary>
