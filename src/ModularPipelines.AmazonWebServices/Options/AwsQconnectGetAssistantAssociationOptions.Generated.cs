...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/get-assistant-association/index.html
...
[CliSubCommand("qconnect", "get-assistant-association")]
public record AwsQconnectGetAssistantAssociationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectGetAssistantAssociationOptions(
    ...
    private AwsQconnectGetAssistantAssociationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectGetAssistantAssociationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectGetAssistantAssociationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
