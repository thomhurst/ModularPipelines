...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/list-organizational-units/index.html
...
[CliSubCommand("notifications", "list-organizational-units")]
public record AwsNotificationsListOrganizationalUnitsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsNotificationsListOrganizationalUnitsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNotificationsListOrganizationalUnitsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNotificationsListOrganizationalUnitsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
