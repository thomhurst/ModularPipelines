...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/get-auth-policy/index.html
...
[CliSubCommand("vpc-lattice", "get-auth-policy")]
public record AwsVpcLatticeGetAuthPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsVpcLatticeGetAuthPolicyOptions(
    ...
    private AwsVpcLatticeGetAuthPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsVpcLatticeGetAuthPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsVpcLatticeGetAuthPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
