...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-carrier-gateway/index.html
...
[CliSubCommand("ec2", "create-carrier-gateway")]
public record AwsEc2CreateCarrierGatewayOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a carrier gateway. For more information about carrier gateways, see Carrier gateways in the Amazon Web Services Wavelength Developer Guide . See also: AWS API Documentation
    /// </summary>
    /// <param name="VpcId">The ID of the VPC to associate with the carrier gateway.</param>
    public AwsEc2CreateCarrierGatewayOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateCarrierGatewayOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateCarrierGatewayOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateCarrierGatewayOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
