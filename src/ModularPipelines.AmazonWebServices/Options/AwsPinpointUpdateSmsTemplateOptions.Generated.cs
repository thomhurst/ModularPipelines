...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/update-sms-template/index.html
...
[CliSubCommand("pinpoint", "update-sms-template")]
public record AwsPinpointUpdateSmsTemplateOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPinpointUpdateSmsTemplateOptions(
    ...
    private AwsPinpointUpdateSmsTemplateOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPinpointUpdateSmsTemplateOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPinpointUpdateSmsTemplateOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
