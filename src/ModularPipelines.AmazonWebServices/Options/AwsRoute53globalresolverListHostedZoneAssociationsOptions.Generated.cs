...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53globalresolver/list-hosted-zone-associations/index.html
...
[CliSubCommand("route53globalresolver", "list-hosted-zone-associations")]
public record AwsRoute53globalresolverListHostedZoneAssociationsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the DNS view to list hosted zone associations for. This parameter is optional; if you omit it, all hosted zone associations in your Amazon Web Services account are re- turned. Constraints: o min: 1 o max: 2048 o pattern: arn:[-.a-z0-9]{1,63}:[-.a-z0-9]{1,63}:[-.a-z0-9]{0,63}:[-.a-z0-9]{0,63}:[^/].{0,1023}
    /// </summary>
