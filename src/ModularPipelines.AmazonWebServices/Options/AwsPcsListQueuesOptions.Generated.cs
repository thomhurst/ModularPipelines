...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pcs/list-queues/index.html
...
[CliSubCommand("pcs", "list-queues")]
public record AwsPcsListQueuesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a list of all queues associated with a cluster. See also: AWS API Documentation list-queues is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: queues
    /// </summary>
    /// <param name="ClusterIdentifier">The name or ID of the cluster to list queues for. Constraints: o pattern: (pcs_[a-zA-Z0-9]+|[A-Za-z][A-Za-z0-9-]{2,40})</param>
    public AwsPcsListQueuesOptions(
    ...
    private AwsPcsListQueuesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPcsListQueuesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPcsListQueuesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name or ID of the cluster to list queues for. Constraints: o pattern: (pcs_[a-zA-Z0-9]+|[A-Za-z][A-Za-z0-9-]{2,40})
    /// </summary>
