...
public record AwsNotificationsUpdateEventRuleOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsNotificationsUpdateEventRuleOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNotificationsUpdateEventRuleOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNotificationsUpdateEventRuleOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
