...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/update-managed-thing/index.html
...
public record AwsIotManagedIntegrationsUpdateManagedThingOptions : AwsOptions
{
    ...
    /// <summary>
    /// The network mode for the hub-connected device. Possible values: o STANDARD o NETWORK_WIDE_EXCLUSION
    /// </summary>
    [CliOption("--hub-network-mode")]
    public AwsIotManagedIntegrationsUpdateManagedThingHubNetworkMode? HubNetworkMode { get; set; }
