...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-datasets/index.html
...
[CliSubCommand("personalize", "list-datasets")]
public record AwsPersonalizeListDatasetsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the dataset group that contains the datasets to list. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
