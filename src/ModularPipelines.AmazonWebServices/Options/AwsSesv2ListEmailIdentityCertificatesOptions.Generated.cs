...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sesv2/list-email-identity-certificates/index.html
...
[CliSubCommand("sesv2", "list-email-identity-certificates")]
public record AwsSesv2ListEmailIdentityCertificatesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists the S/MIME certificates that are associated with the specified email identity. The results include certificates in all states, such as PROVISIONING , ACTIVE , INACTIVE , DEPROVISIONING , and FAILED . If a certificate has passed its expiration time, it's returned with a status of FAILED . We recommend using pagination to ensure that the operation returns quickly and successfully. When there are more results than fit in a single response, the response includes a NextToken value that you use ...
    /// </summary>
    /// <param name="EmailIdentity">The email identity whose certificate associations you want to list. Constraints: o min: 1</param>
    public AwsSesv2ListEmailIdentityCertificatesOptions(
    ...
    private AwsSesv2ListEmailIdentityCertificatesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSesv2ListEmailIdentityCertificatesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSesv2ListEmailIdentityCertificatesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The email identity whose certificate associations you want to list. Constraints: o min: 1
    /// </summary>
