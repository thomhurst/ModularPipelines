...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-ipam-prefix-list-resolver-targets/index.html
...
[CliSubCommand("ec2", "describe-ipam-prefix-list-resolver-targets")]
public record AwsEc2DescribeIpamPrefixListResolverTargetsOptions : AwsOptions
{
    [CliFlag("--dry-run")]
    ...
    /// <summary>
    /// The IDs of the IPAM prefix list resolver Targets to describe. If not specified, all targets in your account are described. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--ipam-prefix-list-resolver-target-ids", GroupValues = true)]
    public IEnumerable<string>? IpamPrefixListResolverTargetIds { get; set; }
