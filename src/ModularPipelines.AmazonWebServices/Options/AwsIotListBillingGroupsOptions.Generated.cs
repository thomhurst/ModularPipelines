...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-billing-groups/index.html
...
[CliSubCommand("iot", "list-billing-groups")]
public record AwsIotListBillingGroupsOptions : AwsOptions
{
    /// <summary>
    /// Limit the results to billing groups whose names have the given pre- fix. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
