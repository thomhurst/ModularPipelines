...
public record AwsSsoAdminGetApplicationAssignmentConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminGetApplicationAssignmentConfigurationOptions(
    ...
    private AwsSsoAdminGetApplicationAssignmentConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminGetApplicationAssignmentConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminGetApplicationAssignmentConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
