...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-invalidations/index.html
...
[CliSubCommand("cloudfront", "list-invalidations")]
public record AwsCloudfrontListInvalidationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCloudfrontListInvalidationsOptions(
    ...
    private AwsCloudfrontListInvalidationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCloudfrontListInvalidationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCloudfrontListInvalidationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
