...
public record AwsEc2AuthorizeSecurityGroupEgressOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2AuthorizeSecurityGroupEgressOptions(
        string GroupId
    )
    {
    ...
    private AwsEc2AuthorizeSecurityGroupEgressOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2AuthorizeSecurityGroupEgressOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2AuthorizeSecurityGroupEgressOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
