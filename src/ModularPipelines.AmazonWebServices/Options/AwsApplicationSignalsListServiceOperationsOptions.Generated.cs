...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/application-signals/list-service-operations/index.html
...
[CliSubCommand("application-signals", "list-service-operations")]
public record AwsApplicationSignalsListServiceOperationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApplicationSignalsListServiceOperationsOptions(
        string StartTime,
        string EndTime,
    ...
    private AwsApplicationSignalsListServiceOperationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApplicationSignalsListServiceOperationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApplicationSignalsListServiceOperationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
