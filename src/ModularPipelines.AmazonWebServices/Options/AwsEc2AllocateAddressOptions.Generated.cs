...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/allocate-address/index.html
...
[CliSubCommand("ec2", "allocate-address")]
public record AwsEc2AllocateAddressOptions : AwsOptions
{
    /// <summary>
    /// The network (vpc ). Possible values: o vpc o standard
    /// </summary>
    [CliOption("--domain")]
    public AwsEc2AllocateAddressDomain? Domain { get; set; }
    ...
    /// <summary>
    /// A unique set of Availability Zones, Local Zones, or Wavelength Zones from which Amazon Web Services advertises IP addresses. Use this pa- rameter to limit the IP address to this location. IP addresses can- not move between network border groups.
    /// </summary>
