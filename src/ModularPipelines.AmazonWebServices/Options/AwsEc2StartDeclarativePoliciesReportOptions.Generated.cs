...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/start-declarative-policies-report/index.html
...
[CliSubCommand("ec2", "start-declarative-policies-report")]
public record AwsEc2StartDeclarativePoliciesReportOptions : AwsOptions, IValidatableObject
{
    ...
    /// Generates an account status report. The report is generated asynchro- nously, and can take several hours to complete. The report provides the current status of all attributes supported by declarative policies for the accounts within the specified scope. The scope is determined by the specified TargetId , which can represent an individual account, or all the accounts that fall under the specified organizational unit (OU) or root (the entire Amazon Web Services Orga- nization). The report is saved...
    /// </summary>
    /// <param name="S3Bucket">The name of the S3 bucket where the report will be saved. The bucket must be in the same Region where the report generation request is made.</param>
    /// <param name="TargetId">The root ID, organizational unit ID, or account ID. Format: o For root: r-ab12 o For OU: ou-ab12-cdef1234 o For account: 123456789012</param>
    public AwsEc2StartDeclarativePoliciesReportOptions(
        string S3Bucket,
        string TargetId
    )
    {
    ...
    private AwsEc2StartDeclarativePoliciesReportOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2StartDeclarativePoliciesReportOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2StartDeclarativePoliciesReportOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The root ID, organizational unit ID, or account ID. Format: o For root: r-ab12 o For OU: ou-ab12-cdef1234 o For account: 123456789012
    /// </summary>
    [CliOption("--target-id")]
