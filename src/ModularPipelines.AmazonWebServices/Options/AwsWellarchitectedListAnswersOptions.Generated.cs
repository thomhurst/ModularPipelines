...
public record AwsWellarchitectedListAnswersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedListAnswersOptions(
        string WorkloadId,
        string LensAlias
    )
    {
    ...
    private AwsWellarchitectedListAnswersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedListAnswersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedListAnswersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
