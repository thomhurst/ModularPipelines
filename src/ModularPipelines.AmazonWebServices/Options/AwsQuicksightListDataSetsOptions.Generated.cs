...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-data-sets/index.html
...
[CliSubCommand("quicksight", "list-data-sets")]
public record AwsQuicksightListDataSetsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListDataSetsOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListDataSetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListDataSetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListDataSetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
