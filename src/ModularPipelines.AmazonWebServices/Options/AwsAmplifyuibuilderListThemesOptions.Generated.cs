...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifyuibuilder/list-themes/index.html
...
[CliSubCommand("amplifyuibuilder", "list-themes")]
public record AwsAmplifyuibuilderListThemesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyuibuilderListThemesOptions(
        string AppId,
    ...
    private AwsAmplifyuibuilderListThemesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyuibuilderListThemesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyuibuilderListThemesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
