...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-regex-pattern-sets/index.html
...
[CliSubCommand("wafv2", "list-regex-pattern-sets")]
public record AwsWafv2ListRegexPatternSetsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2ListRegexPatternSetsOptions(
    ...
    private AwsWafv2ListRegexPatternSetsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2ListRegexPatternSetsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2ListRegexPatternSetsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2ListRegexPatternSetsScope? Scope { get; private init; }
