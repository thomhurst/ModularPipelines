...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53resolver/list-outpost-resolvers/index.html
...
[CliSubCommand("route53resolver", "list-outpost-resolvers")]
public record AwsRoute53resolverListOutpostResolversOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the Outpost. Constraints: o min: 1 o max: 255 o pattern: ^arn:aws([a-z-]+)?:outposts:[a-z\d-]+:\d{12}:out- post/op-[a-f0-9]{17}$
    /// </summary>
