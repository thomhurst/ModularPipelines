...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wickr/list-bots/index.html
...
public record AwsWickrListBotsOptions : AwsOptions
{
    ...
    public AwsWickrListBotsSortDirection? SortDirection { get; set; }

    /// <summary>
    /// Filter results to only include bots with display names matching this value. Constraints: o pattern: [\S\s]*
    /// </summary>
    [CliOption("--display-name")]
    public string? DisplayName { get; set; }

    /// <summary>
    /// Filter results to only include bots with usernames matching this value. Constraints: o pattern: [\S\s]*
    /// </summary>
    [CliOption("--username")]
    ...
    /// <summary>
    /// Filter results to only include bots belonging to this security group. Constraints: o pattern: [\S\s]*
    /// </summary>
    [CliOption("--group-id")]
