...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/delete-assistant/index.html
...
[CliSubCommand("qconnect", "delete-assistant")]
public record AwsQconnectDeleteAssistantOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectDeleteAssistantOptions(
        string AssistantId
    )
    {
    ...
    private AwsQconnectDeleteAssistantOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectDeleteAssistantOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectDeleteAssistantOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
