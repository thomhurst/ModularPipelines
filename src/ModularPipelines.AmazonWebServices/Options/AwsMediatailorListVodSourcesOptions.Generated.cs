...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediatailor/list-vod-sources/index.html
...
[CliSubCommand("mediatailor", "list-vod-sources")]
public record AwsMediatailorListVodSourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMediatailorListVodSourcesOptions(
    ...
    private AwsMediatailorListVodSourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediatailorListVodSourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediatailorListVodSourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
