...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/list-custom-detection-rule-org-configurations/index.html
...
[CliSubCommand("guardduty", "list-custom-detection-rule-org-configurations")]
public record AwsGuarddutyListCustomDetectionRuleOrgConfigurationsOptions : AwsOptions
{
    /// <summary>
    /// The configuration status to filter by. Possible values: o ACTIVE o PROCESSING o FAILED
    /// </summary>
    [CliOption("--status")]
    public AwsGuarddutyListCustomDetectionRuleOrgConfigurationsStatus? Status { get; set; }
