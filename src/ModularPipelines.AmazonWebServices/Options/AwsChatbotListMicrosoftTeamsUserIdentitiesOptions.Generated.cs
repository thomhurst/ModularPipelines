...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/list-microsoft-teams-user-identities/index.html
...
[CliSubCommand("chatbot", "list-microsoft-teams-user-identities")]
public record AwsChatbotListMicrosoftTeamsUserIdentitiesOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the MicrosoftTeamsChannelConfigu- ration associated with the user identities to list. Constraints: o min: 19 o max: 1169 o pattern: arn:aws:(wheatley|chat- bot):[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9_/.-]{0,63}:[A-Za-z0-9][A-Za-z0-9:_/+=,@.-]{0,1023}
    /// </summary>
