...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-subnet-cidr-reservations/index.html
...
[CliSubCommand("ec2", "get-subnet-cidr-reservations")]
public record AwsEc2GetSubnetCidrReservationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetSubnetCidrReservationsOptions(
        string SubnetId
    )
    {
    ...
    private AwsEc2GetSubnetCidrReservationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetSubnetCidrReservationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetSubnetCidrReservationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
