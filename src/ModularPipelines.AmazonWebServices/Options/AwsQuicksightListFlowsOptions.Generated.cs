...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-flows/index.html
...
[CliSubCommand("quicksight", "list-flows")]
public record AwsQuicksightListFlowsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists flows in an Amazon Web Services account. See also: AWS API Documentation list-flows is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: FlowSummaryList
    /// </summary>
    /// <param name="AwsAccountId">The ID of the Amazon Web Services account that contains the flow list that you are getting. Constraints: o min: 12 o max: 12 o pattern: [0-9]{12}</param>
    public AwsQuicksightListFlowsOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListFlowsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListFlowsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListFlowsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the Amazon Web Services account that contains the flow list that you are getting. Constraints: o min: 12 o max: 12 o pattern: [0-9]{12}
    /// </summary>
