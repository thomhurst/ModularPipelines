...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-clusters/index.html
...
[CliSubCommand("kafka", "list-clusters")]
public record AwsKafkaListClustersOptions : AwsOptions
{
    /// <summary>
    /// Specify a prefix of the name of the clusters that you want to list. The service lists all the clusters whose names start with this pre- fix.
    /// </summary>
