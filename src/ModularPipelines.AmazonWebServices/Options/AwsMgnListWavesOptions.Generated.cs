...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mgn/list-waves/index.html
...
[CliSubCommand("mgn", "list-waves")]
public record AwsMgnListWavesOptions : AwsOptions
{
    /// <summary>
    /// Waves list filters. waveIDs -&gt; (list) Filter waves list by wave ID. Constraints: o min: 0 o max: 200 (string) Constraints: o min: 22 o max: 22 o pattern: wave-[0-9a-zA-Z]{17} isArchived -&gt; (boolean) Filter waves list by archival status. Shorthand Syntax: waveIDs=string,string,isArchived=boolean JSON Syntax: { "waveIDs": ["string", ...], "isArchived": true|false }
    /// </summary>
    [CliOption("--filters")]
    public string? Filters { get; set; }

    /// <summary>
    /// Request account ID. Constraints: o min: 12 o max: 12 o pattern: .*[0-9]{12,}.*
    /// </summary>
