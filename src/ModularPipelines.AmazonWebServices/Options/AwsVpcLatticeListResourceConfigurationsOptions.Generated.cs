...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/vpc-lattice/list-resource-configurations/index.html
...
[CliSubCommand("vpc-lattice", "list-resource-configurations")]
public record AwsVpcLatticeListResourceConfigurationsOptions : AwsOptions
{
    /// <summary>
    /// The ID of the resource gateway for the resource configuration. Constraints: o min: 17 o max: 2048 o pattern: ((rgw-[0-9a-z]{17})|(arn:[a-z0-9\-]+:vpc-lat- tice:[a-zA-Z0-9\-]+:\d{12}:resourcegateway/rgw-[0-9a-z]{17}))
    /// </summary>
    [CliOption("--resource-gateway-identifier")]
    public string? ResourceGatewayIdentifier { get; set; }

    /// <summary>
    /// The ID of the resource configuration of type Group . Constraints: o min: 20 o max: 2048 o pattern: ((rcfg-[0-9a-z]{17})|(arn:[a-z0-9\-]+:vpc-lat- tice:[a-zA-Z0-9\-]+:\d{12}:resourceconfigura- tion/rcfg-[0-9a-z]{17}))
    /// </summary>
    [CliOption("--resource-configuration-group-identifier")]
    public string? ResourceConfigurationGroupIdentifier { get; set; }

    /// <summary>
    /// The domain verification ID. Constraints: o min: 20 o max: 2048 o pattern: ((dv-[0-9a-z]{17})|(arn:[a-z0-9\-]+:vpc-lat- tice:[a-zA-Z0-9\-]+:\d{12}:domainverification/dv-[a-fA-F0-9]{17}))
    /// </summary>
