...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-models/index.html
...
[CliSubCommand("apigatewayv2", "get-models")]
public record AwsApigatewayv2GetModelsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetModelsOptions(
        string ApiId
    )
    {
    ...
    private AwsApigatewayv2GetModelsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetModelsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetModelsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
