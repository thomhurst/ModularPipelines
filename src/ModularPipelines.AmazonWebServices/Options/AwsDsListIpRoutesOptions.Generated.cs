...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/list-ip-routes/index.html
...
[CliSubCommand("ds", "list-ip-routes")]
public record AwsDsListIpRoutesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists the address blocks that you have added to a directory. See also: AWS API Documentation list-ip-routes is a paginated operation. Multiple API calls may be is- sued in order to retrieve the entire data set of results. You can dis- able pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: IpRoutesInfo
    /// </summary>
    /// <param name="DirectoryId">Identifier (ID) of the directory for which you want to retrieve the IP addresses. Constraints: o pattern: ^d-[0-9a-f]{10}$</param>
    public AwsDsListIpRoutesOptions(
        string DirectoryId
    )
    {
    ...
    private AwsDsListIpRoutesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsListIpRoutesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsListIpRoutesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Identifier (ID) of the directory for which you want to retrieve the IP addresses. Constraints: o pattern: ^d-[0-9a-f]{10}$
    /// </summary>
