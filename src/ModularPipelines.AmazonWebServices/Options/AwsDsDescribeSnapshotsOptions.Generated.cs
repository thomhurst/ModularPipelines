...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/describe-snapshots/index.html
...
[CliSubCommand("ds", "describe-snapshots")]
public record AwsDsDescribeSnapshotsOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the directory for which to retrieve snapshot in- formation. Constraints: o pattern: ^d-[0-9a-f]{10}$
    /// </summary>
