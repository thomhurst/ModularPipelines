...
public record AwsMigrationhuborchestratorRetryWorkflowStepOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMigrationhuborchestratorRetryWorkflowStepOptions(
        string WorkflowId,
        string StepGroupId,
        string Id
    )
    ...
    private AwsMigrationhuborchestratorRetryWorkflowStepOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMigrationhuborchestratorRetryWorkflowStepOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMigrationhuborchestratorRetryWorkflowStepOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
