...
public record AwsSsoAdminListAccountAssignmentCreationStatusOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminListAccountAssignmentCreationStatusOptions(
        string InstanceArn
    )
    {
    ...
    private AwsSsoAdminListAccountAssignmentCreationStatusOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListAccountAssignmentCreationStatusOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListAccountAssignmentCreationStatusOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
