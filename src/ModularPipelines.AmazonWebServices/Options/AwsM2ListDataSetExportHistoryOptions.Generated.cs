...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/m2/list-data-set-export-history/index.html
...
[CliSubCommand("m2", "list-data-set-export-history")]
public record AwsM2ListDataSetExportHistoryOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsM2ListDataSetExportHistoryOptions(
    ...
    private AwsM2ListDataSetExportHistoryOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsM2ListDataSetExportHistoryOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsM2ListDataSetExportHistoryOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
