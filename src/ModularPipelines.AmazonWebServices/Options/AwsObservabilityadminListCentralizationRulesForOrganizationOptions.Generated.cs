...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/observabilityadmin/list-centralization-rules-for-organization/index.html
...
[CliSubCommand("observabilityadmin", "list-centralization-rules-for-organization")]
public record AwsObservabilityadminListCentralizationRulesForOrganizationOptions : AwsOptions
{
    /// <summary>
    /// A string to filter organization centralization rules whose names be- gin with the specified prefix. Constraints: o min: 1 o max: 100
    /// </summary>
