...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-coip-pool/index.html
...
[CliSubCommand("ec2", "create-coip-pool")]
public record AwsEc2CreateCoipPoolOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateCoipPoolOptions(
    ...
    private AwsEc2CreateCoipPoolOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateCoipPoolOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateCoipPoolOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
