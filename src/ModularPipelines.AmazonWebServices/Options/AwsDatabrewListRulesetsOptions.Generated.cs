...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/databrew/list-rulesets/index.html
...
[CliSubCommand("databrew", "list-rulesets")]
public record AwsDatabrewListRulesetsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of a resource (dataset). Using this parameter indicates to return only those rulesets that are associ- ated with the specified resource. Constraints: o min: 20 o max: 2048
    /// </summary>
