...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/location/list-geofences/index.html
...
[CliSubCommand("location", "list-geofences")]
public record AwsLocationListGeofencesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists geofences stored in a given geofence collection. See also: AWS API Documentation list-geofences is a paginated operation. Multiple API calls may be is- sued in order to retrieve the entire data set of results. You can dis- able pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: Entries
    /// </summary>
    /// <param name="CollectionName">The name of the geofence collection storing the list of geofences. Constraints: o min: 1 o max: 100 o pattern: [-._\w]+</param>
    public AwsLocationListGeofencesOptions(
    ...
    private AwsLocationListGeofencesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLocationListGeofencesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLocationListGeofencesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the geofence collection storing the list of geofences. Constraints: o min: 1 o max: 100 o pattern: [-._\w]+
    /// </summary>
