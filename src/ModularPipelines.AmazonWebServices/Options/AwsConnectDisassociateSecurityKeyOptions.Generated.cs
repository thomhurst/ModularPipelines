...
public record AwsConnectDisassociateSecurityKeyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectDisassociateSecurityKeyOptions(
        string InstanceId,
    ...
    private AwsConnectDisassociateSecurityKeyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectDisassociateSecurityKeyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectDisassociateSecurityKeyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
