...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-security-profiles/index.html
...
[CliSubCommand("iot", "list-security-profiles")]
public record AwsIotListSecurityProfilesOptions : AwsOptions
{
    /// <summary>
    /// A filter to limit results to the security profiles that use the de- fined dimension. Cannot be used with metricName Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
    [CliOption("--dimension-name")]
    public string? DimensionName { get; set; }

    /// <summary>
    /// The name of the custom metric. Cannot be used with dimensionName . Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
