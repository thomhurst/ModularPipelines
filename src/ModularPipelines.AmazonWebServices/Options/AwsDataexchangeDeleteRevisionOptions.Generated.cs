...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dataexchange/delete-revision/index.html
...
[CliSubCommand("dataexchange", "delete-revision")]
public record AwsDataexchangeDeleteRevisionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDataexchangeDeleteRevisionOptions(
        string DataSetId,
        string RevisionId
    )
    {
    ...
    private AwsDataexchangeDeleteRevisionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDataexchangeDeleteRevisionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDataexchangeDeleteRevisionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
