...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/list-attached-user-policies/index.html
...
[CliSubCommand("iam", "list-attached-user-policies")]
public record AwsIamListAttachedUserPoliciesOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsIamListAttachedUserPoliciesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamListAttachedUserPoliciesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamListAttachedUserPoliciesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
