...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-domains/index.html
...
[CliSubCommand("datazone", "list-domains")]
public record AwsDatazoneListDomainsOptions : AwsOptions
{
    /// <summary>
    /// The status of the data source. Possible values: o CREATING o AVAILABLE o CREATION_FAILED o DELETING o DELETED o DELETION_FAILED
    /// </summary>
    [CliOption("--status")]
    public AwsDatazoneListDomainsStatus? Status { get; set; }
