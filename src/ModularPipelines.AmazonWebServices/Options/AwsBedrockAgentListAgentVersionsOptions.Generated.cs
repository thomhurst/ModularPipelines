...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent/list-agent-versions/index.html
...
[CliSubCommand("bedrock-agent", "list-agent-versions")]
public record AwsBedrockAgentListAgentVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBedrockAgentListAgentVersionsOptions(
        string AgentId
    )
    {
    ...
    private AwsBedrockAgentListAgentVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentListAgentVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentListAgentVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
