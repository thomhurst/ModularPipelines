...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/describe-db-engine-versions/index.html
...
[CliSubCommand("docdb", "describe-db-engine-versions")]
public record AwsDocdbDescribeDbEngineVersionsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The name of a specific parameter group family to return details for. Constraints: o If provided, must match an existing DBParameterGroupFamily .
    /// </summary>
