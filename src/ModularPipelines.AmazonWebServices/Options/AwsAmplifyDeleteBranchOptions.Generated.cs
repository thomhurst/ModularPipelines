...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/delete-branch/index.html
...
[CliSubCommand("amplify", "delete-branch")]
public record AwsAmplifyDeleteBranchOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyDeleteBranchOptions(
        string AppId,
        string BranchName
    )
    {
    ...
    private AwsAmplifyDeleteBranchOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyDeleteBranchOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyDeleteBranchOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
