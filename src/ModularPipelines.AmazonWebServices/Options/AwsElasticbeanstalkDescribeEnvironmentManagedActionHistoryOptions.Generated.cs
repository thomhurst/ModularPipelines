...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elasticbeanstalk/describe-environment-managed-action-history/index.html
...
[CliSubCommand("elasticbeanstalk", "describe-environment-managed-action-history")]
public record AwsElasticbeanstalkDescribeEnvironmentManagedActionHistoryOptions : AwsOptions
{
    ...
    /// <summary>
    /// The name of the target environment. Constraints: o min: 4 o max: 40
    /// </summary>
