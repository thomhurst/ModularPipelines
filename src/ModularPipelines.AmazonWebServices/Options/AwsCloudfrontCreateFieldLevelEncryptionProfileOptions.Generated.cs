...
public record AwsCloudfrontCreateFieldLevelEncryptionProfileOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsCloudfrontCreateFieldLevelEncryptionProfileOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCloudfrontCreateFieldLevelEncryptionProfileOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCloudfrontCreateFieldLevelEncryptionProfileOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
