...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wickr/list-networks/index.html
...
[CliSubCommand("wickr", "list-networks")]
public record AwsWickrListNetworksOptions : AwsOptions
{
    /// <summary>
    /// The field to sort networks by. Accepted values are 'networkId' and 'networkName'. Default is 'networkId'. Constraints: o pattern: [\S\s]*
    /// </summary>
    ...
    public AwsWickrListNetworksSortDirection? SortDirection { get; set; }
