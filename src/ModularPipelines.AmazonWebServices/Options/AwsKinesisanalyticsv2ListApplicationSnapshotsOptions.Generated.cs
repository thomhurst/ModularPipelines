...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kinesisanalyticsv2/list-application-snapshots/index.html
...
[CliSubCommand("kinesisanalyticsv2", "list-application-snapshots")]
public record AwsKinesisanalyticsv2ListApplicationSnapshotsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsKinesisanalyticsv2ListApplicationSnapshotsOptions(
    ...
    private AwsKinesisanalyticsv2ListApplicationSnapshotsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKinesisanalyticsv2ListApplicationSnapshotsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKinesisanalyticsv2ListApplicationSnapshotsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
