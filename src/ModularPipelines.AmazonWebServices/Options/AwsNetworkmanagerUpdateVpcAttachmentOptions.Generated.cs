...
public record AwsNetworkmanagerUpdateVpcAttachmentOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerUpdateVpcAttachmentOptions(
        string AttachmentId
    )
    {
    ...
    private AwsNetworkmanagerUpdateVpcAttachmentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerUpdateVpcAttachmentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerUpdateVpcAttachmentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
