...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-capacity-manager-data-exports/index.html
...
[CliSubCommand("ec2", "describe-capacity-manager-data-exports")]
public record AwsEc2DescribeCapacityManagerDataExportsOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the data export configurations to describe. If not speci- fied, all export configurations are returned. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--capacity-manager-data-export-ids", GroupValues = true)]
    public IEnumerable<string>? CapacityManagerDataExportIds { get; set; }
