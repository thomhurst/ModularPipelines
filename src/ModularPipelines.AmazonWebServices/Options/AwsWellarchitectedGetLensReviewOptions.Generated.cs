...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/get-lens-review/index.html
...
[CliSubCommand("wellarchitected", "get-lens-review")]
public record AwsWellarchitectedGetLensReviewOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedGetLensReviewOptions(
        string WorkloadId,
        string LensAlias
    )
    {
    ...
    private AwsWellarchitectedGetLensReviewOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedGetLensReviewOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedGetLensReviewOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
