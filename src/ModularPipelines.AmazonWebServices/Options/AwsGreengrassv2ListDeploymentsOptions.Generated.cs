...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrassv2/list-deployments/index.html
...
[CliSubCommand("greengrassv2", "list-deployments")]
public record AwsGreengrassv2ListDeploymentsOptions : AwsOptions
{
    /// <summary>
    /// The ARN of the target IoT thing or thing group. Constraints: o pattern: arn:[^:]*:iot:[^:]*:[0-9]+:(thing|thinggroup)/.+
    /// </summary>
    [CliOption("--target-arn")]
    public string? TargetArn { get; set; }

    /// <summary>
    /// The filter for the list of deployments. Choose one of the following options: o ALL The list includes all deployments. o LATEST_ONLY The list includes only the latest revision of each deployment. Default: LATEST_ONLY Possible values: o ALL o LATEST_ONLY
    /// </summary>
    [CliOption("--history-filter")]
    public AwsGreengrassv2ListDeploymentsHistoryFilter? HistoryFilter { get; set; }
