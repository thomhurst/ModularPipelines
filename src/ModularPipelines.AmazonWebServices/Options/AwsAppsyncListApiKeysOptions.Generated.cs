...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-api-keys/index.html
...
[CliSubCommand("appsync", "list-api-keys")]
public record AwsAppsyncListApiKeysOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppsyncListApiKeysOptions(
        string ApiId
    )
    {
    ...
    private AwsAppsyncListApiKeysOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppsyncListApiKeysOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppsyncListApiKeysOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
