...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/describe-schemas/index.html
...
[CliSubCommand("dms", "describe-schemas")]
public record AwsDmsDescribeSchemasOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDmsDescribeSchemasOptions(
        string EndpointArn
    )
    {
    ...
    private AwsDmsDescribeSchemasOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDmsDescribeSchemasOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDmsDescribeSchemasOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
