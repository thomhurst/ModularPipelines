...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-base-path-mapping/index.html
...
[CliSubCommand("apigateway", "update-base-path-mapping")]
public record AwsApigatewayUpdateBasePathMappingOptions : AwsOptions, IValidatableObject
{
    ...
    /// Changes information about the BasePathMapping resource. See also: AWS API Documentation
    /// </summary>
    /// <param name="DomainName">The domain name of the BasePathMapping resource to change.</param>
    /// <param name="BasePath">The base path of the BasePathMapping resource to change. To specify an empty base path, set this parameter to '(none)' .</param>
    public AwsApigatewayUpdateBasePathMappingOptions(
        string DomainName,
        string BasePath
    )
    {
    ...
    private AwsApigatewayUpdateBasePathMappingOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateBasePathMappingOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateBasePathMappingOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
