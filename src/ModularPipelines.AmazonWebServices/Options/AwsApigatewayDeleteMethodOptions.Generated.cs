...
public record AwsApigatewayDeleteMethodOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayDeleteMethodOptions(
        string RestApiId,
        string ResourceId,
        string HttpMethod
    )
    ...
    private AwsApigatewayDeleteMethodOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayDeleteMethodOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayDeleteMethodOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
