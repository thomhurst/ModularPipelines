...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/outposts/get-outpost-instance-types/index.html
...
[CliSubCommand("outposts", "get-outpost-instance-types")]
public record AwsOutpostsGetOutpostInstanceTypesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsOutpostsGetOutpostInstanceTypesOptions(
        string OutpostId
    )
    {
    ...
    private AwsOutpostsGetOutpostInstanceTypesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsOutpostsGetOutpostInstanceTypesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsOutpostsGetOutpostInstanceTypesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
