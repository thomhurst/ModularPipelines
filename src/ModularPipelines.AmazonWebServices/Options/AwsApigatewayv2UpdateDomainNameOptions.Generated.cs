...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/update-domain-name/index.html
...
[CliSubCommand("apigatewayv2", "update-domain-name")]
public record AwsApigatewayv2UpdateDomainNameOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2UpdateDomainNameOptions(
        string DomainName
    )
    {
    ...
    private AwsApigatewayv2UpdateDomainNameOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2UpdateDomainNameOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2UpdateDomainNameOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--domain-name-configurations", GroupValues = true)]
    ...
    public AwsApigatewayv2UpdateDomainNameRoutingMode? RoutingMode { get; set; }
