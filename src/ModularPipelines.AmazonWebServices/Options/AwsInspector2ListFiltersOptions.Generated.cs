...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector2/list-filters/index.html
...
[CliSubCommand("inspector2", "list-filters")]
public record AwsInspector2ListFiltersOptions : AwsOptions
{
    ...
    /// <summary>
    /// The action the filter applies to matched findings. Possible values: o NONE o SUPPRESS
    /// </summary>
    [CliOption("--action")]
    public AwsInspector2ListFiltersAction? Action { get; set; }
