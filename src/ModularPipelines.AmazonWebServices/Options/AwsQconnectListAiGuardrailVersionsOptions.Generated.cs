...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-ai-guardrail-versions/index.html
...
[CliSubCommand("qconnect", "list-ai-guardrail-versions")]
public record AwsQconnectListAiGuardrailVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsQconnectListAiGuardrailVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListAiGuardrailVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListAiGuardrailVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
