...
public record AwsResiliencehubDescribeAppOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubDescribeAppOptions(
        string AppArn
    )
    {
    ...
    private AwsResiliencehubDescribeAppOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubDescribeAppOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubDescribeAppOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
