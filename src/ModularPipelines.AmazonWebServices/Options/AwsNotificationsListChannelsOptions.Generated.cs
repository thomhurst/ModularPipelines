...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/notifications/list-channels/index.html
...
[CliSubCommand("notifications", "list-channels")]
public record AwsNotificationsListChannelsOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsNotificationsListChannelsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNotificationsListChannelsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNotificationsListChannelsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
