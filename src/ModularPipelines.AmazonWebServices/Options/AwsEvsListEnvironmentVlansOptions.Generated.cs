...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/evs/list-environment-vlans/index.html
...
[CliSubCommand("evs", "list-environment-vlans")]
public record AwsEvsListEnvironmentVlansOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEvsListEnvironmentVlansOptions(
    ...
    private AwsEvsListEnvironmentVlansOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEvsListEnvironmentVlansOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEvsListEnvironmentVlansOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
