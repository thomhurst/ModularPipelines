...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-domain-configurations/index.html
...
[CliSubCommand("iot", "list-domain-configurations")]
public record AwsIotListDomainConfigurationsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The type of service delivered by the endpoint. Possible values: o DATA o CREDENTIAL_PROVIDER o JOBS
    /// </summary>
    [CliOption("--service-type")]
    public AwsIotListDomainConfigurationsServiceType? ServiceType { get; set; }
