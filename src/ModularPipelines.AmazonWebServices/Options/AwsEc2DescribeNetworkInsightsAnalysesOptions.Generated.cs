...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-network-insights-analyses/index.html
...
[CliSubCommand("ec2", "describe-network-insights-analyses")]
public record AwsEc2DescribeNetworkInsightsAnalysesOptions : AwsOptions
{
    /// <summary>
    /// The ID of the network insights analyses. You must specify either analysis IDs or a path ID. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--network-insights-analysis-ids", GroupValues = true)]
    public IEnumerable<string>? NetworkInsightsAnalysisIds { get; set; }
