...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deploy/register-application-revision/index.html
...
[CliSubCommand("deploy", "register-application-revision")]
public record AwsDeployRegisterApplicationRevisionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDeployRegisterApplicationRevisionOptions(
    ...
    private AwsDeployRegisterApplicationRevisionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeployRegisterApplicationRevisionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeployRegisterApplicationRevisionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
