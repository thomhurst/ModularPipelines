...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-client-certificate/index.html
...
[CliSubCommand("apigateway", "update-client-certificate")]
public record AwsApigatewayUpdateClientCertificateOptions : AwsOptions, IValidatableObject
{
    ...
    /// Changes information about an ClientCertificate resource. See also: AWS API Documentation
    /// </summary>
    /// <param name="ClientCertificateId">The identifier of the ClientCertificate resource to be updated.</param>
    public AwsApigatewayUpdateClientCertificateOptions(
    ...
    private AwsApigatewayUpdateClientCertificateOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateClientCertificateOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateClientCertificateOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
