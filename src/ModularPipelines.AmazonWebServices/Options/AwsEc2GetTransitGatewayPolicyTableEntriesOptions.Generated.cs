...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-transit-gateway-policy-table-entries/index.html
...
[CliSubCommand("ec2", "get-transit-gateway-policy-table-entries")]
public record AwsEc2GetTransitGatewayPolicyTableEntriesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetTransitGatewayPolicyTableEntriesOptions(
    ...
    private AwsEc2GetTransitGatewayPolicyTableEntriesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetTransitGatewayPolicyTableEntriesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetTransitGatewayPolicyTableEntriesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// One or more filters. The possible values are: o policy-rule-number - The rule number for the transit gateway pol- icy table entry. o target-route-table-id - The ID of the target route table. o policy-rule.source-ip - The source CIDR block for the policy rule. o policy-rule.destination-ip - The destination CIDR block for the policy rule. o policy-rule.source-port - The source port or port range for the policy rule. o policy-rule.destination-port - The destination port or port range for the policy rule. o policy-rule.protocol - The protocol for the policy rule. o policy-rule.meta-data.key - The metadata key for the policy rule. o policy-rule.meta-data.value - The metadata value for the policy rule. (structure) A filter name and value pair that is used to return a more spe- cific list of results from a describe operation. Filters can be used to match a set of resources by specific criteria, such as tags, attributes, or IDs. If you specify multiple filters, the filters are joined with an AND , and the request returns only results that match all of the specified filters. For more information, see List and filter using the CLI and API in the Amazon EC2 User Guide . Name -&gt; (string) The name of the filter. Filter names are case-sensitive. Values -&gt; (list) The filter values. Filter values are case-sensitive. If you specify multiple values for a filter, the values are joined with an OR , and the request returns all results that match any of the specified values. (string) Shorthand Syntax: Name=string,Values=string,string ... JSON Syntax: [ { "Name": "string", "Values": ["string", ...] } ... ]
    /// </summary>
