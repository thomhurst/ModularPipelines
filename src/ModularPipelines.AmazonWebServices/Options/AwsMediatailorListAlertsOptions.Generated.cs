...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediatailor/list-alerts/index.html
...
[CliSubCommand("mediatailor", "list-alerts")]
public record AwsMediatailorListAlertsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMediatailorListAlertsOptions(
        string ResourceArn
    )
    {
    ...
    private AwsMediatailorListAlertsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediatailorListAlertsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediatailorListAlertsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
