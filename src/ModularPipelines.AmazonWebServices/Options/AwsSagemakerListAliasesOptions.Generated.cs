...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-aliases/index.html
...
public record AwsSagemakerListAliasesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The version of the image. If image version is not specified, the aliases of all versions of the image are listed. Constraints: o min: 0
    /// </summary>
