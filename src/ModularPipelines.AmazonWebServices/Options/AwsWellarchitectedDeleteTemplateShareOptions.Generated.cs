...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/delete-template-share/index.html
...
[CliSubCommand("wellarchitected", "delete-template-share")]
public record AwsWellarchitectedDeleteTemplateShareOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedDeleteTemplateShareOptions(
        string ShareId,
        string TemplateArn
    )
    {
    ...
    private AwsWellarchitectedDeleteTemplateShareOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedDeleteTemplateShareOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedDeleteTemplateShareOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
