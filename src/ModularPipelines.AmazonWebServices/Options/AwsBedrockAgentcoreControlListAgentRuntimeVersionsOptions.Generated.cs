...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore-control/list-agent-runtime-versions/index.html
...
[CliSubCommand("bedrock-agentcore-control", "list-agent-runtime-versions")]
public record AwsBedrockAgentcoreControlListAgentRuntimeVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists all versions of a specific Amazon Secure Agent. See also: AWS API Documentation list-agent-runtime-versions is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: agentRuntimes
    /// </summary>
    /// <param name="AgentRuntimeId">The unique identifier of the AgentCore Runtime to list versions for. Constraints: o pattern: [a-zA-Z][a-zA-Z0-9_]{0,99}-[a-zA-Z0-9]{10}</param>
    public AwsBedrockAgentcoreControlListAgentRuntimeVersionsOptions(
    ...
    private AwsBedrockAgentcoreControlListAgentRuntimeVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentcoreControlListAgentRuntimeVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentcoreControlListAgentRuntimeVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique identifier of the AgentCore Runtime to list versions for. Constraints: o pattern: [a-zA-Z][a-zA-Z0-9_]{0,99}-[a-zA-Z0-9]{10}
    /// </summary>
