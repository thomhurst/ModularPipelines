...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-transit-gateway-route-table/index.html
...
[CliSubCommand("ec2", "create-transit-gateway-route-table")]
public record AwsEc2CreateTransitGatewayRouteTableOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateTransitGatewayRouteTableOptions(
    ...
    private AwsEc2CreateTransitGatewayRouteTableOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateTransitGatewayRouteTableOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateTransitGatewayRouteTableOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
