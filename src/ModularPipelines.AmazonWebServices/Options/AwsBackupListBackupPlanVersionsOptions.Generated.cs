...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/list-backup-plan-versions/index.html
...
[CliSubCommand("backup", "list-backup-plan-versions")]
public record AwsBackupListBackupPlanVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBackupListBackupPlanVersionsOptions(
        string BackupPlanId
    )
    {
    ...
    private AwsBackupListBackupPlanVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBackupListBackupPlanVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBackupListBackupPlanVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
