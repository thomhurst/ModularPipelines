...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qbusiness/list-indices/index.html
...
[CliSubCommand("qbusiness", "list-indices")]
public record AwsQbusinessListIndicesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQbusinessListIndicesOptions(
    ...
    private AwsQbusinessListIndicesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQbusinessListIndicesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQbusinessListIndicesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
