...
public record AwsEcrGetLifecyclePolicyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEcrGetLifecyclePolicyOptions(
    ...
    private AwsEcrGetLifecyclePolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEcrGetLifecyclePolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEcrGetLifecyclePolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
