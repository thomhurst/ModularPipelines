...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-contact-flow-module-versions/index.html
...
[CliSubCommand("connect", "list-contact-flow-module-versions")]
public record AwsConnectListContactFlowModuleVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListContactFlowModuleVersionsOptions(
        string InstanceId,
    ...
    private AwsConnectListContactFlowModuleVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListContactFlowModuleVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListContactFlowModuleVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
