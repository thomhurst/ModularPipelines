...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-user-profiles/index.html
...
[CliSubCommand("sagemaker", "list-user-profiles")]
public record AwsSagemakerListUserProfilesOptions : AwsOptions
{
    ...
    public AwsSagemakerListUserProfilesSortOrder? SortOrder { get; set; }

    /// <summary>
    /// The parameter by which to sort the results. The default is Creation- Time. Possible values: o CreationTime o LastModifiedTime
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListUserProfilesSortBy? SortBy { get; set; }

    /// <summary>
    /// A parameter by which to filter the results. Constraints: o min: 0 o max: 63 o pattern: d-(-*[a-z0-9]){1,61}
    /// </summary>
    [CliOption("--domain-id-equals")]
    public string? DomainIdEquals { get; set; }

    /// <summary>
    /// A parameter by which to filter the results. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
