...
public record AwsStoragegatewayDescribeTapesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsStoragegatewayDescribeTapesOptions(
        string GatewayArn
    )
    {
    ...
    private AwsStoragegatewayDescribeTapesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsStoragegatewayDescribeTapesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsStoragegatewayDescribeTapesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
