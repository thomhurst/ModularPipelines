...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/budgets/describe-budget-actions-for-account/index.html
...
[CliSubCommand("budgets", "describe-budget-actions-for-account")]
public record AwsBudgetsDescribeBudgetActionsForAccountOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBudgetsDescribeBudgetActionsForAccountOptions(
        string AccountId
    )
    {
    ...
    private AwsBudgetsDescribeBudgetActionsForAccountOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBudgetsDescribeBudgetActionsForAccountOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBudgetsDescribeBudgetActionsForAccountOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
