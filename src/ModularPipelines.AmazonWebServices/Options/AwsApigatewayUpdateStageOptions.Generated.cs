...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-stage/index.html
...
[CliSubCommand("apigateway", "update-stage")]
public record AwsApigatewayUpdateStageOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="StageName">The name of the Stage resource to change information about.</param>
    public AwsApigatewayUpdateStageOptions(
        string RestApiId,
        string StageName
    )
    {
    ...
    private AwsApigatewayUpdateStageOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateStageOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateStageOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
