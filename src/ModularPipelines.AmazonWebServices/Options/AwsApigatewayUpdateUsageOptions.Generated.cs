...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-usage/index.html
...
[CliSubCommand("apigateway", "update-usage")]
public record AwsApigatewayUpdateUsageOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayUpdateUsageOptions(
        string UsagePlanId,
        string KeyId
    )
    {
    ...
    private AwsApigatewayUpdateUsageOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateUsageOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateUsageOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
