...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qbusiness/list-plugins/index.html
...
[CliSubCommand("qbusiness", "list-plugins")]
public record AwsQbusinessListPluginsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQbusinessListPluginsOptions(
    ...
    private AwsQbusinessListPluginsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQbusinessListPluginsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQbusinessListPluginsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
