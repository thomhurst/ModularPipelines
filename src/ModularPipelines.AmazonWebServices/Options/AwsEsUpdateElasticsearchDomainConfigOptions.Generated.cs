...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/es/update-elasticsearch-domain-config/index.html
...
public record AwsEsUpdateElasticsearchDomainConfigOptions : AwsOptions
{
    ...
    /// <summary>
    /// Modifies the advanced option to allow references to indices in an HTTP request body. Must be false when configuring access to individ- ual sub-resources. By default, the value is true . See Configuration Advanced Options for more information. key -&gt; (string) value -&gt; (string) Shorthand Syntax: KeyName1=string,KeyName2=string JSON Syntax: {"string": "string" ...}
    /// </summary>
    ...
    /// </summary>
    [CliOption("--use-case")]
    public AwsEsUpdateElasticsearchDomainConfigUseCase? UseCase { get; set; }
    ...
    public AwsEsUpdateElasticsearchDomainConfigEngineMode? EngineMode { get; set; }
