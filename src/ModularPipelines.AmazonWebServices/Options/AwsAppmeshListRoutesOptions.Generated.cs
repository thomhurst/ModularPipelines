...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appmesh/list-routes/index.html
...
[CliSubCommand("appmesh", "list-routes")]
public record AwsAppmeshListRoutesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a list of existing routes in a service mesh. See also: AWS API Documentation list-routes is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: routes
    /// </summary>
    /// <param name="MeshName">The name of the service mesh to list routes in. Constraints: o min: 1 o max: 255</param>
    /// <param name="VirtualRouterName">The name of the virtual router to list routes in. Constraints: o min: 1 o max: 255</param>
    public AwsAppmeshListRoutesOptions(
        string MeshName,
    ...
    private AwsAppmeshListRoutesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppmeshListRoutesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppmeshListRoutesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the service mesh to list routes in. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--mesh-name")]
    public string? MeshName { get; private init; }

    /// <summary>
    /// The name of the virtual router to list routes in. Constraints: o min: 1 o max: 255
    /// </summary>
