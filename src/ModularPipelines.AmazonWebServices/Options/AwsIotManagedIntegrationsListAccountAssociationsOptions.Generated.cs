...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/list-account-associations/index.html
...
[CliSubCommand("iot-managed-integrations", "list-account-associations")]
public record AwsIotManagedIntegrationsListAccountAssociationsOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the connector destination to filter account asso- ciations by. Constraints: o min: 1 o max: 64 o pattern: [A-Za-z0-9-_]+
    /// </summary>
