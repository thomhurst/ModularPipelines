...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotsitewise/list-tasks/index.html
...
[CliSubCommand("iotsitewise", "list-tasks")]
public record AwsIotsitewiseListTasksOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsIotsitewiseListTasksOptions(
    ...
    private AwsIotsitewiseListTasksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIotsitewiseListTasksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIotsitewiseListTasksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
