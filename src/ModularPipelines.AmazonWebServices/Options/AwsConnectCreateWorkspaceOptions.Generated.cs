...
public record AwsConnectCreateWorkspaceOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Name">The name of the workspace. Must be unique within the instance and can contain 1-127 characters. Constraints: o min: 1 o max: 127 o pattern: .*\\S.*</param>
    public AwsConnectCreateWorkspaceOptions(
        string InstanceId,
        string Name
    )
    {
    ...
    private AwsConnectCreateWorkspaceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectCreateWorkspaceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectCreateWorkspaceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the workspace. Must be unique within the instance and can contain 1-127 characters. Constraints: o min: 1 o max: 127 o pattern: .*\\S.*
    /// </summary>
    [CliOption("--name")]
