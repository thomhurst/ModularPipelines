...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/search-contacts/index.html
...
public record AwsConnectSearchContactsOptions : AwsOptions, IValidatableObject
{
    ...
    /// <summary>
    /// Specifies a field to sort by and a sort order. FieldName -&gt; (string) [required] The name of the field on which to sort. Possible values: o INITIATION_TIMESTAMP o SCHEDULED_TIMESTAMP o CONNECTED_TO_AGENT_TIMESTAMP o DISCONNECT_TIMESTAMP o INITIATION_METHOD o CHANNEL o EXPIRY_TIMESTAMP Order -&gt; (string) [required] An ascending or descending sort. Possible values: o ASCENDING o DESCENDING Shorthand Syntax: FieldName=string,Order=string JSON Syntax: { "FieldName": "INITIATION_TIMESTAMP"|"SCHEDULED_TIMESTAMP"|"CONNECTED_TO_AGENT_TIMESTAMP"|"DISCONNECT_TIMESTAMP"|"INITIATION_METHOD"|"CHANNEL"|"EXPIRY_TIMESTAMP", "Order": "ASCENDING"|"DESCENDING" }
    /// </summary>
    [CliOption("--sort")]
