...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-evaluation-form-versions/index.html
...
[CliSubCommand("connect", "list-evaluation-form-versions")]
public record AwsConnectListEvaluationFormVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListEvaluationFormVersionsOptions(
        string InstanceId,
    ...
    private AwsConnectListEvaluationFormVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListEvaluationFormVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListEvaluationFormVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
