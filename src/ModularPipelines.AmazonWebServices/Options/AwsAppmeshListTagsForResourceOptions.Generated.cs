...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appmesh/list-tags-for-resource/index.html
...
[CliSubCommand("appmesh", "list-tags-for-resource")]
public record AwsAppmeshListTagsForResourceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppmeshListTagsForResourceOptions(
        string ResourceArn
    )
    {
    ...
    private AwsAppmeshListTagsForResourceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppmeshListTagsForResourceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppmeshListTagsForResourceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
