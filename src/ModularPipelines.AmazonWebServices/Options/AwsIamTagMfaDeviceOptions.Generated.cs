...
public record AwsIamTagMfaDeviceOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsIamTagMfaDeviceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamTagMfaDeviceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamTagMfaDeviceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
