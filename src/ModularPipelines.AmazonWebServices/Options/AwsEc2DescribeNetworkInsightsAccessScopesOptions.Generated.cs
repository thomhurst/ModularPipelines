...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-network-insights-access-scopes/index.html
...
[CliSubCommand("ec2", "describe-network-insights-access-scopes")]
public record AwsEc2DescribeNetworkInsightsAccessScopesOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the Network Access Scopes. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--network-insights-access-scope-ids", GroupValues = true)]
    public IEnumerable<string>? NetworkInsightsAccessScopeIds { get; set; }
