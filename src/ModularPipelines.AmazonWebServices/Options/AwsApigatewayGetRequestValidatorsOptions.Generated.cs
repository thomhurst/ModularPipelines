...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-request-validators/index.html
...
[CliSubCommand("apigateway", "get-request-validators")]
public record AwsApigatewayGetRequestValidatorsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayGetRequestValidatorsOptions(
        string RestApiId
    )
    {
    ...
    private AwsApigatewayGetRequestValidatorsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayGetRequestValidatorsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayGetRequestValidatorsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
