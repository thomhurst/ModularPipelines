...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ecr/describe-pull-through-cache-rules/index.html
...
[CliSubCommand("ecr", "describe-pull-through-cache-rules")]
public record AwsEcrDescribePullThroughCacheRulesOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Web Services account ID associated with the registry to return the pull through cache rules for. If you do not specify a registry, the default registry is assumed. Constraints: o pattern: [0-9]{12}
    /// </summary>
