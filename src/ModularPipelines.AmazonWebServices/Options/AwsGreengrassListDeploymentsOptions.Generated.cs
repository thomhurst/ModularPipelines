...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-deployments/index.html
...
[CliSubCommand("greengrass", "list-deployments")]
public record AwsGreengrassListDeploymentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListDeploymentsOptions(
        string GroupId
    )
    {
    ...
    private AwsGreengrassListDeploymentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListDeploymentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListDeploymentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
