...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/arc-zonal-shift/list-autoshifts/index.html
...
[CliSubCommand("arc-zonal-shift", "list-autoshifts")]
public record AwsArcZonalShiftListAutoshiftsOptions : AwsOptions
{
    /// <summary>
    /// The status of the autoshift. Possible values: o ACTIVE o COMPLETED
    /// </summary>
    [CliOption("--status")]
    public AwsArcZonalShiftListAutoshiftsStatus? Status { get; set; }
