...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent/list-flow-versions/index.html
...
[CliSubCommand("bedrock-agent", "list-flow-versions")]
public record AwsBedrockAgentListFlowVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBedrockAgentListFlowVersionsOptions(
    ...
    private AwsBedrockAgentListFlowVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentListFlowVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentListFlowVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
