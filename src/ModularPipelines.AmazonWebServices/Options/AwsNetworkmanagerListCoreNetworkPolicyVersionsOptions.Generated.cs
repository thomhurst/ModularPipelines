...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/list-core-network-policy-versions/index.html
...
[CliSubCommand("networkmanager", "list-core-network-policy-versions")]
public record AwsNetworkmanagerListCoreNetworkPolicyVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerListCoreNetworkPolicyVersionsOptions(
    ...
    private AwsNetworkmanagerListCoreNetworkPolicyVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerListCoreNetworkPolicyVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerListCoreNetworkPolicyVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
