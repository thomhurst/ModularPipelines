...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/supplychain/list-data-integration-flows/index.html
...
[CliSubCommand("supplychain", "list-data-integration-flows")]
public record AwsSupplychainListDataIntegrationFlowsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSupplychainListDataIntegrationFlowsOptions(
        string InstanceId
    )
    {
    ...
    private AwsSupplychainListDataIntegrationFlowsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSupplychainListDataIntegrationFlowsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSupplychainListDataIntegrationFlowsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
