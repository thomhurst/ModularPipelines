...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/start-dependency-insights/index.html
...
[CliSubCommand("resiliencehubv2", "start-dependency-insights")]
public record AwsResiliencehubv2StartDependencyInsightsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2StartDependencyInsightsOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2StartDependencyInsightsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2StartDependencyInsightsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2StartDependencyInsightsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
