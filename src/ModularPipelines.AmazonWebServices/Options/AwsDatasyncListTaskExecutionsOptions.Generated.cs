...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datasync/list-task-executions/index.html
...
[CliSubCommand("datasync", "list-task-executions")]
public record AwsDatasyncListTaskExecutionsOptions : AwsOptions
{
    /// <summary>
    /// Specifies the Amazon Resource Name (ARN) of the task that you want execution information about. Constraints: o max: 128 o pattern: ^arn:(aws|aws-cn|aws-us-gov|aws-eusc|aws-iso|aws-iso-b):data- sync:[a-z\-0-9]+:[0-9]{12}:task/task-[0-9a-f]{17}$
    /// </summary>
    [CliOption("--task-arn")]
