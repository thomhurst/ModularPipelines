...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/describe-permission-set/index.html
...
[CliSubCommand("sso-admin", "describe-permission-set")]
public record AwsSsoAdminDescribePermissionSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminDescribePermissionSetOptions(
        string InstanceArn,
    ...
    private AwsSsoAdminDescribePermissionSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminDescribePermissionSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminDescribePermissionSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
