...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/polly/list-speech-synthesis-tasks/index.html
...
[CliSubCommand("polly", "list-speech-synthesis-tasks")]
public record AwsPollyListSpeechSynthesisTasksOptions : AwsOptions
{
    /// <summary>
    /// Status of the speech synthesis tasks returned in a List operation Possible values: o scheduled o inProgress o completed o failed
    /// </summary>
    [CliOption("--status")]
    public AwsPollyListSpeechSynthesisTasksStatus? Status { get; set; }
