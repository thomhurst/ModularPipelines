...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mediatailor/create-source-location/index.html
...
public record AwsMediatailorCreateSourceLocationOptions : AwsOptions
{
    ...
    /// <summary>
    /// The optional configuration for the server that serves segments. BaseUrl -&gt; (string) The hostname of the server that will be used to serve segments. This string must include the protocol, such as https:// . Shorthand Syntax: BaseUrl=string JSON Syntax: { "BaseUrl": "string" }
    /// </summary>
