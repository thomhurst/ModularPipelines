...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-quick-responses/index.html
...
[CliSubCommand("qconnect", "list-quick-responses")]
public record AwsQconnectListQuickResponsesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListQuickResponsesOptions(
    ...
    private AwsQconnectListQuickResponsesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListQuickResponsesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListQuickResponsesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
