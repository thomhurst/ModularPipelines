...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/describe-db-cluster-parameters/index.html
...
[CliSubCommand("docdb", "describe-db-cluster-parameters")]
public record AwsDocdbDescribeDbClusterParametersOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns the detailed parameter list for a particular cluster parameter group. See also: AWS API Documentation describe-db-cluster-parameters is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: Paramete...
    /// </summary>
    /// <param name="DbClusterParameterGroupName">The name of a specific cluster parameter group to return parameter details for. Constraints: o If provided, must match the name of an existing DBClusterParame- terGroup .</param>
    public AwsDocdbDescribeDbClusterParametersOptions(
    ...
    private AwsDocdbDescribeDbClusterParametersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDocdbDescribeDbClusterParametersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDocdbDescribeDbClusterParametersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of a specific cluster parameter group to return parameter details for. Constraints: o If provided, must match the name of an existing DBClusterParame- terGroup .
    /// </summary>
