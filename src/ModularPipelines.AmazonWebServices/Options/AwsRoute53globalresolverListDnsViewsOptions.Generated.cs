...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53globalresolver/list-dns-views/index.html
...
[CliSubCommand("route53globalresolver", "list-dns-views")]
public record AwsRoute53globalresolverListDnsViewsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists all DNS views for a Route 53 Global Resolver with pagination sup- port. WARNING: Route 53 Global Resolver is a global service that supports resolvers in multiple Amazon Web Services Regions but you must specify the US East (Ohio) Region to create, update, or otherwise work with Route 53 Global Resolver resources. That is, for example, specify --region us-east-2 on Amazon Web Services CLI commands. See also: AWS API Documentation list-dns-views is a paginated operation. Multiple API calls m...
    /// </summary>
    /// <param name="GlobalResolverId">The Global Resolver ID. Constraints: o min: 1 o max: 64 o pattern: [-.a-zA-Z0-9]+</param>
    public AwsRoute53globalresolverListDnsViewsOptions(
    ...
    private AwsRoute53globalresolverListDnsViewsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRoute53globalresolverListDnsViewsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRoute53globalresolverListDnsViewsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Global Resolver ID. Constraints: o min: 1 o max: 64 o pattern: [-.a-zA-Z0-9]+
    /// </summary>
