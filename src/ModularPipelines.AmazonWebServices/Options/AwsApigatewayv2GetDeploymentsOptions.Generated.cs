...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/get-deployments/index.html
...
[CliSubCommand("apigatewayv2", "get-deployments")]
public record AwsApigatewayv2GetDeploymentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2GetDeploymentsOptions(
        string ApiId
    )
    {
    ...
    private AwsApigatewayv2GetDeploymentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2GetDeploymentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2GetDeploymentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
