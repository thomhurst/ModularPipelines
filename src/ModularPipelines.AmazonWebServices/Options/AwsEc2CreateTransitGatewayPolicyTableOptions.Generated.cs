...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-transit-gateway-policy-table/index.html
...
[CliSubCommand("ec2", "create-transit-gateway-policy-table")]
public record AwsEc2CreateTransitGatewayPolicyTableOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a transit gateway policy table. See also: AWS API Documentation
    /// </summary>
    /// <param name="TransitGatewayId">The ID of the transit gateway used for the policy table.</param>
    public AwsEc2CreateTransitGatewayPolicyTableOptions(
    ...
    private AwsEc2CreateTransitGatewayPolicyTableOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateTransitGatewayPolicyTableOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateTransitGatewayPolicyTableOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
