...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecatalyst/list-dev-environments/index.html
...
[CliSubCommand("codecatalyst", "list-dev-environments")]
public record AwsCodecatalystListDevEnvironmentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCodecatalystListDevEnvironmentsOptions(
        string SpaceName
    )
    {
    ...
    private AwsCodecatalystListDevEnvironmentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodecatalystListDevEnvironmentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodecatalystListDevEnvironmentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
