...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-dhcp-options/index.html
...
[CliSubCommand("ec2", "create-dhcp-options")]
public record AwsEc2CreateDhcpOptionsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Creates a custom set of DHCP options. After you create a DHCP option set, you associate it with a VPC. After you associate a DHCP option set with a VPC, all existing and newly launched instances in the VPC use this set of DHCP options. The following are the individual DHCP options you can specify. For more information, see DHCP option sets in the Amazon VPC User Guide . o domain-name - If you're using AmazonProvidedDNS in us-east-1 , spec- ify ec2.internal . If you're using AmazonProvidedDNS in ...
    /// </summary>
    /// <param name="DhcpConfigurations">A DHCP configuration option. (structure) Describes a DHCP configuration option. Key -&gt; (string) The name of a DHCP option. Values -&gt; (list) The values for the DHCP option. (string) Shorthand Syntax: Key=string,Values=string,string ... JSON Syntax: [ { "Key": "string", "Values": ["string", ...] } ... ]</param>
    public AwsEc2CreateDhcpOptionsOptions(
        IEnumerable<string> DhcpConfigurations
    )
    {
        {
            global::System.ArgumentNullException.ThrowIfNull(DhcpConfigurations);
            var materialized = global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(DhcpConfigurations));
            if (!global::System.Linq.Enumerable.Any(global::System.Linq.Enumerable.Cast<object>(materialized), static value => value is not null))
            {
                throw new global::System.ArgumentException(
                    "Required collection must contain at least one value.",
                    nameof(DhcpConfigurations));
            }

            DhcpConfigurations = materialized;
        }
        this.DhcpConfigurations = DhcpConfigurations;
    }

    private AwsEc2CreateDhcpOptionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateDhcpOptionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateDhcpOptionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
