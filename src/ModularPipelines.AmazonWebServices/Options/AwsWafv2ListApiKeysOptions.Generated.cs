...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-api-keys/index.html
...
[CliSubCommand("wafv2", "list-api-keys")]
public record AwsWafv2ListApiKeysOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2ListApiKeysOptions(
        AwsWafv2ListApiKeysScope Scope
    )
    {
        this.Scope = Scope;
    }

    private AwsWafv2ListApiKeysOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2ListApiKeysOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2ListApiKeysOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2ListApiKeysScope? Scope { get; private init; }
