...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/list-scheduled-actions/index.html
...
[CliSubCommand("redshift-serverless", "list-scheduled-actions")]
public record AwsRedshiftServerlessListScheduledActionsOptions : AwsOptions
{
    /// <summary>
    /// The name of namespace associated with the scheduled action to re- trieve. Constraints: o min: 3 o max: 64 o pattern: ^[a-z0-9-]+$
    /// </summary>
