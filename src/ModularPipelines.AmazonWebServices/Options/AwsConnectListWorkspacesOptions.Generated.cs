...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-workspaces/index.html
...
[CliSubCommand("connect", "list-workspaces")]
public record AwsConnectListWorkspacesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListWorkspacesOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListWorkspacesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListWorkspacesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListWorkspacesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
