...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/update-in-app-template/index.html
...
public record AwsPinpointUpdateInAppTemplateOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPinpointUpdateInAppTemplateOptions(
    ...
    private AwsPinpointUpdateInAppTemplateOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPinpointUpdateInAppTemplateOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPinpointUpdateInAppTemplateOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
