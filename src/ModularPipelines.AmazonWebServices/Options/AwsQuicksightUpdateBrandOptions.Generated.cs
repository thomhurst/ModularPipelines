...
public record AwsQuicksightUpdateBrandOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightUpdateBrandOptions(
        string AwsAccountId,
        string BrandId
    )
    {
    ...
    private AwsQuicksightUpdateBrandOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightUpdateBrandOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightUpdateBrandOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
