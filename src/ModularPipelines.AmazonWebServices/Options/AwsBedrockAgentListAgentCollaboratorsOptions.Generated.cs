...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agent/list-agent-collaborators/index.html
...
[CliSubCommand("bedrock-agent", "list-agent-collaborators")]
public record AwsBedrockAgentListAgentCollaboratorsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBedrockAgentListAgentCollaboratorsOptions(
        string AgentId,
        string AgentVersion
    )
    {
    ...
    private AwsBedrockAgentListAgentCollaboratorsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentListAgentCollaboratorsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentListAgentCollaboratorsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
