...
public record AwsSesv2UpdateEmailIdentityPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSesv2UpdateEmailIdentityPolicyOptions(
    ...
    private AwsSesv2UpdateEmailIdentityPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSesv2UpdateEmailIdentityPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSesv2UpdateEmailIdentityPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
