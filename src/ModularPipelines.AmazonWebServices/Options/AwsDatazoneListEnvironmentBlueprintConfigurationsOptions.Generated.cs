...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/datazone/list-environment-blueprint-configurations/index.html
...
[CliSubCommand("datazone", "list-environment-blueprint-configurations")]
public record AwsDatazoneListEnvironmentBlueprintConfigurationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDatazoneListEnvironmentBlueprintConfigurationsOptions(
    ...
    private AwsDatazoneListEnvironmentBlueprintConfigurationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDatazoneListEnvironmentBlueprintConfigurationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDatazoneListEnvironmentBlueprintConfigurationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
