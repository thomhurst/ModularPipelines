...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-monitoring-alerts/index.html
...
[CliSubCommand("sagemaker", "list-monitoring-alerts")]
public record AwsSagemakerListMonitoringAlertsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSagemakerListMonitoringAlertsOptions(
    ...
    private AwsSagemakerListMonitoringAlertsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSagemakerListMonitoringAlertsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSagemakerListMonitoringAlertsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
