...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3vectors/put-vector-bucket-policy/index.html
...
public record AwsS3vectorsPutVectorBucketPolicyOptions : AwsOptions
{
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the vector bucket. Constraints: o pattern: arn:aws[-a-z0-9]*:s3vec- tors:[a-z0-9-]+:[0-9]{12}:bucket/[a-z0-9][a-z0-9-.]{1,61}[a-z0-9]
    /// </summary>
