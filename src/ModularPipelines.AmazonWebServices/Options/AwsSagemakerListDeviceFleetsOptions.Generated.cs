...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-device-fleets/index.html
...
[CliSubCommand("sagemaker", "list-device-fleets")]
public record AwsSagemakerListDeviceFleetsOptions : AwsOptions
{
    ...
    /// <summary>
    /// Filter fleets where the edge packaging job was created before speci- fied time.
    /// </summary>
    ...
    /// <summary>
    /// Filter for fleets containing this name in their fleet device name. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9\-]+
    /// </summary>
    [CliOption("--name-contains")]
    public string? NameContains { get; set; }

    /// <summary>
    /// The column to sort by. Possible values: o NAME o CREATION_TIME o LAST_MODIFIED_TIME
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListDeviceFleetsSortBy? SortBy { get; set; }

    /// <summary>
    /// What direction to sort in. Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListDeviceFleetsSortOrder? SortOrder { get; set; }
