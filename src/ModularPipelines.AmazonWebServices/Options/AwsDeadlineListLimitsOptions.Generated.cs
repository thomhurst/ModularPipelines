...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-limits/index.html
...
[CliSubCommand("deadline", "list-limits")]
public record AwsDeadlineListLimitsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Gets a list of limits defined in the specified farm. See also: AWS API Documentation list-limits is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: limits
    /// </summary>
    /// <param name="FarmId">The unique identifier of the farm that contains the limits. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    public AwsDeadlineListLimitsOptions(
        string FarmId
    )
    {
    ...
    private AwsDeadlineListLimitsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListLimitsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListLimitsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique identifier of the farm that contains the limits. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
