...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-transit-gateway-policy-tables/index.html
...
[CliSubCommand("ec2", "describe-transit-gateway-policy-tables")]
public record AwsEc2DescribeTransitGatewayPolicyTablesOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the transit gateway policy tables. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--transit-gateway-policy-table-ids", GroupValues = true)]
    public IEnumerable<string>? TransitGatewayPolicyTableIds { get; set; }
