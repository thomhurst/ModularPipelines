...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mq/describe-shared-resources/index.html
...
[CliSubCommand("mq", "describe-shared-resources")]
public record AwsMqDescribeSharedResourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMqDescribeSharedResourcesOptions(
        string BrokerId
    )
    {
    ...
    private AwsMqDescribeSharedResourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMqDescribeSharedResourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMqDescribeSharedResourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
