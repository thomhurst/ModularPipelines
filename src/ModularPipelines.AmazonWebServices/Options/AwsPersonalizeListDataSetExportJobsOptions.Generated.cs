...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-dataset-export-jobs/index.html
...
[CliSubCommand("personalize", "list-dataset-export-jobs")]
public record AwsPersonalizeListDataSetExportJobsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the dataset to list the dataset export jobs for. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
