...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-endpoints/index.html
...
[CliSubCommand("sagemaker", "list-endpoints")]
public record AwsSagemakerListEndpointsOptions : AwsOptions
{
    /// <summary>
    /// Sorts the list of results. The default is CreationTime . Possible values: o Name o CreationTime o Status
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListEndpointsSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order for results. The default is Descending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListEndpointsSortOrder? SortOrder { get; set; }

    /// <summary>
    /// A string in endpoint names. This filter returns only endpoints whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9-]+
    /// </summary>
    ...
    /// <summary>
    /// A filter that returns only endpoints with the specified status. Possible values: o OutOfService o Creating o Updating o SystemUpdating o RollingBack o InService o Deleting o Failed o UpdateRollbackFailed
    /// </summary>
    [CliOption("--status-equals")]
    public AwsSagemakerListEndpointsStatusEquals? StatusEquals { get; set; }
