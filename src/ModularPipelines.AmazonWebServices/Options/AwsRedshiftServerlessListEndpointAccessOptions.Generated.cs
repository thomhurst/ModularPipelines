...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/list-endpoint-access/index.html
...
[CliSubCommand("redshift-serverless", "list-endpoint-access")]
public record AwsRedshiftServerlessListEndpointAccessOptions : AwsOptions
{
    ...
    /// <summary>
    /// The name of the workgroup associated with the VPC endpoint to re- turn.
    /// </summary>
