...
public record AwsMediapackagev2GetChannelOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMediapackagev2GetChannelOptions(
    ...
    private AwsMediapackagev2GetChannelOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMediapackagev2GetChannelOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMediapackagev2GetChannelOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
