...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-placement-group/index.html
...
public record AwsEc2CreatePlacementGroupOptions : AwsOptions
{
    ...
    /// <summary>
    /// The placement strategy. Possible values: o cluster o spread o partition o precision-time
    /// </summary>
    [CliOption("--strategy")]
    public AwsEc2CreatePlacementGroupStrategy? Strategy { get; set; }
