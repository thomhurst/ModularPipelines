...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/migrationhuborchestrator/list-templates/index.html
...
[CliSubCommand("migrationhuborchestrator", "list-templates")]
public record AwsMigrationhuborchestratorListTemplatesOptions : AwsOptions
{
    /// <summary>
    /// The name of the template. Constraints: o min: 1 o max: 100 o pattern: [-a-zA-Z0-9_.+]+[-a-zA-Z0-9_.+ ]*
    /// </summary>
    [CliOption("--name")]
