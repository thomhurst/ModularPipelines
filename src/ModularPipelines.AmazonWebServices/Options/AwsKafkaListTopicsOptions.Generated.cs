...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-topics/index.html
...
[CliSubCommand("kafka", "list-topics")]
public record AwsKafkaListTopicsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsKafkaListTopicsOptions(
        string ClusterArn
    )
    {
    ...
    private AwsKafkaListTopicsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKafkaListTopicsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKafkaListTopicsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
