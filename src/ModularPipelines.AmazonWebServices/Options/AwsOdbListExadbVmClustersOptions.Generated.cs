...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/odb/list-exadb-vm-clusters/index.html
...
[CliSubCommand("odb", "list-exadb-vm-clusters")]
public record AwsOdbListExadbVmClustersOptions : AwsOptions
{
    /// <summary>
    /// The unique identifier of the Exascale storage vault to list the as- sociated Exascale VM clusters. Constraints: o min: 6 o max: 2048 o pattern: (arn:(?:aws|aws-cn|aws-us-gov|aws-iso-{0,1}[a-z]{0,1}):[a-z0-9-]+:[a-z0-9-]*:[0-9]+:[a-z0-9-]+/[a-zA-Z0-9_~.-]{6,64}|[a-zA-Z0-9_~.-]{6,64})
    /// </summary>
