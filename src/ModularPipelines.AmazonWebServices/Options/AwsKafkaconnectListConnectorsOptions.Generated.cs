...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafkaconnect/list-connectors/index.html
...
[CliSubCommand("kafkaconnect", "list-connectors")]
public record AwsKafkaconnectListConnectorsOptions : AwsOptions
{
    /// <summary>
    /// The name prefix that you want to use to search for and list connec- tors.
    /// </summary>
