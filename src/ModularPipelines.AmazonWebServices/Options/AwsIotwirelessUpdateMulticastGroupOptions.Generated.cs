...
public record AwsIotwirelessUpdateMulticastGroupOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsIotwirelessUpdateMulticastGroupOptions(
        string Id
    )
    {
    ...
    private AwsIotwirelessUpdateMulticastGroupOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIotwirelessUpdateMulticastGroupOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIotwirelessUpdateMulticastGroupOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
