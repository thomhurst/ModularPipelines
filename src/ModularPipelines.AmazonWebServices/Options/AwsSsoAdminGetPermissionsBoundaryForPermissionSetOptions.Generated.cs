...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/get-permissions-boundary-for-permission-set/index.html
...
[CliSubCommand("sso-admin", "get-permissions-boundary-for-permission-set")]
public record AwsSsoAdminGetPermissionsBoundaryForPermissionSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminGetPermissionsBoundaryForPermissionSetOptions(
        string InstanceArn,
    ...
    private AwsSsoAdminGetPermissionsBoundaryForPermissionSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminGetPermissionsBoundaryForPermissionSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminGetPermissionsBoundaryForPermissionSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
