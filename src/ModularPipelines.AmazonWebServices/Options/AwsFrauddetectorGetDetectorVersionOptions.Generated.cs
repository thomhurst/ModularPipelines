...
public record AwsFrauddetectorGetDetectorVersionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsFrauddetectorGetDetectorVersionOptions(
        string DetectorId,
    ...
    private AwsFrauddetectorGetDetectorVersionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsFrauddetectorGetDetectorVersionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsFrauddetectorGetDetectorVersionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
