...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/docdb/describe-certificates/index.html
...
[CliSubCommand("docdb", "describe-certificates")]
public record AwsDocdbDescribeCertificatesOptions : AwsOptions
{
    /// <summary>
    /// The user-supplied certificate identifier. If this parameter is spec- ified, information for only the specified certificate is returned. If this parameter is omitted, a list of up to MaxRecords certifi- cates is returned. This parameter is not case sensitive. Constraints o Must match an existing CertificateIdentifier .
    /// </summary>
