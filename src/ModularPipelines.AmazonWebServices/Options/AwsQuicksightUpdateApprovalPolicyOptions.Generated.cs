...
public record AwsQuicksightUpdateApprovalPolicyOptions : AwsOptions, IValidatableObject
{
    ...
    /// Updates an approval policy in Quick Sight. See also: AWS API Documentation
    /// </summary>
    /// <param name="PolicyId">The unique identifier of the approval policy to update. Constraints: o min: 1 o max: 64 o pattern: [a-zA-Z0-9\-_]+</param>
    public AwsQuicksightUpdateApprovalPolicyOptions(
        string PolicyId
    )
    {
    ...
    private AwsQuicksightUpdateApprovalPolicyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightUpdateApprovalPolicyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightUpdateApprovalPolicyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique identifier of the approval policy to update. Constraints: o min: 1 o max: 64 o pattern: [a-zA-Z0-9\-_]+
    /// </summary>
    [CliOption("--policy-id")]
