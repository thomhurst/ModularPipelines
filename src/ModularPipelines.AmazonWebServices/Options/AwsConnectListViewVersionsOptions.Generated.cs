...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-view-versions/index.html
...
[CliSubCommand("connect", "list-view-versions")]
public record AwsConnectListViewVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListViewVersionsOptions(
        string InstanceId,
        string ViewId
    )
    {
    ...
    private AwsConnectListViewVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListViewVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListViewVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
