...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-documentation-part/index.html
...
[CliSubCommand("apigateway", "update-documentation-part")]
public record AwsApigatewayUpdateDocumentationPartOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="DocumentationPartId">The identifier of the to-be-updated documentation part.</param>
    public AwsApigatewayUpdateDocumentationPartOptions(
        string RestApiId,
    ...
    private AwsApigatewayUpdateDocumentationPartOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateDocumentationPartOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateDocumentationPartOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
