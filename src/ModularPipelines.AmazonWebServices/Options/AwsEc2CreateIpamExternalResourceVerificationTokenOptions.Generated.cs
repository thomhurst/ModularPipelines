...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-ipam-external-resource-verification-token/index.html
...
[CliSubCommand("ec2", "create-ipam-external-resource-verification-token")]
public record AwsEc2CreateIpamExternalResourceVerificationTokenOptions : AwsOptions, IValidatableObject
{
    ...
    /// Create a verification token. A verification token is an Amazon Web Services-generated random value that you can use to prove ownership of an external resource. For exam- ple, you can use a verification token to validate that you control a public IP address range when you bring an IP address range to Amazon Web Services (BYOIP). See also: AWS API Documentation
    /// </summary>
    /// <param name="IpamId">The ID of the IPAM that will create the token.</param>
    public AwsEc2CreateIpamExternalResourceVerificationTokenOptions(
        string IpamId
    )
    {
    ...
    private AwsEc2CreateIpamExternalResourceVerificationTokenOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateIpamExternalResourceVerificationTokenOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateIpamExternalResourceVerificationTokenOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
