...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock-agentcore-control/list-dataset-versions/index.html
...
[CliSubCommand("bedrock-agentcore-control", "list-dataset-versions")]
public record AwsBedrockAgentcoreControlListDataSetVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBedrockAgentcoreControlListDataSetVersionsOptions(
        string DataSetId
    )
    {
    ...
    private AwsBedrockAgentcoreControlListDataSetVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentcoreControlListDataSetVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentcoreControlListDataSetVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
