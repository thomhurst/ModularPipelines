...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-network-interface-permissions/index.html
...
[CliSubCommand("ec2", "describe-network-interface-permissions")]
public record AwsEc2DescribeNetworkInterfacePermissionsOptions : AwsOptions
{
    /// <summary>
    /// The network interface permission IDs. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--network-interface-permission-ids", GroupValues = true)]
    public IEnumerable<string>? NetworkInterfacePermissionIds { get; set; }

    /// <summary>
    /// One or more filters. o network-interface-permission.network-interface-permission-id - The ID of the permission. o network-interface-permission.network-interface-id - The ID of the network interface. o network-interface-permission.aws-account-id - The Amazon Web Ser- vices account ID. o network-interface-permission.aws-service - The Amazon Web Services service. o network-interface-permission.permission - The type of permission (INSTANCE-ATTACH | EIP-ASSOCIATE ). (structure) A filter name and value pair that is used to return a more spe- cific list of results from a describe operation. Filters can be used to match a set of resources by specific criteria, such as tags, attributes, or IDs. If you specify multiple filters, the filters are joined with an AND , and the request returns only results that match all of the specified filters. For more information, see List and filter using the CLI and API in the Amazon EC2 User Guide . Name -&gt; (string) The name of the filter. Filter names are case-sensitive. Values -&gt; (list) The filter values. Filter values are case-sensitive. If you specify multiple values for a filter, the values are joined with an OR , and the request returns all results that match any of the specified values. (string) Shorthand Syntax: Name=string,Values=string,string ... JSON Syntax: [ { "Name": "string", "Values": ["string", ...] } ... ]
    /// </summary>
