...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-transit-gateway-route-table-announcement/index.html
...
[CliSubCommand("ec2", "create-transit-gateway-route-table-announcement")]
public record AwsEc2CreateTransitGatewayRouteTableAnnouncementOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="PeeringAttachmentId">The ID of the peering attachment.</param>
    public AwsEc2CreateTransitGatewayRouteTableAnnouncementOptions(
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(PeeringAttachmentId);
        this.PeeringAttachmentId = PeeringAttachmentId;
    }

    private AwsEc2CreateTransitGatewayRouteTableAnnouncementOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateTransitGatewayRouteTableAnnouncementOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateTransitGatewayRouteTableAnnouncementOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
