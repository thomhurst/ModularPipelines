...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityagent/list-threat-model-job-tasks/index.html
...
[CliSubCommand("securityagent", "list-threat-model-job-tasks")]
public record AwsSecurityagentListThreatModelJobTasksOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="ThreatModelJobId">The unique identifier of the threat model job to list tasks for.</param>
    public AwsSecurityagentListThreatModelJobTasksOptions(
        string AgentSpaceId,
    ...
    private AwsSecurityagentListThreatModelJobTasksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSecurityagentListThreatModelJobTasksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSecurityagentListThreatModelJobTasksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
