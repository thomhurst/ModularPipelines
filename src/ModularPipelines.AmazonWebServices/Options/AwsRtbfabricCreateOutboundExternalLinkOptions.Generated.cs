...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rtbfabric/create-outbound-external-link/index.html
...
[CliSubCommand("rtbfabric", "create-outbound-external-link")]
public record AwsRtbfabricCreateOutboundExternalLinkOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="PublicEndpoint">The public endpoint of the link. Constraints: o min: 0 o max: 255 o pattern: (https|http)://.+</param>
    ...
    public AwsRtbfabricCreateOutboundExternalLinkOptions(
        string GatewayId,
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(PublicEndpoint);
        this.PublicEndpoint = PublicEndpoint;
        global::System.ArgumentNullException.ThrowIfNull(LogSettings);
        this.LogSettings = LogSettings;
    }

    private AwsRtbfabricCreateOutboundExternalLinkOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRtbfabricCreateOutboundExternalLinkOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRtbfabricCreateOutboundExternalLinkOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The public endpoint of the link. Constraints: o min: 0 o max: 255 o pattern: (https|http)://.+
    /// </summary>
    [CliOption("--public-endpoint")]
    public string? PublicEndpoint { get; private init; }
