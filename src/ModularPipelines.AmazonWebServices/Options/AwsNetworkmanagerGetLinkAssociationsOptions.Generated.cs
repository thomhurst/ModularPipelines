...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-link-associations/index.html
...
[CliSubCommand("networkmanager", "get-link-associations")]
public record AwsNetworkmanagerGetLinkAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerGetLinkAssociationsOptions(
    ...
    private AwsNetworkmanagerGetLinkAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerGetLinkAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerGetLinkAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
