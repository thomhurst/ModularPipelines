...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-traffic-mirror-targets/index.html
...
[CliSubCommand("ec2", "describe-traffic-mirror-targets")]
public record AwsEc2DescribeTrafficMirrorTargetsOptions : AwsOptions
{
    /// <summary>
    /// The ID of the Traffic Mirror targets. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--traffic-mirror-target-ids", GroupValues = true)]
    public IEnumerable<string>? TrafficMirrorTargetIds { get; set; }
