...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/create-security-profile/index.html
...
[CliSubCommand("iot", "create-security-profile")]
public record AwsIotCreateSecurityProfileOptions : AwsOptions, IValidatableObject
{
    ...
    /// NOTE: The IoT Device Defender detect feature will no longer be available to new customers starting August 31, 2026. If you would like to use the detect feature, sign up prior to August 31, 2026. To learn about alternatives to IoT Device Defender detect, see IoT Device Defender detect feature availability change in the IoT Device Defender Devel- oper Guide. There is no change to IoT Device Defender audit avail- ability. Creates a Device Defender security profile. Requires permission to access the...
    /// </summary>
    /// <param name="SecurityProfileName">The name you are giving to the security profile. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+</param>
    public AwsIotCreateSecurityProfileOptions(
    ...
    private AwsIotCreateSecurityProfileOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIotCreateSecurityProfileOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIotCreateSecurityProfileOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name you are giving to the security profile. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
    ...
    /// <summary>
    /// Metadata that can be used to manage the security profile. (structure) A set of key/value pairs that are used to manage the resource. Key -&gt; (string) [required] The tag's key. Constraints: o min: 1 o max: 128 o pattern: ^([\p{L}\p{Z}\p{N}_.:/=+\-@]*)$ Value -&gt; (string) The tag's value. Constraints: o min: 0 o max: 256 Shorthand Syntax: Key=string,Value=string ... JSON Syntax: [ { "Key": "string", "Value": "string" } ... ]
    /// </summary>
