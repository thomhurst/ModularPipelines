...
public record AwsServiceQuotasGetServiceQuotaOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsServiceQuotasGetServiceQuotaOptions(
        string ServiceCode,
        string QuotaCode
    )
    {
    ...
    private AwsServiceQuotasGetServiceQuotaOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsServiceQuotasGetServiceQuotaOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsServiceQuotasGetServiceQuotaOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
