...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-client-vpn-authorization-rules/index.html
...
[CliSubCommand("ec2", "describe-client-vpn-authorization-rules")]
public record AwsEc2DescribeClientVpnAuthorizationRulesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2DescribeClientVpnAuthorizationRulesOptions(
    ...
    private AwsEc2DescribeClientVpnAuthorizationRulesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2DescribeClientVpnAuthorizationRulesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2DescribeClientVpnAuthorizationRulesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
