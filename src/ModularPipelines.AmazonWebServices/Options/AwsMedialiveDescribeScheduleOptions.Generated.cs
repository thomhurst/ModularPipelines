...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/describe-schedule/index.html
...
[CliSubCommand("medialive", "describe-schedule")]
public record AwsMedialiveDescribeScheduleOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMedialiveDescribeScheduleOptions(
        string ChannelId
    )
    {
    ...
    private AwsMedialiveDescribeScheduleOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMedialiveDescribeScheduleOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMedialiveDescribeScheduleOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
