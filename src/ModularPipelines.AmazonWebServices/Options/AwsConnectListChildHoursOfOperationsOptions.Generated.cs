...
public record AwsConnectListChildHoursOfOperationsOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="HoursOfOperationId">The identifier of the parent hours of operation.</param>
    public AwsConnectListChildHoursOfOperationsOptions(
        string InstanceId,
    ...
    private AwsConnectListChildHoursOfOperationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListChildHoursOfOperationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListChildHoursOfOperationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
