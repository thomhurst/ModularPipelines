...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-queue-fleet-associations/index.html
...
public record AwsDeadlineListQueueFleetAssociationsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The fleet ID for the queue-fleet association list. Constraints: o pattern: fleet-[0-9a-f]{32}
    /// </summary>
    [CliOption("--fleet-id")]
