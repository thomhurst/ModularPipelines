...
public record AwsSecurityagentListFindingsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSecurityagentListFindingsOptions(
        string AgentSpaceId
    )
    {
    ...
    private AwsSecurityagentListFindingsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSecurityagentListFindingsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSecurityagentListFindingsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
