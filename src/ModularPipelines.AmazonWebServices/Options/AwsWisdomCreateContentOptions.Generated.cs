...
public record AwsWisdomCreateContentOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomCreateContentOptions(
    ...
    private AwsWisdomCreateContentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomCreateContentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomCreateContentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
