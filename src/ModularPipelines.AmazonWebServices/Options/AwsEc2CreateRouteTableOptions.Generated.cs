...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-route-table/index.html
...
[CliSubCommand("ec2", "create-route-table")]
public record AwsEc2CreateRouteTableOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateRouteTableOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateRouteTableOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateRouteTableOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateRouteTableOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
