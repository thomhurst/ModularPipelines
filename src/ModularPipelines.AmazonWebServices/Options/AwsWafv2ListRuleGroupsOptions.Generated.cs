...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wafv2/list-rule-groups/index.html
...
[CliSubCommand("wafv2", "list-rule-groups")]
public record AwsWafv2ListRuleGroupsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafv2ListRuleGroupsOptions(
    ...
    private AwsWafv2ListRuleGroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafv2ListRuleGroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafv2ListRuleGroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--scope")]
    public AwsWafv2ListRuleGroupsScope? Scope { get; private init; }
