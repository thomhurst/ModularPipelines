...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/textract/list-adapters/index.html
...
[CliSubCommand("textract", "list-adapters")]
public record AwsTextractListAdaptersOptions : AwsOptions
{
    /// <summary>
    /// Specifies the lower bound for the ListAdapters operation. Ensures ListAdapters returns only adapters created after the specified cre- ation time.
    /// </summary>
    [CliOption("--after-creation-time")]
    public string? AfterCreationTime { get; set; }

    /// <summary>
    /// Specifies the upper bound for the ListAdapters operation. Ensures ListAdapters returns only adapters created before the specified cre- ation time.
    /// </summary>
