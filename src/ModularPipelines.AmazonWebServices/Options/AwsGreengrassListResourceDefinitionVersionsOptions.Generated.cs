...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-resource-definition-versions/index.html
...
[CliSubCommand("greengrass", "list-resource-definition-versions")]
public record AwsGreengrassListResourceDefinitionVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListResourceDefinitionVersionsOptions(
    ...
    private AwsGreengrassListResourceDefinitionVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListResourceDefinitionVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListResourceDefinitionVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
