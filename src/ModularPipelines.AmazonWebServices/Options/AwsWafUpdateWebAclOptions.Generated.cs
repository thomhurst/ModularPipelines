...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/update-web-acl/index.html
...
[CliSubCommand("waf", "update-web-acl")]
public record AwsWafUpdateWebAclOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafUpdateWebAclOptions(
        string WebAclId,
        string ChangeToken
    )
    {
    ...
    private AwsWafUpdateWebAclOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafUpdateWebAclOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafUpdateWebAclOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
