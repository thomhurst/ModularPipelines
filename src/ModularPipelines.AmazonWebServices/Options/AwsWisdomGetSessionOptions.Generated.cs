...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/get-session/index.html
...
[CliSubCommand("wisdom", "get-session")]
public record AwsWisdomGetSessionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomGetSessionOptions(
        string AssistantId,
        string SessionId
    )
    {
    ...
    private AwsWisdomGetSessionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomGetSessionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomGetSessionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
