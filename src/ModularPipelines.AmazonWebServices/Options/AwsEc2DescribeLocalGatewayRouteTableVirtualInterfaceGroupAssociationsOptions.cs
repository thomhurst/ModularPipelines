...
[CliCommand("ec2", "describe-local-gateway-route-table-virtual-interface-group-associations")]
public record AwsEc2DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsOptions : AwsOptions
{
    [CliOption("--local-gateway-route-table-virtual-interface-group-association-ids")]
