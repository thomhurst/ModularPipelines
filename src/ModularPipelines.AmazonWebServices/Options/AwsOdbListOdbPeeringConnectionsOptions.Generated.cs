...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/odb/list-odb-peering-connections/index.html
...
[CliSubCommand("odb", "list-odb-peering-connections")]
public record AwsOdbListOdbPeeringConnectionsOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the ODB network to list peering connections for. If not specified, lists all ODB peering connections in the account. Constraints: o min: 6 o max: 2048 o pattern: (arn:(?:aws|aws-cn|aws-us-gov|aws-iso-{0,1}[a-z]{0,1}):[a-z0-9-]+:[a-z0-9-]*:[0-9]+:[a-z0-9-]+/[a-zA-Z0-9_~.-]{6,64}|[a-zA-Z0-9_~.-]{6,64})
    /// </summary>
