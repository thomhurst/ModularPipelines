...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/get-knowledge-base/index.html
...
[CliSubCommand("qconnect", "get-knowledge-base")]
public record AwsQconnectGetKnowledgeBaseOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectGetKnowledgeBaseOptions(
    ...
    private AwsQconnectGetKnowledgeBaseOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectGetKnowledgeBaseOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectGetKnowledgeBaseOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
