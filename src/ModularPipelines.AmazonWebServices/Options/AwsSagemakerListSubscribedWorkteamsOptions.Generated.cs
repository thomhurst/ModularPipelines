...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-subscribed-workteams/index.html
...
[CliSubCommand("sagemaker", "list-subscribed-workteams")]
public record AwsSagemakerListSubscribedWorkteamsOptions : AwsOptions
{
    /// <summary>
    /// A string in the work team name. This filter returns only work teams whose name contains the specified string. Constraints: o min: 1 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
