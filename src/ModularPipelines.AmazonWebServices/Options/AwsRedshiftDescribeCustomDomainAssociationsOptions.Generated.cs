...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift/describe-custom-domain-associations/index.html
...
[CliSubCommand("redshift", "describe-custom-domain-associations")]
public record AwsRedshiftDescribeCustomDomainAssociationsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The certificate Amazon Resource Name (ARN) for the custom domain as- sociation. Constraints: o min: 20 o max: 2048 o pattern: arn:[\w+=/,.@-]+:acm:[\w+=/,.@-]*:[0-9]+:[\w+=,.@-]+(/[\w+=,.@-]+)*
    /// </summary>
