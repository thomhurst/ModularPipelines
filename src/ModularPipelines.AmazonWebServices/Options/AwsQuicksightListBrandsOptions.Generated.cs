...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-brands/index.html
...
[CliSubCommand("quicksight", "list-brands")]
public record AwsQuicksightListBrandsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists all brands in an Quick Sight account. See also: AWS API Documentation list-brands is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: Brands
    /// </summary>
    /// <param name="AwsAccountId">The ID of the Amazon Web Services account that owns the brands that you want to list. Constraints: o min: 12 o max: 12 o pattern: ^[0-9]{12}$</param>
    public AwsQuicksightListBrandsOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListBrandsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListBrandsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListBrandsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the Amazon Web Services account that owns the brands that you want to list. Constraints: o min: 12 o max: 12 o pattern: ^[0-9]{12}$
    /// </summary>
