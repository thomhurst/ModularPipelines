...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pca-connector-ad/delete-service-principal-name/index.html
...
[CliSubCommand("pca-connector-ad", "delete-service-principal-name")]
public record AwsPcaConnectorAdDeleteServicePrincipalNameOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPcaConnectorAdDeleteServicePrincipalNameOptions(
        string ConnectorArn,
    ...
    private AwsPcaConnectorAdDeleteServicePrincipalNameOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPcaConnectorAdDeleteServicePrincipalNameOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPcaConnectorAdDeleteServicePrincipalNameOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
