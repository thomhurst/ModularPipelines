...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/start-document-classification-job/index.html
...
[CliSubCommand("comprehend", "start-document-classification-job")]
public record AwsComprehendStartDocumentClassificationJobOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsComprehendStartDocumentClassificationJobOptions(
    ...
    private AwsComprehendStartDocumentClassificationJobOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsComprehendStartDocumentClassificationJobOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsComprehendStartDocumentClassificationJobOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the document classifier to use to process the job. Constraints: o max: 256 o pattern: arn:aws(-[^:]+)?:comprehend:[a-zA-Z0-9-]*:[0-9]{12}:docu- ment-classifier/[a-zA-Z0-9](-*[a-zA-Z0-9])*(/ver- sion/[a-zA-Z0-9](-*[a-zA-Z0-9])*)?
    /// </summary>
