...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-clusters-v2/index.html
...
[CliSubCommand("kafka", "list-clusters-v2")]
public record AwsKafkaListClustersV2Options : AwsOptions
{
    /// <summary>
    /// Specify a prefix of the names of the clusters that you want to list. The service lists all the clusters whose names start with this pre- fix.
    /// </summary>
