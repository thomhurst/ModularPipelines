...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dsql/list-streams/index.html
...
[CliSubCommand("dsql", "list-streams")]
public record AwsDsqlListStreamsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves information about a list of streams for a cluster. See also: AWS API Documentation list-streams is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: streams
    /// </summary>
    /// <param name="ClusterIdentifier">The ID of the cluster for which to list streams. Constraints: o pattern: [a-z0-9]{26}</param>
    public AwsDsqlListStreamsOptions(
    ...
    private AwsDsqlListStreamsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsqlListStreamsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsqlListStreamsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the cluster for which to list streams. Constraints: o pattern: [a-z0-9]{26}
    /// </summary>
