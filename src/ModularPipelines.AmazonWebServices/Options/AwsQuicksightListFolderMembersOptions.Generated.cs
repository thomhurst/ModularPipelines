...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-folder-members/index.html
...
[CliSubCommand("quicksight", "list-folder-members")]
public record AwsQuicksightListFolderMembersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListFolderMembersOptions(
        string AwsAccountId,
        string FolderId
    )
    {
    ...
    private AwsQuicksightListFolderMembersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListFolderMembersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListFolderMembersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
