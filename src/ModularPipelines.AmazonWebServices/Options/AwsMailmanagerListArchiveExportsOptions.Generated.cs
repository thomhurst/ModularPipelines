...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/mailmanager/list-archive-exports/index.html
...
[CliSubCommand("mailmanager", "list-archive-exports")]
public record AwsMailmanagerListArchiveExportsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMailmanagerListArchiveExportsOptions(
        string ArchiveId
    )
    {
    ...
    private AwsMailmanagerListArchiveExportsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMailmanagerListArchiveExportsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMailmanagerListArchiveExportsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
