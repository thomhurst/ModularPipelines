...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iotfleetwise/list-model-manifests/index.html
...
[CliSubCommand("iotfleetwise", "list-model-manifests")]
public record AwsIotfleetwiseListModelManifestsOptions : AwsOptions
{
    ...
    /// <summary>
    /// When you set the listResponseScope parameter to METADATA_ONLY , the list response includes: model manifest name, Amazon Resource Name (ARN), creation time, and last modification time. Possible values: o METADATA_ONLY
    /// </summary>
    [CliOption("--list-response-scope")]
    public AwsIotfleetwiseListModelManifestsListResponseScope? ListResponseScope { get; set; }
