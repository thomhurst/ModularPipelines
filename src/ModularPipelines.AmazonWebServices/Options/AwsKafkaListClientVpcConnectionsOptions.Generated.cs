...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-client-vpc-connections/index.html
...
[CliSubCommand("kafka", "list-client-vpc-connections")]
public record AwsKafkaListClientVpcConnectionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsKafkaListClientVpcConnectionsOptions(
        string ClusterArn
    )
    {
    ...
    private AwsKafkaListClientVpcConnectionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKafkaListClientVpcConnectionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKafkaListClientVpcConnectionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
