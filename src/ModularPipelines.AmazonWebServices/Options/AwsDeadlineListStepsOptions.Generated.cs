...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-steps/index.html
...
[CliSubCommand("deadline", "list-steps")]
public record AwsDeadlineListStepsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists steps for a job. See also: AWS API Documentation list-steps is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: steps
    /// </summary>
    /// <param name="FarmId">The farm ID to include on the list of steps. Constraints: o pattern: farm-[0-9a-f]{32}</param>
    /// <param name="QueueId">The queue ID to include on the list of steps. Constraints: o pattern: queue-[0-9a-f]{32}</param>
    /// <param name="JobId">The job ID to include on the list of steps. Constraints: o pattern: job-[0-9a-f]{32}</param>
    public AwsDeadlineListStepsOptions(
        string FarmId,
        string QueueId,
        string JobId
    )
    ...
    private AwsDeadlineListStepsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDeadlineListStepsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDeadlineListStepsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The farm ID to include on the list of steps. Constraints: o pattern: farm-[0-9a-f]{32}
    /// </summary>
    [CliOption("--farm-id")]
    public string? FarmId { get; private init; }

    /// <summary>
    /// The queue ID to include on the list of steps. Constraints: o pattern: queue-[0-9a-f]{32}
    /// </summary>
    [CliOption("--queue-id")]
    public string? QueueId { get; private init; }

    /// <summary>
    /// The job ID to include on the list of steps. Constraints: o pattern: job-[0-9a-f]{32}
    /// </summary>
    [CliOption("--job-id")]
