...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-workspace-pages/index.html
...
[CliSubCommand("connect", "list-workspace-pages")]
public record AwsConnectListWorkspacePagesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListWorkspacePagesOptions(
        string InstanceId,
        string WorkspaceId
    )
    {
    ...
    private AwsConnectListWorkspacePagesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListWorkspacePagesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListWorkspacePagesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
