...
public record AwsEc2GetAssociatedIpv6PoolCidrsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetAssociatedIpv6PoolCidrsOptions(
        string PoolId
    )
    {
    ...
    private AwsEc2GetAssociatedIpv6PoolCidrsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetAssociatedIpv6PoolCidrsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetAssociatedIpv6PoolCidrsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
