...
public record AwsStoragegatewayAddCacheOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsStoragegatewayAddCacheOptions(
        string GatewayArn,
    ...
    private AwsStoragegatewayAddCacheOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsStoragegatewayAddCacheOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsStoragegatewayAddCacheOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
