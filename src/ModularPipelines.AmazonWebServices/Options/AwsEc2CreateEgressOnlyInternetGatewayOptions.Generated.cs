...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-egress-only-internet-gateway/index.html
...
[CliSubCommand("ec2", "create-egress-only-internet-gateway")]
public record AwsEc2CreateEgressOnlyInternetGatewayOptions : AwsOptions, IValidatableObject
{
    ...
    /// [IPv6 only] Creates an egress-only internet gateway for your VPC. An egress-only internet gateway is used to enable outbound communication over IPv6 from instances in your VPC to the internet, and prevents hosts outside of your VPC from initiating an IPv6 connection with your instance. See also: AWS API Documentation
    /// </summary>
    /// <param name="VpcId">The ID of the VPC for which to create the egress-only internet gate- way.</param>
    public AwsEc2CreateEgressOnlyInternetGatewayOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateEgressOnlyInternetGatewayOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateEgressOnlyInternetGatewayOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateEgressOnlyInternetGatewayOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ID of the VPC for which to create the egress-only internet gate- way.
    /// </summary>
    [CliOption("--vpc-id")]
