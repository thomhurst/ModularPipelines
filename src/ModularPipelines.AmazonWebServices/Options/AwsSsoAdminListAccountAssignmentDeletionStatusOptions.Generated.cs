...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-account-assignment-deletion-status/index.html
...
[CliSubCommand("sso-admin", "list-account-assignment-deletion-status")]
public record AwsSsoAdminListAccountAssignmentDeletionStatusOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminListAccountAssignmentDeletionStatusOptions(
        string InstanceArn
    )
    {
    ...
    private AwsSsoAdminListAccountAssignmentDeletionStatusOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListAccountAssignmentDeletionStatusOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListAccountAssignmentDeletionStatusOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
