...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/route53profiles/list-profile-resource-associations/index.html
...
[CliSubCommand("route53profiles", "list-profile-resource-associations")]
public record AwsRoute53profilesListProfileResourceAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRoute53profilesListProfileResourceAssociationsOptions(
        string ProfileId
    )
    {
    ...
    private AwsRoute53profilesListProfileResourceAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRoute53profilesListProfileResourceAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRoute53profilesListProfileResourceAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
