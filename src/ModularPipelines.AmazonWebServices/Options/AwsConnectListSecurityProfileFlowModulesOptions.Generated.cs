...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-security-profile-flow-modules/index.html
...
[CliSubCommand("connect", "list-security-profile-flow-modules")]
public record AwsConnectListSecurityProfileFlowModulesOptions : AwsOptions, IValidatableObject
{
    ...
    /// A list of Flow Modules an AI Agent can invoke as a tool See also: AWS API Documentation list-security-profile-flow-modules is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: AllowedFlowModules
    /// </summary>
    /// <param name="SecurityProfileId">The identifier for the security profile.</param>
    /// <param name="InstanceId">The identifier of the Connect Customer instance. You can find the instance ID in the Amazon Resource Name (ARN) of the instance. Constraints: o min: 1 o max: 100</param>
    public AwsConnectListSecurityProfileFlowModulesOptions(
    ...
    private AwsConnectListSecurityProfileFlowModulesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListSecurityProfileFlowModulesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListSecurityProfileFlowModulesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
