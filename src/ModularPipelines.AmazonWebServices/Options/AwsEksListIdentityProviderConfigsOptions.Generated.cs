...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-identity-provider-configs/index.html
...
[CliSubCommand("eks", "list-identity-provider-configs")]
public record AwsEksListIdentityProviderConfigsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEksListIdentityProviderConfigsOptions(
        string ClusterName
    )
    {
    ...
    private AwsEksListIdentityProviderConfigsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEksListIdentityProviderConfigsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEksListIdentityProviderConfigsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
