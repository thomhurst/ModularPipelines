...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-local-gateway-route-table-vpc-association/index.html
...
[CliSubCommand("ec2", "create-local-gateway-route-table-vpc-association")]
public record AwsEc2CreateLocalGatewayRouteTableVpcAssociationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateLocalGatewayRouteTableVpcAssociationOptions(
    ...
    private AwsEc2CreateLocalGatewayRouteTableVpcAssociationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateLocalGatewayRouteTableVpcAssociationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateLocalGatewayRouteTableVpcAssociationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
