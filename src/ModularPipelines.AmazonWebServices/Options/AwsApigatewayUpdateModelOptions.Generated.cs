...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-model/index.html
...
[CliSubCommand("apigateway", "update-model")]
public record AwsApigatewayUpdateModelOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="ModelName">The name of the model to update.</param>
    public AwsApigatewayUpdateModelOptions(
        string RestApiId,
        string ModelName
    )
    {
    ...
    private AwsApigatewayUpdateModelOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateModelOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateModelOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
