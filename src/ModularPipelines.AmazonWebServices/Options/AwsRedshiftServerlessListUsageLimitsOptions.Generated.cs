...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/redshift-serverless/list-usage-limits/index.html
...
[CliSubCommand("redshift-serverless", "list-usage-limits")]
public record AwsRedshiftServerlessListUsageLimitsOptions : AwsOptions
{
    ...
    /// <summary>
    /// The Amazon Redshift Serverless feature whose limits you want to see. Possible values: o serverless-compute o cross-region-datasharing
    /// </summary>
    [CliOption("--usage-type")]
    public AwsRedshiftServerlessListUsageLimitsUsageType? UsageType { get; set; }
