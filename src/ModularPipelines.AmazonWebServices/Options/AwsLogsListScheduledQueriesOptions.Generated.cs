...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/logs/list-scheduled-queries/index.html
...
[CliSubCommand("logs", "list-scheduled-queries")]
public record AwsLogsListScheduledQueriesOptions : AwsOptions
{
    /// <summary>
    /// Filter scheduled queries by state. Valid values are ENABLED and DIS- ABLED . If not specified, all scheduled queries are returned. Possible values: o ENABLED o DISABLED
    /// </summary>
    [CliOption("--state")]
    public AwsLogsListScheduledQueriesState? State { get; set; }

    /// <summary>
    /// Filter scheduled queries by schedule type. Valid values are CUS- TOMER_MANAGED and AWS_MANAGED . If not specified, scheduled queries of all schedule types are returned. Possible values: o CUSTOMER_MANAGED o AWS_MANAGED
    /// </summary>
    [CliOption("--schedule-type")]
    public AwsLogsListScheduledQueriesScheduleType? ScheduleType { get; set; }
