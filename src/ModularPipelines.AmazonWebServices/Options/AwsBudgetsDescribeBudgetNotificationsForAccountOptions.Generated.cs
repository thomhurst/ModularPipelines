...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/budgets/describe-budget-notifications-for-account/index.html
...
[CliSubCommand("budgets", "describe-budget-notifications-for-account")]
public record AwsBudgetsDescribeBudgetNotificationsForAccountOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsBudgetsDescribeBudgetNotificationsForAccountOptions(
        string AccountId
    )
    {
    ...
    private AwsBudgetsDescribeBudgetNotificationsForAccountOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBudgetsDescribeBudgetNotificationsForAccountOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBudgetsDescribeBudgetNotificationsForAccountOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
