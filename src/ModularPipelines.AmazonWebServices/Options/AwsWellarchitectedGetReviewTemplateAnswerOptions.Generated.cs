...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wellarchitected/get-review-template-answer/index.html
...
[CliSubCommand("wellarchitected", "get-review-template-answer")]
public record AwsWellarchitectedGetReviewTemplateAnswerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWellarchitectedGetReviewTemplateAnswerOptions(
        string TemplateArn,
        string LensAlias,
        string QuestionId
    )
    ...
    private AwsWellarchitectedGetReviewTemplateAnswerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWellarchitectedGetReviewTemplateAnswerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWellarchitectedGetReviewTemplateAnswerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
