...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-apps/index.html
...
[CliSubCommand("sagemaker", "list-apps")]
public record AwsSagemakerListAppsOptions : AwsOptions
{
    ...
    public AwsSagemakerListAppsSortOrder? SortOrder { get; set; }
    ...
    /// <summary>
    /// A parameter to search by user profile name. If SpaceNameEquals is set, then this value cannot be set. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
    [CliOption("--user-profile-name-equals")]
    public string? UserProfileNameEquals { get; set; }

    /// <summary>
    /// A parameter to search by space name. If UserProfileNameEquals is set, then this value cannot be set. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
