...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifyuibuilder/list-forms/index.html
...
[CliSubCommand("amplifyuibuilder", "list-forms")]
public record AwsAmplifyuibuilderListFormsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyuibuilderListFormsOptions(
        string AppId,
    ...
    private AwsAmplifyuibuilderListFormsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyuibuilderListFormsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyuibuilderListFormsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
