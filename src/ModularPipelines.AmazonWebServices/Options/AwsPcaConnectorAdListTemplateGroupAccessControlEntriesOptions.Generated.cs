...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pca-connector-ad/list-template-group-access-control-entries/index.html
...
[CliSubCommand("pca-connector-ad", "list-template-group-access-control-entries")]
public record AwsPcaConnectorAdListTemplateGroupAccessControlEntriesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsPcaConnectorAdListTemplateGroupAccessControlEntriesOptions(
        string TemplateArn
    )
    {
    ...
    private AwsPcaConnectorAdListTemplateGroupAccessControlEntriesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsPcaConnectorAdListTemplateGroupAccessControlEntriesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsPcaConnectorAdListTemplateGroupAccessControlEntriesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
