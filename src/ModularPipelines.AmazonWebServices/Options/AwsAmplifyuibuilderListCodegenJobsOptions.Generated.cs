...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplifyuibuilder/list-codegen-jobs/index.html
...
[CliSubCommand("amplifyuibuilder", "list-codegen-jobs")]
public record AwsAmplifyuibuilderListCodegenJobsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves a list of code generation jobs for a specified Amplify app and backend environment. See also: AWS API Documentation list-codegen-jobs is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: entities
    /// </summary>
    /// <param name="AppId">The unique ID for the Amplify app. Constraints: o min: 1 o max: 20 o pattern: d[a-z0-9]+</param>
    /// <param name="EnvironmentName">The name of the backend environment that is a part of the Amplify app.</param>
    public AwsAmplifyuibuilderListCodegenJobsOptions(
        string AppId,
    ...
    private AwsAmplifyuibuilderListCodegenJobsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyuibuilderListCodegenJobsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyuibuilderListCodegenJobsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique ID for the Amplify app. Constraints: o min: 1 o max: 20 o pattern: d[a-z0-9]+
    /// </summary>
    [CliOption("--app-id")]
