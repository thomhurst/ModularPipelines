...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-users/index.html
...
[CliSubCommand("connect", "list-users")]
public record AwsConnectListUsersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListUsersOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListUsersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListUsersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListUsersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
