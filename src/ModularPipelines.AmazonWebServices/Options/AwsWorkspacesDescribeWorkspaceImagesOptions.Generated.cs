...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces/describe-workspace-images/index.html
...
[CliSubCommand("workspaces", "describe-workspace-images")]
public record AwsWorkspacesDescribeWorkspaceImagesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The type (owned or shared) of the image. Possible values: o OWNED o SHARED
    /// </summary>
    [CliOption("--image-type")]
    public AwsWorkspacesDescribeWorkspaceImagesImageType? ImageType { get; set; }
