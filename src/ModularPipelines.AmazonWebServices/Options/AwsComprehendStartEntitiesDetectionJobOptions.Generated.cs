...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/comprehend/start-entities-detection-job/index.html
...
[CliSubCommand("comprehend", "start-entities-detection-job")]
public record AwsComprehendStartEntitiesDetectionJobOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="LanguageCode">The language of the input documents. All documents must be in the same language. You can specify any of the languages supported by Amazon Comprehend. If custom entities recognition is used, this pa- rameter is ignored and the language used for training the model is used instead. Possible values: o en o es o fr o de o it o pt o ar o hi o ja o ko o zh o zh-TW</param>
    public AwsComprehendStartEntitiesDetectionJobOptions(
        string InputDataConfig,
        string OutputDataConfig,
        string DataAccessRoleArn,
        AwsComprehendStartEntitiesDetectionJobLanguageCode LanguageCode
    )
    {
    ...
    private AwsComprehendStartEntitiesDetectionJobOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsComprehendStartEntitiesDetectionJobOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsComprehendStartEntitiesDetectionJobOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The language of the input documents. All documents must be in the same language. You can specify any of the languages supported by Amazon Comprehend. If custom entities recognition is used, this pa- rameter is ignored and the language used for training the model is used instead. Possible values: o en o es o fr o de o it o pt o ar o hi o ja o ko o zh o zh-TW
    /// </summary>
    [CliOption("--language-code")]
    public AwsComprehendStartEntitiesDetectionJobLanguageCode? LanguageCode { get; private init; }
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) that identifies the specific entity recognizer to be used by the StartEntitiesDetectionJob . This ARN is optional and is only used for a custom entity recognition job. Constraints: o max: 256 o pattern: arn:aws(-[^:]+)?:comprehend:[a-zA-Z0-9-]*:[0-9]{12}:en- tity-recognizer/[a-zA-Z0-9](-*[a-zA-Z0-9])*(/ver- sion/[a-zA-Z0-9](-*[a-zA-Z0-9])*)?
    /// </summary>
