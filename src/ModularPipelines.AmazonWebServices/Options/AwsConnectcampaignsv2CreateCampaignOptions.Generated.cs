...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connectcampaignsv2/create-campaign/index.html
...
public record AwsConnectcampaignsv2CreateCampaignOptions : AwsOptions, IValidatableObject
{
    ...
    /// <summary>
    /// The type of campaign externally exposed in APIs. Possible values: o MANAGED o JOURNEY
    /// </summary>
    [CliOption("--type")]
    public AwsConnectcampaignsv2CreateCampaignType? Type { get; set; }
    ...
    /// </summary>
    [CliOption("--connect-campaign-flow-arn")]
