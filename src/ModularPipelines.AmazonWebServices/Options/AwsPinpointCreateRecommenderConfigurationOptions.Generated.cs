...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint/create-recommender-configuration/index.html
...
[CliSubCommand("pinpoint", "create-recommender-configuration")]
public record AwsPinpointCreateRecommenderConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    /// </summary>
    [CliOption("--create-recommender-configuration")]
    public string? CreateRecommenderConfiguration { get; private init; }
