...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-filters/index.html
...
[CliSubCommand("personalize", "list-filters")]
public record AwsPersonalizeListFiltersOptions : AwsOptions
{
    /// <summary>
    /// The ARN of the dataset group that contains the filters. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
