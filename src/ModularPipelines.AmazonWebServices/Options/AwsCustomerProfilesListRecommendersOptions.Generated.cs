...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-recommenders/index.html
...
[CliSubCommand("customer-profiles", "list-recommenders")]
public record AwsCustomerProfilesListRecommendersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListRecommendersOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListRecommendersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListRecommendersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListRecommendersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
