...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/tag-role/index.html
...
[CliSubCommand("iam", "tag-role")]
public record AwsIamTagRoleOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsIamTagRoleOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamTagRoleOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamTagRoleOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
