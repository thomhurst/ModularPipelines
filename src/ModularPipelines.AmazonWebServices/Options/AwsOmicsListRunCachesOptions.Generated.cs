...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/omics/list-run-caches/index.html
...
[CliSubCommand("omics", "list-run-caches")]
public record AwsOmicsListRunCachesOptions : AwsOptions
{
    /// <summary>
