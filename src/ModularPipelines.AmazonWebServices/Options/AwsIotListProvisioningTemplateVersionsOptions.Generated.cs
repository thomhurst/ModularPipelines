...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-provisioning-template-versions/index.html
...
[CliSubCommand("iot", "list-provisioning-template-versions")]
public record AwsIotListProvisioningTemplateVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsIotListProvisioningTemplateVersionsOptions(
        string TemplateName
    )
    {
    ...
    private AwsIotListProvisioningTemplateVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIotListProvisioningTemplateVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIotListProvisioningTemplateVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
