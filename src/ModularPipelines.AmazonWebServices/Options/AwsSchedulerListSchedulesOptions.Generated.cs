...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/scheduler/list-schedules/index.html
...
[CliSubCommand("scheduler", "list-schedules")]
public record AwsSchedulerListSchedulesOptions : AwsOptions
{
    /// <summary>
    /// If specified, only lists the schedules whose associated schedule group matches the given filter. Constraints: o min: 1 o max: 64 o pattern: ^[0-9a-zA-Z-_.]+$
    /// </summary>
    [CliOption("--group-name")]
    public string? GroupName { get; set; }

    /// <summary>
    /// Schedule name prefix to return the filtered list of resources. Constraints: o min: 1 o max: 64 o pattern: ^[0-9a-zA-Z-_.]+$
    /// </summary>
    [CliOption("--name-prefix")]
    public string? NamePrefix { get; set; }

    /// <summary>
    /// If specified, only lists the schedules whose current state matches the given filter. Possible values: o ENABLED o DISABLED
    /// </summary>
    [CliOption("--state")]
    public AwsSchedulerListSchedulesState? State { get; set; }
