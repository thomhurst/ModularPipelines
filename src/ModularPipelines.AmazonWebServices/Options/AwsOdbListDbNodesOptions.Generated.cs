...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/odb/list-db-nodes/index.html
...
[CliSubCommand("odb", "list-db-nodes")]
public record AwsOdbListDbNodesOptions : AwsOptions
{
    /// <summary>
    /// The unique identifier of the VM cluster. You must specify either this parameter or exadbVmClusterId . Constraints: o min: 6 o max: 64 o pattern: [a-zA-Z0-9_~.-]+
    /// </summary>
    [CliOption("--cloud-vm-cluster-id")]
    public string? CloudVmClusterId { get; set; }

    /// <summary>
    /// The unique identifier of the Exascale VM cluster. You must specify either this parameter or cloudVmClusterId . Constraints: o min: 6 o max: 64 o pattern: [a-zA-Z0-9_~.-]+
    /// </summary>
