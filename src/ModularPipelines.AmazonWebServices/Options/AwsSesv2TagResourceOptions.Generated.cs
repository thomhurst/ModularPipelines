...
public record AwsSesv2TagResourceOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsSesv2TagResourceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSesv2TagResourceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSesv2TagResourceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the resource that you want to add one or more tags to. Constraints: o min: 1
    /// </summary>
