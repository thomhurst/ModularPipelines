...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/get-domain-names/index.html
...
[CliSubCommand("apigateway", "get-domain-names")]
public record AwsApigatewayGetDomainNamesOptions : AwsOptions
{
    /// <summary>
    /// The owner of the domain name access association. Possible values: o SELF o OTHER_ACCOUNTS
    /// </summary>
    [CliOption("--resource-owner")]
    public AwsApigatewayGetDomainNamesResourceOwner? ResourceOwner { get; set; }
