...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/delete-alias/index.html
...
[CliSubCommand("lambda", "delete-alias")]
public record AwsLambdaDeleteAliasOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaDeleteAliasOptions(
        string FunctionName,
        string Name
    )
    {
    ...
    private AwsLambdaDeleteAliasOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaDeleteAliasOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaDeleteAliasOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
