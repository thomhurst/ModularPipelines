...
public record AwsQconnectUpdateSessionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectUpdateSessionOptions(
        string AssistantId,
        string SessionId
    )
    {
    ...
    private AwsQconnectUpdateSessionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectUpdateSessionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectUpdateSessionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
