...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-request-validator/index.html
...
[CliSubCommand("apigateway", "update-request-validator")]
public record AwsApigatewayUpdateRequestValidatorOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="RequestValidatorId">The identifier of RequestValidator to be updated.</param>
    public AwsApigatewayUpdateRequestValidatorOptions(
        string RestApiId,
    ...
    private AwsApigatewayUpdateRequestValidatorOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateRequestValidatorOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateRequestValidatorOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
