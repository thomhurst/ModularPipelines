...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/describe-app-version/index.html
...
[CliSubCommand("resiliencehub", "describe-app-version")]
public record AwsResiliencehubDescribeAppVersionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubDescribeAppVersionOptions(
        string AppArn,
        string AppVersion
    )
    {
    ...
    private AwsResiliencehubDescribeAppVersionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubDescribeAppVersionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubDescribeAppVersionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
