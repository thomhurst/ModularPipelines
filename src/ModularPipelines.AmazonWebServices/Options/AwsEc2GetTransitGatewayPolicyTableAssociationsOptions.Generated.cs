...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-transit-gateway-policy-table-associations/index.html
...
[CliSubCommand("ec2", "get-transit-gateway-policy-table-associations")]
public record AwsEc2GetTransitGatewayPolicyTableAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetTransitGatewayPolicyTableAssociationsOptions(
    ...
    private AwsEc2GetTransitGatewayPolicyTableAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetTransitGatewayPolicyTableAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetTransitGatewayPolicyTableAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
