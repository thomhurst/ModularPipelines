...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/agent-toolkit/list-available-skills/index.html
...
[CliSubCommand("agent-toolkit", "list-available-skills")]
public record AwsAgentToolkitListAvailableSkillsOptions : AwsOptions
{
    /// <summary>
    /// Constraints: o min: 1 o max: 100 o pattern: [a-zA-Z0-9-_]+
    /// </summary>
    [CliOption("--category-filter")]
