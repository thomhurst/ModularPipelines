...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehubv2/list-assertions/index.html
...
[CliSubCommand("resiliencehubv2", "list-assertions")]
public record AwsResiliencehubv2ListAssertionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubv2ListAssertionsOptions(
        string ServiceArn
    )
    {
    ...
    private AwsResiliencehubv2ListAssertionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubv2ListAssertionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubv2ListAssertionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Filter assertions by source type. Possible values: o AI_GENERATED o USER
    /// </summary>
    [CliOption("--source")]
    public AwsResiliencehubv2ListAssertionsSource? Source { get; set; }
