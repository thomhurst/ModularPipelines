...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-verified-access-group/index.html
...
[CliSubCommand("ec2", "create-verified-access-group")]
public record AwsEc2CreateVerifiedAccessGroupOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateVerifiedAccessGroupOptions(
    ...
    private AwsEc2CreateVerifiedAccessGroupOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateVerifiedAccessGroupOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateVerifiedAccessGroupOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
