...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-agent-statuses/index.html
...
[CliSubCommand("connect", "list-agent-statuses")]
public record AwsConnectListAgentStatusesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListAgentStatusesOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListAgentStatusesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListAgentStatusesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListAgentStatusesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
