...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-client-vpn-target-networks/index.html
...
[CliSubCommand("ec2", "describe-client-vpn-target-networks")]
public record AwsEc2DescribeClientVpnTargetNetworksOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2DescribeClientVpnTargetNetworksOptions(
    ...
    private AwsEc2DescribeClientVpnTargetNetworksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2DescribeClientVpnTargetNetworksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2DescribeClientVpnTargetNetworksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
