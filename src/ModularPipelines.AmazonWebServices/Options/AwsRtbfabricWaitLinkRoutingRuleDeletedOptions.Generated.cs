...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rtbfabric/wait/link-routing-rule-deleted/index.html
...
[CliSubCommand("rtbfabric", "wait", "link-routing-rule-deleted")]
public record AwsRtbfabricWaitLinkRoutingRuleDeletedOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRtbfabricWaitLinkRoutingRuleDeletedOptions(
        string GatewayId,
        string LinkId,
        string RuleId
    )
    ...
    private AwsRtbfabricWaitLinkRoutingRuleDeletedOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRtbfabricWaitLinkRoutingRuleDeletedOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRtbfabricWaitLinkRoutingRuleDeletedOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
