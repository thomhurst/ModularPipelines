...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-capacity-reservation-by-splitting/index.html
...
[CliSubCommand("ec2", "create-capacity-reservation-by-splitting")]
public record AwsEc2CreateCapacityReservationBySplittingOptions : AwsOptions, IValidatableObject
{
    ...
    /// Create a new Capacity Reservation by splitting the capacity of the source Capacity Reservation. The new Capacity Reservation will have the same attributes as the source Capacity Reservation except for tags. The source Capacity Reservation must be active and owned by your Amazon Web Services account. See also: AWS API Documentation
    /// </summary>
    /// <param name="SourceCapacityReservationId">The ID of the Capacity Reservation from which you want to split the capacity.</param>
    /// <param name="InstanceCount">The number of instances to split from the source Capacity Reserva- tion.</param>
    public AwsEc2CreateCapacityReservationBySplittingOptions(
    ...
    private AwsEc2CreateCapacityReservationBySplittingOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateCapacityReservationBySplittingOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateCapacityReservationBySplittingOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The number of instances to split from the source Capacity Reserva- tion.
    /// </summary>
