...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/list-device-discoveries/index.html
...
[CliSubCommand("iot-managed-integrations", "list-device-discoveries")]
public record AwsIotManagedIntegrationsListDeviceDiscoveriesOptions : AwsOptions
{
    /// <summary>
    /// The discovery type to filter device discovery jobs by. Possible values: o ZWAVE o ZIGBEE o CLOUD o CUSTOM o CONTROLLER_CAPABILITY_REDISCOVERY
    /// </summary>
    [CliOption("--type-filter")]
    public AwsIotManagedIntegrationsListDeviceDiscoveriesTypeFilter? TypeFilter { get; set; }

    /// <summary>
    /// The status to filter device discovery jobs by. Possible values: o RUNNING o SUCCEEDED o FAILED o TIMED_OUT
    /// </summary>
    [CliOption("--status-filter")]
    public AwsIotManagedIntegrationsListDeviceDiscoveriesStatusFilter? StatusFilter { get; set; }
