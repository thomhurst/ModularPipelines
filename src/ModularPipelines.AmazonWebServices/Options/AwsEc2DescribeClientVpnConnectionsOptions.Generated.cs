...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-client-vpn-connections/index.html
...
[CliSubCommand("ec2", "describe-client-vpn-connections")]
public record AwsEc2DescribeClientVpnConnectionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2DescribeClientVpnConnectionsOptions(
    ...
    private AwsEc2DescribeClientVpnConnectionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2DescribeClientVpnConnectionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2DescribeClientVpnConnectionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
