...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/resiliencehub/describe-app-version-template/index.html
...
[CliSubCommand("resiliencehub", "describe-app-version-template")]
public record AwsResiliencehubDescribeAppVersionTemplateOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubDescribeAppVersionTemplateOptions(
        string AppArn,
        string AppVersion
    )
    {
    ...
    private AwsResiliencehubDescribeAppVersionTemplateOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubDescribeAppVersionTemplateOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubDescribeAppVersionTemplateOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
