...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/kafka/list-cluster-operations/index.html
...
[CliSubCommand("kafka", "list-cluster-operations")]
public record AwsKafkaListClusterOperationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsKafkaListClusterOperationsOptions(
        string ClusterArn
    )
    {
    ...
    private AwsKafkaListClusterOperationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsKafkaListClusterOperationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsKafkaListClusterOperationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
