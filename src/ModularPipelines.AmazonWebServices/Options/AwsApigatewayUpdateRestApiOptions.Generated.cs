...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-rest-api/index.html
...
[CliSubCommand("apigateway", "update-rest-api")]
public record AwsApigatewayUpdateRestApiOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayUpdateRestApiOptions(
        string RestApiId
    )
    {
    ...
    private AwsApigatewayUpdateRestApiOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateRestApiOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateRestApiOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
