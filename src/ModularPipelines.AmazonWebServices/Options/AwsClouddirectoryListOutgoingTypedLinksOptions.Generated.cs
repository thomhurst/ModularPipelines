...
public record AwsClouddirectoryListOutgoingTypedLinksOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsClouddirectoryListOutgoingTypedLinksOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsClouddirectoryListOutgoingTypedLinksOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsClouddirectoryListOutgoingTypedLinksOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
