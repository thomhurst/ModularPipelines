...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock/list-prompt-routers/index.html
...
[CliSubCommand("bedrock", "list-prompt-routers")]
public record AwsBedrockListPromptRoutersOptions : AwsOptions
{
    /// <summary>
    /// The type of the prompt routers, such as whether it's default or cus- tom. Possible values: o custom o default
    /// </summary>
    [CliOption("--type")]
    public AwsBedrockListPromptRoutersType? Type { get; set; }
