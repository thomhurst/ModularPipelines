...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-vpc-endpoint-service-permissions/index.html
...
[CliSubCommand("ec2", "describe-vpc-endpoint-service-permissions")]
public record AwsEc2DescribeVpcEndpointServicePermissionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2DescribeVpcEndpointServicePermissionsOptions(
        string ServiceId
    )
    {
    ...
    private AwsEc2DescribeVpcEndpointServicePermissionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2DescribeVpcEndpointServicePermissionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2DescribeVpcEndpointServicePermissionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
