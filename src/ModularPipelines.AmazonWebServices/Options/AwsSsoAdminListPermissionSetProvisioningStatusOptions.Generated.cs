...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-permission-set-provisioning-status/index.html
...
[CliSubCommand("sso-admin", "list-permission-set-provisioning-status")]
public record AwsSsoAdminListPermissionSetProvisioningStatusOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminListPermissionSetProvisioningStatusOptions(
        string InstanceArn
    )
    {
    ...
    private AwsSsoAdminListPermissionSetProvisioningStatusOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListPermissionSetProvisioningStatusOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListPermissionSetProvisioningStatusOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
