...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup-gateway/list-virtual-machines/index.html
...
[CliSubCommand("backup-gateway", "list-virtual-machines")]
public record AwsBackupGatewayListVirtualMachinesOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the hypervisor connected to your virtual machine. Constraints: o min: 50 o max: 500 o pattern: arn:(aws|aws-cn|aws-us-gov):backup-gate- way(:[a-zA-Z-0-9]+){3}\/[a-zA-Z-0-9]+
    /// </summary>
