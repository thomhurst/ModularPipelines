...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-thing-groups/index.html
...
[CliSubCommand("iot", "list-thing-groups")]
public record AwsIotListThingGroupsOptions : AwsOptions
{
    /// <summary>
    /// A filter that limits the results to those with the specified parent group. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
    [CliOption("--parent-group")]
    public string? ParentGroup { get; set; }

    /// <summary>
    /// A filter that limits the results to those with the specified name prefix. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
