...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/describe-db-cluster-parameter-groups/index.html
...
[CliSubCommand("rds", "describe-db-cluster-parameter-groups")]
public record AwsRdsDescribeDbClusterParameterGroupsOptions : AwsOptions
{
    /// <summary>
    /// The name of a specific DB cluster parameter group to return details for. Constraints: o If supplied, must match the name of an existing DBClusterParame- terGroup.
    /// </summary>
