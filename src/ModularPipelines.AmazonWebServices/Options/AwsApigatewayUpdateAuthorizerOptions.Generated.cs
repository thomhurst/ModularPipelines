...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigateway/update-authorizer/index.html
...
[CliSubCommand("apigateway", "update-authorizer")]
public record AwsApigatewayUpdateAuthorizerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayUpdateAuthorizerOptions(
        string RestApiId,
        string AuthorizerId
    )
    {
    ...
    private AwsApigatewayUpdateAuthorizerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateAuthorizerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateAuthorizerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
