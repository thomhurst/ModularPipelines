...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/networkmanager/get-devices/index.html
...
[CliSubCommand("networkmanager", "get-devices")]
public record AwsNetworkmanagerGetDevicesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNetworkmanagerGetDevicesOptions(
    ...
    private AwsNetworkmanagerGetDevicesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNetworkmanagerGetDevicesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNetworkmanagerGetDevicesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
