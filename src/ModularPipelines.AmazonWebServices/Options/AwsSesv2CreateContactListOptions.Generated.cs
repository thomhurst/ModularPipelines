...
public record AwsSesv2CreateContactListOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSesv2CreateContactListOptions(
    ...
    private AwsSesv2CreateContactListOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSesv2CreateContactListOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSesv2CreateContactListOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
