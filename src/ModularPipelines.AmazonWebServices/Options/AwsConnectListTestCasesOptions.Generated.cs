...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-test-cases/index.html
...
[CliSubCommand("connect", "list-test-cases")]
public record AwsConnectListTestCasesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListTestCasesOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListTestCasesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListTestCasesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListTestCasesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
