...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/deadline/list-farms/index.html
...
[CliSubCommand("deadline", "list-farms")]
public record AwsDeadlineListFarmsOptions : AwsOptions
{
    /// <summary>
    /// The principal ID of the member to list on the farm. Constraints: o min: 1 o max: 47 o pattern: ([0-9a-f]{10}-|)[A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12}
    /// </summary>
