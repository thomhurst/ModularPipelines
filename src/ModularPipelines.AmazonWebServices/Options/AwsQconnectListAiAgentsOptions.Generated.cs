...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-ai-agents/index.html
...
[CliSubCommand("qconnect", "list-ai-agents")]
public record AwsQconnectListAiAgentsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListAiAgentsOptions(
        string AssistantId
    )
    {
    ...
    private AwsQconnectListAiAgentsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListAiAgentsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListAiAgentsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The origin of the AI Agents to be listed. SYSTEM for a default AI Agent created by Q in Connect or CUSTOMER for an AI Agent created by calling AI Agent creation APIs. Possible values: o SYSTEM o CUSTOMER
    /// </summary>
    [CliOption("--origin")]
    public AwsQconnectListAiAgentsOrigin? Origin { get; set; }
