...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-managed-policies-in-permission-set/index.html
...
[CliSubCommand("sso-admin", "list-managed-policies-in-permission-set")]
public record AwsSsoAdminListManagedPoliciesInPermissionSetOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="PermissionSetArn">The ARN of the PermissionSet whose managed policies will be listed. Constraints: o min: 10 o max: 1224 o pattern: arn:aws(-[a-z]{1,5}){0,3}:sso:::permission- Set/(sso)?ins-[a-zA-Z0-9-.]{16}/ps-[a-zA-Z0-9-./]{16}</param>
    public AwsSsoAdminListManagedPoliciesInPermissionSetOptions(
        string InstanceArn,
    ...
    private AwsSsoAdminListManagedPoliciesInPermissionSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListManagedPoliciesInPermissionSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListManagedPoliciesInPermissionSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ARN of the PermissionSet whose managed policies will be listed. Constraints: o min: 10 o max: 1224 o pattern: arn:aws(-[a-z]{1,5}){0,3}:sso:::permission- Set/(sso)?ins-[a-zA-Z0-9-.]{16}/ps-[a-zA-Z0-9-./]{16}
    /// </summary>
