...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/describe-shared-directories/index.html
...
[CliSubCommand("ds", "describe-shared-directories")]
public record AwsDsDescribeSharedDirectoriesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns the shared directories in your account. See also: AWS API Documentation describe-shared-directories is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of re- sults. You can disable pagination by providing the --no-paginate argu- ment. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: SharedDirectories
    /// </summary>
    /// <param name="OwnerDirectoryId">Returns the identifier of the directory in the directory owner ac- count. Constraints: o pattern: ^d-[0-9a-f]{10}$</param>
    public AwsDsDescribeSharedDirectoriesOptions(
        string OwnerDirectoryId
    )
    {
        global::System.ArgumentNullException.ThrowIfNull(OwnerDirectoryId);
        this.OwnerDirectoryId = OwnerDirectoryId;
    }

    private AwsDsDescribeSharedDirectoriesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsDescribeSharedDirectoriesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsDescribeSharedDirectoriesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// Returns the identifier of the directory in the directory owner ac- count. Constraints: o pattern: ^d-[0-9a-f]{10}$
    /// </summary>
    [CliOption("--owner-directory-id")]
    public string? OwnerDirectoryId { get; private init; }
