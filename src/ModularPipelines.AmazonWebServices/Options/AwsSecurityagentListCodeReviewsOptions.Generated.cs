...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/securityagent/list-code-reviews/index.html
...
[CliSubCommand("securityagent", "list-code-reviews")]
public record AwsSecurityagentListCodeReviewsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a paginated list of code review summaries for the specified agent space. See also: AWS API Documentation list-code-reviews is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: codeReviewSummaries
    /// </summary>
    /// <param name="AgentSpaceId">The unique identifier of the agent space to list code reviews for.</param>
    public AwsSecurityagentListCodeReviewsOptions(
        string AgentSpaceId
    )
    {
    ...
    private AwsSecurityagentListCodeReviewsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSecurityagentListCodeReviewsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSecurityagentListCodeReviewsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
