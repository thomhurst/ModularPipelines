...
public record AwsFinspaceGetKxVolumeOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsFinspaceGetKxVolumeOptions(
    ...
    private AwsFinspaceGetKxVolumeOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsFinspaceGetKxVolumeOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsFinspaceGetKxVolumeOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
