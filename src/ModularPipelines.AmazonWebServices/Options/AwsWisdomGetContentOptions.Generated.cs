...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/wisdom/get-content/index.html
...
[CliSubCommand("wisdom", "get-content")]
public record AwsWisdomGetContentOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWisdomGetContentOptions(
        string ContentId,
    ...
    private AwsWisdomGetContentOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWisdomGetContentOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWisdomGetContentOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
