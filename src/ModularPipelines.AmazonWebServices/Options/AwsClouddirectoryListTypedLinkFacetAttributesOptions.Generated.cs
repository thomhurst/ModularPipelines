...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/list-typed-link-facet-attributes/index.html
...
[CliSubCommand("clouddirectory", "list-typed-link-facet-attributes")]
public record AwsClouddirectoryListTypedLinkFacetAttributesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsClouddirectoryListTypedLinkFacetAttributesOptions(
        string SchemaArn,
        string Name
    )
    {
    ...
    private AwsClouddirectoryListTypedLinkFacetAttributesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsClouddirectoryListTypedLinkFacetAttributesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsClouddirectoryListTypedLinkFacetAttributesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
