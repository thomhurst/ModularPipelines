...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connect/list-prompts/index.html
...
[CliSubCommand("connect", "list-prompts")]
public record AwsConnectListPromptsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectListPromptsOptions(
        string InstanceId
    )
    {
    ...
    private AwsConnectListPromptsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectListPromptsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectListPromptsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
