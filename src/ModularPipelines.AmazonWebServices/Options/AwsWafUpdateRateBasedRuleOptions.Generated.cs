...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/waf/update-rate-based-rule/index.html
...
[CliSubCommand("waf", "update-rate-based-rule")]
public record AwsWafUpdateRateBasedRuleOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWafUpdateRateBasedRuleOptions(
        string RuleId,
        string ChangeToken,
    ...
    private AwsWafUpdateRateBasedRuleOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWafUpdateRateBasedRuleOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWafUpdateRateBasedRuleOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
