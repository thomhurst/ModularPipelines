...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-verified-access-trust-providers/index.html
...
[CliSubCommand("ec2", "describe-verified-access-trust-providers")]
public record AwsEc2DescribeVerifiedAccessTrustProvidersOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the Verified Access trust providers. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--verified-access-trust-provider-ids", GroupValues = true)]
    public IEnumerable<string>? VerifiedAccessTrustProviderIds { get; set; }
