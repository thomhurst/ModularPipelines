...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-managed-integrations/list-connector-destinations/index.html
...
[CliSubCommand("iot-managed-integrations", "list-connector-destinations")]
public record AwsIotManagedIntegrationsListConnectorDestinationsOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the cloud connector to filter connector destina- tions by. Constraints: o min: 1 o max: 64 o pattern: [A-Za-z0-9-_]+
    /// </summary>
