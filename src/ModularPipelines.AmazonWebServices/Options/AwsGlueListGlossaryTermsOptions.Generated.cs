...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/list-glossary-terms/index.html
...
[CliSubCommand("glue", "list-glossary-terms")]
public record AwsGlueListGlossaryTermsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Lists glossary terms within a business glossary in Glue Data Catalog. See also: AWS API Documentation list-glossary-terms is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: Items
    /// </summary>
    /// <param name="GlossaryIdentifier">The unique identifier of the glossary whose terms to list.</param>
    public AwsGlueListGlossaryTermsOptions(
    ...
    private AwsGlueListGlossaryTermsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueListGlossaryTermsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueListGlossaryTermsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
