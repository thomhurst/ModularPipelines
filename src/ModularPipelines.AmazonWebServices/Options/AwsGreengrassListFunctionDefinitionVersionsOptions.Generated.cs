...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/greengrass/list-function-definition-versions/index.html
...
[CliSubCommand("greengrass", "list-function-definition-versions")]
public record AwsGreengrassListFunctionDefinitionVersionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGreengrassListFunctionDefinitionVersionsOptions(
    ...
    private AwsGreengrassListFunctionDefinitionVersionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGreengrassListFunctionDefinitionVersionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGreengrassListFunctionDefinitionVersionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
