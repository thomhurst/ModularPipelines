...
public record AwsCodestarConnectionsGetSyncConfigurationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCodestarConnectionsGetSyncConfigurationOptions(
        AwsCodestarConnectionsGetSyncConfigurationSyncType SyncType,
        string ResourceName
    )
    {
    ...
    private AwsCodestarConnectionsGetSyncConfigurationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodestarConnectionsGetSyncConfigurationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodestarConnectionsGetSyncConfigurationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--sync-type")]
    public AwsCodestarConnectionsGetSyncConfigurationSyncType? SyncType { get; private init; }
