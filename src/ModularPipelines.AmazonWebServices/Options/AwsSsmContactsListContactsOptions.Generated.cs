...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm-contacts/list-contacts/index.html
...
[CliSubCommand("ssm-contacts", "list-contacts")]
public record AwsSsmContactsListContactsOptions : AwsOptions
{
    /// <summary>
    /// Used to list only contacts who's aliases start with the specified prefix. Constraints: o min: 1 o max: 255 o pattern: ^[a-z0-9_\-]*$
    /// </summary>
    [CliOption("--alias-prefix")]
    public string? AliasPrefix { get; set; }

    /// <summary>
    /// The type of contact. Possible values: o PERSONAL o ESCALATION o ONCALL_SCHEDULE
    /// </summary>
    [CliOption("--type")]
    public AwsSsmContactsListContactsType? Type { get; set; }
