...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workspaces-web/create-data-protection-settings/index.html
...
[CliSubCommand("workspaces-web", "create-data-protection-settings")]
public record AwsWorkspacesWebCreateDataProtectionSettingsOptions : AwsOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The tags to add to the data protection settings resource. A tag is a key-value pair. Constraints: o min: 0 o max: 200 (structure) The tag. Key -&gt; (string) [required] The key of the tag. Constraints: o min: 1 o max: 128 o pattern: ([\p{L}\p{Z}\p{N}_.:/=+\-@]*) Value -&gt; (string) [required] The value of the tag Constraints: o min: 0 o max: 256 o pattern: ([\p{L}\p{Z}\p{N}_.:/=+\-@]*) Shorthand Syntax: Key=string,Value=string ... JSON Syntax: [ { "Key": "string", "Value": "string" } ... ]
    /// </summary>
    [CliOption("--tags")]
    public IEnumerable<string>? Tags { get; set; }

    /// <summary>
    /// The custom managed key of the data protection settings. Constraints: o min: 20 o max: 2048 o pattern: arn:[\w+=\/,.@-]+:kms:[a-zA-Z0-9\-]*:[a-zA-Z0-9]{1,12}:key\/[a-zA-Z0-9-]+
    /// </summary>
