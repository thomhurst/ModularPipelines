...
public record AwsLogsDescribeSubscriptionFiltersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLogsDescribeSubscriptionFiltersOptions(
        string LogGroupName
    )
    {
    ...
    private AwsLogsDescribeSubscriptionFiltersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLogsDescribeSubscriptionFiltersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLogsDescribeSubscriptionFiltersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
