...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune/modify-db-cluster-endpoint/index.html
...
[CliSubCommand("neptune", "modify-db-cluster-endpoint")]
public record AwsNeptuneModifyDbClusterEndpointOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNeptuneModifyDbClusterEndpointOptions(
    ...
    private AwsNeptuneModifyDbClusterEndpointOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNeptuneModifyDbClusterEndpointOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNeptuneModifyDbClusterEndpointOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
