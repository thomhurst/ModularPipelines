...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-scheduled-instances/index.html
...
[CliSubCommand("ec2", "describe-scheduled-instances")]
public record AwsEc2DescribeScheduledInstancesOptions : AwsOptions
{
    ...
    /// <summary>
    /// The Scheduled Instance IDs. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--scheduled-instance-ids", GroupValues = true)]
    public IEnumerable<string>? ScheduledInstanceIds { get; set; }

    /// <summary>
    /// The time period for the first schedule to start. EarliestTime -&gt; (timestamp) The earliest date and time, in UTC, for the Scheduled Instance to start. LatestTime -&gt; (timestamp) The latest date and time, in UTC, for the Scheduled Instance to start. Shorthand Syntax: EarliestTime=timestamp,LatestTime=timestamp JSON Syntax: { "EarliestTime": timestamp, "LatestTime": timestamp }
    /// </summary>
