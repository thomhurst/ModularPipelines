...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-recommender-filters/index.html
...
[CliSubCommand("customer-profiles", "list-recommender-filters")]
public record AwsCustomerProfilesListRecommenderFiltersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListRecommenderFiltersOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListRecommenderFiltersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListRecommenderFiltersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListRecommenderFiltersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
