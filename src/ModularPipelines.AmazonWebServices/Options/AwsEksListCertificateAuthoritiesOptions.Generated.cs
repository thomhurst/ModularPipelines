...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-certificate-authorities/index.html
...
[CliSubCommand("eks", "list-certificate-authorities")]
public record AwsEksListCertificateAuthoritiesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEksListCertificateAuthoritiesOptions(
        string ClusterName
    )
    {
    ...
    private AwsEksListCertificateAuthoritiesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEksListCertificateAuthoritiesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEksListCertificateAuthoritiesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
