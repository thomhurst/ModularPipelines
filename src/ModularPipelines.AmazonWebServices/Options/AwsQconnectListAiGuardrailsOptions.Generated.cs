...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/list-ai-guardrails/index.html
...
[CliSubCommand("qconnect", "list-ai-guardrails")]
public record AwsQconnectListAiGuardrailsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectListAiGuardrailsOptions(
        string AssistantId
    )
    {
    ...
    private AwsQconnectListAiGuardrailsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectListAiGuardrailsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectListAiGuardrailsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
