...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/get-branch/index.html
...
[CliSubCommand("amplify", "get-branch")]
public record AwsAmplifyGetBranchOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyGetBranchOptions(
        string AppId,
        string BranchName
    )
    {
    ...
    private AwsAmplifyGetBranchOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyGetBranchOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyGetBranchOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
