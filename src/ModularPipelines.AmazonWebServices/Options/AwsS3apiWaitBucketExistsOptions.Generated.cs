...
public record AwsS3apiWaitBucketExistsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3apiWaitBucketExistsOptions(
        string Bucket
    )
    {
    ...
    private AwsS3apiWaitBucketExistsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3apiWaitBucketExistsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3apiWaitBucketExistsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
