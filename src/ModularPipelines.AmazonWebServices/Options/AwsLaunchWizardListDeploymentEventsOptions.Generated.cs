...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/launch-wizard/list-deployment-events/index.html
...
[CliSubCommand("launch-wizard", "list-deployment-events")]
public record AwsLaunchWizardListDeploymentEventsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLaunchWizardListDeploymentEventsOptions(
        string DeploymentId
    )
    {
    ...
    private AwsLaunchWizardListDeploymentEventsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLaunchWizardListDeploymentEventsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLaunchWizardListDeploymentEventsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
