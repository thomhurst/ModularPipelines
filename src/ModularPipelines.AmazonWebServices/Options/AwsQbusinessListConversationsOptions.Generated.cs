...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qbusiness/list-conversations/index.html
...
[CliSubCommand("qbusiness", "list-conversations")]
public record AwsQbusinessListConversationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQbusinessListConversationsOptions(
    ...
    private AwsQbusinessListConversationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQbusinessListConversationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQbusinessListConversationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
