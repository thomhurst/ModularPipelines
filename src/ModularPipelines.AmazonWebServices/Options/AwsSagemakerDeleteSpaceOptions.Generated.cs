...
public record AwsSagemakerDeleteSpaceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSagemakerDeleteSpaceOptions(
        string DomainId,
        string SpaceName
    )
    {
    ...
    private AwsSagemakerDeleteSpaceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSagemakerDeleteSpaceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSagemakerDeleteSpaceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
