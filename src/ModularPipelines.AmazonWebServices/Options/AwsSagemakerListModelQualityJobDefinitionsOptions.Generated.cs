...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-model-quality-job-definitions/index.html
...
[CliSubCommand("sagemaker", "list-model-quality-job-definitions")]
public record AwsSagemakerListModelQualityJobDefinitionsOptions : AwsOptions
{
    /// <summary>
    /// A filter that returns only model quality monitoring job definitions that are associated with the specified endpoint. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
    /// </summary>
    ...
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListModelQualityJobDefinitionsSortBy? SortBy { get; set; }
    ...
    public AwsSagemakerListModelQualityJobDefinitionsSortOrder? SortOrder { get; set; }

    /// <summary>
    /// A string in the transform job name. This filter returns only model quality monitoring job definitions whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9\-]+
    /// </summary>
