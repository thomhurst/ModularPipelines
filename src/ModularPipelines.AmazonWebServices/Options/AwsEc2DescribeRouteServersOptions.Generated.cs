...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-route-servers/index.html
...
[CliSubCommand("ec2", "describe-route-servers")]
public record AwsEc2DescribeRouteServersOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the route servers to describe. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--route-server-ids", GroupValues = true)]
    public IEnumerable<string>? RouteServerIds { get; set; }
