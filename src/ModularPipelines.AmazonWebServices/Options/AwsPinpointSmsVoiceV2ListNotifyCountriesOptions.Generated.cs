...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/pinpoint-sms-voice-v2/list-notify-countries/index.html
...
[CliSubCommand("pinpoint-sms-voice-v2", "list-notify-countries")]
public record AwsPinpointSmsVoiceV2ListNotifyCountriesOptions : AwsOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The tier to filter the results by. Possible values: o BASIC o ADVANCED
    /// </summary>
    [CliOption("--tier")]
    public AwsPinpointSmsVoiceV2ListNotifyCountriesTier? Tier { get; set; }
