...
public record AwsTransferCreateConnectorOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsTransferCreateConnectorOptions(
        string AccessRole
    )
    {
    ...
    private AwsTransferCreateConnectorOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsTransferCreateConnectorOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsTransferCreateConnectorOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
