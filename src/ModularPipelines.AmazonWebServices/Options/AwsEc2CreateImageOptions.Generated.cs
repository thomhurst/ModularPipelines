...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-image/index.html
...
[CliSubCommand("ec2", "create-image")]
public record AwsEc2CreateImageOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="Name">A name for the new image. Constraints: 3-128 alphanumeric characters, parentheses (()), square brackets ([]), spaces ( ), periods (.), slashes (/), dashes (-), single quotes ('), at-signs (@), or underscores(_) Constraints: o min: 3 o max: 128</param>
    public AwsEc2CreateImageOptions(
        string InstanceId,
        string Name
    )
    {
    ...
    private AwsEc2CreateImageOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateImageOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateImageOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// A description for the new image. Constraints: o min: 0 o max: 255
    /// </summary>
