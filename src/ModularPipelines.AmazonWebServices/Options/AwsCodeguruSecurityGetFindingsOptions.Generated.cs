...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codeguru-security/get-findings/index.html
...
[CliSubCommand("codeguru-security", "get-findings")]
public record AwsCodeguruSecurityGetFindingsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Returns a list of all findings generated by a particular scan. See also: AWS API Documentation get-findings is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --out- put text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query ex- pressions: findings
    /// </summary>
    /// <param name="ScanName">The name of the scan you want to retrieve findings from. Constraints: o min: 1 o max: 140 o pattern: [a-zA-Z0-9-_$:.]*</param>
    public AwsCodeguruSecurityGetFindingsOptions(
        string ScanName
    )
    {
    ...
    private AwsCodeguruSecurityGetFindingsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodeguruSecurityGetFindingsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodeguruSecurityGetFindingsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the scan you want to retrieve findings from. Constraints: o min: 1 o max: 140 o pattern: [a-zA-Z0-9-_$:.]*
    /// </summary>
    [CliOption("--scan-name")]
    public string? ScanName { get; private init; }

    /// <summary>
    /// The status of the findings you want to get. Pass either Open , Closed , or All . Possible values: o Closed o Open o All
    /// </summary>
    [CliOption("--status")]
    public AwsCodeguruSecurityGetFindingsStatus? Status { get; set; }
