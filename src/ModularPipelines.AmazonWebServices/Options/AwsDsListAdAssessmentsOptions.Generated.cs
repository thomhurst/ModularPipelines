...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ds/list-ad-assessments/index.html
...
[CliSubCommand("ds", "list-ad-assessments")]
public record AwsDsListAdAssessmentsOptions : AwsOptions
{
    /// <summary>
    /// The identifier of the directory for which to list assessments. If not specified, all assessments in your account are returned. Constraints: o pattern: ^d-[0-9a-f]{10}$
    /// </summary>
