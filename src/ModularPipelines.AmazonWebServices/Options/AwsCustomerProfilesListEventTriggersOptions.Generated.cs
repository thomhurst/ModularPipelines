...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/customer-profiles/list-event-triggers/index.html
...
[CliSubCommand("customer-profiles", "list-event-triggers")]
public record AwsCustomerProfilesListEventTriggersOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCustomerProfilesListEventTriggersOptions(
        string DomainName
    )
    {
    ...
    private AwsCustomerProfilesListEventTriggersOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCustomerProfilesListEventTriggersOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCustomerProfilesListEventTriggersOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
