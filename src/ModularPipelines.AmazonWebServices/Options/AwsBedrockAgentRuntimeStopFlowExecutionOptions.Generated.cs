...
public record AwsBedrockAgentRuntimeStopFlowExecutionOptions : AwsOptions, IValidatableObject
{
    ...
    /// Stops an Amazon Bedrock flow's execution. This operation prevents fur- ther processing of the flow and changes the execution status to Aborted . See also: AWS API Documentation
    /// </summary>
    /// <param name="ExecutionIdentifier">The unique identifier of the flow execution to stop. Constraints: o min: 0 o max: 2048 o pattern: ^[a-zA-Z0-9-]{1,36}$|^(arn:aws:bedrock:[a-z0-9-]{1,20}:[0-9]{12}:flow/[0-9a-zA-Z]{10}/alias/[0-9a-zA-Z]{10}/ex- ecution/[a-zA-Z0-9-]{1,36})$</param>
    ...
    public AwsBedrockAgentRuntimeStopFlowExecutionOptions(
    ...
    private AwsBedrockAgentRuntimeStopFlowExecutionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsBedrockAgentRuntimeStopFlowExecutionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsBedrockAgentRuntimeStopFlowExecutionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique identifier of the flow execution to stop. Constraints: o min: 0 o max: 2048 o pattern: ^[a-zA-Z0-9-]{1,36}$|^(arn:aws:bedrock:[a-z0-9-]{1,20}:[0-9]{12}:flow/[0-9a-zA-Z]{10}/alias/[0-9a-zA-Z]{10}/ex- ecution/[a-zA-Z0-9-]{1,36})$
    /// </summary>
