...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/clouddirectory/list-facet-names/index.html
...
[CliSubCommand("clouddirectory", "list-facet-names")]
public record AwsClouddirectoryListFacetNamesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Retrieves the names of facets that exist in a schema. See also: AWS API Documentation list-facet-names is a paginated operation. Multiple API calls may be issued in order to retrieve the entire data set of results. You can disable pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: FacetNames
    /// </summary>
    /// <param name="SchemaArn">The Amazon Resource Name (ARN) to retrieve facet names from.</param>
    public AwsClouddirectoryListFacetNamesOptions(
        string SchemaArn
    )
    {
    ...
    private AwsClouddirectoryListFacetNamesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsClouddirectoryListFacetNamesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsClouddirectoryListFacetNamesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
