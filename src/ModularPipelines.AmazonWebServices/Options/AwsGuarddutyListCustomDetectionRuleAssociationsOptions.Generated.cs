...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/guardduty/list-custom-detection-rule-associations/index.html
...
[CliSubCommand("guardduty", "list-custom-detection-rule-associations")]
public record AwsGuarddutyListCustomDetectionRuleAssociationsOptions : AwsOptions
{
    /// <summary>
    /// The unique identifier for the custom detection rule to filter asso- ciations by. Constraints: o min: 1 o max: 100 o pattern: [a-z0-9]+(-[a-z0-9]+)*
    /// </summary>
    [CliOption("--rule-id")]
    public string? RuleId { get; set; }

    /// <summary>
    /// The rule execution mode to filter associations by. Possible values: o LIVE o DRY_RUN
    /// </summary>
    [CliOption("--mode")]
    public AwsGuarddutyListCustomDetectionRuleAssociationsMode? Mode { get; set; }
