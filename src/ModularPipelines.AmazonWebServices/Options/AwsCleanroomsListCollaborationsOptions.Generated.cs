...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cleanrooms/list-collaborations/index.html
...
[CliSubCommand("cleanrooms", "list-collaborations")]
public record AwsCleanroomsListCollaborationsOptions : AwsOptions
{
    /// <summary>
    /// The caller's status in a collaboration. Possible values: o INVITED o ACTIVE
    /// </summary>
    [CliOption("--member-status")]
    public AwsCleanroomsListCollaborationsMemberStatus? MemberStatus { get; set; }
