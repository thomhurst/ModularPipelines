...
public record AwsAppfabricDeleteIngestionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAppfabricDeleteIngestionOptions(
    ...
    private AwsAppfabricDeleteIngestionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAppfabricDeleteIngestionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAppfabricDeleteIngestionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
