...
public record AwsSagemakerUpdatePartnerAppOptions : AwsOptions, IValidatableObject
{
    ...
    /// Updates all of the SageMaker Partner AI Apps in an account. See also: AWS API Documentation
    /// </summary>
    /// <param name="Arn">The ARN of the SageMaker Partner AI App to update. Constraints: o min: 1 o max: 128 o pattern: arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:part- ner-app\/app-[A-Z0-9]{12}</param>
    public AwsSagemakerUpdatePartnerAppOptions(
        string Arn
    )
    {
    ...
    private AwsSagemakerUpdatePartnerAppOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSagemakerUpdatePartnerAppOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSagemakerUpdatePartnerAppOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The ARN of the SageMaker Partner AI App to update. Constraints: o min: 1 o max: 128 o pattern: arn:aws[a-z\-]*:sagemaker:[a-z0-9\-]*:[0-9]{12}:part- ner-app\/app-[A-Z0-9]{12}
    /// </summary>
    [CliOption("--arn")]
