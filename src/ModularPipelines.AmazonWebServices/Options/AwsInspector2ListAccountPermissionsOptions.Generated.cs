...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector2/list-account-permissions/index.html
...
[CliSubCommand("inspector2", "list-account-permissions")]
public record AwsInspector2ListAccountPermissionsOptions : AwsOptions
{
    /// <summary>
    /// The service scan type to check permissions for. Possible values: o EC2 o ECR o LAMBDA
    /// </summary>
    [CliOption("--service")]
    public AwsInspector2ListAccountPermissionsService? Service { get; set; }
