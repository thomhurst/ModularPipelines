...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/inspector/list-event-subscriptions/index.html
...
[CliSubCommand("inspector", "list-event-subscriptions")]
public record AwsInspectorListEventSubscriptionsOptions : AwsOptions
{
    /// <summary>
    /// The ARN of the assessment template for which you want to list the existing event subscriptions. Constraints: o min: 1 o max: 300
    /// </summary>
