...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/medialive/list-cloud-watch-alarm-template-groups/index.html
...
[CliSubCommand("medialive", "list-cloud-watch-alarm-template-groups")]
public record AwsMedialiveListCloudWatchAlarmTemplateGroupsOptions : AwsOptions
{
    [CliOption("--scope")]
    public string? Scope { get; set; }

    [CliOption("--signal-map-identifier")]
    public string? SignalMapIdentifier { get; set; }
