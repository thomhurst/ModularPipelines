...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/xray/list-tags-for-resource/index.html
...
[CliSubCommand("xray", "list-tags-for-resource")]
public record AwsXrayListTagsForResourceOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsXrayListTagsForResourceOptions(
        string ResourceArn
    )
    {
    ...
    private AwsXrayListTagsForResourceOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsXrayListTagsForResourceOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsXrayListTagsForResourceOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
