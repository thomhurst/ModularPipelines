...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workmail/list-personal-access-tokens/index.html
...
[CliSubCommand("workmail", "list-personal-access-tokens")]
public record AwsWorkmailListPersonalAccessTokensOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsWorkmailListPersonalAccessTokensOptions(
    ...
    private AwsWorkmailListPersonalAccessTokensOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWorkmailListPersonalAccessTokensOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWorkmailListPersonalAccessTokensOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The WorkMail User ID. Constraints: o min: 1 o max: 256 o pattern: [a-zA-Z0-9._%+@-]+
    /// </summary>
    [CliOption("--user-id")]
