...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/imagebuilder/list-image-packages/index.html
...
[CliSubCommand("imagebuilder", "list-image-packages")]
public record AwsImagebuilderListImagePackagesOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsImagebuilderListImagePackagesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsImagebuilderListImagePackagesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsImagebuilderListImagePackagesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
