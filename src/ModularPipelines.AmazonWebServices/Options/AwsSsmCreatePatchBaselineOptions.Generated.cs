...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ssm/create-patch-baseline/index.html
...
public record AwsSsmCreatePatchBaselineOptions : AwsOptions
{
    ...
    /// <summary>
    /// Defines the compliance level for approved patches. When an approved patch is reported as missing, this value describes the severity of the compliance violation. The default value is UNSPECIFIED . Possible values: o CRITICAL o HIGH o MEDIUM o LOW o INFORMATIONAL o UNSPECIFIED
    /// </summary>
    ...
    public AwsSsmCreatePatchBaselineRejectedPatchesAction? RejectedPatchesAction { get; set; }
    ...
    public AwsSsmCreatePatchBaselineAvailableSecurityUpdatesComplianceStatus? AvailableSecurityUpdatesComplianceStatus { get; set; }
