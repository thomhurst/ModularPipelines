...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/glue/get-triggers/index.html
...
[CliSubCommand("glue", "get-triggers")]
public record AwsGlueGetTriggersOptions : AwsOptions
{
    /// <summary>
    /// The name of the job to retrieve triggers for. The trigger that can start this job is returned, and if there is no such trigger, all triggers are returned. Constraints: o min: 1 o max: 255 o pattern: [\u0020-\uD7FF\uE000-\uFFFD\uD800\uDC00-\uDBFF\uDFFF\t]*
    /// </summary>
