...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/apigatewayv2/list-product-rest-endpoint-pages/index.html
...
[CliSubCommand("apigatewayv2", "list-product-rest-endpoint-pages")]
public record AwsApigatewayv2ListProductRestEndpointPagesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayv2ListProductRestEndpointPagesOptions(
    ...
    private AwsApigatewayv2ListProductRestEndpointPagesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayv2ListProductRestEndpointPagesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayv2ListProductRestEndpointPagesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
