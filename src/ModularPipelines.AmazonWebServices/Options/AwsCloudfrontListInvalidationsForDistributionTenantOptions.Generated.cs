...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/list-invalidations-for-distribution-tenant/index.html
...
[CliSubCommand("cloudfront", "list-invalidations-for-distribution-tenant")]
public record AwsCloudfrontListInvalidationsForDistributionTenantOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCloudfrontListInvalidationsForDistributionTenantOptions(
        string Id
    )
    {
    ...
    private AwsCloudfrontListInvalidationsForDistributionTenantOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCloudfrontListInvalidationsForDistributionTenantOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCloudfrontListInvalidationsForDistributionTenantOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
