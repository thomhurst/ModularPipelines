...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/odb/list-autonomous-database-versions/index.html
...
[CliSubCommand("odb", "list-autonomous-database-versions")]
public record AwsOdbListAutonomousDatabaseVersionsOptions : AwsOptions
{
    /// <summary>
    /// The intended use of the Autonomous Database to return versions for, such as transaction processing, data warehouse, JSON database, or APEX. Possible values: o OLTP o AJD o APEX o LH
    /// </summary>
    [CliOption("--db-workload")]
    public AwsOdbListAutonomousDatabaseVersionsDbWorkload? DbWorkload { get; set; }
