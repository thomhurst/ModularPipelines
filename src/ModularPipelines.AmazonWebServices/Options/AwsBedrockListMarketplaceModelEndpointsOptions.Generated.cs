...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/bedrock/list-marketplace-model-endpoints/index.html
...
[CliSubCommand("bedrock", "list-marketplace-model-endpoints")]
public record AwsBedrockListMarketplaceModelEndpointsOptions : AwsOptions
{
    /// <summary>
    /// If specified, only endpoints for the given model source identifier are returned. Constraints: o min: 0 o max: 2048 o pattern: .*arn:aws:sagemaker:.*:hub-content/SageMakerPub- licHub/Model/.*
    /// </summary>
    [CliOption("--model-source-equals")]
