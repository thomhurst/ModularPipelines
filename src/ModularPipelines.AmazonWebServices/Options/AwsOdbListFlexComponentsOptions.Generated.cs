...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/odb/list-flex-components/index.html
...
[CliSubCommand("odb", "list-flex-components")]
public record AwsOdbListFlexComponentsOptions : AwsOptions
{
    /// <summary>
    /// The shape to return flex components for. For a list of valid shapes, use the ListDbSystemShapes operation. Constraints: o min: 1 o max: 256
    /// </summary>
    [CliOption("--shape")]
