...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/describe-folder-permissions/index.html
...
[CliSubCommand("quicksight", "describe-folder-permissions")]
public record AwsQuicksightDescribeFolderPermissionsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightDescribeFolderPermissionsOptions(
        string AwsAccountId,
        string FolderId
    )
    {
    ...
    private AwsQuicksightDescribeFolderPermissionsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightDescribeFolderPermissionsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightDescribeFolderPermissionsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
