...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-ipam-internet-registry-association-asns/index.html
...
[CliSubCommand("ec2", "get-ipam-internet-registry-association-asns")]
public record AwsEc2GetIpamInternetRegistryAssociationAsnsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2GetIpamInternetRegistryAssociationAsnsOptions(
    ...
    private AwsEc2GetIpamInternetRegistryAssociationAsnsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetIpamInternetRegistryAssociationAsnsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetIpamInternetRegistryAssociationAsnsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
