...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/qconnect/delete-assistant-association/index.html
...
[CliSubCommand("qconnect", "delete-assistant-association")]
public record AwsQconnectDeleteAssistantAssociationOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQconnectDeleteAssistantAssociationOptions(
    ...
    private AwsQconnectDeleteAssistantAssociationOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQconnectDeleteAssistantAssociationOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQconnectDeleteAssistantAssociationOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
