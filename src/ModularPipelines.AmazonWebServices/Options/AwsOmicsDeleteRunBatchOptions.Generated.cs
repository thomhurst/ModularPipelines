...
public record AwsOmicsDeleteRunBatchOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsOmicsDeleteRunBatchOptions(
        string BatchId
    )
    {
    ...
    private AwsOmicsDeleteRunBatchOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsOmicsDeleteRunBatchOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsOmicsDeleteRunBatchOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
