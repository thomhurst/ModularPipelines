...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/list-extensions/index.html
...
[CliSubCommand("appconfig", "list-extensions")]
public record AwsAppConfigListExtensionsOptions : AwsOptions
{
    /// <summary>
    /// The extension name. Constraints: o min: 1 o max: 64
    /// </summary>
    [CliOption("--name")]
