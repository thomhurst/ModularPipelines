...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/list-mitigation-actions/index.html
...
[CliSubCommand("iot", "list-mitigation-actions")]
public record AwsIotListMitigationActionsOptions : AwsOptions
{
    /// <summary>
    /// Specify a value to limit the result to mitigation actions with a specific action type. Possible values: o UPDATE_DEVICE_CERTIFICATE o UPDATE_CA_CERTIFICATE o ADD_THINGS_TO_THING_GROUP o REPLACE_DEFAULT_POLICY_VERSION o ENABLE_IOT_LOGGING o PUBLISH_FINDING_TO_SNS
    /// </summary>
    [CliOption("--action-type")]
    public AwsIotListMitigationActionsActionType? ActionType { get; set; }
