...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/eks/list-associated-access-policies/index.html
...
[CliSubCommand("eks", "list-associated-access-policies")]
public record AwsEksListAssociatedAccessPoliciesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEksListAssociatedAccessPoliciesOptions(
        string ClusterName,
        string PrincipalArn
    )
    {
    ...
    private AwsEksListAssociatedAccessPoliciesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEksListAssociatedAccessPoliciesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEksListAssociatedAccessPoliciesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
