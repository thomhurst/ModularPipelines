...
public record AwsGlueUpdateTableOptimizerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueUpdateTableOptimizerOptions(
        string CatalogId,
        string DatabaseName,
        string TableName,
        AwsGlueUpdateTableOptimizerType Type,
    ...
    private AwsGlueUpdateTableOptimizerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueUpdateTableOptimizerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueUpdateTableOptimizerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--type")]
    public AwsGlueUpdateTableOptimizerType? Type { get; private init; }
