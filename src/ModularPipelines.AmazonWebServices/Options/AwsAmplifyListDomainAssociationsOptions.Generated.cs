...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/amplify/list-domain-associations/index.html
...
[CliSubCommand("amplify", "list-domain-associations")]
public record AwsAmplifyListDomainAssociationsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsAmplifyListDomainAssociationsOptions(
        string AppId
    )
    {
    ...
    private AwsAmplifyListDomainAssociationsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsAmplifyListDomainAssociationsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsAmplifyListDomainAssociationsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
