...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/workdocs/describe-groups/index.html
...
[CliSubCommand("workdocs", "describe-groups")]
public record AwsWorkdocsDescribeGroupsOptions : AwsOptions, IValidatableObject
{
    ...
    /// Describes the groups specified by the query. Groups are defined by the underlying Active Directory. See also: AWS API Documentation describe-groups is a paginated operation. Multiple API calls may be is- sued in order to retrieve the entire data set of results. You can dis- able pagination by providing the --no-paginate argument. When using --output text and the --query argument on a paginated response, the --query argument must extract data from the results of the following query expressions: G...
    /// </summary>
    /// <param name="SearchQuery">A query to describe groups by group name. Constraints: o min: 1 o max: 512 o pattern: [\u0020-\uFFFF]+</param>
    public AwsWorkdocsDescribeGroupsOptions(
        string SearchQuery
    )
    {
    ...
    private AwsWorkdocsDescribeGroupsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsWorkdocsDescribeGroupsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsWorkdocsDescribeGroupsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// A query to describe groups by group name. Constraints: o min: 1 o max: 512 o pattern: [\u0020-\uFFFF]+
    /// </summary>
