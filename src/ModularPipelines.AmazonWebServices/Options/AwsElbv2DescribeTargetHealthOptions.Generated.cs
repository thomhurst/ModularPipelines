...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/elbv2/describe-target-health/index.html
...
[CliSubCommand("elbv2", "describe-target-health")]
public record AwsElbv2DescribeTargetHealthOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsElbv2DescribeTargetHealthOptions(
    ...
    private AwsElbv2DescribeTargetHealthOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsElbv2DescribeTargetHealthOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsElbv2DescribeTargetHealthOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
