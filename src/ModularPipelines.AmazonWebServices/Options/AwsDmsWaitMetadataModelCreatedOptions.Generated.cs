...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/dms/wait/metadata-model-created/index.html
...
[CliSubCommand("dms", "wait", "metadata-model-created")]
public record AwsDmsWaitMetadataModelCreatedOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDmsWaitMetadataModelCreatedOptions(
    ...
    private AwsDmsWaitMetadataModelCreatedOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDmsWaitMetadataModelCreatedOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDmsWaitMetadataModelCreatedOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
