...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-snapshot/index.html
...
[CliSubCommand("ec2", "create-snapshot")]
public record AwsEc2CreateSnapshotOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateSnapshotOptions(
        string VolumeId
    )
    {
    ...
    private AwsEc2CreateSnapshotOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateSnapshotOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateSnapshotOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
