...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/delete-knowledge-base/index.html
...
[CliSubCommand("quicksight", "delete-knowledge-base")]
public record AwsQuicksightDeleteKnowledgeBaseOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightDeleteKnowledgeBaseOptions(
        string AwsAccountId,
    ...
    private AwsQuicksightDeleteKnowledgeBaseOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightDeleteKnowledgeBaseOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightDeleteKnowledgeBaseOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
