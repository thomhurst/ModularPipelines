...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/wait/object-exists/index.html
...
[CliSubCommand("s3api", "wait", "object-exists")]
public record AwsS3apiWaitObjectExistsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3apiWaitObjectExistsOptions(
        string Bucket,
        string Key
    )
    {
    ...
    private AwsS3apiWaitObjectExistsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3apiWaitObjectExistsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3apiWaitObjectExistsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public AwsS3apiWaitObjectExistsRequestPayer? RequestPayer { get; set; }
    ...
    public AwsS3apiWaitObjectExistsChecksumMode? ChecksumMode { get; set; }
