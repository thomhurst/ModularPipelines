...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-customer-managed-policy-references-in-permission-set/index.html
...
[CliSubCommand("sso-admin", "list-customer-managed-policy-references-in-permission-set")]
public record AwsSsoAdminListCustomerManagedPolicyReferencesInPermissionSetOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminListCustomerManagedPolicyReferencesInPermissionSetOptions(
        string InstanceArn,
    ...
    private AwsSsoAdminListCustomerManagedPolicyReferencesInPermissionSetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListCustomerManagedPolicyReferencesInPermissionSetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListCustomerManagedPolicyReferencesInPermissionSetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
