...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/tnb/list-sol-network-operations/index.html
...
[CliSubCommand("tnb", "list-sol-network-operations")]
public record AwsTnbListSolNetworkOperationsOptions : AwsOptions
{
    /// <summary>
    /// Network instance id filter, to retrieve network operations associ- ated to a network instance. Constraints: o pattern: ^ni-[a-f0-9]{17}$
    /// </summary>
