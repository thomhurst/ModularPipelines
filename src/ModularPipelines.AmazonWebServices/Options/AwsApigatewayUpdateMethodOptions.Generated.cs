...
public record AwsApigatewayUpdateMethodOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsApigatewayUpdateMethodOptions(
        string RestApiId,
        string ResourceId,
        string HttpMethod
    )
    ...
    private AwsApigatewayUpdateMethodOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsApigatewayUpdateMethodOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsApigatewayUpdateMethodOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
