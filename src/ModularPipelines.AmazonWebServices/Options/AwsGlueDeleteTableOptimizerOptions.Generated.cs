...
public record AwsGlueDeleteTableOptimizerOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsGlueDeleteTableOptimizerOptions(
        string CatalogId,
        string DatabaseName,
        string TableName,
        AwsGlueDeleteTableOptimizerType Type
    )
    {
    ...
    private AwsGlueDeleteTableOptimizerOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsGlueDeleteTableOptimizerOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsGlueDeleteTableOptimizerOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// </summary>
    [CliOption("--type")]
    public AwsGlueDeleteTableOptimizerType? Type { get; private init; }
