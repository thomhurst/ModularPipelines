...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/personalize/list-batch-segment-jobs/index.html
...
[CliSubCommand("personalize", "list-batch-segment-jobs")]
public record AwsPersonalizeListBatchSegmentJobsOptions : AwsOptions
{
    /// <summary>
    /// The Amazon Resource Name (ARN) of the solution version that the batch segment jobs used to generate batch segments. Constraints: o max: 256 o pattern: arn:([a-z\d-]+):personalize:.*:.*:.+
    /// </summary>
