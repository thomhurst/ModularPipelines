...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/wait/db-snapshot-completed/index.html
...
[CliSubCommand("rds", "wait", "db-snapshot-completed")]
public record AwsRdsWaitDbSnapshotCompletedOptions : AwsOptions
{
    ...
    /// <summary>
    /// Specifies whether to include manual DB cluster snapshots that are public and can be copied or restored by any Amazon Web Services ac- count. By default, the public snapshots are not included. You can share a manual DB snapshot as public by using the ModifyDB- SnapshotAttribute API. This setting doesn't apply to RDS Custom.
    /// </summary>
