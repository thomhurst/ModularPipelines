...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/connectcampaignsv2/start-instance-onboarding-job/index.html
...
[CliSubCommand("connectcampaignsv2", "start-instance-onboarding-job")]
public record AwsConnectcampaignsv2StartInstanceOnboardingJobOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsConnectcampaignsv2StartInstanceOnboardingJobOptions(
    ...
    private AwsConnectcampaignsv2StartInstanceOnboardingJobOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsConnectcampaignsv2StartInstanceOnboardingJobOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsConnectcampaignsv2StartInstanceOnboardingJobOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
