...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sso-admin/list-application-access-scopes/index.html
...
[CliSubCommand("sso-admin", "list-application-access-scopes")]
public record AwsSsoAdminListApplicationAccessScopesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsSsoAdminListApplicationAccessScopesOptions(
    ...
    private AwsSsoAdminListApplicationAccessScopesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsSsoAdminListApplicationAccessScopesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsSsoAdminListApplicationAccessScopesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
