...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ivs/list-stream-keys/index.html
...
[CliSubCommand("ivs", "list-stream-keys")]
public record AwsIvsListStreamKeysOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsIvsListStreamKeysOptions(
        string ChannelArn
    )
    {
    ...
    private AwsIvsListStreamKeysOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIvsListStreamKeysOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIvsListStreamKeysOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
