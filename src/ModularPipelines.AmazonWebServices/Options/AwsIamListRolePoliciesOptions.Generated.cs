...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iam/list-role-policies/index.html
...
[CliSubCommand("iam", "list-role-policies")]
public record AwsIamListRolePoliciesOptions : AwsOptions, IValidatableObject
{
    ...
    private AwsIamListRolePoliciesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIamListRolePoliciesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIamListRolePoliciesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the role to list policies for. This parameter allows (through its regex pattern ) a string of char- acters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following charac- ters: _+=,.@- Constraints: o min: 1 o max: 64 o pattern: [\w+=,.@-]+
    /// </summary>
    [CliOption("--role-name")]
