...
public record AwsResiliencehubResolveAppVersionResourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsResiliencehubResolveAppVersionResourcesOptions(
        string AppArn,
        string AppVersion
    )
    {
    ...
    private AwsResiliencehubResolveAppVersionResourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsResiliencehubResolveAppVersionResourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsResiliencehubResolveAppVersionResourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
