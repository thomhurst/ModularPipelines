...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/sagemaker/list-labeling-jobs/index.html
...
[CliSubCommand("sagemaker", "list-labeling-jobs")]
public record AwsSagemakerListLabelingJobsOptions : AwsOptions
{
    ...
    /// <summary>
    /// A filter that returns only labeling jobs modified after the speci- fied time (timestamp).
    /// </summary>
    [CliOption("--last-modified-time-after")]
    public string? LastModifiedTimeAfter { get; set; }

    /// <summary>
    /// A filter that returns only labeling jobs modified before the speci- fied time (timestamp).
    /// </summary>
    [CliOption("--last-modified-time-before")]
    public string? LastModifiedTimeBefore { get; set; }

    /// <summary>
    /// A string in the labeling job name. This filter returns only labeling jobs whose name contains the specified string. Constraints: o min: 0 o max: 63 o pattern: [a-zA-Z0-9\-]+
    /// </summary>
    ...
    /// </summary>
    [CliOption("--sort-by")]
    public AwsSagemakerListLabelingJobsSortBy? SortBy { get; set; }

    /// <summary>
    /// The sort order for results. The default is Ascending . Possible values: o Ascending o Descending
    /// </summary>
    [CliOption("--sort-order")]
    public AwsSagemakerListLabelingJobsSortOrder? SortOrder { get; set; }

    /// <summary>
    /// A filter that retrieves only labeling jobs with a specific status. Possible values: o Initializing o InProgress o Completed o Failed o Stopping o Stopped
    /// </summary>
    [CliOption("--status-equals")]
    public AwsSagemakerListLabelingJobsStatusEquals? StatusEquals { get; set; }
