...
public record AwsDsDataUpdateUserOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsDsDataUpdateUserOptions(
        string DirectoryId,
    ...
    private AwsDsDataUpdateUserOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDsDataUpdateUserOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDsDataUpdateUserOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
