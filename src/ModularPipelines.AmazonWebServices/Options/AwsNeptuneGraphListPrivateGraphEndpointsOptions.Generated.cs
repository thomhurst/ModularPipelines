...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/neptune-graph/list-private-graph-endpoints/index.html
...
[CliSubCommand("neptune-graph", "list-private-graph-endpoints")]
public record AwsNeptuneGraphListPrivateGraphEndpointsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsNeptuneGraphListPrivateGraphEndpointsOptions(
    ...
    private AwsNeptuneGraphListPrivateGraphEndpointsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsNeptuneGraphListPrivateGraphEndpointsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsNeptuneGraphListPrivateGraphEndpointsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
