...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/transfer/list-profiles/index.html
...
[CliSubCommand("transfer", "list-profiles")]
public record AwsTransferListProfilesOptions : AwsOptions
{
    /// <summary>
    /// Indicates whether to list only LOCAL type profiles or only PARTNER type profiles. If not supplied in the request, the command lists all types of profiles. Possible values: o LOCAL o PARTNER
    /// </summary>
    [CliOption("--profile-type")]
    public AwsTransferListProfilesProfileType? ProfileType { get; set; }
