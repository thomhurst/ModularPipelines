...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/codecatalyst/list-source-repository-branches/index.html
...
[CliSubCommand("codecatalyst", "list-source-repository-branches")]
public record AwsCodecatalystListSourceRepositoryBranchesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsCodecatalystListSourceRepositoryBranchesOptions(
        string SpaceName,
        string ProjectName,
    ...
    private AwsCodecatalystListSourceRepositoryBranchesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsCodecatalystListSourceRepositoryBranchesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsCodecatalystListSourceRepositoryBranchesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
