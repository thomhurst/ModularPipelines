...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/quicksight/list-data-sources/index.html
...
[CliSubCommand("quicksight", "list-data-sources")]
public record AwsQuicksightListDataSourcesOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsQuicksightListDataSourcesOptions(
        string AwsAccountId
    )
    {
    ...
    private AwsQuicksightListDataSourcesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsQuicksightListDataSourcesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsQuicksightListDataSourcesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
