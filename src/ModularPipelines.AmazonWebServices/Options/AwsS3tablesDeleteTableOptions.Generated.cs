...
public record AwsS3tablesDeleteTableOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsS3tablesDeleteTableOptions(
    ...
    private AwsS3tablesDeleteTableOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsS3tablesDeleteTableOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsS3tablesDeleteTableOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
