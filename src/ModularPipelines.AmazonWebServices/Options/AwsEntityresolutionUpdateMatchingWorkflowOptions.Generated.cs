...
public record AwsEntityresolutionUpdateMatchingWorkflowOptions : AwsOptions, IValidatableObject
{
    ...
    /// Updates an existing matching workflow. The workflow must already exist for this operation to succeed. WARNING: For workflows where resolutionType is PROVIDER , incremental pro- cessing is not supported. See also: AWS API Documentation update-matching-workflow uses document type values. Document types fol- low the JSON data model where valid values are: strings, numbers, booleans, null, arrays, and objects. For command input, options and nested parameters that are labeled with the type document m...
    /// </summary>
    /// <param name="WorkflowName">The name of the workflow to be retrieved. Constraints: o min: 1 o max: 255 o pattern: [a-zA-Z_0-9-]*</param>
    ...
    public AwsEntityresolutionUpdateMatchingWorkflowOptions(
        string WorkflowName,
    ...
    private AwsEntityresolutionUpdateMatchingWorkflowOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEntityresolutionUpdateMatchingWorkflowOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEntityresolutionUpdateMatchingWorkflowOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The name of the workflow to be retrieved. Constraints: o min: 1 o max: 255 o pattern: [a-zA-Z_0-9-]*
    /// </summary>
