...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/macie2/list-classification-scopes/index.html
...
[CliSubCommand("macie2", "list-classification-scopes")]
public record AwsMacie2ListClassificationScopesOptions : AwsOptions
{
    /// <summary>
    /// The name of the classification scope to retrieve the unique identi- fier for.
    /// </summary>
    [CliOption("--name")]
