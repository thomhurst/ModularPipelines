...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rds/restore-db-cluster-from-snapshot/index.html
...
public record AwsRdsRestoreDbClusterFromSnapshotOptions : AwsOptions
{
    ...
    /// <summary>
    /// The name of the DB subnet group to use for the new DB cluster. Constraints: If supplied, must match the name of an existing DB sub- net group. Example: mydbsubnetgroup Valid for: Aurora DB clusters and Multi-AZ DB clusters
    /// </summary>
    ...
    /// <summary>
    /// The target backtrack window, in seconds. To disable backtracking, set this value to 0. NOTE: Currently, Backtrack is only supported for Aurora MySQL DB clus- ters. Default: 0 Constraints: o If specified, this value must be set to a number from 0 to 259,200 (72 hours). Valid for: Aurora DB clusters only
    /// </summary>
    ...
    /// <summary>
    /// The DB engine mode of the DB cluster, either provisioned or server- less . For more information, see CreateDBCluster . Valid for: Aurora DB clusters only
    /// </summary>
    ...
    /// <summary>
    /// The name of the DB cluster parameter group to associate with this DB cluster. If this argument is omitted, the default DB cluster parame- ter group for the specified engine is used. Constraints: o If supplied, must match the name of an existing default DB cluster parameter group. o Must be 1 to 255 letters, numbers, or hyphens. o First character must be a letter. o Can't end with a hyphen or contain two consecutive hyphens. Valid for: Aurora DB clusters and Multi-AZ DB clusters
    /// </summary>
