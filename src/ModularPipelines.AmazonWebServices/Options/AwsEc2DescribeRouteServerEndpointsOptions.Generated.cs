...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-route-server-endpoints/index.html
...
[CliSubCommand("ec2", "describe-route-server-endpoints")]
public record AwsEc2DescribeRouteServerEndpointsOptions : AwsOptions
{
    /// <summary>
    /// The IDs of the route server endpoints to describe. (string) Syntax: "string" "string" ...
    /// </summary>
    [CliOption("--route-server-endpoint-ids", GroupValues = true)]
    public IEnumerable<string>? RouteServerEndpointIds { get; set; }
