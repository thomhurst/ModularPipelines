...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/odb/list-db-system-shapes/index.html
...
[CliSubCommand("odb", "list-db-system-shapes")]
public record AwsOdbListDbSystemShapesOptions : AwsOptions
{
    /// <summary>
    /// The logical name of the AZ, for example, us-east-1a. This name varies depending on the account. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--availability-zone")]
    public string? AvailabilityZone { get; set; }

    /// <summary>
    /// The physical ID of the AZ, for example, use1-az4. This ID persists across accounts. Constraints: o min: 1 o max: 255
    /// </summary>
    [CliOption("--availability-zone-id")]
    public string? AvailabilityZoneId { get; set; }

    /// <summary>
    /// The shape family to filter results by. Constraints: o min: 1 o max: 255
    /// </summary>
