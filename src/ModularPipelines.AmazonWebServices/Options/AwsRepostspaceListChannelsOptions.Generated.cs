...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/repostspace/list-channels/index.html
...
[CliSubCommand("repostspace", "list-channels")]
public record AwsRepostspaceListChannelsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRepostspaceListChannelsOptions(
        string SpaceId
    )
    {
    ...
    private AwsRepostspaceListChannelsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRepostspaceListChannelsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRepostspaceListChannelsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
