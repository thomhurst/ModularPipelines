...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/list-graphql-apis/index.html
...
[CliSubCommand("appsync", "list-graphql-apis")]
public record AwsAppsyncListGraphqlApisOptions : AwsOptions
{
    ...
    /// </summary>
    [CliOption("--api-type")]
    public AwsAppsyncListGraphqlApisApiType? ApiType { get; set; }

    /// <summary>
    /// The account owner of the GraphQL API. Possible values: o CURRENT_ACCOUNT o OTHER_ACCOUNTS
    /// </summary>
    [CliOption("--owner")]
    public AwsAppsyncListGraphqlApisOwner? Owner { get; set; }
