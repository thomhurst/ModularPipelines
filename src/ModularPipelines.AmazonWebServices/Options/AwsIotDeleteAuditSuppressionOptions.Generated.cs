...
public record AwsIotDeleteAuditSuppressionOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsIotDeleteAuditSuppressionOptions(
        string CheckName,
    ...
    private AwsIotDeleteAuditSuppressionOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsIotDeleteAuditSuppressionOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsIotDeleteAuditSuppressionOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
