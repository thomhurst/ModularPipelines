...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/get-function-concurrency/index.html
...
[CliSubCommand("lambda", "get-function-concurrency")]
public record AwsLambdaGetFunctionConcurrencyOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaGetFunctionConcurrencyOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaGetFunctionConcurrencyOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaGetFunctionConcurrencyOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaGetFunctionConcurrencyOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
