...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot/get-behavior-model-training-summaries/index.html
...
[CliSubCommand("iot", "get-behavior-model-training-summaries")]
public record AwsIotGetBehaviorModelTrainingSummariesOptions : AwsOptions
{
    /// <summary>
    /// The name of the security profile. Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9:_-]+
    /// </summary>
