...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/migrationhuborchestrator/get-workflow-step/index.html
...
[CliSubCommand("migrationhuborchestrator", "get-workflow-step")]
public record AwsMigrationhuborchestratorGetWorkflowStepOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsMigrationhuborchestratorGetWorkflowStepOptions(
        string WorkflowId,
        string StepGroupId,
        string Id
    )
    ...
    private AwsMigrationhuborchestratorGetWorkflowStepOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsMigrationhuborchestratorGetWorkflowStepOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsMigrationhuborchestratorGetWorkflowStepOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
