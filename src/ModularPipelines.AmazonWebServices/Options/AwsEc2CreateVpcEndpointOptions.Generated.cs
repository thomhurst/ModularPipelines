...
public record AwsEc2CreateVpcEndpointOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsEc2CreateVpcEndpointOptions(
        string VpcId
    )
    {
    ...
    private AwsEc2CreateVpcEndpointOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateVpcEndpointOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateVpcEndpointOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
