...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/get-ipam-discovered-public-addresses/index.html
...
[CliSubCommand("ec2", "get-ipam-discovered-public-addresses")]
public record AwsEc2GetIpamDiscoveredPublicAddressesOptions : AwsOptions, IValidatableObject
{
    ...
    /// Gets the public IP addresses that have been discovered by IPAM. See also: AWS API Documentation
    /// </summary>
    /// <param name="IpamResourceDiscoveryId">An IPAM resource discovery ID.</param>
    /// <param name="AddressRegion">The Amazon Web Services Region for the IP address.</param>
    public AwsEc2GetIpamDiscoveredPublicAddressesOptions(
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(AddressRegion);
        this.AddressRegion = AddressRegion;
    }

    private AwsEc2GetIpamDiscoveredPublicAddressesOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2GetIpamDiscoveredPublicAddressesOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2GetIpamDiscoveredPublicAddressesOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public string? AddressRegion { get; private init; }
    ...
    /// <summary>
    /// The maximum number of IPAM discovered public addresses to return in one page of results. Constraints: o min: 5 o max: 1000
    /// </summary>
