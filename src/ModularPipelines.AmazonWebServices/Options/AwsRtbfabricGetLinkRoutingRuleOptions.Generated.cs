...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/rtbfabric/get-link-routing-rule/index.html
...
[CliSubCommand("rtbfabric", "get-link-routing-rule")]
public record AwsRtbfabricGetLinkRoutingRuleOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsRtbfabricGetLinkRoutingRuleOptions(
        string GatewayId,
        string LinkId,
        string RuleId
    )
    ...
    private AwsRtbfabricGetLinkRoutingRuleOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsRtbfabricGetLinkRoutingRuleOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsRtbfabricGetLinkRoutingRuleOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
