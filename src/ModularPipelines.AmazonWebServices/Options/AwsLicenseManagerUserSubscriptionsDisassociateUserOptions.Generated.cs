...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/license-manager-user-subscriptions/disassociate-user/index.html
...
[CliSubCommand("license-manager-user-subscriptions", "disassociate-user")]
public record AwsLicenseManagerUserSubscriptionsDisassociateUserOptions : AwsOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The Amazon Resource Name (ARN) of the user to disassociate from the EC2 instance. Constraints: o pattern: arn:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{1,63}:[a-z0-9-\.]{1,63}:[a-zA-Z0-9-\.]{1,510}/[a-zA-Z0-9-\.]{1,510}
    /// </summary>
    [CliOption("--instance-user-arn")]
