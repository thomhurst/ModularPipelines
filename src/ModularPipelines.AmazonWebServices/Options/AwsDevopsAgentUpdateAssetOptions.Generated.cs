...
public record AwsDevopsAgentUpdateAssetOptions : AwsOptions, IValidatableObject
{
    ...
    /// <param name="AssetId">The unique identifier of the asset to update Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9_.-]+</param>
    public AwsDevopsAgentUpdateAssetOptions(
        string AgentSpaceId,
        string AssetId
    )
    {
    ...
    private AwsDevopsAgentUpdateAssetOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsDevopsAgentUpdateAssetOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsDevopsAgentUpdateAssetOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    /// <summary>
    /// The unique identifier of the asset to update Constraints: o min: 1 o max: 128 o pattern: [a-zA-Z0-9_.-]+
    /// </summary>
    [CliOption("--asset-id")]
