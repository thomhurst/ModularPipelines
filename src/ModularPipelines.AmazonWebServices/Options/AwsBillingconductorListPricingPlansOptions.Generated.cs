...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/billingconductor/list-pricing-plans/index.html
...
[CliSubCommand("billingconductor", "list-pricing-plans")]
public record AwsBillingconductorListPricingPlansOptions : AwsOptions
{
    /// <summary>
    /// The preferred billing period to get pricing plan. Constraints: o pattern: \d{4}-(0?[1-9]|1[012])
    /// </summary>
    [CliOption("--billing-period")]
    public string? BillingPeriod { get; set; }

    /// <summary>
    /// A ListPricingPlansFilter that specifies the Amazon Resource Name (ARNs) of pricing plans to retrieve pricing plans information. Arns -&gt; (list) A list of pricing plan Amazon Resource Names (ARNs) to retrieve information. Constraints: o min: 1 o max: 100 (string) Constraints: o pattern: (arn:aws(-cn)?:billingconduc- tor::(aws|[0-9]{12}):pricingplan/)?(BasicPricing- Plan|Passthrough|[a-zA-Z0-9]{10}) Shorthand Syntax: Arns=string,string JSON Syntax: { "Arns": ["string", ...] }
    /// </summary>
    [CliOption("--filters")]
