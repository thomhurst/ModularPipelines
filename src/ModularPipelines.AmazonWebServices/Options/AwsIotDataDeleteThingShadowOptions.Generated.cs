...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/iot-data/delete-thing-shadow/index.html
...
public record AwsIotDataDeleteThingShadowOptions : AwsOptions
{
    ...
    public AwsIotDataDeleteThingShadowOptions(
        string ThingName,
        string Outfile
    )
    {
