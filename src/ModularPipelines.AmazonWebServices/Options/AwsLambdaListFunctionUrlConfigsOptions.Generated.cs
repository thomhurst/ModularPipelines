...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/list-function-url-configs/index.html
...
[CliSubCommand("lambda", "list-function-url-configs")]
public record AwsLambdaListFunctionUrlConfigsOptions : AwsOptions, IValidatableObject
{
    ...
    public AwsLambdaListFunctionUrlConfigsOptions(
        string FunctionName
    )
    {
    ...
    private AwsLambdaListFunctionUrlConfigsOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsLambdaListFunctionUrlConfigsOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsLambdaListFunctionUrlConfigsOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
