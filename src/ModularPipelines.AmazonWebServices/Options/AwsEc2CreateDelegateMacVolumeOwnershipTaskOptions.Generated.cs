...
// Source: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/create-delegate-mac-volume-ownership-task/index.html
...
[CliSubCommand("ec2", "create-delegate-mac-volume-ownership-task")]
public record AwsEc2CreateDelegateMacVolumeOwnershipTaskOptions : AwsOptions, IValidatableObject
{
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(MacCredentials);
        this.MacCredentials = MacCredentials;
    }

    private AwsEc2CreateDelegateMacVolumeOwnershipTaskOptions()
    {
        _requiresAlternateInput = true;
    }

    public static AwsEc2CreateDelegateMacVolumeOwnershipTaskOptions FromCliInputJson(string cliInputJson)
    {
        global::System.ArgumentException.ThrowIfNullOrWhiteSpace(cliInputJson);
        return new() { CliInputJson = cliInputJson };
    }

    public static AwsEc2CreateDelegateMacVolumeOwnershipTaskOptions ForCliSkeleton(string generateCliSkeleton = "input") =>
    ...
    public string? MacCredentials { get; private init; }
