...
public class TerraformState
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStateIdentitiesOptions(), cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> List(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStateListOptions(), cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Mv(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStateMvOptions(), cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Push(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStatePushOptions(), cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> ReplaceProvider(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStateReplaceProviderOptions(), cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Rm(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStateRmOptions(), cancellationToken);
    }
    ...
    public virtual async Task<CommandResult> Show(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new TerraformStateShowOptions(), cancellationToken);
    }
