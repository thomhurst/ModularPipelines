...
public record FluxBootstrapGiteaOptions : FluxOptions
{
    ...
    /// <summary>
    /// Gitea user or organization name
    /// </summary>
    ...
    /// <summary>
    /// if true, the owner is assumed to be a Gitea user; otherwise an org
    /// </summary>
    [CliFlag("--personal")]
    ...
    /// <summary>
    /// Gitea team and the access to be given to it(team:maintain). Defaults to maintainer access if no access level is specified (also accepts comma-separated values)
    /// </summary>
    ...
    public FluxBootstrapGiteaLogLevel? LogLevel { get; set; }
    ...
    public IEnumerable<FluxBootstrapGiteaSparseCheckout>? SparseCheckout { get; set; }

    /// <summary>
    /// SSH ECDSA public key curve (default p384)
    /// </summary>
    [CliOption("--ssh-ecdsa-curve", Format = OptionFormat.EqualsSeparated)]
    public FluxBootstrapGiteaSshEcdsaCurve? SshEcdsaCurve { get; set; }
    ...
    public FluxBootstrapGiteaSshKeyAlgorithm? SshKeyAlgorithm { get; set; }
