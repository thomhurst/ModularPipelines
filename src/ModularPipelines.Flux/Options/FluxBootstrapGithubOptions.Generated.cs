...
[CliSubCommand("bootstrap", "github")]
public record FluxBootstrapGithubOptions : FluxOptions
{
    ...
    /// <summary>
    /// if true, the owner is assumed to be a GitHub user; otherwise an org
    /// </summary>
    [CliFlag("--personal")]
    ...
    /// <summary>
    /// GitHub team and the access to be given to it(team:maintain). Defaults to maintainer access if no access level is specified (also accepts comma-separated values)
    /// </summary>
    ...
    public FluxBootstrapGithubLogLevel? LogLevel { get; set; }
    ...
    public IEnumerable<FluxBootstrapGithubSparseCheckout>? SparseCheckout { get; set; }

    /// <summary>
    /// SSH ECDSA public key curve (default p384)
    /// </summary>
    [CliOption("--ssh-ecdsa-curve", Format = OptionFormat.EqualsSeparated)]
    public FluxBootstrapGithubSshEcdsaCurve? SshEcdsaCurve { get; set; }
    ...
    public FluxBootstrapGithubSshKeyAlgorithm? SshKeyAlgorithm { get; set; }
