...
[CliSubCommand("bootstrap", "bitbucket-server")]
public record FluxBootstrapBitbucketServerOptions : FluxOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Bitbucket Server user or project name
    /// </summary>
    ...
    /// <summary>
    /// if true, the owner is assumed to be a Bitbucket Server user; otherwise a group
    /// </summary>
    [CliFlag("--personal")]
    public bool? Personal { get; set; }

    /// <summary>
    /// if true, the repository is setup or configured as private (default true)
    /// </summary>
    [CliOption("--private", Format = OptionFormat.EqualsSeparated)]
    public bool? Private { get; set; }

    /// <summary>
    /// if true, the deploy key is configured with read/write permissions
    /// </summary>
    [CliFlag("--read-write-key")]
    public bool? ReadWriteKey { get; set; }
    ...
    /// <summary>
    /// authentication username (default "git")
    /// </summary>
    ...
    public FluxBootstrapBitbucketServerLogLevel? LogLevel { get; set; }
    ...
    public IEnumerable<FluxBootstrapBitbucketServerSparseCheckout>? SparseCheckout { get; set; }

    /// <summary>
    /// SSH ECDSA public key curve (default p384)
    /// </summary>
    [CliOption("--ssh-ecdsa-curve", Format = OptionFormat.EqualsSeparated)]
    public FluxBootstrapBitbucketServerSshEcdsaCurve? SshEcdsaCurve { get; set; }
    ...
    public FluxBootstrapBitbucketServerSshKeyAlgorithm? SshKeyAlgorithm { get; set; }
