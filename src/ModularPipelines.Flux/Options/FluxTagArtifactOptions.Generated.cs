...
[CliSubCommand("tag", "artifact")]
public record FluxTagArtifactOptions : FluxOptions
{
    /// <summary>
    ...
    public FluxTagArtifactProvider? Provider { get; set; }

    /// <summary>
    /// tag name
    /// </summary>
    [CliOption("--tag", Format = OptionFormat.EqualsSeparated, AllowMultiple = true)]
