...
public record FluxBuildArtifactOptions : FluxOptions
{
    ...
    /// <summary>
    /// Path to where the artifact tgz file should be written. (default "artifact.tgz")
    /// </summary>
    ...
    /// </summary>
    [CliOption("--path", ShortForm = "-p", Format = OptionFormat.EqualsSeparated)]
