...
[CliSubCommand("list", "artifacts")]
public record FluxListArtifactsOptions : FluxOptions
{
    /// <summary>
    ...
    /// <summary>
    /// filter tags returned from the oci repository using regex
    /// </summary>
    [CliOption("--filter-regex", Format = OptionFormat.EqualsSeparated)]
    public string? FilterRegex { get; set; }

    /// <summary>
    /// filter tags returned from the oci repository using semver
    /// </summary>
    [CliOption("--filter-semver", Format = OptionFormat.EqualsSeparated)]
    ...
    public FluxListArtifactsProvider? Provider { get; set; }
