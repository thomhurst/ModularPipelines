...
[CliSubCommand("create", "source", "bucket")]
public record FluxCreateSourceBucketOptions : FluxOptions
{
    /// <summary>
    ...
    /// <summary>
    /// for when connecting to a non-TLS S3 HTTP endpoint
    /// </summary>
    [CliFlag("--insecure")]
    ...
    public FluxCreateSourceBucketProvider? Provider { get; set; }
