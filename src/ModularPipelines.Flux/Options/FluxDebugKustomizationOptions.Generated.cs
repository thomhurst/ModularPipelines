...
[CliSubCommand("debug", "kustomization")]
public record FluxDebugKustomizationOptions : FluxOptions
{
    ...
    /// <summary>
    /// print the status of the Flux Kustomization
    /// </summary>
    [CliFlag("--show-status")]
    public bool? ShowStatus { get; set; }

    /// <summary>
    /// print the final vars of the Flux Kustomization in dot env format
    /// </summary>
    [CliFlag("--show-vars")]
    public bool? ShowVars { get; set; }
