...
[CliSubCommand("create", "image", "update")]
public record FluxCreateImageUpdateOptions : FluxOptions
{
    /// <summary>
    /// the email to use for commit author
    /// </summary>
    [CliOption("--author-email", Format = OptionFormat.EqualsSeparated)]
    public string? AuthorEmail { get; set; }

    /// <summary>
    /// the name to use for commit author
    /// </summary>
    ...
    /// </summary>
    [CliOption("--checkout-branch", Format = OptionFormat.EqualsSeparated)]
    public string? CheckoutBranch { get; set; }

    /// <summary>
    /// a template for commit messages
    /// </summary>
    [CliOption("--commit-template", Format = OptionFormat.EqualsSeparated)]
    public string? CommitTemplate { get; set; }

    /// <summary>
    /// the namespace of the GitRepository resource, defaults to the ImageUpdateAutomation namespace
    /// </summary>
    [CliOption("--git-repo-namespace", Format = OptionFormat.EqualsSeparated)]
    public string? GitRepoNamespace { get; set; }

    /// <summary>
    /// path to the directory containing the manifests to be updated, defaults to the repository root
    /// </summary>
    [CliOption("--git-repo-path", Format = OptionFormat.EqualsSeparated)]
    public string? GitRepoPath { get; set; }

    /// <summary>
    /// the name of a GitRepository resource with details of the upstream Git repository
    /// </summary>
    [CliOption("--git-repo-ref", Format = OptionFormat.EqualsSeparated)]
