...
{
    /// <summary>
    /// replacement pattern (using capture groups from --filter-regex) to use for sorting
    /// </summary>
    [CliOption("--filter-extract", Format = OptionFormat.EqualsSeparated)]
    public string? FilterExtract { get; set; }

    /// <summary>
    /// regular expression pattern used to filter the image tags
    /// </summary>
    [CliOption("--filter-regex", Format = OptionFormat.EqualsSeparated)]
    ...
    /// </summary>
    [CliOption("--select-alpha", Format = OptionFormat.EqualsSeparated)]
    public string? SelectAlpha { get; set; }

    /// <summary>
    /// use numeric sorting to select image; either "asc" meaning select the last, or "desc" meaning select the first
    /// </summary>
    [CliOption("--select-numeric", Format = OptionFormat.EqualsSeparated)]
    public string? SelectNumeric { get; set; }

    /// <summary>
    /// a semver range to apply to tags; e.g., '1.x'
    /// </summary>
    [CliOption("--select-semver", Format = OptionFormat.EqualsSeparated)]
    public string? SelectSemver { get; set; }
