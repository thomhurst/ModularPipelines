...
[CliSubCommand("create", "alert")]
public record FluxCreateAlertOptions : FluxOptions
{
    /// <summary>
    /// severity of events to send alerts for
    /// </summary>
    [CliOption("--event-severity", Format = OptionFormat.EqualsSeparated)]
    public string? EventSeverity { get; set; }

    /// <summary>
    /// sources that should generate alerts (&lt;kind&gt;/&lt;name&gt;), also accepts comma-separated values
    /// </summary>
    [CliOption("--event-source", Format = OptionFormat.EqualsSeparated, AllowMultiple = true)]
