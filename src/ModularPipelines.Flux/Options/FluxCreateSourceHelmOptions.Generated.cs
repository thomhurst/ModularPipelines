...
[CliSubCommand("create", "source", "helm")]
public record FluxCreateSourceHelmOptions : FluxOptions
{
    /// <summary>
    /// TLS authentication CA file path
    /// </summary>
    ...
    /// <summary>
    /// OCI provider for authentication
    /// </summary>
    [CliOption("--oci-provider", Format = OptionFormat.EqualsSeparated)]
    public string? OciProvider { get; set; }
