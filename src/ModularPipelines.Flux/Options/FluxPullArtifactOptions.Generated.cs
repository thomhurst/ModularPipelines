...
[CliSubCommand("pull", "artifact")]
public record FluxPullArtifactOptions : FluxOptions
{
    /// <summary>
    ...
    /// <summary>
    /// path where the artifact content should be extracted.
    /// </summary>
    ...
    public FluxPullArtifactProvider? Provider { get; set; }
