...
[CliSubCommand("logs")]
public record FluxLogsOptions : FluxOptions
{
    /// <summary>
    /// displays logs for objects across all namespaces
    /// </summary>
    [CliFlag("--all-namespaces", ShortForm = "-A")]
    public bool? AllNamespaces { get; set; }

    /// <summary>
    /// the namespace where the Flux components are running (default "flux-system")
    /// </summary>
    [CliOption("--flux-namespace", Format = OptionFormat.EqualsSeparated)]
    public string? FluxNamespace { get; set; }
    ...
    public FluxLogsLevel? Level { get; set; }

    /// <summary>
    /// specifies the name of the object logs to be displayed
    /// </summary>
    ...
    /// <summary>
    /// lines of recent log file to display (default -1)
    /// </summary>
