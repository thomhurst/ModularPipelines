...
[CliSubCommand("create", "secret", "helm")]
public record FluxCreateSecretHelmOptions : FluxOptions
{
    /// <summary>
    ...
    public string? TlsCrtFile { get; set; }

    /// <summary>
    /// TLS authentication key file path
    /// </summary>
    [CliOption("--tls-key-file", Format = OptionFormat.EqualsSeparated)]
