...
public record FluxBootstrapGitlabOptions : FluxOptions
{
    ...
    /// <summary>
    /// specifies the visibility of the repository (default private)
    /// </summary>
    [CliOption("--visibility", Format = OptionFormat.EqualsSeparated)]
    public FluxBootstrapGitlabVisibility? Visibility { get; set; }
    ...
    public FluxBootstrapGitlabLogLevel? LogLevel { get; set; }
    ...
    public FluxBootstrapGitlabSshEcdsaCurve? SshEcdsaCurve { get; set; }
    ...
    public FluxBootstrapGitlabSshKeyAlgorithm? SshKeyAlgorithm { get; set; }
