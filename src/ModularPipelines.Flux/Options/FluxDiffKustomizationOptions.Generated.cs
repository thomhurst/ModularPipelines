...
[CliSubCommand("diff", "kustomization")]
public record FluxDiffKustomizationOptions : FluxOptions
{
    ...
    /// </summary>
    [CliFlag("--in-memory-build")]
    public bool? InMemoryBuild { get; set; }

    /// <summary>
    /// Path to the Flux Kustomization YAML file.
    /// </summary>
    [CliOption("--kustomization-file", Format = OptionFormat.EqualsSeparated)]
    public string? KustomizationFile { get; set; }
    ...
    /// <summary>
    /// Boolean to set the progress bar. The default value is true. (default true)
    /// </summary>
    [CliOption("--progress-bar", Format = OptionFormat.EqualsSeparated)]
    ...
    /// </summary>
    [CliFlag("--strict-substitute")]
    public bool? StrictSubstitute { get; set; }
