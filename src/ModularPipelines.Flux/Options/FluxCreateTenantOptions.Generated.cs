...
[CliSubCommand("create", "tenant")]
public record FluxCreateTenantOptions : FluxOptions
{
    /// <summary>
    /// cluster role of the tenant role binding (default "cluster-admin")
    /// </summary>
    [CliOption("--cluster-role", Format = OptionFormat.EqualsSeparated)]
    ...
    /// <summary>
    /// service account belonging to this tenant
    /// </summary>
    [CliOption("--with-service-account", Format = OptionFormat.EqualsSeparated)]
    public string? WithServiceAccount { get; set; }
