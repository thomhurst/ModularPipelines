...
[CliSubCommand("store", "add")]
public record PnpmStoreAddOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmStoreAddReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmStoreAddLoglevel? Loglevel { get; set; }
