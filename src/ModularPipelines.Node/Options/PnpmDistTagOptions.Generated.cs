...
[CliSubCommand("dist-tag")]
public record PnpmDistTagOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmDistTagReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmDistTagLoglevel? Loglevel { get; set; }
