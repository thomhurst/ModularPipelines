...
public record PnpmRemoveOptions : PnpmOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Dependencies are not removed from `node_modules`. Only the manifest and `pnpm-lock.yaml` are updated
    /// </summary>
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmRemoveLoglevel? Loglevel { get; set; }
