...
public record PnpmUnpublishOptions : PnpmOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Removes the package from the registry regardless of what version is currently published. Without this flag, pnpm refuses to unpublish an entire package
    /// </summary>
    [CliFlag("--force")]
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmUnpublishReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmUnpublishLoglevel? Loglevel { get; set; }
