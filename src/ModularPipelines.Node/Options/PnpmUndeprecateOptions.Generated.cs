...
[CliSubCommand("undeprecate")]
public record PnpmUndeprecateOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmUndeprecateReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmUndeprecateLoglevel? Loglevel { get; set; }
