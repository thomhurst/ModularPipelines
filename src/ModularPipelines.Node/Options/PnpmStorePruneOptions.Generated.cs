...
[CliSubCommand("store", "prune")]
public record PnpmStorePruneOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmStorePruneReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmStorePruneLoglevel? Loglevel { get; set; }
