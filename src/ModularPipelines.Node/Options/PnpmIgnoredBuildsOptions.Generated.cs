...
[CliSubCommand("ignored-builds")]
public record PnpmIgnoredBuildsOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmIgnoredBuildsReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmIgnoredBuildsLoglevel? Loglevel { get; set; }
