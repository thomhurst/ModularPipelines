...
[CliSubCommand("get")]
public record PnpmGetOptions : PnpmOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Which config to read or write: `project` for the project's config, `global` for the global config
    /// </summary>
    [CliOption("--location")]
    public PnpmGetLocation? Location { get; set; }
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmGetReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmGetLoglevel? Loglevel { get; set; }
