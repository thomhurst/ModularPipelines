...
public record PnpmImportOptions : PnpmOptions
{
    /// <summary>
    /// URL of a pnpr server. Accepted for symmetry with the other installing commands; `pnpm import` always resolves locally
    /// </summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmImportReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmImportLoglevel? Loglevel { get; set; }
