...
public record PnpmRebuildOptions : PnpmOptions
{
    /// <summary>
    /// Rebuild packages that were not built during installation, such as under `--ignore-scripts`
    /// </summary>
    [CliFlag("--pending")]
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmRebuildReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmRebuildLoglevel? Loglevel { get; set; }
