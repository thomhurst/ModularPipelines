...
public record PnpmDlxOptions : PnpmOptions
{
    ...
    /// <summary>
    /// Package names allowed to run lifecycle (build) scripts during the dlx install. May be repeated
    /// </summary>
    ...
    /// <summary>
    /// libc families (`glibc`, `musl`) whose platform-tagged optional dependencies the dlx install should keep
    /// </summary>
    [CliOption("--libc")]
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmDlxLoglevel? Loglevel { get; set; }
