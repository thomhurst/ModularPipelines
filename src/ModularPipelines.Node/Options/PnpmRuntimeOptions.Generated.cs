...
[CliSubCommand("runtime")]
public record PnpmRuntimeOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmRuntimeReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmRuntimeLoglevel? Loglevel { get; set; }
