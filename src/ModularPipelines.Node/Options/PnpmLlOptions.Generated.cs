...
[CliSubCommand("ll")]
public record PnpmLlOptions : PnpmOptions
{
    ...
    /// <summary>
    /// Max display depth of the dependency tree. `0` lists direct dependencies only; `-1` lists projects only
    /// </summary>
    [CliOption("--depth")]
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmLlLoglevel? Loglevel { get; set; }
