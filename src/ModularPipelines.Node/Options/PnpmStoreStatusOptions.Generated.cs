...
[CliSubCommand("store", "status")]
public record PnpmStoreStatusOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmStoreStatusReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmStoreStatusLoglevel? Loglevel { get; set; }
