...
public record PnpmPkgSetOptions : PnpmOptions
{
    ...
    /// Sets a value in package.json
    /// </summary>
    /// <param name="Pairs">The &lt;PAIRS&gt; operand.</param>
    ...
    {
        {
            ...
            var materialized = global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Cast<string>(Pairs));
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmPkgSetLoglevel? Loglevel { get; set; }
