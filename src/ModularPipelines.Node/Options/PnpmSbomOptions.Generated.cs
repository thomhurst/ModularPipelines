...
) : PnpmOptions
{
    ...
    /// <summary>
    /// The `CycloneDX` specification version (`1.5`, `1.6`, or `1.7`; default: `1.7`). Only valid with `--sbom-format cyclonedx`
    /// </summary>
    ...
    /// </summary>
    [CliOption("--sbom-authors")]
    public string? SbomAuthors { get; set; }

    /// <summary>
    /// SBOM supplier name (`CycloneDX` `metadata.supplier`)
    /// </summary>
    [CliOption("--sbom-supplier")]
