...
[CliSubCommand("recursive")]
public record PnpmRecursiveOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmRecursiveReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmRecursiveLoglevel? Loglevel { get; set; }
