...
[CliSubCommand("store", "path")]
public record PnpmStorePathOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmStorePathReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmStorePathLoglevel? Loglevel { get; set; }
