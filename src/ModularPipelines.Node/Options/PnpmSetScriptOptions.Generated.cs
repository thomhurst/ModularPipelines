...
[CliSubCommand("set-script")]
public record PnpmSetScriptOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmSetScriptReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmSetScriptLoglevel? Loglevel { get; set; }
