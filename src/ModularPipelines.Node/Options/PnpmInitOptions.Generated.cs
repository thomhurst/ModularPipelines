...
public record PnpmInitOptions : PnpmOptions
{
    ...
    /// </summary>
    [CliOption("--init-type")]
    public PnpmInitInitType? InitType { get; set; }
    ...
    /// </summary>
    [CliFlag("--no-init-package-manager")]
    public bool? NoInitPackageManager { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmInitLoglevel? Loglevel { get; set; }
