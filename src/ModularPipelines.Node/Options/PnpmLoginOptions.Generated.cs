...
[CliSubCommand("login")]
public record PnpmLoginOptions : PnpmOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Associate the login token with a package scope and record the scope-to-registry mapping
    /// </summary>
    [CliOption("--scope")]
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmLoginReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmLoginLoglevel? Loglevel { get; set; }
