...
[CliSubCommand("pack-app")]
public record PnpmPackAppOptions : PnpmOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Target to build for. May be specified multiple times. Supported: linux-x64, linux-x64-musl, linux-arm64, linux-arm64-musl, darwin-x64, darwin-arm64, win32-x64, win32-arm64
    /// </summary>
    [CliOption("--target", ShortForm = "-t")]
    public IEnumerable<string>? Target { get; set; }

    /// <summary>
    /// Runtime to embed, as a `&lt;name&gt;@&lt;version&gt;` spec (e.g. `node@25`, `node@25.5.0`). Only `node` is supported, and the version must be &gt;= v25.5. Defaults to the minimum SEA-capable version (v25.5.0)
    /// </summary>
    [CliOption("--runtime")]
    ...
    /// </summary>
    [CliOption("--output-dir", ShortForm = "-o")]
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmPackAppLoglevel? Loglevel { get; set; }
