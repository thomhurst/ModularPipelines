...
{
    /// <summary>
    /// Package names allowed to run lifecycle (build) scripts during the install. May be repeated
    /// </summary>
    [CliOption("--allow-build")]
    public IEnumerable<string>? AllowBuild { get; set; }

    /// <summary>
    /// Run the command inside of a shell. Uses `/bin/sh` on UNIX and `cmd.exe` on Windows
    /// </summary>
    ...
    /// <summary>
    /// libc families (`glibc`, `musl`) whose platform-tagged optional dependencies the install should keep
    /// </summary>
    [CliOption("--libc")]
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmCreateReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmCreateLoglevel? Loglevel { get; set; }
