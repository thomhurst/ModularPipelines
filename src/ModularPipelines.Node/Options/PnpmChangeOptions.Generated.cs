...
[CliSubCommand("change")]
public record PnpmChangeOptions : PnpmOptions
{
    /// <summary>
    /// Bump type for the named packages: none, patch, minor, major. "none" records an explicit decline — the change needs no release
    /// </summary>
    [CliOption("--bump")]
    public string? Bump { get; set; }

    /// <summary>
    /// The summary for the changelog entry. Runs non-interactively when given together with package names
    /// </summary>
    [CliOption("--summary")]
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmChangeLoglevel? Loglevel { get; set; }
