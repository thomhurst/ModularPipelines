...
public record PnpmDeployOptions : PnpmOptions
{
    /// <summary>
    ...
    public PnpmDeployNodeLinker? NodeLinker { get; set; }
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmDeployReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmDeployLoglevel? Loglevel { get; set; }
    ...
    public IEnumerable<string>? DirArgument { get; set; }
