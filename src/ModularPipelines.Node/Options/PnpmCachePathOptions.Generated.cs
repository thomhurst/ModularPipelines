...
[CliSubCommand("cache", "path")]
public record PnpmCachePathOptions : PnpmOptions
{
    /// <summary>
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmCachePathReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmCachePathLoglevel? Loglevel { get; set; }
