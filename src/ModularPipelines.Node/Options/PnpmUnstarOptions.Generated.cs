...
public record PnpmUnstarOptions : PnpmOptions
{
    public PnpmUnstarOptions(
        string PackageName
    )
    {
    ...
    /// </summary>
    [CliOption("--reporter")]
    public PnpmUnstarReporter? Reporter { get; set; }
    ...
    /// </summary>
    [CliOption("--loglevel")]
    public PnpmUnstarLoglevel? Loglevel { get; set; }
