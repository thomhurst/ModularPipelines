...
{
    /// <summary>
    /// Converts <see cref="CommandExecutionOptions"/> to <see cref="CommandLineToolOptions"/> with the specified tool and arguments.
    /// </summary>
    ...
    public static CommandLineToolOptions ToCommandLineToolOptions(this CommandExecutionOptions options, string tool,
    ...
    /// <summary>
    /// Converts <see cref="CommandExecutionOptions"/> to <see cref="CommandLineToolOptions"/> with the specified tool and a single argument.
    /// </summary>
    /// <param name="options">The command execution options to convert.</param>
    /// <param name="tool">The name or path of the command-line tool.</param>
    ...
    /// <summary>
    /// Converts <see cref="CommandExecutionOptions"/> to <see cref="CommandLineToolOptions"/> with the specified tool and arguments array.
    /// </summary>
    /// <param name="options">The command execution options to convert.</param>
    /// <param name="tool">The name or path of the command-line tool.</param>
    /// <param name="arguments">An array of arguments to pass to the tool.</param>
    /// <returns>A new <see cref="CommandLineToolOptions"/> instance configured with the specified tool and arguments.</returns>
    public static CommandLineToolOptions ToCommandLineToolOptions(this CommandExecutionOptions options, string tool, string[] arguments)
    {
