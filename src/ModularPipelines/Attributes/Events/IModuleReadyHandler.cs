...
/// <summary>
/// Implement this interface on an attribute to handle module ready events.
...
/// </summary>
public interface IModuleReadyHandler
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="context">The hook context providing module information and timing data.</param>
