...
/// The non-generic <see cref="Module"/> uses <see cref="None"/> internally for modules
/// that perform actions without returning results. The non-generic <see cref="SyncModule"/>
/// provides the synchronous equivalent.
/// </remarks>
