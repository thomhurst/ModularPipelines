    ...
    DateTimeOffset claimedAt)
{
    ...
    public TimeSpan DependencyResultTransferDuration { get; set; }

    public TimeSpan DependencyResultProcessingDuration { get; set; }
    ...
    public DistributedModuleExecutionTelemetry CreateTelemetry()
    {
        ...
        return new DistributedModuleExecutionTelemetry
        {
            ...
            DependencyResultTransferDuration = DependencyResultTransferDuration,
