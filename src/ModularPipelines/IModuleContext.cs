...
public interface IModuleContext : IPipelineContext
{
    ...
    /// </para>
    /// <para>
    /// <b>Important:</b> Always declare dependencies using <see cref="DependsOnAttribute{T}"/>
    ...
    /// <seealso cref="DependsOnAttribute{T}"/>
    ...
    /// <see cref="DependsOnAttribute.Optional"/> on your dependency attribute
