...
internal class ModuleDisposeExecutor : IModuleDisposeExecutor
{
    ...
    public ModuleDisposeExecutor(IModuleDisposer moduleDisposer, IOptions<PipelineOptions> options, IModuleRetriever moduleRetriever, ILogger<ModuleDisposeExecutor> logger)
    {
