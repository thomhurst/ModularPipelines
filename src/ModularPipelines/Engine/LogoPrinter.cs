...
"""""""";
    ...
    public void PrintLogo()
    {
        ...
        if (console.Profile.Capabilities.Interactive && console.Profile.Width < 90)
        {
            console.Profile.Width = 90;
        }

        if (console.Profile.Width >= 90)
        {
            console.WriteLine(LargeAsciiLogo, new Style(Color.Turquoise2, null, Decoration.Bold));
        }
    }
}
