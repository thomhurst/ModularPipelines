...
internal class WinGet : IWinGet
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new FeaturesOptions(), null, token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new SettingsOptions(), null, token);
    }
