...
public record TrivyImageOptions : TrivyOptions
{
    ...
    /// <summary>
    /// unix domain socket path to use for docker scanning
    /// </summary>
    [CliOption("--docker-host", Format = OptionFormat.EqualsSeparated)]
    public string? DockerHost { get; set; }

    /// <summary>
    /// comma-separated list of what security issues to detect on container image configurations (allowed values: misconfig,secret)
    /// </summary>
    [CliOption("--image-config-scanners", Format = OptionFormat.EqualsSeparated, AllowMultiple = true)]
    public IEnumerable<TrivyImageImageConfigScanners>? ImageConfigScanners { get; set; }
    ...
    public IEnumerable<TrivyImageImageSrc>? ImageSrc { get; set; }
    ...
    /// <summary>
    /// [EXPERIMENTAL] maximum image size to process, specified in a human-readable format (e.g., '44kB', '17MB'); an error will be returned if the image exceeds this size
    /// </summary>
    [CliOption("--max-image-size", Format = OptionFormat.EqualsSeparated)]
    public string? MaxImageSize { get; set; }

    /// <summary>
    /// set platform in the form os/arch if image is multi-platform capable
    /// </summary>
    [CliOption("--platform", Format = OptionFormat.EqualsSeparated)]
    public string? Platform { get; set; }

    /// <summary>
    /// unix podman socket path to use for podman scanning
    /// </summary>
    [CliOption("--podman-host", Format = OptionFormat.EqualsSeparated)]
    public string? PodmanHost { get; set; }

    /// <summary>
    /// detect vulnerabilities of removed packages (only for Alpine)
    /// </summary>
    [CliFlag("--removed-pkgs")]
    public bool? RemovedPkgs { get; set; }
    ...
    public IEnumerable<TrivyImageRenderCause>? RenderCause { get; set; }
    ...
    public IEnumerable<TrivyImagePkgRelationships>? PkgRelationships { get; set; }
    ...
    public IEnumerable<TrivyImagePkgTypes>? PkgTypes { get; set; }
    ...
    /// <summary>
    /// compliance report to generate (built-in compliance's: docker-cis-1.6.0)
    /// </summary>
    ...
    public TrivyImageFormat? Format { get; set; }
    ...
    /// <summary>
    /// specify a format for the compliance report. (allowed values: all,summary) (default "summary")
    /// </summary>
    [CliOption("--report", Format = OptionFormat.EqualsSeparated)]
    public TrivyImageReport? Report { get; set; }
    ...
    public IEnumerable<TrivyImageSeverity>? Severity { get; set; }
    ...
    public IEnumerable<TrivyImageTableMode>? TableMode { get; set; }
    ...
    public TrivyImageDetectionPriority? DetectionPriority { get; set; }
    ...
    public IEnumerable<TrivyImageSbomSources>? SbomSources { get; set; }
    ...
    public IEnumerable<TrivyImageScanners>? Scanners { get; set; }
    ...
    public IEnumerable<TrivyImageIgnoreStatus>? IgnoreStatus { get; set; }
