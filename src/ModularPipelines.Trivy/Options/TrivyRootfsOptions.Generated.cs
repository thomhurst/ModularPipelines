...
public record TrivyRootfsOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string RootDirectory
) : TrivyOptions
{
    /// <summary>
    ...
    public IEnumerable<TrivyRootfsRenderCause>? RenderCause { get; set; }
    ...
    public IEnumerable<TrivyRootfsPkgRelationships>? PkgRelationships { get; set; }
    ...
    public IEnumerable<TrivyRootfsPkgTypes>? PkgTypes { get; set; }
    ...
    public TrivyRootfsFormat? Format { get; set; }
    ...
    public IEnumerable<TrivyRootfsSeverity>? Severity { get; set; }
    ...
    public IEnumerable<TrivyRootfsTableMode>? TableMode { get; set; }
    ...
    public TrivyRootfsDetectionPriority? DetectionPriority { get; set; }
    ...
    public IEnumerable<TrivyRootfsSbomSources>? SbomSources { get; set; }
    ...
    public IEnumerable<TrivyRootfsScanners>? Scanners { get; set; }
    ...
    public IEnumerable<TrivyRootfsIgnoreStatus>? IgnoreStatus { get; set; }
