...
public class GhLabel : IGhLabel
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GhLabelOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new GhLabelListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
