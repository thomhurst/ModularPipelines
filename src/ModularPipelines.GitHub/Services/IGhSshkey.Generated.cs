...
public interface IGhSshkey
{
    ...
    public Task<CommandResult> ExecuteAsync(GhSshKeyOptions options, CommandExecutionOptions? executionOptions = null, CancellationToken cancellationToken = default)
