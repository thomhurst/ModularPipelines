...
[CliCommand("eventgrid", "topic", "show")]
public class AzEventgridTopicShowEventgrid
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridTopicShowEventgridExtensionOptions(), cancellationToken: token);
    }
}