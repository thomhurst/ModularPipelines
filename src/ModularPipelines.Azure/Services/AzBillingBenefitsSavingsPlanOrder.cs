...
[CliSubCommand("billing-benefits")]
public class AzBillingBenefitsSavingsPlanOrder
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBillingBenefitsSavingsPlanOrderListOptions(), cancellationToken: token);
    }
