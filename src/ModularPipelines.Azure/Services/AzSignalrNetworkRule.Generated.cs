...
public class AzSignalrNetworkRule
{
    ...
    /// </summary>
    public AzSignalrNetworkRule(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> UpdateAsync(
        AzSignalrNetworkRuleUpdateOptions? options = null,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AzSignalrNetworkRuleUpdateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
