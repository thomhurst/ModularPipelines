...
public class AzNetworkPerimeterLink
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkPerimeterLinkDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkPerimeterLinkShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkPerimeterLinkUpdateOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Wait(AzNetworkPerimeterLinkWaitOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkPerimeterLinkWaitOptions(), cancellationToken: token);
    }
}