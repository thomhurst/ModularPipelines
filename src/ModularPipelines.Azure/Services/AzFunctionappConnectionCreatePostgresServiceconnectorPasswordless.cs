...
[CliCommand("functionapp", "connection", "create", "postgres")]
public class AzFunctionappConnectionCreatePostgresServiceconnectorPasswordless
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzFunctionappConnectionCreatePostgresServiceconnectorPasswordlessExtensionOptions(), cancellationToken: token);
    }
}