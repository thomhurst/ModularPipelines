...
public class AzPostgresFlexibleServerParameter
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzPostgresFlexibleServerParameterSetOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzPostgresFlexibleServerParameterShowOptions(), cancellationToken: token);
    }
}