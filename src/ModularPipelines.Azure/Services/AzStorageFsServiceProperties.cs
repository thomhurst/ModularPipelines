...
public class AzStorageFsServiceProperties
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzStorageFsServicePropertiesShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzStorageFsServicePropertiesUpdateOptions(), cancellationToken: token);
    }
}