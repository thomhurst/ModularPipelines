...
public class AzDatafactoryPipeline
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDatafactoryPipelineDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDatafactoryPipelineShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDatafactoryPipelineUpdateOptions(), cancellationToken: token);
    }
}