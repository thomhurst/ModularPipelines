...
public class AzFunctionappConfigAppSettings
{
    ...
    public virtual async Task<CommandResult> SetAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AzFunctionappConfigAppSettingsSetOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
