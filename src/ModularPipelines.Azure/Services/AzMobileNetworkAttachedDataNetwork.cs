...
public class AzMobileNetworkAttachedDataNetwork
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMobileNetworkAttachedDataNetworkDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMobileNetworkAttachedDataNetworkShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMobileNetworkAttachedDataNetworkUpdateOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMobileNetworkAttachedDataNetworkWaitOptions(), cancellationToken: token);
    }
}