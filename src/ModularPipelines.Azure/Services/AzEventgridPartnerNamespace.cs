...
public class AzEventgridPartnerNamespace
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridPartnerNamespaceDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridPartnerNamespaceListOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridPartnerNamespaceShowOptions(), cancellationToken: token);
    }
}