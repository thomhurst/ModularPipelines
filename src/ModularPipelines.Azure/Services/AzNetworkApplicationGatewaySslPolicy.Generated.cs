...
public class AzNetworkApplicationGatewaySslPolicy
{
    ...
    public virtual async Task<CommandResult> WaitAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AzNetworkApplicationGatewaySslPolicyWaitOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
