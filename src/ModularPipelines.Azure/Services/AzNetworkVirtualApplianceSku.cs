...
public class AzNetworkVirtualApplianceSku
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkVirtualApplianceSkuListOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkVirtualApplianceSkuShowOptions(), cancellationToken: token);
    }
}