...
public class AzContainerappGithubAction
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzContainerappGithubActionDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzContainerappGithubActionShowOptions(), cancellationToken: token);
    }
}