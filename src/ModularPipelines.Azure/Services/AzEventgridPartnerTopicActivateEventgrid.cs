...
[CliCommand("eventgrid", "partner", "topic", "activate")]
public class AzEventgridPartnerTopicActivateEventgrid
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridPartnerTopicActivateEventgridExtensionOptions(), cancellationToken: token);
    }
}