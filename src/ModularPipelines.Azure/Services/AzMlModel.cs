...
public class AzMlModel
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMlModelCreateOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMlModelListOptions(), cancellationToken: token);
    }
