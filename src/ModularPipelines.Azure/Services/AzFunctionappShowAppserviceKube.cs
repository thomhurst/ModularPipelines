...
public class AzFunctionappShowAppserviceKube
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzFunctionappShowAppserviceKubeExtensionOptions(), cancellationToken: token);
    }
}