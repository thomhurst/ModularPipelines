...
[CliCommand("capacity", "reservation")]
public class AzCapacityReservationGroup
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzCapacityReservationGroupDeleteOptions(), cancellationToken: token);
    }
