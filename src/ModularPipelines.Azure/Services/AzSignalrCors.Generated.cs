...
public class AzSignalrCors
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AzSignalrCors"/> class.
    /// </summary>
    public AzSignalrCors(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> AddAsync(
        AzSignalrCorsAddOptions options,
    ...
    public virtual async Task<CommandResult> ListAsync(
        AzSignalrCorsListOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken);
    ...
    public virtual async Task<CommandResult> RemoveAsync(
        AzSignalrCorsRemoveOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken);
    ...
    public virtual async Task<CommandResult> UpdateAsync(
        AzSignalrCorsUpdateOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken);
