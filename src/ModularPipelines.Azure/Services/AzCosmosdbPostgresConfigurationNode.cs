...
public class AzCosmosdbPostgresConfigurationNode
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzCosmosdbPostgresConfigurationNodeShowOptions(), null, cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzCosmosdbPostgresConfigurationNodeUpdateOptions(), null, cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzCosmosdbPostgresConfigurationNodeWaitOptions(), null, cancellationToken: token);
    }
}