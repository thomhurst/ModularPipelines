...
public class AzEventgridNamespaceCaCertificate
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridNamespaceCaCertificateDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridNamespaceCaCertificateShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridNamespaceCaCertificateUpdateOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridNamespaceCaCertificateWaitOptions(), cancellationToken: token);
    }
}