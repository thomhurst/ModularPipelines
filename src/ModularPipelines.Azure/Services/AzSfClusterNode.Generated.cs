...
public class AzSfClusterNode
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AzSfClusterNode"/> class.
    /// </summary>
    public AzSfClusterNode(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> AddAsync(
        AzSfClusterNodeAddOptions options,
    ...
    public virtual async Task<CommandResult> RemoveAsync(
        AzSfClusterNodeRemoveOptions options,
        CommandExecutionOptions? executionOptions = null,
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options, executionOptions, cancellationToken);
