...
public class AzDevcenterAdminPool
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDevcenterAdminPoolDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDevcenterAdminPoolRunHealthCheckOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Show(AzDevcenterAdminPoolShowOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDevcenterAdminPoolShowOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Update(AzDevcenterAdminPoolUpdateOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDevcenterAdminPoolUpdateOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Wait(AzDevcenterAdminPoolWaitOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDevcenterAdminPoolWaitOptions(), cancellationToken: token);
    }
}