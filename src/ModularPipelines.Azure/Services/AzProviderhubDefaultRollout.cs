...
public class AzProviderhubDefaultRollout
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzProviderhubDefaultRolloutDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzProviderhubDefaultRolloutShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzProviderhubDefaultRolloutStopOptions(), cancellationToken: token);
    }
}