...
public class AzAlertsManagementPrometheusRuleGroup
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzAlertsManagementPrometheusRuleGroupDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzAlertsManagementPrometheusRuleGroupListOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzAlertsManagementPrometheusRuleGroupShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzAlertsManagementPrometheusRuleGroupUpdateOptions(), cancellationToken: token);
    }
}