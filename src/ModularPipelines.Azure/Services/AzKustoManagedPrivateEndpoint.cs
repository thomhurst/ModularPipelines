...
public class AzKustoManagedPrivateEndpoint
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoManagedPrivateEndpointDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoManagedPrivateEndpointShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoManagedPrivateEndpointUpdateOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoManagedPrivateEndpointWaitOptions(), cancellationToken: token);
    }
}