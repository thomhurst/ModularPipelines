...
[CliCommand("network", "routeserver")]
public class AzNetworkRouteserverPeering
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkRouteserverPeeringDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkRouteserverPeeringListAdvertisedRoutesOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkRouteserverPeeringListLearnedRoutesOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkRouteserverPeeringShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkRouteserverPeeringUpdateOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkRouteserverPeeringWaitOptions(), cancellationToken: token);
    }
}