...
[CliCommand("kusto", "cluster", "start")]
public class AzKustoClusterStartKusto
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoClusterStartKustoExtensionOptions(), cancellationToken: token);
    }
}