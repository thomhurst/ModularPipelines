...
[CliCommand("kusto", "database", "delete")]
public class AzKustoDatabaseDeleteKusto
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoDatabaseDeleteKustoExtensionOptions(), cancellationToken: token);
    }
}