...
public class AzMonitorLogAnalyticsWorkspaceLinkedStorage
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMonitorLogAnalyticsWorkspaceLinkedStorageDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMonitorLogAnalyticsWorkspaceLinkedStorageShowOptions(), cancellationToken: token);
    }
}