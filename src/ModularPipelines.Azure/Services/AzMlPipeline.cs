...
public class AzMlPipeline
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMlPipelineCloneDraftOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMlPipelineListOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> ListDrafts(AzMlPipelineListDraftsOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMlPipelineListDraftsOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzMlPipelineUpdateDraftOptions(), cancellationToken: token);
    }
