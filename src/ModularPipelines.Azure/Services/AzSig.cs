...
public class AzSig
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzSigDeleteOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> List(AzSigListOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzSigListOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> ListCommunity(AzSigListCommunityOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzSigListCommunityOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzSigShowOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> ShowCommunity(AzSigShowCommunityOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzSigShowCommunityOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> ShowShared(AzSigShowSharedOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzSigShowSharedOptions(), cancellationToken: token);
    }
