...
[CliCommand("network", "manager", "connection")]
public class AzNetworkManagerConnectionSubscription
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkManagerConnectionSubscriptionDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkManagerConnectionSubscriptionListOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkManagerConnectionSubscriptionShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkManagerConnectionSubscriptionUpdateOptions(), cancellationToken: token);
    }
}