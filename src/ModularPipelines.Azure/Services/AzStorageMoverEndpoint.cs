...
public class AzStorageMoverEndpoint
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzStorageMoverEndpointDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzStorageMoverEndpointShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzStorageMoverEndpointWaitOptions(), cancellationToken: token);
    }
}