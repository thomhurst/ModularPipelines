...
public class AzDatashareTrigger
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDatashareTriggerDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDatashareTriggerShowOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Wait(AzDatashareTriggerWaitOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzDatashareTriggerWaitOptions(), cancellationToken: token);
    }
}