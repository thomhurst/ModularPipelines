...
public interface IAzFunctionapp
{
    ...
    public Task<CommandResult> CreateAsync(AzFunctionappCreateOptions options, CommandExecutionOptions? executionOptions = null, CancellationToken cancellationToken = default)
