...
public class AzNetworkVnetGatewayVpnClientIpsecPolicy
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AzNetworkVnetGatewayVpnClientIpsecPolicy"/> class.
    /// </summary>
    public AzNetworkVnetGatewayVpnClientIpsecPolicy(ICommandContext command)
    {
        _command = command;
    }
    ...
    public virtual async Task<CommandResult> WaitAsync(
        AzNetworkVnetGatewayVpnClientIpsecPolicyWaitOptions? options = null,
