...
public class AzNetworkFirewallNatRule
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkFirewallNatRuleDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkFirewallNatRuleShowOptions(), cancellationToken: token);
    }
}