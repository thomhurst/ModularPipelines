...
public class AzNetworkApplicationGatewaySslPolicy
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkApplicationGatewaySslPolicyListOptionsOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkApplicationGatewaySslPolicyWaitOptions(), cancellationToken: token);
    }
}