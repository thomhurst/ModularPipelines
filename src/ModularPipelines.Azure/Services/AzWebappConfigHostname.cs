...
public class AzWebappConfigHostname
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzWebappConfigHostnameAddOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzWebappConfigHostnameDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzWebappConfigHostnameGetExternalIpOptions(), cancellationToken: token);
    }
