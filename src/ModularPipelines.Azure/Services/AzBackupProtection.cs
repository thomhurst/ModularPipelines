...
public class AzBackupProtection
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBackupProtectionBackupNowOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> CheckVm(AzBackupProtectionCheckVmOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBackupProtectionCheckVmOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Disable(AzBackupProtectionDisableOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBackupProtectionDisableOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBackupProtectionUndeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBackupProtectionUpdateForVmOptions(), cancellationToken: token);
    }
}