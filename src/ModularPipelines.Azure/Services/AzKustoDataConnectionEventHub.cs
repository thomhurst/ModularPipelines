...
public class AzKustoDataConnectionEventHub
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoDataConnectionEventHubDataConnectionValidationOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzKustoDataConnectionEventHubUpdateOptions(), cancellationToken: token);
    }
}