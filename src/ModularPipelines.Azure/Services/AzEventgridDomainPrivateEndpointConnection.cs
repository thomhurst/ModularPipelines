...
public class AzEventgridDomainPrivateEndpointConnection
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridDomainPrivateEndpointConnectionDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridDomainPrivateEndpointConnectionShowOptions(), cancellationToken: token);
    }
}