...
[CliCommand("eventgrid", "domain", "list")]
public class AzEventgridDomainListEventgrid
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzEventgridDomainListEventgridExtensionOptions(), cancellationToken: token);
    }
}