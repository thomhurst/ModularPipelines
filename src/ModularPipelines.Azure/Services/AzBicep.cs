...
public class AzBicep
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBicepInstallOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBicepListVersionsOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBicepUninstallOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Upgrade(AzBicepUpgradeOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBicepUpgradeOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Version(AzBicepVersionOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzBicepVersionOptions(), cancellationToken: token);
    }
}