...
public class AzCosmosdbShowCosmosdbPreview
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzCosmosdbShowCosmosdbPreviewExtensionOptions(), cancellationToken: token);
    }
}