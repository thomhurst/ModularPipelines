...
public class AzNetworkDnsRecordSetCname
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkDnsRecordSetCnameDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkDnsRecordSetCnameShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetworkDnsRecordSetCnameUpdateOptions(), cancellationToken: token);
    }
}