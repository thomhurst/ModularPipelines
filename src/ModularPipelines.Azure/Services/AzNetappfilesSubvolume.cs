...
public class AzNetappfilesSubvolume
{
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetappfilesSubvolumeDeleteOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetappfilesSubvolumeShowOptions(), cancellationToken: token);
    }
    ...
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetappfilesSubvolumeUpdateOptions(), cancellationToken: token);
    }

    public async Task<CommandResult> Wait(AzNetappfilesSubvolumeWaitOptions? options = default, CancellationToken token = default)
    {
        return await _command.ExecuteCommandLineTool(options ?? new AzNetappfilesSubvolumeWaitOptions(), cancellationToken: token);
    }
}