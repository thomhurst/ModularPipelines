...
public class AzBatchPool
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AzBatchPoolCreateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new AzBatchPoolListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
