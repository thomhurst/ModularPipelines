...
[CommandPrecedingArguments("network", "watcher", "connection-monitor", "endpoint", "wait")]
public record AzNetworkWatcherConnectionMonitorEndpointWaitOptions : AzOptions
{
