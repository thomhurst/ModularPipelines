...
public record AzPostgresFlexibleServerCreateOptions : AzOptions
{
    ...
    /// <summary>
    /// The default database name for an elastic cluster. Only applicable when --cluster-option is set to ElasticCluster.
    /// </summary>
    ...
    /// <summary>
    /// Storage type for the server. Allowed values are Premium_LRS and PremiumV2_LRS. Default value is Premium_LRS.Must set iops and throughput if using PremiumV2_LRS.  Allowed values:
    /// </summary>
