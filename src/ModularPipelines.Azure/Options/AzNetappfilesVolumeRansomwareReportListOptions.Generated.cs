...
[CliSubCommand("netappfiles", "volume", "ransomware-report", "list")]
public record AzNetappfilesVolumeRansomwareReportListOptions : AzOptions
{
    /// <summary>
    /// List all ransomware reports for the volume.
    /// </summary>
    ...
    public AzNetappfilesVolumeRansomwareReportListOptions(
        string AccountName,
        string PoolName,
