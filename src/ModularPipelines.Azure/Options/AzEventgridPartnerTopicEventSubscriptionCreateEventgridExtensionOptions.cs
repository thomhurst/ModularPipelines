...
[CommandPrecedingArguments("eventgrid", "partner", "topic", "event-subscription", "create", "(eventgrid", "extension)")]
public record AzEventgridPartnerTopicEventSubscriptionCreateEventgridExtensionOptions(
