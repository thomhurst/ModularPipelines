...
public record AzStorageFileUrlOptions : AzOptions
{
    /// <summary>
    /// Create the url to access a file.
    /// </summary>
    /// <param name="Path">The path to the file/directory within the file share.</param>
    /// <param name="ShareName">The file share name.</param>
    public AzStorageFileUrlOptions(
        string Path,
        string ShareName
    )
    {
