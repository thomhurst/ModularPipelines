...
public record AzContainerappConnectionCreateCosmosGremlinOptions : AzOptions
{
    ...
    /// <summary>
    /// The client type used on the containerapp.  Allowed values: dotnet, dotnet-internal, java, nodejs, none, php, python.
    /// </summary>
    [CliFlag("--client-type")]
    ...
    [Obsolete("Use GraphValue instead.")]
    public bool? Graph
    {
        get => bool.TryParse(GraphValue, out var value) ? value : null;
        set => GraphValue = value?.ToString(global::System.Globalization.CultureInfo.InvariantCulture);
    }
