...
public record AzNetworkApplicationGatewayUrlPathMapRuleDeleteOptions : AzOptions
{
    ...
    public AzNetworkApplicationGatewayUrlPathMapRuleDeleteOptions(
        string GatewayName,
        string Name,
        string PathMapName,
    ...
    public void Deconstruct(out string GatewayName, out string Name, out string PathMapName, out string ResourceGroup)
    {
