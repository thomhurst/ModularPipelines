...
[CommandPrecedingArguments("spring-cloud", "application-configuration-service", "git", "repo", "list")]
public record AzSpringCloudApplicationConfigurationServiceGitRepoListOptions(
