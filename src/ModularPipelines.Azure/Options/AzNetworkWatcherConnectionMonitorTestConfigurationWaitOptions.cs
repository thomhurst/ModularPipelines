...
[CommandPrecedingArguments("network", "watcher", "connection-monitor", "test-configuration", "wait")]
public record AzNetworkWatcherConnectionMonitorTestConfigurationWaitOptions : AzOptions
{
    [CommandSwitch("--connection-monitor")]
