...
[CommandPrecedingArguments("networkcloud", "cluster", "baremetalmachinekeyset", "wait")]
public record AzNetworkcloudClusterBaremetalmachinekeysetWaitOptions : AzOptions
{
