...
{
    public AzAppservicePlanCreateOptions()
    ...
    [Obsolete("DefaultIdentity is no longer supported by the installed CLI and has no effect.")]
    public string? DefaultIdentity { get; set; }

    [Obsolete("EnrichedErrors is no longer supported by the installed CLI and has no effect.")]
    public bool? EnrichedErrors { get; set; }

    [Obsolete("InstallScript is no longer supported by the installed CLI and has no effect.")]
    public string? InstallScript { get; set; }

    [Obsolete("IsManagedInstance is no longer supported by the installed CLI and has no effect.")]
    public bool? IsManagedInstance { get; set; }

    [Obsolete("MiSystemAssigned is no longer supported by the installed CLI and has no effect.")]
    public bool? MiSystemAssigned { get; set; }

    [Obsolete("MiUserAssigned is no longer supported by the installed CLI and has no effect.")]
    public IEnumerable<string>? MiUserAssigned { get; set; }

    [Obsolete("RdpEnabled is no longer supported by the installed CLI and has no effect.")]
    public bool? RdpEnabled { get; set; }

    [Obsolete("RegistryAdapter is no longer supported by the installed CLI and has no effect.")]
    public string? RegistryAdapter { get; set; }

    [Obsolete("StorageMount is no longer supported by the installed CLI and has no effect.")]
    ...
    [Obsolete("Vnet is no longer supported by the installed CLI and has no effect.")]
    public string? Vnet { get; set; }

    [Obsolete("Use AppServiceEnvironment instead.")]
    public string? AppServiceEnvironmentValue
    {
        get => AppServiceEnvironment;
        set => AppServiceEnvironment = value;
    }
