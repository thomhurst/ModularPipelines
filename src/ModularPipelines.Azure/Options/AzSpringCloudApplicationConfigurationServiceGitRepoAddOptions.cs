...
[CommandPrecedingArguments("spring-cloud", "application-configuration-service", "git", "repo", "add")]
public record AzSpringCloudApplicationConfigurationServiceGitRepoAddOptions(
