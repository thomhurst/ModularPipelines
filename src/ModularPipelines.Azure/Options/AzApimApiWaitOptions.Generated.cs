...
public record AzApimApiWaitOptions : AzOptions
{
    /// <summary>
    /// Place the CLI in a waiting state until a condition of an apim api is met.
    /// </summary>
    ...
    public void Deconstruct(out string ApiId, out string Name, out string ResourceGroup)
    {
        ApiId = this.ApiId;
        Name = this.Name;
