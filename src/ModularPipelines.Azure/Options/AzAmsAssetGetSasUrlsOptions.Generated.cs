...
{
    /// <summary>
    /// Specifies the UTC datetime (Y-m-d'T'H:M:S'Z') at which the SAS becomes invalid. This must be less than 24 hours from the current time. Default: 2026-09-15 03:31:35.513561.
    /// </summary>
    [CliFlag("--expiry")]
