...
[CommandPrecedingArguments("palo-alto", "cloudngfw", "local-rulestack", "prefixlist", "wait")]
public record AzPaloAltoCloudngfwLocalRulestackPrefixlistWaitOptions : AzOptions
{
