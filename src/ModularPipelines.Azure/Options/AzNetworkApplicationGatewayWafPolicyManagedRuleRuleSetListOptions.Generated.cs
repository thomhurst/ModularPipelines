...
public record AzNetworkApplicationGatewayWafPolicyManagedRuleRuleSetListOptions : AzOptions
{
    /// <summary>
    /// List all managed rule
    /// </summary>
    ...
    public AzNetworkApplicationGatewayWafPolicyManagedRuleRuleSetListOptions(
        string PolicyName,
