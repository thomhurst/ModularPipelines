...
[CliSubCommand("storage", "account", "network-security-perimeter-configuration", "show")]
public record AzStorageAccountNetworkSecurityPerimeterConfigurationShowOptions : AzOptions
{
    /// <summary>
