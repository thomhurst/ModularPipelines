...
[CommandPrecedingArguments("synapse", "kusto", "attached-database-configuration", "wait")]
public record AzSynapseKustoAttachedDatabaseConfigurationWaitOptions : AzOptions
{
