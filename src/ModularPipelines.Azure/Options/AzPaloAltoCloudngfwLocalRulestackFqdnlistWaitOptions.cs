...
[CommandPrecedingArguments("palo-alto", "cloudngfw", "local-rulestack", "fqdnlist", "wait")]
public record AzPaloAltoCloudngfwLocalRulestackFqdnlistWaitOptions : AzOptions
{
