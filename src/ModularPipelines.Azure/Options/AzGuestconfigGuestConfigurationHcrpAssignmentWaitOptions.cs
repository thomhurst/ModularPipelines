...
[CommandPrecedingArguments("guestconfig", "guest-configuration-hcrp-assignment", "wait")]
public record AzGuestconfigGuestConfigurationHcrpAssignmentWaitOptions : AzOptions
{
