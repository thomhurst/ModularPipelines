...
[CliSubCommand("webapp", "connection", "create", "app-insights")]
public record AzWebappConnectionCreateAppInsightsOptions : AzOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The client type used on the webapp.  Allowed values: dotnet, dotnet-internal, go, java, nodejs, none, python.
    /// </summary>
    [CliFlag("--client-type")]
