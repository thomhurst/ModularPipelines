...
[CliSubCommand("functionapp", "connection", "create", "mongodb-atlas")]
public record AzFunctionappConnectionCreateMongodbAtlasOptions : AzOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The client type used on the functionapp.  Allowed values: django, dotnet, dotnet-internal, go, java, nodejs, none, php, python, ruby, springBoot.
    /// </summary>
    [CliFlag("--client-type")]
