...
[CommandPrecedingArguments("storage", "directory", "metadata", "show", "(storage-preview", "extension)")]
public record AzStorageDirectoryMetadataShowStoragePreviewExtensionOptions(
