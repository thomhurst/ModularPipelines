...
public record AzNetworkApplicationGatewayAuthCertUpdateOptions : AzOptions
{
    /// <summary>
    /// Update an authorization certificate.
    /// </summary>
    /// <param name="CertFile">Path to the certificate file.</param>
    ...
    public AzNetworkApplicationGatewayAuthCertUpdateOptions(
        string CertFile,
        string GatewayName,
        string Name,
    ...
    public void Deconstruct(out string CertFile, out string GatewayName, out string Name, out string ResourceGroup)
    {
