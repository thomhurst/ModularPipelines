...
[CommandPrecedingArguments("network", "firewall", "policy", "rule-collection-group", "collection", "rule", "add")]
public record AzNetworkFirewallPolicyRuleCollectionGroupCollectionRuleAddOptions(
