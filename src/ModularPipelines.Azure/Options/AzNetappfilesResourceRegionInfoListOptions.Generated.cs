...
[CliSubCommand("netappfiles", "resource", "region-info", "list")]
public record AzNetappfilesResourceRegionInfoListOptions : AzOptions
{
    /// <summary>
    /// List region specific information.
    /// </summary>
    ...
    public AzNetappfilesResourceRegionInfoListOptions(
        string Location
    )
    {
