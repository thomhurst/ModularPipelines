...
[CommandPrecedingArguments("spring-cloud", "application-configuration-service", "git", "repo", "remove")]
public record AzSpringCloudApplicationConfigurationServiceGitRepoRemoveOptions(
