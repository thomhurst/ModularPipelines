...
public record AzPostgresFlexibleServerGeoRestoreOptions : AzOptions
{
    ...
    public AzPostgresFlexibleServerGeoRestoreOptions(
        string Location,
        string SourceServer
    )
    {
    ...
    /// <summary>
    /// The point in time in UTC to restore from (ISO8601 format), e.g., 2026-03-22T18:20:22+00:00 The default value is set to current time.  Default: 2026-09-21T12:31:58+00:00.
    /// </summary>
