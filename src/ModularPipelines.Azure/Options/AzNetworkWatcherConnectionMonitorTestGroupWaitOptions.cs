...
[CommandPrecedingArguments("network", "watcher", "connection-monitor", "test-group", "wait")]
public record AzNetworkWatcherConnectionMonitorTestGroupWaitOptions : AzOptions
{
