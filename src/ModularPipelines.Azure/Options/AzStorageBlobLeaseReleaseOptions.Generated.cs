...
public record AzStorageBlobLeaseReleaseOptions : AzOptions
{
    /// <summary>
    /// Release the lease.
    /// </summary>
    ...
    public AzStorageBlobLeaseReleaseOptions(
        string BlobName,
    ...
    public void Deconstruct(out string BlobName, out string ContainerName, out string LeaseId)
    {
