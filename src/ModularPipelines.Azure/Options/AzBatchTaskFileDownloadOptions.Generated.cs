...
public record AzBatchTaskFileDownloadOptions : AzOptions
{
    /// <summary>
    /// Download the content of a Batch task file.
    /// </summary>
    ...
    public AzBatchTaskFileDownloadOptions(
        string Destination,
        string FilePath,
        string JobId,
        string TaskId
    ...
    public void Deconstruct(out string Destination, out string FilePath, out string JobId, out string TaskId)
    {
