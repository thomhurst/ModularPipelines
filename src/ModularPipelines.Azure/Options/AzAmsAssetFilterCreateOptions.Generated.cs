...
public record AzAmsAssetFilterCreateOptions : AzOptions
{
    ...
    /// <param name="Name">The name of the asset filter.</param>
    /// <param name="ResourceGroup">Name of resource group. You can configure the default group using `az configure --defaults group=&lt;name&gt;`.</param>
    public AzAmsAssetFilterCreateOptions(
        string AccountName,
        string AssetName,
        string Name,
    ...
    public void Deconstruct(out string AccountName, out string AssetName, out string Name, out string ResourceGroup)
    {
