...
public record AzNetworkVnetPeeringCreateOptions : AzOptions
{
    ...
    public AzNetworkVnetPeeringCreateOptions(
        string Name,
        string RemoteVnet,
    ...
    )
    {
        ...
        this.Name = Name;
        global::System.ArgumentNullException.ThrowIfNull(RemoteVnet);
    ...
    public void Deconstruct(out string Name, out string RemoteVnet, out string ResourceGroup, out string VnetName)
    {
        Name = this.Name;
        RemoteVnet = this.RemoteVnet;
    ...
    public string RemoteVnet { get; private init; }
