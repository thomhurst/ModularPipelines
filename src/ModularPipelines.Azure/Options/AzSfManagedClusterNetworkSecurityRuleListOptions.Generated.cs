...
[CliSubCommand("sf", "managed-cluster", "network-security-rule", "list")]
public record AzSfManagedClusterNetworkSecurityRuleListOptions : AzOptions
{
    /// <summary>
    /// List network security rules in a cluster.
    /// </summary>
    ...
    public AzSfManagedClusterNetworkSecurityRuleListOptions(
        string ClusterName,
