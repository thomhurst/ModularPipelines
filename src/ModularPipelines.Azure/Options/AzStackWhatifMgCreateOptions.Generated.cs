...
public record AzStackWhatifMgCreateOptions : AzOptions
{
    ...
    public void Deconstruct(out string ActionOnUnmanage, out string DenySettingsMode, out string Location, out string ManagementGroupId, out string Name, out string RetentionInterval, out string StackId)
    {
