...
public record AzEventhubsNamespaceApplicationGroupUpdateOptions : AzOptions
{
    ...
    /// <summary>
    /// Determines if Application Group is allowed to create connection with namespace or not. Once the isEnabled is set to false, all the existing connections of application group gets dropped and no new connections will be allowed. Allowed values: 0, 1, f, false, n, no, t, true, y, yes.
    /// </summary>
    ...
    /// </summary>
    [CliFlag("--application-group-name", ShortForm = "-n")]
    public bool? ApplicationGroupName { get; set; }
