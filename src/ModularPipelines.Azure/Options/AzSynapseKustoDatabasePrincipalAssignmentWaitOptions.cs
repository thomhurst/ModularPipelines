...
[CommandPrecedingArguments("synapse", "kusto", "database-principal-assignment", "wait")]
public record AzSynapseKustoDatabasePrincipalAssignmentWaitOptions : AzOptions
{
