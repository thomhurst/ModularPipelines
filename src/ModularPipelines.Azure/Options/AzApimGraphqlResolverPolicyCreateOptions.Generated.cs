...
public record AzApimGraphqlResolverPolicyCreateOptions : AzOptions
{
    ...
    /// <param name="ValuePath">Contents of the Policy as defined by the format.</param>
    ...
    )
    {
        ...
        global::System.ArgumentNullException.ThrowIfNull(ValuePath);
        this.ValuePath = ValuePath;
        global::System.ArgumentNullException.ThrowIfNull(ApiId);
        this.ApiId = ApiId;
    }

    public void Deconstruct(out string ResolverId, out string ResourceGroup, out string ServiceName, out string ValuePath, out string ApiId)
    {
    ...
    /// </summary>
    [CliOption("--value-path")]
    public string ValuePath { get; private init; }
