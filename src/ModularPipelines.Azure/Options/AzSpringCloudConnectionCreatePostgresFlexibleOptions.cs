...
[CommandPrecedingArguments("spring-cloud", "connection", "create", "postgres-flexible")]
public record AzSpringCloudConnectionCreatePostgresFlexibleOptions : AzOptions
{
    [CommandSwitch("--app")]
