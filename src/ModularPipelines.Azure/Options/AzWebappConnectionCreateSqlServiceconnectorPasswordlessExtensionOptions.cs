...
[CommandPrecedingArguments("webapp", "connection", "create", "sql", "(serviceconnector-passwordless", "extension)")]
public record AzWebappConnectionCreateSqlServiceconnectorPasswordlessExtensionOptions : AzOptions
{
