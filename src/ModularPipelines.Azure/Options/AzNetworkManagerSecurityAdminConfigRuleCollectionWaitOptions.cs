...
[CommandPrecedingArguments("network", "manager", "security-admin-config", "rule-collection", "wait")]
public record AzNetworkManagerSecurityAdminConfigRuleCollectionWaitOptions : AzOptions
{
