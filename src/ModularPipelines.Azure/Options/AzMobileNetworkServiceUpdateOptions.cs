...
[CommandPrecedingArguments("mobile-network", "service", "update")]
public record AzMobileNetworkServiceUpdateOptions : AzOptions
{
    ...
    [CommandSwitch("--pcc-rules")]
    public string? PccRules { get; set; }
    ...
    [CommandSwitch("--service-precedence")]
    public string? ServicePrecedence { get; set; }
