...
[CliSubCommand("webapp", "connection", "update", "cognitiveservices")]
public record AzWebappConnectionUpdateCognitiveservicesOptions : AzOptions
{
    /// <summary>
    ...
    /// <summary>
    /// The client type used on the webapp.  Allowed values: dotnet, none, python.
    /// </summary>
    [CliFlag("--client-type")]
