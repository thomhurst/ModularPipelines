...
public record AzStorageBlobLeaseChangeOptions : AzOptions
{
    /// <summary>
    /// Change the lease ID of an active lease.
    /// </summary>
    ...
    /// <param name="LeaseId">Required if the blob has an active lease.</param>
    ...
    public AzStorageBlobLeaseChangeOptions(
        string BlobName,
    ...
    public void Deconstruct(out string BlobName, out string ContainerName, out string LeaseId, out string ProposedLeaseId)
    {
