...
{
    /// <summary>
    /// Specifies the UTC datetime (Y-m-d'T'H:M:S'Z') at which the SAS becomes invalid. This must be less than 24 hours from the current time.  Default: 2026-01-04 12:26:19.587979.
    /// </summary>
    [CliFlag("--expiry")]
