...
internal partial class Packer : IPacker
{
    ...
    public virtual async Task<CommandResult> ConsoleAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PackerConsoleOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> FmtAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new PackerFmtOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
