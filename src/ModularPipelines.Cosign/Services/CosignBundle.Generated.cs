...
public class CosignBundle : ICosignBundle
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new CosignBundleOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> CreateAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new CosignBundleCreateOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
