...
[CliSubCommand("proj", "role", "create")]
public record ArgoCdProjRoleCreateOptions : ArgoCdOptions
{
    /// <summary>
    /// Create a project role
    /// </summary>
    ...
    public ArgoCdProjRoleCreateOptions(
        string Project,
        string RoleName
    )
    {
    ...
    public ArgoCdProjRoleCreateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleCreateLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleCreateRedisCompress? RedisCompress { get; set; }
