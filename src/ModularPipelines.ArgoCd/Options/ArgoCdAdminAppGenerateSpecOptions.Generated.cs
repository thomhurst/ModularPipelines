...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminAppGenerateSpecOutput? Output { get; set; }
    ...
    public ArgoCdAdminAppGenerateSpecLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminAppGenerateSpecLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminAppGenerateSpecRedisCompress? RedisCompress { get; set; }
