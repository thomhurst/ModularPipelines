...
[CliSubCommand("proj", "deny-namespace-resource")]
public record ArgoCdProjDenyNamespaceResourceOptions : ArgoCdOptions
{
    /// <summary>
    /// Adds a namespaced API resource to the deny list or removes a namespaced API resource from the allow list
    /// </summary>
    ...
    public ArgoCdProjDenyNamespaceResourceOptions(
        string Project,
        string Group,
        string Kind
    )
    ...
    public ArgoCdProjDenyNamespaceResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjDenyNamespaceResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjDenyNamespaceResourceRedisCompress? RedisCompress { get; set; }
