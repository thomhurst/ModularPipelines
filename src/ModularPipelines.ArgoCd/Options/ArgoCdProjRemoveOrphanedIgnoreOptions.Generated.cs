...
public record ArgoCdProjRemoveOrphanedIgnoreOptions : ArgoCdOptions
{
    /// <summary>
    /// Remove a resource from orphaned ignore list
    /// </summary>
    ...
    public ArgoCdProjRemoveOrphanedIgnoreOptions(
        string Project,
        string Group,
        string Kind
    )
    ...
    public ArgoCdProjRemoveOrphanedIgnoreLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRemoveOrphanedIgnoreLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRemoveOrphanedIgnoreRedisCompress? RedisCompress { get; set; }
