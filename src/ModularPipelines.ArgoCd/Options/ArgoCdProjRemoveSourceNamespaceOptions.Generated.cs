...
public record ArgoCdProjRemoveSourceNamespaceOptions : ArgoCdOptions
{
    /// <summary>
    /// Removes the source namespace from the AppProject
    /// </summary>
    ...
    public ArgoCdProjRemoveSourceNamespaceOptions(
        string Project,
        string Namespace
    )
    {
    ...
    public ArgoCdProjRemoveSourceNamespaceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRemoveSourceNamespaceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRemoveSourceNamespaceRedisCompress? RedisCompress { get; set; }
