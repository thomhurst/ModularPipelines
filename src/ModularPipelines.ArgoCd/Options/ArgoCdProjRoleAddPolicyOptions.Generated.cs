...
[CliSubCommand("proj", "role", "add-policy")]
public record ArgoCdProjRoleAddPolicyOptions : ArgoCdOptions
{
    /// <summary>
    /// Add a policy to a project role
    /// </summary>
    ...
    public ArgoCdProjRoleAddPolicyOptions(
        string Project,
        string RoleName
    )
    {
    ...
    public ArgoCdProjRoleAddPolicyLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleAddPolicyLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleAddPolicyRedisCompress? RedisCompress { get; set; }
