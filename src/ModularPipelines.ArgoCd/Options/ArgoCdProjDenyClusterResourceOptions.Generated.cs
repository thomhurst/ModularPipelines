...
[CliSubCommand("proj", "deny-cluster-resource")]
public record ArgoCdProjDenyClusterResourceOptions : ArgoCdOptions
{
    /// <summary>
    /// Removes a cluster-scoped API resource from the allow list and adds it to deny list
    /// </summary>
    ...
    public ArgoCdProjDenyClusterResourceOptions(
        string Project,
        string Group,
        string Kind
    )
    ...
    /// <summary>
    /// Use deny list or allow list. This can only be 'allow' or 'deny' (default "allow")
    /// </summary>
    [CliOption("--list", ShortForm = "-l", Format = OptionFormat.EqualsSeparated)]
    ...
    public ArgoCdProjDenyClusterResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjDenyClusterResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjDenyClusterResourceRedisCompress? RedisCompress { get; set; }
