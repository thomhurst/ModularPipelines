...
[CliSubCommand("proj", "role", "create-token")]
public record ArgoCdProjRoleCreateTokenOptions : ArgoCdOptions
{
    /// <summary>
    /// Create a project token
    /// </summary>
    ...
    public ArgoCdProjRoleCreateTokenOptions(
        string Project,
        string RoleName
    )
    {
    ...
    /// </summary>
    [CliOption("--expires-in", ShortForm = "-e", Format = OptionFormat.EqualsSeparated)]
    public string? ExpiresIn { get; set; }

    /// <summary>
    /// Token unique identifier. (Default: Random UUID)
    /// </summary>
    [CliOption("--id", ShortForm = "-i", Format = OptionFormat.EqualsSeparated)]
    public string? Id { get; set; }

    /// <summary>
    /// Output token only - for use in scripts.
    /// </summary>
    [CliFlag("--token-only", ShortForm = "-t")]
    ...
    public ArgoCdProjRoleCreateTokenLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleCreateTokenLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleCreateTokenRedisCompress? RedisCompress { get; set; }
