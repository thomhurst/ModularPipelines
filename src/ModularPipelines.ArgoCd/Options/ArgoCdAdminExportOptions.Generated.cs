...
[CliSubCommand("admin", "export")]
public record ArgoCdAdminExportOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminExportLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminExportLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminExportRedisCompress? RedisCompress { get; set; }
