...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjRoleAddGroupLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleAddGroupLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleAddGroupRedisCompress? RedisCompress { get; set; }
