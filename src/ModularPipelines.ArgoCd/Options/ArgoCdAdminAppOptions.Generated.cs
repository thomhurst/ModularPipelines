...
public record ArgoCdAdminAppOptions : ArgoCdOptions
{
    ...
    public ArgoCdAdminAppLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminAppLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminAppRedisCompress? RedisCompress { get; set; }
