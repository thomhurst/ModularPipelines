...
[CliSubCommand("admin", "settings", "validate")]
public record ArgoCdAdminSettingsValidateOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminSettingsValidateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsValidateLoglevel? Loglevel { get; set; }
