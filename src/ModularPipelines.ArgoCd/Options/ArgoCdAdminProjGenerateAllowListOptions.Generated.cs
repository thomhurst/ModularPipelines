...
public record ArgoCdAdminProjGenerateAllowListOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string ClusterrolePath,
    [property: CliArgument(1, Placement = ArgumentPlacement.BeforeOptions)] string ProjName
) : ArgoCdOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Output to the specified file instead of stdout (default "-")
    /// </summary>
    ...
    public ArgoCdAdminProjGenerateAllowListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminProjGenerateAllowListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminProjGenerateAllowListRedisCompress? RedisCompress { get; set; }
