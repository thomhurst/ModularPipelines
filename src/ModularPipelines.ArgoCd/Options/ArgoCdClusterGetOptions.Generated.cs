...
) : ArgoCdOptions
{
    ...
    public ArgoCdClusterGetOutput? Output { get; set; }
    ...
    public ArgoCdClusterGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdClusterGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdClusterGetRedisCompress? RedisCompress { get; set; }
