...
public record ArgoCdGpgGetOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string KeyId
) : ArgoCdOptions
{
    /// <summary>
    /// help for get
    ...
    public ArgoCdGpgGetOutput? Output { get; set; }
    ...
    public ArgoCdGpgGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdGpgGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdGpgGetRedisCompress? RedisCompress { get; set; }
