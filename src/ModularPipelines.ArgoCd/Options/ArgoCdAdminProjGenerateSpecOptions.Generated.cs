...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminProjGenerateSpecOutput? Output { get; set; }
    ...
    public ArgoCdAdminProjGenerateSpecLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminProjGenerateSpecLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminProjGenerateSpecRedisCompress? RedisCompress { get; set; }
