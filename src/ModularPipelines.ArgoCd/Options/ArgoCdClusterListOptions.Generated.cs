...
[CliSubCommand("cluster", "list")]
public record ArgoCdClusterListOptions : ArgoCdOptions
{
    /// <summary>
    /// help for list
    /// </summary>
    ...
    /// <summary>
    /// Output format. One of: json|yaml|wide|server (default "wide")
    /// </summary>
    [CliOption("--output", ShortForm = "-o", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdClusterListOutput? Output { get; set; }
    ...
    public ArgoCdClusterListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdClusterListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdClusterListRedisCompress? RedisCompress { get; set; }
