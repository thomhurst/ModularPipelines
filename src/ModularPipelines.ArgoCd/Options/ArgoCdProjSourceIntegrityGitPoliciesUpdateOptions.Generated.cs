...
) : ArgoCdOptions
{
    ...
    /// Add GPG key ID
    /// </summary>
    [CliOption("--add-gpg-key", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? AddGpgKey { get; set; }

    /// <summary>
    /// Add repository URL pattern
    /// </summary>
    [CliOption("--add-repo-url", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? AddRepoUrl { get; set; }

    /// <summary>
    /// Delete GPG key ID
    /// </summary>
    [CliOption("--delete-gpg-key", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? DeleteGpgKey { get; set; }

    /// <summary>
    /// Delete repository URL pattern
    /// </summary>
    [CliOption("--delete-repo-url", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? DeleteRepoUrl { get; set; }

    /// <summary>
    /// Set GPG key ID (replaces existing)
    /// </summary>
    [CliOption("--gpg-key", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? GpgKey { get; set; }

    /// <summary>
    /// Set GPG verification mode (strict, head, or none)
    /// </summary>
    ...
    /// </summary>
    [CliOption("--repo-url", Format = OptionFormat.EqualsSeparated)]
    public IEnumerable<string>? RepoUrl { get; set; }
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesUpdateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjSourceIntegrityGitPoliciesUpdateLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesUpdateRedisCompress? RedisCompress { get; set; }
