...
public record ArgoCdProjAddDestinationOptions(
    ...
    [property: CliArgument(1, Phase = CommandLinePhase.EarlyOperand)] string ServerOrName,
...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjAddDestinationLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjAddDestinationLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjAddDestinationRedisCompress? RedisCompress { get; set; }
