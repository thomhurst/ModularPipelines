...
public record ArgoCdAccountBcryptOptions : ArgoCdOptions
{
    ...
    public ArgoCdAccountBcryptLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAccountBcryptLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAccountBcryptRedisCompress? RedisCompress { get; set; }
