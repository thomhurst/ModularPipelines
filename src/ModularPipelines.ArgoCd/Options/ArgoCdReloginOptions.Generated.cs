...
[CliSubCommand("relogin")]
public record ArgoCdReloginOptions : ArgoCdOptions
{
    /// <summary>
    /// Host and Port for the callback URL
    /// </summary>
    ...
    /// <summary>
    /// Port to run local OAuth2 login application (default 8085)
    /// </summary>
    [CliOption("--sso-port", Format = OptionFormat.EqualsSeparated)]
    public int? SsoPort { get; set; }
    ...
    public ArgoCdReloginLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdReloginLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdReloginRedisCompress? RedisCompress { get; set; }
