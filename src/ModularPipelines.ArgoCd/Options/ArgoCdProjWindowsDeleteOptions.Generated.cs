...
[CliSubCommand("proj", "windows", "delete")]
public record ArgoCdProjWindowsDeleteOptions(
...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjWindowsDeleteLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjWindowsDeleteLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjWindowsDeleteRedisCompress? RedisCompress { get; set; }
