...
public record ArgoCdClusterRmOptions : ArgoCdOptions
{
    /// <summary>
    /// Remove cluster credentials
    /// </summary>
    /// <param name="ServerOrName">Cluster server address or configured name.</param>
    public ArgoCdClusterRmOptions(
        string ServerOrName
    )
    {
    ...
    public ArgoCdClusterRmLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdClusterRmLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdClusterRmRedisCompress? RedisCompress { get; set; }
