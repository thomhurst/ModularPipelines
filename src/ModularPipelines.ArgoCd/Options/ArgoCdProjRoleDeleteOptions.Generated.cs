...
[CliSubCommand("proj", "role", "delete")]
public record ArgoCdProjRoleDeleteOptions : ArgoCdOptions
{
    /// <summary>
    /// Delete a project role
    /// </summary>
    ...
    public ArgoCdProjRoleDeleteOptions(
        string Project,
        string RoleName
    )
    {
    ...
    public ArgoCdProjRoleDeleteLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleDeleteLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleDeleteRedisCompress? RedisCompress { get; set; }
