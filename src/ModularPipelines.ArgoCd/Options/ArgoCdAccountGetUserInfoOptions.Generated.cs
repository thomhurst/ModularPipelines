...
[CliSubCommand("account", "get-user-info")]
public record ArgoCdAccountGetUserInfoOptions : ArgoCdOptions
{
    /// <summary>
    /// help for get-user-info
    /// </summary>
    ...
    public ArgoCdAccountGetUserInfoOutput? Output { get; set; }
    ...
    public ArgoCdAccountGetUserInfoLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAccountGetUserInfoLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAccountGetUserInfoRedisCompress? RedisCompress { get; set; }
