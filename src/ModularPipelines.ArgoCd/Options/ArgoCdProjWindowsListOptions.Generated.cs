...
[CliSubCommand("proj", "windows", "list")]
public record ArgoCdProjWindowsListOptions : ArgoCdOptions
{
    /// <summary>
    /// List project sync windows
    /// </summary>
    /// <param name="Project">The PROJECT operand.</param>
    public ArgoCdProjWindowsListOptions(
        string Project
    )
    {
    ...
    public ArgoCdProjWindowsListOutput? Output { get; set; }
    ...
    public ArgoCdProjWindowsListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjWindowsListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjWindowsListRedisCompress? RedisCompress { get; set; }
