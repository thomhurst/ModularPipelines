...
public record ArgoCdProjRemoveSignatureKeyOptions(
    ...
    [property: CliArgument(1, Placement = ArgumentPlacement.BeforeOptions)] string KeyId
) : ArgoCdOptions
{
    /// <summary>
    /// help for remove-signature-key
    /// </summary>
    ...
    public ArgoCdProjRemoveSignatureKeyLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRemoveSignatureKeyLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRemoveSignatureKeyRedisCompress? RedisCompress { get; set; }
