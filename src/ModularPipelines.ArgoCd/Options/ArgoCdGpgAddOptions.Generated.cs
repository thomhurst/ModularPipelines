...
[CliSubCommand("gpg", "add")]
public record ArgoCdGpgAddOptions : ArgoCdOptions
{
    /// <summary>
    /// Path to the file that contains the GPG public key to import
    /// </summary>
    ...
    public ArgoCdGpgAddLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdGpgAddLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdGpgAddRedisCompress? RedisCompress { get; set; }
