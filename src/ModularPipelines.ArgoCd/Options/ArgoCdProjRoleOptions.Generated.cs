...
[CliSubCommand("proj", "role")]
public record ArgoCdProjRoleOptions : ArgoCdOptions
{
    /// <summary>
    /// help for role
    /// </summary>
    ...
    public ArgoCdProjRoleLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleRedisCompress? RedisCompress { get; set; }
