...
public record ArgoCdProjSourceIntegrityGitOptions : ArgoCdOptions
{
    ...
    public ArgoCdProjSourceIntegrityGitLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjSourceIntegrityGitLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjSourceIntegrityGitRedisCompress? RedisCompress { get; set; }
