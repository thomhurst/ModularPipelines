...
[CliSubCommand("account", "get")]
public record ArgoCdAccountGetOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAccountGetOutput? Output { get; set; }
    ...
    public ArgoCdAccountGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAccountGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAccountGetRedisCompress? RedisCompress { get; set; }
