...
[CliSubCommand("repocreds", "list")]
public record ArgoCdRepocredsListOptions : ArgoCdOptions
{
    /// <summary>
    /// help for list
    /// </summary>
    ...
    public ArgoCdRepocredsListOutput? Output { get; set; }
    ...
    public ArgoCdRepocredsListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdRepocredsListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdRepocredsListRedisCompress? RedisCompress { get; set; }
