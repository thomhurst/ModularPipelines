...
[CliSubCommand("app", "actions")]
public record ArgoCdAppActionsOptions : ArgoCdOptions
{
    /// <summary>
    /// help for actions
    /// </summary>
    ...
    public ArgoCdAppActionsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppActionsLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppActionsRedisCompress? RedisCompress { get; set; }
