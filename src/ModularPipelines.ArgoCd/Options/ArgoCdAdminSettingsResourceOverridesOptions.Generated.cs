...
[CliSubCommand("admin", "settings", "resource-overrides")]
public record ArgoCdAdminSettingsResourceOverridesOptions : ArgoCdOptions
{
    ...
    public ArgoCdAdminSettingsResourceOverridesLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsResourceOverridesLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsResourceOverridesRedisCompress? RedisCompress { get; set; }
