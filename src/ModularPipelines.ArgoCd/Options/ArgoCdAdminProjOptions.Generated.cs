...
[CliSubCommand("admin", "proj")]
public record ArgoCdAdminProjOptions : ArgoCdOptions
{
    /// <summary>
    /// help for proj
    /// </summary>
    ...
    public ArgoCdAdminProjLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminProjLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminProjRedisCompress? RedisCompress { get; set; }
