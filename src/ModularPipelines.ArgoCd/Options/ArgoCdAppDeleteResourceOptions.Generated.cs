...
[CliSubCommand("app", "delete-resource")]
public record ArgoCdAppDeleteResourceOptions : ArgoCdOptions
{
    /// <summary>
    /// Delete resource in an application
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppDeleteResourceOptions(
    ...
    /// <summary>
    /// Indicates whether to orphan the dependents of the deleted resource
    /// </summary>
    [CliFlag("--orphan")]
    ...
    public ArgoCdAppDeleteResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppDeleteResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppDeleteResourceRedisCompress? RedisCompress { get; set; }
