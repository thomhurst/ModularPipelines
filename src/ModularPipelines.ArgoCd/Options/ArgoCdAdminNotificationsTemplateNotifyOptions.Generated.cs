...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminNotificationsTemplateNotifyLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminNotificationsTemplateNotifyLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminNotificationsTemplateNotifyRedisCompress? RedisCompress { get; set; }
