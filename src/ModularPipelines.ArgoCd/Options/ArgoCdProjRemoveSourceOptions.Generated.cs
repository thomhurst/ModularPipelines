...
public record ArgoCdProjRemoveSourceOptions(
    ...
    [property: CliArgument(1, Placement = ArgumentPlacement.BeforeOptions)] string Url
) : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdProjRemoveSourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRemoveSourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRemoveSourceRedisCompress? RedisCompress { get; set; }
