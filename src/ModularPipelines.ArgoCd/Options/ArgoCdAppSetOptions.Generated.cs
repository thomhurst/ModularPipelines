...
[CliSubCommand("app", "set")]
public record ArgoCdAppSetOptions : ArgoCdOptions
{
    /// <summary>
    /// Set application parameters
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppSetOptions(
    ...
    /// <summary>
    /// Set application parameters in namespace
    /// </summary>
    ...
    public ArgoCdAppSetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppSetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppSetRedisCompress? RedisCompress { get; set; }
