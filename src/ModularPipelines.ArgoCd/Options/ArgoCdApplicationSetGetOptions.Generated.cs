...
) : ArgoCdOptions
{
    ...
    public ArgoCdApplicationSetGetOutput? Output { get; set; }

    /// <summary>
    /// Show ApplicationSet parameters and overrides
    /// </summary>
    [CliFlag("--show-params")]
    ...
    public ArgoCdApplicationSetGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdApplicationSetGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdApplicationSetGetRedisCompress? RedisCompress { get; set; }
