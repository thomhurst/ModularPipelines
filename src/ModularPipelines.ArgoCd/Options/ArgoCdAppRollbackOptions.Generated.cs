...
) : ArgoCdOptions
{
    ...
    public ArgoCdAppRollbackLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppRollbackLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppRollbackRedisCompress? RedisCompress { get; set; }
