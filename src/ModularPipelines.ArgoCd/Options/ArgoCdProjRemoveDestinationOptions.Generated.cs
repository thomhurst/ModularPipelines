...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjRemoveDestinationLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRemoveDestinationLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRemoveDestinationRedisCompress? RedisCompress { get; set; }
