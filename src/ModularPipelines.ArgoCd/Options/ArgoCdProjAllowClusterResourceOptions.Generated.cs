...
public record ArgoCdProjAllowClusterResourceOptions : ArgoCdOptions
{
    /// <summary>
    /// Adds a cluster-scoped API resource to the allow list and removes it from deny list
    /// </summary>
    ...
    public ArgoCdProjAllowClusterResourceOptions(
        string Project,
        string Group,
        string Kind
    )
    ...
    public ArgoCdProjAllowClusterResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjAllowClusterResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjAllowClusterResourceRedisCompress? RedisCompress { get; set; }
