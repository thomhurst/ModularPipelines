...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// Indicates if cluster level resources should be managed.
    /// </summary>
    ...
    /// </summary>
    [CliOption("--max-namespace-count", Format = OptionFormat.EqualsSeparated)]
    public int? MaxNamespaceCount { get; set; }
    ...
    public ArgoCdAdminClusterNamespacesEnableNamespacedModeLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminClusterNamespacesEnableNamespacedModeLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminClusterNamespacesEnableNamespacedModeRedisCompress? RedisCompress { get; set; }
