...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// Path to the local repository root. Used together with --local allows setting the repository root. Example: '/home/username/apps'. (default ".")
    /// </summary>
    ...
    /// <summary>
    /// Source of manifests. One of: live|git (default "git")
    /// </summary>
    [CliOption("--source", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppManifestsSource? Source { get; set; }
    ...
    public ArgoCdAppManifestsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppManifestsLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppManifestsRedisCompress? RedisCompress { get; set; }
