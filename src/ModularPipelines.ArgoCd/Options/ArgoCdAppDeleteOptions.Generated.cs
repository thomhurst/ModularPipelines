...
public record ArgoCdAppDeleteOptions : ArgoCdOptions
{
    ...
    public ArgoCdAppDeletePropagationPolicy? PropagationPolicy { get; set; }
    ...
    public ArgoCdAppDeleteLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppDeleteLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppDeleteRedisCompress? RedisCompress { get; set; }
