...
[CliSubCommand("admin", "notifications", "trigger", "get")]
public record ArgoCdAdminNotificationsTriggerGetOptions : ArgoCdOptions
{
    ...
    public ArgoCdAdminNotificationsTriggerGetOutput? Output { get; set; }
    ...
    public ArgoCdAdminNotificationsTriggerGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminNotificationsTriggerGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminNotificationsTriggerGetRedisCompress? RedisCompress { get; set; }
