...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminSettingsResourceOverridesIgnoreResourceUpdatesLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsResourceOverridesIgnoreResourceUpdatesLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsResourceOverridesIgnoreResourceUpdatesRedisCompress? RedisCompress { get; set; }
