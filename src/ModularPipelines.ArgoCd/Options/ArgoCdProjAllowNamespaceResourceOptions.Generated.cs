...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjAllowNamespaceResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjAllowNamespaceResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjAllowNamespaceResourceRedisCompress? RedisCompress { get; set; }
