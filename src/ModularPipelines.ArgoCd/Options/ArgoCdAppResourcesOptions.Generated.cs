...
[CliSubCommand("app", "resources")]
public record ArgoCdAppResourcesOptions : ArgoCdOptions
{
    /// <summary>
    /// List resources of application
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppResourcesOptions(
    ...
    /// <summary>
    /// Lists only orphaned resources
    /// </summary>
    [CliFlag("--orphaned")]
    public bool? Orphaned { get; set; }

    /// <summary>
    /// Output format. One of: tree|tree=detailed. tree: Shows resource hierarchy with parent-child relationships tree=detailed: Same as tree, but includes AGE, HEALTH, and REASON columns
    /// </summary>
    ...
    public ArgoCdAppResourcesLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppResourcesLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppResourcesRedisCompress? RedisCompress { get; set; }
