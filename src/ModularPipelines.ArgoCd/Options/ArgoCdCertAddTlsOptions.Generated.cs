...
public record ArgoCdCertAddTlsOptions(
    [property: CliArgument(0, Phase = CommandLinePhase.EarlyOperand)] string RepositoryServerName
) : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdCertAddTlsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdCertAddTlsLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdCertAddTlsRedisCompress? RedisCompress { get; set; }
