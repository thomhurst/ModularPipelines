...
[CliSubCommand("proj", "windows", "enable-manual-sync")]
public record ArgoCdProjWindowsEnableManualSyncOptions(
    [property: CliArgument(0, Phase = CommandLinePhase.EarlyOperand)] string Project,
    [property: CliArgument(1, Phase = CommandLinePhase.EarlyOperand)] string Id
) : ArgoCdOptions
{
    /// <summary>
    /// help for enable-manual-sync
    /// </summary>
    ...
    public ArgoCdProjWindowsEnableManualSyncLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjWindowsEnableManualSyncLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjWindowsEnableManualSyncRedisCompress? RedisCompress { get; set; }
