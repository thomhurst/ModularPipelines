...
) : ArgoCdOptions
{
    ...
    public ArgoCdAppGetOutput? Output { get; set; }
    ...
    /// <summary>
    /// Show application operation
    /// </summary>
    [CliFlag("--show-operation")]
    ...
    public ArgoCdAppGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppGetRedisCompress? RedisCompress { get; set; }
