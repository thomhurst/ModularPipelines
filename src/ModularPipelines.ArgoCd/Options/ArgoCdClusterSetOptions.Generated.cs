...
) : ArgoCdOptions
{
    ...
    public ArgoCdClusterSetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdClusterSetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdClusterSetRedisCompress? RedisCompress { get; set; }
