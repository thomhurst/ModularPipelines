...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// Namespace of the resource on which the action should be run
    /// </summary>
    [CliOption("--namespace", Format = OptionFormat.EqualsSeparated)]
    public string? Namespace { get; set; }

    /// <summary>
    /// Name of resource on which the action should be run
    /// </summary>
    ...
    public ArgoCdAppActionsRunLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppActionsRunLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppActionsRunRedisCompress? RedisCompress { get; set; }
