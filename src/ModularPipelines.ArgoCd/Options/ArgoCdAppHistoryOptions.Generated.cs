...
public record ArgoCdAppHistoryOptions : ArgoCdOptions
{
    /// <summary>
    /// Show application deployment history
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppHistoryOptions(
    ...
    /// <summary>
    /// Output format. One of: wide|id (default "wide")
    /// </summary>
    [CliOption("--output", ShortForm = "-o", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppHistoryOutput? Output { get; set; }
    ...
    public ArgoCdAppHistoryLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppHistoryLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppHistoryRedisCompress? RedisCompress { get; set; }
