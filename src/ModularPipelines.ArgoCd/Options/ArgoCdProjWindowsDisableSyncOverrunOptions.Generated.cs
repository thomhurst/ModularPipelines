...
[CliSubCommand("proj", "windows", "disable-sync-overrun")]
public record ArgoCdProjWindowsDisableSyncOverrunOptions : ArgoCdOptions
{
    /// <summary>
    /// Disable sync overrun for a sync window. Requires ID which can be found by running "argocd proj windows list PROJECT"
    /// </summary>
    ...
    public ArgoCdProjWindowsDisableSyncOverrunOptions(
        string Project,
        string Id
    )
    {
    ...
    public ArgoCdProjWindowsDisableSyncOverrunLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjWindowsDisableSyncOverrunLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjWindowsDisableSyncOverrunRedisCompress? RedisCompress { get; set; }
