...
[CliSubCommand("gpg", "list")]
public record ArgoCdGpgListOptions : ArgoCdOptions
{
    /// <summary>
    /// help for list
    /// </summary>
    ...
    public ArgoCdGpgListOutput? Output { get; set; }
    ...
    public ArgoCdGpgListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdGpgListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdGpgListRedisCompress? RedisCompress { get; set; }
