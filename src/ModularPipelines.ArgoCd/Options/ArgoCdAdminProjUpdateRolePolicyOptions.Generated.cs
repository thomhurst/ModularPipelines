...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminProjUpdateRolePolicyLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminProjUpdateRolePolicyLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminProjUpdateRolePolicyRedisCompress? RedisCompress { get; set; }
