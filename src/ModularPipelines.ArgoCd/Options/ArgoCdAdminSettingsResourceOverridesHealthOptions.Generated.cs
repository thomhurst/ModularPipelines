...
[CliSubCommand("admin", "settings", "resource-overrides", "health")]
public record ArgoCdAdminSettingsResourceOverridesHealthOptions : ArgoCdOptions
{
    /// <summary>
    /// Assess resource health using the lua script configured in the 'resource.customizations' field of 'argocd-cm' ConfigMap
    /// </summary>
    /// <param name="ResourceYamlPath">The RESOURCE_YAML_PATH operand.</param>
    public ArgoCdAdminSettingsResourceOverridesHealthOptions(
    ...
    public ArgoCdAdminSettingsResourceOverridesHealthLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsResourceOverridesHealthLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsResourceOverridesHealthRedisCompress? RedisCompress { get; set; }
