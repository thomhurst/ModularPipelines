...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjAddSourceNamespaceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjAddSourceNamespaceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjAddSourceNamespaceRedisCompress? RedisCompress { get; set; }
