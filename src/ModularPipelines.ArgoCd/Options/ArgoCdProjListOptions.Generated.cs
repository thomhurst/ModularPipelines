...
[CliSubCommand("proj", "list")]
public record ArgoCdProjListOptions : ArgoCdOptions
{
    /// <summary>
    /// help for list
    /// </summary>
    ...
    public ArgoCdProjListOutput? Output { get; set; }
    ...
    public ArgoCdProjListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjListRedisCompress? RedisCompress { get; set; }
