...
[CliSubCommand("app", "terminate-op")]
public record ArgoCdAppTerminateOpOptions : ArgoCdOptions
{
    /// <summary>
    /// Terminate running operation of an application
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppTerminateOpOptions(
    ...
    public ArgoCdAppTerminateOpLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppTerminateOpLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppTerminateOpRedisCompress? RedisCompress { get; set; }
