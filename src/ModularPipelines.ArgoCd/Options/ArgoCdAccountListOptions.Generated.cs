...
public record ArgoCdAccountListOptions : ArgoCdOptions
{
    /// <summary>
    /// help for list
    /// </summary>
    ...
    public ArgoCdAccountListOutput? Output { get; set; }
    ...
    public ArgoCdAccountListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAccountListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAccountListRedisCompress? RedisCompress { get; set; }
