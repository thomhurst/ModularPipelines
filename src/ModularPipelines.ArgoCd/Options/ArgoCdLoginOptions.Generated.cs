...
) : ArgoCdOptions
{
    ...
    /// </summary>
    [CliFlag("--skip-test-tls")]
    public bool? SkipTestTls { get; set; }
    ...
    public ArgoCdLoginLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdLoginLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdLoginRedisCompress? RedisCompress { get; set; }
