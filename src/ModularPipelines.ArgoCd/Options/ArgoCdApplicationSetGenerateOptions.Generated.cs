...
) : ArgoCdOptions
{
    ...
    public ArgoCdApplicationSetGenerateOutput? Output { get; set; }
    ...
    public ArgoCdApplicationSetGenerateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdApplicationSetGenerateLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdApplicationSetGenerateRedisCompress? RedisCompress { get; set; }
