...
[CliSubCommand("proj", "get")]
public record ArgoCdProjGetOptions : ArgoCdOptions
{
    /// <summary>
    /// Get project details
    /// </summary>
    /// <param name="Project">The PROJECT operand.</param>
    public ArgoCdProjGetOptions(
        string Project
    )
    {
    ...
    public ArgoCdProjGetOutput? Output { get; set; }
    ...
    public ArgoCdProjGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjGetRedisCompress? RedisCompress { get; set; }
