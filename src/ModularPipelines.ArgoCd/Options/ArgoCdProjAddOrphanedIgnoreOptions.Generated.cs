...
[CliSubCommand("proj", "add-orphaned-ignore")]
public record ArgoCdProjAddOrphanedIgnoreOptions : ArgoCdOptions
{
    /// <summary>
    /// Add a resource to orphaned ignore list
    /// </summary>
    ...
    public ArgoCdProjAddOrphanedIgnoreOptions(
        string Project,
        string Group,
        string Kind
    )
    ...
    public ArgoCdProjAddOrphanedIgnoreLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjAddOrphanedIgnoreLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjAddOrphanedIgnoreRedisCompress? RedisCompress { get; set; }
