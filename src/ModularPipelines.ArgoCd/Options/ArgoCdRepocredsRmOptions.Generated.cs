...
public record ArgoCdRepocredsRmOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string Credsurl
) : ArgoCdOptions
{
    /// <summary>
    /// help for rm
    ...
    public ArgoCdRepocredsRmLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdRepocredsRmLoglevel? Loglevel { get; set; }
