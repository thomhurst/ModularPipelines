...
[CliSubCommand("cert", "add-ssh")]
public record ArgoCdCertAddSshOptions : ArgoCdOptions
{
    /// <summary>
    /// Perform batch processing by reading in SSH known hosts data (mandatory flag)
    /// </summary>
    [CliFlag("--batch")]
    public bool? Batch { get; set; }

    /// <summary>
    /// Read SSH known hosts data from file (default is to read from stdin)
    /// </summary>
    ...
    public ArgoCdCertAddSshLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdCertAddSshLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdCertAddSshRedisCompress? RedisCompress { get; set; }
