...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjRoleListOutput? Output { get; set; }
    ...
    public ArgoCdProjRoleListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleListRedisCompress? RedisCompress { get; set; }
