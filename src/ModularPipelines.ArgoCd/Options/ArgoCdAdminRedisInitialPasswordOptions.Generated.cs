...
[CliSubCommand("admin", "redis-initial-password")]
public record ArgoCdAdminRedisInitialPasswordOptions : ArgoCdOptions
{
    /// <summary>
    ...
    /// <summary>
    /// help for redis-initial-password
    /// </summary>
    ...
    public ArgoCdAdminRedisInitialPasswordLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminRedisInitialPasswordLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminRedisInitialPasswordRedisCompress? RedisCompress { get; set; }
