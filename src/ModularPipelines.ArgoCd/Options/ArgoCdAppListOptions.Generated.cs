...
[CliSubCommand("app", "list")]
public record ArgoCdAppListOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAppListOutput? Output { get; set; }
    ...
    public ArgoCdAppListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppListRedisCompress? RedisCompress { get; set; }
