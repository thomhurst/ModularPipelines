...
[CliSubCommand("admin", "cluster")]
public record ArgoCdAdminClusterOptions : ArgoCdOptions
{
    /// <summary>
    /// help for cluster
    /// </summary>
    ...
    public ArgoCdAdminClusterLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminClusterLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminClusterRedisCompress? RedisCompress { get; set; }
