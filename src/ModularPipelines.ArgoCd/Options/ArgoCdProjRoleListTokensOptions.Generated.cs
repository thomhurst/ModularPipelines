...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjRoleListTokensLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleListTokensLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleListTokensRedisCompress? RedisCompress { get; set; }
