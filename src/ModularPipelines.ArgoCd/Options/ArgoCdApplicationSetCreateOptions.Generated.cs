...
public record ArgoCdApplicationSetCreateOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] IEnumerable<string> Files
) : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdApplicationSetCreateOutput? Output { get; set; }

    /// <summary>
    /// Allows to override ApplicationSet with the same name even if supplied ApplicationSet spec is different from existing spec
    /// </summary>
    [CliFlag("--upsert")]
    public bool? Upsert { get; set; }

    /// <summary>
    /// Wait until the ApplicationSet's resources are up to date. Will block indefinitely if the ApplicationSet has errors
    /// </summary>
    [CliFlag("--wait")]
    ...
    public ArgoCdApplicationSetCreateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdApplicationSetCreateLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdApplicationSetCreateRedisCompress? RedisCompress { get; set; }
