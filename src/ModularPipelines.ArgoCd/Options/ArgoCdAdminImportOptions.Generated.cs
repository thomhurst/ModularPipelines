...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// Override the resource on conflict when updating resources
    /// </summary>
    [CliFlag("--override-on-conflict")]
    public bool? OverrideOnConflict { get; set; }
    ...
    /// <summary>
    /// Prune secrets, applications and projects which do not appear in the backup
    /// </summary>
    [CliFlag("--prune")]
    ...
    /// <summary>
    /// Skip importing resources based on the label e.g. '--skip-resources-with-label my-label/example.io=true'
    /// </summary>
    [CliOption("--skip-resources-with-label", Format = OptionFormat.EqualsSeparated)]
    public string? SkipResourcesWithLabel { get; set; }

    /// <summary>
    /// Stop any existing operations
    /// </summary>
    [CliFlag("--stop-operation")]
    ...
    /// <summary>
    /// Verbose output (versus only changed output)
    /// </summary>
    [CliFlag("--verbose")]
    ...
    public ArgoCdAdminImportLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminImportLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminImportRedisCompress? RedisCompress { get; set; }
