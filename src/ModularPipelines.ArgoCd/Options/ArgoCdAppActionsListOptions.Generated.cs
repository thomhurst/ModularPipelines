...
[CliSubCommand("app", "actions", "list")]
public record ArgoCdAppActionsListOptions : ArgoCdOptions
{
    /// <summary>
    /// Lists available actions on a resource
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppActionsListOptions(
    ...
    public ArgoCdAppActionsListOut? Out { get; set; }
    ...
    public ArgoCdAppActionsListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppActionsListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppActionsListRedisCompress? RedisCompress { get; set; }
