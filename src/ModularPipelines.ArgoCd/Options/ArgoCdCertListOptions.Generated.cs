...
[CliSubCommand("cert", "list")]
public record ArgoCdCertListOptions : ArgoCdOptions
{
    /// <summary>
    /// Only list certificates of given type, valid: 'ssh','https'
    /// </summary>
    ...
    public ArgoCdCertListOutput? Output { get; set; }

    /// <summary>
    /// Set display sort order for output format wide. One of: hostname|type
    /// </summary>
    [CliOption("--sort", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdCertListSort? Sort { get; set; }
    ...
    public ArgoCdCertListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdCertListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdCertListRedisCompress? RedisCompress { get; set; }
