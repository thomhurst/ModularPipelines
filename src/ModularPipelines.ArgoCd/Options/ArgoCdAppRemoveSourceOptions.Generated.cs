...
[CliSubCommand("app", "remove-source")]
public record ArgoCdAppRemoveSourceOptions : ArgoCdOptions
{
    /// <summary>
    /// Remove a source from multiple sources application.
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppRemoveSourceOptions(
    ...
    public ArgoCdAppRemoveSourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppRemoveSourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppRemoveSourceRedisCompress? RedisCompress { get; set; }
