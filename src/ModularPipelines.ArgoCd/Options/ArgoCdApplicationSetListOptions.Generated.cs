...
[CliSubCommand("appset", "list")]
public record ArgoCdApplicationSetListOptions : ArgoCdOptions
{
    /// <summary>
    /// Only list applicationsets in namespace
    /// </summary>
    ...
    public ArgoCdApplicationSetListOutput? Output { get; set; }
    ...
    public ArgoCdApplicationSetListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdApplicationSetListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdApplicationSetListRedisCompress? RedisCompress { get; set; }
