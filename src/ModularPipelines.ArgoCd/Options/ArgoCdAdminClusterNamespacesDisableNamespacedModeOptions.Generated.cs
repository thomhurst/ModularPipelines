...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminClusterNamespacesDisableNamespacedModeLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminClusterNamespacesDisableNamespacedModeLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminClusterNamespacesDisableNamespacedModeRedisCompress? RedisCompress { get; set; }
