...
[CliSubCommand("proj", "role", "remove-group")]
public record ArgoCdProjRoleRemoveGroupOptions : ArgoCdOptions
{
    /// <summary>
    /// Remove a group claim from a role within a project
    /// </summary>
    ...
    public ArgoCdProjRoleRemoveGroupOptions(
        string Project,
        string RoleName,
        string GroupClaim
    )
    ...
    public ArgoCdProjRoleRemoveGroupLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleRemoveGroupLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleRemoveGroupRedisCompress? RedisCompress { get; set; }
