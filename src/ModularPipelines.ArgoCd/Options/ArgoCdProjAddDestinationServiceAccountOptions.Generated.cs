...
public record ArgoCdProjAddDestinationServiceAccountOptions : ArgoCdOptions
{
    /// <summary>
    /// Add project destination's default service account
    /// </summary>
    ...
    public ArgoCdProjAddDestinationServiceAccountOptions(
        string Project,
    ...
    /// <summary>
    /// Use service-account-namespace as namespace where the service account is present
    /// </summary>
    [CliOption("--service-account-namespace", Format = OptionFormat.EqualsSeparated)]
    ...
    public ArgoCdProjAddDestinationServiceAccountLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjAddDestinationServiceAccountLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjAddDestinationServiceAccountRedisCompress? RedisCompress { get; set; }
