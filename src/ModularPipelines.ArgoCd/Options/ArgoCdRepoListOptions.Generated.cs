...
public record ArgoCdRepoListOptions : ArgoCdOptions
{
    /// <summary>
    /// help for list
    /// </summary>
    ...
    /// <summary>
    /// Output format. Supported formats: yaml|json|url|wide (default "wide")
    /// </summary>
    [CliOption("--output", ShortForm = "-o", Format = OptionFormat.EqualsSeparated)]
    public string? Output { get; set; }

    /// <summary>
    /// Force a cache refresh on connection status. Supported values: hard
    /// </summary>
    ...
    public ArgoCdRepoListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdRepoListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdRepoListRedisCompress? RedisCompress { get; set; }
