...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// Sync window duration. (e.g. --duration 1h)
    /// </summary>
    ...
    /// </summary>
    [CliOption("--kind", ShortForm = "-k", Format = OptionFormat.EqualsSeparated)]
    public string? Kind { get; set; }

    /// <summary>
    /// Allow manual syncs for both deny and allow windows
    /// </summary>
    [CliFlag("--manual-sync")]
    ...
    /// <summary>
    /// Sync window schedule in cron format. (e.g. --schedule "0 22 * * *")
    /// </summary>
    ...
    public ArgoCdProjWindowsAddLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjWindowsAddLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjWindowsAddRedisCompress? RedisCompress { get; set; }
