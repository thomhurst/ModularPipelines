...
public record ArgoCdProjDeleteOptions : ArgoCdOptions
{
    /// <summary>
    /// Delete project
    /// </summary>
    /// <param name="Project">The PROJECT operand.</param>
    public ArgoCdProjDeleteOptions(
        string Project
    )
    {
    ...
    public ArgoCdProjDeleteLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjDeleteLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjDeleteRedisCompress? RedisCompress { get; set; }
