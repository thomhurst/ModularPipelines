...
[CliSubCommand("account", "generate-token")]
public record ArgoCdAccountGenerateTokenOptions : ArgoCdOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Duration before the token will expire. (Default: No expiration) (default "0s")
    /// </summary>
    ...
    public ArgoCdAccountGenerateTokenLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAccountGenerateTokenLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAccountGenerateTokenRedisCompress? RedisCompress { get; set; }
