...
[CliSubCommand("admin", "initial-password")]
public record ArgoCdAdminInitialPasswordOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminInitialPasswordLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminInitialPasswordLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminInitialPasswordRedisCompress? RedisCompress { get; set; }
