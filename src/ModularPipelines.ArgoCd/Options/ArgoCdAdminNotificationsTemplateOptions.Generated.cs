...
[CliSubCommand("admin", "notifications", "template")]
public record ArgoCdAdminNotificationsTemplateOptions : ArgoCdOptions
{
    /// <summary>
    /// help for template
    /// </summary>
    ...
    public ArgoCdAdminNotificationsTemplateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminNotificationsTemplateLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminNotificationsTemplateRedisCompress? RedisCompress { get; set; }
