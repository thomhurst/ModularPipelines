...
[CliSubCommand("admin", "notifications", "trigger")]
public record ArgoCdAdminNotificationsTriggerOptions : ArgoCdOptions
{
    /// <summary>
    /// help for trigger
    /// </summary>
    ...
    public ArgoCdAdminNotificationsTriggerLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminNotificationsTriggerLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminNotificationsTriggerRedisCompress? RedisCompress { get; set; }
