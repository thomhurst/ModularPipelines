...
[CliSubCommand("proj", "source-integrity", "git", "policies", "list")]
public record ArgoCdProjSourceIntegrityGitPoliciesListOptions : ArgoCdOptions
{
    /// <summary>
    /// List git source integrity policies.
    /// </summary>
    /// <param name="Project">The PROJECT operand.</param>
    public ArgoCdProjSourceIntegrityGitPoliciesListOptions(
        string Project
    )
    {
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesListLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjSourceIntegrityGitPoliciesListLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesListRedisCompress? RedisCompress { get; set; }
