...
[CliSubCommand("app", "patch")]
public record ArgoCdAppPatchOptions : ArgoCdOptions
{
    /// <summary>
    /// Patch application
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppPatchOptions(
    ...
    /// <summary>
    /// The type of patch being provided; one of [json merge] (default "json")
    /// </summary>
    ...
    public ArgoCdAppPatchLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppPatchLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppPatchRedisCompress? RedisCompress { get; set; }
