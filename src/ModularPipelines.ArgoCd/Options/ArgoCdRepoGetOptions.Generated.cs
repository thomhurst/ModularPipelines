...
public record ArgoCdRepoGetOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string Repo
) : ArgoCdOptions
{
    /// <summary>
    /// help for get
    ...
    public ArgoCdRepoGetOutput? Output { get; set; }
    ...
    public ArgoCdRepoGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdRepoGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdRepoGetRedisCompress? RedisCompress { get; set; }
