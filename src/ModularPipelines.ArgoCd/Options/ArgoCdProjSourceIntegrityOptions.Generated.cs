...
[CliSubCommand("proj", "source-integrity")]
public record ArgoCdProjSourceIntegrityOptions : ArgoCdOptions
{
    /// <summary>
    /// help for source-integrity
    /// </summary>
    ...
    public ArgoCdProjSourceIntegrityLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjSourceIntegrityLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjSourceIntegrityRedisCompress? RedisCompress { get; set; }
