...
[CliSubCommand("admin", "cluster", "stats")]
public record ArgoCdAdminClusterStatsOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminClusterStatsRedisCompress? RedisCompress { get; set; }
    ...
    public ArgoCdAdminClusterStatsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminClusterStatsLoglevel? Loglevel { get; set; }
