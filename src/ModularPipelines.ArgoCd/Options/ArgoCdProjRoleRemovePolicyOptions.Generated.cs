...
public record ArgoCdProjRoleRemovePolicyOptions : ArgoCdOptions
{
    /// <summary>
    /// Remove a policy from a role within a project
    /// </summary>
    ...
    public ArgoCdProjRoleRemovePolicyOptions(
        string Project,
        string RoleName
    )
    {
    ...
    public ArgoCdProjRoleRemovePolicyRedisCompress? RedisCompress { get; set; }
