...
[CliSubCommand("proj", "source-integrity", "git", "policies")]
public record ArgoCdProjSourceIntegrityGitPoliciesOptions : ArgoCdOptions
{
    /// <summary>
    /// help for policies
    /// </summary>
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjSourceIntegrityGitPoliciesLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesRedisCompress? RedisCompress { get; set; }
