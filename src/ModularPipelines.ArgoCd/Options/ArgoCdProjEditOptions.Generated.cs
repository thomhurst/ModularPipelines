...
) : ArgoCdOptions
{
    ...
    public ArgoCdProjEditLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjEditLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjEditRedisCompress? RedisCompress { get; set; }
