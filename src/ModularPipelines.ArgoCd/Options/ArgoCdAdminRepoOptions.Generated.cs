...
[CliSubCommand("admin", "repo")]
public record ArgoCdAdminRepoOptions : ArgoCdOptions
{
    /// <summary>
    /// help for repo
    /// </summary>
    ...
    public ArgoCdAdminRepoLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminRepoLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminRepoRedisCompress? RedisCompress { get; set; }
