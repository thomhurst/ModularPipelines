...
[CliSubCommand("admin", "settings", "rbac")]
public record ArgoCdAdminSettingsRbacOptions : ArgoCdOptions
{
    ...
    public ArgoCdAdminSettingsRbacLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsRbacLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsRbacRedisCompress? RedisCompress { get; set; }
