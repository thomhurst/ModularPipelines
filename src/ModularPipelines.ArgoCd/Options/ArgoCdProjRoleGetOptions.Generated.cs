...
[CliSubCommand("proj", "role", "get")]
public record ArgoCdProjRoleGetOptions : ArgoCdOptions
{
    /// <summary>
    /// Get the details of a specific role
    /// </summary>
    ...
    public ArgoCdProjRoleGetOptions(
        string Project,
        string RoleName
    )
    {
    ...
    public ArgoCdProjRoleGetLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjRoleGetLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjRoleGetRedisCompress? RedisCompress { get; set; }
