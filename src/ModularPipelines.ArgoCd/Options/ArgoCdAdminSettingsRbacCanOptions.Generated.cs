...
) : ArgoCdOptions
{
    ...
    /// </summary>
    [CliOption("--default-role", Format = OptionFormat.EqualsSeparated)]
    ...
    public ArgoCdAdminSettingsRbacCanLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsRbacCanLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsRbacCanRedisCompress? RedisCompress { get; set; }
