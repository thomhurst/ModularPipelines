...
[CliSubCommand("admin", "cluster", "namespaces")]
public record ArgoCdAdminClusterNamespacesOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminClusterNamespacesLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminClusterNamespacesLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminClusterNamespacesRedisCompress? RedisCompress { get; set; }
