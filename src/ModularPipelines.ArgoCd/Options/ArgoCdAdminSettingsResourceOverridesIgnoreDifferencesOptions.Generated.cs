...
public record ArgoCdAdminSettingsResourceOverridesIgnoreDifferencesOptions : ArgoCdOptions
{
    /// <summary>
    /// Renders ignored fields using the 'ignoreDifferences' setting specified in the 'resource.customizations' field of 'argocd-cm' ConfigMap
    /// </summary>
    /// <param name="ResourceYamlPath">The RESOURCE_YAML_PATH operand.</param>
    public ArgoCdAdminSettingsResourceOverridesIgnoreDifferencesOptions(
    ...
    public ArgoCdAdminSettingsResourceOverridesIgnoreDifferencesLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsResourceOverridesIgnoreDifferencesLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsResourceOverridesIgnoreDifferencesRedisCompress? RedisCompress { get; set; }
