...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// GPG verification mode (strict, head, or none)
    /// </summary>
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesAddLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjSourceIntegrityGitPoliciesAddLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjSourceIntegrityGitPoliciesAddRedisCompress? RedisCompress { get; set; }
