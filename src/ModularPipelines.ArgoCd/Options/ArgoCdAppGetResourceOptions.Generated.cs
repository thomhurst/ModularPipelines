...
) : ArgoCdOptions
{
    ...
    /// <summary>
    /// Format of the output, wide, yaml, or json (default "wide")
    /// </summary>
    ...
    /// <summary>
    /// Name of resource, if none is included will output details of all resources with specified kind
    /// </summary>
    [CliOption("--resource-name", Format = OptionFormat.EqualsSeparated)]
    public string? ResourceName { get; set; }

    /// <summary>
    /// Show managed fields in the output manifest
    /// </summary>
    ...
    public ArgoCdAppGetResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppGetResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppGetResourceRedisCompress? RedisCompress { get; set; }
