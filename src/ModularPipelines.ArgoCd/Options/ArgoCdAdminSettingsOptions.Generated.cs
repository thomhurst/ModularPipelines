...
[CliSubCommand("admin", "settings")]
public record ArgoCdAdminSettingsOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminSettingsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsRedisCompress? RedisCompress { get; set; }
