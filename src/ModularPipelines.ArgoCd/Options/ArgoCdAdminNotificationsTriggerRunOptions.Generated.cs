...
) : ArgoCdOptions
{
    ...
    public ArgoCdAdminNotificationsTriggerRunLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminNotificationsTriggerRunLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminNotificationsTriggerRunRedisCompress? RedisCompress { get; set; }
