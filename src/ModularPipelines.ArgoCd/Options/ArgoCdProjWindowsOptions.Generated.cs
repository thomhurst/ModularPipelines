...
[CliSubCommand("proj", "windows")]
public record ArgoCdProjWindowsOptions : ArgoCdOptions
{
    /// <summary>
    /// help for windows
    /// </summary>
    ...
    public ArgoCdProjWindowsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdProjWindowsLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdProjWindowsRedisCompress? RedisCompress { get; set; }
