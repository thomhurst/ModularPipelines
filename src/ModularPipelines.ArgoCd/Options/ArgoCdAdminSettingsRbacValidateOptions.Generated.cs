...
public record ArgoCdAdminSettingsRbacValidateOptions : ArgoCdOptions
{
    ...
    public ArgoCdAdminSettingsRbacValidateLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminSettingsRbacValidateLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminSettingsRbacValidateRedisCompress? RedisCompress { get; set; }
