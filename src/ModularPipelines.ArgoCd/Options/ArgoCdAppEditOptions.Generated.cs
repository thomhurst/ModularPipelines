...
[CliSubCommand("app", "edit")]
public record ArgoCdAppEditOptions : ArgoCdOptions
{
    /// <summary>
    /// Edit application
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppEditOptions(
    ...
    public ArgoCdAppEditLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppEditLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppEditRedisCompress? RedisCompress { get; set; }
