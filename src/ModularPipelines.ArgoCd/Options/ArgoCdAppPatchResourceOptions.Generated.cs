...
[CliSubCommand("app", "patch-resource")]
public record ArgoCdAppPatchResourceOptions : ArgoCdOptions
{
    /// <summary>
    /// Patch resource in an application
    /// </summary>
    /// <param name="ApplicationName">The APPNAME operand.</param>
    public ArgoCdAppPatchResourceOptions(
    ...
    /// <summary>
    /// Indicates whether to patch multiple matching of resources
    /// </summary>
    [CliFlag("--all")]
    ...
    /// <summary>
    /// Which Patching strategy to use: 'application/json-patch+json', 'application/merge-patch+json', or 'application/strategic-merge-patch+json'. Defaults to 'application/merge-patch+json' (default "application/merge-patch+json")
    /// </summary>
    [CliOption("--patch-type", Format = OptionFormat.EqualsSeparated)]
    public string? PatchType { get; set; }

    /// <summary>
    /// The name of the application's project - specifying this allows the command to report "not found" instead of "permission denied" if the app does not exist
    /// </summary>
    ...
    public ArgoCdAppPatchResourceLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAppPatchResourceLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAppPatchResourceRedisCompress? RedisCompress { get; set; }
