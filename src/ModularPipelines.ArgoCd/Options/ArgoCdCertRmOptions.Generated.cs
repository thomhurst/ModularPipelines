...
public record ArgoCdCertRmOptions(
    [property: CliArgument(0, Placement = ArgumentPlacement.BeforeOptions)] string RepositoryServer
) : ArgoCdOptions
{
    /// <summary>
    /// Only remove certs of given sub-type (only for ssh)
    /// </summary>
    [CliOption("--cert-sub-type", Format = OptionFormat.EqualsSeparated)]
    public string? CertSubType { get; set; }

    /// <summary>
    /// Only remove certs of given type (ssh, https)
    /// </summary>
    ...
    public ArgoCdCertRmLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdCertRmLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdCertRmRedisCompress? RedisCompress { get; set; }
