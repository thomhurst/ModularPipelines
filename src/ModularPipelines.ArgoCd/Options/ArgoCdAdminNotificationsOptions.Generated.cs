...
[CliSubCommand("admin", "notifications")]
public record ArgoCdAdminNotificationsOptions : ArgoCdOptions
{
    /// <summary>
    ...
    public ArgoCdAdminNotificationsLogformat? Logformat { get; set; }

    /// <summary>
    /// Set the logging level. One of: debug|info|warn|error (default "info")
    /// </summary>
    [CliOption("--loglevel", Format = OptionFormat.EqualsSeparated)]
    public ArgoCdAdminNotificationsLoglevel? Loglevel { get; set; }
    ...
    public ArgoCdAdminNotificationsRedisCompress? RedisCompress { get; set; }
