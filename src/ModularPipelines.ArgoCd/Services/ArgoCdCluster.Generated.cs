...
public class ArgoCdCluster : IArgoCdCluster
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new ArgoCdClusterOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new ArgoCdClusterListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
