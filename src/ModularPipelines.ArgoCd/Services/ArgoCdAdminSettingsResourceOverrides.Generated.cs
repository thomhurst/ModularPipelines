...
public class ArgoCdAdminSettingsResourceOverrides
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new ArgoCdAdminSettingsResourceOverridesOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
