...
public class ArgoCdApplicationSet : IArgoCdApplicationSet
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new ArgoCdApplicationSetOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> ListAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new ArgoCdApplicationSetListOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
