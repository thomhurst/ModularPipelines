...
public class CreateReleaseModule : Module<Release>, IModuleErrorHandling, IModuleSkipLogic
{
    ...
    /// <inheritdoc/>
    public override async Task<Release?> ExecuteAsync(IPipelineContext context, CancellationToken cancellationToken)
    {
        var versionInfoResult = await context.GetModuleAsync<NugetVersionGeneratorModule>();
