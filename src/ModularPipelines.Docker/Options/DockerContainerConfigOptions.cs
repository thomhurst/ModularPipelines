// This file contains shared container configuration options to reduce duplication
// between DockerRunOptions, DockerCreateOptions, DockerContainerRunOptions, and DockerContainerCreateOptions.
...
/// <summary>
/// Base options class containing common container configuration properties.
/// This reduces duplication between docker run, docker create, docker container run, and docker container create commands.
/// </summary>
[ExcludeFromCodeCoverage]
public abstract record DockerContainerConfigOptions : DockerOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Pull image before creating/running ("always", "missing", "never") (default "missing")
    /// </summary>
    ...
    /// <summary>
    /// Image and optional tag/digest
    /// </summary>
    [CliArgument(0, Name = "IMAGE")]
