...
public record DockerContainerRunOptions : DockerOptions
{
    ...
    public DockerContainerRunCgroupns? Cgroupns { get; set; }
    ...
    public DockerContainerRunHealthInterval? HealthInterval { get; set; }
    ...
    public DockerContainerRunHealthStartInterval? HealthStartInterval { get; set; }

    /// <summary>
    /// Start period for the container to initialize before starting health-retries countdown (ms|s|m|h) (default 0s)
    /// </summary>
    [CliOption("--health-start-period", Format = OptionFormat.EqualsSeparated)]
    public DockerContainerRunHealthStartPeriod? HealthStartPeriod { get; set; }

    /// <summary>
    /// Maximum time to allow one check to run (ms|s|m|h) (default 0s)
    /// </summary>
    [CliOption("--health-timeout", Format = OptionFormat.EqualsSeparated)]
    public DockerContainerRunHealthTimeout? HealthTimeout { get; set; }
