// This file provides a slim version of DockerContainerRunOptions that inherits from the shared base class.
...
/// <summary>
/// Slim version of docker container run options that inherits common container configuration from base class.
/// Use this class for new code to reduce duplication.
/// </summary>
[ExcludeFromCodeCoverage]
[CliSubCommand("container", "run")]
public record DockerContainerRunOptionsSlim : DockerContainerConfigOptions
{
    /// <summary>
