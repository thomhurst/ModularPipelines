...
public record DockerCreateOptions : DockerOptions
{
    ...
    public DockerCreateCgroupns? Cgroupns { get; set; }
    ...
    public DockerCreateHealthInterval? HealthInterval { get; set; }
    ...
    public DockerCreateHealthStartInterval? HealthStartInterval { get; set; }

    /// <summary>
    /// Start period for the container to initialize before starting health-retries countdown (ms|s|m|h) (default 0s)
    /// </summary>
    [CliOption("--health-start-period", Format = OptionFormat.EqualsSeparated)]
    public DockerCreateHealthStartPeriod? HealthStartPeriod { get; set; }

    /// <summary>
    /// Maximum time to allow one check to run (ms|s|m|h) (default 0s)
    /// </summary>
    [CliOption("--health-timeout", Format = OptionFormat.EqualsSeparated)]
    public DockerCreateHealthTimeout? HealthTimeout { get; set; }
