...
public class DockerPlugin : IDockerPlugin
{
    ...
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new DockerPluginOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
    ...
    public virtual async Task<CommandResult> LsAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        return await _command.ExecuteCommandLineToolAsync(options ?? new DockerPluginLsOptions(), executionOptions, cancellationToken).ConfigureAwait(false);
    }
