...
[CliSubCommand("delete", "fargateprofile")]
public record EksctlDeleteFargateprofileOptions : EksctlOptions
{
    /// <summary>
    ...
    /// <summary>
    /// wait for wait for the deletion of the Fargate profile, which may take from a couple seconds to a couple minutes. before exiting
    /// </summary>
