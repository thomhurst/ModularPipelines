...
[CliSubCommand("utils", "describe-stacks")]
public record EksctlUtilsDescribeStacksOptions : EksctlOptions
{
    /// <summary>
    /// EKS cluster name
    /// </summary>
    ...
    /// <summary>
    /// include stack events
    /// </summary>
    [CliFlag("--events")]
    public bool? Events { get; set; }

    /// <summary>
    /// resource statuses to filter events by, e.g. CREATE_FAILED, `UPDATE_FAILED`
    /// </summary>
    [CliOption("--resource-status", Format = OptionFormat.EqualsSeparated)]
    public string? ResourceStatus { get; set; }

    /// <summary>
    /// lookup CloudTrail events for the cluster
    /// </summary>
    [CliFlag("--trail")]
    public bool? Trail { get; set; }

    /// <summary>
    /// specifies the output formats (valid option: json and yaml)
    /// </summary>
