...
[CliSubCommand("delete", "iamserviceaccount")]
public record EksctlDeleteIamserviceaccountOptions : EksctlOptions
{
    /// <summary>
    /// EKS cluster name
    /// </summary>
    ...
    /// <summary>
    /// name of the iamserviceaccount to delete
    /// </summary>
    [CliOption("--name", Format = OptionFormat.EqualsSeparated)]
    public string? Name { get; set; }

    /// <summary>
    /// namespace where to delete the iamserviceaccount (default "default")
    /// </summary>
    ...
    /// <summary>
    /// Only delete iamserviceaccounts that are not defined in the given config file
    /// </summary>
