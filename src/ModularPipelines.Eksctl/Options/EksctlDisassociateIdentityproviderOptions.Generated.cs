...
[CliSubCommand("disassociate", "identityprovider")]
public record EksctlDisassociateIdentityproviderOptions : EksctlOptions
{
    /// <summary>
    /// EKS cluster name
    /// </summary>
    ...
    /// <summary>
    /// wait for providers to disassociate before exiting
    /// </summary>
    [CliFlag("--wait", ShortForm = "-w")]
    public bool? Wait { get; set; }

    /// <summary>
    /// maximum waiting time for any long-running operation (default 35m0s)
    /// </summary>
    [CliOption("--timeout", Format = OptionFormat.EqualsSeparated)]
    public string? Timeout { get; set; }

    /// <summary>
    /// name of the provider to disassociate
    /// </summary>
    [CliOption("--name", Format = OptionFormat.EqualsSeparated)]
    public string? Name { get; set; }

    /// <summary>
    /// type of the provider to disassociate
    /// </summary>
