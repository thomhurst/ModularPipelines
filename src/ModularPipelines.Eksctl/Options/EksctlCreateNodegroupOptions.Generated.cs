...
[CliSubCommand("create", "nodegroup")]
public record EksctlCreateNodegroupOptions : EksctlOptions
{
    /// <summary>
    /// EKS cluster name
    /// </summary>
    ...
    /// <summary>
    /// Kubernetes version [for nodegroups "auto" and "latest" can be used to automatically inherit version from the control plane or force latest] (default "auto")
    /// </summary>
    ...
    /// <summary>
    /// Dry-run mode that skips nodegroup creation and outputs a ClusterConfig
    /// </summary>
    [CliFlag("--dry-run")]
    public bool? DryRun { get; set; }

    /// <summary>
    /// whether the creation of ARM nodegroups should proceed when the cluster addons are outdated
    /// </summary>
    [CliFlag("--skip-outdated-addons-check")]
    public bool? SkipOutdatedAddonsCheck { get; set; }

    /// <summary>
    /// name of the new nodegroup (generated if unspecified)
    /// </summary>
