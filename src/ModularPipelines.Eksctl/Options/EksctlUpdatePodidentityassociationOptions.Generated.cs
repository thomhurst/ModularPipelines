...
[CliSubCommand("update", "podidentityassociation")]
public record EksctlUpdatePodidentityassociationOptions : EksctlOptions
{
    /// <summary>
    /// EKS cluster name
    /// </summary>
    ...
    /// <summary>
    /// Namespace of the pod identity association
    /// </summary>
    [CliOption("--namespace", Format = OptionFormat.EqualsSeparated)]
    public string? Namespace { get; set; }

    /// <summary>
    /// Service account name of the pod identity association
    /// </summary>
    ...
    /// <summary>
    /// ARN of the target IAM role for cross-account access
    /// </summary>
    [CliOption("--target-role-arn", Format = OptionFormat.EqualsSeparated)]
    public string? TargetRoleArn { get; set; }

    /// <summary>
    /// Disable session tags added by EKS Pod Identity
    /// </summary>
    [CliFlag("--disable-session-tags")]
    public bool? DisableSessionTags { get; set; }

    /// <summary>
    /// Enable session tags added by EKS Pod Identity
    /// </summary>
    [CliFlag("--no-disable-session-tags")]
    public bool? NoDisableSessionTags { get; set; }
