...
[CliSubCommand("utils", "enable-secrets-encryption")]
public record EksctlUtilsEnableSecretsEncryptionOptions : EksctlOptions
{
    /// <summary>
    ...
    /// <summary>
    /// maximum waiting time for any long-running operation (default 1h20m0s)
    /// </summary>
    ...
    /// KMS key ARN
    /// </summary>
    [CliOption("--key-arn", Format = OptionFormat.EqualsSeparated)]
    public string? KeyArn { get; set; }

    /// <summary>
    /// Encrypt all existing secrets with the new KMS key (default true)
    /// </summary>
    [CliFlag("--encrypt-existing-secrets")]
