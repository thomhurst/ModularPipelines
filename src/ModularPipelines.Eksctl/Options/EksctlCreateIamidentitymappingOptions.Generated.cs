...
[CliSubCommand("create", "iamidentitymapping")]
public record EksctlCreateIamidentitymappingOptions : EksctlOptions
{
    /// <summary>
    /// Account ID to automatically map to its username
    /// </summary>
    [CliOption("--account", Format = OptionFormat.EqualsSeparated)]
    public string? Account { get; set; }

    /// <summary>
    /// ARN of the IAM role or user to create
    /// </summary>
    [CliOption("--arn", Format = OptionFormat.EqualsSeparated)]
    ...
    /// <summary>
    /// Service name; valid value: emr-containers
    /// </summary>
    [CliOption("--service-name", Format = OptionFormat.EqualsSeparated)]
    public string? ServiceName { get; set; }

    /// <summary>
    /// Namespace in which to create RBAC resources (only valid with --service-name)
    /// </summary>
    [CliOption("--namespace", Format = OptionFormat.EqualsSeparated)]
    public string? Namespace { get; set; }

    /// <summary>
    /// Throw error when an aws-auth record already exists with the given ARN
    /// </summary>
    [CliFlag("--no-duplicate-arns")]
    public bool? NoDuplicateArns { get; set; }
