...
[CliSubCommand("create", "accessentry")]
public record EksctlCreateAccessentryOptions : EksctlOptions
{
    /// <summary>
    /// Principal ARN (default "arn:::::")
    /// </summary>
    ...
    /// <summary>
    /// A Kubernetes username to map to the principal ARN
    /// </summary>
    [CliOption("--kubernetes-username", Format = OptionFormat.EqualsSeparated)]
    public string? KubernetesUsername { get; set; }
