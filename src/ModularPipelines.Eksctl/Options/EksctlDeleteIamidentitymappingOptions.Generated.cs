...
[CliSubCommand("delete", "iamidentitymapping")]
public record EksctlDeleteIamidentitymappingOptions : EksctlOptions
{
    /// <summary>
    /// Delete all matching mappings instead of just one
    /// </summary>
    [CliFlag("--all")]
    public bool? All { get; set; }

    /// <summary>
    /// ARN of the IAM role or user to delete
    /// </summary>
