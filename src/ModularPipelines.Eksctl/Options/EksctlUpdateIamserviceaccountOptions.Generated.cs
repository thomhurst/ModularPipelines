...
[CliSubCommand("update", "iamserviceaccount")]
public record EksctlUpdateIamserviceaccountOptions : EksctlOptions
{
    /// <summary>
    /// EKS cluster name
    /// </summary>
    ...
    /// <summary>
    /// name of the iamserviceaccount to update
    /// </summary>
    [CliOption("--name", Format = OptionFormat.EqualsSeparated)]
    public string? Name { get; set; }

    /// <summary>
    /// namespace where to update the iamserviceaccount (default "default")
    /// </summary>
    [CliOption("--namespace", Format = OptionFormat.EqualsSeparated)]
    public string? Namespace { get; set; }

    /// <summary>
    /// ARN of the policy where to update the iamserviceaccount
    /// </summary>
