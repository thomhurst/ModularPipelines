...
[CliCommand("helm", "history")]
public record HelmHistoryOptions : HelmOptions
{
    /// <summary>
    /// help for history      --max int         maximum number of revision to include in history (default 256)  -o, --output format   prints the output in the specified format. Allowed values: table, json, yaml (default table)
    /// </summary>
