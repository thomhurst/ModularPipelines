...
// Source: https://helm.sh/docs/helm/helm_push/
...
[CliCommand("helm", "push")]
public record HelmPushOptions : HelmOptions
{
    /// <summary>
    /// verify certificates of HTTPS-enabled servers using this CA bundle      --cert-file string           identify registry client using this SSL certificate file  -h, --help                       help for push      --insecure-skip-tls-verify   skip tls certificate checks for the chart upload      --key-file string            identify registry client using this SSL key file      --password string            chart repository password where to locate the requested chart      --plain-http                 use insecure HTTP connections for the chart upload      --username string            chart repository username where to locate the requested chart
    /// </summary>
