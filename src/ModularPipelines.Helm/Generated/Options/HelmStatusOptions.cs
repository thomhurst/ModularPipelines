...
[CliCommand("helm", "status")]
public record HelmStatusOptions : HelmOptions
{
    /// <summary>
    /// help for status  -o, --output format   prints the output in the specified format. Allowed values: table, json, yaml (default table)      --revision int    if set, display the status of the named release with revision
    /// </summary>
