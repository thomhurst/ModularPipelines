...
[CliCommand("helm", "plugin", "verify")]
public record HelmPluginVerifyOptions : HelmOptions
{
    /// <summary>
    /// help for verify      --keyring string   keyring containing public keys (default "~/.gnupg/pubring.gpg")
    /// </summary>
