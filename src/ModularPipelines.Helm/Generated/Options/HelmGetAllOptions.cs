...
[CliCommand("helm", "get", "all")]
public record HelmGetAllOptions : HelmOptions
{
    /// <summary>
    /// help for all      --revision int      get the named release with revision      --template string   go template for formatting the output, eg: {{.Release.Name}}
    /// </summary>
