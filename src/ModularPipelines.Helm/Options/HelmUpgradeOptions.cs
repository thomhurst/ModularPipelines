...
public record HelmUpgradeOptions : HelmOptions
{
    ...
    /// </summary>
    [CliOption("--history-max", Format = OptionFormat.EqualsSeparated)]
    ...
    /// </summary>
    [CliFlag("--reset-then-reuse-values")]
    public bool? ResetThenReuseValues { get; set; }
