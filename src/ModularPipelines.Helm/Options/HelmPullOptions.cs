...
public record HelmPullOptions : HelmOptions
{
    ...
    /// <summary>
    /// location to write the chart. If this and untardir are specified, untardir is appended to this (default ".")
    /// </summary>
    ...
    /// </summary>
    [CliOption("--untardir", Format = OptionFormat.EqualsSeparated)]
